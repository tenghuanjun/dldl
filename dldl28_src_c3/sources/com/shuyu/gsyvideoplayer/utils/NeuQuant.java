...
class NeuQuant {
    ...
    public void learn() {
        ...
        for (int i6 = 0; i6 < 32; i6++) {
            this.radpower[i6] = WXMediaMessage.DESCRIPTION_LENGTH_LIMIT * (((1024 - (i6 * i6)) * 256) / WXMediaMessage.DESCRIPTION_LENGTH_LIMIT);
        }
    ...
    protected void alterneigh(int i, int i2, int i3, int i4, int i5) {
        ...
        while (true) {
            ...
            if (i8 < i7) {
                ...
                try {
                    int i14 = iArr[0];
                    iArr[0] = i14 - (((i14 - i3) * i12) / alpharadbias);
                    int i15 = iArr[1];
                    iArr[1] = i15 - (((i15 - i4) * i12) / alpharadbias);
                    int i16 = iArr[2];
                    iArr[2] = i16 - (((i16 - i5) * i12) / alpharadbias);
            ...
            if (i9 > i6) {
                ...
                try {
                    int i18 = iArr2[0];
                    iArr2[0] = i18 - (((i18 - i3) * i12) / alpharadbias);
                    int i19 = iArr2[1];
                    iArr2[1] = i19 - (((i19 - i4) * i12) / alpharadbias);
                    int i20 = iArr2[2];
                    iArr2[2] = i20 - ((i12 * (i20 - i5)) / alpharadbias);
    ...
    protected void altersingle(int i, int i2, int i3, int i4, int i5) {
        ...
        int i6 = iArr[0];
        iArr[0] = i6 - (((i6 - i3) * i) / WXMediaMessage.DESCRIPTION_LENGTH_LIMIT);
        int i7 = iArr[1];
        iArr[1] = i7 - (((i7 - i4) * i) / WXMediaMessage.DESCRIPTION_LENGTH_LIMIT);
        int i8 = iArr[2];
        iArr[2] = i8 - ((i * (i8 - i5)) / WXMediaMessage.DESCRIPTION_LENGTH_LIMIT);
    }
    ...
    protected int contest(int i, int i2, int i3) {
        ...
        int[] iArr5 = this.bias;
        iArr5[i6] = iArr5[i6] - WXMediaMessage.THUMB_LENGTH_LIMIT;
        return i7;
    }
}
