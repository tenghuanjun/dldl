...
public class ImagePagerAdapter extends PagerAdapter {
    ...
    /* JADX WARN: Type inference failed for: r3v1, types: [android.view.View, com.github.chrisbanes.photoview.PhotoView, java.lang.Object] */
    public void destroyItem(ViewGroup viewGroup, int i, Object obj) {
        if (obj instanceof PhotoView) {
            ?? r3 = (PhotoView) obj;
            r3.setImageDrawable(null);
            this.viewList.add((PhotoView) r3);
            viewGroup.removeView(r3);
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r0v2, types: [android.view.View, android.widget.ImageView, com.github.chrisbanes.photoview.PhotoView, java.lang.Object] */
    public Object instantiateItem(ViewGroup viewGroup, final int i) {
        ...
        if (image.isGif()) {
            ...
            Glide.with(this.mContext).load(this.isAndroidQ ? image.getUri() : image.getPath()).apply(new RequestOptions().diskCacheStrategy(DiskCacheStrategy.NONE)).override(720, 1080).into(photoViewRemove);
        } else {
            Glide.with(this.mContext).asBitmap().apply(new RequestOptions().diskCacheStrategy(DiskCacheStrategy.NONE)).load(this.isAndroidQ ? image.getUri() : image.getPath()).into(new SimpleTarget<Bitmap>(i3, i2) { // from class: com.donkingliang.imageselector.adapter.ImagePagerAdapter.1
