        ...
        final void encodeUtf8Default(CharSequence charSequence, ByteBuffer byteBuffer) {
            ...
            while (i < length) {
                ...
                if (cCharAt2 < 128) {
                    ...
                    int i2 = iPosition + 1;
                    try {
                        byteBuffer.put(iPosition, (byte) ((cCharAt2 >>> 6) | KeyBoardKey.KeyboardKeyOem3));
                    ...
                    if (i4 != length) {
                        try {
                            ...
                            if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                ...
                                int i5 = iPosition + 1;
                                try {
                                    byteBuffer.put(iPosition, (byte) ((codePoint >>> 18) | KeyBoardKey.KeyboardKeyOemAttn));
                                    int i6 = iPosition + 2;
                                    try {
                    ...
                    if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || i7 > i5 - 3) {
                        if (i7 <= i5 - 4) {
                            ...
                            if (i9 != charSequence.length()) {
                                ...
                                if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                    int codePoint = Character.toCodePoint(cCharAt2, cCharAt3);
                                    bArr[i7] = (byte) ((codePoint >>> 18) | KeyBoardKey.KeyboardKeyOemAttn);
                            ...
                            if (j4 <= j5 - 4) {
                                ...
                                if (i5 != length) {
                                    ...
                                    if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                        int codePoint = Character.toCodePoint(cCharAt2, cCharAt3);
                                        j2 = 1;
                                        UnsafeUtil.putByte(bArr, j4, (byte) ((codePoint >>> 18) | KeyBoardKey.KeyboardKeyOemAttn));
                                        j3 = j5;
                        ...
                        if (jPosition <= jLimit - 4) {
                            ...
                            if (i != length) {
                                ...
                                if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                    int codePoint = Character.toCodePoint(cCharAt2, cCharAt3);
                                    j4 = 1;
                                    UnsafeUtil.putByte(jPosition, (byte) ((codePoint >>> 18) | KeyBoardKey.KeyboardKeyOemAttn));
                                    j3 = jLimit;
