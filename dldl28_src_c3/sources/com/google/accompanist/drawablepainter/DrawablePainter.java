...
public final class DrawablePainter extends Painter implements RememberObserver {
    ...
    public DrawablePainter(Drawable drawable) {
        ...
        this.drawableIntrinsicSize = SnapshotStateKt.mutableStateOf$default(Size.box-impl(DrawablePainterKt.getIntrinsicSize(drawable)), (SnapshotMutationPolicy) null, 2, (Object) null);
            ...
            public final AnonymousClass1 m34invoke() {
                ...
                return new Drawable.Callback() { // from class: com.google.accompanist.drawablepainter.DrawablePainter$callback$2.1
                    ...
                    public void invalidateDrawable(Drawable d) {
                        ...
                        drawablePainter3.m32setDrawableIntrinsicSizeuvyYCjk(DrawablePainterKt.getIntrinsicSize(drawablePainter3.getDrawable()));
                    }
    ...
    public final void m32setDrawableIntrinsicSizeuvyYCjk(long j) {
    ...
    protected boolean applyAlpha(float alpha) {
        this.drawable.setAlpha(RangesKt.coerceIn(MathKt.roundToInt(alpha * KotlinVersion.MAX_COMPONENT_VALUE), 0, KotlinVersion.MAX_COMPONENT_VALUE));
        return true;
    }
    ...
    protected boolean applyLayoutDirection(LayoutDirection layoutDirection) {
        ...
        return x$.ExternalSyntheticApiModelOutline0.m(drawable, i);
    }

    /* JADX INFO: renamed from: getIntrinsicSize-NH-jbRc, reason: not valid java name */
    public long m33getIntrinsicSizeNHjbRc() {
