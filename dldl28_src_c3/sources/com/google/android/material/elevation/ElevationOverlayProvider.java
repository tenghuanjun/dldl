...
public class ElevationOverlayProvider {
    ...
    public int compositeOverlay(int i, float f) {
        ...
        int iLayer = MaterialColors.layer(ColorUtils.setAlphaComponent(i, KotlinVersion.MAX_COMPONENT_VALUE), this.elevationOverlayColor, fCalculateOverlayAlphaFraction);
