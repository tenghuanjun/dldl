...
class UtcDates {
    ...
    private static android.icu.util.TimeZone getUtcAndroidTimeZone() {
        return x$.ExternalSyntheticApiModelOutline0.m(UTC);
    }
    ...
    private static DateFormat getAndroidFormat(String str, Locale locale) {
        DateFormat dateFormatM = x$.ExternalSyntheticApiModelOutline0.m(str, locale);
        x$.ExternalSyntheticApiModelOutline0.m(dateFormatM, getUtcAndroidTimeZone());
        return dateFormatM;
    }
