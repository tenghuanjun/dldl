    ...
    final void showView() {
        this.view.setOnAttachStateChangeListener(new OnAttachStateChangeListener() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.6
            ...
            public void onViewAttachedToWindow(View view) {
                ...
                if (Build.VERSION.SDK_INT < 29 || (windowInsetsM = x$.ExternalSyntheticApiModelOutline0.m(BaseTransientBottomBar.this.view)) == null) {
                    return;
                }
                BaseTransientBottomBar.this.extraBottomMarginGestureInset = ComponentDialog$.ExternalSyntheticApiModelOutline0.m$3(HalfKt$.ExternalSyntheticApiModelOutline0.m$1(windowInsetsM));
                BaseTransientBottomBar.this.updateMargins();
            }
