...
final class Cam16 {
    ...
    static Cam16 fromIntInViewingConditions(int i, ViewingConditions viewingConditions) {
        ...
        float fLinearized3 = ColorUtils.linearized(i2 / 255.0f) * 100.0f;
        ...
        double d2 = f15;
        return new Cam16(fAtan2, fPow5, fPow4, c, flRoot, fSqrt, f16, fLog1p * ((float) Math.cos(d2)), fLog1p * ((float) Math.sin(d2)));
    }
    ...
    private static Cam16 fromJchInViewingConditions(float f, float f2, float f3, ViewingConditions viewingConditions) {
        ...
        return new Cam16(f3, f2, f, c, flRoot, fSqrt, f4, fLog1p * ((float) Math.cos(d)), fLog1p * ((float) Math.sin(d)));
    }
