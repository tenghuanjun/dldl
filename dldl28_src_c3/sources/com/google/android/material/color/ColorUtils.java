...
final class ColorUtils {
    ...
    public static int intFromRgb(int i, int i2, int i3) {
        return ((i & KotlinVersion.MAX_COMPONENT_VALUE) << 16) | (-16777216) | ((i2 & KotlinVersion.MAX_COMPONENT_VALUE) << 8) | (i3 & KotlinVersion.MAX_COMPONENT_VALUE);
    }
    ...
    public static int intFromXyzComponents(float f, float f2, float f3) {
        ...
        return intFromRgb(Math.max(Math.min(KotlinVersion.MAX_COMPONENT_VALUE, Math.round(delinearized(f7) * 255.0f)), 0), Math.max(Math.min(KotlinVersion.MAX_COMPONENT_VALUE, Math.round(delinearized(f8) * 255.0f)), 0), Math.max(Math.min(KotlinVersion.MAX_COMPONENT_VALUE, Math.round(delinearized(f9) * 255.0f)), 0));
    }
