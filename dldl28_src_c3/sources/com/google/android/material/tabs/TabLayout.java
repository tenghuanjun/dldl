    ...
    public final class TabView extends LinearLayout {
        ...
        public void onMeasure(int i, int i2) {
            ...
            if (tabMaxWidth > 0 && (mode == 0 || size > tabMaxWidth)) {
                i = View.MeasureSpec.makeMeasureSpec(TabLayout.this.tabMaxWidth, Priority.BG_LOW);
            }
        ...
        public void draw(Canvas canvas) {
            ...
            if (TabLayout.this.tabSelectedIndicator.getBounds().width() > 0) {
                ...
                if (TabLayout.this.tabSelectedIndicatorColor != 0) {
                    ...
                    drawableWrap.setColorFilter(null);
                } else {
                    DrawableCompat.setTintList(drawableWrap, (ColorStateList) null);
                }
