...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            if (typedArrayObtainStyledAttributes.hasValue(R.styleable.AppBarLayout_android_keyboardNavigationCluster)) {
                x$.ExternalSyntheticApiModelOutline0.m(this, typedArrayObtainStyledAttributes.getBoolean(R.styleable.AppBarLayout_android_keyboardNavigationCluster, false));
            }
    ...
    protected static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        private void updateAccessibilityActions(CoordinatorLayout coordinatorLayout, T t) {
            ...
            if (viewFindFirstScrollingChild == null || t.getTotalScrollRange() == 0 || !(viewFindFirstScrollingChild.getLayoutParams().getBehavior() instanceof ScrollingViewBehavior)) {
                return;
            }
        ...
        public Parcelable onSaveInstanceState(CoordinatorLayout coordinatorLayout, T t) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (childAt.getTop() + topAndBottomOffset <= 0 && bottom >= 0) {
                    ?? savedState = new SavedState(parcelableOnSaveInstanceState);
