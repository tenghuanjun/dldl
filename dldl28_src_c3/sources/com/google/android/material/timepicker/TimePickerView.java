...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    /* JADX WARN: Type inference failed for: r1v10, types: [android.view.View, com.google.android.material.chip.Chip] */
    /* JADX WARN: Type inference failed for: r2v6, types: [android.view.View, com.google.android.material.chip.Chip] */
    public TimePickerView(Context context, AttributeSet attributeSet, int i) {
        ...
        ?? r1 = (Chip) findViewById(R.id.material_minute_tv);
        this.minuteView = r1;
        ?? r2 = (Chip) findViewById(R.id.material_hour_tv);
        this.hourView = r2;
        this.clockHandView = (ClockHandView) findViewById(R.id.material_clock_hand);
        ViewCompat.setAccessibilityLiveRegion((View) r1, 2);
        ViewCompat.setAccessibilityLiveRegion((View) r2, 2);
        setupDoubleTap();
        setUpDisplay();
    }
