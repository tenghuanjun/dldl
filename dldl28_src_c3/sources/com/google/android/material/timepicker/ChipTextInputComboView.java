...
class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public ChipTextInputComboView(Context context, AttributeSet attributeSet, int i) {
        ...
        ?? r5 = (Chip) layoutInflaterFrom.inflate(R.layout.material_time_chip, (ViewGroup) this, false);
        this.chip = r5;
    ...
    private void updateHintLocales() {
        if (Build.VERSION.SDK_INT >= 24) {
            x$.ExternalSyntheticApiModelOutline0.m(this.editText, ComponentDialog$.ExternalSyntheticApiModelOutline0.m(getContext().getResources().getConfiguration()));
        }
    }
