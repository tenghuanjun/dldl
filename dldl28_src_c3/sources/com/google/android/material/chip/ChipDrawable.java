...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    private void drawDebug(Canvas canvas, Rect rect) {
        ...
        if (paint != null) {
            paint.setColor(ColorUtils.setAlphaComponent(-16777216, KeyBoardKey.KeyboardKeyF16));
            ...
            this.debugPaint.setColor(ColorUtils.setAlphaComponent(-65536, KeyBoardKey.KeyboardKeyF16));
            calculateChipTouchBounds(rect, this.rectF);
            canvas.drawRect(this.rectF, this.debugPaint);
            this.debugPaint.setColor(ColorUtils.setAlphaComponent(-16711936, KeyBoardKey.KeyboardKeyF16));
