...
final class StaticLayoutBuilderCompat {
    ...
    public StaticLayout build() throws StaticLayoutBuilderCompatException {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            StaticLayout.Builder builderM = NotificationCompat$.ExternalSyntheticApiModelOutline0.m(charSequenceEllipsize, this.start, this.end, this.paint, iMax);
            NotificationCompat$.ExternalSyntheticApiModelOutline0.m(builderM, this.alignment);
            NotificationCompat$.ExternalSyntheticApiModelOutline0.m(builderM, this.includePad);
            ComponentDialog$.ExternalSyntheticApiModelOutline0.m(builderM, this.isRtl ? TextDirectionHeuristics.RTL : TextDirectionHeuristics.LTR);
            TextUtils.TruncateAt truncateAt = this.ellipsize;
            if (truncateAt != null) {
                NotificationCompat$.ExternalSyntheticApiModelOutline0.m(builderM, truncateAt);
            }
            NotificationCompat$.ExternalSyntheticApiModelOutline0.m$2(builderM, this.maxLines);
            float f = this.lineSpacingAdd;
            if (f != 0.0f || this.lineSpacingMultiplier != 1.0f) {
                NotificationCompat$.ExternalSyntheticApiModelOutline0.m(builderM, f, this.lineSpacingMultiplier);
            }
            if (this.maxLines > 1) {
                NotificationCompat$.ExternalSyntheticApiModelOutline0.m$1(builderM, this.hyphenationFrequency);
            }
            return NotificationCompat$.ExternalSyntheticApiModelOutline0.m(builderM);
        }
