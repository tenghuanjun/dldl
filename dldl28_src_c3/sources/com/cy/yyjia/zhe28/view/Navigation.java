...
public class Navigation extends ConstraintLayout {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        LayoutInflater.from(context).inflate(2131558957, (ViewGroup) this, true);
        this.rlBg = findViewById(2131361924);
        ImageView imageView = (ImageView) findViewById(2131362161);
        ...
        this.ivMore = (ImageView) findViewById(2131362185);
        this.tvTitle = (TextView) findViewById(2131362362);
        this.tvMore = (TextView) findViewById(2131362730);
        ...
        this.textColor = typedArrayObtainStyledAttributes.getColor(9, -16777216);
        boolean z = typedArrayObtainStyledAttributes.getBoolean(8, false);
        this.moreIcon = typedArrayObtainStyledAttributes.getResourceId(4, 2131624207);
        this.backIcon = typedArrayObtainStyledAttributes.getResourceId(0, 2131624429);
