...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        LayoutInflater.from(context).inflate(2131558956, (ViewGroup) this, true);
        setOrientation(1);
        setVisibility(8);
        ...
        this.mContentTextSize = typedArrayObtainStyledAttributes.getDimension(3, context.getResources().getDimensionPixelSize(2131165334));
        this.mContentLineSpacingMultiplier = 1.0f;
        this.mContentTextColor = typedArrayObtainStyledAttributes.getColor(0, context.getResources().getColor(2131099708));
        this.mStateTvGravity = 2;
        this.mStateTextColor = context.getResources().getColor(com.mobile.auth.R.color.colorPrimary);
    ...
    private void findViews() {
        TextView textView = (TextView) findViewById(2131362092);
        this.mTv = textView;
        ...
        this.mStateTv = (TextView) findViewById(2131362091);
