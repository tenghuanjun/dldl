...
public final class AutoHeightViewPager extends ViewPager {
    ...
    public AutoHeightViewPager(Context context, AttributeSet attributeSet) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        addOnPageChangeListener((ViewPager.OnPageChangeListener) new ViewPager.SimpleOnPageChangeListener() { // from class: com.cy.yyjia.zhe28.view.AutoHeightViewPager.1
    ...
    public final int getViewHeight(int position) {
        View view;
        AutoHeightPager adapter = getAdapter();
        AutoHeightPager autoHeightPager = adapter instanceof AutoHeightPager ? adapter : null;
