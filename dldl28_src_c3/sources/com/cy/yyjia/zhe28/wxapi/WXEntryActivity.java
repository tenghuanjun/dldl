...
public final class WXEntryActivity extends Activity implements IWXAPIEventHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            WXEntryActivity$.ExternalSyntheticApiModelOutline0.m(this, getReceiver(), new IntentFilter(ConstantsAPI.ACTION_REFRESH_WXAPP), 4);
        } else {
    ...
    public void onResp(BaseResp resp) {
        ...
        Log.e("onResp: ", "type=" + resp.getType() + " errCode=" + resp.errCode + " errStr=" + resp.errStr + " openId=" + resp.openId + " transaction=" + resp.transaction + " ");
        if (resp.errCode == 0) {
            try {
