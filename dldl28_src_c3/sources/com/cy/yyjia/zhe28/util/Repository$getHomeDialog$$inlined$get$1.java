...
@DebugMetadata(c = "com.cy.yyjia.zhe28.util.Repository$getHomeDialog$$inlined$get$1", f = "Repository.kt", i = {}, l = {382}, m = "invokeSuspend", n = {}, s = {})
public final class Repository$getHomeDialog$$inlined$get$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public Repository$getHomeDialog$$inlined$get$1(Function1 function1, Function1 function12, String str, Map map, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new Repository$getHomeDialog$$inlined$get$1(this.$success, this.$fail, this.$url, this.$param, continuation);
    }
    ...
    /* JADX INFO: renamed from: com.cy.yyjia.zhe28.util.Repository$getHomeDialog$$inlined$get$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: NetUtil.kt */
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super NetUtil.RequestResult<? extends List<SlideBean>>>, Object> {
        final /* synthetic */ Map $param;
        final /* synthetic */ String $url;
        int label;
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super NetUtil.RequestResult<? extends List<SlideBean>>> continuation) {
            return create(coroutineScope, continuation).invokeSuspend(Unit.INSTANCE);
        }
            ...
            try {
                ...
                if (strString != null) {
                    if (responseExecute.isSuccessful()) {
                        ...
                        if (i == 200) {
                            Object objFromJson = new Gson().fromJson(strString, new TypeToken<BaseResult<List<SlideBean>>>() { // from class: com.cy.yyjia.zhe28.util.Repository$getHomeDialog$.inlined.get.1.1.1
                            }.getType());
