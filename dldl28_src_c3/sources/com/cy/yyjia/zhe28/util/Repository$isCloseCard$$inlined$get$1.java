...
@DebugMetadata(c = "com.cy.yyjia.zhe28.util.Repository$isCloseCard$$inlined$get$1", f = "Repository.kt", i = {}, l = {382}, m = "invokeSuspend", n = {}, s = {})
public final class Repository$isCloseCard$$inlined$get$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ Map $param;
    final /* synthetic */ String $url;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Repository$isCloseCard$$inlined$get$1(String str, Map map, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new Repository$isCloseCard$$inlined$get$1(this.$url, this.$param, continuation);
    }
    ...
    /* JADX INFO: renamed from: com.cy.yyjia.zhe28.util.Repository$isCloseCard$$inlined$get$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: NetUtil.kt */
            ...
            try {
                ...
                if (strString != null) {
                    if (responseExecute.isSuccessful()) {
                        ...
                        if (i == 200) {
                            Object objFromJson = new Gson().fromJson(strString, new TypeToken<BaseResult<Integer>>() { // from class: com.cy.yyjia.zhe28.util.Repository$isCloseCard$.inlined.get.1.1.1
                            }.getType());
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (requestResult instanceof NetUtil.RequestResult.Success) {
            Constant.INSTANCE.setHideCard(((Number) ((NetUtil.RequestResult.Success) requestResult).getData()).intValue() == 1);
        } else if (requestResult instanceof NetUtil.RequestResult.Error) {
            ((NetUtil.RequestResult.Error) requestResult).getE();
        }
