...
@DebugMetadata(c = "com.cy.yyjia.zhe28.util.Repository$getAccoutRole$$inlined$get$1", f = "Repository.kt", i = {}, l = {382}, m = "invokeSuspend", n = {}, s = {})
public final class Repository$getAccoutRole$$inlined$get$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public Repository$getAccoutRole$$inlined$get$1(Function1 function1, Function1 function12, String str, Map map, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new Repository$getAccoutRole$$inlined$get$1(this.$success, this.$fail, this.$url, this.$param, continuation);
    }
    ...
    /* JADX INFO: renamed from: com.cy.yyjia.zhe28.util.Repository$getAccoutRole$$inlined$get$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: NetUtil.kt */
            ...
            try {
                ...
                if (strString != null) {
                    if (responseExecute.isSuccessful()) {
                        ...
                        if (i == 200) {
                            Object objFromJson = new Gson().fromJson(strString, new TypeToken<BaseResult<List<GMRoleBean>>>() { // from class: com.cy.yyjia.zhe28.util.Repository$getAccoutRole$.inlined.get.1.1.1
                            }.getType());
