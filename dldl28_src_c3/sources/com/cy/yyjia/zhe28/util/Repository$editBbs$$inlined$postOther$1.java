...
@Metadata(d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001\"\n\b\u0000\u0010\u0002\u0018\u0001*\u00020\u0003*\u00020\u0004H\u008a@¨\u0006\u0005"}, d2 = {"<anonymous>", "", "T", "", "Lkotlinx/coroutines/CoroutineScope;", "com/cy/yyjia/zhe28/util/NetUtil$postOther$1"}, k = 3, mv = {1, 9, 0}, xi = 48)
@DebugMetadata(c = "com.cy.yyjia.zhe28.util.Repository$editBbs$$inlined$postOther$1", f = "Repository.kt", i = {}, l = {448}, m = "invokeSuspend", n = {}, s = {})
public final class Repository$editBbs$$inlined$postOther$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public Repository$editBbs$$inlined$postOther$1(Function1 function1, Function1 function12, String str, Map map, boolean z, ArrayList arrayList, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new Repository$editBbs$$inlined$postOther$1(this.$success, this.$fail, this.$url, this.$param, this.$useToken, this.$fileList, continuation);
    }
    ...
    /* JADX INFO: renamed from: com.cy.yyjia.zhe28.util.Repository$editBbs$$inlined$postOther$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: NetUtil.kt */
    @Metadata(d1 = {"\u0000\u0012\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0001\"\n\b\u0000\u0010\u0002\u0018\u0001*\u00020\u0003*\u00020\u0004H\u008a@¨\u0006\u0005"}, d2 = {"<anonymous>", "Lcom/cy/yyjia/zhe28/util/NetUtil$RequestResult;", "T", "", "Lkotlinx/coroutines/CoroutineScope;", "com/cy/yyjia/zhe28/util/NetUtil$postOther$1$result$1"}, k = 3, mv = {1, 9, 0}, xi = 48)
    @DebugMetadata(c = "com.cy.yyjia.zhe28.util.NetUtil$postOther$1$result$1", f = "NetUtil.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super NetUtil.RequestResult<? extends BaseResult<BbsPublishBean>>>, Object> {
        final /* synthetic */ ArrayList $fileList;
        final /* synthetic */ Map $param;
        final /* synthetic */ String $url;
        final /* synthetic */ boolean $useToken;
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super NetUtil.RequestResult<? extends BaseResult<BbsPublishBean>>> continuation) {
            return create(coroutineScope, continuation).invokeSuspend(Unit.INSTANCE);
        }
            ...
            try {
                ...
                if (strString != null) {
                    if (responseExecute.isSuccessful()) {
                        Object objFromJson = new Gson().fromJson(strString, new TypeToken<BaseResult<BbsPublishBean>>() { // from class: com.cy.yyjia.zhe28.util.Repository$editBbs$.inlined.postOther.1.1.1
                        }.getType());
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            this.label = 1;
            obj = BuildersKt.withContext(Dispatchers.getIO(), new AnonymousClass1(this.$url, this.$param, this.$useToken, this.$fileList, null), (Continuation) this);
