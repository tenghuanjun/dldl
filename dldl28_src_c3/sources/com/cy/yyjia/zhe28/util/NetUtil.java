...
public final class NetUtil {
    ...
    public static abstract class RequestResult<R> {
        ...
        /* JADX INFO: compiled from: NetUtil.kt */
        @Metadata(d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\t\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0087\b\u0018\u0000*\u0006\b\u0001\u0010\u0001 \u00012\b\u0012\u0004\u0012\u0002H\u00010\u0002B\r\u0012\u0006\u0010\u0003\u001a\u00028\u0001¢\u0006\u0002\u0010\u0004J\u000e\u0010\b\u001a\u00028\u0001HÆ\u0003¢\u0006\u0002\u0010\u0006J\u001e\u0010\t\u001a\b\u0012\u0004\u0012\u00028\u00010\u00002\b\b\u0002\u0010\u0003\u001a\u00028\u0001HÆ\u0001¢\u0006\u0002\u0010\nJ\u0013\u0010\u000b\u001a\u00020\f2\b\u0010\r\u001a\u0004\u0018\u00010\u000eHÖ\u0003J\t\u0010\u000f\u001a\u00020\u0010HÖ\u0001J\t\u0010\u0011\u001a\u00020\u0012HÖ\u0001R\u0013\u0010\u0003\u001a\u00028\u0001¢\u0006\n\n\u0002\u0010\u0007\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u0013"}, d2 = {"Lcom/cy/yyjia/zhe28/util/NetUtil$RequestResult$Success;", "T", "Lcom/cy/yyjia/zhe28/util/NetUtil$RequestResult;", CacheEntity.DATA, "(Ljava/lang/Object;)V", "getData", "()Ljava/lang/Object;", "Ljava/lang/Object;", "component1", "copy", "(Ljava/lang/Object;)Lcom/cy/yyjia/zhe28/util/NetUtil$RequestResult$Success;", "equals", "", "other", "", "hashCode", "", "toString", "", "app_zhe28Release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ RequestResult request$default(NetUtil netUtil, String str, Map map, boolean z, int i, Object obj) {
        ...
        try {
            ...
            if (z) {
                responseExecute = ((GetRequest) ((GetRequest) OkGo.get(str).headers("Authorization", "bearer " + token)).params(map, new boolean[0])).execute();
                Intrinsics.checkNotNull(responseExecute);
            } else {
                responseExecute = ((PostRequest) ((PostRequest) OkGo.post(str).headers("Authorization", "bearer " + token)).params((Map<String, String>) map, new boolean[0])).execute();
                Intrinsics.checkNotNull(responseExecute);
            }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ RequestResult requestOther$default(NetUtil netUtil, String str, Map map, boolean z, boolean z2, ArrayList arrayList, int i, Object obj) {
        Response responseExecute;
        if ((i & 4) != 0) {
            z = true;
        }
        ...
        try {
            ...
            if (z) {
                ...
                responseExecute = ((GetRequest) getRequest.params(map, new boolean[0])).execute();
                Intrinsics.checkNotNull(responseExecute);
            } else {
                ...
                responseExecute = ((PostRequest) postRequestPost.params((Map<String, String>) map, new boolean[0])).execute();
                Intrinsics.checkNotNull(responseExecute);
            }
            ResponseBody responseBodyBody = responseExecute.body();
            String strString = responseBodyBody != null ? responseBodyBody.string() : null;
    ...
    public final RequestResult<Result> requestResult2(String url, Map<String, String> param, File file, String fileName) {
        ...
        Intrinsics.checkNotNullParameter(fileName, Progress.FILE_NAME);
        if (!StringsKt.startsWith$default(url, "http", false, 2, (Object) null)) {
            url = BASE_URL1 + url;
        }
        String str = "";
    ...
    public final void toOther(String msg) {
        Intrinsics.checkNotNullParameter(msg, SocialConstants.PARAM_SEND_MSG);
        String str = msg;
        if (StringsKt.contains$default(str, "绑定手机", false, 2, (Object) null)) {
        ...
        if (StringsKt.contains$default(str, "实名", false, 2, (Object) null)) {
    ...
    /* JADX INFO: compiled from: NetUtil.kt */
    @Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\n\b\u0000\u0010\u0002\u0018\u0001*\u00020\u0003*\u00020\u0004H\u008a@"}, d2 = {"<anonymous>", "", "T", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 9, 0}, xi = KeyBoardKey.KeyboardKeyMediaNextTrack)
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                Intrinsics.needClassReification();
                this.label = 1;
                obj = BuildersKt.withContext(io2, new NetUtil$get$1$result$1(this.$url, this.$param, null), (Continuation) this);
            ...
            if (requestResult instanceof RequestResult.Success) {
                this.$success.invoke(((RequestResult.Success) requestResult).getData());
        ...
        public final Object invokeSuspend$$forInline(Object obj) {
            ...
            Intrinsics.needClassReification();
            InlineMarker.mark(0);
            Object objWithContext = BuildersKt.withContext(io2, new NetUtil$get$1$result$1(this.$url, this.$param, null), (Continuation) this);
            InlineMarker.mark(1);
    ...
    public final /* synthetic */ <T> Job get(String url, Map<String, String> param, Function1<? super T, Unit> success, Function1<? super Exception, Unit> fail) {
        ...
        Intrinsics.needClassReification();
        return BuildersKt.launch$default(coroutineScopeMainScope, (CoroutineContext) null, (CoroutineStart) null, new AnonymousClass1(success, fail, url, param, null), 3, (Object) null);
    }

    public static /* synthetic */ Job getOther$default(NetUtil netUtil, String str, Map map, Function1 function1, Function1 function12, boolean z, int i, Object obj) {
        ...
        CoroutineScope coroutineScopeMainScope = CoroutineScopeKt.MainScope();
        Intrinsics.needClassReification();
        return BuildersKt.launch$default(coroutineScopeMainScope, (CoroutineContext) null, (CoroutineStart) null, new C02091(function1, function12, str, map, z2, null), 3, (Object) null);
    }
    ...
    public static final class C02091 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C02091(Function1<? super T, Unit> function1, Function1<? super Exception, Unit> function12, String str, Map<String, String> map, boolean z, Continuation<? super C02091> continuation) {
            super(2, continuation);
            this.$success = function1;
            this.$fail = function12;
            this.$url = str;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02091(this.$success, this.$fail, this.$url, this.$param, this.$useToken, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                Intrinsics.needClassReification();
                this.label = 1;
                obj = BuildersKt.withContext(io2, new NetUtil$getOther$1$result$1(this.$url, this.$param, this.$useToken, null), (Continuation) this);
                if (obj == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
        ...
        public final Object invokeSuspend$$forInline(Object obj) {
            ...
            Intrinsics.needClassReification();
            InlineMarker.mark(0);
            Object objWithContext = BuildersKt.withContext(io2, new NetUtil$getOther$1$result$1(this.$url, this.$param, this.$useToken, null), (Continuation) this);
            InlineMarker.mark(1);
            RequestResult requestResult = (RequestResult) objWithContext;
            if (requestResult instanceof RequestResult.Success) {
                this.$success.invoke(((RequestResult.Success) requestResult).getData());
    ...
    public final /* synthetic */ <T> Job getOther(String url, Map<String, String> param, Function1<? super T, Unit> success, Function1<? super Exception, Unit> fail, boolean useToken) {
        ...
        CoroutineScope coroutineScopeMainScope = CoroutineScopeKt.MainScope();
        Intrinsics.needClassReification();
        return BuildersKt.launch$default(coroutineScopeMainScope, (CoroutineContext) null, (CoroutineStart) null, new C02091(success, fail, url, param, useToken, null), 3, (Object) null);
    }
    ...
    static final class C02081 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C02081(Function1<? super Result, Unit> function1, Function1<? super Exception, Unit> function12, String str, Map<String, String> map, Continuation<? super C02081> continuation) {
            super(2, continuation);
            this.$success = function1;
            this.$fail = function12;
            this.$url = str;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02081(this.$success, this.$fail, this.$url, this.$param, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                this.label = 1;
                obj = BuildersKt.withContext(Dispatchers.getIO(), new NetUtil$get2$1$result$1(this.$url, this.$param, null), (Continuation) this);
                if (obj == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
    ...
    public final Job get2(String url, Map<String, String> param, Function1<? super Result, Unit> success, Function1<? super Exception, Unit> fail) {
        ...
        Intrinsics.checkNotNullParameter(success, "success");
        Intrinsics.checkNotNullParameter(fail, "fail");
        return BuildersKt.launch$default(CoroutineScopeKt.MainScope(), (CoroutineContext) null, (CoroutineStart) null, new C02081(success, fail, url, param, null), 3, (Object) null);
    }
    ...
    public static final class C02101 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C02101(Function1<? super T, Unit> function1, Function1<? super Exception, Unit> function12, String str, Map<String, String> map, Continuation<? super C02101> continuation) {
            super(2, continuation);
            this.$success = function1;
            this.$fail = function12;
            this.$url = str;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02101(this.$success, this.$fail, this.$url, this.$param, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                Intrinsics.needClassReification();
                this.label = 1;
                obj = BuildersKt.withContext(io2, new NetUtil$post$1$result$1(this.$url, this.$param, null), (Continuation) this);
                if (obj == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
        ...
        public final Object invokeSuspend$$forInline(Object obj) {
            ...
            Intrinsics.needClassReification();
            InlineMarker.mark(0);
            Object objWithContext = BuildersKt.withContext(io2, new NetUtil$post$1$result$1(this.$url, this.$param, null), (Continuation) this);
            InlineMarker.mark(1);
            RequestResult requestResult = (RequestResult) objWithContext;
            if (requestResult instanceof RequestResult.Success) {
                this.$success.invoke(((RequestResult.Success) requestResult).getData());
    ...
    public final /* synthetic */ <T> Job post(String url, Map<String, String> param, Function1<? super T, Unit> success, Function1<? super Exception, Unit> fail) {
        ...
        CoroutineScope coroutineScopeMainScope = CoroutineScopeKt.MainScope();
        Intrinsics.needClassReification();
        return BuildersKt.launch$default(coroutineScopeMainScope, (CoroutineContext) null, (CoroutineStart) null, new C02101(success, fail, url, param, null), 3, (Object) null);
    }

    public static /* synthetic */ Job postOther$default(NetUtil netUtil, String str, Map map, Function1 function1, Function1 function12, boolean z, ArrayList arrayList, int i, Object obj) {
        boolean z2 = (i & 16) != 0 ? false : z;
        ...
        CoroutineScope coroutineScopeMainScope = CoroutineScopeKt.MainScope();
        Intrinsics.needClassReification();
        return BuildersKt.launch$default(coroutineScopeMainScope, (CoroutineContext) null, (CoroutineStart) null, new C02131(function1, function12, str, map, z2, arrayList2, null), 3, (Object) null);
    }
    ...
    public static final class C02131 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C02131(Function1<? super T, Unit> function1, Function1<? super Exception, Unit> function12, String str, Map<String, String> map, boolean z, ArrayList<File> arrayList, Continuation<? super C02131> continuation) {
            super(2, continuation);
            this.$success = function1;
            this.$fail = function12;
            this.$url = str;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02131(this.$success, this.$fail, this.$url, this.$param, this.$useToken, this.$fileList, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                Intrinsics.needClassReification();
                this.label = 1;
                obj = BuildersKt.withContext(io2, new NetUtil$postOther$1$result$1(this.$url, this.$param, this.$useToken, this.$fileList, null), (Continuation) this);
                if (obj == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
        ...
        public final Object invokeSuspend$$forInline(Object obj) {
            ...
            Intrinsics.needClassReification();
            InlineMarker.mark(0);
            Object objWithContext = BuildersKt.withContext(io2, new NetUtil$postOther$1$result$1(this.$url, this.$param, this.$useToken, this.$fileList, null), (Continuation) this);
            InlineMarker.mark(1);
            RequestResult requestResult = (RequestResult) objWithContext;
            if (requestResult instanceof RequestResult.Success) {
                this.$success.invoke(((RequestResult.Success) requestResult).getData());
    ...
    public final /* synthetic */ <T> Job postOther(String url, Map<String, String> param, Function1<? super T, Unit> success, Function1<? super Exception, Unit> fail, boolean useToken, ArrayList<File> fileList) {
        ...
        CoroutineScope coroutineScopeMainScope = CoroutineScopeKt.MainScope();
        Intrinsics.needClassReification();
        return BuildersKt.launch$default(coroutineScopeMainScope, (CoroutineContext) null, (CoroutineStart) null, new C02131(success, fail, url, param, useToken, fileList, null), 3, (Object) null);
    }
    ...
    static final class C02111 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C02111(Function1<? super Result, Unit> function1, Function1<? super Exception, Unit> function12, String str, Map<String, String> map, ArrayList<File> arrayList, Continuation<? super C02111> continuation) {
            super(2, continuation);
            this.$success = function1;
            this.$fail = function12;
            this.$url = str;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02111(this.$success, this.$fail, this.$url, this.$param, this.$fileList, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                this.label = 1;
                obj = BuildersKt.withContext(Dispatchers.getIO(), new NetUtil$post2$1$result$1(this.$url, this.$param, this.$fileList, null), (Continuation) this);
                if (obj == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
    ...
    public final Job post2(String url, Map<String, String> param, Function1<? super Result, Unit> success, Function1<? super Exception, Unit> fail, ArrayList<File> fileList) {
        ...
        Intrinsics.checkNotNullParameter(success, "success");
        Intrinsics.checkNotNullParameter(fail, "fail");
        return BuildersKt.launch$default(CoroutineScopeKt.MainScope(), (CoroutineContext) null, (CoroutineStart) null, new C02111(success, fail, url, param, fileList, null), 3, (Object) null);
    }
    ...
    static final class C02121 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C02121(Function1<? super Result, Unit> function1, Function1<? super Exception, Unit> function12, String str, Map<String, String> map, File file, String str2, Continuation<? super C02121> continuation) {
            super(2, continuation);
            this.$success = function1;
            this.$fail = function12;
            this.$url = str;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02121(this.$success, this.$fail, this.$url, this.$param, this.$file, this.$fileName, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                this.label = 1;
                obj = BuildersKt.withContext(Dispatchers.getIO(), new NetUtil$post3$1$result$1(this.$url, this.$param, this.$file, this.$fileName, null), (Continuation) this);
                if (obj == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
    ...
    public final Job post3(String url, File file, String fileName, Function1<? super Result, Unit> success, Function1<? super Exception, Unit> fail, Map<String, String> param) {
        ...
        Intrinsics.checkNotNullParameter(fail, "fail");
        Intrinsics.checkNotNullParameter(param, "param");
        return BuildersKt.launch$default(CoroutineScopeKt.MainScope(), (CoroutineContext) null, (CoroutineStart) null, new C02121(success, fail, url, param, file, fileName, null), 3, (Object) null);
    }
