...
@Metadata(d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\bÇ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J&\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\nJ*\u0010\f\u001a\u00020\r2\u0006\u0010\u0005\u001a\u00020\u00062\f\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\r0\u000f2\f\u0010\u0010\u001a\b\u0012\u0004\u0012\u00020\r0\u000fJ\u0010\u0010\u0011\u001a\u00020\b2\u0006\u0010\u0005\u001a\u00020\u0006H\u0002J\u0010\u0010\u0012\u001a\u00020\b2\u0006\u0010\u0005\u001a\u00020\u0006H\u0002J\u000e\u0010\u0013\u001a\u00020\r2\u0006\u0010\u0005\u001a\u00020\u0006J\u0018\u0010\u0014\u001a\u00020\r2\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0015\u001a\u00020\bH\u0002¨\u0006\u0016"}, d2 = {"Lcom/cy/yyjia/zhe28/util/CalendarUtil;", "", "()V", "addCalendarEvent", "", "context", "Landroid/content/Context;", DBHelpTool.RecordEntry.COLUMN_NAME_TIMESTAMP, "", "title", "", SocialConstants.PARAM_COMMENT, "checkCalendarPermission", "", "success", "Lkotlin/Function0;", "failure", "createCalendarAccount", "getCalendarAccount", "openCalendar", "setEventAlarm", "eventId", "app_zhe28Release"}, k = 1, mv = {1, 9, 0}, xi = 48)
public final class CalendarUtil {
    ...
    public final void checkCalendarPermission(Context context, final Function0<Unit> success, final Function0<Unit> failure) {
        ...
        List<String> listListOf = CollectionsKt.listOf(new String[]{Permission.READ_CALENDAR, Permission.WRITE_CALENDAR});
    ...
    private final long getCalendarAccount(Context context) {
        ContentResolver contentResolver = context.getContentResolver();
        Intrinsics.checkNotNullExpressionValue(contentResolver, "getContentResolver(...)");
        Cursor cursorQuery = contentResolver.query(CalendarContract.Calendars.CONTENT_URI, new String[]{"_id", "account_name", "calendar_displayName"}, null, null, null);
        if (cursorQuery != null) {
    ...
    private final long createCalendarAccount(Context context) {
        ...
        Uri uriInsert = contentResolver.insert(CalendarContract.Calendars.CONTENT_URI.buildUpon().appendQueryParameter("caller_is_syncadapter", "true").appendQueryParameter("account_name", "28zhe@example.com").appendQueryParameter("account_type", "LOCAL").build(), contentValues);
        if (uriInsert == null || (lastPathSegment = uriInsert.getLastPathSegment()) == null || (longOrNull = StringsKt.toLongOrNull(lastPathSegment)) == null) {
            return -1L;
        }
