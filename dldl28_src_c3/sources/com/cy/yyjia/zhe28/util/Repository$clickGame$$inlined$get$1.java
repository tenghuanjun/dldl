...
@DebugMetadata(c = "com.cy.yyjia.zhe28.util.Repository$clickGame$$inlined$get$1", f = "Repository.kt", i = {}, l = {382}, m = "invokeSuspend", n = {}, s = {})
public final class Repository$clickGame$$inlined$get$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public Repository$clickGame$$inlined$get$1(String str, Map map, Continuation continuation, int i) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new Repository$clickGame$$inlined$get$1(this.$url, this.$param, continuation, this.$id$inlined);
    }
    ...
    /* JADX INFO: renamed from: com.cy.yyjia.zhe28.util.Repository$clickGame$$inlined$get$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: NetUtil.kt */
            ...
            try {
                ...
                if (strString != null) {
                    if (responseExecute.isSuccessful()) {
                        ...
                        if (i == 200) {
                            Object objFromJson = new Gson().fromJson(strString, new TypeToken<BaseResult<Result>>() { // from class: com.cy.yyjia.zhe28.util.Repository$clickGame$.inlined.get.1.1.1
                            }.getType());
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (requestResult instanceof NetUtil.RequestResult.Success) {
            Log.e("clickGame: ", "点击游戏" + this.$id$inlined);
        } else if (requestResult instanceof NetUtil.RequestResult.Error) {
            Log.e("clickGame: ", ((NetUtil.RequestResult.Error) requestResult).getE().getLocalizedMessage());
        }
