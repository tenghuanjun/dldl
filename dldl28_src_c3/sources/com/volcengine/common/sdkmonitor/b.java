...
public class b implements MonitorService, ConfigService.ConfigObserver, PluginService.ILoadResultListener {
    ...
    public b() {
        SDKContext.getConfigService().register(ConfigService.monitor_config, this);
    ...
    public void onLoadSuccess() {
        ...
        JSONObject configJson = SDKContext.getConfigService().getConfigJson(ConfigService.monitor_config);
    ...
    public void onReceiveConfig(String str, String str2) {
        ...
        if (ConfigService.monitor_config.equals(str)) {
            ConfigService configService = SDKContext.getConfigService();
            configService.unregister(ConfigService.monitor_config, this);
