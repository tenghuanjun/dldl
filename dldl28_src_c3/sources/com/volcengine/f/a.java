...
public class a implements HttpService, com.volcengine.a.a, ConfigService.ConfigObserver {
    ...
    private volatile HttpDispatcher a;
    ...
    class C0206a implements Callback {
        final /* synthetic */ HttpService.Callback a;

        C0206a(HttpService.Callback callback) {
            this.a = callback;
        }
        ...
        public void onResponse(final Call call, final HttpResponse httpResponse) {
            ...
            try {
                try {
                    ...
                    runnable = new Runnable() { // from class: com.volcengine.f.a$a$$ExternalSyntheticLambda0
                        ...
                        public final void run() {
                            a.C0206a.a(callback, call, httpResponse);
                        }
                    };
                } catch (Exception e) {
                    ...
                    runnable = new Runnable() { // from class: com.volcengine.f.a$a$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            a.C0206a.a(callback2, call, httpResponse);
                        }
                    };
                }
                ...
                executorsService2.executeMain(new Runnable() { // from class: com.volcengine.f.a$a$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        a.C0206a.a(callback3, call, httpResponse);
                    }
                });
                throw th;
            }
    ...
    public /* synthetic */ void a(int i) {
        ...
        dnsResolverResolver.refresh(str);
    }
    ...
    private synchronized HttpDispatcher c() {
        if (this.a == null) {
            ...
            this.a = builderRetryCount.retryInterval(jOptLong, timeUnit).retryMode(configJson.optInt("retry_mode", 0)).connectTimeout(configJson.optLong("connect_timeout", 10000L), timeUnit).readTimeout(configJson.optLong("read_timeout", 15000L), timeUnit).cacheExpiredTime(configJson.optLong("cache_expired_time", 300000L), timeUnit).dnsSelectStrategy(configJson.optInt("dns_select_strategy", 0)).build();
            try {
                if (configJson.has("ip_map")) {
                        ...
                        while (itKeys.hasNext()) {
                            ...
                            if (!TextUtils.isEmpty(next)) {
                                ...
                                if (!TextUtils.isEmpty(strOptString)) {
                                    this.a.resolver().addHttpCloud(next, Arrays.asList(strOptString.split(";")));
                                }
                            }
                        }
                    }
                    ...
                    for (String str : f) {
                        this.a.resolver().addHttpCloud(str, Arrays.asList(g));
                    }
                }
            } catch (Exception e) {
                AcLog.e("HttpService", e.getMessage());
    ...
    public void post(List<String> list, List<String> list2, Map<String, String> map, Map<String, String> map2, String str, HttpService.Callback callback) {
        ...
        callNewCall.enqueue(new C0206a(callback));
    }
