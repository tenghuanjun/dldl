...
public class TokenGenerator {
    ...
    public String assembleToken(Context context, String str, String str2, String str3, String str4, String str5, String str6, boolean z, String str7, String str8, String str9, boolean z2, String str10) {
        ...
        try {
            strEncode = !z ? CryptUtil.Base64.encode(EncryptUtils.encryptToken(context, str, str2, str3, this.c.c(), str4, str5, str6, str12, true, str10).getBytes(Constants.ENC_UTF_8)) : assembleCustomizeToken(context, str4, str5, str7, str8, str9, str11);
            return strEncode;
