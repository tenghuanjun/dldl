    ...
    public static Drawable a(Context context, String str, String str2) {
        ...
        try {
            try {
                ...
                drawableF = !TextUtils.isEmpty(str) ? (str.contains("/") || (iA2 = a(context, str)) == 0) ? f(context, str) : ResourcesCompat.getDrawable(context.getResources(), iA2, (Resources.Theme) null) : null;
                if (drawableF != null) {
                    return drawableF;
                }
                try {
                    return (TextUtils.isEmpty(str2) || (iA = a(context, str2)) == 0) ? drawableF : ResourcesCompat.getDrawable(context.getResources(), iA, (Resources.Theme) null);
                } catch (Exception e) {
                    e = e;
                    i.a(e);
                    return drawableF;
