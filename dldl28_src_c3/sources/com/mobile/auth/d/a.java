        ...
        public void run() {
            try {
                if (new e().a(this.a, "https://id6.me/auth/preauth.do")) {
                    ...
                    String strA = a.a(a.this, this.a, this.b, this.c, this.d, null, this.e, this.f);
                    if (a()) {
                    } else {
                        com.mobile.auth.a.a.b(this.a, strA, this.f, this.g);
                    }
                } else if (a()) {
                } else {
                    com.mobile.auth.a.a.b(this.a, h.a(80800, "WIFI切换超时"), this.f, this.g);
                }
            } catch (Throwable th) {
                try {
    ...
    private String b(Context context, String str, String str2, Network network) {
        try {
            ...
            try {
                ...
                String strOptString = jSONObject.optString(CacheEntity.DATA);
                if ((iOptInt == 0 || iOptInt == 30002) && !TextUtils.isEmpty(strOptString)) {
                    String strA = a(strOptString, str2);
                    if (!TextUtils.isEmpty(strA)) {
                        try {
                            jSONObject.put(CacheEntity.DATA, new JSONObject(strA));
                        } catch (JSONException e) {
                            e.printStackTrace();
                            jSONObject.put(CacheEntity.DATA, strA);
                        }
                        if (iOptInt != 30002) {
                            return jSONObject.toString();
                        }
                        JSONObject jSONObject2 = (JSONObject) jSONObject.opt(CacheEntity.DATA);
