...
public class a extends com.mobile.auth.gatewayauth.manager.a {
    ...
    private synchronized void a(final RequestCallback<a.C0182a, b> requestCallback, final MonitorStruct monitorStruct, final String str) {
        try {
            ...
            com.mobile.auth.a.a.a(this.d, this.a, this.b, new com.mobile.auth.a.b() { // from class: com.mobile.auth.s.a.2
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (cTCCTokenRetFromJson != null) {
                                ...
                                requestCallback.onSuccess(a.C0182a.a().a(number).c(Constant.CTCC_PROTOCOL).d(Constant.CTCC_PROTOCOL_URL).b(accessCode).a(System.currentTimeMillis() + ((long) (data.getExpiredTime() * Priority.UI_NORMAL))).a());
    ...
    */
    ...
    @Override // com.mobile.auth.gatewayauth.manager.a
    public synchronized void e(RequestCallback<a.C0182a, b> requestCallback, a.b bVar) {
        try {
            MonitorStruct monitorStruct = new MonitorStruct();
            monitorStruct.putApiParam(Constant.API_PARAMS_KEY_TIMEOUT, String.valueOf(this.c));
            monitorStruct.setSessionId(bVar.c());
    ...
    public synchronized void f(final RequestCallback<a.C0182a, b> requestCallback, a.b bVar) {
        try {
            ...
            monitorStruct.setNetworkType(com.mobile.auth.gatewayauth.utils.c.a(this.d, true));
            com.mobile.auth.a.a.a((int) this.c, (int) this.c, (int) this.c, this.i);
            com.mobile.auth.a.a.a(this.d, this.a, this.b, new com.mobile.auth.a.b() { // from class: com.mobile.auth.s.a.3
                @Override // com.mobile.auth.a.b
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (cTCCTokenRetFromJson != null) {
                                ...
                                requestCallback.onSuccess(a.C0182a.a().b(accessCode).a(System.currentTimeMillis() + ((long) (data.getExpiredTime() * Priority.UI_NORMAL))).a());
                            }
                        } catch (Exception e) {
