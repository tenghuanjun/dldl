    ...
    public final String a(Context context, String str, HashMap<String, String> map, Object obj) {
        ...
        try {
            ...
            if (host.contains(e.d()) && b && a) {
                String strReplaceFirst2 = !TextUtils.isEmpty(u.a) ? strReplaceFirst.replaceFirst(e.d(), a(u.a)) : strReplaceFirst;
                b = false;
            ...
            try {
                ...
                if (responseCode == 200) {
                    ...
                    jSONObject2.put(SocialConstants.PARAM_SEND_MSG, "outputStr isEmpty");
                    jSONObject2.put("seq", queryParameter);
                    jSONObject2.put(CacheEntity.DATA, "requestUrl:".concat(String.valueOf(strReplaceFirst)));
                    return jSONObject2.toString();
                }
                if (responseCode != 302) {
                    JSONObject jSONObject3 = new JSONObject();
                    jSONObject3.put("code", 410010);
                    jSONObject3.put(SocialConstants.PARAM_SEND_MSG, "https statusCode NOK ".concat(String.valueOf(responseCode)));
                    jSONObject3.put(CacheEntity.DATA, "requestUrl:".concat(String.valueOf(strReplaceFirst)));
                ...
                if (TextUtils.isEmpty(str3)) {
                    ...
                    jSONObject4.put(SocialConstants.PARAM_SEND_MSG, "无跳转地址");
                    jSONObject4.put(CacheEntity.DATA, host);
                ...
                jSONObject5.put(SocialConstants.PARAM_SEND_MSG, "无法跳转HTTP地址");
                jSONObject5.put(CacheEntity.DATA, host);
                ...
                if (message == null || iE >= v.d()) {
                    try {
                        ...
                        jSONObject6.put(SocialConstants.PARAM_SEND_MSG, "https异常 : ".concat(String.valueOf(message)));
                        jSONObject6.put(CacheEntity.DATA, "requestUrl->".concat(String.valueOf(strReplaceFirst)));
