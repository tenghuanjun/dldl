...
final class HttpProxyCacheServerClients {
    ...
    private HttpProxyCache newHttpProxyCache() throws ProxyCacheException {
        HttpProxyCache httpProxyCache = new HttpProxyCache(new HttpUrlSource(this.url, this.config.sourceInfoStorage, this.config.headerInjector, this.config.v, this.config.trustAllCerts), new FileCache(this.config.generateCacheFile(this.url), this.config.diskUsage));
