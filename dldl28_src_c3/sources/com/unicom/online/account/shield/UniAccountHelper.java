...
public class UniAccountHelper {
    ...
    private void cuPreGetToken(int i, final int i2, final String str, final ResultListener resultListener) {
        try {
            ...
            if (eVarA.a != null && !TextUtils.isEmpty(u.c()) && !TextUtils.isEmpty(u.d())) {
                ...
                u.b(i);
                k kVar = new k();
                Context context2 = eVarA.a;
                kVar.b = new l();
                kVar.b.a = dVar;
                try {
                    kVar.a.schedule(new Runnable() { // from class: com.mobile.auth.z.k.1
                                ...
                                synchronized (k.this) {
                                    ...
                                    if (i5 == 1) {
                                        try {
                                            ...
                                            String strOptString = jSONObject2.optString(SocialConstants.PARAM_SEND_MSG);
                                            String strOptString2 = jSONObject2.optString(CacheEntity.DATA);
                                            String strOptString3 = jSONObject2.optString("seq");
                                            if (iOptInt == 100) {
                                                String strA2 = v.a();
                                                String strDecode = URLDecoder.decode(v.b(strOptString2, strA2.substring(0, 16), strA2.substring(16, 32)), Constants.ENC_UTF_8);
    ...
    */
    public com.unicom.online.account.shield.UniAccountHelper init(android.content.Context r4, java.lang.String r5, boolean r6) {
        ...
        L51:
            r6 = 0
            com.mobile.auth.z.p.a = r6     // Catch: java.lang.Exception -> L8b java.lang.Throwable -> L99
            android.content.Context r4 = r4.getApplicationContext()     // Catch: java.lang.Exception -> L8b java.lang.Throwable -> L99
            r1.a = r4     // Catch: java.lang.Exception -> L8b java.lang.Throwable -> L99
            ...
            android.content.Context r4 = r1.a     // Catch: java.lang.Exception -> L8b java.lang.Throwable -> L99
            ...
            java.lang.String r6 = com.mobile.auth.z.u.a     // Catch: java.lang.Exception -> L8b java.lang.Throwable -> L99
        ...
        L94:
            com.mobile.auth.z.b.a = r5     // Catch: java.lang.Throwable -> L99
