...
public final class ai {
    ...
    public final long a(boolean z) {
        ...
        al.c("[UploadManager] Local network consume: %d KB", Long.valueOf(jD / ConstantsAPI.AppSupportContentFlag.MMAPP_SUPPORT_XLS));
        return jD;
    }
    ...
    protected final synchronized void a(long j, boolean z) {
        ...
        al.c("[UploadManager] Network total consume: %d KB", Long.valueOf(j / ConstantsAPI.AppSupportContentFlag.MMAPP_SUPPORT_XLS));
    }
