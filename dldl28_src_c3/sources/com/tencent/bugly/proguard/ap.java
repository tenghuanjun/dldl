...
public final class ap {
    ...
    public static byte[] a(String str, String str2) {
        ...
        try {
            ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(str.getBytes(Constants.ENC_UTF_8));
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    byte[] bArr = new byte[Math.max(Constant.DEFAULT_TIMEOUT, Priority.UI_NORMAL)];
                    while (true) {
