    ...
    private synchronized void a(boolean z) {
        ...
        if (this.j) {
            ...
            try {
                ...
                String str = (String) ap.a("com.tencent.feedback.eup.jni.NativeExceptionUpload", "registNativeExceptionHandler2", new Class[]{String.class, String.class, cls, cls}, new Object[]{a, ab.d(), Integer.valueOf(z ? 1 : 5), 1});
                if (str == null) {
                    Class[] clsArr = {String.class, String.class, Integer.TYPE};
                    String strD = ab.d();
                    aa.b();
                    str = (String) ap.a("com.tencent.feedback.eup.jni.NativeExceptionUpload", "registNativeExceptionHandler", clsArr, new Object[]{a, strD, Integer.valueOf(aa.B())});
                }
                if (str != null) {
                    this.k = true;
                    this.e.u = str;
