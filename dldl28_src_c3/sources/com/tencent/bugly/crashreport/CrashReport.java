...
public class CrashReport {
    ...
    public static void putUserData(Context context, String str, String str2) {
        ...
        if (str2.length() > 200) {
            al.d("user data value length over limit %d, it will be cutted!", Integer.valueOf(KeyBoardKey.KeyboardKeyGamepadLeftShoulder));
            str2 = str2.substring(0, KeyBoardKey.KeyboardKeyGamepadLeftShoulder);
        }
        aa aaVarA = aa.a(context);
    ...
    private static void putSdkData(Context context, String str, String str2) {
        ...
        if (str2.length() > 500) {
            Log.w(al.b, String.format("putSdkData value length over limit %d, will be cutted!", Integer.valueOf(KeyBoardKey.KeyboardKeyGamepadLeftShoulder)));
            str2 = str2.substring(0, KeyBoardKey.KeyboardKeyGamepadLeftShoulder);
        }
