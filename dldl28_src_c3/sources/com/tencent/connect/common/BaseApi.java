...
public abstract class BaseApi {
    ...
    protected void a(StringBuilder sb, Activity activity) {
        ...
        a(sb, Constants.JumpUrlConstants.URL_KEY_SDK_VERSION, m.k(Constants.SDK_VERSION));
    }
    ...
    protected void a(Fragment fragment, Intent intent, int i, Map<String, Object> map) {
        intent.putExtra(Constants.KEY_REQUEST_CODE, i);
        try {
            fragment.startActivityForResult(a((Activity) fragment.getActivity(), intent, map, i), i);
        } catch (Exception e) {
            SLog.e("openSDK_LOG.BaseApi", "startAssitActivity exception", e);
        }
    }
    ...
    private void a(Activity activity, Intent intent, Intent intent2, int i) {
        ...
        try {
            ...
            intent.putExtra(AssistActivity.KEY_EXTRA_PENDING_INTENT, Build.VERSION.SDK_INT >= 23 ? PendingIntent.getActivity(activity, i, intent2, 1140850688) : PendingIntent.getActivity(activity, i, intent2, 1073741824));
        } catch (Throwable th2) {
