...
public class a extends Dialog {
    ...
    /* JADX INFO: compiled from: ProGuard */
    private class C0191a extends WebViewClient {
        private C0191a() {
        }
    ...
    private void c() {
        ...
        if (this.i.equals("action_login")) {
            ...
            textView.setTextColor(Color.rgb(KotlinVersion.MAX_COMPONENT_VALUE, KotlinVersion.MAX_COMPONENT_VALUE, KotlinVersion.MAX_COMPONENT_VALUE));
    ...
    private void d() {
        ...
        this.j.setWebViewClient(new C0191a());
    ...
    public static void b(Context context, String str) {
        try {
            ...
            Toast.makeText(context.getApplicationContext(), jSONObjectD.getString(SocialConstants.PARAM_SEND_MSG), i).show();
        } catch (JSONException e) {
            e.printStackTrace();
        }
    }
