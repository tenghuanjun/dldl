...
public class d extends com.tencent.open.c implements a.InterfaceC0197a {
    static Toast c;
    private String d;
    ...
    public d(Context context, String str, String str2, IUiListener iUiListener, QQToken qQToken) {
        ...
        this.g = new HandlerC0198d(this.f, context.getMainLooper());
        this.e = iUiListener;
    ...
    /* JADX INFO: compiled from: ProGuard */
    private class b extends b.C0196b {
        private b() {
        }
    }
    ...
    /* JADX INFO: compiled from: ProGuard */
    private class HandlerC0198d extends Handler {
        private c b;

        public HandlerC0198d(c cVar, Looper looper) {
            super(looper);
            this.b = cVar;
        }
    ...
    @Override // com.tencent.open.c.a.InterfaceC0197a
    public void a(int i) {
        WeakReference<Context> weakReference = this.j;
        if (weakReference != null && weakReference.get() != null) {
