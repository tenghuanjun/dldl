...
public class a {
    ...
    private void a(Context context) throws Exception {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            keyPairGenerator.initialize(x$.ExternalSyntheticApiModelOutline0.m(x$.ExternalSyntheticApiModelOutline0.m$2(x$.ExternalSyntheticApiModelOutline0.m(x$.ExternalSyntheticApiModelOutline0.m("KEYSTORE_AES", 3), new String[]{"SHA-256", "SHA-512"}), new String[]{"PKCS1Padding"})));
