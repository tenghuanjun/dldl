...
public class SocialOperation extends BaseApi {
    ...
    public void unBindGroup(Context context, String str, final IUiListener iUiListener) {
        ...
        if (context == null) {
            ...
            if (iUiListener != null) {
                iUiListener.onError(new UiError(Constant.LOGIN_SUCCESS_CODE, "param acitivty is null", "activity param of api can not be null."));
                return;
            }
            return;
        }
    ...
    public void joinGroup(final Activity activity, String str, final IUiListener iUiListener) {
        ...
        if (TextUtils.isEmpty(openId)) {
            ...
            if (iUiListener != null) {
                iUiListener.onError(new UiError(CrashModule.MODULE_ID, "openid is null", "openid is null, please login."));
                return;
            }
            return;
        }
    ...
    public void bindQQGroup(final Activity activity, String str, String str2, final IUiListener iUiListener) {
        ...
        if (TextUtils.isEmpty(openId)) {
            ...
            if (iUiListener != null) {
                iUiListener.onError(new UiError(CrashModule.MODULE_ID, "openid params is null", "please login."));
                return;
            }
            return;
        }
