        ...
        if (context == null || c0193a == null) {
            ...
            if (!b.b(c0193a.b)) {
                if (b.b(c0193a.a)) {
                    ...
                    str2 = c0193a.a + ".permission.MM_MESSAGE";
                }
                Intent intent = new Intent(c0193a.b);
                Bundle bundle = c0193a.e;
                if (bundle != null) {
                ...
                intent.putExtra(ConstantsAPI.CONTENT, c0193a.c);
                intent.putExtra(ConstantsAPI.APP_SUPORT_CONTENT_TYPE, c0193a.d);
                intent.putExtra(ConstantsAPI.CHECK_SUM, a(c0193a.c, Build.SDK_INT, packageName));
