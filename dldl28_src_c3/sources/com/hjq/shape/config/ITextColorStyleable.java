...
public interface ITextColorStyleable {
    ...
    /* JADX INFO: renamed from: com.hjq.shape.config.ITextColorStyleable$-CC, reason: invalid class name */
    public final /* synthetic */ class CC {
        public static int $default$getTextCheckedColorStyleable(ITextColorStyleable _this) {
            return 0;
        }
    }
