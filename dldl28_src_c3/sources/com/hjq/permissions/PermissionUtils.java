...
final class PermissionUtils {
    ...
    static boolean checkSelfPermission(Context context, String str) {
        return NotificationCompat$.ExternalSyntheticApiModelOutline0.m(context, str) == 0;
    }
    ...
    static boolean checkOpNoThrow(Context context, String str) {
        ...
        if (AndroidVersion.isAndroid10()) {
            iCheckOpNoThrow = x$.ExternalSyntheticApiModelOutline0.m(appOpsManager, str, context.getApplicationInfo().uid, context.getPackageName());
        } else {
    ...
    static boolean shouldShowRequestPermissionRationale(Activity activity, String str) {
        ...
        return x$.ExternalSyntheticApiModelOutline0.m(activity, str);
    }
    ...
    static boolean isActivityReverse(Activity activity) {
        ...
        if (AndroidVersion.isAndroid11()) {
            rotation = x$.ExternalSyntheticApiModelOutline0.m(activity).getRotation();
        } else {
    ...
    static boolean areActivityIntent(Context context, Intent intent) {
        ...
        if (AndroidVersion.isAndroid13()) {
            return !x$.ExternalSyntheticApiModelOutline0.m(packageManager, intent, x$.ExternalSyntheticApiModelOutline0.m(65536L)).isEmpty();
        }
        return !packageManager.queryIntentActivities(intent, WXMediaMessage.THUMB_LENGTH_LIMIT).isEmpty();
    }
