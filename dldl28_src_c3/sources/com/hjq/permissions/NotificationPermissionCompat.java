...
final class NotificationPermissionCompat {
    ...
    static boolean isGrantedPermission(Context context) {
        if (AndroidVersion.isAndroid7()) {
            return x$.ExternalSyntheticApiModelOutline0.m((NotificationManager) ComponentDialog$.ExternalSyntheticApiModelOutline0.m(context, NotificationManager.class));
        }
