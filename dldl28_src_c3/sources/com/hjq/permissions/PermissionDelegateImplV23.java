...
class PermissionDelegateImplV23 extends PermissionDelegateImplV21 {
    ...
    private static boolean isGrantedSettingPermission(Context context) {
        if (AndroidVersion.isAndroid6()) {
            return x$.ExternalSyntheticApiModelOutline0.m(context);
        }
        return true;
    }
    ...
    private static boolean isGrantedNotDisturbPermission(Context context) {
        return x$.ExternalSyntheticApiModelOutline0.m$1((NotificationManager) ComponentDialog$.ExternalSyntheticApiModelOutline0.m(context, NotificationManager.class));
    }
    ...
    private static boolean isGrantedIgnoreBatteryPermission(Context context) {
        return x$.ExternalSyntheticApiModelOutline0.m((PowerManager) ComponentDialog$.ExternalSyntheticApiModelOutline0.m(context, PowerManager.class), context.getPackageName());
    }
