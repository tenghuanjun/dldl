...
public class DefaultCachePolicy<T> extends BaseCachePolicy<T> {
    ...
    public boolean onAnalysisResponse(Call call, okhttp3.Response response) {
        ...
        if (this.cacheEntity == null) {
            final Response responseError = Response.error(true, call, response, CacheException.NON_AND_304(this.request.getCacheKey()));
            ...
            final Response responseSuccess = Response.success(true, this.cacheEntity.getData(), call, response);
    ...
    public Response<T> requestSync(CacheEntity<T> cacheEntity) {
        try {
            ...
            if (cacheEntity == null) {
                return Response.error(true, this.rawCall, responseRequestNetworkSync.getRawResponse(), CacheException.NON_AND_304(this.request.getCacheKey()));
            }
            return Response.success(true, cacheEntity.getData(), this.rawCall, responseRequestNetworkSync.getRawResponse());
        } catch (Throwable th) {
