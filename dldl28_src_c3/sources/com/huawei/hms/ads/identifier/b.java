...
public class b {
    private static final Uri a = new Uri.Builder().scheme(DBHelpTool.RecordEntry.COLUMN_NAME_CONTENT).authority("com.huawei.hwid.pps.apiprovider").path("/oaid_scp/get").build();
