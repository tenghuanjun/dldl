...
public final class BehaviorProcessor<T> extends FlowableProcessor<T> {
    ...
    public void onError(Throwable t) {
        ...
        if (!ComplexDouble$.ExternalSyntheticBackport0.m(this.terminalEvent, (Object) null, t)) {
    ...
    public void onComplete() {
        if (ComplexDouble$.ExternalSyntheticBackport0.m(this.terminalEvent, (Object) null, ExceptionHelper.TERMINATED)) {
    ...
    boolean add(BehaviorSubscription<T> rs) {
        ...
        } while (!ComplexDouble$.ExternalSyntheticBackport0.m(this.subscribers, behaviorSubscriptionArr, behaviorSubscriptionArr2));
        return true;
    }
