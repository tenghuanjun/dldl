...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    public final CompletionStage<T> toCompletionStage() {
        return l$$ExternalSyntheticApiModelOutline0.m113m((Object) subscribeWith(new CompletionStageConsumer(false, null)));
    }

    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final CompletionStage<T> toCompletionStage(T defaultItem) {
        return l$$ExternalSyntheticApiModelOutline0.m113m((Object) subscribeWith(new CompletionStageConsumer(true, defaultItem)));
    }
