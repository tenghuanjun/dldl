...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    public final CompletionStage<T> firstStage(T defaultItem) {
        return l$$ExternalSyntheticApiModelOutline0.m113m((Object) subscribeWith(new ObservableFirstStageObserver(true, defaultItem)));
    }

    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final CompletionStage<T> singleStage(T defaultItem) {
        return l$$ExternalSyntheticApiModelOutline0.m113m((Object) subscribeWith(new ObservableSingleStageObserver(true, defaultItem)));
    }

    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final CompletionStage<T> lastStage(T defaultItem) {
        return l$$ExternalSyntheticApiModelOutline0.m113m((Object) subscribeWith(new ObservableLastStageObserver(true, defaultItem)));
    }

    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final CompletionStage<T> firstOrErrorStage() {
        return l$$ExternalSyntheticApiModelOutline0.m113m((Object) subscribeWith(new ObservableFirstStageObserver(false, null)));
    }

    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final CompletionStage<T> singleOrErrorStage() {
        return l$$ExternalSyntheticApiModelOutline0.m113m((Object) subscribeWith(new ObservableSingleStageObserver(false, null)));
    }

    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final CompletionStage<T> lastOrErrorStage() {
        return l$$ExternalSyntheticApiModelOutline0.m113m((Object) subscribeWith(new ObservableLastStageObserver(false, null)));
    }
