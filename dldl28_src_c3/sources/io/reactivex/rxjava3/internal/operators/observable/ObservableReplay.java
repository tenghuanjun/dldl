...
public final class ObservableReplay<T> extends ConnectableObservable<T> implements HasUpstreamObservableSource<T> {
    ...
    public void reset() {
        ...
        ComplexDouble$.ExternalSyntheticBackport0.m(this.current, replayObserver, (Object) null);
    }
    ...
    public void connect(Consumer<? super Disposable> connection) {
        ...
        while (true) {
            ...
            if (ComplexDouble$.ExternalSyntheticBackport0.m(this.current, replayObserver, replayObserver2)) {
    ...
    static final class ReplayObserver<T> extends AtomicReference<Disposable> implements Observer<T>, Disposable {
        ...
        boolean add(InnerDisposable<T> producer) {
            ...
            } while (!ComplexDouble$.ExternalSyntheticBackport0.m(this.observers, innerDisposableArr, innerDisposableArr2));
            return true;
        }
    ...
    static final class ReplaySource<T> implements ObservableSource<T> {
        ...
        public void subscribe(Observer<? super T> child) {
            ...
            while (true) {
                ...
                ReplayObserver<T> replayObserver2 = new ReplayObserver<>(this.bufferFactory.call());
                if (ComplexDouble$.ExternalSyntheticBackport0.m(this.curr, (Object) null, replayObserver2)) {
                    replayObserver = replayObserver2;
                    break;
                }
            }
