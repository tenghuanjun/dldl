        ...
        SlotPair<T> addValue(T value) {
            ...
            while (true) {
                ...
                if (slotPair == null) {
                    ...
                    if (!ComplexDouble$.ExternalSyntheticBackport0.m(this.current, (Object) null, slotPair)) {
                        continue;
                    }
                }
                ...
                ComplexDouble$.ExternalSyntheticBackport0.m(this.current, slotPair, (Object) null);
            }
            if (iTryAcquireSlot == 0) {
