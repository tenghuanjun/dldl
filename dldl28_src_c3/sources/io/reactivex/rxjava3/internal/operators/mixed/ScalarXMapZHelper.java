...
final class ScalarXMapZHelper {
    ...
    static <T> boolean tryAsCompletable(Object obj, Function<? super T, ? extends CompletableSource> function, CompletableObserver completableObserver) {
        ...
        try {
            R.bool boolVar = (Object) ((Supplier) obj).get();
            CompletableSource completableSource = boolVar != null ? (CompletableSource) Objects.requireNonNull(function.apply(boolVar), "The mapper returned a null CompletableSource") : null;
    ...
    static <T, R> boolean tryAsMaybe(Object obj, Function<? super T, ? extends MaybeSource<? extends R>> function, Observer<? super R> observer) {
        ...
        try {
            R.bool boolVar = (Object) ((Supplier) obj).get();
            MaybeSource maybeSource = boolVar != null ? (MaybeSource) Objects.requireNonNull(function.apply(boolVar), "The mapper returned a null MaybeSource") : null;
            if (maybeSource == null) {
    ...
    static <T, R> boolean tryAsSingle(Object obj, Function<? super T, ? extends SingleSource<? extends R>> function, Observer<? super R> observer) {
        ...
        try {
            R.bool boolVar = (Object) ((Supplier) obj).get();
            SingleSource singleSource = boolVar != null ? (SingleSource) Objects.requireNonNull(function.apply(boolVar), "The mapper returned a null SingleSource") : null;
