    ...
    static final class SwitchMapSingleMainObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public void onNext(T t) {
            ...
            try {
                ...
                } while (!ComplexDouble$.ExternalSyntheticBackport0.m(this.inner, switchMapSingleObserver, switchMapSingleObserver3));
        ...
        void innerError(SwitchMapSingleObserver<R> sender, Throwable ex) {
            if (ComplexDouble$.ExternalSyntheticBackport0.m(this.inner, sender, (Object) null)) {
        ...
        void drain() {
            ...
            while (!this.cancelled) {
                ...
                if (z && z2) {
                    ...
                    ComplexDouble$.ExternalSyntheticBackport0.m(atomicReference, switchMapSingleObserver, (Object) null);
