    ...
    static final class SwitchMapCompletableObserver<T> implements FlowableSubscriber<T>, Disposable {
        ...
        public void onNext(T t) {
            ...
            try {
                ...
                } while (!ComplexDouble$.ExternalSyntheticBackport0.m(this.inner, switchMapInnerObserver, switchMapInnerObserver2));
        ...
        void innerComplete(SwitchMapInnerObserver sender) {
            if (ComplexDouble$.ExternalSyntheticBackport0.m(this.inner, sender, (Object) null) && this.done) {
                this.errors.tryTerminateConsumer(this.downstream);
            }
        }
