...
public final class FutureMultiObserver<T> extends CountDownLatch implements MaybeObserver<T>, SingleObserver<T>, CompletableObserver, Future<T>, Disposable {
    ...
    public void onSuccess(T t) {
        ...
        this.value = t;
        ComplexDouble$.ExternalSyntheticBackport0.m(this.upstream, disposable, this);
        countDown();
    }
    ...
    public void onError(Throwable t) {
        ...
        do {
            ...
            this.error = t;
        } while (!ComplexDouble$.ExternalSyntheticBackport0.m(this.upstream, disposable, this));
        countDown();
    }
