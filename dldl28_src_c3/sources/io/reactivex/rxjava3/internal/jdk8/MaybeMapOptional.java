...
public final class MaybeMapOptional<T, R> extends Maybe<R> {
    ...
    static final class MapOptionalMaybeObserver<T, R> implements MaybeObserver<T>, Disposable {
        ...
        public void onSuccess(T t) {
            try {
                Optional optionalM112m = l$$ExternalSyntheticApiModelOutline0.m112m(Objects.requireNonNull(this.mapper.apply(t), "The mapper returned a null item"));
                if (optionalM112m.isPresent()) {
                    this.downstream.onSuccess((Object) optionalM112m.get());
                } else {
