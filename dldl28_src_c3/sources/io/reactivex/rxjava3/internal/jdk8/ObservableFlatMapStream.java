...
public final class ObservableFlatMapStream<T, R> extends Observable<R> {
    ...
    protected void subscribeActual(Observer<? super R> observer) {
        ...
        if (observable instanceof Supplier) {
            try {
                ...
                if (streamM118m != null) {
                    ObservableFromStream.subscribeStream(observer, streamM118m);
                    return;
                } else {
    ...
    static final class FlatMapStreamObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public void onNext(T t) {
            ...
            try {
                Stream streamM118m = l$$ExternalSyntheticApiModelOutline0.m118m(Objects.requireNonNull(this.mapper.apply(t), "The mapper returned a null Stream"));
                try {
                    Iterator it = streamM118m.iterator();
                    while (true) {
                        if (!it.hasNext()) {
                            break;
                        }
