...
public final class UIntArray implements Collection<UInt>, KMappedMarker {
    ...
    public static final /* synthetic */ UIntArray m288boximpl(int[] iArr) {
        return new UIntArray(iArr);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int[] m290constructorimpl(int[] iArr) {
        Intrinsics.checkNotNullParameter(iArr, "storage");
        return iArr;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m293equalsimpl(int[] iArr, Object obj) {
        return (obj instanceof UIntArray) && Intrinsics.areEqual(iArr, ((UIntArray) obj).getStorage());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m294equalsimpl0(int[] iArr, int[] iArr2) {
    ...
    public static int m297hashCodeimpl(int[] iArr) {
        return Arrays.hashCode(iArr);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m301toStringimpl(int[] iArr) {
    ...
    public boolean m302addWZ4Q5Ns(int i) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UInt) {
            return m303containsWZ4Q5Ns(((UInt) obj).getData());
        }
        return false;
    }
    ...
    public static int[] m289constructorimpl(int i) {
        return m290constructorimpl(new int[i]);
    }

    /* JADX INFO: renamed from: get-pVg5ArA, reason: not valid java name */
    public static final int m295getpVg5ArA(int[] iArr, int i) {
        return UInt.m235constructorimpl(iArr[i]);
    }

    /* JADX INFO: renamed from: set-VXSXFK8, reason: not valid java name */
    public static final void m300setVXSXFK8(int[] iArr, int i, int i2) {
        iArr[i] = i2;
    }

    /* JADX INFO: renamed from: getSize-impl, reason: not valid java name */
    public static int m296getSizeimpl(int[] iArr) {
        return iArr.length;
    }
    ...
    public static java.util.Iterator<UInt> m299iteratorimpl(int[] iArr) {
    ...
    private static final class Iterator implements java.util.Iterator<UInt>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ UInt next() {
            return UInt.m229boximpl(m305nextpVg5ArA());
        }
    ...
    public boolean m303containsWZ4Q5Ns(int i) {
        return m291containsWZ4Q5Ns(this.storage, i);
    }

    /* JADX INFO: renamed from: contains-WZ4Q5Ns, reason: not valid java name */
    public static boolean m291containsWZ4Q5Ns(int[] iArr, int i) {
    ...
    public boolean containsAll(Collection<? extends Object> collection) {
        ...
        return m292containsAllimpl(this.storage, collection);
    }

    /* JADX INFO: renamed from: containsAll-impl, reason: not valid java name */
    public static boolean m292containsAllimpl(int[] iArr, Collection<UInt> collection) {
        Intrinsics.checkNotNullParameter(collection, "elements");
    ...
    public static boolean m298isEmptyimpl(int[] iArr) {
