...
public final class ResultKt {
    ...
    private static final <R> Object runCatching(Function0<? extends R> function0) {
        ...
        try {
            ...
            return Result.m139constructorimpl(function0.invoke());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m139constructorimpl(createFailure(th));
        }
    }
    ...
    private static final <T, R> Object runCatching(T t, Function1<? super T, ? extends R> function1) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.m139constructorimpl(function1.invoke(t));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m139constructorimpl(createFailure(th));
        }
    ...
    private static final <R, T extends R> R getOrElse(Object obj, Function1<? super Throwable, ? extends R> function1) {
        ...
        Throwable thM142exceptionOrNullimpl = Result.m142exceptionOrNullimpl(obj);
        return thM142exceptionOrNullimpl == null ? obj : (R) function1.invoke(thM142exceptionOrNullimpl);
    }

    /* JADX WARN: Multi-variable type inference failed */
    private static final <R, T extends R> R getOrDefault(Object obj, R r) {
        return Result.m145isFailureimpl(obj) ? r : obj;
    }
    ...
    private static final <R, T> R fold(Object obj, Function1<? super T, ? extends R> function1, Function1<? super Throwable, ? extends R> function12) {
        ...
        Throwable thM142exceptionOrNullimpl = Result.m142exceptionOrNullimpl(obj);
        if (thM142exceptionOrNullimpl == null) {
            return (R) function1.invoke(obj);
        }
        return (R) function12.invoke(thM142exceptionOrNullimpl);
    }

    private static final <R, T> Object map(Object obj, Function1<? super T, ? extends R> function1) {
        Intrinsics.checkNotNullParameter(function1, "transform");
        if (!Result.m146isSuccessimpl(obj)) {
            return Result.m139constructorimpl(obj);
        }
        Result.Companion companion = Result.INSTANCE;
        return Result.m139constructorimpl(function1.invoke(obj));
    }
    ...
    private static final <R, T extends R> Object recover(Object obj, Function1<? super Throwable, ? extends R> function1) {
        ...
        Result.Companion companion = Result.INSTANCE;
        return Result.m139constructorimpl(function1.invoke(thM142exceptionOrNullimpl));
    }
    ...
    private static final <T> Object onFailure(Object obj, Function1<? super Throwable, Unit> function1) {
        ...
        Throwable thM142exceptionOrNullimpl = Result.m142exceptionOrNullimpl(obj);
        if (thM142exceptionOrNullimpl != null) {
            function1.invoke(thM142exceptionOrNullimpl);
        }
        return obj;
    }
