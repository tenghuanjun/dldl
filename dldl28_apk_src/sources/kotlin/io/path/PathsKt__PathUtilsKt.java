...
class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    public static final List<Path> listDirectoryEntries(Path path, String glob) throws IOException {
        ...
        try {
            DirectoryStream directoryStreamM = l$$ExternalSyntheticApiModelOutline0.m((Object) directoryStreamNewDirectoryStream);
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesViewOrNull(Path path, LinkOption... options) {
        ...
        return (V) Files.getFileAttributeView(path, Headers$$ExternalSyntheticApiModelOutline0.m8367m(), (LinkOption[]) Arrays.copyOf(options, options.length));
    }
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesView(Path path, LinkOption... options) {
        ...
        Intrinsics.checkNotNullParameter(options, "options");
        Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_MEASUREMENT_INTERRUPTED);
        FileAttributeView fileAttributeView = Files.getFileAttributeView(path, Headers$$ExternalSyntheticApiModelOutline0.m8367m(), (LinkOption[]) Arrays.copyOf(options, options.length));
        if (fileAttributeView != null) {
            return (V) Headers$$ExternalSyntheticApiModelOutline0.m8371m((Object) fileAttributeView);
        }
        Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_MEASUREMENT_INTERRUPTED);
        PathsKt.fileAttributeViewNotAvailable(path, Headers$$ExternalSyntheticApiModelOutline0.m8367m());
    ...
    private static final /* synthetic */ <A extends BasicFileAttributes> A readAttributes(Path path, LinkOption... options) throws IOException {
        ...
        BasicFileAttributes attributes = Files.readAttributes(path, (Class<BasicFileAttributes>) l$$ExternalSyntheticApiModelOutline0.m(), (LinkOption[]) Arrays.copyOf(options, options.length));
        Intrinsics.checkNotNullExpressionValue(attributes, "readAttributes(...)");
        return (A) l$$ExternalSyntheticApiModelOutline0.m6716m((Object) attributes);
    }
