...
public class b implements Runnable {
    ...
    public String c(Map<String, String> map) {
        ...
        if (!TextUtils.equals(map.get("ping_hot_host"), "0") && !TextUtils.equals(map.get("ping_hot_ip"), "0")) {
            ...
            if ((this.f.containsKey("master_host") && !this.f.containsKey("host")) || this.f.containsKey("dns_resolver")) {
    ...
    public void d(Map<String, String> map) {
        if (this.d.isEmpty()) {
            a(new com.volcengine.b.b(this.f1104a, map, this.f, this.h));
            a(new c(this.f1104a, map, this.f, this.c, this.h));
        }
    }
