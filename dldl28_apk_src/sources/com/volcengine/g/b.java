...
public class b implements IJsonConverter {
    ...
    private final Gson f1139a = new Gson().newBuilder().registerTypeAdapter(Double.class, a()).registerTypeAdapter(Float.class, b()).create();
    ...
    class C0449b extends TypeAdapter<Number> {
        C0449b(b bVar) {
        }
    ...
    public <T> T fromJson(String str, Class<T> cls) {
        ...
        try {
            return (T) this.f1139a.fromJson(str, (Class) cls);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public <T> T fromJson(String str, Type type) {
        try {
            return (T) this.f1139a.fromJson(str, type);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
