...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    private int modifiers = KeyBoardKey.KeyboardKeyNavigationView;
    ...
    public Excluder withVersion(double d) {
        Excluder excluderM6682clone = m6682clone();
        excluderM6682clone.version = d;
        return excluderM6682clone;
    }

    public Excluder withModifiers(int... iArr) {
        Excluder excluderM6682clone = m6682clone();
        excluderM6682clone.modifiers = 0;
        for (int i : iArr) {
            excluderM6682clone.modifiers = i | excluderM6682clone.modifiers;
        }
        return excluderM6682clone;
    }
    ...
    public Excluder disableInnerClassSerialization() {
        Excluder excluderM6682clone = m6682clone();
        excluderM6682clone.serializeInnerClasses = false;
        return excluderM6682clone;
    }

    public Excluder excludeFieldsWithoutExposeAnnotation() {
        Excluder excluderM6682clone = m6682clone();
        excluderM6682clone.requireExpose = true;
        return excluderM6682clone;
    }
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z, boolean z2) {
        ...
        if (z) {
            ...
            excluderM6682clone.serializationStrategies = arrayList;
            arrayList.add(exclusionStrategy);
        }
        if (z2) {
            ArrayList arrayList2 = new ArrayList(this.deserializationStrategies);
            excluderM6682clone.deserializationStrategies = arrayList2;
