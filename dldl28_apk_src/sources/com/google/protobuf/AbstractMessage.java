...
public abstract class AbstractMessage extends AbstractMessageLite implements Message {
    ...
    private static Map convertMapEntryListToMap(List list) {
        ...
        Descriptors.FieldDescriptor fieldDescriptorFindFieldByName = descriptorForType.findFieldByName(CacheEntity.KEY);
        Descriptors.FieldDescriptor fieldDescriptorFindFieldByName2 = descriptorForType.findFieldByName(DBHelper.COL_VALUE);
