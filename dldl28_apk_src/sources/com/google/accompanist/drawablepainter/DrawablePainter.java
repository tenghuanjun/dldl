...
public final class DrawablePainter extends Painter implements RememberObserver {
    ...
    public DrawablePainter(Drawable drawable) {
        ...
        this.drawableIntrinsicSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m3276boximpl(DrawablePainterKt.getIntrinsicSize(drawable)), null, 2, null);
            ...
            public final AnonymousClass1 invoke() {
                ...
                return new Drawable.Callback() { // from class: com.google.accompanist.drawablepainter.DrawablePainter$callback$2.1
                    ...
                    public void invalidateDrawable(Drawable d) {
                        ...
                        drawablePainter3.m6681setDrawableIntrinsicSizeuvyYCjk(DrawablePainterKt.getIntrinsicSize(drawablePainter3.getDrawable()));
                    }
    ...
    private final long m6680getDrawableIntrinsicSizeNHjbRc() {
    ...
    public final void m6681setDrawableIntrinsicSizeuvyYCjk(long j) {
        this.drawableIntrinsicSize.setValue(Size.m3276boximpl(j));
    }
    ...
    public long getIntrinsicSize() {
        return m6680getDrawableIntrinsicSizeNHjbRc();
    }
    ...
    protected void onDraw(DrawScope drawScope) {
        ...
        this.drawable.setBounds(0, 0, MathKt.roundToInt(Size.m3288getWidthimpl(drawScope.mo3973getSizeNHjbRc())), MathKt.roundToInt(Size.m3285getHeightimpl(drawScope.mo3973getSizeNHjbRc())));
        try {
            canvas.save();
