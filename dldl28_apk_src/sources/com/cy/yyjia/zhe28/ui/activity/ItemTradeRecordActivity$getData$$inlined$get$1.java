...
@DebugMetadata(c = "com.cy.yyjia.zhe28.ui.activity.ItemTradeRecordActivity$getData$$inlined$get$1", f = "ItemTradeRecordActivity.kt", i = {}, l = {382}, m = "invokeSuspend", n = {}, s = {})
public final class ItemTradeRecordActivity$getData$$inlined$get$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ Map $param;
    final /* synthetic */ String $url;
    int label;
    final /* synthetic */ ItemTradeRecordActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ItemTradeRecordActivity$getData$$inlined$get$1(String str, Map map, Continuation continuation, ItemTradeRecordActivity itemTradeRecordActivity, ItemTradeRecordActivity itemTradeRecordActivity2) {
        super(2, continuation);
        this.$url = str;
        this.$param = map;
        this.this$0 = itemTradeRecordActivity;
    }
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        String str = this.$url;
        Map map = this.$param;
        ItemTradeRecordActivity itemTradeRecordActivity = this.this$0;
        return new ItemTradeRecordActivity$getData$$inlined$get$1(str, map, continuation, itemTradeRecordActivity, itemTradeRecordActivity);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ItemTradeRecordActivity$getData$$inlined$get$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.cy.yyjia.zhe28.ui.activity.ItemTradeRecordActivity$getData$$inlined$get$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: NetUtil.kt */
            ...
            try {
                ...
                if (strString != null) {
                    if (responseExecute.isSuccessful()) {
                        ...
                        if (i == 200) {
                            Object objFromJson = new Gson().fromJson(strString, new TypeToken<BaseResult<PageBean<ItemTradeRecordBean>>>() { // from class: com.cy.yyjia.zhe28.ui.activity.ItemTradeRecordActivity$getData$.inlined.get.1.1.1
                            }.getType());
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (requestResult instanceof NetUtil.RequestResult.Success) {
            ...
            ItemTradeRecordActivity.access$getMBinding(this.this$0).srl.finishRefresh();
            if (this.this$0.getPage() == 1) {
                this.this$0.getAdapter().setNewInstance(pageBean.getList());
            } else {
                this.this$0.getAdapter().addData(pageBean.getList());
            }
            ItemTradeRecordActivity itemTradeRecordActivity = this.this$0;
            itemTradeRecordActivity.setPage(itemTradeRecordActivity.getPage() + 1);
            this.this$0.getPage();
            ...
            ItemTradeRecordActivity.access$getMBinding(this.this$0).srl.finishRefresh(false);
