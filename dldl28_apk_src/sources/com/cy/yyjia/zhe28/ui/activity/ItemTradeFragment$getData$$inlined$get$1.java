...
@DebugMetadata(c = "com.cy.yyjia.zhe28.ui.activity.ItemTradeFragment$getData$$inlined$get$1", f = "ItemTradeFragment.kt", i = {}, l = {382}, m = "invokeSuspend", n = {}, s = {})
public final class ItemTradeFragment$getData$$inlined$get$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ItemTradeFragment$getData$$inlined$get$1(String str, Map map, Continuation continuation, ItemTradeFragment itemTradeFragment, ItemTradeFragment itemTradeFragment2) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        return new ItemTradeFragment$getData$$inlined$get$1(str, map, continuation, itemTradeFragment, itemTradeFragment);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ItemTradeFragment$getData$$inlined$get$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (requestResult instanceof NetUtil.RequestResult.Success) {
            ...
            ItemTradeFragment itemTradeFragment = this.this$0;
            itemTradeFragment.setPage(itemTradeFragment.getPage() + 1);
            this.this$0.getPage();
    ...
    /* JADX INFO: renamed from: com.cy.yyjia.zhe28.ui.activity.ItemTradeFragment$getData$$inlined$get$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: NetUtil.kt */
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super NetUtil.RequestResult<? extends PageBean<ItemTradeBean>>>, Object> {
        final /* synthetic */ Map $param;
        final /* synthetic */ String $url;
        int label;
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super NetUtil.RequestResult<? extends PageBean<ItemTradeBean>>> continuation) {
            ...
            try {
                ...
                if (strString != null) {
                    if (responseExecute.isSuccessful()) {
                        ...
                        if (i == 200) {
                            Object objFromJson = new Gson().fromJson(strString, new TypeToken<BaseResult<PageBean<ItemTradeBean>>>() { // from class: com.cy.yyjia.zhe28.ui.activity.ItemTradeFragment$getData$.inlined.get.1.1.1
                            }.getType());
