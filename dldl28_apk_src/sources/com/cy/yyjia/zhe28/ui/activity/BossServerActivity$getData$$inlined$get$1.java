...
@DebugMetadata(c = "com.cy.yyjia.zhe28.ui.activity.BossServerActivity$getData$$inlined$get$1", f = "BossServerActivity.kt", i = {}, l = {382}, m = "invokeSuspend", n = {}, s = {})
public final class BossServerActivity$getData$$inlined$get$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ Map $param;
    final /* synthetic */ String $url;
    int label;
    final /* synthetic */ BossServerActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BossServerActivity$getData$$inlined$get$1(String str, Map map, Continuation continuation, BossServerActivity bossServerActivity, BossServerActivity bossServerActivity2) {
        super(2, continuation);
        this.$url = str;
        this.$param = map;
        this.this$0 = bossServerActivity;
    }
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        String str = this.$url;
        Map map = this.$param;
        BossServerActivity bossServerActivity = this.this$0;
        return new BossServerActivity$getData$$inlined$get$1(str, map, continuation, bossServerActivity, bossServerActivity);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((BossServerActivity$getData$$inlined$get$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.cy.yyjia.zhe28.ui.activity.BossServerActivity$getData$$inlined$get$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: NetUtil.kt */
            ...
            try {
                ...
                if (strString != null) {
                    if (responseExecute.isSuccessful()) {
                        ...
                        if (i == 200) {
                            Object objFromJson = new Gson().fromJson(strString, new TypeToken<BaseResult<BossServerBean>>() { // from class: com.cy.yyjia.zhe28.ui.activity.BossServerActivity$getData$.inlined.get.1.1.1
                            }.getType());
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (requestResult instanceof NetUtil.RequestResult.Success) {
            this.this$0.getMBinding().setData((BossServerBean) ((NetUtil.RequestResult.Success) requestResult).getData());
