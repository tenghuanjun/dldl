...
@DebugMetadata(c = "com.cy.yyjia.zhe28.ui.activity.ItemSellRecordActivity$getData$$inlined$get$1", f = "ItemSellRecordActivity.kt", i = {}, l = {382}, m = "invokeSuspend", n = {}, s = {})
public final class ItemSellRecordActivity$getData$$inlined$get$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ItemSellRecordActivity$getData$$inlined$get$1(String str, Map map, Continuation continuation, ItemSellRecordActivity itemSellRecordActivity, ItemSellRecordActivity itemSellRecordActivity2) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        return new ItemSellRecordActivity$getData$$inlined$get$1(str, map, continuation, itemSellRecordActivity, itemSellRecordActivity);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ItemSellRecordActivity$getData$$inlined$get$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.cy.yyjia.zhe28.ui.activity.ItemSellRecordActivity$getData$$inlined$get$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: NetUtil.kt */
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super NetUtil.RequestResult<? extends PageBean<ItemSellRecordBean>>>, Object> {
        final /* synthetic */ Map $param;
        final /* synthetic */ String $url;
        int label;
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super NetUtil.RequestResult<? extends PageBean<ItemSellRecordBean>>> continuation) {
            ...
            try {
                ...
                if (strString != null) {
                    if (responseExecute.isSuccessful()) {
                        ...
                        if (i == 200) {
                            Object objFromJson = new Gson().fromJson(strString, new TypeToken<BaseResult<PageBean<ItemSellRecordBean>>>() { // from class: com.cy.yyjia.zhe28.ui.activity.ItemSellRecordActivity$getData$.inlined.get.1.1.1
                            }.getType());
