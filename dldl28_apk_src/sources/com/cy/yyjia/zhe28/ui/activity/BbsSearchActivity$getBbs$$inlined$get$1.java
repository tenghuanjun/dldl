...
@DebugMetadata(c = "com.cy.yyjia.zhe28.ui.activity.BbsSearchActivity$getBbs$$inlined$get$1", f = "BbsSearchActivity.kt", i = {}, l = {382}, m = "invokeSuspend", n = {}, s = {})
public final class BbsSearchActivity$getBbs$$inlined$get$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ Map $param;
    final /* synthetic */ String $url;
    int label;
    final /* synthetic */ BbsSearchActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BbsSearchActivity$getBbs$$inlined$get$1(String str, Map map, Continuation continuation, BbsSearchActivity bbsSearchActivity, BbsSearchActivity bbsSearchActivity2) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        return new BbsSearchActivity$getBbs$$inlined$get$1(str, map, continuation, bbsSearchActivity, bbsSearchActivity);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((BbsSearchActivity$getBbs$$inlined$get$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.cy.yyjia.zhe28.ui.activity.BbsSearchActivity$getBbs$$inlined$get$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: NetUtil.kt */
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super NetUtil.RequestResult<? extends PageBean<BbsBean>>>, Object> {
        final /* synthetic */ Map $param;
        final /* synthetic */ String $url;
        int label;
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super NetUtil.RequestResult<? extends PageBean<BbsBean>>> continuation) {
            ...
            try {
                ...
                if (strString != null) {
                    if (responseExecute.isSuccessful()) {
                        ...
                        if (i == 200) {
                            Object objFromJson = new Gson().fromJson(strString, new TypeToken<BaseResult<PageBean<BbsBean>>>() { // from class: com.cy.yyjia.zhe28.ui.activity.BbsSearchActivity$getBbs$.inlined.get.1.1.1
                            }.getType());
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (requestResult instanceof NetUtil.RequestResult.Success) {
            ...
            if (this.this$0.getPage() == 1) {
                this.this$0.getBbsAdapter().setNewInstance(pageBean.getList());
            } else {
                this.this$0.getBbsAdapter().addData(pageBean.getList());
            }
            BbsSearchActivity bbsSearchActivity = this.this$0;
            bbsSearchActivity.setPage(bbsSearchActivity.getPage() + 1);
            this.this$0.getPage();
            if (pageBean.getCurrent_page() >= pageBean.getLast_page()) {
                BaseLoadMoreModule.loadMoreEnd$default(this.this$0.getBbsAdapter().getLoadMoreModule(), false, 1, null);
            } else {
                this.this$0.getBbsAdapter().getLoadMoreModule().loadMoreComplete();
            }
        } else if (requestResult instanceof NetUtil.RequestResult.Error) {
            Exception e = ((NetUtil.RequestResult.Error) requestResult).getE();
            this.this$0.getBbsAdapter().getLoadMoreModule().loadMoreFail();
