...
@DebugMetadata(c = "com.cy.yyjia.zhe28.ui.activity.PtbDetailActivity$getData$$inlined$get$1", f = "PtbDetailActivity.kt", i = {}, l = {382}, m = "invokeSuspend", n = {}, s = {})
public final class PtbDetailActivity$getData$$inlined$get$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ Map $param;
    final /* synthetic */ String $url;
    int label;
    final /* synthetic */ PtbDetailActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PtbDetailActivity$getData$$inlined$get$1(String str, Map map, Continuation continuation, PtbDetailActivity ptbDetailActivity, PtbDetailActivity ptbDetailActivity2) {
        super(2, continuation);
        this.$url = str;
        this.$param = map;
        this.this$0 = ptbDetailActivity;
    }
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        String str = this.$url;
        Map map = this.$param;
        PtbDetailActivity ptbDetailActivity = this.this$0;
        return new PtbDetailActivity$getData$$inlined$get$1(str, map, continuation, ptbDetailActivity, ptbDetailActivity);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((PtbDetailActivity$getData$$inlined$get$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (requestResult instanceof NetUtil.RequestResult.Success) {
            this.this$0.getMBinding().setData((PtbDetailBean) ((NetUtil.RequestResult.Success) requestResult).getData());
    ...
    /* JADX INFO: renamed from: com.cy.yyjia.zhe28.ui.activity.PtbDetailActivity$getData$$inlined$get$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: NetUtil.kt */
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super NetUtil.RequestResult<? extends PtbDetailBean>>, Object> {
        final /* synthetic */ Map $param;
        final /* synthetic */ String $url;
        int label;
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super NetUtil.RequestResult<? extends PtbDetailBean>> continuation) {
            ...
            try {
                ...
                if (strString != null) {
                    if (responseExecute.isSuccessful()) {
                        ...
                        if (i == 200) {
                            Object objFromJson = new Gson().fromJson(strString, new TypeToken<BaseResult<PtbDetailBean>>() { // from class: com.cy.yyjia.zhe28.ui.activity.PtbDetailActivity$getData$.inlined.get.1.1.1
                            }.getType());
