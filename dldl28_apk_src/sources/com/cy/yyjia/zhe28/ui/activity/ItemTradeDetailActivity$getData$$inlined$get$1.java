...
@DebugMetadata(c = "com.cy.yyjia.zhe28.ui.activity.ItemTradeDetailActivity$getData$$inlined$get$1", f = "ItemTradeDetailActivity.kt", i = {}, l = {382}, m = "invokeSuspend", n = {}, s = {})
public final class ItemTradeDetailActivity$getData$$inlined$get$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ItemTradeDetailActivity$getData$$inlined$get$1(String str, Map map, Continuation continuation, ItemTradeDetailActivity itemTradeDetailActivity, ItemTradeDetailActivity itemTradeDetailActivity2) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        return new ItemTradeDetailActivity$getData$$inlined$get$1(str, map, continuation, itemTradeDetailActivity, itemTradeDetailActivity);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ItemTradeDetailActivity$getData$$inlined$get$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (requestResult instanceof NetUtil.RequestResult.Success) {
            this.this$0.getMBinding().setData((ItemTradeBean) ((NetUtil.RequestResult.Success) requestResult).getData());
            this.this$0.getMBinding().et.setText("1");
    ...
    /* JADX INFO: renamed from: com.cy.yyjia.zhe28.ui.activity.ItemTradeDetailActivity$getData$$inlined$get$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: NetUtil.kt */
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super NetUtil.RequestResult<? extends ItemTradeBean>>, Object> {
        final /* synthetic */ Map $param;
        final /* synthetic */ String $url;
        int label;
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super NetUtil.RequestResult<? extends ItemTradeBean>> continuation) {
            ...
            try {
                ...
                if (strString != null) {
                    if (responseExecute.isSuccessful()) {
                        ...
                        if (i == 200) {
                            Object objFromJson = new Gson().fromJson(strString, new TypeToken<BaseResult<ItemTradeBean>>() { // from class: com.cy.yyjia.zhe28.ui.activity.ItemTradeDetailActivity$getData$.inlined.get.1.1.1
                            }.getType());
