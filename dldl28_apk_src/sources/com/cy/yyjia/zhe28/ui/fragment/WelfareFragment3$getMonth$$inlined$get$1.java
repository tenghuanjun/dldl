...
@DebugMetadata(c = "com.cy.yyjia.zhe28.ui.fragment.WelfareFragment3$getMonth$$inlined$get$1", f = "WelfareFragment3.kt", i = {}, l = {382}, m = "invokeSuspend", n = {}, s = {})
public final class WelfareFragment3$getMonth$$inlined$get$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public WelfareFragment3$getMonth$$inlined$get$1(String str, Map map, Continuation continuation, WelfareFragment3 welfareFragment3, WelfareFragment3 welfareFragment32) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        return new WelfareFragment3$getMonth$$inlined$get$1(str, map, continuation, welfareFragment3, welfareFragment3);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((WelfareFragment3$getMonth$$inlined$get$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.cy.yyjia.zhe28.ui.fragment.WelfareFragment3$getMonth$$inlined$get$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: NetUtil.kt */
            ...
            try {
                ...
                if (strString != null) {
                    if (responseExecute.isSuccessful()) {
                        ...
                        if (i == 200) {
                            Object objFromJson = new Gson().fromJson(strString, new TypeToken<BaseResult<MonthlyTaskBean>>() { // from class: com.cy.yyjia.zhe28.ui.fragment.WelfareFragment3$getMonth$.inlined.get.1.1.1
                            }.getType());
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (requestResult instanceof NetUtil.RequestResult.Success) {
            WelfareFragment3.access$getMBinding(this.this$0).setMonth((MonthlyTaskBean) ((NetUtil.RequestResult.Success) requestResult).getData());
