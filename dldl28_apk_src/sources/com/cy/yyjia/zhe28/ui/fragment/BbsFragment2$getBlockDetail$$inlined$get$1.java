...
@DebugMetadata(c = "com.cy.yyjia.zhe28.ui.fragment.BbsFragment2$getBlockDetail$$inlined$get$1", f = "BbsFragment2.kt", i = {}, l = {382}, m = "invokeSuspend", n = {}, s = {})
public final class BbsFragment2$getBlockDetail$$inlined$get$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ Map $param;
    final /* synthetic */ String $url;
    int label;
    final /* synthetic */ BbsFragment2 this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BbsFragment2$getBlockDetail$$inlined$get$1(String str, Map map, Continuation continuation, BbsFragment2 bbsFragment2, BbsFragment2 bbsFragment22) {
        super(2, continuation);
        this.$url = str;
        this.$param = map;
        this.this$0 = bbsFragment2;
    }
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        String str = this.$url;
        Map map = this.$param;
        BbsFragment2 bbsFragment2 = this.this$0;
        return new BbsFragment2$getBlockDetail$$inlined$get$1(str, map, continuation, bbsFragment2, bbsFragment2);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((BbsFragment2$getBlockDetail$$inlined$get$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.cy.yyjia.zhe28.ui.fragment.BbsFragment2$getBlockDetail$$inlined$get$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: NetUtil.kt */
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super NetUtil.RequestResult<? extends BbsDetailBean>>, Object> {
        final /* synthetic */ Map $param;
        final /* synthetic */ String $url;
        int label;
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super NetUtil.RequestResult<? extends BbsDetailBean>> continuation) {
            ...
            try {
                ...
                if (strString != null) {
                    if (responseExecute.isSuccessful()) {
                        ...
                        if (i == 200) {
                            Object objFromJson = new Gson().fromJson(strString, new TypeToken<BaseResult<BbsDetailBean>>() { // from class: com.cy.yyjia.zhe28.ui.fragment.BbsFragment2$getBlockDetail$.inlined.get.1.1.1
                            }.getType());
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (requestResult instanceof NetUtil.RequestResult.Success) {
            BbsDetailBean bbsDetailBean = (BbsDetailBean) ((NetUtil.RequestResult.Success) requestResult).getData();
            BbsFragment2.access$getMBinding(this.this$0).setData(bbsDetailBean);
            BbsFragment2.access$getMBinding(this.this$0).tab.removeAllTabs();
            for (BbsDetailBean.Cate cate : bbsDetailBean.getInfo().getCates()) {
                TabLayout.Tab tabNewTab = BbsFragment2.access$getMBinding(this.this$0).tab.newTab();
                Intrinsics.checkNotNullExpressionValue(tabNewTab, "newTab(...)");
                tabNewTab.setTag(Boxing.boxInt(cate.getId()));
                tabNewTab.setText(cate.getName());
                BbsFragment2.access$getMBinding(this.this$0).tab.addTab(tabNewTab);
            }
            this.this$0.setCateId(bbsDetailBean.getInfo().getCates().get(0).getId());
