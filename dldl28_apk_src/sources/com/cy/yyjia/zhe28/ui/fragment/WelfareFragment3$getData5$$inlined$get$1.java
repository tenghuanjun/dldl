...
@DebugMetadata(c = "com.cy.yyjia.zhe28.ui.fragment.WelfareFragment3$getData5$$inlined$get$1", f = "WelfareFragment3.kt", i = {}, l = {382}, m = "invokeSuspend", n = {}, s = {})
public final class WelfareFragment3$getData5$$inlined$get$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public WelfareFragment3$getData5$$inlined$get$1(String str, Map map, Continuation continuation, WelfareFragment3 welfareFragment3, WelfareFragment3 welfareFragment32) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        String str = this.$url;
        Map map = this.$param;
        WelfareFragment3 welfareFragment3 = this.this$0;
        return new WelfareFragment3$getData5$$inlined$get$1(str, map, continuation, welfareFragment3, welfareFragment3);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((WelfareFragment3$getData5$$inlined$get$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.cy.yyjia.zhe28.ui.fragment.WelfareFragment3$getData5$$inlined$get$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: NetUtil.kt */
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super NetUtil.RequestResult<? extends BossServerBean>>, Object> {
        final /* synthetic */ Map $param;
        final /* synthetic */ String $url;
        int label;
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super NetUtil.RequestResult<? extends BossServerBean>> continuation) {
            ...
            try {
                ...
                if (strString != null) {
                    if (responseExecute.isSuccessful()) {
                        ...
                        if (i == 200) {
                            Object objFromJson = new Gson().fromJson(strString, new TypeToken<BaseResult<BossServerBean>>() { // from class: com.cy.yyjia.zhe28.ui.fragment.WelfareFragment3$getData5$.inlined.get.1.1.1
                            }.getType());
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (requestResult instanceof NetUtil.RequestResult.Success) {
            BossServerBean bossServerBean = (BossServerBean) ((NetUtil.RequestResult.Success) requestResult).getData();
            WelfareFragment3.access$getMBinding(this.this$0).setBoss(bossServerBean);
            Welfare3NewsAdapter welfare3NewsAdapter = new Welfare3NewsAdapter(this.this$0.getMContext());
            welfare3NewsAdapter.setData(bossServerBean.getNews());
            WelfareFragment3.access$getMBinding(this.this$0).vf.setAdapter(welfare3NewsAdapter);
