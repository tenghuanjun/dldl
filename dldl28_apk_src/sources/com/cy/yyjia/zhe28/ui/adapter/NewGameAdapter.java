...
/* JADX INFO: compiled from: NewGameAdapter.kt */
/* JADX INFO: loaded from: classes2.dex */
@Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010!\n\u0002\b\u0003\n\u0002\u0010 \n\u0002\b\u0002\b\u0007\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u00012\u00020\u0003B\u0005¢\u0006\u0002\u0010\u0004J\u001a\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\u00020\f2\f\u0010\r\u001a\b\u0012\u0004\u0012\u00020\u00020\fJ\u001e\u0010\u000e\u001a\u00020\u00062\f\u0010\u000f\u001a\b\u0012\u0004\u0012\u00020\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u0006H\u0014R\u001a\u0010\u0005\u001a\u00020\u0006X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0007\u0010\b\"\u0004\b\t\u0010\n¨\u0006\u0012"}, d2 = {"Lcom/cy/yyjia/zhe28/ui/adapter/NewGameAdapter;", "Lcom/chad/library/adapter/base/BaseProviderMultiAdapter;", "Lcom/cy/yyjia/zhe28/domain/GameBean;", "Lcom/chad/library/adapter/base/module/LoadMoreModule;", "()V", "type", "", "getType", "()I", "setType", "(I)V", "formatData", "", "list", "getItemType", "data", "", ImageSelector.POSITION, "app_zhe28Release"}, k = 1, mv = {1, 9, 0}, xi = 48)
public final class NewGameAdapter extends BaseProviderMultiAdapter<GameBean> implements LoadMoreModule {
    ...
    public NewGameAdapter() {
        ...
        addItemProvider(new BaseProvider(0, R.layout.item_home_new, new Function4<BaseViewHolder, ItemHomeNewBinding, Integer, GameBean, Unit>() { // from class: com.cy.yyjia.zhe28.ui.adapter.NewGameAdapter.1
            {
                super(4);
            }
            ...
            public final void invoke(BaseViewHolder holder, ItemHomeNewBinding binding, int i, GameBean gameBean) {
                Intrinsics.checkNotNullParameter(holder, "holder");
                Intrinsics.checkNotNullParameter(binding, "binding");
                binding.setOrder(NewGameAdapter.this.getType() != 0);
            }
        }));
    }
    ...
    public final List<GameBean> formatData(List<GameBean> list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (i == 0 && getData().size() == 0) {
                GameBean gameBean4 = new GameBean(gameBean.getStartTimeStr());
                gameBean4.setGroupType(1);
