...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0001\"\n\b\u0000\u0010\u0002\u0018\u0001*\u00020\u0003*\u00020\u0004H\u008a@"}, d2 = {"<anonymous>", "Lcom/cy/yyjia/zhe28/util/NetUtil$RequestResult;", ExifInterface.GPS_DIRECTION_TRUE, "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 9, 0}, xi = KeyBoardKey.KeyboardKeyMediaNextTrack)
@DebugMetadata(c = "com.cy.yyjia.zhe28.util.NetUtil$postOther$1$result$1", f = "NetUtil.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
public final class NetUtil$postOther$1$result$1<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super NetUtil.RequestResult<? extends T>>, Object> {
    ...
    public NetUtil$postOther$1$result$1(String str, Map<String, String> map, boolean z, ArrayList<File> arrayList, Continuation<? super NetUtil$postOther$1$result$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        return new NetUtil$postOther$1$result$1(this.$url, this.$param, this.$useToken, this.$fileList, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super NetUtil.RequestResult<? extends T>> continuation) {
        return ((NetUtil$postOther$1$result$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            ...
            if (numBoxInt.intValue() > 0) {
                ...
                while (i < size) {
                    int i2 = i + 1;
                    postRequestPost.params("file" + i2, arrayList.get(i));
                    i = i2;
                }
            }
            ...
            if (strString != null) {
                if (responseExecute.isSuccessful()) {
                    Intrinsics.needClassReification();
                    Object objFromJson = new Gson().fromJson(strString, new TypeToken<T>() { // from class: com.cy.yyjia.zhe28.util.NetUtil$postOther$1$result$1$invokeSuspend$$inlined$requestOther$1
                    }.getType());
