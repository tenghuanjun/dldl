...
public final class ShareTool {
    ...
    public final void shareToWechat(Context context, ShareInfo shareInfo, int mTargetScene) {
        ...
        if (!TextUtils.isEmpty(shareInfo.getImgUrl())) {
            BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, Dispatchers.getIO(), null, new C12041(context, shareInfo, mTargetScene, null), 2, null);
        } else {
    ...
    static final class C12041 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C12041(Context context, ShareInfo shareInfo, int i, Continuation<? super C12041> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C12041(this.$context, this.$shareInfo, this.$mTargetScene, continuation);
        }
