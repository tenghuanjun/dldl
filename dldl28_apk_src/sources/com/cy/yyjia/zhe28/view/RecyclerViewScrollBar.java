...
public class RecyclerViewScrollBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        this.mTrackColor = getResources().getColor(typedArrayObtainStyledAttributes.getResourceId(2, R.color.colorShadow));
        this.mThumbColor = getResources().getColor(typedArrayObtainStyledAttributes.getResourceId(2, R.color.colorPrimary));
