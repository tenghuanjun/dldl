...
public class ItemDealRoleBindingImpl extends ItemDealRoleBinding {
    ...
    public ItemDealRoleBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }

    private ItemDealRoleBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.cy.yyjia.zhe28.databinding.ItemDealRoleBinding
    ...
    protected void executeBindings() {
        ...
        if (j2 != 0) {
            TextViewBindingAdapter.setText(this.mboundView1, serviceCode);
            TextViewBindingAdapter.setText(this.mboundView2, roleName);
        }
    }
}
