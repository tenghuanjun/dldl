...
public class DialogConfirmBindingImpl extends DialogConfirmBinding {
    ...
    public DialogConfirmBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private DialogConfirmBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (TextView) bindings[2], (TextView) bindings[3]);
        this.mDirtyFlags = -1L;
    ...
    @Override // com.cy.yyjia.zhe28.databinding.DialogConfirmBinding
