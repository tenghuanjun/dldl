...
public class k {
    ...
    private static ConcurrentHashMap<String, com.tencent.a.a.a> f1092a = new ConcurrentHashMap<>();
    ...
    private static PackageInfo e(Context context, String str) {
        ...
        synchronized (k.class) {
            if (f1092a.containsKey(str)) {
                com.tencent.a.a.a aVar = f1092a.get(str);
                if (aVar == null) {
            ...
            f1092a.put(str, new com.tencent.a.a.a(str, packageInfoF));
            return packageInfoF;
        }
    }
