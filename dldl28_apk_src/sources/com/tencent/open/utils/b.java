...
public final class b {
    ...
    private static final n f1079a = new n(101010256);
    ...
    private static class a {
        ...
        void a(byte[] bArr) throws IOException {
            ...
            this.f1080a.load(new ByteArrayInputStream(bArr4));
        ...
        public String toString() {
            return "ApkExternalInfo [p=" + this.f1080a + ", otherData=" + Arrays.toString(this.b) + "]";
        }
    }
        ...
        try {
            ...
            try {
                ...
                if (bArrA != null) {
                    a aVar = new a();
                    aVar.a(bArrA);
                    String property = aVar.f1080a.getProperty(str);
