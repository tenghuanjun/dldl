...
public class d extends com.tencent.open.c implements a.InterfaceC0439a {
    static Toast c;
    private String d;
    ...
    public d(Context context, String str, String str2, IUiListener iUiListener, QQToken qQToken) {
        ...
        this.g = new HandlerC0440d(this.f, context.getMainLooper());
        this.e = iUiListener;
    ...
    private void c() {
        ...
        this.f1059a.a(new b(), "sdk_js_if");
        this.i.clearView();
        this.i.loadUrl(this.d);
    }

    /* JADX INFO: compiled from: ProGuard */
    private class b extends b.C0438b {
        private b() {
        }
    }
    ...
    /* JADX INFO: compiled from: ProGuard */
    private class HandlerC0440d extends Handler {
        private c b;

        public HandlerC0440d(c cVar, Looper looper) {
            super(looper);
            this.b = cVar;
        }
    ...
    private static class c extends DefaultUiListener {
        ...
        public void onComplete(Object obj) {
            ...
            h.a().a(this.d + "_H5", SystemClock.elapsedRealtime(), 0L, 0L, jSONObject.optInt("ret", -6), this.f1065a, false);
        ...
        public void onError(UiError uiError) {
            ...
            if (uiError.errorMessage != null) {
                str = uiError.errorMessage + this.f1065a;
            } else {
                str = this.f1065a;
            }
            h hVarA = h.a();
    ...
    @Override // com.tencent.open.c.a.InterfaceC0439a
    public void a(int i) {
        WeakReference<Context> weakReference = this.j;
        if (weakReference != null && weakReference.get() != null) {
