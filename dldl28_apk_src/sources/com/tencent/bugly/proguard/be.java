...
public final class be {
    ...
    private static List<File> f917a = new ArrayList();
                    ...
                    if (!TextUtils.isEmpty(str4)) {
                        ...
                        if (crashDetailBeanPackageCrashDatas != null) {
                            ...
                            if (str15 != null) {
                                ...
                                zEqualsIgnoreCase = str15.equalsIgnoreCase(BooleanUtils.TRUE);
                            } else {
    ...
    public static void a(boolean z, String str) {
        if (str != null) {
            f917a.add(new File(str, "rqd_record.eup"));
            f917a.add(new File(str, "reg_record.txt"));
            f917a.add(new File(str, "map_record.txt"));
            f917a.add(new File(str, "backup_record.txt"));
            if (z) {
                c(str);
            }
        }
        List<File> list = f917a;
