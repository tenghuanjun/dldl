...
public final class k {
    ...
    private void a(byte b) {
        ...
        switch (b) {
            ...
            case 13:
                ...
                a(aVar);
                if (aVar.f937a != 0) {
                    throw new h("skipField with invalid type, type value: " + ((int) b) + ", " + ((int) aVar.f937a));
                }
                a(a(0, 0, true));
                return;
            default:
    ...
    public final String b(int i, boolean z) {
        ...
        if (b == 6) {
            ...
            this.b.get(bArr);
            try {
                return new String(bArr, this.f936a);
        ...
        if (b == 7) {
            ...
            this.b.get(bArr2);
            try {
                return new String(bArr2, this.f936a);
    ...
    public final byte[] c(int i, boolean z) {
        ...
        if (b == 13) {
            ...
            a(aVar2);
            if (aVar2.f937a != 0) {
                throw new h("type mismatch, tag: " + i + ", type: " + ((int) aVar.f937a) + ", " + ((int) aVar2.f937a));
            }
            int iA2 = a(0, 0, true);
            if (iA2 < 0) {
                throw new h("invalid size, tag: " + i + ", type: " + ((int) aVar.f937a) + ", " + ((int) aVar2.f937a) + ", size: " + iA2);
            }
