...
public final class ac {
    ...
    private ac(Context context, List<o> list) {
        ...
        if (aa.a(context) != null) {
            ...
            if ("oversea".equals(str)) {
                StrategyBean.f858a = "https://astat.bugly.qcloud.com/rqd/async";
                StrategyBean.b = "https://astat.bugly.qcloud.com/rqd/async";
            } else if ("na_https".equals(str)) {
                StrategyBean.f858a = "https://astat.bugly.cros.wr.pvp.net/:8180/rqd/async";
    ...
    public final void a(bt btVar) {
        ...
        if (this.g == null || btVar.h != this.g.o) {
            ...
            if (btVar.f != null && !ap.b(btVar.f.f928a)) {
                strategyBean.s = btVar.f.f928a;
            }
            if (btVar.h != 0) {
