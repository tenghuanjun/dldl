...
public final class l {
    ...
    public ByteBuffer f938a;
    protected String b;

    public l(int i) {
        this.b = "GBK";
        this.f938a = ByteBuffer.allocate(i);
    }
    ...
    private void a(int i) {
        if (this.f938a.remaining() < i) {
            ByteBuffer byteBufferAllocate = ByteBuffer.allocate((this.f938a.capacity() + i) * 2);
            byteBufferAllocate.put(this.f938a.array(), 0, this.f938a.position());
            this.f938a = byteBufferAllocate;
        }
    }

    private void b(byte b, int i) {
        if (i < 15) {
            this.f938a.put((byte) (b | (i << 4)));
        } else {
            if (i < 256) {
                this.f938a.put((byte) (b | 240));
                this.f938a.put((byte) i);
                return;
            }
    ...
    private void a(float f, int i) {
        a(6);
        b((byte) 4, i);
        this.f938a.putFloat(f);
    }

    private void a(double d, int i) {
        a(10);
        b((byte) 5, i);
        this.f938a.putDouble(d);
    }
    ...
    public final void a(String str, int i) {
        ...
        if (bytes.length > 255) {
            b((byte) 7, i);
            this.f938a.putInt(bytes.length);
            this.f938a.put(bytes);
        } else {
            b((byte) 6, i);
            this.f938a.put((byte) bytes.length);
            this.f938a.put(bytes);
        }
    }
