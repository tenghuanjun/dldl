...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    BaseWXApiImplV10(Context context, String str, boolean z, int i) {
        ...
        this.launchMode = i;
        b.f1025a = context.getApplicationContext();
    }
    ...
    private String finderShareVideoJumpInfoToString(IWXChannelJumpInfo iWXChannelJumpInfo) {
        ...
        try {
            ...
            if (iWXChannelJumpInfo instanceof WXChannelBaseJumpInfo) {
                ...
                jSONObject.put(CommonConstants.KEY_EXTRA, ((WXChannelBaseJumpInfo) iWXChannelJumpInfo).extra);
    ...
    public boolean registerApp(String str, long j) {
        ...
        c0435a.f1015a = "com.tencent.mm";
        c0435a.b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c0435a.c = "weixin://registerapp?appid=" + this.appId;
        c0435a.d = j;
        return a.a(this.context, c0435a);
    }
    ...
    public void unregisterApp() {
        ...
        a.C0435a c0435a = new a.C0435a();
        c0435a.f1015a = "com.tencent.mm";
        c0435a.b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c0435a.c = "weixin://unregisterapp?appid=" + this.appId;
        a.a(this.context, c0435a);
    }
}
