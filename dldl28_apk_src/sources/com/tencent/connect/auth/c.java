...
public class c {
    ...
    private int a(Activity activity, Fragment fragment, String str, IUiListener iUiListener, String str2, boolean z, Map<String, Object> map) {
        ...
        BaseApi.isOEM = false;
        return this.f982a.doLogin(activity, str, iUiListener, false, fragment, z, map);
    }
    ...
    public int a(Activity activity, String str, IUiListener iUiListener, boolean z, String str2, String str3, String str4) {
        ...
        return this.f982a.a(activity, str, iUiListener, false, null, z);
    }

    public int b(Activity activity, String str, IUiListener iUiListener) {
        SLog.i("openSDK_LOG.QQAuth", "reAuth()");
        return this.f982a.a(activity, str, iUiListener, true, null, false);
    }

    public void a() {
        this.f982a.a((IUiListener) null);
    }

    public void a(IUiListener iUiListener) {
        this.f982a.b(iUiListener);
    }
    ...
    public boolean c() {
        SLog.i("openSDK_LOG.QQAuth", "isSessionValid(), result = ".concat(this.b.isSessionValid() ? BooleanUtils.TRUE : BooleanUtils.FALSE));
