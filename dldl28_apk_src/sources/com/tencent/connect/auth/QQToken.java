...
public class QQToken {
    ...
    public String getOpenIdWithCache() {
        ...
        try {
            if (TextUtils.isEmpty(openId)) {
                JSONObject jSONObjectLoadSession = loadSession(this.f969a);
                ...
                SLog.i("QQToken", "getOpenId from Session openId = " + openId + " appId = " + this.f969a);
            } else {
                SLog.i("QQToken", "getOpenId from field openId = " + openId + " appId = " + this.f969a);
            }
        } catch (Exception e) {
    ...
    public boolean saveSession(JSONObject jSONObject) {
        try {
            ...
            return a(this.f969a, jSONObject, this.f);
        } catch (Exception e) {
