...
public class a extends Dialog {
    ...
    private class b extends DefaultUiListener {
        ...
        public void onComplete(Object obj) {
            ...
            h.a().a(this.d + "_H5", SystemClock.elapsedRealtime(), 0L, 0L, jSONObject.optInt("ret", -6), this.f977a, false);
        ...
        public void onError(UiError uiError) {
            ...
            if (uiError.errorMessage != null) {
                str = uiError.errorMessage + this.f977a;
            } else {
                str = this.f977a;
            }
    ...
    /* JADX INFO: compiled from: ProGuard */
    private class C0433a extends WebViewClient {
        private C0433a() {
        }
            ...
            if (str.startsWith("auth://browser")) {
                ...
                if (!a.this.m) {
                    if (jSONObjectC.optString("fail_cb", null) != null) {
                        ...
                        sb.append(a.this.f970a);
                        sb.append(a.this.f970a.indexOf("?") > -1 ? "&" : "?");
                        aVar2.f970a = sb.toString();
                        a.this.f970a = a.this.f970a + "browser_error=1";
                        a.this.j.loadUrl(a.this.f970a);
                    } else {
    ...
    class d implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            SLog.v("openSDK_LOG.AuthDialog", "-->timeoutUrl: " + this.f979a + " | mRetryUrl: " + a.this.o);
            if (this.f979a.equals(a.this.o)) {
    ...
    private void b() {
        try {
            ...
            String string = m.b(this.f970a).getString("style");
    ...
    private void d() {
        ...
        this.j.setWebViewClient(new C0433a());
        ...
        SLog.v("openSDK_LOG.AuthDialog", "-->mUrl : " + this.f970a);
        String str = this.f970a;
        this.o = str;
        this.j.loadUrl(str);
