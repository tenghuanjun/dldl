...
public class AssistActivity extends Activity {
    ...
    */
    protected void onCreate(android.os.Bundle r19) throws java.lang.Throwable {
        /*
    ...
    protected void onSaveInstanceState(Bundle bundle) {
        ...
        bundle.putBoolean("RESUME_FLAG", this.f999a);
    ...
    private class QQStayReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            try {
                ...
                intent2.putExtra(CommonConstants.KEY_RESPONSE, "parse error.");
            }
