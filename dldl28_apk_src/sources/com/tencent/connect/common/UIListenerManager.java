...
public class UIListenerManager {
    ...
    private static UIListenerManager f1005a;
    private Map<String, ApiTask> b;

    public static UIListenerManager getInstance() {
        if (f1005a == null) {
            f1005a = new UIListenerManager();
        }
        return f1005a;
    }
    ...
    public void handleDataToListener(Intent intent, IUiListener iUiListener) {
        ...
        if ("action_share".equals(stringExtra)) {
            ...
            String stringExtra4 = intent.getStringExtra(CommonConstants.KEY_RESPONSE);
    ...
    public boolean onActivityResult(int i, int i2, Intent intent, IUiListener iUiListener) {
        ...
        if ("action_common_channel".equals(stringExtra)) {
            ...
            if (intExtra2 == 0) {
                String stringExtra5 = intent.getStringExtra(CommonConstants.KEY_RESPONSE);
                if (stringExtra5 != null) {
                    try {
                        String stringExtra6 = intent.getStringExtra(CommonConstants.KEY_MESSAGE);
                        JSONObject jSONObjectD = m.d(stringExtra5);
                        jSONObjectD.put(CommonConstants.KEY_MESSAGE, stringExtra6);
