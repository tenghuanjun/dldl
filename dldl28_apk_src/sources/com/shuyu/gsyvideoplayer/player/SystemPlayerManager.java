    ...
    private void setSpeed(float f) {
        ...
        try {
            if (Build.VERSION.SDK_INT >= 23) {
                ...
                PlaybackParams playbackParamsM6341m = x$$ExternalSyntheticApiModelOutline0.m6341m();
                playbackParamsM6341m.setSpeed(f);
                this.mediaPlayer.getInternalMediaPlayer().setPlaybackParams(playbackParamsM6341m);
            } else {
