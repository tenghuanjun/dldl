...
public class LunarCalendar {
    ...
    private static final int[] DAYS_BEFORE_MONTH = {0, 31, 59, 90, 120, 151, KeyBoardKey.KeyboardKeyLaunchMediaSelect, KeyBoardKey.KeyboardKeyGamepadLeftThumbStickDown, KeyBoardKey.KeyboardKeyOemAuto, 273, 304, 334, 365};
    ...
    public static final int[] lunarToSolar(int i, int i2, int i3, boolean z) {
        ...
        for (int i8 = 1; i8 < i2; i8++) {
            i7 = ((524288 >> (i8 + (-1))) & LUNAR_INFO[i4]) == 0 ? i7 + 29 : i7 + 30;
        }
        int i9 = i7 + i3;
        int i10 = LUNAR_INFO[i4];
        int i11 = (15728640 & i10) >> 20;
        if (i11 != 0 && (i2 > i11 || (i2 == i11 && z))) {
            i9 = ((524288 >> (i2 - 1)) & i10) == 0 ? i9 + 29 : i9 + 30;
        }
        if (i9 > 366 || (i % 4 != 0 && i9 > 365)) {
            i++;
            i9 = i % 4 == 1 ? i9 - 366 : i9 - 365;
        }
        int[] iArr = new int[3];
        int i12 = 1;
        while (true) {
    ...
    public static final int[] solarToLunarDeprecated(int i, int i2, int i3) {
        ...
        return new int[]{i4, i6, time + 1, i5};
    }
