...
public class b {
    ...
    private static byte[] f741a;

    static String a(Context context, String str) {
        a();
        byte[] bArrB = b(context);
        if (bArrB != null) {
            return a.a(bArrB, str, f741a);
        }
        a();
        return null;
    }
    ...
    private static boolean a(Context context) {
        try {
            if (Build.VERSION.SDK_INT >= 23) {
                ...
                x$$ExternalSyntheticApiModelOutline0.m6348m();
                keyGenerator.init(x$$ExternalSyntheticApiModelOutline0.m("CMCC_SDK_V1", 3).setDigests("SHA-256", "SHA-512").setBlockModes("CBC").setEncryptionPaddings("PKCS7Padding").setRandomizedEncryptionRequired(false).setKeySize(256).build());
                Thread.sleep(1000L);
        ...
        try {
            ...
            if (TextUtils.isEmpty(strB)) {
                ...
                if (key instanceof SecretKey) {
                    ...
                    cipher2.init(1, key, new IvParameterSpec(f741a));
                } else {
                ...
                String strEncodeToString2 = Base64.encodeToString(f741a, 0);
                HashMap map = new HashMap();
                map.put("AES_IV", strEncodeToString2);
                map.put("AES_KEY", strEncodeToString);
                k.a(map);
            } else {
                f741a = Base64.decode(c(), 0);
                ...
                if (key2 instanceof SecretKey) {
                    ...
                    cipher.init(2, key2, new IvParameterSpec(f741a));
                    str = "KeystoreUtil";
                    str2 = "使用aes";
                } else {
