...
public class a {
    ...
    private com.mobile.auth.f.a f780a;
    private Context c;
    ...
    private class RunnableC0428a implements Runnable {
        ...
        RunnableC0428a(com.cmic.sso.sdk.a aVar) {
            this.b = aVar;
        }
        ...
        static /* synthetic */ boolean a(RunnableC0428a runnableC0428a) {
            try {
                return runnableC0428a.a();
            } catch (Throwable th) {
                try {
                    ExceptionProcessor.processException(th);
                    return false;
    ...
    public a(Context context) {
        this.f780a = com.mobile.auth.f.a.a(context);
    ...
    private void a(String str, com.cmic.sso.sdk.a aVar, final c cVar) {
        try {
            final RunnableC0428a runnableC0428a = new RunnableC0428a(aVar);
            this.g.postDelayed(runnableC0428a, b());
            ...
            a(d(), aVar, new com.mobile.auth.f.d() { // from class: com.mobile.auth.r.a.3
                ...
                public void a(String str2, String str3, com.cmic.sso.sdk.a aVar2, JSONObject jSONObject) {
                    try {
                        if (RunnableC0428a.a(runnableC0428a)) {
                            a.f(a.this).removeCallbacks(runnableC0428a);
    ...
    */
    private com.mobile.auth.f.c d() {
        /*
            ...
            com.mobile.auth.f.a r3 = r4.f780a     // Catch: java.lang.IllegalAccessException -> L22 java.lang.NoSuchFieldException -> L24 java.lang.Throwable -> L39
    ...
    public void b(com.mobile.auth.f.b bVar) {
        try {
            this.f780a.a(this.h, this.i, new c(bVar));
        } catch (Throwable th) {
            try {
                ExceptionProcessor.processException(th);
            } catch (Throwable th2) {
