...
public class f {
    ...
    public static String e(Context context) {
        try {
            int iH = h(context);
            return iH != -101 ? (iH == -1 || iH == 0) ? "null" : iH != 1 ? iH != 2 ? iH != 3 ? Integer.toString(iH) : "4G" : "3G" : "2G" : "WIFI";
        } catch (Throwable th) {
            try {
                ExceptionProcessor.processException(th);
                return null;
                ...
                try {
                    ...
                    if (networkInfoA != null && networkInfoA.isAvailable() && networkInfoA.isConnected()) {
                        ...
                        if (type == 1) {
                            ...
                            try {
                                subtype = ((TelephonyManager) context.getSystemService(HintConstants.AUTOFILL_HINT_PHONE)).getNetworkType();
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                            if (subtype == 0) {
