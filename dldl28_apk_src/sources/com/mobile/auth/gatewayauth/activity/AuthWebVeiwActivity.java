...
public class AuthWebVeiwActivity extends Activity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        try {
            ...
            this.f609a = (WebView) findViewById(AppUtils.getResID(this, "authsdk_webview", "id"));
            if (l.a(this.g.getBottomNavBarColor())) {
                this.f609a.setY(this.f.getHeight() + this.f.getY());
            }
            if (dVarA.b() && !this.g.isStatusBarHidden()) {
                this.f609a.setY(this.f.getHeight() + a((Context) this));
            }
            this.f609a.setWebChromeClient(new WebChromeClient() { // from class: com.mobile.auth.gatewayauth.activity.AuthWebVeiwActivity.2
            ...
            this.f609a.setWebViewClient(new WebViewClient() { // from class: com.mobile.auth.gatewayauth.activity.AuthWebVeiwActivity.3
                @Override // android.webkit.WebViewClient
                public boolean shouldOverrideUrlLoading(WebView webView, String str) {
                    return false;
                }
            });
            this.f609a.setVerticalScrollBarEnabled(false);
            this.f609a.setHorizontalScrollBarEnabled(false);
            WebSettings settings = this.f609a.getSettings();
            ...
            this.f609a.setVerticalScrollbarOverlay(false);
            settings.setUseWideViewPort(true);
            settings.setBuiltInZoomControls(true);
            settings.setDisplayZoomControls(false);
            settings.setSupportZoom(true);
            settings.setCacheMode(this.g.getWebCacheMode());
            this.f609a.loadUrl(this.b);
        } catch (Throwable th) {
            ExceptionProcessor.processException(th);
        }
    }
