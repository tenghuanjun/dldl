...
public class PrivacyDialogActivity extends Activity {
    ...
    class AnonymousClass1 implements View.OnClickListener {
        ...
        final /* synthetic */ LinkedHashMap f600a;
        final /* synthetic */ String b;

        AnonymousClass1(LinkedHashMap linkedHashMap, String str) {
            this.f600a = linkedHashMap;
            this.b = str;
        }
        ...
        public void onClick(View view) {
            ...
            try {
                AuthRegisterViewConfig authRegisterViewConfig = (AuthRegisterViewConfig) this.f600a.get(this.b);
    ...
    class AnonymousClass2 implements View.OnClickListener {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ LinkedHashMap f601a;
        final /* synthetic */ String b;

        AnonymousClass2(LinkedHashMap linkedHashMap, String str) {
            this.f601a = linkedHashMap;
            this.b = str;
        }
        ...
        public void onClick(View view) {
            CustomInterface customInterface;
            try {
                AuthRegisterViewConfig authRegisterViewConfig = (AuthRegisterViewConfig) this.f601a.get(this.b);
                if (authRegisterViewConfig == null || (customInterface = authRegisterViewConfig.getCustomInterface()) == null) {
                    return;
                }
                customInterface.onClick(PrivacyDialogActivity.this);
    ...
    class AnonymousClass3 implements View.OnClickListener {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ LinkedHashMap f602a;
        final /* synthetic */ String b;

        AnonymousClass3(LinkedHashMap linkedHashMap, String str) {
            this.f602a = linkedHashMap;
            this.b = str;
        }
        ...
        public void onClick(View view) {
            CustomInterface customInterface;
            try {
                AuthRegisterViewConfig authRegisterViewConfig = (AuthRegisterViewConfig) this.f602a.get(this.b);
                if (authRegisterViewConfig == null || (customInterface = authRegisterViewConfig.getCustomInterface()) == null) {
                    return;
                }
                customInterface.onClick(PrivacyDialogActivity.this);
    ...
    class AnonymousClass9 extends ClickableSpan {
        ...
        public void onClick(View view) {
            try {
                PrivacyDialogActivity.access$100(PrivacyDialogActivity.this).b(PrivacyDialogActivity.access$000(PrivacyDialogActivity.this), this.f608a, this.b, false);
                PrivacyDialogActivity.access$100(PrivacyDialogActivity.this).a(this.f608a, this.b);
            } catch (Throwable th) {
                ExceptionProcessor.processException(th);
            }
        }
