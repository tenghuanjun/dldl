...
public class PhoneNumberAuthHelper {
    ...
    protected static volatile PhoneNumberAuthHelper f556a;
    ...
    public static PhoneNumberAuthHelper getInstance(Context context, TokenResultListener tokenResultListener) {
        try {
            if (f556a == null && context != null) {
                synchronized (PhoneNumberAuthHelper.class) {
                    if (f556a == null) {
                        f556a = new PhoneNumberAuthHelper(context, tokenResultListener);
                    }
                }
            }
            f556a.setAuthListener(tokenResultListener);
            return f556a;
        } catch (Throwable th) {
            ExceptionProcessor.processException(th);
            return null;
