...
public class VendorSdkInfoManager {
    ...
    private SparseArray<VendorConfig> f653a = new com.mobile.auth.gatewayauth.manager.base.a(3);
    ...
    public VendorConfig a(int i) {
        try {
            ...
            return vendorConfig != null ? vendorConfig : this.f653a.get(i);
        } catch (Throwable th) {
            try {
                ExceptionProcessor.processException(th);
                return null;
