...
public class f {
    ...
    public f(SystemManager systemManager, d dVar) {
        this.f677a = systemManager;
        this.e = dVar;
        this.b = new com.mobile.auth.r.d(systemManager.e(), this.e);
        this.c = new com.mobile.auth.t.a(this.f677a.e(), this.e);
        this.d = new com.mobile.auth.s.a(this.f677a.e(), this.e);
    }
