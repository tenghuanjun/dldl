...
public class TurboAgent {
    ...
    public static void init(TurboConfig turboConfig) {
        e.c.INSTANCE.f74a.a(turboConfig);
    }

    public static void on14dayStay() {
        e.c.INSTANCE.f74a.a(new a("EVENT_14_DAY_STAY"));
    }

    public static void on24hStay() {
        e.c.INSTANCE.f74a.a(new a("EVENT_24h_STAY"));
    }

    public static void on2dayStay() {
        e.c.INSTANCE.f74a.a(new a("EVENT_2_DAY_STAY"));
    }

    public static void on30dayStay() {
        e.c.INSTANCE.f74a.a(new a("EVENT_30_DAY_STAY"));
    }

    public static void on3dayStay() {
        e.c.INSTANCE.f74a.a(new a("EVENT_3_DAY_STAY"));
    }

    public static void on4dayStay() {
        e.c.INSTANCE.f74a.a(new a("EVENT_4_DAY_STAY"));
    }

    public static void on5dayStay() {
        e.c.INSTANCE.f74a.a(new a("EVENT_5_DAY_STAY"));
    }

    public static void on6dayStay() {
        e.c.INSTANCE.f74a.a(new a("EVENT_6_DAY_STAY"));
    }
    ...
    public static void onAffairFinish() {
        e.c.INSTANCE.f74a.a(new a("EVENT_JINJIAN"));
    }

    public static void onAppActive() {
        e.c.INSTANCE.f74a.a(new a("EVENT_ACTIVE"));
    }

    public static void onCreditGrant() {
        e.c.INSTANCE.f74a.a(new a("EVENT_CREDIT_GRANT"));
    }

    public static void onFormSubmit() {
        e.c.INSTANCE.f74a.a(new a("EVENT_FORM_SUBMIT"));
    }
    ...
    public static void onGameWatchRewardVideo() {
        e.c.INSTANCE.f74a.a(new a("EVENT_GAME_WATCH_REWARD_VIDEO"));
    }
    ...
    public static void onNextDayStay() {
        e.c.INSTANCE.f74a.a(new a("EVENT_NEXTDAY_STAY"));
    }
    ...
    public static void onPassKeyGameCard() {
        e.c.INSTANCE.f74a.a(new a("EVENT_PASS_KEY_GAME_CARD"));
    }
    ...
    public static void onRegister() {
        e.c.INSTANCE.f74a.a(new a("EVENT_REGISTER"));
    }
    ...
    public static void onWatchAppAd() {
        e.c.INSTANCE.f74a.a(new a("EVENT_WATCH_APP_AD"));
    }

    public static void onWeekStay() {
        e.c.INSTANCE.f74a.a(new a("EVENT_WEEK_STAY"));
    }
    ...
    public static void registerOAIDListener(Context context, OAIDListener oAIDListener) {
        ...
        if (TextUtils.isEmpty(a.a.a.f.a.f116a)) {
            a.a.a.f.a.b(applicationContext);
            return;
        }
        try {
            if (a.a.a.f.a.b != null) {
                a.a.a.f.a.b.OnOAIDValid(a.a.a.f.a.f116a);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void reportInsufficientGoldCoins() {
        e.c.INSTANCE.f74a.a(new a("EVENT_INSUFFICIENT_GOLD_COINS"));
    }
    ...
    public static void reportUsersIndependentNaming() {
        e.c.INSTANCE.f74a.a(new a("EVENT_USERS_INDEPENDENT_NAMING"));
    }

    public static void reportUsersReceiveGiftBags() {
        e.c.INSTANCE.f74a.a(new a("EVENT_USERS_RECEIVE_GIFT_BAGS"));
    }

    public static void reportUsersReceiveRedEnvelopes() {
        e.c.INSTANCE.f74a.a(new a("EVENT_USERS_RECEIVE_RED_ENVELOPES"));
    }
