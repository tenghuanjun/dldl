...
public abstract class BaseQuickAdapter<T, VH extends BaseViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    protected void bindViewClickListener(final VH viewHolder, int viewType) {
        ...
        if (this.mOnItemClickListener != null) {
            viewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.chad.library.adapter.base.BaseQuickAdapter$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view) {
                    BaseQuickAdapter.m6373bindViewClickListener$lambda7$lambda6(viewHolder, this, view);
                }
            });
        }
        if (this.mOnItemLongClickListener != null) {
            viewHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.chad.library.adapter.base.BaseQuickAdapter$$ExternalSyntheticLambda1
                ...
                public final boolean onLongClick(View view) {
                    return BaseQuickAdapter.m6374bindViewClickListener$lambda9$lambda8(viewHolder, this, view);
                }
            });
        }
        if (this.mOnItemChildClickListener != null) {
            for (Integer id : getChildClickViewIds()) {
                ...
                if (viewFindViewById != null) {
                    ...
                    viewFindViewById.setOnClickListener(new View.OnClickListener() { // from class: com.chad.library.adapter.base.BaseQuickAdapter$$ExternalSyntheticLambda2
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view2) {
                            BaseQuickAdapter.m6371bindViewClickListener$lambda12$lambda11$lambda10(viewHolder, this, view2);
                        }
                    });
                }
            }
        ...
        if (this.mOnItemChildLongClickListener != null) {
            for (Integer id2 : getChildLongClickViewIds()) {
                ...
                if (viewFindViewById2 != null) {
                    ...
                    viewFindViewById2.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.chad.library.adapter.base.BaseQuickAdapter$$ExternalSyntheticLambda3
                        ...
                        public final boolean onLongClick(View view3) {
                            return BaseQuickAdapter.m6372bindViewClickListener$lambda15$lambda14$lambda13(viewHolder, this, view3);
                        }
                    });
                }
            }
    ...
    public static final void m6373bindViewClickListener$lambda7$lambda6(BaseViewHolder viewHolder, BaseQuickAdapter this$0, View v) {
        Intrinsics.checkNotNullParameter(viewHolder, "$viewHolder");
    ...
    public static final boolean m6374bindViewClickListener$lambda9$lambda8(BaseViewHolder viewHolder, BaseQuickAdapter this$0, View v) {
        Intrinsics.checkNotNullParameter(viewHolder, "$viewHolder");
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        int bindingAdapterPosition = viewHolder.getBindingAdapterPosition();
        if (bindingAdapterPosition == -1) {
    ...
    public static final void m6371bindViewClickListener$lambda12$lambda11$lambda10(BaseViewHolder viewHolder, BaseQuickAdapter this$0, View v) {
        Intrinsics.checkNotNullParameter(viewHolder, "$viewHolder");
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        int bindingAdapterPosition = viewHolder.getBindingAdapterPosition();
        if (bindingAdapterPosition == -1) {
    ...
    public static final boolean m6372bindViewClickListener$lambda15$lambda14$lambda13(BaseViewHolder viewHolder, BaseQuickAdapter this$0, View v) {
        Intrinsics.checkNotNullParameter(viewHolder, "$viewHolder");
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        int bindingAdapterPosition = viewHolder.getBindingAdapterPosition();
        if (bindingAdapterPosition == -1) {
