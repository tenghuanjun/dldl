...
/* JADX INFO: compiled from: BrvahAsyncDiffer.kt */
...
public final class BrvahAsyncDiffer<T> implements DifferImp<T> {
    ...
    public BrvahAsyncDiffer(BaseQuickAdapter<T, ?> adapter, BrvahAsyncDifferConfig<T> config) {
        ...
        Executor mainThreadExecutor2 = config.getMainThreadExecutor();
    ...
    public final void submitList(final List<T> newList, final Runnable commitCallback) {
        ...
        this.config.getBackgroundThreadExecutor().execute(new Runnable() { // from class: com.chad.library.adapter.base.diff.BrvahAsyncDiffer$$ExternalSyntheticLambda1
            ...
            public final void run() {
                BrvahAsyncDiffer.m6375submitList$lambda1(this.f$0, data, newList, i, commitCallback);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: submitList$lambda-1, reason: not valid java name */
    public static final void m6375submitList$lambda1(final BrvahAsyncDiffer this$0, final List oldList, final List list, final int i, final Runnable runnable) {
        ...
        this$0.mMainThreadExecutor.execute(new Runnable() { // from class: com.chad.library.adapter.base.diff.BrvahAsyncDiffer$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                BrvahAsyncDiffer.m6376submitList$lambda1$lambda0(this.f$0, i, list, diffResultCalculateDiff, runnable);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: submitList$lambda-1$lambda-0, reason: not valid java name */
    public static final void m6376submitList$lambda1$lambda0(BrvahAsyncDiffer this$0, int i, List list, DiffUtil.DiffResult result, Runnable runnable) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
