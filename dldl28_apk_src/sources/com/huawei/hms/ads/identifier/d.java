...
public abstract class d {
    ...
    private static final byte[] f487a = new byte[0];
    ...
    public static class a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private static final Long f489a = 120000L;
        ...
        public boolean c() {
            synchronized (this.g) {
                ...
                return j + f489a.longValue() > System.currentTimeMillis();
            }
        }
    ...
    private static String f(Context context) {
        ...
        e.f490a.execute(new Runnable() { // from class: com.huawei.hms.ads.identifier.d.1
