...
public interface IShapeDrawableStyleable {
    ...
    /* JADX INFO: renamed from: com.hjq.shape.config.IShapeDrawableStyleable$-CC, reason: invalid class name */
    public final /* synthetic */ class CC {
        public static int $default$getSolidCheckedColorStyleable(IShapeDrawableStyleable _this) {
            return 0;
        }

        public static int $default$getStrokeCheckedColorStyleable(IShapeDrawableStyleable _this) {
            return 0;
        }
    }
