...
public final class JsonHelper {
    ...
    static final class a implements Serializable, GenericArrayType {
        ...
        private final Type f839a;

        public a(Type type) {
            this.f839a = JsonHelper.canonicalize(type);
        }
        ...
        public final String toString() {
            return JsonHelper.typeToString(this.f839a) + HttpUrl.PATH_SEGMENT_ENCODE_SET_URI;
        }
    }
    ...
    static final class b implements Serializable, ParameterizedType {
        ...
        public b(Type type, Type type2, Type... typeArr) {
            ...
            this.f840a = type == null ? null : JsonHelper.canonicalize(type);
        ...
        public final int hashCode() {
            return (Arrays.hashCode(this.c) ^ this.b.hashCode()) ^ JsonHelper.hashCodeOrZero(this.f840a);
        }
    ...
    static final class c implements Serializable, WildcardType {
        ...
        public final Type[] getUpperBounds() {
            return new Type[]{this.f841a};
        }

        public final int hashCode() {
            Type type = this.b;
            return (type != null ? type.hashCode() + 31 : 1) ^ (this.f841a.hashCode() + 31);
        }
