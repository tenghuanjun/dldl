...
public final class HttpUriFetcher implements Fetcher {
    ...
    /* JADX INFO: compiled from: HttpUriFetcher.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    @DebugMetadata(c = "coil.fetch.HttpUriFetcher", f = "HttpUriFetcher.kt", i = {0, 0, 0, 1, 1, 1}, l = {77, 106}, m = "fetch", n = {"this", "snapshot", "cacheStrategy", "this", "snapshot", CommonConstants.KEY_RESPONSE}, s = {"L$0", "L$1", "L$2", "L$0", "L$1", "L$2"})
