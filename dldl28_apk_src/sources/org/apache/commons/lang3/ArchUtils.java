...
public class ArchUtils {
    ...
    private static void init_X86_32Bit() {
        addProcessors(new Processor(Processor.Arch.BIT_32, Processor.Type.X86), InternalConstants.ABI_x86_str, "i386", "i486", "i586", "i686", "pentium");
    }

    private static void init_X86_64Bit() {
        addProcessors(new Processor(Processor.Arch.BIT_64, Processor.Type.X86), InternalConstants.ABI_x86_64_str, "amd64", "em64t", "universal");
    }
    ...
    private static void addProcessors(final Processor processor, String... strArr) {
        Stream.of((Object[]) strArr).forEach(new Consumer() { // from class: org.apache.commons.lang3.ArchUtils$$ExternalSyntheticLambda2
