...
public final class AndroidDefaultTypeface implements AndroidTypeface {
    ...
    public Typeface mo5614getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        if (Build.VERSION.SDK_INT < 28) {
            return Typeface.defaultFromStyle(AndroidFontUtils_androidKt.m5433getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle));
        }
        return TypefaceHelperMethodsApi28.INSTANCE.create(Typeface.DEFAULT, fontWeight.getWeight(), FontStyle.m5480equalsimpl0(fontStyle, FontStyle.INSTANCE.m5486getItalic_LCdwA()));
    }
}
