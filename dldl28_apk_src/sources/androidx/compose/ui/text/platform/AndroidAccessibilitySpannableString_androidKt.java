...
public final class AndroidAccessibilitySpannableString_androidKt {
    ...
    private static final void setSpanStyle(SpannableString spannableString, SpanStyle spanStyle, int i, int i2, Density density, FontFamily.Resolver resolver) {
        ...
        SpannableExtensions_androidKt.m5639setColorRPmYEkk(spannableString2, spanStyle.m5327getColor0d7_KjU(), i, i2);
        SpannableExtensions_androidKt.m5640setFontSizeKmRG4DE(spannableString2, spanStyle.getFontSize(), density, i, i2);
        if (spanStyle.getFontWeight() != null || spanStyle.getFontStyle() != null) {
            ...
            spannableString.setSpan(new StyleSpan(AndroidFontUtils_androidKt.m5433getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle != null ? fontStyle.m5483unboximpl() : FontStyle.INSTANCE.m5487getNormal_LCdwA())), i, i2, 33);
        }
        if (spanStyle.getFontFamily() != null) {
            if (spanStyle.getFontFamily() instanceof GenericFontFamily) {
                ...
                Object value = FontFamily.Resolver.CC.m5455resolveDPcqOEQ$default(resolver, fontFamily, null, 0, fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m5497getAllGVVA2EU(), 6, null).getValue();
        ...
        SpannableExtensions_androidKt.m5637setBackgroundRPmYEkk(spannableString2, spanStyle.getBackground(), i, i2);
    }
}
