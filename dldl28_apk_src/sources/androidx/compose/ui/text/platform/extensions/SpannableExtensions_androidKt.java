...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(Spannable spannable, TextIndent textIndent, float f, Density density) {
        float fM6077getValueimpl;
        if (textIndent != null) {
            if ((TextUnit.m6074equalsimpl0(textIndent.getFirstLine(), TextUnitKt.getSp(0)) && TextUnit.m6074equalsimpl0(textIndent.getRestLine(), TextUnitKt.getSp(0))) || TextUnitKt.m6095isUnspecifiedR2X_6o(textIndent.getFirstLine()) || TextUnitKt.m6095isUnspecifiedR2X_6o(textIndent.getRestLine())) {
                return;
            }
            long jM6076getTypeUIouoOA = TextUnit.m6076getTypeUIouoOA(textIndent.getFirstLine());
            float fM6077getValueimpl2 = 0.0f;
            if (TextUnitType.m6105equalsimpl0(jM6076getTypeUIouoOA, TextUnitType.INSTANCE.m6110getSpUIouoOA())) {
                fM6077getValueimpl = density.mo344toPxR2X_6o(textIndent.getFirstLine());
            } else {
                fM6077getValueimpl = TextUnitType.m6105equalsimpl0(jM6076getTypeUIouoOA, TextUnitType.INSTANCE.m6109getEmUIouoOA()) ? TextUnit.m6077getValueimpl(textIndent.getFirstLine()) * f : 0.0f;
            }
            long jM6076getTypeUIouoOA2 = TextUnit.m6076getTypeUIouoOA(textIndent.getRestLine());
            if (TextUnitType.m6105equalsimpl0(jM6076getTypeUIouoOA2, TextUnitType.INSTANCE.m6110getSpUIouoOA())) {
                fM6077getValueimpl2 = density.mo344toPxR2X_6o(textIndent.getRestLine());
            } else if (TextUnitType.m6105equalsimpl0(jM6076getTypeUIouoOA2, TextUnitType.INSTANCE.m6109getEmUIouoOA())) {
                fM6077getValueimpl2 = TextUnit.m6077getValueimpl(textIndent.getRestLine()) * f;
            }
            setSpan(spannable, new LeadingMarginSpan.Standard((int) Math.ceil(fM6077getValueimpl), (int) Math.ceil(fM6077getValueimpl2)), 0, spannable.length());
        }
    }

    /* JADX INFO: renamed from: setLineHeight-KmRG4DE, reason: not valid java name */
    public static final void m5641setLineHeightKmRG4DE(Spannable spannable, long j, float f, Density density, LineHeightStyle lineHeightStyle) {
        float fM5636resolveLineHeightInPxo2QH7mI = m5636resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(fM5636resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        Spannable spannable2 = spannable;
        setSpan(spannable, new LineHeightStyleSpan(fM5636resolveLineHeightInPxo2QH7mI, 0, (spannable2.length() == 0 || StringsKt.last(spannable2) == '\n') ? spannable.length() + 1 : spannable.length(), LineHeightStyle.Trim.m5749isTrimFirstLineTopimpl$ui_text_release(lineHeightStyle.getTrim()), LineHeightStyle.Trim.m5750isTrimLastLineBottomimpl$ui_text_release(lineHeightStyle.getTrim()), lineHeightStyle.getAlignment()), 0, spannable.length());
    }

    /* JADX INFO: renamed from: setLineHeight-r9BaKPg, reason: not valid java name */
    public static final void m5642setLineHeightr9BaKPg(Spannable spannable, long j, float f, Density density) {
        float fM5636resolveLineHeightInPxo2QH7mI = m5636resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(fM5636resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        setSpan(spannable, new LineHeightSpan(fM5636resolveLineHeightInPxo2QH7mI), 0, spannable.length());
    }

    /* JADX INFO: renamed from: resolveLineHeightInPx-o2QH7mI, reason: not valid java name */
    private static final float m5636resolveLineHeightInPxo2QH7mI(long j, float f, Density density) {
        float fM6077getValueimpl;
        long jM6076getTypeUIouoOA = TextUnit.m6076getTypeUIouoOA(j);
        if (TextUnitType.m6105equalsimpl0(jM6076getTypeUIouoOA, TextUnitType.INSTANCE.m6110getSpUIouoOA())) {
            if (!isNonLinearFontScalingActive(density)) {
                return density.mo344toPxR2X_6o(j);
            }
            fM6077getValueimpl = TextUnit.m6077getValueimpl(j) / TextUnit.m6077getValueimpl(density.mo348toSpkPz2Gy4(f));
        } else {
            if (!TextUnitType.m6105equalsimpl0(jM6076getTypeUIouoOA, TextUnitType.INSTANCE.m6109getEmUIouoOA())) {
                return Float.NaN;
            }
            fM6077getValueimpl = TextUnit.m6077getValueimpl(j);
        }
        return fM6077getValueimpl * f;
    }
    ...
    public static final void setSpanStyles(Spannable spannable, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        MetricAffectingSpan metricAffectingSpanM5635createLetterSpacingSpaneAf_CNQ;
        ...
        if (z) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (start2 >= 0 && start2 < spannable.length() && end2 > start2 && end2 <= spannable.length() && (metricAffectingSpanM5635createLetterSpacingSpaneAf_CNQ = m5635createLetterSpacingSpaneAf_CNQ(item.getLetterSpacing(), density)) != null) {
                    setSpan(spannable, metricAffectingSpanM5635createLetterSpacingSpaneAf_CNQ, start2, end2);
                }
            }
        }
    }
    ...
    private static final void setSpanStyle(Spannable spannable, AnnotatedString.Range<SpanStyle> range, Density density) {
        ...
        m5638setBaselineShift0ocSgnM(spannable, item.getBaselineShift(), start, end);
        m5639setColorRPmYEkk(spannable, item.m5327getColor0d7_KjU(), start, end);
        setBrush(spannable, item.getBrush(), item.getAlpha(), start, end);
        setTextDecoration(spannable, item.getTextDecoration(), start, end);
        m5640setFontSizeKmRG4DE(spannable, item.getFontSize(), density, start, end);
        ...
        m5637setBackgroundRPmYEkk(spannable, item.getBackground(), start, end);
    ...
    private static final MetricAffectingSpan m5635createLetterSpacingSpaneAf_CNQ(long j, Density density) {
        long jM6076getTypeUIouoOA = TextUnit.m6076getTypeUIouoOA(j);
        if (TextUnitType.m6105equalsimpl0(jM6076getTypeUIouoOA, TextUnitType.INSTANCE.m6110getSpUIouoOA())) {
            return new LetterSpacingSpanPx(density.mo344toPxR2X_6o(j));
        }
        if (TextUnitType.m6105equalsimpl0(jM6076getTypeUIouoOA, TextUnitType.INSTANCE.m6109getEmUIouoOA())) {
            return new LetterSpacingSpanEm(TextUnit.m6077getValueimpl(j));
        }
        return null;
    }

    private static final boolean getNeedsLetterSpacingSpan(SpanStyle spanStyle) {
        return TextUnitType.m6105equalsimpl0(TextUnit.m6076getTypeUIouoOA(spanStyle.getLetterSpacing()), TextUnitType.INSTANCE.m6110getSpUIouoOA()) || TextUnitType.m6105equalsimpl0(TextUnit.m6076getTypeUIouoOA(spanStyle.getLetterSpacing()), TextUnitType.INSTANCE.m6109getEmUIouoOA());
    }

    private static final void setShadow(Spannable spannable, Shadow shadow, int i, int i2) {
        if (shadow != null) {
            setSpan(spannable, new ShadowSpan(ColorKt.m3548toArgb8_81llA(shadow.getColor()), Offset.m3219getXimpl(shadow.getOffset()), Offset.m3220getYimpl(shadow.getOffset()), TextPaintExtensions_androidKt.correctBlurRadius(shadow.getBlurRadius())), i, i2);
        }
    }
    ...
    public static final void m5640setFontSizeKmRG4DE(Spannable spannable, long j, Density density, int i, int i2) {
        long jM6076getTypeUIouoOA = TextUnit.m6076getTypeUIouoOA(j);
        if (TextUnitType.m6105equalsimpl0(jM6076getTypeUIouoOA, TextUnitType.INSTANCE.m6110getSpUIouoOA())) {
            setSpan(spannable, new AbsoluteSizeSpan(MathKt.roundToInt(density.mo344toPxR2X_6o(j)), false), i, i2);
        } else if (TextUnitType.m6105equalsimpl0(jM6076getTypeUIouoOA, TextUnitType.INSTANCE.m6109getEmUIouoOA())) {
            setSpan(spannable, new RelativeSizeSpan(TextUnit.m6077getValueimpl(j)), i, i2);
        }
    }
    ...
    private static final void m5638setBaselineShift0ocSgnM(Spannable spannable, BaselineShift baselineShift, int i, int i2) {
        if (baselineShift != null) {
            setSpan(spannable, new BaselineShiftSpan(baselineShift.m5654unboximpl()), i, i2);
        }
    }
    ...
    private static final void setBrush(Spannable spannable, Brush brush, float f, int i, int i2) {
        if (brush != null) {
            if (brush instanceof SolidColor) {
                m5639setColorRPmYEkk(spannable, ((SolidColor) brush).getValue(), i, i2);
    ...
    private static final boolean hasFontAttributes(TextStyle textStyle) {
        return TextPaintExtensions_androidKt.hasFontAttributes(textStyle.toSpanStyle()) || textStyle.m5401getFontSynthesisZQGJjVo() != null;
    }
    ...
    private static final void setFontAttributes(final Spannable spannable, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, final Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        ...
        flattenFontStylesAndApply(hasFontAttributes(textStyle) ? new SpanStyle(0L, 0L, textStyle.getFontWeight(), textStyle.m5400getFontStyle4Lr2A7w(), textStyle.m5401getFontSynthesisZQGJjVo(), textStyle.getFontFamily(), (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65475, (DefaultConstructorMarker) null) : null, arrayList2, new Function3<SpanStyle, Integer, Integer, Unit>() { // from class: androidx.compose.ui.text.platform.extensions.SpannableExtensions_androidKt.setFontAttributes.1
            ...
            public final void invoke(SpanStyle spanStyle, int i2, int i3) {
                ...
                FontStyle fontStyleM5477boximpl = FontStyle.m5477boximpl(fontStyle != null ? fontStyle.m5483unboximpl() : FontStyle.INSTANCE.m5487getNormal_LCdwA());
                FontSynthesis fontSynthesis = spanStyle.getFontSynthesis();
                spannable2.setSpan(new TypefaceSpan(function42.invoke(fontFamily, fontWeight, fontStyleM5477boximpl, FontSynthesis.m5488boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m5497getAllGVVA2EU()))), i2, i3, 33);
            }
        });
    }

    /* JADX INFO: renamed from: setBackground-RPmYEkk, reason: not valid java name */
    public static final void m5637setBackgroundRPmYEkk(Spannable spannable, long j, int i, int i2) {
        if (j != Color.INSTANCE.m3530getUnspecified0d7_KjU()) {
            setSpan(spannable, new BackgroundColorSpan(ColorKt.m3548toArgb8_81llA(j)), i, i2);
        }
    }

    /* JADX INFO: renamed from: setColor-RPmYEkk, reason: not valid java name */
    public static final void m5639setColorRPmYEkk(Spannable spannable, long j, int i, int i2) {
        if (j != Color.INSTANCE.m3530getUnspecified0d7_KjU()) {
            setSpan(spannable, new ForegroundColorSpan(ColorKt.m3548toArgb8_81llA(j)), i, i2);
        }
    }
}
