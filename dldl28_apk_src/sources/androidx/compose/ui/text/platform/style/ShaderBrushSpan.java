...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    private final MutableState size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m3276boximpl(Size.INSTANCE.m3296getUnspecifiedNHjbRc()), null, 2, null);
    private final State<Shader> shaderState = SnapshotStateKt.derivedStateOf(new Function0<Shader>() { // from class: androidx.compose.ui.text.platform.style.ShaderBrushSpan$shaderState$1
        ...
        public final Shader invoke() {
            if (this.this$0.m5646getSizeNHjbRc() == Size.INSTANCE.m3296getUnspecifiedNHjbRc() || Size.m3290isEmptyimpl(this.this$0.m5646getSizeNHjbRc())) {
                return null;
            }
            return this.this$0.getShaderBrush().mo3463createShaderuvyYCjk(this.this$0.m5646getSizeNHjbRc());
        }
    });
