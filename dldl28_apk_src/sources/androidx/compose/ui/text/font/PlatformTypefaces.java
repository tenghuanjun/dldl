...
public interface PlatformTypefaces {
    ...
    android.graphics.Typeface mo5507createDefaultFO1MlWM(FontWeight fontWeight, int fontStyle);

    /* JADX INFO: renamed from: createNamed-RetOiIg, reason: not valid java name */
    android.graphics.Typeface mo5508createNamedRetOiIg(GenericFontFamily name, FontWeight fontWeight, int fontStyle);

    /* JADX INFO: renamed from: optionalOnDeviceFontFamilyByName-78DK7lM, reason: not valid java name */
    android.graphics.Typeface mo5509optionalOnDeviceFontFamilyByName78DK7lM(String familyName, FontWeight weight, int style, FontVariation.Settings variationSettings, Context context);
}
