...
public final class ResourceFont implements Font {
    ...
    public static /* synthetic */ void m5518getLoadingStrategyPKNRLFQ$annotations() {
    }
    ...
    public /* synthetic */ ResourceFont(int i, FontWeight fontWeight, int i2, FontVariation.Settings settings, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        int iM5487getNormal_LCdwA = (i4 & 4) != 0 ? FontStyle.INSTANCE.m5487getNormal_LCdwA() : i2;
        this(i, normal, iM5487getNormal_LCdwA, (i4 & 8) != 0 ? FontVariation.INSTANCE.m5502Settings6EWAqTQ(normal, iM5487getNormal_LCdwA, new FontVariation.Setting[0]) : settings, (i4 & 16) != 0 ? FontLoadingStrategy.INSTANCE.m5471getAsyncPKNRLFQ() : i3, null);
    }
    ...
    public static /* synthetic */ ResourceFont m5517copyRetOiIg$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        return resourceFont.m5520copyRetOiIg(i, fontWeight, i2);
    }

    /* JADX INFO: renamed from: copy-RetOiIg, reason: not valid java name */
    public final ResourceFont m5520copyRetOiIg(int resId, FontWeight weight, int style) {
        return m5516copyF3nL8kk$default(this, resId, weight, style, getLoadingStrategy(), null, 16, null);
    }

    /* JADX INFO: renamed from: copy-F3nL8kk$default, reason: not valid java name */
    public static /* synthetic */ ResourceFont m5516copyF3nL8kk$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = resourceFont.resId;
        }
        if ((i4 & 2) != 0) {
        ...
        return resourceFont.m5519copyF3nL8kk(i, fontWeight2, i5, i6, settings);
    }

    /* JADX INFO: renamed from: copy-F3nL8kk, reason: not valid java name */
    public final ResourceFont m5519copyF3nL8kk(int resId, FontWeight weight, int style, int loadingStrategy, FontVariation.Settings variationSettings) {
    ...
    public boolean equals(Object other) {
        ...
        return this.resId == resourceFont.resId && Intrinsics.areEqual(getWeight(), resourceFont.getWeight()) && FontStyle.m5480equalsimpl0(getStyle(), resourceFont.getStyle()) && Intrinsics.areEqual(this.variationSettings, resourceFont.variationSettings) && FontLoadingStrategy.m5467equalsimpl0(getLoadingStrategy(), resourceFont.getLoadingStrategy());
    }

    public int hashCode() {
        return (((((((this.resId * 31) + getWeight().hashCode()) * 31) + FontStyle.m5481hashCodeimpl(getStyle())) * 31) + FontLoadingStrategy.m5468hashCodeimpl(getLoadingStrategy())) * 31) + this.variationSettings.hashCode();
    }

    public String toString() {
        return "ResourceFont(resId=" + this.resId + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m5482toStringimpl(getStyle())) + ", loadingStrategy=" + ((Object) FontLoadingStrategy.m5469toStringimpl(getLoadingStrategy())) + ')';
    }
}
