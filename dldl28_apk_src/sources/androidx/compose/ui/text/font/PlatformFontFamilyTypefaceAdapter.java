...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        android.graphics.Typeface typefaceMo5614getNativeTypefacePYhJU0U;
        FontFamily fontFamily = typefaceRequest.getFontFamily();
        if (fontFamily == null ? true : fontFamily instanceof DefaultFontFamily) {
            typefaceMo5614getNativeTypefacePYhJU0U = this.platformTypefaceResolver.mo5507createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m5525getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            typefaceMo5614getNativeTypefacePYhJU0U = this.platformTypefaceResolver.mo5508createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m5525getFontStyle_LCdwA());
        } else {
            ...
            typefaceMo5614getNativeTypefacePYhJU0U = ((AndroidTypeface) typeface).mo5614getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m5525getFontStyle_LCdwA(), typefaceRequest.m5526getFontSynthesisGVVA2EU());
        }
        return new TypefaceResult.Immutable(typefaceMo5614getNativeTypefacePYhJU0U, false, 2, null);
    }
}
