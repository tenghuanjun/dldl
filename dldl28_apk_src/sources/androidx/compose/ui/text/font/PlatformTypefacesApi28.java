...
final class PlatformTypefacesApi28 implements PlatformTypefaces {
    ...
    public android.graphics.Typeface mo5509optionalOnDeviceFontFamilyByName78DK7lM(String familyName, FontWeight weight, int style, FontVariation.Settings variationSettings, Context context) {
        ...
        if (Intrinsics.areEqual(familyName, FontFamily.INSTANCE.getSansSerif().getName())) {
            ...
            typefaceMo5508createNamedRetOiIg = Intrinsics.areEqual(familyName, FontFamily.INSTANCE.getCursive().getName()) ? mo5508createNamedRetOiIg(FontFamily.INSTANCE.getCursive(), weight, style) : m5515loadNamedFromTypefaceCacheOrNullRetOiIg(familyName, weight, style);
        }
    ...
    public android.graphics.Typeface mo5507createDefaultFO1MlWM(FontWeight fontWeight, int fontStyle) {
        return m5513createAndroidTypefaceApi28RetOiIg(null, fontWeight, fontStyle);
    }
    ...
    public android.graphics.Typeface mo5508createNamedRetOiIg(GenericFontFamily name, FontWeight fontWeight, int fontStyle) {
        return m5513createAndroidTypefaceApi28RetOiIg(name.getName(), fontWeight, fontStyle);
    }

    /* JADX INFO: renamed from: loadNamedFromTypefaceCacheOrNull-RetOiIg, reason: not valid java name */
    private final android.graphics.Typeface m5515loadNamedFromTypefaceCacheOrNullRetOiIg(String familyName, FontWeight weight, int style) {
        if (familyName.length() == 0) {
            return null;
        }
        android.graphics.Typeface typefaceM5513createAndroidTypefaceApi28RetOiIg = m5513createAndroidTypefaceApi28RetOiIg(familyName, weight, style);
        if (Intrinsics.areEqual(typefaceM5513createAndroidTypefaceApi28RetOiIg, TypefaceHelperMethodsApi28.INSTANCE.create(android.graphics.Typeface.DEFAULT, weight.getWeight(), FontStyle.m5480equalsimpl0(style, FontStyle.INSTANCE.m5486getItalic_LCdwA()))) || Intrinsics.areEqual(typefaceM5513createAndroidTypefaceApi28RetOiIg, m5513createAndroidTypefaceApi28RetOiIg(null, weight, style))) {
            return null;
        }
        return typefaceM5513createAndroidTypefaceApi28RetOiIg;
    }

    /* JADX INFO: renamed from: createAndroidTypefaceApi28-RetOiIg$default, reason: not valid java name */
    static /* synthetic */ android.graphics.Typeface m5514createAndroidTypefaceApi28RetOiIg$default(PlatformTypefacesApi28 platformTypefacesApi28, String str, FontWeight fontWeight, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            str = null;
        }
        return platformTypefacesApi28.m5513createAndroidTypefaceApi28RetOiIg(str, fontWeight, i);
    }

    /* JADX INFO: renamed from: createAndroidTypefaceApi28-RetOiIg, reason: not valid java name */
    private final android.graphics.Typeface m5513createAndroidTypefaceApi28RetOiIg(String genericFontFamily, FontWeight fontWeight, int fontStyle) {
        ...
        return android.graphics.Typeface.create(typefaceCreate, fontWeight.getWeight(), FontStyle.m5480equalsimpl0(fontStyle, FontStyle.INSTANCE.m5486getItalic_LCdwA()));
    }
}
