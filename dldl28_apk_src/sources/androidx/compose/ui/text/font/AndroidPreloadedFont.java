...
public abstract class AndroidPreloadedFont extends AndroidFont {
    ...
    private AndroidPreloadedFont(FontWeight fontWeight, int i, FontVariation.Settings settings) {
        super(FontLoadingStrategy.INSTANCE.m5472getBlockingPKNRLFQ(), AndroidPreloadedFontTypefaceLoader.INSTANCE, settings, null);
        this.weight = fontWeight;
        this.style = i;
    }

    /* JADX INFO: renamed from: getTypeface$ui_text_release, reason: from getter */
