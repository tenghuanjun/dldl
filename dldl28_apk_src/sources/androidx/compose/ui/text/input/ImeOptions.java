...
public final class ImeOptions {
    ...
    public /* synthetic */ ImeOptions(boolean z, int i, boolean z2, int i2, int i3, PlatformImeOptions platformImeOptions, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? false : z, (i4 & 2) != 0 ? KeyboardCapitalization.INSTANCE.m5576getNoneIUNYP9k() : i, (i4 & 4) != 0 ? true : z2, (i4 & 8) != 0 ? KeyboardType.INSTANCE.m5602getTextPjHm6EE() : i2, (i4 & 16) != 0 ? ImeAction.INSTANCE.m5547getDefaulteUduSuo() : i3, (i4 & 32) != 0 ? null : platformImeOptions, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ ImeOptions(boolean z, int i, boolean z2, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? false : z, (i4 & 2) != 0 ? KeyboardCapitalization.INSTANCE.m5576getNoneIUNYP9k() : i, (i4 & 4) != 0 ? true : z2, (i4 & 8) != 0 ? KeyboardType.INSTANCE.m5602getTextPjHm6EE() : i2, (i4 & 16) != 0 ? ImeAction.INSTANCE.m5547getDefaulteUduSuo() : i3, (DefaultConstructorMarker) null);
    }
    ...
    public static /* synthetic */ ImeOptions m5555copyYTHSh70$default(ImeOptions imeOptions, boolean z, int i, boolean z2, int i2, int i3, PlatformImeOptions platformImeOptions, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        return imeOptions.m5557copyYTHSh70(z, i5, z3, i6, i7, platformImeOptions);
    }

    /* JADX INFO: renamed from: copy-YTHSh70, reason: not valid java name */
    public final ImeOptions m5557copyYTHSh70(boolean singleLine, int capitalization, boolean autoCorrect, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions) {
    ...
    public static /* synthetic */ ImeOptions m5556copyuxg59PA$default(ImeOptions imeOptions, boolean z, int i, boolean z2, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            z = imeOptions.singleLine;
        }
        if ((i4 & 2) != 0) {
        ...
        return imeOptions.m5558copyuxg59PA(z, i5, z3, i6, i3);
    }
    ...
    public final /* synthetic */ ImeOptions m5558copyuxg59PA(boolean singleLine, int capitalization, boolean autoCorrect, int keyboardType, int imeAction) {
    ...
    public boolean equals(Object other) {
        ...
        return this.singleLine == imeOptions.singleLine && KeyboardCapitalization.m5567equalsimpl0(this.capitalization, imeOptions.capitalization) && this.autoCorrect == imeOptions.autoCorrect && KeyboardType.m5582equalsimpl0(this.keyboardType, imeOptions.keyboardType) && ImeAction.m5535equalsimpl0(this.imeAction, imeOptions.imeAction) && Intrinsics.areEqual(this.platformImeOptions, imeOptions.platformImeOptions);
    }

    public int hashCode() {
        int iM = ((((((((UByte$$ExternalSyntheticBackport0.m(this.singleLine) * 31) + KeyboardCapitalization.m5568hashCodeimpl(this.capitalization)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.autoCorrect)) * 31) + KeyboardType.m5583hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m5536hashCodeimpl(this.imeAction)) * 31;
        PlatformImeOptions platformImeOptions = this.platformImeOptions;
        return iM + (platformImeOptions != null ? platformImeOptions.hashCode() : 0);
    }

    public String toString() {
        return "ImeOptions(singleLine=" + this.singleLine + ", capitalization=" + ((Object) KeyboardCapitalization.m5569toStringimpl(this.capitalization)) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + ((Object) KeyboardType.m5584toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m5537toStringimpl(this.imeAction)) + ", platformImeOptions=" + this.platformImeOptions + ')';
    }
}
