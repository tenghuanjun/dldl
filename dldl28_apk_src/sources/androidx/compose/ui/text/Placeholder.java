...
public final class Placeholder {
    ...
    private Placeholder(long j, long j2, int i) {
        ...
        if (TextUnitKt.m6095isUnspecifiedR2X_6o(j2)) {
    ...
    public static /* synthetic */ Placeholder m5287copyK8Q__8$default(Placeholder placeholder, long j, long j2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            j = placeholder.width;
        }
        long j3 = j;
        ...
        return placeholder.m5288copyK8Q__8(j3, j4, i);
    }

    /* JADX INFO: renamed from: copy-K8Q-__8, reason: not valid java name */
    public final Placeholder m5288copyK8Q__8(long width, long height, int placeholderVerticalAlign) {
    ...
    public boolean equals(Object other) {
        ...
        return TextUnit.m6074equalsimpl0(this.width, placeholder.width) && TextUnit.m6074equalsimpl0(this.height, placeholder.height) && PlaceholderVerticalAlign.m5295equalsimpl0(this.placeholderVerticalAlign, placeholder.placeholderVerticalAlign);
    }

    public int hashCode() {
        return (((TextUnit.m6078hashCodeimpl(this.width) * 31) + TextUnit.m6078hashCodeimpl(this.height)) * 31) + PlaceholderVerticalAlign.m5296hashCodeimpl(this.placeholderVerticalAlign);
    }

    public String toString() {
        return "Placeholder(width=" + ((Object) TextUnit.m6084toStringimpl(this.width)) + ", height=" + ((Object) TextUnit.m6084toStringimpl(this.height)) + ", placeholderVerticalAlign=" + ((Object) PlaceholderVerticalAlign.m5297toStringimpl(this.placeholderVerticalAlign)) + ')';
    }
}
