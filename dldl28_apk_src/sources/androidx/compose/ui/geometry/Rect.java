...
public final /* data */ class Rect {
    ...
    public static /* synthetic */ void m3244getSizeNHjbRc$annotations() {
    }
    ...
    public final long m3252getSizeNHjbRc() {
    ...
    public final Rect m3256translatek4lQ0M(long offset) {
        return new Rect(this.left + Offset.m3219getXimpl(offset), this.top + Offset.m3220getYimpl(offset), this.right + Offset.m3219getXimpl(offset), this.bottom + Offset.m3220getYimpl(offset));
    }
    ...
    public final long m3251getCenterRightF1C5BW0() {
    ...
    public final long m3248getBottomRightF1C5BW0() {
        return OffsetKt.Offset(this.right, this.bottom);
    }

    /* JADX INFO: renamed from: contains-k-4lQ0M, reason: not valid java name */
    public final boolean m3245containsk4lQ0M(long offset) {
        return Offset.m3219getXimpl(offset) >= this.left && Offset.m3219getXimpl(offset) < this.right && Offset.m3220getYimpl(offset) >= this.top && Offset.m3220getYimpl(offset) < this.bottom;
    }
