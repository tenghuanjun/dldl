...
public final class AndroidAutofill implements Autofill {
    ...
    public AndroidAutofill(View view, AutofillTree autofillTree) {
        ...
        AutofillManager autofillManagerM8m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m8m(view.getContext().getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m13m()));
        if (autofillManagerM8m == null) {
            throw new IllegalStateException("Autofill service could not be located.".toString());
        }
        this.autofillManager = autofillManagerM8m;
