...
public final /* data */ class BiasAlignment implements Alignment {
    ...
    public long mo3096alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        float f;
        float fM6056getWidthimpl = (IntSize.m6056getWidthimpl(space) - IntSize.m6056getWidthimpl(size)) / 2.0f;
        float fM6055getHeightimpl = (IntSize.m6055getHeightimpl(space) - IntSize.m6055getHeightimpl(size)) / 2.0f;
        ...
        float f2 = 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt(fM6056getWidthimpl * (f + f2)), MathKt.roundToInt(fM6055getHeightimpl * (f2 + this.verticalBias)));
    }
