...
final class DialogLayout extends AbstractComposeView implements DialogWindowProvider {
    ...
    public DialogLayout(Context context, Window window) {
        ...
        this.window = window;
        this.content = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$AndroidDialog_androidKt.INSTANCE.m6137getLambda1$ui_release(), null, 2, null);
    }
    ...
    public void Content(Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(Content)269@10475L9:AndroidDialog.android.kt#2oxthz");
