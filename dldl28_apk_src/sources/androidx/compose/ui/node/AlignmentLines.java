...
public abstract class AlignmentLines {
    ...
    protected abstract long mo4874calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        while (true) {
            jOffset = mo4874calculatePositionInParentR5De75A(initialCoordinator, jOffset);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            iRoundToInt = MathKt.roundToInt(Offset.m3220getYimpl(jOffset));
        } else {
            iRoundToInt = MathKt.roundToInt(Offset.m3219getXimpl(jOffset));
        }
        Map<AlignmentLine, Integer> map = this.alignmentLineMap;
        if (map.containsKey(alignmentLine)) {
            iRoundToInt = AlignmentLineKt.merge(alignmentLine, ((Number) MapsKt.getValue(this.alignmentLineMap, alignmentLine)).intValue(), iRoundToInt);
        }
