...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public void m4946setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public final void set_measureResult(MeasureResult measureResult) {
        ...
        if (measureResult != null) {
            m4834setMeasuredSizeozmzZPI(IntSizeKt.IntSize(measureResult.getWidth(), measureResult.getHeight()));
            unit = Unit.INSTANCE;
        } else {
            unit = null;
        }
        if (unit == null) {
            m4834setMeasuredSizeozmzZPI(IntSize.INSTANCE.m6061getZeroYbymL2g());
        }
    ...
    public void replace$ui_release() {
        mo4784placeAtf8xVGno(getPosition(), 0.0f, null);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // androidx.compose.ui.layout.Placeable
    /* JADX INFO: renamed from: placeAt-f8xVGno */
    public final void mo4784placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        m4942placeSelfgyyYBs(position);
    ...
    private final void m4942placeSelfgyyYBs(long position) {
        if (IntOffset.m6013equalsimpl0(getPosition(), position)) {
            return;
        }
        m4946setPositiongyyYBs(position);
    ...
    public final void m4944placeSelfApparentToRealOffsetgyyYBs$ui_release(long position) {
        long j = getApparentToRealOffset();
        m4942placeSelfgyyYBs(IntOffsetKt.IntOffset(IntOffset.m6014getXimpl(position) + IntOffset.m6014getXimpl(j), IntOffset.m6015getYimpl(position) + IntOffset.m6015getYimpl(j)));
    }
    ...
    public final Placeable m4943performingMeasureK40F9xA(long constraints, Function0<? extends MeasureResult> block) {
    ...
    public final long m4945positionInBjo55l4$ui_release(LookaheadDelegate ancestor) {
        long jM6024getZeronOccac = IntOffset.INSTANCE.m6024getZeronOccac();
        ...
        while (!Intrinsics.areEqual(lookaheadDelegate, ancestor)) {
            ...
            jM6024getZeronOccac = IntOffsetKt.IntOffset(IntOffset.m6014getXimpl(jM6024getZeronOccac) + IntOffset.m6014getXimpl(position), IntOffset.m6015getYimpl(jM6024getZeronOccac) + IntOffset.m6015getYimpl(position));
