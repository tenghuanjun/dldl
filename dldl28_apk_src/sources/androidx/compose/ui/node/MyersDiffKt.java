...
public final class MyersDiffKt {
    private static final IntStack calculateDiff(int i, int i2, DiffCallback diffCallback) {
        ...
        int i4 = (i3 * 2) + 1;
        int[] iArrM4876constructorimpl = CenteredArray.m4876constructorimpl(new int[i4]);
        int[] iArrM4876constructorimpl2 = CenteredArray.m4876constructorimpl(new int[i4]);
        int[] iArrM5053constructorimpl = Snake.m5053constructorimpl(new int[5]);
        while (intStack2.isNotEmpty()) {
            int iPop = intStack2.pop();
            int iPop2 = intStack2.pop();
            int iPop3 = intStack2.pop();
            int iPop4 = intStack2.pop();
            int[] iArr = iArrM4876constructorimpl;
            int[] iArr2 = iArrM4876constructorimpl2;
            if (m4954midPointq5eDKzI(iPop4, iPop3, iPop2, iPop, diffCallback, iArrM4876constructorimpl, iArrM4876constructorimpl2, iArrM5053constructorimpl)) {
                if (Snake.m5056getDiagonalSizeimpl(iArrM5053constructorimpl) > 0) {
                    Snake.m5051addDiagonalToStackimpl(iArrM5053constructorimpl, intStack);
                }
                intStack2.pushRange(iPop4, Snake.m5061getStartXimpl(iArrM5053constructorimpl), iPop2, Snake.m5062getStartYimpl(iArrM5053constructorimpl));
                intStack2.pushRange(Snake.m5057getEndXimpl(iArrM5053constructorimpl), iPop3, Snake.m5058getEndYimpl(iArrM5053constructorimpl), iPop);
            }
            iArrM4876constructorimpl = iArr;
            iArrM4876constructorimpl2 = iArr2;
        }
    ...
    private static final boolean m4954midPointq5eDKzI(int i, int i2, int i3, int i4, DiffCallback diffCallback, int[] iArr, int[] iArr2, int[] iArr3) {
        int i5 = i2 - i;
        int i6 = i4 - i3;
        if (i5 >= 1 && i6 >= 1) {
            int i7 = ((i5 + i6) + 1) / 2;
            CenteredArray.m4882setimpl(iArr, 1, i);
            CenteredArray.m4882setimpl(iArr2, 1, i2);
            int i8 = 0;
            while (i8 < i7) {
                int i9 = i8;
                if (m4953forward4l5_RBY(i, i2, i3, i4, diffCallback, iArr, iArr2, i8, iArr3) || m4952backward4l5_RBY(i, i2, i3, i4, diffCallback, iArr, iArr2, i9, iArr3)) {
                    return true;
                }
                i8 = i9 + 1;
            }
    ...
    private static final boolean m4953forward4l5_RBY(int i, int i2, int i3, int i4, DiffCallback diffCallback, int[] iArr, int[] iArr2, int i5, int[] iArr3) {
        int iM4879getimpl;
        int i6;
        int i7;
        int i8 = (i2 - i) - (i4 - i3);
        ...
        for (int i10 = i9; i10 <= i5; i10 += 2) {
            if (i10 == i9 || (i10 != i5 && CenteredArray.m4879getimpl(iArr, i10 + 1) > CenteredArray.m4879getimpl(iArr, i10 - 1))) {
                iM4879getimpl = CenteredArray.m4879getimpl(iArr, i10 + 1);
                i6 = iM4879getimpl;
            } else {
                iM4879getimpl = CenteredArray.m4879getimpl(iArr, i10 - 1);
                i6 = iM4879getimpl + 1;
            ...
            int i11 = (i3 + (i6 - i)) - i10;
            int i12 = (i5 == 0 || i6 != iM4879getimpl) ? i11 : i11 - 1;
            while (i6 < i2 && i11 < i4) {
            ...
            CenteredArray.m4882setimpl(iArr, i10, i6);
            if (z && (i7 = i8 - i10) >= i9 + 1 && i7 <= i5 - 1) {
                if (CenteredArray.m4879getimpl(iArr2, i7) <= i6) {
                    fillSnake(iM4879getimpl, i12, i6, i11, false, iArr3);
                    return true;
                }
            }
        }
    ...
    private static final boolean m4952backward4l5_RBY(int i, int i2, int i3, int i4, DiffCallback diffCallback, int[] iArr, int[] iArr2, int i5, int[] iArr3) {
        int iM4879getimpl;
        int i6;
        int i7;
        int i8 = (i2 - i) - (i4 - i3);
        ...
        int i9 = -i5;
        for (int i10 = i9; i10 <= i5; i10 += 2) {
            if (i10 == i9 || (i10 != i5 && CenteredArray.m4879getimpl(iArr2, i10 + 1) < CenteredArray.m4879getimpl(iArr2, i10 - 1))) {
                iM4879getimpl = CenteredArray.m4879getimpl(iArr2, i10 + 1);
                i6 = iM4879getimpl;
            } else {
                iM4879getimpl = CenteredArray.m4879getimpl(iArr2, i10 - 1);
                i6 = iM4879getimpl - 1;
            ...
            CenteredArray.m4882setimpl(iArr2, i10, i6);
            if (z && (i7 = i8 - i10) >= i9 && i7 <= i5) {
                if (CenteredArray.m4879getimpl(iArr, i7) >= i6) {
                    fillSnake(i6, i11, iM4879getimpl, i12, true, iArr3);
                    return true;
                }
            }
        }
