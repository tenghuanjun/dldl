...
public interface Owner extends PlatformTextInputSessionHandler {
    ...
    long mo5046calculateLocalPositionMKHz9U(long positionInWindow);

    /* JADX INFO: renamed from: calculatePositionInWindow-MK-Hz9U, reason: not valid java name */
    long mo5047calculatePositionInWindowMKHz9U(long localPosition);
    ...
    FocusDirection mo5048getFocusDirectionP8AzH3I(KeyEvent keyEvent);
    ...
    void mo5049measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints);
