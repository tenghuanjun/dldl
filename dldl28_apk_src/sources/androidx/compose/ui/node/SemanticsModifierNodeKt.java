...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(Modifier.Node node, boolean z) {
        ...
        if (!z) {
            return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m4889requireCoordinator64DMado(node, NodeKind.m4993constructorimpl(8)));
        }
        return DelegatableNodeKt.m4889requireCoordinator64DMado(node, NodeKind.m4993constructorimpl(8)).touchBoundsInRoot();
    }
}
