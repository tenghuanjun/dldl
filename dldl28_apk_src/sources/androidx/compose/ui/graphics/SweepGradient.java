...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader mo3463createShaderuvyYCjk(long size) {
        ...
        if (OffsetKt.m3240isUnspecifiedk4lQ0M(this.center)) {
            jOffset = SizeKt.m3298getCenteruvyYCjk(size);
        } else {
            jOffset = OffsetKt.Offset(Offset.m3219getXimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m3288getWidthimpl(size) : Offset.m3219getXimpl(this.center), Offset.m3220getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m3285getHeightimpl(size) : Offset.m3220getYimpl(this.center));
        }
        return ShaderKt.m3821SweepGradientShader9KIMszo(jOffset, this.colors, this.stops);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Offset.m3216equalsimpl0(this.center, sweepGradient.center) && Intrinsics.areEqual(this.colors, sweepGradient.colors) && Intrinsics.areEqual(this.stops, sweepGradient.stops);
    }

    public int hashCode() {
        int iM3221hashCodeimpl = ((Offset.m3221hashCodeimpl(this.center) * 31) + this.colors.hashCode()) * 31;
        List<Float> list = this.stops;
        return iM3221hashCodeimpl + (list != null ? list.hashCode() : 0);
    }
