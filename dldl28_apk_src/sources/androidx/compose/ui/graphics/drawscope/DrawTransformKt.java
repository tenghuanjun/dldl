...
public final class DrawTransformKt {
    ...
    public static /* synthetic */ void m4117rotateRad0AR0LA0$default(DrawTransform drawTransform, float f, long j, int i, Object obj) {
        if ((i & 2) != 0) {
            j = drawTransform.mo3983getCenterF1C5BW0();
        }
        drawTransform.mo3985rotateUv8p0NA(DegreesKt.degrees(f), j);
    }

    /* JADX INFO: renamed from: rotateRad-0AR0LA0, reason: not valid java name */
    public static final void m4116rotateRad0AR0LA0(DrawTransform drawTransform, float f, long j) {
        drawTransform.mo3985rotateUv8p0NA(DegreesKt.degrees(f), j);
    }

    /* JADX INFO: renamed from: scale-0AR0LA0$default, reason: not valid java name */
    public static /* synthetic */ void m4119scale0AR0LA0$default(DrawTransform drawTransform, float f, long j, int i, Object obj) {
        if ((i & 2) != 0) {
            j = drawTransform.mo3983getCenterF1C5BW0();
        }
        drawTransform.mo3986scale0AR0LA0(f, f, j);
    }

    /* JADX INFO: renamed from: scale-0AR0LA0, reason: not valid java name */
    public static final void m4118scale0AR0LA0(DrawTransform drawTransform, float f, long j) {
        drawTransform.mo3986scale0AR0LA0(f, f, j);
    }
