...
public final class DrawCache {
    ...
    private long size = IntSize.INSTANCE.m6061getZeroYbymL2g();
    private int config = ImageBitmapConfig.INSTANCE.m3723getArgb8888_sVssgQ();
    ...
    public final void m4133drawCachedImageFqjB98A(int config, long size, Density density, LayoutDirection layoutDirection, Function1<? super DrawScope, Unit> block) {
        this.scopeDensity = density;
        this.layoutDirection = layoutDirection;
        ImageBitmap imageBitmapM3728ImageBitmapx__hDU$default = this.mCachedImage;
        Canvas Canvas = this.cachedCanvas;
        if (imageBitmapM3728ImageBitmapx__hDU$default == null || Canvas == null || IntSize.m6056getWidthimpl(size) > imageBitmapM3728ImageBitmapx__hDU$default.getWidth() || IntSize.m6055getHeightimpl(size) > imageBitmapM3728ImageBitmapx__hDU$default.getHeight() || !ImageBitmapConfig.m3718equalsimpl0(this.config, config)) {
            imageBitmapM3728ImageBitmapx__hDU$default = ImageBitmapKt.m3728ImageBitmapx__hDU$default(IntSize.m6056getWidthimpl(size), IntSize.m6055getHeightimpl(size), config, false, null, 24, null);
            Canvas = CanvasKt.Canvas(imageBitmapM3728ImageBitmapx__hDU$default);
            this.mCachedImage = imageBitmapM3728ImageBitmapx__hDU$default;
            this.cachedCanvas = Canvas;
            this.config = config;
        }
        this.size = size;
        CanvasDrawScope canvasDrawScope = this.cacheScope;
        long jM6066toSizeozmzZPI = IntSizeKt.m6066toSizeozmzZPI(size);
        ...
        drawParams2.m3978setSizeuvyYCjk(jM6066toSizeozmzZPI);
        Canvas.save();
        ...
        imageBitmapM3728ImageBitmapx__hDU$default.prepareToDraw();
    }
    ...
    public final void drawInto(DrawScope target, float alpha, ColorFilter colorFilter) {
        ...
        DrawScope.CC.m4042drawImageAZ2fEMs$default(target, imageBitmap, 0L, this.size, 0L, 0L, alpha, null, colorFilter, 0, 0, 858, null);
    }

    private final void clear(DrawScope drawScope) {
        DrawScope.CC.m4053drawRectnJ9OG0$default(drawScope, Color.INSTANCE.m3520getBlack0d7_KjU(), 0L, 0L, 0.0f, null, null, BlendMode.INSTANCE.m3409getClear0nO6VwU(), 62, null);
    }
}
