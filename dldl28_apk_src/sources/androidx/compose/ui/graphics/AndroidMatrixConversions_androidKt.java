...
public final class AndroidMatrixConversions_androidKt {
    ...
    public static final void m3332setFromtUYjHk(float[] fArr, android.graphics.Matrix matrix) {
    ...
    public static final void m3331setFromEL8BTi8(android.graphics.Matrix matrix, float[] fArr) {
        float f = fArr[2];
        if (f == 0.0f) {
            float f2 = fArr[6];
