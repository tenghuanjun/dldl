...
public final class AndroidPath implements Path {
    ...
    public int mo3352getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.INSTANCE.m3785getEvenOddRgk1Os();
        }
        return PathFillType.INSTANCE.m3786getNonZeroRgk1Os();
    }

    @Override // androidx.compose.ui.graphics.Path
    /* JADX INFO: renamed from: setFillType-oQ8Xj4U, reason: not valid java name */
    public void mo3354setFillTypeoQ8Xj4U(int i) {
        Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m3781equalsimpl0(i, PathFillType.INSTANCE.m3785getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect) {
        ...
        fArr[0] = CornerRadius.m3194getXimpl(roundRect.m3269getTopLeftCornerRadiuskKHJgLs());
        fArr[1] = CornerRadius.m3195getYimpl(roundRect.m3269getTopLeftCornerRadiuskKHJgLs());
        fArr[2] = CornerRadius.m3194getXimpl(roundRect.m3270getTopRightCornerRadiuskKHJgLs());
        fArr[3] = CornerRadius.m3195getYimpl(roundRect.m3270getTopRightCornerRadiuskKHJgLs());
        fArr[4] = CornerRadius.m3194getXimpl(roundRect.m3268getBottomRightCornerRadiuskKHJgLs());
        fArr[5] = CornerRadius.m3195getYimpl(roundRect.m3268getBottomRightCornerRadiuskKHJgLs());
        fArr[6] = CornerRadius.m3194getXimpl(roundRect.m3267getBottomLeftCornerRadiuskKHJgLs());
        fArr[7] = CornerRadius.m3195getYimpl(roundRect.m3267getBottomLeftCornerRadiuskKHJgLs());
        android.graphics.Path path = this.internalPath;
        RectF rectF2 = this.rectF;
        Intrinsics.checkNotNull(rectF2);
    ...
    public void mo3351addPathUv8p0NA(Path path, long offset) {
        android.graphics.Path path2 = this.internalPath;
        if (path instanceof AndroidPath) {
            path2.addPath(((AndroidPath) path).getInternalPath(), Offset.m3219getXimpl(offset), Offset.m3220getYimpl(offset));
            return;
        }
    ...
    public void mo3356translatek4lQ0M(long offset) {
        ...
        matrix2.setTranslate(Offset.m3219getXimpl(offset), Offset.m3220getYimpl(offset));
        android.graphics.Path path = this.internalPath;
    ...
    public void mo3355transform58bKbWc(float[] matrix) {
    ...
    public boolean mo3353opN5in7k0(Path path1, Path path2, int operation) {
        Path.Op op;
        if (PathOperation.m3790equalsimpl0(operation, PathOperation.INSTANCE.m3794getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m3790equalsimpl0(operation, PathOperation.INSTANCE.m3795getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m3790equalsimpl0(operation, PathOperation.INSTANCE.m3796getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m3790equalsimpl0(operation, PathOperation.INSTANCE.m3797getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
