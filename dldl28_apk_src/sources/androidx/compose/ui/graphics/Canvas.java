...
public interface Canvas {
    ...
    void mo3313clipPathmtrdDE(Path path, int clipOp);

    /* JADX INFO: renamed from: clipRect-N_I0leg */
    void mo3314clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp);

    /* JADX INFO: renamed from: clipRect-mtrdD-E */
    void mo3315clipRectmtrdDE(Rect rect, int clipOp);

    /* JADX INFO: renamed from: concat-58bKbWc */
    void mo3316concat58bKbWc(float[] matrix);
    ...
    void mo3317drawCircle9KIMszo(long center, float radius, Paint paint);

    /* JADX INFO: renamed from: drawImage-d-4ec7I */
    void mo3318drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint);

    /* JADX INFO: renamed from: drawImageRect-HPBpro0 */
    void mo3319drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint);

    /* JADX INFO: renamed from: drawLine-Wko1d7g */
    void mo3320drawLineWko1d7g(long p1, long p2, Paint paint);
    ...
    void mo3321drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint);

    /* JADX INFO: renamed from: drawRawPoints-O7TthRY */
    void mo3322drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint);
    ...
    void mo3323drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint);
    ...
    public final /* synthetic */ class CC {
        ...
        public static /* synthetic */ void m3468clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
            if (obj != null) {
            ...
            canvas.mo3315clipRectmtrdDE(rect, i);
        }

        /* JADX INFO: renamed from: $default$clipRect-mtrdD-E, reason: not valid java name */
        public static void m3464$default$clipRectmtrdDE(Canvas _this, Rect rect, int i) {
            _this.mo3314clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), i);
        }

        /* JADX INFO: renamed from: clipRect-N_I0leg$default, reason: not valid java name */
        public static /* synthetic */ void m3467clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
            if (obj != null) {
            ...
            canvas.mo3314clipRectN_I0leg(f, f2, f3, f4, i);
        }

        /* JADX INFO: renamed from: clipPath-mtrdD-E$default, reason: not valid java name */
        public static /* synthetic */ void m3466clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
            if (obj != null) {
            ...
            canvas.mo3313clipPathmtrdDE(path, i);
        }
        ...
        public static /* synthetic */ void m3469drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
            if (obj != null) {
                throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: drawImageRect-HPBpro0");
            }
            long jM6024getZeronOccac = (i & 2) != 0 ? IntOffset.INSTANCE.m6024getZeronOccac() : j;
            long jIntSize = (i & 4) != 0 ? IntSizeKt.IntSize(imageBitmap.getWidth(), imageBitmap.getHeight()) : j2;
            canvas.mo3319drawImageRectHPBpro0(imageBitmap, jM6024getZeronOccac, jIntSize, (i & 8) != 0 ? IntOffset.INSTANCE.m6024getZeronOccac() : j3, (i & 16) != 0 ? jIntSize : j4, paint);
        }
    }
    ...
    public static final class DefaultImpls {
        ...
        public static void m3472clipRectmtrdDE(Canvas canvas, Rect rect, int i) {
            CC.m3464$default$clipRectmtrdDE(canvas, rect, i);
        }
