...
public class ColorFilter {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ ColorFilter m3535tintxETnrds$default(Companion companion, long j, int i, int i2, Object obj) {
            if ((i2 & 2) != 0) {
                i = BlendMode.INSTANCE.m3434getSrcIn0nO6VwU();
            }
            return companion.m3538tintxETnrds(j, i);
        }

        /* JADX INFO: renamed from: tint-xETnrds, reason: not valid java name */
        public final ColorFilter m3538tintxETnrds(long color, int blendMode) {
        ...
        public final ColorFilter m3536colorMatrixjHGOpc(float[] colorMatrix) {
        ...
        public final ColorFilter m3537lightingOWjLjI(long multiply, long add) {
