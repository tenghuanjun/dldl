...
public final class LightingColorFilter extends ColorFilter {
    ...
    private LightingColorFilter(long j, long j2) {
        this(j, j2, AndroidColorFilter_androidKt.m3326actualLightingColorFilterOWjLjI(j, j2), null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3495equalsimpl0(this.multiply, lightingColorFilter.multiply) && Color.m3495equalsimpl0(this.add, lightingColorFilter.add);
    }

    public int hashCode() {
        return (Color.m3501hashCodeimpl(this.multiply) * 31) + Color.m3501hashCodeimpl(this.add);
    }

    public String toString() {
        return "LightingColorFilter(multiply=" + ((Object) Color.m3502toStringimpl(this.multiply)) + ", add=" + ((Object) Color.m3502toStringimpl(this.add)) + ')';
    }
}
