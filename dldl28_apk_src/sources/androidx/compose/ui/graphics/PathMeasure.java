...
public interface PathMeasure {
    ...
    long mo3359getPositiontuRUvjQ(float distance);
    ...
    long mo3360getTangenttuRUvjQ(float distance);

    void setPath(Path path, boolean forceClosed);

    /* JADX INFO: renamed from: androidx.compose.ui.graphics.PathMeasure$-CC, reason: invalid class name */
    /* JADX INFO: compiled from: PathMeasure.kt */
