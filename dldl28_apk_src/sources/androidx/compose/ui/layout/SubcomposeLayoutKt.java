...
public final class SubcomposeLayoutKt {
    ...
    public static final void SubcomposeLayout(final SubcomposeLayoutState subcomposeLayoutState, Modifier modifier, final Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> function2, Composer composer, final int i, final int i2) {
        ...
        Updater.m2996setimpl(composerM2989constructorimpl, subcomposeLayoutState, subcomposeLayoutState.getSetRoot$ui_release());
        Updater.m2996setimpl(composerM2989constructorimpl, compositionContextRememberCompositionContext, subcomposeLayoutState.getSetCompositionContext$ui_release());
        Updater.m2996setimpl(composerM2989constructorimpl, function2, subcomposeLayoutState.getSetMeasurePolicy$ui_release());
