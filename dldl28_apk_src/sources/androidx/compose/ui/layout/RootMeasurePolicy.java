...
public final class RootMeasurePolicy extends LayoutNode.NoIntrinsicsMeasurePolicy {
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        if (list.isEmpty()) {
            return MeasureScope.CC.layout$default(measureScope, Constraints.m5830getMinWidthimpl(j), Constraints.m5829getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.RootMeasurePolicy$measure$1
        ...
        if (list.size() == 1) {
            ...
            return MeasureScope.CC.layout$default(measureScope, ConstraintsKt.m5842constrainWidthK40F9xA(j, placeableMo4783measureBRTryo0.getWidth()), ConstraintsKt.m5841constrainHeightK40F9xA(j, placeableMo4783measureBRTryo0.getHeight()), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.RootMeasurePolicy$measure$2
                ...
                /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2(Placeable.PlacementScope placementScope) {
                    Placeable.PlacementScope.placeRelativeWithLayer$default(placementScope, placeableMo4783measureBRTryo0, 0, 0, 0.0f, null, 12, null);
                }
            }, 4, null);
        }
        ...
        return MeasureScope.CC.layout$default(measureScope, ConstraintsKt.m5842constrainWidthK40F9xA(j, iMax), ConstraintsKt.m5841constrainHeightK40F9xA(j, iMax2), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.RootMeasurePolicy$measure$4
