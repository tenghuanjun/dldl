...
public final class PointerInteropFilter$pointerInputFilter$1 extends PointerInputFilter {
    ...
    public void mo4680onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        boolean z;
    ...
    private final void dispatchToView(PointerEvent pointerEvent) {
            ...
            if (changes.get(i).isConsumed()) {
                if (this.state == PointerInteropFilter.DispatchToViewState.Dispatching) {
                    ...
                    if (layoutCoordinates$ui_release != null) {
                        long jMo4792localToRootMKHz9U = layoutCoordinates$ui_release.mo4792localToRootMKHz9U(Offset.INSTANCE.m3235getZeroF1C5BW0());
                        final PointerInteropFilter pointerInteropFilter = this.this$0;
                        PointerInteropUtils_androidKt.m4716toCancelMotionEventScoped4ec7I(pointerEvent, jMo4792localToRootMKHz9U, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$2
                            {
                                super(1);
                            }
        ...
        if (layoutCoordinates$ui_release2 != null) {
            long jMo4792localToRootMKHz9U2 = layoutCoordinates$ui_release2.mo4792localToRootMKHz9U(Offset.INSTANCE.m3235getZeroF1C5BW0());
            final PointerInteropFilter pointerInteropFilter2 = this.this$0;
            PointerInteropUtils_androidKt.m4717toMotionEventScoped4ec7I(pointerEvent, jMo4792localToRootMKHz9U2, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$3
