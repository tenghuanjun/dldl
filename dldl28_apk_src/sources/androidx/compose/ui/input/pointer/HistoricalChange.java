...
public final class HistoricalChange {
    ...
    public String toString() {
        return "HistoricalChange(uptimeMillis=" + this.uptimeMillis + ", position=" + ((Object) Offset.m3227toStringimpl(this.position)) + ')';
    }
}
