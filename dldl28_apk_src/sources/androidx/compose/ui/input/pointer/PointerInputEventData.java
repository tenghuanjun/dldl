...
public final /* data */ class PointerInputEventData {
    ...
    public final PointerInputEventData m4670copyrc8HELY(long id, long uptime, long positionOnScreen, long position, boolean down, float pressure, int type, boolean issuesEnterExit, List<HistoricalChange> historical, long scrollDelta, long originalEventPosition) {
    ...
    public boolean equals(Object other) {
        ...
        return PointerId.m4638equalsimpl0(this.id, pointerInputEventData.id) && this.uptime == pointerInputEventData.uptime && Offset.m3216equalsimpl0(this.positionOnScreen, pointerInputEventData.positionOnScreen) && Offset.m3216equalsimpl0(this.position, pointerInputEventData.position) && this.down == pointerInputEventData.down && Float.compare(this.pressure, pointerInputEventData.pressure) == 0 && PointerType.m4729equalsimpl0(this.type, pointerInputEventData.type) && this.issuesEnterExit == pointerInputEventData.issuesEnterExit && Intrinsics.areEqual(this.historical, pointerInputEventData.historical) && Offset.m3216equalsimpl0(this.scrollDelta, pointerInputEventData.scrollDelta) && Offset.m3216equalsimpl0(this.originalEventPosition, pointerInputEventData.originalEventPosition);
    }

    public int hashCode() {
        return (((((((((((((((((((PointerId.m4639hashCodeimpl(this.id) * 31) + UByte$$ExternalSyntheticBackport0.m(this.uptime)) * 31) + Offset.m3221hashCodeimpl(this.positionOnScreen)) * 31) + Offset.m3221hashCodeimpl(this.position)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.down)) * 31) + Float.floatToIntBits(this.pressure)) * 31) + PointerType.m4730hashCodeimpl(this.type)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.issuesEnterExit)) * 31) + this.historical.hashCode()) * 31) + Offset.m3221hashCodeimpl(this.scrollDelta)) * 31) + Offset.m3221hashCodeimpl(this.originalEventPosition);
    }

    public String toString() {
        return "PointerInputEventData(id=" + ((Object) PointerId.m4640toStringimpl(this.id)) + ", uptime=" + this.uptime + ", positionOnScreen=" + ((Object) Offset.m3227toStringimpl(this.positionOnScreen)) + ", position=" + ((Object) Offset.m3227toStringimpl(this.position)) + ", down=" + this.down + ", pressure=" + this.pressure + ", type=" + ((Object) PointerType.m4731toStringimpl(this.type)) + ", issuesEnterExit=" + this.issuesEnterExit + ", historical=" + this.historical + ", scrollDelta=" + ((Object) Offset.m3227toStringimpl(this.scrollDelta)) + ", originalEventPosition=" + ((Object) Offset.m3227toStringimpl(this.originalEventPosition)) + ')';
    }
    ...
    public final long m4674getPositionOnScreenF1C5BW0() {
        return this.positionOnScreen;
    }

    /* JADX INFO: renamed from: getPosition-F1C5BW0, reason: not valid java name */
    public final long m4673getPositionF1C5BW0() {
        return this.position;
    }
    ...
    public final int m4676getTypeT8wyACA() {
        return this.type;
    }
    ...
    public /* synthetic */ PointerInputEventData(long j, long j2, long j3, long j4, boolean z, float f, int i, boolean z2, List list, long j5, long j6, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, j2, j3, j4, z, f, i, (i2 & 128) != 0 ? false : z2, (i2 & 256) != 0 ? new ArrayList() : list, (i2 & 512) != 0 ? Offset.INSTANCE.m3235getZeroF1C5BW0() : j5, (i2 & 1024) != 0 ? Offset.INSTANCE.m3235getZeroF1C5BW0() : j6, null);
    }
    ...
    public final long m4675getScrollDeltaF1C5BW0() {
        return this.scrollDelta;
    }

    /* JADX INFO: renamed from: getOriginalEventPosition-F1C5BW0, reason: not valid java name */
    public final long m4672getOriginalEventPositionF1C5BW0() {
        return this.originalEventPosition;
    }
}
