...
public final class PointerInputChange {
    ...
    private PointerInputChange(long j, long j2, long j3, boolean z, float f, long j4, long j5, boolean z2, boolean z3, int i, long j6) {
        ...
        this.type = i;
        this.scrollDelta = j6;
        this.originalEventPosition = Offset.INSTANCE.m3235getZeroF1C5BW0();
    ...
    public /* synthetic */ PointerInputChange(long j, long j2, long j3, boolean z, float f, long j4, long j5, boolean z2, boolean z3, int i, long j6, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, j2, j3, z, f, j4, j5, z2, z3, (i2 & 512) != 0 ? PointerType.INSTANCE.m4736getTouchT8wyACA() : i, (i2 & 1024) != 0 ? Offset.INSTANCE.m3235getZeroF1C5BW0() : j6, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ PointerInputChange(long j, long j2, long j3, boolean z, long j4, long j5, boolean z2, boolean z3, int i, long j6, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, j2, j3, z, j4, j5, z2, z3, (i2 & 256) != 0 ? PointerType.INSTANCE.m4736getTouchT8wyACA() : i, (i2 & 512) != 0 ? Offset.INSTANCE.m3235getZeroF1C5BW0() : j6, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ PointerInputChange(long j, long j2, long j3, boolean z, long j4, long j5, boolean z2, ConsumedData consumedData, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, j2, j3, z, j4, j5, z2, consumedData, (i2 & 256) != 0 ? PointerType.INSTANCE.m4736getTouchT8wyACA() : i, (DefaultConstructorMarker) null);
    }

    private PointerInputChange(long j, long j2, long j3, boolean z, long j4, long j5, boolean z2, ConsumedData consumedData, int i) {
        this(j, j2, j3, z, 1.0f, j4, j5, z2, consumedData.getDownChange() || consumedData.getPositionChange(), i, Offset.INSTANCE.m3235getZeroF1C5BW0(), (DefaultConstructorMarker) null);
    }
    ...
    public final void m4660setOriginalEventPositionk4lQ0M$ui_release(long j) {
    ...
    public final /* synthetic */ PointerInputChange m4650copyEzrO64(long id, long currentTime, long currentPosition, boolean currentPressed, long previousTime, long previousPosition, boolean previousPressed, ConsumedData consumed, int type) {
    ...
    public final PointerInputChange m4651copyJKmWfYY(long id, long currentTime, long currentPosition, boolean currentPressed, long previousTime, long previousPosition, boolean previousPressed, int type, long scrollDelta) {
        return m4643copy8H9lfAM$default(this, id, currentTime, currentPosition, 0L, currentPressed, this.pressure, previousTime, previousPosition, previousPressed, type, getHistorical(), scrollDelta, 8, null);
    }
    ...
    public final PointerInputChange m4648copy0GkPj7c(long id, long currentTime, long currentPosition, boolean currentPressed, long previousTime, long previousPosition, boolean previousPressed, ConsumedData consumed, int type, long scrollDelta) {
    ...
    public final PointerInputChange m4653copyTn9QgHE(long id, long currentTime, long currentPosition, boolean currentPressed, float pressure, long previousTime, long previousPosition, boolean previousPressed, int type, long scrollDelta) {
    ...
    public final PointerInputChange m4652copyOHpmEuE(long id, long currentTime, long currentPosition, boolean currentPressed, long previousTime, long previousPosition, boolean previousPressed, int type, List<HistoricalChange> historical, long scrollDelta) {
        return m4643copy8H9lfAM$default(this, id, currentTime, currentPosition, 0L, currentPressed, this.pressure, previousTime, previousPosition, previousPressed, type, historical, scrollDelta, 8, null);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: copy-8H9lfAM$default, reason: not valid java name */
    public static /* synthetic */ PointerInputChange m4643copy8H9lfAM$default(PointerInputChange pointerInputChange, long j, long j2, long j3, long j4, boolean z, float f, long j5, long j6, boolean z2, int i, List list, long j7, int i2, Object obj) {
        return pointerInputChange.m4649copy8H9lfAM((i2 & 1) != 0 ? pointerInputChange.id : j, (i2 & 2) != 0 ? pointerInputChange.uptimeMillis : j2, (i2 & 4) != 0 ? pointerInputChange.position : j3, (i2 & 8) != 0 ? pointerInputChange.originalEventPosition : j4, (i2 & 16) != 0 ? pointerInputChange.pressed : z, (i2 & 32) != 0 ? pointerInputChange.pressure : f, (i2 & 64) != 0 ? pointerInputChange.previousUptimeMillis : j5, (i2 & 128) != 0 ? pointerInputChange.previousPosition : j6, (i2 & 256) != 0 ? pointerInputChange.previousPressed : z2, (i2 & 512) != 0 ? pointerInputChange.type : i, (i2 & 1024) != 0 ? pointerInputChange.getHistorical() : list, (i2 & 2048) != 0 ? pointerInputChange.scrollDelta : j7);
    }

    /* JADX INFO: renamed from: copy-8H9lfAM, reason: not valid java name */
    public final PointerInputChange m4649copy8H9lfAM(long id, long currentTime, long currentPosition, long originalEventPosition, boolean currentPressed, float pressure, long previousTime, long previousPosition, boolean previousPressed, int type, List<HistoricalChange> historical, long scrollDelta) {
    ...
    public String toString() {
        return "PointerInputChange(id=" + ((Object) PointerId.m4640toStringimpl(this.id)) + ", uptimeMillis=" + this.uptimeMillis + ", position=" + ((Object) Offset.m3227toStringimpl(this.position)) + ", pressed=" + this.pressed + ", pressure=" + this.pressure + ", previousUptimeMillis=" + this.previousUptimeMillis + ", previousPosition=" + ((Object) Offset.m3227toStringimpl(this.previousPosition)) + ", previousPressed=" + this.previousPressed + ", isConsumed=" + isConsumed() + ", type=" + ((Object) PointerType.m4731toStringimpl(this.type)) + ", historical=" + getHistorical() + ",scrollDelta=" + ((Object) Offset.m3227toStringimpl(this.scrollDelta)) + ')';
    }
}
