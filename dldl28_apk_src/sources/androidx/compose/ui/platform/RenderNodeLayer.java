...
public final class RenderNodeLayer implements OwnedLayer, GraphicLayerInfo {
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope scope, LayoutDirection layoutDirection, Density density) {
        ...
        if ((mutatedFields & 64) != 0) {
            this.renderNode.setAmbientShadowColor(ColorKt.m3548toArgb8_81llA(scope.getAmbientShadowColor()));
        }
        if ((mutatedFields & 128) != 0) {
            this.renderNode.setSpotShadowColor(ColorKt.m3548toArgb8_81llA(scope.getSpotShadowColor()));
        }
        ...
        if (i != 0) {
            this.renderNode.setPivotX(TransformOrigin.m3888getPivotFractionXimpl(this.transformOrigin) * this.renderNode.getWidth());
            this.renderNode.setPivotY(TransformOrigin.m3889getPivotFractionYimpl(this.transformOrigin) * this.renderNode.getHeight());
        }
        ...
        if ((32768 & mutatedFields) != 0) {
            this.renderNode.mo5105setCompositingStrategyaDBOjCE(scope.getCompositingStrategy());
        }
    ...
    public boolean mo5041isInLayerk4lQ0M(long position) {
        ...
        if (this.renderNode.getClipToBounds()) {
            return 0.0f <= fM3219getXimpl && fM3219getXimpl < ((float) this.renderNode.getWidth()) && 0.0f <= fM3220getYimpl && fM3220getYimpl < ((float) this.renderNode.getHeight());
        }
    ...
    public void mo5044resizeozmzZPI(long size) {
        ...
        this.renderNode.setPivotX(TransformOrigin.m3888getPivotFractionXimpl(this.transformOrigin) * f);
        float f2 = iM6055getHeightimpl;
        this.renderNode.setPivotY(TransformOrigin.m3889getPivotFractionYimpl(this.transformOrigin) * f2);
        DeviceRenderNode deviceRenderNode = this.renderNode;
        if (deviceRenderNode.setPosition(deviceRenderNode.getLeft(), this.renderNode.getTop(), this.renderNode.getLeft() + iM6056getWidthimpl, this.renderNode.getTop() + iM6055getHeightimpl)) {
    ...
    public void mo5043movegyyYBs(long position) {
        ...
        if (left == iM6014getXimpl && top == iM6015getYimpl) {
            return;
        }
        if (left != iM6014getXimpl) {
            this.renderNode.offsetLeftAndRight(iM6014getXimpl - left);
        }
        if (top != iM6015getYimpl) {
            this.renderNode.offsetTopAndBottom(iM6015getYimpl - top);
        }
        triggerRepaint();
        this.matrixCache.invalidate();
    }
    ...
    public void drawLayer(Canvas canvas) {
        ...
        canvas.mo3316concat58bKbWc(this.matrixCache.m5120calculateMatrixGrdbGEg(this.renderNode));
    ...
    public long mo5042mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            float[] fArrM5119calculateInverseMatrixbWbORWo = this.matrixCache.m5119calculateInverseMatrixbWbORWo(this.renderNode);
        ...
        return androidx.compose.ui.graphics.Matrix.m3739mapMKHz9U(this.matrixCache.m5120calculateMatrixGrdbGEg(this.renderNode), point);
    }
    ...
    public void mapBounds(MutableRect rect, boolean inverse) {
        ...
        androidx.compose.ui.graphics.Matrix.m3741mapimpl(this.matrixCache.m5120calculateMatrixGrdbGEg(this.renderNode), rect);
    }
    ...
    public void reuseLayer(Function1<? super Canvas, Unit> drawBlock, Function0<Unit> invalidateParentLayer) {
        ...
        this.transformOrigin = TransformOrigin.INSTANCE.m3893getCenterSzJe1aQ();
    ...
    public void mo5045transform58bKbWc(float[] matrix) {
        androidx.compose.ui.graphics.Matrix.m3750timesAssign58bKbWc(matrix, this.matrixCache.m5120calculateMatrixGrdbGEg(this.renderNode));
    }
