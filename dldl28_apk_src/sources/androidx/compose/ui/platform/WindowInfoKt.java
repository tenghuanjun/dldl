...
public final class WindowInfoKt {
    public static final void WindowFocusObserver(final Function1<? super Boolean, Unit> function1, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(WindowFocusObserver)54@2046L7,55@2073L42,56@2120L117:WindowInfo.kt#itgzvw");
        if ((i & 14) == 0) {
        ...
        if ((i2 & 11) != 2 || !composerStartRestartGroup.getSkipping()) {
            ...
            EffectsKt.LaunchedEffect(windowInfo, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) windowInfoKt$WindowFocusObserver$1$1RememberedValue, composerStartRestartGroup, 64);
            if (ComposerKt.isTraceInProgress()) {
