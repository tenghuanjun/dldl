...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public RenderNodeApi23(AndroidComposeView androidComposeView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.INSTANCE.m3584getAutoNrFUSI();
    ...
    public void mo5105setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m3580equalsimpl0(i, CompositingStrategy.INSTANCE.m3586getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m3580equalsimpl0(i, CompositingStrategy.INSTANCE.m3585getModulateAlphaNrFUSI())) {
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m3580equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.INSTANCE.m3586getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            androidCanvas.save();
            Canvas.CC.m3466clipPathmtrdDE$default(androidCanvas, clipPath, 0, 2, null);
        }
