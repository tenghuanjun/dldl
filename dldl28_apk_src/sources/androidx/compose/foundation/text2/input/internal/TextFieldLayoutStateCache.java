...
public final class TextFieldLayoutStateCache implements State<TextLayoutResult>, StateObject {
    ...
    public final TextLayoutResult m1178layoutWithNewMeasureInputshBUhpc(Density density, LayoutDirection layoutDirection, FontFamily.Resolver fontFamilyResolver, long constraints) {
        ...
        if (!Intrinsics.areEqual(textLayoutResultComputeLayout, layoutResult)) {
            ...
            if (!current.getReadOnly()) {
                ...
                synchronized (SnapshotKt.getLock()) {
                    ...
                    cacheRecord3.m1180setConstraintsBRTryo0(measureInputs.getConstraints());
    ...
    private static final class CacheRecord extends StateRecord {
        ...
        public final void m1180setConstraintsBRTryo0(long j) {
            this.constraints = j;
        }
    ...
    static final class MeasureInputs {
        ...
        private static final SnapshotMutationPolicy<MeasureInputs> mutationPolicy = new SnapshotMutationPolicy<MeasureInputs>() { // from class: androidx.compose.foundation.text2.input.internal.TextFieldLayoutStateCache$MeasureInputs$Companion$mutationPolicy$1
            ...
            public boolean equivalent(TextFieldLayoutStateCache.MeasureInputs a2, TextFieldLayoutStateCache.MeasureInputs b) {
                ...
                } else if (a2.getDensityValue() == b.getDensityValue() && a2.getFontScale() == b.getFontScale() && a2.getLayoutDirection() == b.getLayoutDirection() && Intrinsics.areEqual(a2.getFontFamilyResolver(), b.getFontFamilyResolver()) && Constraints.m5821equalsimpl0(a2.getConstraints(), b.getConstraints())) {
                    return true;
                }
                return false;
            }
        ...
        public String toString() {
            return "MeasureInputs(density=" + this.density + ", densityValue=" + this.densityValue + ", fontScale=" + this.fontScale + ", layoutDirection=" + this.layoutDirection + ", fontFamilyResolver=" + this.fontFamilyResolver + ", constraints=" + ((Object) Constraints.m5833toStringimpl(this.constraints)) + ')';
        }
