...
final class AndroidFlingSpline {
    ...
    public final long m494flingPositionLfoxSSI(float time) {
        float f;
        float f2;
        float f3 = 100;
        int i = (int) (f3 * time);
        ...
        return FlingResult.m496constructorimpl((((long) Float.floatToRawIntBits(f2)) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }
    ...
    public static final class FlingResult {
        ...
        public static final /* synthetic */ FlingResult m495boximpl(long j) {
            return new FlingResult(j);
        }

        /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
        public static long m496constructorimpl(long j) {
            return j;
        }
        ...
        public static String m502toStringimpl(long j) {
            return "FlingResult(packedValue=" + j + ')';
        }

        public boolean equals(Object obj) {
            return m497equalsimpl(this.packedValue, obj);
        }

        public int hashCode() {
            return m501hashCodeimpl(this.packedValue);
        }

        public String toString() {
            return m502toStringimpl(this.packedValue);
        }
        ...
        public static final float m499getDistanceCoefficientimpl(long j) {
            FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
            return Float.intBitsToFloat((int) (j >> 32));
        }

        /* JADX INFO: renamed from: getVelocityCoefficient-impl, reason: not valid java name */
        public static final float m500getVelocityCoefficientimpl(long j) {
            FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
