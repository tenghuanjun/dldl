...
public final class OffsetKt {
    ...
    public static final Modifier m558offsetVpY3zN4(Modifier modifier, final float f, final float f2) {
        return modifier.then(new OffsetElement(f, f2, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.OffsetKt.offset.1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                inspectorInfo.setName(IjkMediaPlayer.OnNativeInvokeListener.ARG_OFFSET);
                inspectorInfo.getProperties().set("x", Dp.m5880boximpl(f));
                inspectorInfo.getProperties().set("y", Dp.m5880boximpl(f2));
            }
        }, null));
    }

    /* JADX INFO: renamed from: absoluteOffset-VpY3zN4, reason: not valid java name */
    public static final Modifier m556absoluteOffsetVpY3zN4(Modifier modifier, final float f, final float f2) {
    ...
    public static final Modifier offset(Modifier modifier, final Function1<? super Density, IntOffset> function1) {
        return modifier.then(new OffsetPxElement(function1, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.OffsetKt.offset.2
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                inspectorInfo.setName(IjkMediaPlayer.OnNativeInvokeListener.ARG_OFFSET);
                inspectorInfo.getProperties().set(IjkMediaPlayer.OnNativeInvokeListener.ARG_OFFSET, function1);
            }
        }));
    }
    ...
    public static /* synthetic */ Modifier m559offsetVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m558offsetVpY3zN4(modifier, f, f2);
    }

    /* JADX INFO: renamed from: absoluteOffset-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m557absoluteOffsetVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m5882constructorimpl(0);
        }
        if ((i & 2) != 0) {
        ...
        return m556absoluteOffsetVpY3zN4(modifier, f, f2);
    }
}
