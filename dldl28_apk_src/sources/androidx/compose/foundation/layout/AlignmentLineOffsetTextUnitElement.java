...
final class AlignmentLineOffsetTextUnitElement extends ModifierNodeElement<AlignmentLineOffsetTextUnitNode> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + TextUnit.m6078hashCodeimpl(this.before)) * 31) + TextUnit.m6078hashCodeimpl(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        return alignmentLineOffsetTextUnitElement != null && Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetTextUnitElement.alignmentLine) && TextUnit.m6074equalsimpl0(this.before, alignmentLineOffsetTextUnitElement.before) && TextUnit.m6074equalsimpl0(this.after, alignmentLineOffsetTextUnitElement.after);
    }
    ...
    public void update(AlignmentLineOffsetTextUnitNode node) {
        ...
        node.m493setBeforeR2X_6o(this.before);
        node.m492setAfterR2X_6o(this.after);
    }
}
