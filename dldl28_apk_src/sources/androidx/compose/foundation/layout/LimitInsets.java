...
final class LimitInsets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        int iM688getAllowLeftInRtlJoeWqyM$foundation_layout_release;
        if (layoutDirection == LayoutDirection.Ltr) {
            iM688getAllowLeftInRtlJoeWqyM$foundation_layout_release = WindowInsetsSides.INSTANCE.m687getAllowLeftInLtrJoeWqyM$foundation_layout_release();
        } else {
            iM688getAllowLeftInRtlJoeWqyM$foundation_layout_release = WindowInsetsSides.INSTANCE.m688getAllowLeftInRtlJoeWqyM$foundation_layout_release();
        }
        if (WindowInsetsSides.m681hasAnybkgdKaI$foundation_layout_release(this.sides, iM688getAllowLeftInRtlJoeWqyM$foundation_layout_release)) {
    ...
    public int getTop(Density density) {
        if (WindowInsetsSides.m681hasAnybkgdKaI$foundation_layout_release(this.sides, WindowInsetsSides.INSTANCE.m697getTopJoeWqyM())) {
    ...
    public int getRight(Density density, LayoutDirection layoutDirection) {
        int iM690getAllowRightInRtlJoeWqyM$foundation_layout_release;
        if (layoutDirection == LayoutDirection.Ltr) {
            iM690getAllowRightInRtlJoeWqyM$foundation_layout_release = WindowInsetsSides.INSTANCE.m689getAllowRightInLtrJoeWqyM$foundation_layout_release();
        } else {
            iM690getAllowRightInRtlJoeWqyM$foundation_layout_release = WindowInsetsSides.INSTANCE.m690getAllowRightInRtlJoeWqyM$foundation_layout_release();
        }
        if (WindowInsetsSides.m681hasAnybkgdKaI$foundation_layout_release(this.sides, iM690getAllowRightInRtlJoeWqyM$foundation_layout_release)) {
    ...
    public int getBottom(Density density) {
        if (WindowInsetsSides.m681hasAnybkgdKaI$foundation_layout_release(this.sides, WindowInsetsSides.INSTANCE.m691getBottomJoeWqyM())) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.insets, limitInsets.insets) && WindowInsetsSides.m680equalsimpl0(this.sides, limitInsets.sides);
    }
