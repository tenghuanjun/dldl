...
abstract class IntrinsicSizeModifier extends Modifier.Node implements LayoutModifierNode {
    ...
    public abstract long mo552calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j);
    ...
    public final MeasureResult mo121measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        long jMo552calculateContentConstraintsl58MMJ0 = mo552calculateContentConstraintsl58MMJ0(measureScope, measurable, j);
        if (getEnforceIncoming()) {
            jMo552calculateContentConstraintsl58MMJ0 = ConstraintsKt.m5840constrainN9IONVI(j, jMo552calculateContentConstraintsl58MMJ0);
        }
        final Placeable placeableMo4783measureBRTryo0 = measurable.mo4783measureBRTryo0(jMo552calculateContentConstraintsl58MMJ0);
        return MeasureScope.CC.layout$default(measureScope, placeableMo4783measureBRTryo0.getWidth(), placeableMo4783measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.IntrinsicSizeModifier$measure$1
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m4837placeRelative70tqf50$default(placementScope, placeableMo4783measureBRTryo0, IntOffset.INSTANCE.m6024getZeronOccac(), 0.0f, 2, null);
            }
        }, 4, null);
    }
