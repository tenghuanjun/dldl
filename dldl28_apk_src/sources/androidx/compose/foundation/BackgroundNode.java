...
final class BackgroundNode extends Modifier.Node implements DrawModifierNode {
    ...
    public final void m244setColor8_81llA(long j) {
        this.color = j;
    }
    ...
    private final void drawRect(ContentDrawScope contentDrawScope) {
        if (!Color.m3495equalsimpl0(this.color, Color.INSTANCE.m3530getUnspecified0d7_KjU())) {
            DrawScope.CC.m4053drawRectnJ9OG0$default(contentDrawScope, this.color, 0L, 0L, 0.0f, null, null, 0, 126, null);
        }
        Brush brush = this.brush;
        if (brush != null) {
            DrawScope.CC.m4052drawRectAsUm42w$default(contentDrawScope, brush, 0L, 0L, this.alpha, null, null, 0, 118, null);
        }
    }

    private final void drawOutline(ContentDrawScope contentDrawScope) {
        Outline outlineMo292createOutlinePq9zytI;
        if (Size.m3283equalsimpl(contentDrawScope.mo3973getSizeNHjbRc(), this.lastSize) && contentDrawScope.getLayoutDirection() == this.lastLayoutDirection && Intrinsics.areEqual(this.lastShape, this.shape)) {
            outlineMo292createOutlinePq9zytI = this.lastOutline;
            Intrinsics.checkNotNull(outlineMo292createOutlinePq9zytI);
        } else {
            outlineMo292createOutlinePq9zytI = this.shape.mo292createOutlinePq9zytI(contentDrawScope.mo3973getSizeNHjbRc(), contentDrawScope.getLayoutDirection(), contentDrawScope);
        }
        if (!Color.m3495equalsimpl0(this.color, Color.INSTANCE.m3530getUnspecified0d7_KjU())) {
            OutlineKt.m3760drawOutlinewDX37Ww(contentDrawScope, outlineMo292createOutlinePq9zytI, this.color, (60 & 4) != 0 ? 1.0f : 0.0f, (60 & 8) != 0 ? Fill.INSTANCE : null, (60 & 16) != 0 ? null : null, (60 & 32) != 0 ? DrawScope.INSTANCE.m4056getDefaultBlendMode0nO6VwU() : 0);
        }
        Brush brush = this.brush;
        if (brush != null) {
            OutlineKt.m3759drawOutlinehn5TExg$default(contentDrawScope, outlineMo292createOutlinePq9zytI, brush, this.alpha, null, null, 0, 56, null);
        }
        this.lastOutline = outlineMo292createOutlinePq9zytI;
        this.lastSize = Size.m3276boximpl(contentDrawScope.mo3973getSizeNHjbRc());
