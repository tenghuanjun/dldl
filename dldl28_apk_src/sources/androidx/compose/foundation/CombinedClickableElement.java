...
final class CombinedClickableElement extends ModifierNodeElement<CombinedClickableNodeImpl> {
    ...
    public void update(CombinedClickableNodeImpl node) {
        node.mo293updatexpl5gLE(this.onClick, this.onLongClickLabel, this.onLongClick, this.onDoubleClick, this.interactionSource, this.enabled, this.onClickLabel, this.role);
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int iHashCode = ((this.interactionSource.hashCode() * 31) + UByte$$ExternalSyntheticBackport0.m(this.enabled)) * 31;
        String str = this.onClickLabel;
        int iHashCode2 = (iHashCode + (str != null ? str.hashCode() : 0)) * 31;
        Role role = this.role;
        int iM5193hashCodeimpl = (((iHashCode2 + (role != null ? Role.m5193hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode()) * 31;
        String str2 = this.onLongClickLabel;
        int iHashCode3 = (iM5193hashCodeimpl + (str2 != null ? str2.hashCode() : 0)) * 31;
