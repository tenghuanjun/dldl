...
public final class AbsoluteCutCornerShape extends CornerBasedShape {
    ...
    public Outline mo859createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m3288getWidthimpl(size) - topEnd, 0.0f);
        Path.lineTo(Size.m3288getWidthimpl(size), topEnd);
        Path.lineTo(Size.m3288getWidthimpl(size), Size.m3285getHeightimpl(size) - bottomEnd);
        Path.lineTo(Size.m3288getWidthimpl(size) - bottomEnd, Size.m3285getHeightimpl(size));
        Path.lineTo(bottomStart, Size.m3285getHeightimpl(size));
        Path.lineTo(0.0f, Size.m3285getHeightimpl(size) - bottomStart);
        Path.close();
