...
final class AndroidEmbeddedExternalSurfaceState extends BaseAndroidExternalSurfaceState implements TextureView.SurfaceTextureListener {
    ...
    public AndroidEmbeddedExternalSurfaceState(CoroutineScope coroutineScope) {
        ...
        this.surfaceSize = IntSize.INSTANCE.m6061getZeroYbymL2g();
    ...
    public final void m226setSurfaceSizeozmzZPI(long j) {
        this.surfaceSize = j;
    }
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int width, int height) {
        if (!IntSize.m6054equalsimpl0(this.surfaceSize, IntSize.INSTANCE.m6061getZeroYbymL2g())) {
            width = IntSize.m6056getWidthimpl(this.surfaceSize);
            height = IntSize.m6055getHeightimpl(this.surfaceSize);
