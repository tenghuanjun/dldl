...
public final class KeyboardActionRunner implements KeyboardActionScope {
    ...
    public final void m906runActionKlQnJC8(int imeAction) {
        Function1<KeyboardActionScope, Unit> onSend;
        Unit unit = null;
        if (ImeAction.m5535equalsimpl0(imeAction, ImeAction.INSTANCE.m5548getDoneeUduSuo())) {
            ...
            if (!(ImeAction.m5535equalsimpl0(imeAction, ImeAction.INSTANCE.m5547getDefaulteUduSuo()) ? true : ImeAction.m5535equalsimpl0(imeAction, ImeAction.INSTANCE.m5551getNoneeUduSuo()))) {
        ...
        if (unit == null) {
            mo905defaultKeyboardActionKlQnJC8(imeAction);
        }
    }

    @Override // androidx.compose.foundation.text.KeyboardActionScope
    /* JADX INFO: renamed from: defaultKeyboardAction-KlQnJC8, reason: not valid java name */
    public void mo905defaultKeyboardActionKlQnJC8(int imeAction) {
        if (ImeAction.m5535equalsimpl0(imeAction, ImeAction.INSTANCE.m5550getNexteUduSuo())) {
            getFocusManager().mo3153moveFocus3ESFkO8(FocusDirection.INSTANCE.m3149getNextdhqQ8s());
            return;
        }
        if (ImeAction.m5535equalsimpl0(imeAction, ImeAction.INSTANCE.m5552getPreviouseUduSuo())) {
            getFocusManager().mo3153moveFocus3ESFkO8(FocusDirection.INSTANCE.m3150getPreviousdhqQ8s());
            return;
        }
        if (!ImeAction.m5535equalsimpl0(imeAction, ImeAction.INSTANCE.m5548getDoneeUduSuo())) {
            if (ImeAction.m5535equalsimpl0(imeAction, ImeAction.INSTANCE.m5549getGoeUduSuo()) ? true : ImeAction.m5535equalsimpl0(imeAction, ImeAction.INSTANCE.m5553getSearcheUduSuo()) ? true : ImeAction.m5535equalsimpl0(imeAction, ImeAction.INSTANCE.m5554getSendeUduSuo()) ? true : ImeAction.m5535equalsimpl0(imeAction, ImeAction.INSTANCE.m5547getDefaulteUduSuo())) {
                return;
            }
            ImeAction.m5535equalsimpl0(imeAction, ImeAction.INSTANCE.m5551getNoneeUduSuo());
        } else {
