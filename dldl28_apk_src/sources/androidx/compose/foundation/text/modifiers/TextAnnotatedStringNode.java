...
public final class TextAnnotatedStringNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public final boolean m1026updateLayoutRelatedArgsMPT68mk(TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow) {
    ...
    public final boolean setSubstitution(AnnotatedString updatedText) {
        ...
        if (textSubstitution != null) {
            ...
            if (layoutCache != null) {
                layoutCache.m1010updateZNqEYIc(updatedText, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders);
                unit = Unit.INSTANCE;
            } else {
                unit = null;
            }
                ...
                */
                public final java.lang.Boolean invoke(java.util.List<androidx.compose.ui.text.TextLayoutResult> r38) {
                    ...
                    L31:
                        ...
                        r33 = 0
                        r34 = 0
                        androidx.compose.ui.text.TextStyle r5 = androidx.compose.ui.text.TextStyle.m5388mergedA7vx0o$default(r5, r6, r8, r10, r11, r12, r13, r14, r15, r17, r18, r19, r20, r22, r23, r24, r25, r26, r27, r29, r30, r31, r32, r33, r34, r35, r36)
                        androidx.compose.ui.text.TextLayoutInput r3 = r2.getLayoutInput()
                        ...
                        r7 = 0
                        r4 = 0
                        androidx.compose.ui.text.TextLayoutResult r1 = androidx.compose.ui.text.TextLayoutResult.m5338copyO0kMr_c$default(r2, r3, r4, r6, r7)
                        if (r1 == 0) goto Lb8
                        r2 = r38
                        r2.add(r1)
                        goto Lb9
    ...
    public final MeasureResult m1025measureNonExtension3p2s80s(MeasureScope measureScope, Measurable measurable, long constraints) {
        return mo121measure3p2s80s(measureScope, measurable, constraints);
    }
    ...
    public MeasureResult mo121measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        boolean zM1009layoutWithConstraintsK40F9xA = layoutCache.m1009layoutWithConstraintsK40F9xA(j, measureScope.getLayoutDirection());
        ...
        if (zM1009layoutWithConstraintsK40F9xA) {
        ...
        final Placeable placeableMo4783measureBRTryo0 = measurable.mo4783measureBRTryo0(LayoutUtilsKt.fixedCoerceHeightAndWidthForBits(Constraints.INSTANCE, IntSize.m6056getWidthimpl(textLayoutResult.getSize()), IntSize.m6055getHeightimpl(textLayoutResult.getSize())));
        int iM6056getWidthimpl = IntSize.m6056getWidthimpl(textLayoutResult.getSize());
        int iM6055getHeightimpl = IntSize.m6055getHeightimpl(textLayoutResult.getSize());
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return measureScope.layout(iM6056getWidthimpl, iM6055getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextAnnotatedStringNode$measure$1
            {
                super(1);
            }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        if (getIsAttached()) {
            ...
            boolean z = textLayoutResult.getHasVisualOverflow() && !TextOverflow.m5806equalsimpl0(this.overflow, TextOverflow.INSTANCE.m5815getVisiblegIe3tQ8());
            if (z) {
            ...
            try {
                ...
                if (brush != null) {
                    multiParagraph.m5249painthn5TExg(canvas, brush, (64 & 4) != 0 ? Float.NaN : this.style.getAlpha(), (64 & 8) != 0 ? null : shadow2, (64 & 16) != 0 ? null : textDecoration2, (64 & 32) != 0 ? null : drawStyle2, (64 & 64) != 0 ? DrawScope.INSTANCE.m4056getDefaultBlendMode0nO6VwU() : 0);
                } else {
                    ...
                    multiParagraph.m5247paintLG529CI(canvas, (32 & 2) != 0 ? Color.INSTANCE.m3530getUnspecified0d7_KjU() : jM3575invoke0d7_KjU, (32 & 4) != 0 ? null : shadow2, (32 & 8) != 0 ? null : textDecoration2, (32 & 16) == 0 ? drawStyle2 : null, (32 & 32) != 0 ? DrawScope.INSTANCE.m4056getDefaultBlendMode0nO6VwU() : 0);
                }
