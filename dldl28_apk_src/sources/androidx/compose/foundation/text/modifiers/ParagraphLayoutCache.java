...
public final class ParagraphLayoutCache {
    ...
    private ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3) {
        ...
        this.maxLines = i2;
        this.minLines = i3;
        this.lastDensity = InlineDensity.INSTANCE.m999getUnspecifiedL26CHvs();
        this.layoutSize = IntSizeKt.IntSize(0, 0);
        this.prevConstraints = Constraints.INSTANCE.m5836fixedJhjzzOo(0, 0);
    ...
    public /* synthetic */ ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m5813getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, null);
    }
    ...
    public final void setDensity$foundation_release(Density density) {
        ...
        long jM991constructorimpl = density != null ? InlineDensity.m991constructorimpl(density) : InlineDensity.INSTANCE.m999getUnspecifiedL26CHvs();
        if (density2 == null) {
            this.density = density;
            this.lastDensity = jM991constructorimpl;
        } else if (density == null || !InlineDensity.m993equalsimpl0(this.lastDensity, jM991constructorimpl)) {
            this.density = density;
            this.lastDensity = jM991constructorimpl;
            markDirty();
        }
    ...
    public final boolean m1014layoutWithConstraintsK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        if (this.minLines > 1) {
            ...
            constraints = minLinesConstrainerFrom.m1003coerceMinLinesOh53vG4$foundation_release(constraints, this.minLines);
        }
        boolean z2 = false;
        if (!m1012newLayoutWillBeDifferentK40F9xA(constraints, layoutDirection)) {
            if (!Constraints.m5821equalsimpl0(constraints, this.prevConstraints)) {
                Paragraph paragraph = this.paragraph;
                Intrinsics.checkNotNull(paragraph);
                this.layoutSize = ConstraintsKt.m5839constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(Math.min(paragraph.getMaxIntrinsicWidth(), paragraph.getWidth())), TextDelegateKt.ceilToIntPx(paragraph.getHeight())));
                if (TextOverflow.m5806equalsimpl0(this.overflow, TextOverflow.INSTANCE.m5815getVisiblegIe3tQ8()) || (IntSize.m6056getWidthimpl(r3) >= paragraph.getWidth() && IntSize.m6055getHeightimpl(r3) >= paragraph.getHeight())) {
                    z = false;
                }
                this.didOverflow = z;
        ...
        Paragraph paragraphM1011layoutTextK40F9xA = m1011layoutTextK40F9xA(constraints, layoutDirection);
        this.prevConstraints = constraints;
        this.layoutSize = ConstraintsKt.m5839constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(paragraphM1011layoutTextK40F9xA.getWidth()), TextDelegateKt.ceilToIntPx(paragraphM1011layoutTextK40F9xA.getHeight())));
        if (!TextOverflow.m5806equalsimpl0(this.overflow, TextOverflow.INSTANCE.m5815getVisiblegIe3tQ8()) && (IntSize.m6056getWidthimpl(r9) < paragraphM1011layoutTextK40F9xA.getWidth() || IntSize.m6055getHeightimpl(r9) < paragraphM1011layoutTextK40F9xA.getHeight())) {
            z2 = true;
        }
        this.didOverflow = z2;
        this.paragraph = paragraphM1011layoutTextK40F9xA;
        return true;
    }
    ...
    public final int intrinsicHeight(int width, LayoutDirection layoutDirection) {
        ...
        int iCeilToIntPx = TextDelegateKt.ceilToIntPx(m1011layoutTextK40F9xA(ConstraintsKt.Constraints(0, width, 0, Integer.MAX_VALUE), layoutDirection).getHeight());
    ...
    public final void m1016updateL6sJoHM(String text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int overflow, boolean softWrap, int maxLines, int minLines) {
        this.text = text;
        this.style = style;
    ...
    private final Paragraph m1011layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        return ParagraphKt.m5261Paragraph_EkL_Y(layoutDirection2, LayoutUtilsKt.m1000finalConstraintstfFHcEY(constraints, this.softWrap, this.overflow, layoutDirection2.getMaxIntrinsicWidth()), LayoutUtilsKt.m1001finalMaxLinesxdlQI24(this.softWrap, this.overflow, this.maxLines), TextOverflow.m5806equalsimpl0(this.overflow, TextOverflow.INSTANCE.m5814getEllipsisgIe3tQ8()));
    }
    ...
    private final boolean m1012newLayoutWillBeDifferentK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        return Constraints.m5828getMaxWidthimpl(constraints) != Constraints.m5828getMaxWidthimpl(this.prevConstraints) || ((float) Constraints.m5827getMaxHeightimpl(constraints)) < paragraph.getHeight() || paragraph.getDidExceedMaxLines();
    }
    ...
    public final TextLayoutResult slowCreateTextLayoutResultOrNull(TextStyle style) {
        ...
        long jM5819copyZbe2FdA$default = Constraints.m5819copyZbe2FdA$default(this.prevConstraints, 0, 0, 0, 0, 10, null);
        return new TextLayoutResult(new TextLayoutInput(annotatedString, style, CollectionsKt.emptyList(), this.maxLines, this.softWrap, this.overflow, density, layoutDirection, this.fontFamilyResolver, jM5819copyZbe2FdA$default, (DefaultConstructorMarker) null), new MultiParagraph(new MultiParagraphIntrinsics(annotatedString, style, (List<AnnotatedString.Range<Placeholder>>) CollectionsKt.emptyList(), density, this.fontFamilyResolver), jM5819copyZbe2FdA$default, this.maxLines, TextOverflow.m5806equalsimpl0(this.overflow, TextOverflow.INSTANCE.m5814getEllipsisgIe3tQ8()), null), this.layoutSize, null);
    }
