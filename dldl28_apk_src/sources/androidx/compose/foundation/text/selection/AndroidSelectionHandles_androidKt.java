...
public final class AndroidSelectionHandles_androidKt {
                            ...
                            public final void invoke(Composer composer3, int i5) {
                                ...
                                Modifier modifierSemantics$default = SemanticsModifierKt.semantics$default(modifier3, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt.SelectionHandle.1.1.1
                                    ...
                                    public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                                        long jMo880provideF1C5BW0 = offsetProvider3.mo880provideF1C5BW0();
                                        semanticsPropertyReceiver.set(SelectionHandlesKt.getSelectionHandleInfoKey(), new SelectionHandleInfo(z5 ? Handle.SelectionStart : Handle.SelectionEnd, jMo880provideF1C5BW0, z6 ? SelectionHandleAnchor.Left : SelectionHandleAnchor.Right, OffsetKt.m3238isSpecifiedk4lQ0M(jMo880provideF1C5BW0), null));
                                    }
                                }, 1, null);
                                ...
                                AndroidSelectionHandles_androidKt.SelectionHandleIcon(modifierSemantics$default, new Function0<Boolean>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt.SelectionHandle.1.1.2
                                    ...
                                    public final Boolean invoke() {
                                        return Boolean.valueOf(OffsetKt.m3238isSpecifiedk4lQ0M(offsetProvider4.mo880provideF1C5BW0()));
                                    }
                                }, z3, composer3, 0);
                                if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void SelectionHandleIcon(final Modifier modifier, final Function0<Boolean> function0, final boolean z, Composer composer, final int i) {
        ...
        if ((i2 & 731) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            SpacerKt.Spacer(drawSelectionHandle(SizeKt.m649sizeVpY3zN4(modifier, SelectionHandlesKt.getHandleWidth(), SelectionHandlesKt.getHandleHeight()), function0, z), composerStartRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
                ...
                if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue = (Function1) new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$drawSelectionHandle$1$1$1
                        ...
                        public final DrawResult invoke(CacheDrawScope cacheDrawScope) {
                            final ImageBitmap imageBitmapCreateHandleImage = AndroidSelectionHandles_androidKt.createHandleImage(cacheDrawScope, Size.m3288getWidthimpl(cacheDrawScope.m3126getSizeNHjbRc()) / 2.0f);
                            final ColorFilter colorFilterM3535tintxETnrds$default = ColorFilter.Companion.m3535tintxETnrds$default(ColorFilter.INSTANCE, handleColor, 0, 2, null);
                                ...
                                public final void invoke2(ContentDrawScope contentDrawScope) {
                                    ...
                                    if (function03.invoke().booleanValue()) {
                                        if (z3) {
                                            ...
                                            ColorFilter colorFilter = colorFilterM3535tintxETnrds$default;
                                            long jMo3972getCenterF1C5BW0 = contentDrawScope2.mo3972getCenterF1C5BW0();
                                            ...
                                            DrawScope.CC.m4043drawImagegbVJVH8$default(contentDrawScope2, imageBitmap, 0L, 0.0f, null, colorFilter, 0, 46, null);
                                            drawContext.getCanvas().restore();
                                            drawContext.mo3980setSizeuvyYCjk(jMo3979getSizeNHjbRc);
                                            return;
                                        }
                                        DrawScope.CC.m4043drawImagegbVJVH8$default(contentDrawScope, imageBitmapCreateHandleImage, 0L, 0.0f, null, colorFilterM3535tintxETnrds$default, 0, 46, null);
                                    }
                                }
                            });
                        }
    ...
    public static final ImageBitmap createHandleImage(CacheDrawScope cacheDrawScope, float f) {
        ...
        if (imageBitmap == null || canvas == null || iCeil > imageBitmap.getWidth() || iCeil > imageBitmap.getHeight()) {
            imageBitmap = ImageBitmapKt.m3728ImageBitmapx__hDU$default(iCeil, iCeil, ImageBitmapConfig.INSTANCE.m3722getAlpha8_sVssgQ(), false, null, 24, null);
        ...
        drawParams2.m3978setSizeuvyYCjk(jSize);
        canvas2.save();
        CanvasDrawScope canvasDrawScope3 = canvasDrawScope2;
        DrawScope.CC.m4053drawRectnJ9OG0$default(canvasDrawScope3, Color.INSTANCE.m3520getBlack0d7_KjU(), 0L, canvasDrawScope3.mo3973getSizeNHjbRc(), 0.0f, null, null, BlendMode.INSTANCE.m3409getClear0nO6VwU(), 58, null);
        DrawScope.CC.m4053drawRectnJ9OG0$default(canvasDrawScope3, ColorKt.Color(4278190080L), Offset.INSTANCE.m3235getZeroF1C5BW0(), androidx.compose.ui.geometry.SizeKt.Size(f, f), 0.0f, null, null, 0, 120, null);
        DrawScope.CC.m4040drawCircleVaOC9Bg$default(canvasDrawScope3, ColorKt.Color(4278190080L), f, OffsetKt.Offset(f, f), 0.0f, null, null, 0, 120, null);
        canvas2.restore();
