...
public final class SelectionManager {
    ...
    private final MutableState dragBeginPosition = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3208boximpl(Offset.INSTANCE.m3235getZeroF1C5BW0()), null, 2, null);

    /* JADX INFO: renamed from: dragTotalDistance$delegate, reason: from kotlin metadata */
    private final MutableState dragTotalDistance = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3208boximpl(Offset.INSTANCE.m3235getZeroF1C5BW0()), null, 2, null);
    ...
    public SelectionManager(SelectionRegistrarImpl selectionRegistrarImpl) {
        ...
        selectionRegistrarImpl.setOnSelectionUpdateStartCallback$foundation_release(new Function4<Boolean, LayoutCoordinates, Offset, SelectionAdjustment, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.2
            ...
            public /* bridge */ /* synthetic */ Unit invoke(Boolean bool, LayoutCoordinates layoutCoordinates, Offset offset, SelectionAdjustment selectionAdjustment) {
                m1080invokeRg1IO4c(bool.booleanValue(), layoutCoordinates, offset.getPackedValue(), selectionAdjustment);
                return Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: invoke-Rg1IO4c, reason: not valid java name */
            public final void m1080invokeRg1IO4c(boolean z, LayoutCoordinates layoutCoordinates, long j, SelectionAdjustment selectionAdjustment) {
                long jMo4790getSizeYbymL2g = layoutCoordinates.mo4790getSizeYbymL2g();
                Rect rect = new Rect(0.0f, 0.0f, IntSize.m6056getWidthimpl(jMo4790getSizeYbymL2g), IntSize.m6055getHeightimpl(jMo4790getSizeYbymL2g));
                if (!SelectionManagerKt.m1085containsInclusiveUv8p0NA(rect, j)) {
                    j = TextLayoutStateKt.m1191coerceIn3MmeM6k(j, rect);
                }
                long jM1064convertToContainerCoordinatesR5De75A = SelectionManager.this.m1064convertToContainerCoordinatesR5De75A(layoutCoordinates, j);
                if (OffsetKt.m3238isSpecifiedk4lQ0M(jM1064convertToContainerCoordinatesR5De75A)) {
                    SelectionManager.this.setInTouchMode(z);
                    SelectionManager.this.m1071startSelection9KIMszo(jM1064convertToContainerCoordinatesR5De75A, false, selectionAdjustment);
        ...
        selectionRegistrarImpl.setOnSelectionUpdateCallback$foundation_release(new Function6<Boolean, LayoutCoordinates, Offset, Offset, Boolean, SelectionAdjustment, Boolean>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.4
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(Boolean bool, LayoutCoordinates layoutCoordinates, Offset offset, Offset offset2, Boolean bool2, SelectionAdjustment selectionAdjustment) {
                return m1081invokepGV3PM0(bool.booleanValue(), layoutCoordinates, offset.getPackedValue(), offset2.getPackedValue(), bool2.booleanValue(), selectionAdjustment);
            }

            /* JADX INFO: renamed from: invoke-pGV3PM0, reason: not valid java name */
            public final Boolean m1081invokepGV3PM0(boolean z, LayoutCoordinates layoutCoordinates, long j, long j2, boolean z2, SelectionAdjustment selectionAdjustment) {
                long jM1064convertToContainerCoordinatesR5De75A = SelectionManager.this.m1064convertToContainerCoordinatesR5De75A(layoutCoordinates, j);
                long jM1064convertToContainerCoordinatesR5De75A2 = SelectionManager.this.m1064convertToContainerCoordinatesR5De75A(layoutCoordinates, j2);
                SelectionManager.this.setInTouchMode(z);
                return Boolean.valueOf(SelectionManager.this.m1079updateSelectionqNKwrvQ$foundation_release(Offset.m3208boximpl(jM1064convertToContainerCoordinatesR5De75A), jM1064convertToContainerCoordinatesR5De75A2, z2, selectionAdjustment));
            }
        });
        selectionRegistrarImpl.setOnSelectionUpdateEndCallback$foundation_release(new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.5
            ...
            public final void invoke2() {
                ...
                SelectionManager.this.m1066setCurrentDragPosition_kEHs6E(null);
            }
        });
        ...
        selectionRegistrarImpl.setAfterSelectableUnsubscribe$foundation_release(new Function1<Long, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.7
            ...
            public final void invoke(long j) {
                ...
                if (selection != null && (start = selection.getStart()) != null && j == start.getSelectableId()) {
                    SelectionManager.this.m1070setStartHandlePosition_kEHs6E(null);
                }
                ...
                if (selection2 != null && (end = selection2.getEnd()) != null && j == end.getSelectableId()) {
                    SelectionManager.this.m1069setEndHandlePosition_kEHs6E(null);
                }
                if (SelectionManager.this.selectionRegistrar.getSubselections().containsKey(Long.valueOf(j))) {
                    SelectionManager.this.updateSelectionToolbar();
                }
    ...
    public final Modifier getModifier() {
        return KeyInputModifierKt.onKeyEvent(SelectionGesturesKt.updateSelectionTouchMode(FocusableKt.focusable$default(FocusChangedModifierKt.onFocusChanged(FocusRequesterModifierKt.focusRequester(OnGloballyPositionedModifierKt.onGloballyPositioned(onClearSelectionRequested(Modifier.INSTANCE, new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager$modifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m1082invokeZmokQxo(keyEvent.m4504unboximpl());
            }

            /* JADX INFO: renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m1082invokeZmokQxo(android.view.KeyEvent keyEvent) {
                boolean z;
                if (SelectionManager_androidKt.m1087isCopyKeyEventZmokQxo(keyEvent)) {
    ...
    public final void setContainerLayoutCoordinates(LayoutCoordinates layoutCoordinates) {
        ...
        Offset offsetM3208boximpl = layoutCoordinates != null ? Offset.m3208boximpl(LayoutCoordinatesKt.positionInWindow(layoutCoordinates)) : null;
        if (Intrinsics.areEqual(this.previousPosition, offsetM3208boximpl)) {
            return;
        }
        this.previousPosition = offsetM3208boximpl;
        updateHandleOffsets();
        updateSelectionToolbar();
    }
    ...
    public final void m1067setDragBeginPositionk4lQ0M(long j) {
        this.dragBeginPosition.setValue(Offset.m3208boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getDragBeginPosition-F1C5BW0$foundation_release, reason: not valid java name */
    public final long m1074getDragBeginPositionF1C5BW0$foundation_release() {
    ...
    public final void m1068setDragTotalDistancek4lQ0M(long j) {
        this.dragTotalDistance.setValue(Offset.m3208boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getDragTotalDistance-F1C5BW0$foundation_release, reason: not valid java name */
    public final long m1075getDragTotalDistanceF1C5BW0$foundation_release() {
    ...
    public final void m1066setCurrentDragPosition_kEHs6E(Offset offset) {
        this.currentDragPosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getCurrentDragPosition-_m7T9-E, reason: not valid java name */
    public final Offset m1073getCurrentDragPosition_m7T9E() {
    ...
    */
    public final void updateHandleOffsets() {
        ...
        L42:
            ...
            if (r5 == 0) goto L6f
            r8 = 1
            long r8 = r3.mo1033getHandlePositiondBAh8RU(r0, r8)
            boolean r3 = androidx.compose.ui.geometry.OffsetKt.m3240isUnspecifiedk4lQ0M(r8)
            if (r3 == 0) goto L54
            goto L6f
        L54:
            long r8 = r1.mo4791localPositionOfR5De75A(r5, r8)
            androidx.compose.ui.geometry.Offset r3 = androidx.compose.ui.geometry.Offset.m3208boximpl(r8)
            ...
            if (r5 == r10) goto L70
            boolean r5 = androidx.compose.foundation.text.selection.SelectionManagerKt.m1085containsInclusiveUv8p0NA(r7, r8)
            if (r5 == 0) goto L6f
            goto L70
        L6f:
            r3 = r2
        L70:
            r11.m1070setStartHandlePosition_kEHs6E(r3)
            if (r6 == 0) goto L9c
            r3 = 0
            long r3 = r4.mo1033getHandlePositiondBAh8RU(r0, r3)
            boolean r0 = androidx.compose.ui.geometry.OffsetKt.m3240isUnspecifiedk4lQ0M(r3)
            if (r0 == 0) goto L81
            goto L9c
        L81:
            long r0 = r1.mo4791localPositionOfR5De75A(r6, r3)
            androidx.compose.ui.geometry.Offset r0 = androidx.compose.ui.geometry.Offset.m3208boximpl(r0)
            long r3 = r0.getPackedValue()
            androidx.compose.foundation.text.Handle r1 = r11.getDraggingHandle()
            androidx.compose.foundation.text.Handle r5 = androidx.compose.foundation.text.Handle.SelectionEnd
            if (r1 == r5) goto L9b
            boolean r1 = androidx.compose.foundation.text.selection.SelectionManagerKt.m1085containsInclusiveUv8p0NA(r7, r3)
            if (r1 == 0) goto L9c
        L9b:
            r2 = r0
        L9c:
            r11.m1069setEndHandlePosition_kEHs6E(r2)
            return
        La0:
            r11.m1070setStartHandlePosition_kEHs6E(r2)
            r11.m1069setEndHandlePosition_kEHs6E(r2)
            return
        */
    ...
    public final void updateSelectionToolbar() {
        ...
        if (getHasFocus() && (textToolbar = this.textToolbar) != null) {
            if (this.showToolbar && isInTouchMode() && isNonEmptySelection$foundation_release()) {
                ...
                TextToolbar.CC.showMenu$default(textToolbar, contentRect, new C06141(this), null, null, null, 28, null);
                return;
            }
    ...
    /* synthetic */ class C06141 extends FunctionReferenceImpl implements Function0<Unit> {
        C06141(Object obj) {
    ...
    private final Rect getContentRect() {
        ...
        return Rect.copy$default(rectIntersect.m3256translatek4lQ0M(LayoutCoordinatesKt.positionInRoot(layoutCoordinates)), 0.0f, 0.0f, 0.0f, rectIntersect.getBottom() + (SelectionHandlesKt.getHandleHeight() * 4), 7, null);
    }
    ...
    public final TextDragObserver handleDragObserver(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.SelectionManager.handleDragObserver.1
            ...
            public void mo948onDownk4lQ0M(long point) {
                LayoutCoordinates layoutCoordinates;
                Offset offsetM1077getStartHandlePosition_m7T9E = isStartHandle ? this.m1077getStartHandlePosition_m7T9E() : this.m1076getEndHandlePosition_m7T9E();
                if (offsetM1077getStartHandlePosition_m7T9E != null) {
                    offsetM1077getStartHandlePosition_m7T9E.getPackedValue();
                    ...
                    long jMo1033getHandlePositiondBAh8RU = anchorSelectable$foundation_release.mo1033getHandlePositiondBAh8RU(selection, isStartHandle);
                    if (OffsetKt.m3240isUnspecifiedk4lQ0M(jMo1033getHandlePositiondBAh8RU)) {
                        return;
                    }
                    long jM1048getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m1048getAdjustedCoordinatesk4lQ0M(jMo1033getHandlePositiondBAh8RU);
                    SelectionManager selectionManager = this;
                    selectionManager.m1066setCurrentDragPosition_kEHs6E(Offset.m3208boximpl(selectionManager.requireContainerCoordinates$foundation_release().mo4791localPositionOfR5De75A(layoutCoordinates, jM1048getAdjustedCoordinatesk4lQ0M)));
            ...
            public void mo950onStartk4lQ0M(long startPoint) {
                ...
                long jMo1033getHandlePositiondBAh8RU = selectable2.mo1033getHandlePositiondBAh8RU(selection, isStartHandle);
                if (OffsetKt.m3240isUnspecifiedk4lQ0M(jMo1033getHandlePositiondBAh8RU)) {
                    return;
                }
                long jM1048getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m1048getAdjustedCoordinatesk4lQ0M(jMo1033getHandlePositiondBAh8RU);
                SelectionManager selectionManager = this;
                selectionManager.m1067setDragBeginPositionk4lQ0M(selectionManager.requireContainerCoordinates$foundation_release().mo4791localPositionOfR5De75A(layoutCoordinates, jM1048getAdjustedCoordinatesk4lQ0M));
                this.m1068setDragTotalDistancek4lQ0M(Offset.INSTANCE.m3235getZeroF1C5BW0());
            }
            ...
            public void mo949onDragk4lQ0M(long delta) {
                ...
                SelectionManager selectionManager = this;
                selectionManager.m1068setDragTotalDistancek4lQ0M(Offset.m3224plusMKHz9U(selectionManager.m1075getDragTotalDistanceF1C5BW0$foundation_release(), delta));
                long jM3224plusMKHz9U = Offset.m3224plusMKHz9U(this.m1074getDragBeginPositionF1C5BW0$foundation_release(), this.m1075getDragTotalDistanceF1C5BW0$foundation_release());
                if (this.m1079updateSelectionqNKwrvQ$foundation_release(Offset.m3208boximpl(jM3224plusMKHz9U), this.m1074getDragBeginPositionF1C5BW0$foundation_release(), isStartHandle, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate())) {
                    this.m1067setDragBeginPositionk4lQ0M(jM3224plusMKHz9U);
                    this.m1068setDragTotalDistancek4lQ0M(Offset.INSTANCE.m3235getZeroF1C5BW0());
                }
            }
            ...
            private final void done() {
                ...
                this.m1066setCurrentDragPosition_kEHs6E(null);
            }
    ...
    static final class C06112 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C06112(Function1<? super Offset, Unit> function1, Continuation<? super C06112> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C06112 c06112 = new C06112(this.$onTap, continuation);
            c06112.L$0 = obj;
            return c06112;
        }
        ...
        public final Object invoke(AwaitPointerEventScope awaitPointerEventScope, Continuation<? super Unit> continuation) {
            return ((C06112) create(awaitPointerEventScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (pointerInputChange != null) {
                this.$onTap.invoke(Offset.m3208boximpl(pointerInputChange.getPosition()));
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public final Object detectNonConsumingTap(PointerInputScope pointerInputScope, Function1<? super Offset, Unit> function1, Continuation<? super Unit> continuation) {
        Object objAwaitEachGesture = ForEachGestureKt.awaitEachGesture(pointerInputScope, new C06112(function1, null), continuation);
    ...
    static final class C06131 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06131(Function0<Unit> function0, Continuation<? super C06131> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C06131 c06131 = SelectionManager.this.new C06131(this.$block, continuation);
            c06131.L$0 = obj;
            return c06131;
        }
            ...
            if (i == 0) {
                ...
                if (selectionManager.detectNonConsumingTap(pointerInputScope, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.onClearSelectionRequested.1.1
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                        m1083invokek4lQ0M(offset.getPackedValue());
                        return Unit.INSTANCE;
                    }

                    /* JADX INFO: renamed from: invoke-k-4lQ0M, reason: not valid java name */
                    public final void m1083invokek4lQ0M(long j) {
                        function0.invoke();
                    }
    ...
    private final Modifier onClearSelectionRequested(Modifier modifier, Function0<Unit> function0) {
        return getHasFocus() ? SuspendingPointerInputFilterKt.pointerInput(modifier, Unit.INSTANCE, new C06131(function0, null)) : modifier;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: convertToContainerCoordinates-R5De75A, reason: not valid java name */
    public final long m1064convertToContainerCoordinatesR5De75A(LayoutCoordinates layoutCoordinates, long offset) {
        LayoutCoordinates layoutCoordinates2 = this.containerLayoutCoordinates;
        if (layoutCoordinates2 == null || !layoutCoordinates2.isAttached()) {
            return Offset.INSTANCE.m3234getUnspecifiedF1C5BW0();
        }
        return requireContainerCoordinates$foundation_release().mo4791localPositionOfR5De75A(layoutCoordinates, offset);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: startSelection-9KIMszo, reason: not valid java name */
    public final void m1071startSelection9KIMszo(long position, boolean isStartHandle, SelectionAdjustment adjustment) {
        this.previousSelectionLayout = null;
        m1078updateSelectionjyLRC_s$foundation_release(position, Offset.INSTANCE.m3234getUnspecifiedF1C5BW0(), isStartHandle, adjustment);
    }

    /* JADX INFO: renamed from: updateSelection-qNKwrvQ$foundation_release, reason: not valid java name */
    public final boolean m1079updateSelectionqNKwrvQ$foundation_release(Offset newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        if (newPosition == null) {
            return false;
        }
        return m1078updateSelectionjyLRC_s$foundation_release(newPosition.getPackedValue(), previousPosition, isStartHandle, adjustment);
    }

    /* JADX INFO: renamed from: updateSelection-jyLRC_s$foundation_release, reason: not valid java name */
    public final boolean m1078updateSelectionjyLRC_s$foundation_release(long position, long previousHandlePosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
        m1066setCurrentDragPosition_kEHs6E(Offset.m3208boximpl(position));
        SelectionLayout selectionLayoutM1065getSelectionLayoutWko1d7g = m1065getSelectionLayoutWko1d7g(position, previousHandlePosition, isStartHandle);
        if (!selectionLayoutM1065getSelectionLayoutWko1d7g.shouldRecomputeSelection(this.previousSelectionLayout)) {
            return false;
        }
        Selection selectionAdjust = adjustment.adjust(selectionLayoutM1065getSelectionLayoutWko1d7g);
        if (!Intrinsics.areEqual(selectionAdjust, getSelection())) {
            selectionChanged(selectionLayoutM1065getSelectionLayoutWko1d7g, selectionAdjust);
        }
        this.previousSelectionLayout = selectionLayoutM1065getSelectionLayoutWko1d7g;
        return true;
    }

    /* JADX INFO: renamed from: getSelectionLayout-Wko1d7g, reason: not valid java name */
    private final SelectionLayout m1065getSelectionLayoutWko1d7g(long position, long previousHandlePosition, boolean isStartHandle) {
    ...
    public final void m1072contextMenuOpenAdjustmentk4lQ0M(long position) {
        Selection selection = getSelection();
        if (selection != null ? TextRange.m5362getCollapsedimpl(selection.m1039toTextRanged9O1mEE()) : true) {
            m1071startSelection9KIMszo(position, true, SelectionAdjustment.INSTANCE.getWord());
        }
    }
}
