...
public final class KeyEventHelpers_androidKt {
    ...
    public static final boolean m903cancelsTextSelectionZmokQxo(KeyEvent keyEvent) {
        return keyEvent.getKeyCode() == 4 && KeyEventType.m4508equalsimpl0(KeyEvent_androidKt.m4516getTypeZmokQxo(keyEvent), KeyEventType.INSTANCE.m4513getKeyUpCS__XNY());
    }
}
