...
public final class DeadKeyCombiner {
    ...
    public final Integer m902consumeZmokQxo(KeyEvent event) {
        int iM4517getUtf16CodePointZmokQxo = KeyEvent_androidKt.m4517getUtf16CodePointZmokQxo(event);
        if ((Integer.MIN_VALUE & iM4517getUtf16CodePointZmokQxo) != 0) {
            this.deadKeyCode = Integer.valueOf(iM4517getUtf16CodePointZmokQxo & Integer.MAX_VALUE);
            return null;
        }
        Integer num = this.deadKeyCode;
        if (num != null) {
            this.deadKeyCode = null;
            Integer numValueOf = Integer.valueOf(KeyCharacterMap.getDeadChar(num.intValue(), iM4517getUtf16CodePointZmokQxo));
            Integer num2 = numValueOf.intValue() != 0 ? numValueOf : null;
            return num2 == null ? Integer.valueOf(iM4517getUtf16CodePointZmokQxo) : num2;
        }
        return Integer.valueOf(iM4517getUtf16CodePointZmokQxo);
    }
}
