    ...
    public static final void InlineChildren(final AnnotatedString annotatedString, final List<AnnotatedString.Range<Function3<String, Composer, Integer, Unit>>> list, Composer composer, final int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            AnnotatedStringResolveInlineContentKt$InlineChildren$1$2 annotatedStringResolveInlineContentKt$InlineChildren$1$2 = new MeasurePolicy() { // from class: androidx.compose.foundation.text.AnnotatedStringResolveInlineContentKt$InlineChildren$1$2
                ...
                public final MeasureResult mo69measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list2, long j) {
                    ArrayList arrayList = new ArrayList(list2.size());
                    int size2 = list2.size();
                    for (int i3 = 0; i3 < size2; i3++) {
                        arrayList.add(list2.get(i3).mo4783measureBRTryo0(j));
                    }
                    final ArrayList arrayList2 = arrayList;
                    return MeasureScope.CC.layout$default(measureScope, Constraints.m5828getMaxWidthimpl(j), Constraints.m5827getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.AnnotatedStringResolveInlineContentKt$InlineChildren$1$2.1
            ...
            Updater.m2996setimpl(composerM2989constructorimpl, annotatedStringResolveInlineContentKt$InlineChildren$1$2, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            ...
            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, -1488000014, "C76@2767L42:AnnotatedStringResolveInlineContent.kt#423gt5");
