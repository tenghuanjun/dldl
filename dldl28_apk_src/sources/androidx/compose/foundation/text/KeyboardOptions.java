...
public final class KeyboardOptions {
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m5576getNoneIUNYP9k() : i, (i4 & 2) != 0 ? true : z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m5602getTextPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m5547getDefaulteUduSuo() : i3, (i4 & 16) != 0 ? null : platformImeOptions, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m5576getNoneIUNYP9k() : i, (i4 & 2) != 0 ? true : z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m5602getTextPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m5547getDefaulteUduSuo() : i3, (DefaultConstructorMarker) null);
    }
    ...
    public static /* synthetic */ KeyboardOptions m908copyij11fho$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        return keyboardOptions.m910copyij11fho(i, z2, i5, i6, platformImeOptions);
    }

    /* JADX INFO: renamed from: copy-ij11fho, reason: not valid java name */
    public final KeyboardOptions m910copyij11fho(int capitalization, boolean autoCorrect, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions) {
    ...
    public static /* synthetic */ KeyboardOptions m907copy3m2b7yw$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = keyboardOptions.capitalization;
        }
        if ((i4 & 2) != 0) {
        ...
        return keyboardOptions.m909copy3m2b7yw(i, z, i2, i3);
    }
    ...
    public final /* synthetic */ KeyboardOptions m909copy3m2b7yw(int capitalization, boolean autoCorrect, int keyboardType, int imeAction) {
    ...
    public boolean equals(Object other) {
        ...
        return KeyboardCapitalization.m5567equalsimpl0(this.capitalization, keyboardOptions.capitalization) && this.autoCorrect == keyboardOptions.autoCorrect && KeyboardType.m5582equalsimpl0(this.keyboardType, keyboardOptions.keyboardType) && ImeAction.m5535equalsimpl0(this.imeAction, keyboardOptions.imeAction) && Intrinsics.areEqual(this.platformImeOptions, keyboardOptions.platformImeOptions);
    }

    public int hashCode() {
        int iM5568hashCodeimpl = ((((((KeyboardCapitalization.m5568hashCodeimpl(this.capitalization) * 31) + UByte$$ExternalSyntheticBackport0.m(this.autoCorrect)) * 31) + KeyboardType.m5583hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m5536hashCodeimpl(this.imeAction)) * 31;
        PlatformImeOptions platformImeOptions = this.platformImeOptions;
        return iM5568hashCodeimpl + (platformImeOptions != null ? platformImeOptions.hashCode() : 0);
    }

    public String toString() {
        return "KeyboardOptions(capitalization=" + ((Object) KeyboardCapitalization.m5569toStringimpl(this.capitalization)) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + ((Object) KeyboardType.m5584toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m5537toStringimpl(this.imeAction)) + ", platformImeOptions=" + this.platformImeOptions + ')';
    }
}
