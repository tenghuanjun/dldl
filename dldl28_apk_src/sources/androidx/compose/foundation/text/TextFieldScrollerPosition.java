...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation orientation, float f) {
        ...
        this.previousSelection = TextRange.INSTANCE.m5373getZerod9O1mEE();
    ...
    public final void m971setPreviousSelection5zctL8(long j) {
    ...
    public final int m969getOffsetToFollow5zctL8(long selection) {
        return TextRange.m5368getStartimpl(selection) != TextRange.m5368getStartimpl(this.previousSelection) ? TextRange.m5368getStartimpl(selection) : TextRange.m5363getEndimpl(selection) != TextRange.m5363getEndimpl(this.previousSelection) ? TextRange.m5363getEndimpl(selection) : TextRange.m5366getMinimpl(selection);
    }
