...
public final class ScrollingLayoutNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo121measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final Placeable placeableMo4783measureBRTryo0 = measurable.mo4783measureBRTryo0(Constraints.m5819copyZbe2FdA$default(j, 0, this.isVertical ? Constraints.m5828getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, this.isVertical ? Integer.MAX_VALUE : Constraints.m5827getMaxHeightimpl(j), 5, null));
        int iCoerceAtMost = RangesKt.coerceAtMost(placeableMo4783measureBRTryo0.getWidth(), Constraints.m5828getMaxWidthimpl(j));
        int iCoerceAtMost2 = RangesKt.coerceAtMost(placeableMo4783measureBRTryo0.getHeight(), Constraints.m5827getMaxHeightimpl(j));
        final int height = placeableMo4783measureBRTryo0.getHeight() - iCoerceAtMost2;
        int width = placeableMo4783measureBRTryo0.getWidth() - iCoerceAtMost;
        if (!this.isVertical) {
            height = width;
        }
        ...
        return MeasureScope.CC.layout$default(measureScope, iCoerceAtMost, iCoerceAtMost2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.ScrollingLayoutNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                Placeable.PlacementScope.placeRelativeWithLayer$default(placementScope, placeableMo4783measureBRTryo0, this.this$0.getIsVertical() ? 0 : i, this.this$0.getIsVertical() ? i : 0, 0.0f, null, 12, null);
            }
        }, 4, null);
    }
