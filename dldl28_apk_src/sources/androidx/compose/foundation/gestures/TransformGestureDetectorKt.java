...
public final class TransformGestureDetectorKt {
    ...
    public static final float calculateRotation(PointerEvent pointerEvent) {
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            ...
            if (pointerInputChange2.getPressed() && pointerInputChange2.getPreviousPressed()) {
                ...
                long jM3223minusMKHz9U = Offset.m3223minusMKHz9U(pointerInputChange2.getPreviousPosition(), jCalculateCentroid2);
                long jM3223minusMKHz9U2 = Offset.m3223minusMKHz9U(position, jCalculateCentroid);
                float fM451anglek4lQ0M = m451anglek4lQ0M(jM3223minusMKHz9U2) - m451anglek4lQ0M(jM3223minusMKHz9U);
                float fM3217getDistanceimpl = Offset.m3217getDistanceimpl(Offset.m3224plusMKHz9U(jM3223minusMKHz9U2, jM3223minusMKHz9U)) / 2.0f;
                if (fM451anglek4lQ0M > 180.0f) {
                    fM451anglek4lQ0M -= 360.0f;
                } else if (fM451anglek4lQ0M < -180.0f) {
                    fM451anglek4lQ0M += 360.0f;
                }
                f2 += fM451anglek4lQ0M * fM3217getDistanceimpl;
                f += fM3217getDistanceimpl;
            }
        }
        if (f == 0.0f) {
            return 0.0f;
    ...
    private static final float m451anglek4lQ0M(long j) {
        if (Offset.m3219getXimpl(j) == 0.0f && Offset.m3220getYimpl(j) == 0.0f) {
            return 0.0f;
        }
        return ((-((float) Math.atan2(Offset.m3219getXimpl(j), Offset.m3220getYimpl(j)))) * 180.0f) / 3.1415927f;
    }
    ...
    public static final long calculatePan(PointerEvent pointerEvent) {
        long jCalculateCentroid = calculateCentroid(pointerEvent, true);
        if (Offset.m3216equalsimpl0(jCalculateCentroid, Offset.INSTANCE.m3234getUnspecifiedF1C5BW0())) {
            return Offset.INSTANCE.m3235getZeroF1C5BW0();
        }
        return Offset.m3223minusMKHz9U(jCalculateCentroid, calculateCentroid(pointerEvent, false));
    }
    ...
    public static final float calculateCentroidSize(PointerEvent pointerEvent, boolean z) {
        ...
        float fM3217getDistanceimpl = 0.0f;
        if (Offset.m3216equalsimpl0(jCalculateCentroid, Offset.INSTANCE.m3234getUnspecifiedF1C5BW0())) {
            return 0.0f;
        }
        List<PointerInputChange> changes = pointerEvent.getChanges();
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                fM3217getDistanceimpl += Offset.m3217getDistanceimpl(Offset.m3223minusMKHz9U(z ? pointerInputChange.getPosition() : pointerInputChange.getPreviousPosition(), jCalculateCentroid));
                i++;
            }
        }
        return fM3217getDistanceimpl / i;
    }
    ...
    public static final long calculateCentroid(PointerEvent pointerEvent, boolean z) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            PointerInputChange pointerInputChange = changes.get(i2);
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                jM3235getZeroF1C5BW0 = Offset.m3224plusMKHz9U(jM3235getZeroF1C5BW0, z ? pointerInputChange.getPosition() : pointerInputChange.getPreviousPosition());
                i++;
            }
        }
        if (i == 0) {
        ...
        return Offset.m3214divtuRUvjQ(jM3235getZeroF1C5BW0, i);
    }
}
