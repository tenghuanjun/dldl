...
public final class TransformableStateKt {
        ...
        if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = TransformableState(new Function3<Float, Offset, Float, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableStateKt$rememberTransformableState$1$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Float f, Offset offset, Float f2) {
                    m459invoked4ec7I(f.floatValue(), offset.getPackedValue(), f2.floatValue());
                    return Unit.INSTANCE;
                }

                /* JADX INFO: renamed from: invoke-d-4ec7I, reason: not valid java name */
                public final void m459invoked4ec7I(float f, long j, float f2) {
                    stateRememberUpdatedState.getValue().invoke(Float.valueOf(f), Offset.m3208boximpl(j), Float.valueOf(f2));
                }
            });
    ...
    @DebugMetadata(c = "androidx.compose.foundation.gestures.TransformableStateKt$animateZoomBy$3", f = "TransformableState.kt", i = {}, l = {KeyBoardKey.KeyboardKeyNavigationUp}, m = "invokeSuspend", n = {}, s = {})
            ...
            if (i == 0) {
                ...
                if (SuspendAnimationKt.animateTo$default(animationStateAnimationState$default, fBoxFloat, animationSpec, false, new Function1<AnimationScope<Float, AnimationVector1D>, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableStateKt.animateZoomBy.3.1
                    ...
                    public final void invoke2(AnimationScope<Float, AnimationVector1D> animationScope) {
                        TransformScope.CC.m452transformByd4ec7I$default(transformScope, floatRef.element == 0.0f ? 1.0f : animationScope.getValue().floatValue() / floatRef.element, 0L, 0.0f, 6, null);
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                if (SuspendAnimationKt.animateTo$default(animationStateAnimationState$default, fBoxFloat, animationSpec, false, new Function1<AnimationScope<Float, AnimationVector1D>, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableStateKt.animateRotateBy.2.1
                    ...
                    /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                    public final void invoke2(AnimationScope<Float, AnimationVector1D> animationScope) {
                        TransformScope.CC.m452transformByd4ec7I$default(transformScope, 0.0f, 0L, animationScope.getValue().floatValue() - floatRef.element, 3, null);
                        floatRef.element = animationScope.getValue().floatValue();
                    }
                }, this, 4, null) == coroutine_suspended) {
                    return coroutine_suspended;
    ...
    public static /* synthetic */ Object m457animatePanByubNVwUQ$default(TransformableState transformableState, long j, AnimationSpec animationSpec, Continuation continuation, int i, Object obj) {
        if ((i & 2) != 0) {
            animationSpec = new SpringSpec(0.0f, 200.0f, null, 5, null);
        }
        return m456animatePanByubNVwUQ(transformableState, j, animationSpec, continuation);
    }

    /* JADX INFO: renamed from: animatePanBy-ubNVwUQ, reason: not valid java name */
    public static final Object m456animatePanByubNVwUQ(TransformableState transformableState, long j, AnimationSpec<Offset> animationSpec, Continuation<? super Unit> continuation) {
        Ref.LongRef longRef = new Ref.LongRef();
        longRef.element = Offset.INSTANCE.m3235getZeroF1C5BW0();
    ...
    static final class C05442 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ float $zoomFactor;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05442(float f, Continuation<? super C05442> continuation) {
            super(2, continuation);
            this.$zoomFactor = f;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C05442 c05442 = new C05442(this.$zoomFactor, continuation);
            c05442.L$0 = obj;
            return c05442;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(TransformScope transformScope, Continuation<? super Unit> continuation) {
            return ((C05442) create(transformScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            ((TransformScope) this.L$0).mo361transformByd4ec7I(this.$zoomFactor, Offset.INSTANCE.m3235getZeroF1C5BW0(), 0.0f);
            return Unit.INSTANCE;
        }
    }

    public static final Object zoomBy(TransformableState transformableState, float f, Continuation<? super Unit> continuation) {
        Object objTransform$default = TransformableState.CC.transform$default(transformableState, null, new C05442(f, null), continuation, 1, null);
        return objTransform$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objTransform$default : Unit.INSTANCE;
    }
    ...
    static final class C05422 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ float $degrees;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05422(float f, Continuation<? super C05422> continuation) {
            super(2, continuation);
            this.$degrees = f;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C05422 c05422 = new C05422(this.$degrees, continuation);
            c05422.L$0 = obj;
            return c05422;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(TransformScope transformScope, Continuation<? super Unit> continuation) {
            return ((C05422) create(transformScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            ((TransformScope) this.L$0).mo361transformByd4ec7I(1.0f, Offset.INSTANCE.m3235getZeroF1C5BW0(), this.$degrees);
            return Unit.INSTANCE;
        }
    }

    public static final Object rotateBy(TransformableState transformableState, float f, Continuation<? super Unit> continuation) {
        Object objTransform$default = TransformableState.CC.transform$default(transformableState, null, new C05422(f, null), continuation, 1, null);
        return objTransform$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objTransform$default : Unit.INSTANCE;
    }

    /* JADX INFO: renamed from: panBy-d-4ec7I, reason: not valid java name */
    public static final Object m458panByd4ec7I(TransformableState transformableState, long j, Continuation<? super Unit> continuation) {
    ...
    static final class C05432 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
        int label;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C05432(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(TransformScope transformScope, Continuation<? super Unit> continuation) {
            return ((C05432) create(transformScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final Object stopTransformation(TransformableState transformableState, MutatePriority mutatePriority, Continuation<? super Unit> continuation) {
        Object objTransform = transformableState.transform(mutatePriority, new C05432(null), continuation);
