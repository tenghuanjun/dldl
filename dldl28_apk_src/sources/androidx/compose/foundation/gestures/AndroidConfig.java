...
final class AndroidConfig implements ScrollConfig {
    ...
    public long mo351calculateMouseWheelScroll8xgXZGE(Density density, PointerEvent pointerEvent, long j) {
        List<PointerInputChange> changes = pointerEvent.getChanges();
        Offset offsetM3208boximpl = Offset.m3208boximpl(Offset.INSTANCE.m3235getZeroF1C5BW0());
        int size = changes.size();
        for (int i = 0; i < size; i++) {
            offsetM3208boximpl = Offset.m3208boximpl(Offset.m3224plusMKHz9U(offsetM3208boximpl.getPackedValue(), changes.get(i).getScrollDelta()));
        }
        return Offset.m3226timestuRUvjQ(offsetM3208boximpl.getPackedValue(), -density.mo345toPx0680j_4(Dp.m5882constructorimpl(64)));
    }
}
