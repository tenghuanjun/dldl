...
public final class LazyLayoutPrefetchState {
    ...
    public interface Prefetcher {
        ...
        PrefetchHandle mo772schedulePrefetch0kLqBqw(int index, long constraints);
    }

    /* JADX INFO: renamed from: getPrefetcher$foundation_release, reason: from getter */
    ...
    /* JADX INFO: renamed from: schedulePrefetch-0kLqBqw, reason: not valid java name */
    public final PrefetchHandle m771schedulePrefetch0kLqBqw(int index, long constraints) {
        PrefetchHandle prefetchHandleMo772schedulePrefetch0kLqBqw;
        Prefetcher prefetcher = this.prefetcher;
        return (prefetcher == null || (prefetchHandleMo772schedulePrefetch0kLqBqw = prefetcher.mo772schedulePrefetch0kLqBqw(index, constraints)) == null) ? DummyHandle.INSTANCE : prefetchHandleMo772schedulePrefetch0kLqBqw;
    }
}
