...
public abstract class LazyStaggeredGridMeasureProvider {
    ...
    private final long m810childConstraintsJhjzzOo(int slot, int span) {
        int i;
        if (span == 1) {
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m5838fixedWidthOenEA2s(i);
        }
        return Constraints.INSTANCE.m5837fixedHeightOenEA2s(i);
    }

    /* JADX INFO: renamed from: getAndMeasure-jy6DScQ, reason: not valid java name */
    public final LazyStaggeredGridMeasuredItem m811getAndMeasurejy6DScQ(int index, long span) {
        ...
        return createItem(index, iCoerceAtMost, iCoerceAtMost2, key, contentType, this.measureScope.mo762measure0kLqBqw(index, m810childConstraintsJhjzzOo(iCoerceAtMost, iCoerceAtMost2)));
    }
