...
final class GridSlotCache implements LazyGridSlotsProvider {
    ...
    public LazyGridSlots mo723invoke0kLqBqw(Density density, long constraints) {
        ...
        LazyGridSlots lazyGridSlotsInvoke = this.calculation.invoke(density, Constraints.m5816boximpl(constraints));
