...
final class MarqueeModifierNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, FocusEventModifierNode {
    ...
    private MarqueeModifierNode(int i, int i2, int i3, int i4, final MarqueeSpacing marqueeSpacing, float f) {
        ...
        this.animationMode = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(MarqueeAnimationMode.m314boximpl(i2), null, 2, null);
    ...
    public final int m329getAnimationModeZbEOnfQ() {
    ...
    public final void m330setAnimationMode97h66l8(int i) {
        this.animationMode.setValue(MarqueeAnimationMode.m314boximpl(i));
    }
    ...
    public final void m331updatelWfNwf4(int iterations, int animationMode, int delayMillis, int initialDelayMillis, MarqueeSpacing spacing, float velocity) {
        setSpacing(spacing);
        m330setAnimationMode97h66l8(animationMode);
        if (this.iterations == iterations && this.delayMillis == delayMillis && this.initialDelayMillis == initialDelayMillis && Dp.m5887equalsimpl0(this.velocity, velocity)) {
            return;
        }
    ...
    public MeasureResult mo121measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable placeableMo4783measureBRTryo0 = measurable.mo4783measureBRTryo0(Constraints.m5819copyZbe2FdA$default(j, 0, Integer.MAX_VALUE, 0, 0, 13, null));
        setContainerWidth(ConstraintsKt.m5842constrainWidthK40F9xA(j, placeableMo4783measureBRTryo0.getWidth()));
        setContentWidth(placeableMo4783measureBRTryo0.getWidth());
        return MeasureScope.CC.layout$default(measureScope, getContainerWidth(), placeableMo4783measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.MarqueeModifierNode$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.placeWithLayer$default(placementScope, placeableMo4783measureBRTryo0, MathKt.roundToInt((-((Number) this.offset.getValue()).floatValue()) * this.getDirection()), 0, 0.0f, null, 12, null);
            }
        }, 4, null);
    }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        float fM3285getHeightimpl = Size.m3285getHeightimpl(contentDrawScope2.mo3973getSizeNHjbRc());
        ...
        drawContext.getTransform().mo3982clipRectN_I0leg(fFloatValue, 0.0f, fFloatValue + getContainerWidth(), fM3285getHeightimpl, iM3483getIntersectrtfAjoo);
        if (z2) {
            ...
            if (i == 0) {
                ...
                if (FlowKt.collectLatest(SnapshotStateKt.snapshotFlow(new Function0<Float>() { // from class: androidx.compose.foundation.MarqueeModifierNode.runAnimation.2.1
                    ...
                    public final Float invoke() {
                        ...
                        if (!MarqueeAnimationMode.m317equalsimpl0(marqueeModifierNode.m329getAnimationModeZbEOnfQ(), MarqueeAnimationMode.INSTANCE.m324getWhileFocusedZbEOnfQ()) || marqueeModifierNode.getHasFocus()) {
                            return Float.valueOf(marqueeModifierNode.getContentWidth() + marqueeModifierNode.getSpacingPx());
                        }
                        return null;
                    }
                }), new C00232(MarqueeModifierNode.this, null), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
