...
public final class Updater<T> {
    ...
    public static int m2992hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m2997toStringimpl(Composer composer) {
        return "Updater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m2990equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m2992hashCodeimpl(this.composer);
    }

    public String toString() {
        return m2997toStringimpl(this.composer);
    }
    ...
    public static final void m2995setimpl(Composer composer, int i, Function2<? super T, ? super Integer, Unit> function2) {
    ...
    /* JADX INFO: renamed from: set-impl, reason: not valid java name */
    public static final <V> void m2996setimpl(Composer composer, V v, Function2<? super T, ? super V, Unit> function2) {
    ...
    public static final void m2998updateimpl(Composer composer, int i, Function2<? super T, ? super Integer, Unit> function2) {
    ...
    /* JADX INFO: renamed from: update-impl, reason: not valid java name */
    public static final <V> void m2999updateimpl(Composer composer, V v, Function2<? super T, ? super V, Unit> function2) {
        boolean inserting = composer.getInserting();
    ...
    public static final void m2993initimpl(Composer composer, final Function1<? super T, Unit> function1) {
    ...
    public static final void m2994reconcileimpl(Composer composer, final Function1<? super T, Unit> function1) {
