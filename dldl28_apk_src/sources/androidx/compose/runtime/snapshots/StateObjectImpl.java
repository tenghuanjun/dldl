...
public abstract class StateObjectImpl implements StateObject {
    ...
    public final void m3095recordReadInh_f27i8$runtime_release(int reader) {
        int iM3082constructorimpl;
        do {
            iM3082constructorimpl = ReaderKind.m3082constructorimpl(this.readerKind.get());
            if ((iM3082constructorimpl & reader) != 0) {
                return;
            }
        } while (!this.readerKind.compareAndSet(iM3082constructorimpl, ReaderKind.m3082constructorimpl(iM3082constructorimpl | reader)));
    }

    /* JADX INFO: renamed from: isReadIn-h_f27i8$runtime_release, reason: not valid java name */
    public final boolean m3094isReadInh_f27i8$runtime_release(int reader) {
        return (reader & ReaderKind.m3082constructorimpl(this.readerKind.get())) != 0;
    }
}
