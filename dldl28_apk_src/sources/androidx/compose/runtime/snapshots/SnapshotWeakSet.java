...
public final class SnapshotWeakSet<T> {
    ...
    public final void removeIf(Function1<? super T, Boolean> block) {
        ...
        while (true) {
            ...
            c cVar = weakReference != null ? (Object) weakReference.get() : null;
            if (cVar != null && !block.invoke(cVar).booleanValue()) {
                if (i2 != i) {
