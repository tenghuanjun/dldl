...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1250defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long jM1260defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m1260defaultRippleColor5vOe2sY(Color.INSTANCE.m3520getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return jM1260defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha rippleAlphaM1259defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m1259defaultRippleAlphaDxMtmZc(Color.INSTANCE.m3520getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return rippleAlphaM1259defaultRippleAlphaDxMtmZc;
    }
}
