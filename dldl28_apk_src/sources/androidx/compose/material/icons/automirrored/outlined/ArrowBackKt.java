...
public final class ArrowBackKt {
    ...
    public static final ImageVector getArrowBack(Icons.AutoMirrored.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Outlined.ArrowBack", Dp.m5882constructorimpl(24.0f), Dp.m5882constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
