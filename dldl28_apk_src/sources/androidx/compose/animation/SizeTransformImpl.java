...
final class SizeTransformImpl implements SizeTransform {
    ...
    public FiniteAnimationSpec<IntSize> mo144createAnimationSpecTemP2vQ(long initialSize, long targetSize) {
        return this.sizeAnimationSpec.invoke(IntSize.m6048boximpl(initialSize), IntSize.m6048boximpl(targetSize));
    }
}
