...
public final class AnimatedContentTransitionScopeImpl<S> implements AnimatedContentTransitionScope<S> {
    ...
    private final MutableState measuredSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m6048boximpl(IntSize.INSTANCE.m6061getZeroYbymL2g()), null, 2, null);
    ...
    public EnterTransition mo70slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> initialOffset) {
        return m91isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$1
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf(IntSize.m6056getWidthimpl(this.m90getCurrentSizeYbymL2g()) - IntOffset.m6014getXimpl(this.m89calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m90getCurrentSizeYbymL2g()))));
            }
        }) : m92isRightgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf((-IntOffset.m6014getXimpl(this.m89calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m90getCurrentSizeYbymL2g()))) - i));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m77equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m86getUpDKzdypw()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf(IntSize.m6055getHeightimpl(this.m90getCurrentSizeYbymL2g()) - IntOffset.m6015getYimpl(this.m89calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m90getCurrentSizeYbymL2g()))));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m77equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m81getDownDKzdypw()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$4
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf((-IntOffset.m6015getYimpl(this.m89calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m90getCurrentSizeYbymL2g()))) - i));
            }
        }) : EnterTransition.INSTANCE.getNone();
    }

    /* JADX INFO: renamed from: isLeft-gWo6LJ4, reason: not valid java name */
    private final boolean m91isLeftgWo6LJ4(int i) {
        return AnimatedContentTransitionScope.SlideDirection.m77equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m83getLeftDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m77equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m85getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr) || (AnimatedContentTransitionScope.SlideDirection.m77equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m82getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl);
    }

    /* JADX INFO: renamed from: isRight-gWo6LJ4, reason: not valid java name */
    private final boolean m92isRightgWo6LJ4(int i) {
        return AnimatedContentTransitionScope.SlideDirection.m77equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m84getRightDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m77equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m85getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl) || (AnimatedContentTransitionScope.SlideDirection.m77equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m82getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: calculateOffset-emnUabE, reason: not valid java name */
    public final long m89calculateOffsetemnUabE(long fullSize, long currentSize) {
        return getContentAlignment().mo3096alignKFBX0sM(fullSize, currentSize, LayoutDirection.Ltr);
    }

    @Override // androidx.compose.animation.AnimatedContentTransitionScope
    /* JADX INFO: renamed from: slideOutOfContainer-mOhB8PU */
    public ExitTransition mo71slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> targetOffset) {
        return m91isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$1
            ...
            public final Integer invoke(int i) {
                ...
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m6014getXimpl(this.this$0.m89calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m6061getZeroYbymL2g()))) - i));
            }
        }) : m92isRightgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$2
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
            ...
            public final Integer invoke(int i) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                long packedValue = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m6061getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m6014getXimpl(this.this$0.m89calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue))) + IntSize.m6056getWidthimpl(packedValue)));
            }
            ...
            public final Integer invoke(int i) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m6015getYimpl(this.this$0.m89calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m6061getZeroYbymL2g()))) - i));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m77equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m81getDownDKzdypw()) ? EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$4
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
            ...
            public final Integer invoke(int i) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                long packedValue = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m6061getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m6015getYimpl(this.this$0.m89calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue))) + IntSize.m6055getHeightimpl(packedValue)));
            }
    ...
    public final long m93getMeasuredSizeYbymL2g$animation_release() {
    ...
    public final void m94setMeasuredSizeozmzZPI$animation_release(long j) {
        this.measuredSize.setValue(IntSize.m6048boximpl(j));
    }
    ...
    public final long m90getCurrentSizeYbymL2g() {
        State<IntSize> state = this.animatedSize;
        return state != null ? state.getValue().getPackedValue() : m93getMeasuredSizeYbymL2g$animation_release();
    }
        ...
        public MeasureResult mo95measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
            ...
            Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>> function1 = new Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$1
                ...
                public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> segment) {
                    FiniteAnimationSpec<IntSize> finiteAnimationSpecMo144createAnimationSpecTemP2vQ;
                    State<IntSize> state = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(segment.getInitialState());
                    long packedValue = state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m6061getZeroYbymL2g();
                    State<IntSize> state2 = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(segment.getTargetState());
                    long packedValue2 = state2 != null ? state2.getValue().getPackedValue() : IntSize.INSTANCE.m6061getZeroYbymL2g();
                    SizeTransform value = this.getSizeTransform().getValue();
                    return (value == null || (finiteAnimationSpecMo144createAnimationSpecTemP2vQ = value.mo144createAnimationSpecTemP2vQ(packedValue, packedValue2)) == null) ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : finiteAnimationSpecMo144createAnimationSpecTemP2vQ;
                }
            };
            ...
            State<IntSize> stateAnimate = deferredAnimation.animate(function1, new Function1<S, IntSize>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$2
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(Object obj) {
                    return IntSize.m6048boximpl(m96invokeYEO4UFw(obj));
                }

                /* JADX INFO: renamed from: invoke-YEO4UFw, reason: not valid java name */
                public final long m96invokeYEO4UFw(S s) {
                    State<IntSize> state = animatedContentTransitionScopeImpl2.getTargetSizeMap$animation_release().get(s);
                    return state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m6061getZeroYbymL2g();
                }
            });
            AnimatedContentTransitionScopeImpl.this.setAnimatedSize$animation_release(stateAnimate);
            final long jMo3096alignKFBX0sM = AnimatedContentTransitionScopeImpl.this.getContentAlignment().mo3096alignKFBX0sM(IntSizeKt.IntSize(placeableMo4783measureBRTryo0.getWidth(), placeableMo4783measureBRTryo0.getHeight()), stateAnimate.getValue().getPackedValue(), LayoutDirection.Ltr);
            return MeasureScope.CC.layout$default(measureScope, IntSize.m6056getWidthimpl(stateAnimate.getValue().getPackedValue()), IntSize.m6055getHeightimpl(stateAnimate.getValue().getPackedValue()), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable.PlacementScope placementScope) {
                    Placeable.PlacementScope.m4836place70tqf50$default(placementScope, placeableMo4783measureBRTryo0, jMo3096alignKFBX0sM, 0.0f, 2, null);
                }
            }, 4, null);
        }
    }
