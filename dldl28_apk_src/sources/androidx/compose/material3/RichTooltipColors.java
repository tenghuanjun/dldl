...
public final class RichTooltipColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3495equalsimpl0(this.containerColor, richTooltipColors.containerColor) && Color.m3495equalsimpl0(this.contentColor, richTooltipColors.contentColor) && Color.m3495equalsimpl0(this.titleContentColor, richTooltipColors.titleContentColor) && Color.m3495equalsimpl0(this.actionContentColor, richTooltipColors.actionContentColor);
    }

    public int hashCode() {
        return (((((Color.m3501hashCodeimpl(this.containerColor) * 31) + Color.m3501hashCodeimpl(this.contentColor)) * 31) + Color.m3501hashCodeimpl(this.titleContentColor)) * 31) + Color.m3501hashCodeimpl(this.actionContentColor);
    }

    /* JADX INFO: renamed from: copy-jRlVdoo, reason: not valid java name */
    public final RichTooltipColors m1818copyjRlVdoo(long containerColor, long contentColor, long titleContentColor, long actionContentColor) {
        return new RichTooltipColors(containerColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? containerColor : this.containerColor, contentColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? contentColor : this.contentColor, titleContentColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? titleContentColor : this.titleContentColor, actionContentColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? actionContentColor : this.actionContentColor, null);
    }
}
