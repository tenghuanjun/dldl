...
public final class TopAppBarColors {
    ...
    public final long m2317containerColorvNxB06k$material3_release(float colorTransitionFraction) {
        return ColorKt.m3545lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(colorTransitionFraction));
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3495equalsimpl0(this.containerColor, topAppBarColors.containerColor) && Color.m3495equalsimpl0(this.scrolledContainerColor, topAppBarColors.scrolledContainerColor) && Color.m3495equalsimpl0(this.navigationIconContentColor, topAppBarColors.navigationIconContentColor) && Color.m3495equalsimpl0(this.titleContentColor, topAppBarColors.titleContentColor) && Color.m3495equalsimpl0(this.actionIconContentColor, topAppBarColors.actionIconContentColor);
    }

    public int hashCode() {
        return (((((((Color.m3501hashCodeimpl(this.containerColor) * 31) + Color.m3501hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m3501hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m3501hashCodeimpl(this.titleContentColor)) * 31) + Color.m3501hashCodeimpl(this.actionIconContentColor);
    }

    /* JADX INFO: renamed from: copy-t635Npw, reason: not valid java name */
    public final TopAppBarColors m2318copyt635Npw(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor) {
        return new TopAppBarColors(containerColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? containerColor : this.containerColor, scrolledContainerColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? scrolledContainerColor : this.scrolledContainerColor, navigationIconContentColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? navigationIconContentColor : this.navigationIconContentColor, titleContentColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? titleContentColor : this.titleContentColor, actionIconContentColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? actionIconContentColor : this.actionIconContentColor, null);
    }
}
