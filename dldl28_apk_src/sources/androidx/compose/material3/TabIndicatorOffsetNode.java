...
public final class TabIndicatorOffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    @Override // androidx.compose.ui.node.LayoutModifierNode
    /* JADX INFO: renamed from: measure-3p2s80s */
    public MeasureResult mo121measure3p2s80s(final MeasureScope measureScope, Measurable measurable, final long j) {
        Measurable measurable2;
        long jM5819copyZbe2FdA$default;
        ...
        if (this.followContentSize) {
            if (this.initialWidth != null) {
                ...
                if (!Dp.m5887equalsimpl0(contentWidth, animatable.getTargetValue().m5896unboximpl())) {
                ...
                this.initialWidth = Dp.m5880boximpl(contentWidth);
            }
        }
        ...
        if (this.initialOffset != null) {
            ...
            if (!Dp.m5887equalsimpl0(left, animatable2.getTargetValue().m5896unboximpl())) {
            ...
            this.initialOffset = Dp.m5880boximpl(left);
        }
        Animatable<Dp, AnimationVector1D> animatable3 = this.offsetAnimatable;
        if (animatable3 != null) {
            left = animatable3.getValue().m5896unboximpl();
        }
        final float f = left;
        if (this.followContentSize) {
            Animatable<Dp, AnimationVector1D> animatable4 = this.widthAnimatable;
            if (animatable4 != null) {
                contentWidth = animatable4.getValue().m5896unboximpl();
            }
            jM5819copyZbe2FdA$default = Constraints.m5819copyZbe2FdA$default(j, measureScope.mo339roundToPx0680j_4(contentWidth), measureScope.mo339roundToPx0680j_4(contentWidth), 0, 0, 12, null);
            measurable2 = measurable;
        } else {
            measurable2 = measurable;
            jM5819copyZbe2FdA$default = j;
        }
        final Placeable placeableMo4783measureBRTryo0 = measurable2.mo4783measureBRTryo0(jM5819copyZbe2FdA$default);
        return MeasureScope.CC.layout$default(measureScope, placeableMo4783measureBRTryo0.getWidth(), Constraints.m5827getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TabIndicatorOffsetNode$measure$4
            ...
            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, placeableMo4783measureBRTryo0, measureScope.mo339roundToPx0680j_4(f), Constraints.m5827getMaxHeightimpl(j) - placeableMo4783measureBRTryo0.getHeight(), 0.0f, 4, null);
            }
        }, 4, null);
    }
}
