...
public final class ColorScheme {
    ...
    public final /* synthetic */ ColorScheme m1398copyG1PFcw(long primary, long onPrimary, long primaryContainer, long onPrimaryContainer, long inversePrimary, long secondary, long onSecondary, long secondaryContainer, long onSecondaryContainer, long tertiary, long onTertiary, long tertiaryContainer, long onTertiaryContainer, long background, long onBackground, long surface, long onSurface, long surfaceVariant, long onSurfaceVariant, long surfaceTint, long inverseSurface, long inverseOnSurface, long error, long onError, long errorContainer, long onErrorContainer, long outline, long outlineVariant, long scrim) {
        return m1395copyCXl9yA$default(this, primary, onPrimary, primaryContainer, onPrimaryContainer, inversePrimary, secondary, onSecondary, secondaryContainer, onSecondaryContainer, tertiary, onTertiary, tertiaryContainer, onTertiaryContainer, background, onBackground, surface, onSurface, surfaceVariant, onSurfaceVariant, surfaceTint, inverseSurface, inverseOnSurface, error, onError, errorContainer, onErrorContainer, outline, outlineVariant, scrim, 0L, 0L, 0L, 0L, 0L, 0L, 0L, -536870912, 15, null);
    }

    public String toString() {
        return "ColorScheme(primary=" + ((Object) Color.m3502toStringimpl(this.primary)) + "onPrimary=" + ((Object) Color.m3502toStringimpl(this.onPrimary)) + "primaryContainer=" + ((Object) Color.m3502toStringimpl(this.primaryContainer)) + "onPrimaryContainer=" + ((Object) Color.m3502toStringimpl(this.onPrimaryContainer)) + "inversePrimary=" + ((Object) Color.m3502toStringimpl(this.inversePrimary)) + "secondary=" + ((Object) Color.m3502toStringimpl(this.secondary)) + "onSecondary=" + ((Object) Color.m3502toStringimpl(this.onSecondary)) + "secondaryContainer=" + ((Object) Color.m3502toStringimpl(this.secondaryContainer)) + "onSecondaryContainer=" + ((Object) Color.m3502toStringimpl(this.onSecondaryContainer)) + "tertiary=" + ((Object) Color.m3502toStringimpl(this.tertiary)) + "onTertiary=" + ((Object) Color.m3502toStringimpl(this.onTertiary)) + "tertiaryContainer=" + ((Object) Color.m3502toStringimpl(this.tertiaryContainer)) + "onTertiaryContainer=" + ((Object) Color.m3502toStringimpl(this.onTertiaryContainer)) + "background=" + ((Object) Color.m3502toStringimpl(this.background)) + "onBackground=" + ((Object) Color.m3502toStringimpl(this.onBackground)) + "surface=" + ((Object) Color.m3502toStringimpl(this.surface)) + "onSurface=" + ((Object) Color.m3502toStringimpl(this.onSurface)) + "surfaceVariant=" + ((Object) Color.m3502toStringimpl(this.surfaceVariant)) + "onSurfaceVariant=" + ((Object) Color.m3502toStringimpl(this.onSurfaceVariant)) + "surfaceTint=" + ((Object) Color.m3502toStringimpl(this.surfaceTint)) + "inverseSurface=" + ((Object) Color.m3502toStringimpl(this.inverseSurface)) + "inverseOnSurface=" + ((Object) Color.m3502toStringimpl(this.inverseOnSurface)) + "error=" + ((Object) Color.m3502toStringimpl(this.error)) + "onError=" + ((Object) Color.m3502toStringimpl(this.onError)) + "errorContainer=" + ((Object) Color.m3502toStringimpl(this.errorContainer)) + "onErrorContainer=" + ((Object) Color.m3502toStringimpl(this.onErrorContainer)) + "outline=" + ((Object) Color.m3502toStringimpl(this.outline)) + "outlineVariant=" + ((Object) Color.m3502toStringimpl(this.outlineVariant)) + "scrim=" + ((Object) Color.m3502toStringimpl(this.scrim)) + "surfaceBright=" + ((Object) Color.m3502toStringimpl(this.surfaceBright)) + "surfaceDim=" + ((Object) Color.m3502toStringimpl(this.surfaceDim)) + "surfaceContainer=" + ((Object) Color.m3502toStringimpl(this.surfaceContainer)) + "surfaceContainerHigh=" + ((Object) Color.m3502toStringimpl(this.surfaceContainerHigh)) + "surfaceContainerHighest=" + ((Object) Color.m3502toStringimpl(this.surfaceContainerHighest)) + "surfaceContainerLow=" + ((Object) Color.m3502toStringimpl(this.surfaceContainerLow)) + "surfaceContainerLowest=" + ((Object) Color.m3502toStringimpl(this.surfaceContainerLowest)) + ')';
    }
