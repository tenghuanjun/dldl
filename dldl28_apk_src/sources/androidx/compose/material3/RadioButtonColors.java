...
public final class RadioButtonColors {
    ...
    public final State<Color> radioColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        if (z) {
            ...
            stateRememberUpdatedState = SingleValueAnimationKt.m135animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 48, 12);
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3495equalsimpl0(this.selectedColor, radioButtonColors.selectedColor) && Color.m3495equalsimpl0(this.unselectedColor, radioButtonColors.unselectedColor) && Color.m3495equalsimpl0(this.disabledSelectedColor, radioButtonColors.disabledSelectedColor) && Color.m3495equalsimpl0(this.disabledUnselectedColor, radioButtonColors.disabledUnselectedColor);
    }

    public int hashCode() {
        return (((((Color.m3501hashCodeimpl(this.selectedColor) * 31) + Color.m3501hashCodeimpl(this.unselectedColor)) * 31) + Color.m3501hashCodeimpl(this.disabledSelectedColor)) * 31) + Color.m3501hashCodeimpl(this.disabledUnselectedColor);
    }

    /* JADX INFO: renamed from: copy-jRlVdoo, reason: not valid java name */
    public final RadioButtonColors m1810copyjRlVdoo(long selectedColor, long unselectedColor, long disabledSelectedColor, long disabledUnselectedColor) {
        return new RadioButtonColors(selectedColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? selectedColor : this.selectedColor, unselectedColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? unselectedColor : this.unselectedColor, disabledSelectedColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? disabledSelectedColor : this.disabledSelectedColor, disabledUnselectedColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? disabledUnselectedColor : this.disabledUnselectedColor, null);
    }
}
