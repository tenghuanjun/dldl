...
public final class SliderColors {
    ...
    public final long m1907thumbColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m1909trackColorWaAFU9c$material3_release(boolean enabled, boolean active) {
    ...
    public final long m1908tickColorWaAFU9c$material3_release(boolean enabled, boolean active) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3495equalsimpl0(this.thumbColor, sliderColors.thumbColor) && Color.m3495equalsimpl0(this.activeTrackColor, sliderColors.activeTrackColor) && Color.m3495equalsimpl0(this.activeTickColor, sliderColors.activeTickColor) && Color.m3495equalsimpl0(this.inactiveTrackColor, sliderColors.inactiveTrackColor) && Color.m3495equalsimpl0(this.inactiveTickColor, sliderColors.inactiveTickColor) && Color.m3495equalsimpl0(this.disabledThumbColor, sliderColors.disabledThumbColor) && Color.m3495equalsimpl0(this.disabledActiveTrackColor, sliderColors.disabledActiveTrackColor) && Color.m3495equalsimpl0(this.disabledActiveTickColor, sliderColors.disabledActiveTickColor) && Color.m3495equalsimpl0(this.disabledInactiveTrackColor, sliderColors.disabledInactiveTrackColor) && Color.m3495equalsimpl0(this.disabledInactiveTickColor, sliderColors.disabledInactiveTickColor);
    }

    public int hashCode() {
        return (((((((((((((((((Color.m3501hashCodeimpl(this.thumbColor) * 31) + Color.m3501hashCodeimpl(this.activeTrackColor)) * 31) + Color.m3501hashCodeimpl(this.activeTickColor)) * 31) + Color.m3501hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m3501hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m3501hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m3501hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m3501hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m3501hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m3501hashCodeimpl(this.disabledInactiveTickColor);
    }

    /* JADX INFO: renamed from: copy--K518z4, reason: not valid java name */
    public final SliderColors m1896copyK518z4(long thumbColor, long activeTrackColor, long activeTickColor, long inactiveTrackColor, long inactiveTickColor, long disabledThumbColor, long disabledActiveTrackColor, long disabledActiveTickColor, long disabledInactiveTrackColor, long disabledInactiveTickColor) {
        return new SliderColors(thumbColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? thumbColor : this.thumbColor, activeTrackColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? activeTrackColor : this.activeTrackColor, activeTickColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? activeTickColor : this.activeTickColor, inactiveTrackColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? inactiveTrackColor : this.inactiveTrackColor, inactiveTickColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? inactiveTickColor : this.inactiveTickColor, disabledThumbColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? disabledThumbColor : this.disabledThumbColor, disabledActiveTrackColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? disabledActiveTrackColor : this.disabledActiveTrackColor, disabledActiveTickColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? disabledActiveTickColor : this.disabledActiveTickColor, disabledInactiveTrackColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? disabledInactiveTrackColor : this.disabledInactiveTrackColor, disabledInactiveTickColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? disabledInactiveTickColor : this.disabledInactiveTickColor, null);
    }
}
