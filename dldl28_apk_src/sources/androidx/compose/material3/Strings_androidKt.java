...
public final class Strings_androidKt {
    ...
    public static final String m2011getStringNWtq28(int i, Composer composer, int i2) {
    ...
    public static final String m2012getStringiSCLEhQ(int i, Object[] objArr, Composer composer, int i2) {
        ...
        String strM2011getStringNWtq28 = m2011getStringNWtq28(i, composer, i2 & 14);
        ProvidableCompositionLocal<Configuration> localConfiguration = AndroidCompositionLocals_androidKt.getLocalConfiguration();
        ComposerKt.sourceInformationMarkerStart(composer, 2023513938, "CC:CompositionLocal.kt#9igjgp");
        ...
        String str = String.format(locale, strM2011getStringNWtq28, Arrays.copyOf(objArrCopyOf, objArrCopyOf.length));
