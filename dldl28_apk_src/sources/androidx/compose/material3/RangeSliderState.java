...
public final class RangeSliderState {
    ...
    public final void onDrag$material3_release(boolean isStart, float offset) {
        ...
        long jM1816scaleToUserValueowVgs5E = m1816scaleToUserValueowVgs5E(getMinPx(), getMaxPx(), jSliderRange);
        if (SliderRange.m1926equalsimpl0(jM1816scaleToUserValueowVgs5E, SliderKt.SliderRange(getActiveRangeStart(), getActiveRangeEnd()))) {
            return;
        }
        Function1<? super SliderRange, Unit> function1 = this.onValueChange;
        if (function1 == null) {
            setActiveRangeStart(SliderRange.m1928getStartimpl(jM1816scaleToUserValueowVgs5E));
            setActiveRangeEnd(SliderRange.m1927getEndInclusiveimpl(jM1816scaleToUserValueowVgs5E));
        } else if (function1 != null) {
            function1.invoke(SliderRange.m1923boximpl(jM1816scaleToUserValueowVgs5E));
        }
    }
    ...
    private final long m1816scaleToUserValueowVgs5E(float minPx, float maxPx, long offset) {
        return SliderKt.m1919scaleziovWd0(minPx, maxPx, offset, this.valueRange.getStart().floatValue(), this.valueRange.getEndInclusive().floatValue());
    }
