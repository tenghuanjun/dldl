...
public final class TimePicker_androidKt {
    ...
    public static final int getDefaultTimePickerLayoutType(Composer composer, int i) {
        ...
        if (configuration.screenHeightDp < configuration.screenWidthDp) {
            iM2215getVerticalQJTpgSE = TimePickerLayoutType.INSTANCE.m2214getHorizontalQJTpgSE();
        } else {
            iM2215getVerticalQJTpgSE = TimePickerLayoutType.INSTANCE.m2215getVerticalQJTpgSE();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return iM2215getVerticalQJTpgSE;
    }
}
