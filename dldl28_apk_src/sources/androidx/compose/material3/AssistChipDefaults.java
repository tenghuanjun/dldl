...
public final class AssistChipDefaults {
    ...
    private static final float Height = AssistChipTokens.INSTANCE.m2345getContainerHeightD9Ej5fM();
    private static final float IconSize = AssistChipTokens.INSTANCE.m2354getIconSizeD9Ej5fM();

    private AssistChipDefaults() {
    }

    /* JADX INFO: renamed from: getHeight-D9Ej5fM, reason: not valid java name */
    public final float m1287getHeightD9Ej5fM() {
        return Height;
    }

    /* JADX INFO: renamed from: getIconSize-D9Ej5fM, reason: not valid java name */
    public final float m1288getIconSizeD9Ej5fM() {
        return IconSize;
    }
    ...
    public final ChipColors m1283assistChipColorsoq7We08(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, Composer composer, int i, int i2) {
        ...
        long jM3530getUnspecified0d7_KjU8 = (i2 & 128) != 0 ? Color.INSTANCE.m3530getUnspecified0d7_KjU() : j8;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-391745725, i, -1, "androidx.compose.material3.AssistChipDefaults.assistChipColors (Chip.kt:977)");
        }
        ChipColors chipColorsM1366copyFD3wquc = getDefaultAssistChipColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1366copyFD3wquc(jM3530getUnspecified0d7_KjU, jM3530getUnspecified0d7_KjU2, jM3530getUnspecified0d7_KjU3, jM3530getUnspecified0d7_KjU4, jM3530getUnspecified0d7_KjU5, jM3530getUnspecified0d7_KjU6, jM3530getUnspecified0d7_KjU7, jM3530getUnspecified0d7_KjU8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ChipElevation m1284assistChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float fM2352getFlatContainerElevationD9Ej5fM = (i2 & 1) != 0 ? AssistChipTokens.INSTANCE.m2352getFlatContainerElevationD9Ej5fM() : f;
        float f7 = (i2 & 2) != 0 ? fM2352getFlatContainerElevationD9Ej5fM : f2;
        float f8 = (i2 & 4) != 0 ? fM2352getFlatContainerElevationD9Ej5fM : f3;
        float f9 = (i2 & 8) != 0 ? fM2352getFlatContainerElevationD9Ej5fM : f4;
        float fM2346getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? AssistChipTokens.INSTANCE.m2346getDraggedContainerElevationD9Ej5fM() : f5;
        float f10 = (i2 & 32) != 0 ? fM2352getFlatContainerElevationD9Ej5fM : f6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(245366099, i, -1, "androidx.compose.material3.AssistChipDefaults.assistChipElevation (Chip.kt:1029)");
        }
        ChipElevation chipElevation = new ChipElevation(fM2352getFlatContainerElevationD9Ej5fM, f7, f8, f9, fM2346getDraggedContainerElevationD9Ej5fM, f10, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final BorderStroke m1282assistChipBorderh1eTWw(boolean z, long j, long j2, float f, Composer composer, int i, int i2) {
        ...
        long jM3493copywmQWz5c$default = (i2 & 4) != 0 ? Color.m3493copywmQWz5c$default(ColorSchemeKt.getValue(AssistChipTokens.INSTANCE.getFlatDisabledOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j2;
        float fM2353getFlatOutlineWidthD9Ej5fM = (i2 & 8) != 0 ? AssistChipTokens.INSTANCE.m2353getFlatOutlineWidthD9Ej5fM() : f;
        if (ComposerKt.isTraceInProgress()) {
        ...
        BorderStroke borderStrokeM269BorderStrokecXLIe8U = BorderStrokeKt.m269BorderStrokecXLIe8U(fM2353getFlatOutlineWidthD9Ej5fM, value);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ChipBorder m1281assistChipBorderd_3_b6Q(long j, long j2, float f, Composer composer, int i, int i2) {
        ...
        long jM3493copywmQWz5c$default = (i2 & 2) != 0 ? Color.m3493copywmQWz5c$default(ColorSchemeKt.getValue(AssistChipTokens.INSTANCE.getFlatDisabledOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j2;
        float fM2353getFlatOutlineWidthD9Ej5fM = (i2 & 4) != 0 ? AssistChipTokens.INSTANCE.m2353getFlatOutlineWidthD9Ej5fM() : f;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(382372847, i, -1, "androidx.compose.material3.AssistChipDefaults.assistChipBorder (Chip.kt:1076)");
        }
        ChipBorder chipBorder = new ChipBorder(value, jM3493copywmQWz5c$default, fM2353getFlatOutlineWidthD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ChipColors m1285elevatedAssistChipColorsoq7We08(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, Composer composer, int i, int i2) {
        ...
        ChipColors chipColorsM1366copyFD3wquc = SuggestionChipDefaults.INSTANCE.getDefaultElevatedSuggestionChipColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1366copyFD3wquc(jM3530getUnspecified0d7_KjU, jM3530getUnspecified0d7_KjU2, jM3530getUnspecified0d7_KjU3, jM3530getUnspecified0d7_KjU4, jM3530getUnspecified0d7_KjU5, jM3530getUnspecified0d7_KjU6, jM3530getUnspecified0d7_KjU7, jM3530getUnspecified0d7_KjU8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ChipElevation m1286elevatedAssistChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float fM2347getElevatedContainerElevationD9Ej5fM = (i2 & 1) != 0 ? AssistChipTokens.INSTANCE.m2347getElevatedContainerElevationD9Ej5fM() : f;
        float fM2351getElevatedPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? AssistChipTokens.INSTANCE.m2351getElevatedPressedContainerElevationD9Ej5fM() : f2;
        float fM2349getElevatedFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? AssistChipTokens.INSTANCE.m2349getElevatedFocusContainerElevationD9Ej5fM() : f3;
        float fM2350getElevatedHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? AssistChipTokens.INSTANCE.m2350getElevatedHoverContainerElevationD9Ej5fM() : f4;
        float fM2346getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? AssistChipTokens.INSTANCE.m2346getDraggedContainerElevationD9Ej5fM() : f5;
        float fM2348getElevatedDisabledContainerElevationD9Ej5fM = (i2 & 32) != 0 ? AssistChipTokens.INSTANCE.m2348getElevatedDisabledContainerElevationD9Ej5fM() : f6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ChipElevation chipElevation = new ChipElevation(fM2347getElevatedContainerElevationD9Ej5fM, fM2351getElevatedPressedContainerElevationD9Ej5fM, fM2349getElevatedFocusContainerElevationD9Ej5fM, fM2350getElevatedHoverContainerElevationD9Ej5fM, fM2346getDraggedContainerElevationD9Ej5fM, fM2348getElevatedDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
