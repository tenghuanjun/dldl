...
public final class RadioButtonTokens {
    ...
    private static final float IconSize = Dp.m5882constructorimpl((float) 20.0d);
    ...
    public final float m2812getIconSizeD9Ej5fM() {
        return IconSize;
    }
    ...
    public final float m2813getStateLayerSizeD9Ej5fM() {
