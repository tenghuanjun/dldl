...
public final class SheetBottomTokens {
    ...
    private static final float DockedDragHandleHeight = Dp.m5882constructorimpl((float) 4.0d);
    private static final float DockedDragHandleWidth = Dp.m5882constructorimpl((float) 32.0d);
    private static final ShapeKeyTokens DockedMinimizedContainerShape = ShapeKeyTokens.CornerNone;
    private static final float DockedModalContainerElevation = ElevationTokens.INSTANCE.m2517getLevel1D9Ej5fM();
    private static final float DockedStandardContainerElevation = ElevationTokens.INSTANCE.m2517getLevel1D9Ej5fM();
    ...
    public final float m2825getDockedDragHandleHeightD9Ej5fM() {
        return DockedDragHandleHeight;
    }

    /* JADX INFO: renamed from: getDockedDragHandleWidth-D9Ej5fM, reason: not valid java name */
    public final float m2826getDockedDragHandleWidthD9Ej5fM() {
    ...
    public final float m2827getDockedModalContainerElevationD9Ej5fM() {
    ...
    public final float m2828getDockedStandardContainerElevationD9Ej5fM() {
