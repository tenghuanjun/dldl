...
public final class CircularProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m5882constructorimpl((float) 4.0d);
    ...
    private static final float Size = Dp.m5882constructorimpl((float) 48.0d);
    ...
    public final float m2379getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m2380getSizeD9Ej5fM() {
        return Size;
    }
}
