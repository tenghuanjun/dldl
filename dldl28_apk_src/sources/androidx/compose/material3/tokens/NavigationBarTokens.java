...
public final class NavigationBarTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m5882constructorimpl((float) 64.0d);
    ...
    private static final float ContainerElevation = ElevationTokens.INSTANCE.m2518getLevel2D9Ej5fM();
    private static final float ContainerHeight = Dp.m5882constructorimpl((float) 80.0d);
    ...
    public final float m2664getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2665getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m2666getContainerElevationD9Ej5fM() {
