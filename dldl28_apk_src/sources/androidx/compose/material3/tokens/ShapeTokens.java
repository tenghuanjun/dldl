...
public final class ShapeTokens {
    ...
    private static final RoundedCornerShape CornerMedium = RoundedCornerShapeKt.m876RoundedCornerShape0680j_4(Dp.m5882constructorimpl((float) 12.0d));
    private static final Shape CornerNone = RectangleShapeKt.getRectangleShape();
    private static final RoundedCornerShape CornerSmall = RoundedCornerShapeKt.m876RoundedCornerShape0680j_4(Dp.m5882constructorimpl((float) 8.0d));
    ...
    static {
        float f = (float) 28.0d;
        CornerExtraLarge = RoundedCornerShapeKt.m876RoundedCornerShape0680j_4(Dp.m5882constructorimpl(f));
        float f2 = (float) 0.0d;
        CornerExtraLargeTop = RoundedCornerShapeKt.m877RoundedCornerShapea9UjIt4(Dp.m5882constructorimpl(f), Dp.m5882constructorimpl(f), Dp.m5882constructorimpl(f2), Dp.m5882constructorimpl(f2));
        float f3 = (float) 4.0d;
        CornerExtraSmall = RoundedCornerShapeKt.m876RoundedCornerShape0680j_4(Dp.m5882constructorimpl(f3));
        CornerExtraSmallTop = RoundedCornerShapeKt.m877RoundedCornerShapea9UjIt4(Dp.m5882constructorimpl(f3), Dp.m5882constructorimpl(f3), Dp.m5882constructorimpl(f2), Dp.m5882constructorimpl(f2));
        float f4 = (float) 16.0d;
        CornerLarge = RoundedCornerShapeKt.m876RoundedCornerShape0680j_4(Dp.m5882constructorimpl(f4));
        CornerLargeEnd = RoundedCornerShapeKt.m877RoundedCornerShapea9UjIt4(Dp.m5882constructorimpl(f2), Dp.m5882constructorimpl(f4), Dp.m5882constructorimpl(f4), Dp.m5882constructorimpl(f2));
        CornerLargeTop = RoundedCornerShapeKt.m877RoundedCornerShapea9UjIt4(Dp.m5882constructorimpl(f4), Dp.m5882constructorimpl(f4), Dp.m5882constructorimpl(f2), Dp.m5882constructorimpl(f2));
    }
}
