...
public final class MenuTokens {
    ...
    private static final float ListItemContainerHeight = Dp.m5882constructorimpl((float) 48.0d);
    ...
    static {
        float f = (float) 24.0d;
        ListItemLeadingIconSize = Dp.m5882constructorimpl(f);
        ListItemTrailingIconSize = Dp.m5882constructorimpl(f);
    }
    ...
    public final float m2660getContainerElevationD9Ej5fM() {
    ...
    public final float m2661getListItemContainerHeightD9Ej5fM() {
    ...
    public final float m2662getListItemLeadingIconSizeD9Ej5fM() {
    ...
    public final float m2663getListItemTrailingIconSizeD9Ej5fM() {
