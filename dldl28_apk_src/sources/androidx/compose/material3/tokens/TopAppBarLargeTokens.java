...
public final class TopAppBarLargeTokens {
    ...
    private static final float ContainerHeight = Dp.m5882constructorimpl((float) 152.0d);
    ...
    public final float m2893getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m2894getTrailingIconSizeD9Ej5fM() {
