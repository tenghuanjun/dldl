...
public final class NavigationDrawerTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m5882constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens ActiveIndicatorShape = ShapeKeyTokens.CornerFull;
    private static final float ActiveIndicatorWidth = Dp.m5882constructorimpl((float) 336.0d);
    ...
    private static final float ContainerWidth = Dp.m5882constructorimpl((float) 360.0d);
    ...
    private static final float ModalContainerElevation = ElevationTokens.INSTANCE.m2517getLevel1D9Ej5fM();
    private static final float StandardContainerElevation = ElevationTokens.INSTANCE.m2516getLevel0D9Ej5fM();
    ...
    public final float m2669getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2670getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m2671getContainerWidthD9Ej5fM() {
    ...
    public final float m2672getIconSizeD9Ej5fM() {
        return IconSize;
    }
    ...
    public final float m2673getModalContainerElevationD9Ej5fM() {
        return ModalContainerElevation;
    }

    /* JADX INFO: renamed from: getStandardContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m2674getStandardContainerElevationD9Ej5fM() {
