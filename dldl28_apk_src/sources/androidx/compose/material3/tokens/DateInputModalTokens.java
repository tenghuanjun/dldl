...
public final class DateInputModalTokens {
    ...
    private static final float ContainerHeight = Dp.m5882constructorimpl((float) 512.0d);
    ...
    public final float m2477getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2478getContainerHeightD9Ej5fM() {
