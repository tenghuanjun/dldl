    ...
    */
    ...
    private static Configuration generateConfigDelta(Configuration configuration, Configuration configuration2) {
        ...
        if (configuration2 != null && configuration.diff(configuration2) != 0) {
            ...
            if ((configuration.screenLayout & KeyBoardKey.KeyboardKeyOem3) != (configuration2.screenLayout & KeyBoardKey.KeyboardKeyOem3)) {
                configuration3.screenLayout |= configuration2.screenLayout & KeyBoardKey.KeyboardKeyOem3;
            }
    ...
    static class Api33Impl {
        ...
        static OnBackInvokedCallback registerOnBackPressedCallback(Object obj, final AppCompatDelegateImpl appCompatDelegateImpl) {
            ...
            ComponentDialog$$ExternalSyntheticApiModelOutline0.m12m(obj).registerOnBackInvokedCallback(DurationKt.NANOS_IN_MILLIS, onBackInvokedCallback);
            return onBackInvokedCallback;
        }

        static void unregisterOnBackInvokedCallback(Object obj, Object obj2) {
            ComponentDialog$$ExternalSyntheticApiModelOutline0.m12m(obj).unregisterOnBackInvokedCallback(ComponentDialog$$ExternalSyntheticApiModelOutline0.m11m(obj2));
        }
