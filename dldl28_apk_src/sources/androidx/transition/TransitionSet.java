...
public class TransitionSet extends Transition {
    ...
    public Transition mo6295clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo6295clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo6295clone());
        }
