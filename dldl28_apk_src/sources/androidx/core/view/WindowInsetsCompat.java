...
public class WindowInsetsCompat {
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = HalfKt$$ExternalSyntheticApiModelOutline0.m6238m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            WindowInsets.Builder builderM6238m;
            super(windowInsetsCompat);
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                builderM6238m = HalfKt$$ExternalSyntheticApiModelOutline0.m6239m(windowInsets);
            } else {
                builderM6238m = HalfKt$$ExternalSyntheticApiModelOutline0.m6238m();
            }
            this.mPlatBuilder = builderM6238m;
        }
