...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        int i = KeyBoardKey.KeyboardKeyF19;
        if (!zCanScroll) {
            ...
            View viewFindNextFocus = FocusFinder.getInstance().findNextFocus(this, viewFindFocus, KeyBoardKey.KeyboardKeyF19);
            return (viewFindNextFocus == null || viewFindNextFocus == this || !viewFindNextFocus.requestFocus(KeyBoardKey.KeyboardKeyF19)) ? false : true;
        }
        ...
        if (keyCode == 20) {
            if (keyEvent.isAltPressed()) {
                return fullScroll(KeyBoardKey.KeyboardKeyF19);
            }
            return arrowScroll(KeyBoardKey.KeyboardKeyF19);
        }
        if (keyCode == 62) {
        ...
        pageScroll(KeyBoardKey.KeyboardKeyF19);
        return false;
    }
