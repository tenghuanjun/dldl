...
public final class LongSparseArrayKt {
    ...
    public static final class C08471<T> implements Iterator<T>, KMappedMarker {
        ...
        C08471(LongSparseArray<T> longSparseArray) {
    ...
    public static final <T> Iterator<T> valueIterator(LongSparseArray<T> longSparseArray) {
        return new C08471(longSparseArray);
    }
