...
public final class SparseArrayKt {
    ...
    public static final class C08481<T> implements Iterator<T>, KMappedMarker {
        ...
        C08481(SparseArray<T> sparseArray) {
