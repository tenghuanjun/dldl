    ...
    private final void resizeStorage(int newCapacity) {
        ...
        while (i2 < i) {
            if (((jArr2[i2 >> 3] >> ((i2 & 7) << 3)) & 255) < 128) {
                ...
                iArr4[iFindFirstAvailableSlot] = i3;
                iArr5[iFindFirstAvailableSlot] = iArr3[i2];
            } else {
                jArr = jArr2;
                iArr = iArr2;
            }
