...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    */
    ...
    private final Request createTunnel(int readTimeout, int writeTimeout, Request tunnelRequest, HttpUrl url) throws IOException {
        ...
        while (true) {
            ...
            if (iCode == 407) {
                ...
                if (StringsKt.equals("close", Response.header$default(responseBuild, HttpHeaders.HEAD_KEY_CONNECTION, null, 2, null), true)) {
    ...
    private final Request createTunnelRequest() throws IOException {
        Request requestBuild = new Request.Builder().url(this.route.address().url()).method("CONNECT", null).header("Host", Util.toHostHeader(this.route.address().url(), true)).header("Proxy-Connection", "Keep-Alive").header(HttpHeaders.HEAD_KEY_USER_AGENT, Util.userAgent).build();
