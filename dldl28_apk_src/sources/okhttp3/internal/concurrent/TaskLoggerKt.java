...
public final class TaskLoggerKt {
    ...
    public static final <T> T logElapsed(Task task, TaskQueue queue, Function0<? extends T> block) {
        ...
        try {
            ...
            if (zIsLoggable) {
                log(task, queue, Intrinsics.stringPlus("finished run in ", formatDuration(queue.getTaskRunner().getBackend().nanoTime() - jNanoTime)));
            }
