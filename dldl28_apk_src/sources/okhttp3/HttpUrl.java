...
public final class HttpUrl {
    ...
    public final String m8403deprecated_encodedUsername() {
    ...
    public final String m8399deprecated_encodedPassword() {
    ...
    public static final class Builder {
        ...
        public final Builder username(String username) {
            Intrinsics.checkNotNullParameter(username, "username");
            setEncodedUsername$okhttp(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, username, 0, 0, " \"':;<=>@[]^`{}|/\\?#", false, false, false, false, null, KeyBoardKey.KeyboardKeyZoom, null));
            return this;
        }

        public final Builder encodedUsername(String encodedUsername) {
            Intrinsics.checkNotNullParameter(encodedUsername, "encodedUsername");
            setEncodedUsername$okhttp(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, encodedUsername, 0, 0, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, KeyBoardKey.KeyboardKeyOemAuto, null));
            return this;
        }

        public final Builder password(String password) {
            Intrinsics.checkNotNullParameter(password, "password");
            setEncodedPassword$okhttp(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, password, 0, 0, " \"':;<=>@[]^`{}|/\\?#", false, false, false, false, null, KeyBoardKey.KeyboardKeyZoom, null));
            return this;
        }

        public final Builder encodedPassword(String encodedPassword) {
            Intrinsics.checkNotNullParameter(encodedPassword, "encodedPassword");
            setEncodedPassword$okhttp(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, encodedPassword, 0, 0, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, KeyBoardKey.KeyboardKeyOemAuto, null));
            return this;
        }
        ...
        public final Builder setPathSegment(int index, String pathSegment) {
            Intrinsics.checkNotNullParameter(pathSegment, "pathSegment");
            String strCanonicalize$okhttp$default = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, pathSegment, 0, 0, HttpUrl.PATH_SEGMENT_ENCODE_SET, false, false, false, false, null, KeyBoardKey.KeyboardKeyZoom, null);
        ...
        public final Builder setEncodedPathSegment(int index, String encodedPathSegment) {
            Intrinsics.checkNotNullParameter(encodedPathSegment, "encodedPathSegment");
            String strCanonicalize$okhttp$default = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, encodedPathSegment, 0, 0, HttpUrl.PATH_SEGMENT_ENCODE_SET, true, false, false, false, null, KeyBoardKey.KeyboardKeyOemAuto, null);
            getEncodedPathSegments$okhttp().set(index, strCanonicalize$okhttp$default);
            if (isDot(strCanonicalize$okhttp$default) || isDotDot(strCanonicalize$okhttp$default)) {
        ...
        public final Builder query(String query) {
            ...
            if (query != null && (strCanonicalize$okhttp$default = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, query, 0, 0, HttpUrl.QUERY_ENCODE_SET, false, false, true, false, null, KeyBoardKey.KeyboardKeyOem4, null)) != null) {
        ...
        public final Builder encodedQuery(String encodedQuery) {
            String strCanonicalize$okhttp$default;
            List<String> queryNamesAndValues$okhttp = null;
            if (encodedQuery != null && (strCanonicalize$okhttp$default = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, encodedQuery, 0, 0, HttpUrl.QUERY_ENCODE_SET, true, false, true, false, null, KeyBoardKey.KeyboardKeyGamepadLeftThumbStickUp, null)) != null) {
                queryNamesAndValues$okhttp = HttpUrl.INSTANCE.toQueryNamesAndValues$okhttp(strCanonicalize$okhttp$default);
            }
            setEncodedQueryNamesAndValues$okhttp(queryNamesAndValues$okhttp);
            return this;
        ...
        public final Builder addQueryParameter(String name, String value) {
            ...
            encodedQueryNamesAndValues$okhttp.add(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, name, 0, 0, HttpUrl.QUERY_COMPONENT_ENCODE_SET, false, false, true, false, null, KeyBoardKey.KeyboardKeyOem4, null));
            ...
            encodedQueryNamesAndValues$okhttp2.add(value == null ? null : Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, value, 0, 0, HttpUrl.QUERY_COMPONENT_ENCODE_SET, false, false, true, false, null, KeyBoardKey.KeyboardKeyOem4, null));
            return this;
        }
        ...
        public final Builder addEncodedQueryParameter(String encodedName, String encodedValue) {
            ...
            List<String> encodedQueryNamesAndValues$okhttp = getEncodedQueryNamesAndValues$okhttp();
            Intrinsics.checkNotNull(encodedQueryNamesAndValues$okhttp);
            encodedQueryNamesAndValues$okhttp.add(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, encodedName, 0, 0, HttpUrl.QUERY_COMPONENT_REENCODE_SET, true, false, true, false, null, KeyBoardKey.KeyboardKeyGamepadLeftThumbStickUp, null));
            List<String> encodedQueryNamesAndValues$okhttp2 = getEncodedQueryNamesAndValues$okhttp();
            Intrinsics.checkNotNull(encodedQueryNamesAndValues$okhttp2);
            encodedQueryNamesAndValues$okhttp2.add(encodedValue == null ? null : Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, encodedValue, 0, 0, HttpUrl.QUERY_COMPONENT_REENCODE_SET, true, false, true, false, null, KeyBoardKey.KeyboardKeyGamepadLeftThumbStickUp, null));
            return this;
        }
        ...
        public final Builder removeAllQueryParameters(String name) {
            ...
            removeAllCanonicalQueryParameters(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, name, 0, 0, HttpUrl.QUERY_COMPONENT_ENCODE_SET, false, false, true, false, null, KeyBoardKey.KeyboardKeyOem4, null));
            return this;
        }
        ...
        public final Builder removeAllEncodedQueryParameters(String encodedName) {
            ...
            removeAllCanonicalQueryParameters(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, encodedName, 0, 0, HttpUrl.QUERY_COMPONENT_REENCODE_SET, true, false, true, false, null, KeyBoardKey.KeyboardKeyGamepadLeftThumbStickUp, null));
            return this;
        }
        ...
        public final Builder fragment(String fragment) {
            setEncodedFragment$okhttp(fragment == null ? null : Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, fragment, 0, 0, "", false, false, false, true, null, KeyBoardKey.KeyboardKeyOemPlus, null));
            return this;
        }

        public final Builder encodedFragment(String encodedFragment) {
            setEncodedFragment$okhttp(encodedFragment == null ? null : Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, encodedFragment, 0, 0, "", true, false, false, true, null, KeyBoardKey.KeyboardKeyMediaPlayPause, null));
            return this;
        }
        ...
        public final Builder reencodeForUri$okhttp() {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                getEncodedPathSegments$okhttp().set(i2, Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, getEncodedPathSegments$okhttp().get(i2), 0, 0, HttpUrl.PATH_SEGMENT_ENCODE_SET_URI, true, true, false, false, null, KeyBoardKey.KeyboardKeyIcoHelp, null));
            }
            List<String> encodedQueryNamesAndValues$okhttp = getEncodedQueryNamesAndValues$okhttp();
            if (encodedQueryNamesAndValues$okhttp != null) {
                ...
                while (i < size2) {
                    ...
                    encodedQueryNamesAndValues$okhttp.set(i, str == null ? null : Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, str, 0, 0, HttpUrl.QUERY_COMPONENT_ENCODE_SET_URI, true, true, true, false, null, KeyBoardKey.KeyboardKeyGamepadA, null));
                    i = i3;
                }
            }
            String encodedFragment = getEncodedFragment();
            setEncodedFragment$okhttp(encodedFragment != null ? Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, encodedFragment, 0, 0, HttpUrl.FRAGMENT_ENCODE_SET_URI, true, true, false, true, null, KeyBoardKey.KeyboardKeyRcontrol, null) : null);
            return this;
        }
        ...
        */
        ...
        public final Builder parse$okhttp(HttpUrl base, String input) {
                ...
                while (true) {
                    ...
                    if (bCharAt == 64) {
                        if (!z2) {
                            ...
                            String strCanonicalize$okhttp$default = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, i4, iDelimiterOffset2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, KeyBoardKey.KeyboardKeyOemAttn, null);
                            if (z3) {
                            ...
                            if (iDelimiterOffset2 != iDelimiterOffset) {
                                i2 = iDelimiterOffset;
                                this.encodedPassword = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, iDelimiterOffset2 + 1, iDelimiterOffset, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, KeyBoardKey.KeyboardKeyOemAttn, null);
                                z = true;
                            } else {
                                i2 = iDelimiterOffset;
                                z = z2;
                            ...
                            sb2.append("%40");
                            i3 = iIndexOfLastNonAsciiWhitespace$default;
                            sb2.append(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, i4, i2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, KeyBoardKey.KeyboardKeyOemAttn, null));
            ...
            if (iDelimiterOffset3 < i6 && input2.charAt(iDelimiterOffset3) == '?') {
                ...
                this.encodedQueryNamesAndValues = HttpUrl.INSTANCE.toQueryNamesAndValues$okhttp(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, iDelimiterOffset3 + 1, iDelimiterOffset4, HttpUrl.QUERY_ENCODE_SET, true, false, true, false, null, KeyBoardKey.KeyboardKeyGamepadView, null));
                iDelimiterOffset3 = iDelimiterOffset4;
            }
            if (iDelimiterOffset3 < i6 && input2.charAt(iDelimiterOffset3) == '#') {
                this.encodedFragment = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, iDelimiterOffset3 + 1, i6, "", true, false, false, true, null, KeyBoardKey.KeyboardKeyMediaNextTrack, null);
            }
            return this;
        }
        ...
        private final void push(String input, int pos, int limit, boolean addTrailingSlash, boolean alreadyEncoded) {
            String strCanonicalize$okhttp$default = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, pos, limit, HttpUrl.PATH_SEGMENT_ENCODE_SET, alreadyEncoded, false, false, false, null, KeyBoardKey.KeyboardKeyOemAttn, null);
        ...
        public static final class Companion {
            ...
            public final int parsePort(String input, int pos, int limit) {
                try {
                    int i = Integer.parseInt(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, pos, limit, "", false, false, false, false, null, KeyBoardKey.KeyboardKeyExSel, null));
                    if (1 > i || i >= 65536) {
                        return -1;
                    }
                    return i;
    ...
    public static final class Companion {
        ...
        public final HttpUrl m8417deprecated_get(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        public final HttpUrl m8420deprecated_parse(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return parse(url);
        }
        ...
        @Deprecated(level = DeprecationLevel.ERROR, message = "moved to extension function", replaceWith = @ReplaceWith(expression = "url.toHttpUrlOrNull()", imports = {"okhttp3.HttpUrl.Companion.toHttpUrlOrNull"}))
        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m8419deprecated_get(URL url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m8418deprecated_get(URI uri) {
