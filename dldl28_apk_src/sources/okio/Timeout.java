    ...
    public final void awaitSignal(Condition condition) throws InterruptedIOException {
        ...
        try {
            ...
            if (jNanoTime >= timeoutNanos) {
                throw new InterruptedIOException(Constant.API_PARAMS_KEY_TIMEOUT);
            }
