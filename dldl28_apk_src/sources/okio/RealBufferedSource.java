...
public final class RealBufferedSource implements BufferedSource {
    ...
    public InputStream inputStream() {
        return new InputStream() { // from class: okio.RealBufferedSource.inputStream.1
            ...
            public int read() throws IOException {
                ...
                if (RealBufferedSource.this.bufferField.size() == 0 && RealBufferedSource.this.source.read(RealBufferedSource.this.bufferField, IjkMediaMeta.AV_CH_TOP_FRONT_CENTER) == -1) {
                    return -1;
                }
    ...
    public long read(Buffer sink, long byteCount) {
        ...
        if (this.bufferField.size() == 0 && this.source.read(this.bufferField, IjkMediaMeta.AV_CH_TOP_FRONT_CENTER) == -1) {
            return -1L;
        }
    ...
    public boolean exhausted() {
        ...
        return this.bufferField.exhausted() && this.source.read(this.bufferField, IjkMediaMeta.AV_CH_TOP_FRONT_CENTER) == -1;
    }
    ...
    public boolean request(long byteCount) {
        ...
        while (this.bufferField.size() < byteCount) {
            if (this.source.read(this.bufferField, IjkMediaMeta.AV_CH_TOP_FRONT_CENTER) == -1) {
                return false;
            }
        }
        return true;
    ...
    public int select(Options options) throws EOFException {
        ...
        while (true) {
            ...
            } else if (this.source.read(this.bufferField, IjkMediaMeta.AV_CH_TOP_FRONT_CENTER) == -1) {
                break;
            }
        }
        return -1;
    ...
    public long readAll(Sink sink) throws IOException {
        Intrinsics.checkNotNullParameter(sink, "sink");
        long j = 0;
        while (this.source.read(this.bufferField, IjkMediaMeta.AV_CH_TOP_FRONT_CENTER) != -1) {
    ...
    public long indexOf(byte b, long fromIndex, long toIndex) {
        ...
        while (fromIndex < toIndex) {
            ...
            if (size >= toIndex || this.source.read(this.bufferField, IjkMediaMeta.AV_CH_TOP_FRONT_CENTER) == -1) {
                return -1L;
            }
