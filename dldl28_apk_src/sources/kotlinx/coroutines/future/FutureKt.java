...
public final class FutureKt {
    ...
    public static final <T> CompletableFuture<T> future(CoroutineScope coroutineScope, CoroutineContext coroutineContext, CoroutineStart coroutineStart, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2) {
        ...
        CompletableFuture<T> completableFutureM8378m = Headers$$ExternalSyntheticApiModelOutline0.m8378m();
        CompletableFutureCoroutine completableFutureCoroutine = new CompletableFutureCoroutine(coroutineContextNewCoroutineContext, completableFutureM8378m);
        completableFutureM8378m.handle(Headers$$ExternalSyntheticApiModelOutline0.m8380m((Object) completableFutureCoroutine));
        completableFutureCoroutine.start(coroutineStart, completableFutureCoroutine, function2);
        return completableFutureM8378m;
    }

    public static final <T> CompletableFuture<T> asCompletableFuture(final Deferred<? extends T> deferred) {
        final CompletableFuture<T> completableFutureM8378m = Headers$$ExternalSyntheticApiModelOutline0.m8378m();
        setupCancellation(deferred, completableFutureM8378m);
        deferred.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.future.FutureKt.asCompletableFuture.1
            ...
            public final void invoke2(Throwable th) {
                try {
                    completableFutureM8378m.complete(deferred.getCompleted());
                } catch (Throwable th2) {
                    completableFutureM8378m.completeExceptionally(th2);
                }
            }
        });
        return completableFutureM8378m;
    ...
    public static final CompletableFuture<Unit> asCompletableFuture(Job job) {
        final CompletableFuture<Unit> completableFutureM8378m = Headers$$ExternalSyntheticApiModelOutline0.m8378m();
        setupCancellation(job, completableFutureM8378m);
        job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.future.FutureKt.asCompletableFuture.2
            ...
            public final void invoke2(Throwable th) {
                if (th == null) {
                    completableFutureM8378m.complete(Unit.INSTANCE);
                } else {
                    completableFutureM8378m.completeExceptionally(th);
                }
            }
        });
        return completableFutureM8378m;
            ...
            public final Object invoke(T t, Throwable th2) {
                ...
                try {
                    if (th2 == null) {
                        ...
                        CompletionException completionExceptionM8379m = Headers$$ExternalSyntheticApiModelOutline0.m8384m((Object) th2) ? Headers$$ExternalSyntheticApiModelOutline0.m8379m((Object) th2) : null;
                        if (completionExceptionM8379m != null && (cause2 = completionExceptionM8379m.getCause()) != null) {
                            th2 = cause2;
                        }
    ...
    public static final <T> Object await(CompletionStage<T> completionStage, Continuation<? super T> continuation) throws Throwable {
        ...
        completionStage.handle(Headers$$ExternalSyntheticApiModelOutline0.m8380m((Object) continuationHandler));
