...
final class ContinuationHandler<T> implements BiFunction<T, Throwable, Unit> {
    ...
    public void apply2(T result, Throwable exception) {
        ...
        if (exception == null) {
            ...
            continuation.resumeWith(Result.m6745constructorimpl(result));
            return;
        }
        CompletionException completionExceptionM8379m = Headers$$ExternalSyntheticApiModelOutline0.m8384m((Object) exception) ? Headers$$ExternalSyntheticApiModelOutline0.m8379m((Object) exception) : null;
        if (completionExceptionM8379m != null && (cause = completionExceptionM8379m.getCause()) != null) {
            exception = cause;
        }
        Result.Companion companion2 = Result.INSTANCE;
        continuation.resumeWith(Result.m6745constructorimpl(ResultKt.createFailure(exception)));
    }
}
