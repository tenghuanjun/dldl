...
public class SemaphoreImpl implements Semaphore {
    ...
    private static final AtomicReferenceFieldUpdater head$FU = AtomicReferenceFieldUpdater.newUpdater(SemaphoreImpl.class, Object.class, CacheEntity.HEAD);
    ...
    public final boolean addAcquireToQueue(Waiter waiter) {
        ...
        SemaphoreSegment semaphoreSegment2 = (SemaphoreSegment) SegmentOrClosed.m8310getSegmentimpl(objFindSegmentInternal);
