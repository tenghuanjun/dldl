...
public final class DelayKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.DelayKt", f = "Delay.kt", i = {}, l = {KeyBoardKey.KeyboardKeyRcontrol}, m = "awaitCancellation", n = {}, s = {})
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.get$context()).mo8305scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m8236delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m8237toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m8237toDelayMillisLRDsOJo(long j) {
        if (Duration.m8071compareToLRDsOJo(j, Duration.INSTANCE.m8175getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m8090getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
