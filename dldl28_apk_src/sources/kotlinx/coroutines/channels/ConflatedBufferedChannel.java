...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM8276trySendImplMj0NB7M = conflatedBufferedChannel.m8276trySendImplMj0NB7M(e, true);
        if (objM8276trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m8262exceptionOrNullimpl(objM8276trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM8276trySendImplMj0NB7M = conflatedBufferedChannel.m8276trySendImplMj0NB7M(e, true);
        if (!(objM8276trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo8248trySendJP2dKIU(E element) {
        return m8276trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m8276trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m8274trySendDropLatestMj0NB7M(element, isSendOp) : m8275trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m8274trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo8248trySendJP2dKIU = super.mo8248trySendJP2dKIU(element);
        if (ChannelResult.m8268isSuccessimpl(objMo8248trySendJP2dKIU) || ChannelResult.m8266isClosedimpl(objMo8248trySendJP2dKIU)) {
            return objMo8248trySendJP2dKIU;
        }
        ...
        return ChannelResult.INSTANCE.m8273successJP2dKIU(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: trySendDropOldest-JP2dKIU, reason: not valid java name */
    private final Object m8275trySendDropOldestJP2dKIU(E element) {
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (channelSegmentFindSegmentSend != null) {
                    ...
                    return ChannelResult.INSTANCE.m8271closedJP2dKIU(getSendException());
                }
            } else {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo8248trySendJP2dKIU = mo8248trySendJP2dKIU(element);
        if (!(objMo8248trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo8248trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m8262exceptionOrNullimpl(objMo8248trySendJP2dKIU);
