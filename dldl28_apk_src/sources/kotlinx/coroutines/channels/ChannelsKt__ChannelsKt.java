...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                ...
                objM6745constructorimpl = Result.m6745constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM6745constructorimpl = Result.m6745constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m8258boximpl(Result.m6752isSuccessimpl(objM6745constructorimpl) ? ChannelResult.INSTANCE.m8273successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m8271closedJP2dKIU(Result.m6748exceptionOrNullimpl(objM6745constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo8248trySendJP2dKIU = sendChannel.mo8248trySendJP2dKIU(e);
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel sendChannel, Object obj) throws InterruptedException {
        if (ChannelResult.m8268isSuccessimpl(sendChannel.mo8248trySendJP2dKIU(obj))) {
            return;
        }
