...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM6745constructorimpl2;
        ...
        try {
            ...
            objM6745constructorimpl = Result.m6745constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM6745constructorimpl = Result.m6745constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m6748exceptionOrNullimpl(objM6745constructorimpl) == null) {
            obj2 = objM6745constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM6745constructorimpl2 = Result.m6745constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM6745constructorimpl2 = Result.m6745constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m6748exceptionOrNullimpl(objM6745constructorimpl2) == null) {
            obj = objM6745constructorimpl2;
        }
