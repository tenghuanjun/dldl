...
public final class SingleMapOptional<T, R> extends Maybe<R> {
    ...
    static final class MapOptionalSingleObserver<T, R> implements SingleObserver<T>, Disposable {
        ...
        public void onSuccess(T t) {
            try {
                Optional optionalM6718m = l$$ExternalSyntheticApiModelOutline0.m6718m(Objects.requireNonNull(this.mapper.apply(t), "The mapper returned a null item"));
                if (optionalM6718m.isPresent()) {
                    this.downstream.onSuccess((Object) optionalM6718m.get());
                } else {
