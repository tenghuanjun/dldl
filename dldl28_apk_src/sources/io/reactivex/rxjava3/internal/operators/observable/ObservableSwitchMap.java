    ...
    static final class SwitchMapObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public void onNext(T t) {
            ...
            try {
                ...
                } while (!ComplexDouble$$ExternalSyntheticBackport0.m(this.active, switchMapInnerObserver, switchMapInnerObserver3));
        ...
        */
        void drain() {
            ...
            L82:
                ...
                androidx.compose.animation.core.ComplexDouble$$ExternalSyntheticBackport0.m(r1, r5, r10)
                if (r2 != 0) goto L9b
                r13.disposeInner()
