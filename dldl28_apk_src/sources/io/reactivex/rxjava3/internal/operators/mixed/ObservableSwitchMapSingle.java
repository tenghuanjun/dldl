...
public final class ObservableSwitchMapSingle<T, R> extends Observable<R> {
    ...
    static final class SwitchMapSingleMainObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        void innerError(SwitchMapSingleObserver<R> sender, Throwable ex) {
            if (ComplexDouble$$ExternalSyntheticBackport0.m(this.inner, sender, null)) {
        ...
        void drain() {
            ...
            while (!this.cancelled) {
                ...
                if (z && z2) {
                    ...
                    ComplexDouble$$ExternalSyntheticBackport0.m(atomicReference, switchMapSingleObserver, null);
