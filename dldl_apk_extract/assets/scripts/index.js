                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            var assetsIdUrl=urlpath + 'update/assetsid.txt?rand=' + Math.random() * Date.now();
                            if(window["downloadBySourceIp"])
                                return [4 /*yield*/,window["downloadBySourceIp"](assetsIdUrl)];//直接从cdn下载这个文件失败率太高，这里支持外部可以修改，增加重试次数
                            else
                                return [4 /*yield*/,asyncs.downloadSync(assetsIdUrl, false, null)];
                        case 1:
                            assetsidStr = (_a.sent());
                        ...
                        case 2:
                            ...
                            log('need update;');
                            txtdcc = '';
                            return [4 /*yield*/, asyncs.downloadSync(urlpath + 'update/filetable_'+assetsidStr+'.bin', true, null)];
                        case 3:
                            bindcc = _a.sent();
                            if (!(!bindcc || !(bindcc instanceof ArrayBuffer))) return [3 /*break*/, 5];
                            return [4 /*yield*/, asyncs.downloadSync(urlpath + 'update/filetable_'+assetsidStr+'.txt' , false, null)];
                        case 4:
                            txtdcc = (_a.sent());
                            return [3 /*break*/, 6];
                        case 5:
                ...
                case 8:
                    if (!data) {
                        if (window["loadingView"] && window["loadingView"].setTips) {
                            ...
                            window["loadingView"].setTips(['網絡異常，請檢查您的網絡或與開發商聯系。']);
                        }
