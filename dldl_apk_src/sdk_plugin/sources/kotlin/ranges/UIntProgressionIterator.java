...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    private UIntProgressionIterator(int i, int i2, int i3) {
        ...
        this.hasNext = z;
        this.step = UInt.m146constructorimpl(i3);
        this.next = this.hasNext ? i : this.finalElement;
    }

    @Override // java.util.Iterator
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m140boximpl(m1284nextpVg5ArA());
    }
    ...
    public int m1284nextpVg5ArA() {
        ...
        if (i == this.finalElement) {
            ...
            this.next = UInt.m146constructorimpl(this.step + i);
        }
        return i;
    }
}
