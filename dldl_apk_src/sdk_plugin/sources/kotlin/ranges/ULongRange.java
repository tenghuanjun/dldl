...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong>, OpenEndRange<ULong> {
    ...
    public static /* synthetic */ void m1294getEndExclusivesVKNKU$annotations() {
    }

    @Override // kotlin.ranges.ClosedRange, kotlin.ranges.OpenEndRange
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m1295containsVKZWuLQ(((ULong) comparable).getData());
    }

    @Override // kotlin.ranges.OpenEndRange
    public /* bridge */ /* synthetic */ Comparable getEndExclusive() {
        return ULong.m218boximpl(m1296getEndExclusivesVKNKU());
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ Comparable getEndInclusive() {
        return ULong.m218boximpl(m1297getEndInclusivesVKNKU());
    }

    @Override // kotlin.ranges.ClosedRange, kotlin.ranges.OpenEndRange
    public /* bridge */ /* synthetic */ Comparable getStart() {
        return ULong.m218boximpl(m1298getStartsVKNKU());
    }
    ...
    public long m1298getStartsVKNKU() {
        return getFirst();
    }

    /* JADX INFO: renamed from: getEndInclusive-s-VKNKU, reason: not valid java name */
    public long m1297getEndInclusivesVKNKU() {
        return getLast();
    }

    /* JADX INFO: renamed from: getEndExclusive-s-VKNKU, reason: not valid java name */
    public long m1296getEndExclusivesVKNKU() {
        if (getLast() == -1) {
            throw new IllegalStateException("Cannot return the exclusive upper bound of a range that includes MAX_VALUE.".toString());
        }
        return ULong.m224constructorimpl(getLast() + ULong.m224constructorimpl(((long) 1) & 4294967295L));
    }

    /* JADX INFO: renamed from: contains-VKZWuLQ, reason: not valid java name */
    public boolean m1295containsVKZWuLQ(long value) {
    ...
    public int hashCode() {
        ...
        return ((int) ULong.m224constructorimpl(getLast() ^ ULong.m224constructorimpl(getLast() >>> 32))) + (((int) ULong.m224constructorimpl(getFirst() ^ ULong.m224constructorimpl(getFirst() >>> 32))) * 31);
    }

    @Override // kotlin.ranges.ULongProgression
    public String toString() {
        return ((Object) ULong.m269toStringimpl(getFirst())) + ".." + ((Object) ULong.m269toStringimpl(getLast()));
    }
