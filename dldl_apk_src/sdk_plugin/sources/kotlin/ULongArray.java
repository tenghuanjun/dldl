...
public final class ULongArray implements Collection<ULong>, KMappedMarker {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof ULong) {
            return m291containsVKZWuLQ(((ULong) obj).getData());
        }
        return false;
    }
    ...
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long[] m277constructorimpl(int i) {
        return m278constructorimpl(new long[i]);
    }

    /* JADX INFO: renamed from: get-s-VKNKU, reason: not valid java name */
    public static final long m283getsVKNKU(long[] jArr, int i) {
        return ULong.m224constructorimpl(jArr[i]);
    }

    /* JADX INFO: renamed from: set-k8EXiF4, reason: not valid java name */
    public static final void m288setk8EXiF4(long[] jArr, int i, long j) {
        jArr[i] = j;
    }

    /* JADX INFO: renamed from: getSize-impl, reason: not valid java name */
    public static int m284getSizeimpl(long[] jArr) {
        return jArr.length;
    }
    ...
    public static java.util.Iterator<ULong> m287iteratorimpl(long[] jArr) {
    ...
    private static final class Iterator implements java.util.Iterator<ULong>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ ULong next() {
            return ULong.m218boximpl(m293nextsVKNKU());
        }
    ...
    public boolean m291containsVKZWuLQ(long j) {
        return m279containsVKZWuLQ(this.storage, j);
    }

    /* JADX INFO: renamed from: contains-VKZWuLQ, reason: not valid java name */
    public static boolean m279containsVKZWuLQ(long[] jArr, long j) {
    ...
    public static boolean m280containsAllimpl(long[] jArr, Collection<ULong> elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
    ...
    public static boolean m286isEmptyimpl(long[] jArr) {
