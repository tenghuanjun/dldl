...
class USequencesKt___USequencesKt {
    public static final int sumOfUInt(Sequence<UInt> sequence) {
        ...
        int iM146constructorimpl = 0;
        while (it.hasNext()) {
            iM146constructorimpl = UInt.m146constructorimpl(iM146constructorimpl + it.next().getData());
        }
        return iM146constructorimpl;
    }

    public static final long sumOfULong(Sequence<ULong> sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        Iterator<ULong> it = sequence.iterator();
        long jM224constructorimpl = 0;
        while (it.hasNext()) {
            jM224constructorimpl = ULong.m224constructorimpl(jM224constructorimpl + it.next().getData());
        }
        return jM224constructorimpl;
    }
    ...
    public static final int sumOfUByte(Sequence<UByte> sequence) {
        ...
        int iM146constructorimpl = 0;
        while (it.hasNext()) {
            iM146constructorimpl = UInt.m146constructorimpl(iM146constructorimpl + UInt.m146constructorimpl(it.next().getData() & 255));
        }
        return iM146constructorimpl;
    }
    ...
    public static final int sumOfUShort(Sequence<UShort> sequence) {
        ...
        int iM146constructorimpl = 0;
        while (it.hasNext()) {
            iM146constructorimpl = UInt.m146constructorimpl(iM146constructorimpl + UInt.m146constructorimpl(it.next().getData() & UShort.MAX_VALUE));
        }
        return iM146constructorimpl;
    }
}
