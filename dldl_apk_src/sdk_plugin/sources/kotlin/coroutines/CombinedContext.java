...
public final class CombinedContext implements CoroutineContext, Serializable {
    ...
    public String toString() {
        return AbstractJsonLexerKt.BEGIN_LIST + ((String) fold("", new Function2<String, CoroutineContext.Element, String>() { // from class: kotlin.coroutines.CombinedContext.toString.1
