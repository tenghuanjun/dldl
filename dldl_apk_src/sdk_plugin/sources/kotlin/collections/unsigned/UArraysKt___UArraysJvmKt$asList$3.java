...
public final class UArraysKt___UArraysJvmKt$asList$3 extends AbstractList<UByte> implements RandomAccess {
    ...
    public /* bridge */ /* synthetic */ Object get(int i) {
        return UByte.m64boximpl(m564getw2LRezQ(i));
    }
    ...
    public int getSize() {
        return UByteArray.m128getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return UByteArray.m130isEmptyimpl(this.$this_asList);
    }

    /* JADX INFO: renamed from: contains-7apg3OU, reason: not valid java name */
    public boolean m563contains7apg3OU(byte element) {
        return UByteArray.m123contains7apg3OU(this.$this_asList, element);
    }

    /* JADX INFO: renamed from: get-w2LRezQ, reason: not valid java name */
    public byte m564getw2LRezQ(int index) {
        return UByteArray.m127getw2LRezQ(this.$this_asList, index);
    }
