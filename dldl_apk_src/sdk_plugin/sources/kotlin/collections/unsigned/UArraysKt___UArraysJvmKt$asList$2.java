...
public final class UArraysKt___UArraysJvmKt$asList$2 extends AbstractList<ULong> implements RandomAccess {
    ...
    public /* bridge */ /* synthetic */ Object get(int i) {
        return ULong.m218boximpl(m560getsVKNKU(i));
    }
    ...
    public int getSize() {
        return ULongArray.m284getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return ULongArray.m286isEmptyimpl(this.$this_asList);
    }

    /* JADX INFO: renamed from: contains-VKZWuLQ, reason: not valid java name */
    public boolean m559containsVKZWuLQ(long element) {
        return ULongArray.m279containsVKZWuLQ(this.$this_asList, element);
    }

    /* JADX INFO: renamed from: get-s-VKNKU, reason: not valid java name */
    public long m560getsVKNKU(int index) {
        return ULongArray.m283getsVKNKU(this.$this_asList, index);
    }
