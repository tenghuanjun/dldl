...
public class StringsKt__IndentKt extends StringsKt__AppendableKt {
    ...
    public static final String replaceIndentByMargin(String str, String newIndent, String marginPrefix) {
        ...
        String string = ((StringBuilder) CollectionsKt.joinTo(arrayList, new StringBuilder(length), (BuglessAction.PAY_ERROR & 2) != 0 ? ", " : ShellAdbUtils.COMMAND_LINE_END, (BuglessAction.PAY_ERROR & 4) != 0 ? "" : null, (BuglessAction.PAY_ERROR & 8) != 0 ? "" : null, (BuglessAction.PAY_ERROR & 16) != 0 ? -1 : 0, (BuglessAction.PAY_ERROR & 32) != 0 ? "..." : null, (BuglessAction.PAY_ERROR & 64) != 0 ? null : null)).toString();
    ...
    public static final String replaceIndent(String str, String newIndent) {
        ...
        String string = ((StringBuilder) CollectionsKt.joinTo(arrayList4, new StringBuilder(length), (BuglessAction.PAY_ERROR & 2) != 0 ? ", " : ShellAdbUtils.COMMAND_LINE_END, (BuglessAction.PAY_ERROR & 4) != 0 ? "" : null, (BuglessAction.PAY_ERROR & 8) != 0 ? "" : null, (BuglessAction.PAY_ERROR & 16) != 0 ? -1 : 0, (BuglessAction.PAY_ERROR & 32) != 0 ? "..." : null, (BuglessAction.PAY_ERROR & 64) != 0 ? null : null)).toString();
        Intrinsics.checkNotNullExpressionValue(string, "mapIndexedNotNull { inde…\"\\n\")\n        .toString()");
        return string;
    }
    ...
    public static final String prependIndent(String str, final String indent) {
        ...
        }), ShellAdbUtils.COMMAND_LINE_END, null, null, 0, null, null, 62, null);
    }
    ...
    private static final String reindent$StringsKt__IndentKt(List<String> list, int i, Function1<? super String, String> function1, Function1<? super String, String> function12) {
        ...
        String string = ((StringBuilder) CollectionsKt.joinTo(arrayList, new StringBuilder(i), (BuglessAction.PAY_ERROR & 2) != 0 ? ", " : ShellAdbUtils.COMMAND_LINE_END, (BuglessAction.PAY_ERROR & 4) != 0 ? "" : null, (BuglessAction.PAY_ERROR & 8) != 0 ? "" : null, (BuglessAction.PAY_ERROR & 16) != 0 ? -1 : 0, (BuglessAction.PAY_ERROR & 32) != 0 ? "..." : null, (BuglessAction.PAY_ERROR & 64) != 0 ? null : null)).toString();
        Intrinsics.checkNotNullExpressionValue(string, "mapIndexedNotNull { inde…\"\\n\")\n        .toString()");
        return string;
    }
}
