...
public interface TimeMark {
    ...
    TimeMark mo1367minusLRDsOJo(long duration);

    /* JADX INFO: renamed from: plus-LRDsOJo */
    TimeMark mo1368plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1509minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1368plusLRDsOJo(Duration.m1426unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1407isNegativeimpl(timeMark.mo1366elapsedNowUwyO8pc());
        }
