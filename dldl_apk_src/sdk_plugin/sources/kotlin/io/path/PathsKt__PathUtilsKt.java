...
class PathsKt__PathUtilsKt extends PathsKt__PathReadWriteKt {
    ...
    public static final String getNameWithoutExtension(Path path) {
        ...
        Intrinsics.checkNotNullParameter(path, "<this>");
        Path fileName = path.getFileName();
        return (fileName == null || (string = fileName.toString()) == null || (strSubstringBeforeLast$default = StringsKt.substringBeforeLast$default(string, FileUtil.FILE_EXTENSION_SEPARATOR, (String) null, 2, (Object) null)) == null) ? "" : strSubstringBeforeLast$default;
    }
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesViewOrNull(Path path, LinkOption... options) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(options, "options");
        Intrinsics.reifiedOperationMarker(4, LinkMicData.STAGE_V);
