...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    public static final String getNameWithoutExtension(File file) {
        ...
        String name = file.getName();
        Intrinsics.checkNotNullExpressionValue(name, "name");
        return StringsKt.substringBeforeLast$default(name, FileUtil.FILE_EXTENSION_SEPARATOR, (String) null, 2, (Object) null);
    }
    ...
    private static final String toRelativeStringOrNull$FilesKt__UtilsKt(File file, File file2) {
        ...
        if (i < size2) {
            ...
            CollectionsKt.joinTo(CollectionsKt.drop(filePathComponentsNormalize$FilesKt__UtilsKt.getSegments(), i), sb, (BuglessAction.PAY_ERROR & 2) != 0 ? ", " : separator, (BuglessAction.PAY_ERROR & 4) != 0 ? "" : null, (BuglessAction.PAY_ERROR & 8) != 0 ? "" : null, (BuglessAction.PAY_ERROR & 16) != 0 ? -1 : 0, (BuglessAction.PAY_ERROR & 32) != 0 ? "..." : null, (BuglessAction.PAY_ERROR & 64) != 0 ? null : null);
        }
        return sb.toString();
    }
    ...
    */
    ...
    private static final List<File> normalize$FilesKt__UtilsKt(List<? extends File> list) {
        ...
        for (File file : list) {
            String name = file.getName();
            if (!Intrinsics.areEqual(name, FileUtil.FILE_EXTENSION_SEPARATOR)) {
