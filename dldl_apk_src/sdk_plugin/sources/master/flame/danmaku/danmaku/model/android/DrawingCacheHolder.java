...
public class DrawingCacheHolder {
    ...
    public void buildCache(int i, int i2, int i3, boolean z, int i4) {
        ...
        Bitmap bitmapCreateBitmap = NativeBitmapFactory.createBitmap(i, i2, config);
        this.bitmap = bitmapCreateBitmap;
        if (i3 > 0) {
            this.mDensity = i3;
            bitmapCreateBitmap.setDensity(i3);
        }
        ...
        if (i6 > i3 || i5 > i4) {
            ...
            for (int i14 = 0; i14 < i10; i14++) {
                for (int i15 = 0; i15 < i8; i15++) {
                    ...
                    Bitmap bitmapCreateBitmap = NativeBitmapFactory.createBitmap(i11, i12, Bitmap.Config.ARGB_8888);
                    bitmapArr2[i15] = bitmapCreateBitmap;
