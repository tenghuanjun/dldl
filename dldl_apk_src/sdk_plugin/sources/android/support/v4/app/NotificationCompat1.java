...
public class NotificationCompat1 {
    ...
    public static class Builder {
        ...
        public Notification build() {
            return new NotificationCompatBuilder1(this).build();
        }
    ...
    public static abstract class Style {
        ...
        */
        public android.widget.RemoteViews applyStandardTemplate(boolean r13, int r14, boolean r15) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.v4.app.NotificationCompat1.Style.applyStandardTemplate(boolean, int, boolean):android.widget.RemoteViews");
        }
    ...
    public static class BigPictureStyle extends Style {
        ...
        @Override // android.support.v4.app.NotificationCompat1.Style
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (this.mConversationTitle != null) {
                ...
                notificationBuilderWithBuilderAccessor.getBuilder().setContentTitle(messageFindLatestIncomingMessage.getSender());
            }
            ...
            if (Build.VERSION.SDK_INT >= 16) {
                ...
                for (int size = this.mMessages.size() - 1; size >= 0; size--) {
                    ...
                    if (size != this.mMessages.size() - 1) {
                        spannableStringBuilder.insert(0, (CharSequence) ShellAdbUtils.COMMAND_LINE_END);
                    }
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            @Override // android.support.v4.app.NotificationCompat1.Action.Extender
    ...
    public static final class WearableExtender implements Extender {
        ...
        public WearableExtender(Notification notification) {
            ...
            this.mCustomSizePreset = 0;
            this.mGravity = 80;
            Bundle extras = NotificationCompat1.getExtras(notification);
            ...
            if (bundle != null) {
                ...
                if (Build.VERSION.SDK_INT >= 16 && parcelableArrayList != null) {
                    ...
                    for (int i = 0; i < size; i++) {
                        if (Build.VERSION.SDK_INT >= 20) {
                            actionArr[i] = NotificationCompat1.getActionCompatFromAction((Notification.Action) parcelableArrayList.get(i));
                        } else if (Build.VERSION.SDK_INT >= 16) {
                            actionArr[i] = NotificationCompatJellybean1.getActionFromBundle((Bundle) parcelableArrayList.get(i));
                        }
                    }
                ...
                Notification[] notificationArrayFromBundle = NotificationCompat1.getNotificationArrayFromBundle(bundle, KEY_PAGES);
        ...
        @Override // android.support.v4.app.NotificationCompat1.Extender
        public Builder extend(Builder builder) {
            Bundle bundle = new Bundle();
                ...
                if (Build.VERSION.SDK_INT >= 16) {
                    ...
                    for (Action action : this.mActions) {
                        if (Build.VERSION.SDK_INT >= 20) {
                            ...
                            arrayList.add(NotificationCompatJellybean1.getBundleForAction(action));
                        }
                    }
    ...
    public static final class CarExtender implements Extender {
        ...
        public CarExtender(Notification notification) {
            ...
            Bundle bundle = NotificationCompat1.getExtras(notification) == null ? null : NotificationCompat1.getExtras(notification).getBundle(EXTRA_CAR_EXTENDER);
            if (bundle != null) {
    ...
    public static Bundle getExtras(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            return NotificationCompatJellybean1.getExtras(notification);
        }
        return null;
    }
    ...
    public static int getActionCount(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            return NotificationCompatJellybean1.getActionCount(notification);
        }
        return 0;
    }
    ...
    public static Action getAction(Notification notification, int i) {
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            ...
            return NotificationCompatJellybean1.readAction(action.icon, action.title, action.actionIntent, sparseParcelableArray != null ? (Bundle) sparseParcelableArray.get(i) : null);
        }
        if (Build.VERSION.SDK_INT >= 16) {
            return NotificationCompatJellybean1.getAction(notification, i);
        }
        return null;
    }
    ...
    public static String getGroup(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            return NotificationCompatJellybean1.getExtras(notification).getString(NotificationCompatExtras.EXTRA_GROUP_KEY);
        }
        return null;
    }
    ...
    public static boolean isGroupSummary(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            return NotificationCompatJellybean1.getExtras(notification).getBoolean(NotificationCompatExtras.EXTRA_GROUP_SUMMARY);
        }
        return false;
    }
    ...
    public static String getSortKey(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            return NotificationCompatJellybean1.getExtras(notification).getString(NotificationCompatExtras.EXTRA_SORT_KEY);
        }
        return null;
    }
