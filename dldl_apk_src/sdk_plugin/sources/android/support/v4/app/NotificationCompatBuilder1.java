...
class NotificationCompatBuilder1 implements NotificationBuilderWithBuilderAccessor {
    private RemoteViews mBigContentView;
    private Notification.Builder mBuilder;
    private NotificationCompat1.Builder mBuilderCompat;
    ...
    NotificationCompatBuilder1(NotificationCompat1.Builder builder) {
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            ...
            Iterator<NotificationCompat1.Action> it = builder.mActions.iterator();
            while (it.hasNext()) {
                addAction(it.next());
            }
    ...
    public Notification build() {
        ...
        NotificationCompat1.Style style = this.mBuilderCompat.mStyle;
        if (style != null) {
            style.apply(this);
        }
    ...
    private void addAction(NotificationCompat1.Action action) {
        Bundle bundle;
        if (Build.VERSION.SDK_INT >= 20) {
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            this.mActionExtrasList.add(NotificationCompatJellybean1.writeActionAndGetExtras(this.mBuilder, action));
        }
    }
    ...
    protected Notification buildInternal() {
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            ...
            if (sparseArrayBuildActionExtrasMap2 != null) {
                NotificationCompat1.getExtras(notificationBuild5).putSparseParcelableArray(NotificationCompatExtras.EXTRA_ACTION_EXTRAS, sparseArrayBuildActionExtrasMap2);
            }
