...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        private class StubApi21 implements MediaSessionCompatApi21.Callback {
            ...
            public void onCustomAction(String str, Bundle bundle) {
                ...
                if (str.equals(MediaSessionCompat.ACTION_SET_SHUFFLE_MODE_ENABLED)) {
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        public void setPlaybackToLocal(int i) {
            ...
            sendVolumeInfoChanged(new ParcelableVolumeInfo(1, i2, 2, this.mAudioManager.getStreamMaxVolume(i2), this.mAudioManager.getStreamVolume(this.mLocalStream)));
        }
        ...
        private void sendShuffleModeEnabled(boolean z) {
            for (int iBeginBroadcast = this.mControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                try {
                    ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onShuffleModeChangedDeprecated(z);
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
    ...
    static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public MediaSessionImplApi21(Context context, String str) {
            ...
            this.mToken = new Token(MediaSessionCompatApi21.getSessionToken(objCreateSession), new ExtraSession());
        }
        ...
        public void setShuffleModeEnabled(boolean z) {
            if (this.mShuffleModeEnabled != z) {
                ...
                for (int iBeginBroadcast = this.mExtraControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                    try {
                        ((IMediaControllerCallback) this.mExtraControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onShuffleModeChangedDeprecated(z);
                    } catch (RemoteException unused) {
                    }
                }
                this.mExtraControllerCallbacks.finishBroadcast();
