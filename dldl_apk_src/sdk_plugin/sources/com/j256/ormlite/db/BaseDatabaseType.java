    ...
    public void loadDriver() throws SQLException {
        ...
        if (driverClassName != null) {
            try {
                ...
                throw SqlExceptionUtil.create("Driver class was not found for " + getDatabaseName() + " database.  Missing jar with class " + driverClassName + FileUtil.FILE_EXTENSION_SEPARATOR, e);
            }
        }
    }
