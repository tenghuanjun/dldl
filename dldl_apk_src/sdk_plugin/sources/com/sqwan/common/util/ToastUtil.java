...
public class ToastUtil {
    public static void showToast(Context context, CharSequence charSequence) {
        ...
        try {
            LogUtil.v("Toast Log -> " + ((Object) charSequence));
    ...
    public static void showToast(String str) {
        LogUtil.v("Toast Log -> " + str);
        MyToast.showToast(L.getActivity(), str, 17, 0, 0);
    }
    ...
    public static class Builder {
        ...
        public void show() {
            ...
            gradientDrawable.setCornerRadius(com.sq.sdk.tool.util.DisplayUtil.dip2px(this.mContext, 6.0f));
