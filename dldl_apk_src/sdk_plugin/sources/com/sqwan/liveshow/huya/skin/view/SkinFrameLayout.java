...
public class SkinFrameLayout extends FrameLayout implements SkinViewInterface {
    ...
    public SkinFrameLayout(Context context, AttributeSet attributeSet, int i, int i2) {
