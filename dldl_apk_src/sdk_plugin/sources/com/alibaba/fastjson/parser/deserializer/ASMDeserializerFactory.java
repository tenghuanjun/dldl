...
public class ASMDeserializerFactory implements Opcodes {
    ...
    private void _deserialzeArrayMapping(ClassWriter classWriter, Context context) {
        ...
        methodWriter.visitVarInsn(25, 1);
        methodWriter.visitMethodInsn(Opcodes.INVOKEVIRTUAL, DefaultJSONParser, ILiveConstants.FuncName.GETCONFIG, "()" + ASMUtils.desc((Class<?>) ParserConfig.class));
                ...
                if (cls == Byte.class) {
                    ...
                    if (Collection.class.isAssignableFrom(cls)) {
                        ...
                        if (collectionItemClass == String.class) {
                            ...
                            methodWriter.visitVarInsn(25, 3);
                            methodWriter.visitMethodInsn(Opcodes.INVOKESTATIC, ASMUtils.type(JavaBeanDeserializer.class), "parseArray", "(Ljava/util/Collection;" + ASMUtils.desc((Class<?>) ObjectDeserializer.class) + LinkMicData.STAGE_L + DefaultJSONParser + ";Ljava/lang/reflect/Type;Ljava/lang/Object;)V");
                        }
                    } else if (cls.isArray()) {
                        methodWriter.visitVarInsn(25, context.var("lexer"));
                        methodWriter.visitLdcInsn(14);
    ...
    /* JADX WARN: Removed duplicated region for block: B:133:0x0e3a  */
    /* JADX WARN: Removed duplicated region for block: B:134:0x0e59  */
    /*
    ...
    */
    private void _deserialze(com.alibaba.fastjson.asm.ClassWriter r32, com.alibaba.fastjson.parser.deserializer.ASMDeserializerFactory.Context r33) {
        /*
            Method dump skipped, instruction units count: 4187
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor methodVisitor, Label label, FieldInfo fieldInfo, Class<?> cls, Class<?> cls2, int i) {
        ...
        if (zIsPrimitive2) {
            ...
            str2 = "nextToken";
            str3 = "(I)V";
            methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, JSONLexerBase, str2, str3);
        } else {
            str2 = "nextToken";
            str3 = "(I)V";
            methodVisitor.visitInsn(87);
    ...
    private void _getCollectionFieldItemDeser(Context context, MethodVisitor methodVisitor, FieldInfo fieldInfo, Class<?> cls) {
        ...
        methodVisitor.visitVarInsn(25, 0);
        methodVisitor.visitVarInsn(25, 1);
        methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, DefaultJSONParser, ILiveConstants.FuncName.GETCONFIG, "()" + ASMUtils.desc((Class<?>) ParserConfig.class));
