...
public class FieldInfo implements Comparable<FieldInfo> {
    ...
    public FieldInfo(String str, Method method, Field field, Class<?> cls, Type type, int i, int i2, int i3, JSONField jSONField, JSONField jSONField2, String str2, Map<TypeVariable, Type> map) {
        ...
        if (zJsonDirect && returnType == String.class) {
            z = true;
        }
        this.jsonDirect = z;
        if (cls != null && returnType == Object.class && (genericType instanceof TypeVariable) && (inheritGenericType = getInheritGenericType(cls, type, (TypeVariable) genericType)) != null) {
