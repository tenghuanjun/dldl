    ...
    public void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type, int i) throws IOException {
        ...
        if (cls == SimpleDateFormat.class) {
            ...
            if (serializeWriter.isEnabled(SerializerFeature.WriteClassName) && obj.getClass() != type) {
                ...
                serializeWriter.writeFieldValue(AbstractJsonLexerKt.COMMA, "val", string);
                ...
                if (obj instanceof Map.Entry) {
                    ...
                    if (key instanceof String) {
                        ...
                        if (value instanceof String) {
                            serializeWriter.writeFieldValueStringWithDoubleQuoteCheck(AbstractJsonLexerKt.BEGIN_OBJ, str, (String) value);
                        } else {
                            serializeWriter.write(123);
            ...
            if (obj2 == null) {
                ...
                if (obj2 instanceof JSONObject) {
                    ...
                    if (type == Currency.class) {
                        String string = jSONObject.getString(SqConstants.CURRENCY);
                        if (string != null) {
