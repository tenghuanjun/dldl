    ...
    public void writeValue(JSONSerializer jSONSerializer, Object obj) throws Exception {
        ...
        if (this.fieldInfo.unwrapped) {
            if (objectSerializer2 instanceof JavaBeanSerializer) {
                ...
                ((MapSerializer) objectSerializer2).write(jSONSerializer, obj, this.fieldInfo.name, this.fieldInfo.fieldType, i, true);
                return;
            }
        }
        if ((this.features & SerializerFeature.WriteClassName.mask) != 0 && cls3 != this.fieldInfo.fieldClass && JavaBeanSerializer.class.isInstance(objectSerializer2)) {
            ((JavaBeanSerializer) objectSerializer2).write(jSONSerializer, obj, this.fieldInfo.name, this.fieldInfo.fieldType, i, false);
            return;
        }
        ...
        objectSerializer2.write(jSONSerializer, obj, this.fieldInfo.name, this.fieldInfo.fieldType, i);
    }
