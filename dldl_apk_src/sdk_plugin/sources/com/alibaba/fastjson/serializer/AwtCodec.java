...
public class AwtCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    public void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type, int i) throws IOException {
        ...
        if (obj instanceof Point) {
            ...
            serializeWriter.writeFieldValue(writeClassName(serializeWriter, Point.class, AbstractJsonLexerKt.BEGIN_OBJ), "x", point.x);
            serializeWriter.writeFieldValue(AbstractJsonLexerKt.COMMA, "y", point.y);
        } else if (obj instanceof Font) {
            Font font = (Font) obj;
            serializeWriter.writeFieldValue(writeClassName(serializeWriter, Font.class, AbstractJsonLexerKt.BEGIN_OBJ), "name", font.getName());
            serializeWriter.writeFieldValue(AbstractJsonLexerKt.COMMA, "style", font.getStyle());
            serializeWriter.writeFieldValue(AbstractJsonLexerKt.COMMA, "size", font.getSize());
        } else if (obj instanceof Rectangle) {
            Rectangle rectangle = (Rectangle) obj;
            serializeWriter.writeFieldValue(writeClassName(serializeWriter, Rectangle.class, AbstractJsonLexerKt.BEGIN_OBJ), "x", rectangle.x);
            serializeWriter.writeFieldValue(AbstractJsonLexerKt.COMMA, "y", rectangle.y);
            serializeWriter.writeFieldValue(AbstractJsonLexerKt.COMMA, Common.Predefined.SUB_WIDTH, rectangle.width);
            serializeWriter.writeFieldValue(AbstractJsonLexerKt.COMMA, "height", rectangle.height);
        } else if (obj instanceof Color) {
            Color color = (Color) obj;
            serializeWriter.writeFieldValue(writeClassName(serializeWriter, Color.class, AbstractJsonLexerKt.BEGIN_OBJ), "r", color.getRed());
            serializeWriter.writeFieldValue(AbstractJsonLexerKt.COMMA, "g", color.getGreen());
            serializeWriter.writeFieldValue(AbstractJsonLexerKt.COMMA, "b", color.getBlue());
            if (color.getAlpha() > 0) {
                serializeWriter.writeFieldValue(AbstractJsonLexerKt.COMMA, "alpha", color.getAlpha());
            }
        } else {
        ...
        while (jSONLexer.token() != 13) {
            if (jSONLexer.token() == 4) {
                ...
                if (strStringVal.equalsIgnoreCase("x")) {
                    ...
                    i2 = iFloatValue;
                } else if (strStringVal.equalsIgnoreCase(Common.Predefined.SUB_WIDTH)) {
                    i3 = iFloatValue;
                } else {
