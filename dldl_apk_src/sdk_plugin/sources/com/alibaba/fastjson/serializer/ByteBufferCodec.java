...
public class ByteBufferCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    public void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type, int i) throws IOException {
        ...
        serializeWriter.writeFieldValue(AbstractJsonLexerKt.COMMA, "limit", byteBuffer.limit());
        serializeWriter.writeFieldValue(AbstractJsonLexerKt.COMMA, "position", byteBuffer.position());
