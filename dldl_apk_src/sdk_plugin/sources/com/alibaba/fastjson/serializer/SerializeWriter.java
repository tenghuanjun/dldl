...
public final class SerializeWriter extends Writer {
    ...
    public SerializeWriter append(CharSequence charSequence) {
        String string = charSequence == null ? AbstractJsonLexerKt.NULL : charSequence.toString();
    ...
    */
    ...
    public void writeFieldNameDirect(String str) {
        ...
        char[] cArr2 = this.buf;
        cArr2[i - 2] = '\"';
        cArr2[i - 1] = AbstractJsonLexerKt.COLON;
    }
    ...
    public void write(List<String> list) {
        ...
        while (i4 < size) {
            ...
            if (i4 == 0) {
                i = i3 + 1;
                this.buf[i3] = AbstractJsonLexerKt.BEGIN_LIST;
            } else {
                i = i3 + 1;
                this.buf[i3] = AbstractJsonLexerKt.COMMA;
            }
            int i7 = i + 1;
            this.buf[i] = '\"';
        ...
        this.buf[i3] = AbstractJsonLexerKt.END_LIST;
        this.count = i3 + 1;
    }
    ...
    public void writeFieldValue(char c, String str, int i) {
        ...
        cArr2[i4 + 2] = AbstractJsonLexerKt.COLON;
    ...
    public void writeFieldValueStringWithDoubleQuoteCheck(char c, String str, String str2) {
        ...
        int i6 = i5 + 1;
        int i7 = i6 + 1;
        cArr2[i6] = AbstractJsonLexerKt.COLON;
        if (str2 == null) {
            int i8 = i7 + 1;
            cArr2[i7] = 'n';
            int i9 = i8 + 1;
            cArr2[i8] = AbstractJsonLexerKt.UNICODE_ESC;
            cArr2[i9] = 'l';
            cArr2[i9 + 1] = 'l';
            return;
        }
        ...
        if (i13 > 0) {
            ...
            if (i13 == 1) {
                if (c2 == 8232) {
                    ...
                    cArr4[i18] = AbstractJsonLexerKt.UNICODE_ESC;
                    int i19 = i18 + 1;
                    cArr4[i19] = '2';
                    int i20 = i19 + 1;
                    cArr4[i20] = '0';
                    ...
                    char[] cArr6 = this.buf;
                    cArr6[i15] = AbstractJsonLexerKt.STRING_ESC;
                    cArr6[i22] = AbstractJsonLexerKt.UNICODE_ESC;
                    int i23 = i22 + 1;
                    cArr6[i23] = '2';
                    int i24 = i23 + 1;
                    cArr6[i24] = '0';
                    ...
                    char[] cArr8 = this.buf;
                    cArr8[i15] = AbstractJsonLexerKt.STRING_ESC;
                    int i27 = i26 + 1;
                    cArr8[i26] = AbstractJsonLexerKt.UNICODE_ESC;
                    int i28 = i27 + 1;
                    ...
                    cArr10[i15] = AbstractJsonLexerKt.STRING_ESC;
                    int i31 = i30 + 1;
                    cArr10[i30] = AbstractJsonLexerKt.UNICODE_ESC;
                    int i32 = i31 + 1;
                    ...
                    cArr12[i15] = AbstractJsonLexerKt.STRING_ESC;
                ...
                for (int i35 = i14 - i10; i35 < str2.length(); i35++) {
                    ...
                    if (this.browserSecure) {
                        ...
                        int i36 = i14 + 1;
                        cArr13[i14] = AbstractJsonLexerKt.STRING_ESC;
                        int i37 = i36 + 1;
                        cArr13[i36] = AbstractJsonLexerKt.UNICODE_ESC;
                        int i38 = i37 + 1;
                    ...
                    if ((cCharAt < IOUtils.specicalFlags_doubleQuotes.length && IOUtils.specicalFlags_doubleQuotes[cCharAt] != 0) || (cCharAt == '/' && isEnabled(SerializerFeature.WriteSlashAsSpecial))) {
                        int i41 = i14 + 1;
                        this.buf[i14] = AbstractJsonLexerKt.STRING_ESC;
                        if (IOUtils.specicalFlags_doubleQuotes[cCharAt] == 4) {
                            char[] cArr14 = this.buf;
                            int i42 = i41 + 1;
                            cArr14[i41] = AbstractJsonLexerKt.UNICODE_ESC;
                            int i43 = i42 + 1;
                        ...
                        int i46 = i14 + 1;
                        cArr15[i14] = AbstractJsonLexerKt.STRING_ESC;
                        int i47 = i46 + 1;
                        cArr15[i46] = AbstractJsonLexerKt.UNICODE_ESC;
                        int i48 = i47 + 1;
    ...
    protected void writeStringWithSingleQuote(String str) {
        ...
        if (i == 1) {
            ...
            char[] cArr3 = this.buf;
            cArr3[i7] = AbstractJsonLexerKt.STRING_ESC;
            ...
            char[] cArr5 = this.buf;
            cArr5[i7] = AbstractJsonLexerKt.STRING_ESC;
            ...
            for (int i13 = i11 - 2; i13 >= i5; i13--) {
                ...
                if (c3 <= '\r' || c3 == '\\' || c3 == '\'' || (c3 == '/' && isEnabled(SerializerFeature.WriteSlashAsSpecial))) {
                    ...
                    char[] cArr7 = this.buf;
                    cArr7[i13] = AbstractJsonLexerKt.STRING_ESC;
    ...
    protected void writeStringWithSingleQuote(char[] cArr) {
        ...
        if (i == 1) {
            ...
            char[] cArr4 = this.buf;
            cArr4[i7] = AbstractJsonLexerKt.STRING_ESC;
            ...
            char[] cArr6 = this.buf;
            cArr6[i7] = AbstractJsonLexerKt.STRING_ESC;
            ...
            for (int i13 = i11 - 2; i13 >= i5; i13--) {
                ...
                if (c4 <= '\r' || c4 == '\\' || c4 == '\'' || (c4 == '/' && isEnabled(SerializerFeature.WriteSlashAsSpecial))) {
                    ...
                    char[] cArr8 = this.buf;
                    cArr8[i13] = AbstractJsonLexerKt.STRING_ESC;
    ...
    private void writeKeyWithSingleQuoteIfHasSpecial(String str) {
        ...
        if (length == 0) {
            ...
            cArr[i6] = '\'';
            this.count = i7 + 1;
            cArr[i7] = AbstractJsonLexerKt.COLON;
            return;
        }
        int i8 = this.count;
        int i9 = i8 + length;
        ...
        while (i10 < i9) {
            ...
            if (c < bArr.length && bArr[c] != 0) {
                if (!z2) {
                    ...
                    char[] cArr7 = this.buf;
                    cArr7[i10] = AbstractJsonLexerKt.STRING_ESC;
