...
public class ASMSerializerFactory implements Opcodes {
    ...
    static final String ObjectSerializer_desc = LinkMicData.STAGE_L + ObjectSerializer + ";";
    static final String SerializeWriter = ASMUtils.type(SerializeWriter.class);
    static final String SerializeWriter_desc = LinkMicData.STAGE_L + SerializeWriter + ";";
    static final String JavaBeanSerializer = ASMUtils.type(JavaBeanSerializer.class);
    static final String JavaBeanSerializer_desc = LinkMicData.STAGE_L + ASMUtils.type(JavaBeanSerializer.class) + ";";
    ...
    public JavaBeanSerializer createJavaBeanSerializer(SerializeBeanInfo serializeBeanInfo) throws Exception {
        ...
        if (r3 != null) {
            ...
            str = name + FileUtil.FILE_EXTENSION_SEPARATOR + str6;
            str2 = str7;
        } else {
            str = str6;
            str2 = str;
