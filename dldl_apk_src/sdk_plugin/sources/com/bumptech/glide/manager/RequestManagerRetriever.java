...
public class RequestManagerRetriever implements Handler.Callback {
    ...
    private SupportRequestManagerFragment getSupportRequestManagerFragment(android.support.v4.app.FragmentManager fragmentManager, Fragment fragment, boolean z) {
    ...
    private RequestManager supportFragmentGet(Context context, android.support.v4.app.FragmentManager fragmentManager, Fragment fragment, boolean z) {
