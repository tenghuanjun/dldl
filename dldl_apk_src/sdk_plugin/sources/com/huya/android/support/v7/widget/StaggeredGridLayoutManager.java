...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager {
    ...
    private final Runnable mCheckForGapsRunnable = new Runnable() { // from class: com.huya.android.support.v7.widget.StaggeredGridLayoutManager.1
    ...
    */
    android.view.View hasGapsToFix() {
        ...
        L2e:
            ...
            com.huya.android.support.v7.widget.StaggeredGridLayoutManager$LayoutParams r8 = (com.huya.android.support.v7.widget.StaggeredGridLayoutManager.LayoutParams) r8
            com.huya.android.support.v7.widget.StaggeredGridLayoutManager$Span r9 = r8.mSpan
            int r9 = r9.mIndex
        ...
        L59:
            ...
            if (r10 == 0) goto L77
            com.huya.android.support.v7.widget.OrientationHelper r10 = r12.mPrimaryOrientation
            int r10 = r10.getDecoratedEnd(r7)
            com.huya.android.support.v7.widget.OrientationHelper r11 = r12.mPrimaryOrientation
        ...
        L8b:
            ...
            com.huya.android.support.v7.widget.StaggeredGridLayoutManager$LayoutParams r9 = (com.huya.android.support.v7.widget.StaggeredGridLayoutManager.LayoutParams) r9
            com.huya.android.support.v7.widget.StaggeredGridLayoutManager$Span r8 = r8.mSpan
            int r8 = r8.mIndex
            com.huya.android.support.v7.widget.StaggeredGridLayoutManager$Span r9 = r9.mSpan
            int r9 = r9.mIndex
            int r8 = r8 - r9
            if (r8 >= 0) goto La0
            r8 = 1
        ...
        Lab:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huya.android.support.v7.widget.StaggeredGridLayoutManager.hasGapsToFix():android.view.View");
    }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        if (getChildCount() > 0) {
            ...
            View viewFindFirstVisibleItemClosestToStart = findFirstVisibleItemClosestToStart(false, true);
            View viewFindFirstVisibleItemClosestToEnd = findFirstVisibleItemClosestToEnd(false, true);
    ...
    int findFirstVisibleItemPositionInt() {
        View viewFindFirstVisibleItemClosestToEnd = this.mShouldReverseLayout ? findFirstVisibleItemClosestToEnd(true, true) : findFirstVisibleItemClosestToStart(true, true);
    ...
    private void fixStartGap(RecyclerView.Recycler recycler, RecyclerView.State state, boolean z) {
        ...
        if (minStart > 0) {
            int iScrollBy = minStart - scrollBy(minStart, recycler, state);
            if (!z || iScrollBy <= 0) {
                return;
            }
    ...
    */
    private void handleUpdate(int r6, int r7, int r8) {
        ...
        L1b:
            r3 = r6
        L1c:
            com.huya.android.support.v7.widget.StaggeredGridLayoutManager$LazySpanLookup r4 = r5.mLazySpanLookup
            ...
            goto L3f
        L29:
            com.huya.android.support.v7.widget.StaggeredGridLayoutManager$LazySpanLookup r8 = r5.mLazySpanLookup
            r8.offsetForRemoval(r6, r4)
            com.huya.android.support.v7.widget.StaggeredGridLayoutManager$LazySpanLookup r6 = r5.mLazySpanLookup
            r6.offsetForAddition(r7, r4)
            goto L3f
        L34:
            com.huya.android.support.v7.widget.StaggeredGridLayoutManager$LazySpanLookup r8 = r5.mLazySpanLookup
        ...
        L54:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huya.android.support.v7.widget.StaggeredGridLayoutManager.handleUpdate(int, int, int):void");
    }
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (layoutState.hasMore(state) && !this.mRemainingSpans.isEmpty()) {
            ...
            boolean z2 = span == -1;
            if (z2) {
                nextSpan = layoutParams.mFullSpan ? this.mSpans[i2] : getNextSpan(layoutState);
            ...
            if (layoutState.mLayoutDirection == 1) {
                maxEnd2 = layoutParams.mFullSpan ? getMaxEnd(i4) : span2.getEndLine(i4);
                decoratedMeasurement = this.mPrimaryOrientation.getDecoratedMeasurement(next) + maxEnd2;
                ...
                decoratedMeasurement = minStart;
                maxEnd2 = decoratedMeasurement2;
            }
            ...
            int decoratedMeasurement3 = startAfterPadding2 + this.mSecondaryOrientation.getDecoratedMeasurement(next);
            if (this.mOrientation == 1) {
                layoutDecoratedWithMargins(next, startAfterPadding2, maxEnd2, decoratedMeasurement3, decoratedMeasurement);
            } else {
                layoutDecoratedWithMargins(next, maxEnd2, startAfterPadding2, decoratedMeasurement, decoratedMeasurement3);
            }
            if (layoutParams.mFullSpan) {
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int i) {
        LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(recyclerView.getContext()) { // from class: com.huya.android.support.v7.widget.StaggeredGridLayoutManager.2
            @Override // com.huya.android.support.v7.widget.LinearSmoothScroller
            public PointF computeScrollVectorForPosition(int i2) {
                int iCalculateScrollDirectionForPosition = StaggeredGridLayoutManager.this.calculateScrollDirectionForPosition(i2);
                if (iCalculateScrollDirectionForPosition == 0) {
                    return null;
                }
                if (StaggeredGridLayoutManager.this.mOrientation == 0) {
                    return new PointF(iCalculateScrollDirectionForPosition, 0.0f);
                }
                return new PointF(0.0f, iCalculateScrollDirectionForPosition);
            }
        };
    ...
    int scrollBy(int i, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        int iAbs = Math.abs(i);
        this.mLayoutState.mAvailable = iAbs;
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            public static final Parcelable.Creator<FullSpanItem> CREATOR = new Parcelable.Creator<FullSpanItem>() { // from class: com.huya.android.support.v7.widget.StaggeredGridLayoutManager.LazySpanLookup.FullSpanItem.1
    ...
    static class SavedState implements Parcelable {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() { // from class: com.huya.android.support.v7.widget.StaggeredGridLayoutManager.SavedState.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
