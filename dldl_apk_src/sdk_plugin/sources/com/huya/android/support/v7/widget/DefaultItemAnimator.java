...
public class DefaultItemAnimator extends RecyclerView.ItemAnimator {
    ...
    @Override // com.huya.android.support.v7.widget.RecyclerView.ItemAnimator
    public void runPendingAnimations() {
        ...
        if (z || z2 || z4 || z3) {
            ...
            if (z2) {
                ...
                Runnable runnable = new Runnable() { // from class: com.huya.android.support.v7.widget.DefaultItemAnimator.1
            ...
            if (z3) {
                ...
                Runnable runnable2 = new Runnable() { // from class: com.huya.android.support.v7.widget.DefaultItemAnimator.2
                    @Override // java.lang.Runnable
                    public void run() {
            ...
            if (z4) {
                ...
                Runnable runnable3 = new Runnable() { // from class: com.huya.android.support.v7.widget.DefaultItemAnimator.3
                    @Override // java.lang.Runnable
                    public void run() {
    ...
    private void animateRemoveImpl(final RecyclerView.ViewHolder viewHolder) {
        ...
        viewPropertyAnimatorCompatAnimate.setDuration(getRemoveDuration()).alpha(0.0f).setListener(new VpaListenerAdapter() { // from class: com.huya.android.support.v7.widget.DefaultItemAnimator.4
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super();
            }

            @Override // com.huya.android.support.v7.widget.DefaultItemAnimator.VpaListenerAdapter, android.support.v4.view.ViewPropertyAnimatorListener
    ...
    public void animateAddImpl(final RecyclerView.ViewHolder viewHolder) {
        ...
        viewPropertyAnimatorCompatAnimate.alpha(1.0f).setDuration(getAddDuration()).setListener(new VpaListenerAdapter() { // from class: com.huya.android.support.v7.widget.DefaultItemAnimator.5
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super();
            }
    ...
    public void animateMoveImpl(final RecyclerView.ViewHolder viewHolder, int i, int i2, int i3, int i4) {
        ...
        viewPropertyAnimatorCompatAnimate.setDuration(getMoveDuration()).setListener(new VpaListenerAdapter() { // from class: com.huya.android.support.v7.widget.DefaultItemAnimator.6
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super();
            }
    ...
    public void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            duration.alpha(0.0f).setListener(new VpaListenerAdapter() { // from class: com.huya.android.support.v7.widget.DefaultItemAnimator.7
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super();
                }
        ...
        if (view2 != null) {
            ...
            viewPropertyAnimatorCompatAnimate.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(1.0f).setListener(new VpaListenerAdapter() { // from class: com.huya.android.support.v7.widget.DefaultItemAnimator.8
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super();
                }
