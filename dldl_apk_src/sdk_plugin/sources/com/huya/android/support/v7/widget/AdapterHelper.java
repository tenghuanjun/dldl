...
import com.huya.android.support.v7.widget.OpReorderer;
...
class AdapterHelper implements OpReorderer.Callback {
    ...
    private void applyRemove(UpdateOp updateOp) {
        ...
        while (i3 < i2) {
            if (this.mCallback.findViewHolder(i3) != null || canFindInPreLayout(i3)) {
                if (b2 == 0) {
                    dispatchAndUpdateViewHolders(obtainUpdateOp(1, i, i4));
                    z = true;
                } else {
                    z = false;
                }
                ...
                if (b2 == 1) {
                    postponeAndUpdateViewHolders(obtainUpdateOp(1, i, i4));
                    z = true;
                } else {
                    z = false;
                }
        ...
        if (i4 != updateOp.itemCount) {
            ...
            updateOp = obtainUpdateOp(1, i, i4);
        }
        if (b2 == 0) {
    ...
    private void applyUpdate(UpdateOp updateOp) {
        ...
        for (int i4 = updateOp.positionStart; i4 < i2; i4++) {
            if (this.mCallback.findViewHolder(i4) != null || canFindInPreLayout(i4)) {
                if (b == 0) {
                    dispatchAndUpdateViewHolders(obtainUpdateOp(2, i, i3));
                    i = i4;
                    i3 = 0;
                }
                b = 1;
                ...
                if (b == 1) {
                    postponeAndUpdateViewHolders(obtainUpdateOp(2, i, i3));
                    i = i4;
                    i3 = 0;
                }
                b = 0;
        ...
        if (i3 != updateOp.itemCount) {
            recycleUpdateOp(updateOp);
            updateOp = obtainUpdateOp(2, i, i3);
        }
        if (b == 0) {
            dispatchAndUpdateViewHolders(updateOp);
        } else {
    ...
    private void dispatchAndUpdateViewHolders(UpdateOp updateOp) {
        ...
        for (int i5 = 1; i5 < updateOp.itemCount; i5++) {
            ...
            int i6 = updateOp.cmd;
            if (i6 == 1 ? iUpdatePositionWithPostponed2 == iUpdatePositionWithPostponed : i6 == 2 && iUpdatePositionWithPostponed2 == iUpdatePositionWithPostponed + 1) {
                i4++;
            } else {
                UpdateOp updateOpObtainUpdateOp = obtainUpdateOp(updateOp.cmd, iUpdatePositionWithPostponed, i4);
        ...
        recycleUpdateOp(updateOp);
        if (i4 > 0) {
            UpdateOp updateOpObtainUpdateOp2 = obtainUpdateOp(updateOp.cmd, iUpdatePositionWithPostponed, i4);
    ...
    boolean onItemRangeInserted(int i, int i2) {
        this.mPendingUpdates.add(obtainUpdateOp(0, i, i2));
        return this.mPendingUpdates.size() == 1;
    }

    boolean onItemRangeRemoved(int i, int i2) {
        this.mPendingUpdates.add(obtainUpdateOp(1, i, i2));
        return this.mPendingUpdates.size() == 1;
    }
    ...
    @Override // com.huya.android.support.v7.widget.OpReorderer.Callback
