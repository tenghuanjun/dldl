...
public class LinearLayoutManager extends RecyclerView.LayoutManager {
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int i) {
        LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(recyclerView.getContext()) { // from class: com.huya.android.support.v7.widget.LinearLayoutManager.1
            @Override // com.huya.android.support.v7.widget.LinearSmoothScroller
    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LayoutState layoutState, LayoutChunkResult layoutChunkResult) {
        ...
        layoutDecorated(next, paddingLeft + layoutParams.leftMargin, layoutParams.topMargin + i, decoratedMeasurementInOther - layoutParams.rightMargin, i2 - layoutParams.bottomMargin);
    ...
    public View onFocusSearchFailed(View view, int i, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        View viewFindReferenceChildClosestToEnd;
        ...
        if (iConvertFocusDirectionToLayoutDirection == -1) {
            viewFindReferenceChildClosestToEnd = findReferenceChildClosestToStart(recycler, state);
        } else {
            viewFindReferenceChildClosestToEnd = findReferenceChildClosestToEnd(recycler, state);
        }
        ...
        if (childClosestToEnd == viewFindReferenceChildClosestToEnd || !childClosestToEnd.isFocusable()) {
            return null;
        }
    ...
    static class LayoutState {
        ...
        public void assignPositionFromScrapList(RecyclerView.ViewHolder viewHolder) {
            RecyclerView.ViewHolder viewHolderNextViewHolderInLimitedList = nextViewHolderInLimitedList(viewHolder);
            this.mCurrentPosition = viewHolderNextViewHolderInLimitedList == null ? -1 : viewHolderNextViewHolderInLimitedList.getLayoutPosition();
        }
        ...
        public RecyclerView.ViewHolder nextViewHolderInLimitedList(RecyclerView.ViewHolder viewHolder) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                RecyclerView.ViewHolder viewHolder3 = this.mScrapList.get(i2);
                if (viewHolder3 != viewHolder && !viewHolder3.isRemoved() && (layoutPosition = (viewHolder3.getLayoutPosition() - this.mCurrentPosition) * this.mItemDirection) >= 0 && layoutPosition < i) {
    ...
    static class SavedState implements Parcelable {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() { // from class: com.huya.android.support.v7.widget.LinearLayoutManager.SavedState.1
    ...
    class AnchorInfo {
        ...
        public String toString() {
            return "AnchorInfo{mPosition=" + this.mPosition + ", mCoordinate=" + this.mCoordinate + ", mLayoutFromEnd=" + this.mLayoutFromEnd + AbstractJsonLexerKt.END_OBJ;
        }
