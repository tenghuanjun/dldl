...
public class LiveAlert extends Dialog {
    ...
    private LiveAlert(Context context, int i, boolean z) {
        int layoutResIDByName;
        super(context, i);
        if (z) {
            layoutResIDByName = ResourceUtil.getLayoutResIDByName(SqR.layout.hyberry_live_alert_portrait);
        } else {
            layoutResIDByName = ResourceUtil.getLayoutResIDByName(SqR.layout.hyberry_live_alert);
        }
    ...
    private void initView() {
        ...
        this.mTitleDivider = findViewById(ResourceUtil.getIdResIDByName(SqR.id.title_divider));
        this.mMessage = (TextView) findViewById(ResourceUtil.getIdResIDByName("message"));
        this.mMessageDivider = findViewById(ResourceUtil.getIdResIDByName(SqR.id.message_divider));
        this.mButtonNegative = (TextView) findViewById(ResourceUtil.getIdResIDByName(SqR.id.button_negative));
        this.mButtonDividerA = findViewById(ResourceUtil.getIdResIDByName(SqR.id.button_divider_a));
        this.mButtonNeutral = (TextView) findViewById(ResourceUtil.getIdResIDByName(SqR.id.button_neutral));
        this.mButtonDividerB = findViewById(ResourceUtil.getIdResIDByName(SqR.id.button_divider_b));
        this.mButtonPositive = (TextView) findViewById(ResourceUtil.getIdResIDByName(SqR.id.button_positive));
        this.mButtonDividerC = findViewById(ResourceUtil.getIdResIDByName(SqR.id.button_divider_c));
        this.mCustomView = (FrameLayout) findViewById(ResourceUtil.getIdResIDByName(SqR.id.custom_view));
        this.mMessage.setMovementMethod(ScrollingMovementMethod.getInstance());
        this.mMessage.setLongClickable(false);
        this.mButtonNegative.setOnClickListener(new View.OnClickListener() { // from class: com.huya.berry.gamesdk.widgets.LiveAlert.1
        ...
        this.mButtonNeutral.setOnClickListener(new View.OnClickListener() { // from class: com.huya.berry.gamesdk.widgets.LiveAlert.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LiveAlert.this.dismiss();
                if (LiveAlert.this.mListener != null) {
        ...
        this.mButtonPositive.setOnClickListener(new View.OnClickListener() { // from class: com.huya.berry.gamesdk.widgets.LiveAlert.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LiveAlert.this.dismiss();
                if (LiveAlert.this.mListener != null) {
    ...
    public static class Builder {
        ...
        public LiveAlert create() {
            LiveAlert liveAlert = new LiveAlert(this.mContext, ResourceUtil.getStyleResIDByName("Theme.Dialog.Kiwi"), this.mPortrait);
            CharSequence charSequence = this.mTitle;
            if (charSequence == null) {
                liveAlert.mTitle.setVisibility(8);
                liveAlert.mTitleDivider.setVisibility(8);
                if (this.mMessage != null) {
                    liveAlert.mMessage.setTextColor(this.mContext.getResources().getColor(ResourceUtil.getColorResIDByName(SqR.color.hyberry_gray22)));
                }
            } else {
            ...
            if (charSequence2 == null) {
                ...
                liveAlert.setMessage(charSequence2);
            }
            CharSequence charSequence3 = this.mPositive;
            if (charSequence3 == null) {
                liveAlert.mButtonPositive.setVisibility(8);
                liveAlert.mButtonDividerC.setVisibility(8);
            } else {
                liveAlert.setPositive(charSequence3);
            }
            ...
            if (charSequence4 == null) {
                ...
                liveAlert.setNegative(charSequence4);
            }
            ...
            if (charSequence5 == null) {
                ...
                liveAlert.setNeutral(charSequence5);
            }
