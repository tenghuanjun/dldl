...
public final class WSRegisterGroupReq extends JceStruct implements Cloneable {
    static final /* synthetic */ boolean $assertionsDisabled = false;
    static ArrayList<String> cache_vGroupId;
    public ArrayList<String> vGroupId = null;

    public String className() {
        return "HUYA.WSRegisterGroupReq";
    }

    public String fullClassName() {
        return "com.duowan.HUYA.WSRegisterGroupReq";
    }
    ...
    public WSRegisterGroupReq(ArrayList<String> arrayList) {
    ...
    public boolean equals(Object obj) {
        ...
        return JceUtil.equals(this.vGroupId, ((WSRegisterGroupReq) obj).vGroupId);
    }
