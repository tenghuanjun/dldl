...
public class WSExitP2P extends JceStruct implements Cloneable, Parcelable {
    static final /* synthetic */ boolean $assertionsDisabled = false;
    public static final Parcelable.Creator<WSExitP2P> CREATOR = new Parcelable.Creator<WSExitP2P>() { // from class: com.huya.hysignal.jce.WSExitP2P.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public WSExitP2P createFromParcel(Parcel parcel) {
            byte[] bArrCreateByteArray = parcel.createByteArray();
            JceInputStream jceInputStream = new JceInputStream();
            jceInputStream.warp(bArrCreateByteArray);
            WSExitP2P wSExitP2P = new WSExitP2P();
            wSExitP2P.readFrom(jceInputStream);
            return wSExitP2P;
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public WSExitP2P[] newArray(int i) {
            return new WSExitP2P[i];
        }
    };
    ...
    public String fullClassName() {
        return "com.duowan.HUYA.WSExitP2P";
    }
    ...
    public WSExitP2P(ArrayList<String> arrayList) {
    ...
    public boolean equals(Object obj) {
        ...
        return JceUtil.equals(this.vGroupId, ((WSExitP2P) obj).vGroupId);
    }
