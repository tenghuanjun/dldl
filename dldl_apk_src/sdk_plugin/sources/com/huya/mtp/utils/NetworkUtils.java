...
public class NetworkUtils {
    ...
    static {
        ...
        sNetworkMonitor = new NetworkMonitor(application);
    }
    ...
    */
    public static java.lang.String getNetworkName() {
        ...
        L67:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huya.mtp.utils.NetworkUtils.getNetworkName():java.lang.String");
    }

    public static String getWifiSSID() {
        try {
            WifiInfo connectionInfo = ((WifiManager) sApplication.getSystemService("wifi")).getConnectionInfo();
    ...
    public static boolean isWifiActive() {
        ...
        try {
            connectivityManager = (ConnectivityManager) sApplication.getSystemService("connectivity");
        } catch (Exception e) {
            MTPApi.LOGGER.error("NetworkUtil", e);
    ...
    public static String getNetWorkType() {
        return !isNetworkAvailable() ? "none" : isWifiActive() ? "wifi" : getNetWorkSubType();
    }
    ...
    public static InetSocketAddress getTunnelProxy() {
        if (sApplication.checkCallingOrSelfPermission("android.permission.WRITE_APN_SETTINGS") == -1) {
            return null;
        }
        NetworkInfo activeNetworkInfo = ((ConnectivityManager) sApplication.getSystemService("connectivity")).getActiveNetworkInfo();
        ...
        Cursor cursorQuery = sApplication.getContentResolver().query(Uri.parse("content://telephony/carriers/preferapn"), null, null, null, null);
