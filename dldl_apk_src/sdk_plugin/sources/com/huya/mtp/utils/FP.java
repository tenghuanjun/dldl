...
public class FP {
    ...
    public static abstract class Eq<A> implements BinaryFunc<Boolean, A, A> {
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // com.huya.mtp.utils.FP.BinaryFunc
    ...
    public static <E> Pred<E> negate(final Pred<E> pred) {
        return new Pred<E>() { // from class: com.huya.mtp.utils.FP.1
    ...
    public static <E> E find(final E e, List<E> list) {
        return (E) find((Pred) new Pred<E>() { // from class: com.huya.mtp.utils.FP.2
            @Override // com.huya.mtp.utils.FP.Pred
    ...
    public static <E> List<E> nubBy(final Eq<E> eq, List<E> list) {
        ...
        if (!empty(list)) {
            for (final E e : list) {
                if (find((Pred) new Pred<E>() { // from class: com.huya.mtp.utils.FP.3
                    @Override // com.huya.mtp.utils.FP.Pred
                    public boolean pred(E e2) {
                        return eq.eq(e, e2);
                    }
    ...
    public static <E> List<E> nub(List<E> list) {
        return nubBy(new Eq<E>() { // from class: com.huya.mtp.utils.FP.4
            @Override // com.huya.mtp.utils.FP.Eq
    ...
    public static <T> List<T> union(List<T> list, List<T> list2) {
        return unionBy(new Eq<T>() { // from class: com.huya.mtp.utils.FP.5
            @Override // com.huya.mtp.utils.FP.Eq
