...
public class WebSocketCommand extends JceStruct implements Cloneable, Parcelable {
    ...
    public static final Parcelable.Creator<WebSocketCommand> CREATOR = new Parcelable.Creator<WebSocketCommand>() { // from class: com.huya.mtp.hyns.miniprogram.jce.WebSocketCommand.1
    ...
    public String fullClassName() {
        return "com.huya.mtp.hyns.miniprogram.jce.WebSocketCommand";
    }
    ...
    public WebSocketCommand(int i, byte[] bArr, long j, String str, int i2) {
        setICmdType(i);
        setVData(bArr);
        setLRequestId(j);
        setTraceId(str);
    ...
    public boolean equals(Object obj) {
        ...
        return JceUtil.equals(this.iCmdType, webSocketCommand.iCmdType) && JceUtil.equals(this.vData, webSocketCommand.vData) && JceUtil.equals(this.lRequestId, webSocketCommand.lRequestId) && JceUtil.equals(this.traceId, webSocketCommand.traceId) && JceUtil.equals(this.iEncryptType, webSocketCommand.iEncryptType);
    }

    public int hashCode() {
        return Arrays.hashCode(new int[]{JceUtil.hashCode(this.iCmdType), JceUtil.hashCode(this.vData), JceUtil.hashCode(this.lRequestId), JceUtil.hashCode(this.traceId), JceUtil.hashCode(this.iEncryptType)});
    }
