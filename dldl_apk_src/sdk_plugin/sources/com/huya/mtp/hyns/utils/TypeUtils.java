...
public class TypeUtils {
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        ParameterizedTypeImpl(Type type, Type type2, Type... typeArr) {
            ...
            for (Type type3 : typeArr) {
                TypeUtils.checkNotNull(type3, "typeArgument == null");
                TypeUtils.checkNotPrimitive(type3);
            }
            this.ownerType = type;
            this.rawType = type2;
        ...
        public boolean equals(Object obj) {
            return (obj instanceof ParameterizedType) && TypeUtils.equals(this, (ParameterizedType) obj);
        }
        ...
        public String toString() {
            ...
            sb.append(TypeUtils.typeToString(this.rawType));
            sb.append(SimpleComparison.LESS_THAN_OPERATION);
            sb.append(TypeUtils.typeToString(this.typeArguments[0]));
            for (int i = 1; i < this.typeArguments.length; i++) {
                sb.append(", ");
                sb.append(TypeUtils.typeToString(this.typeArguments[i]));
            }
    ...
    private static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public boolean equals(Object obj) {
            return (obj instanceof GenericArrayType) && TypeUtils.equals(this, (GenericArrayType) obj);
        }
    ...
    private static final class WildcardTypeImpl implements WildcardType {
        ...
        WildcardTypeImpl(Type[] typeArr, Type[] typeArr2) {
            ...
            if (typeArr2.length == 1) {
                ...
                TypeUtils.checkNotPrimitive(typeArr2[0]);
            ...
            TypeUtils.checkNotPrimitive(typeArr[0]);
        ...
        public Type[] getLowerBounds() {
            ...
            return type != null ? new Type[]{type} : TypeUtils.EMPTY_TYPE_ARRAY;
        }

        public boolean equals(Object obj) {
            return (obj instanceof WildcardType) && TypeUtils.equals(this, (WildcardType) obj);
        }
