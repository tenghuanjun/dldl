...
public class ExecutorTimer {
    private static final ThreadFactory mFactory = new ThreadFactory() { // from class: com.huya.live.utils.ExecutorTimer.1
    ...
    public void start(Runnable runnable, long j, long j2) {
        ...
        this.mExecutorService.scheduleWithFixedDelay(runnable, j, j2, TimeUnit.MILLISECONDS);
    }
