...
final class PayloadWriter {
    ...
    private static void writeValues(File file, final Map<Integer, ByteBuffer> map) throws Throwable {
        writeApkSigningBlock(file, new ApkSigningBlockHandler() { // from class: com.duowan.live.common.packer.walle.PayloadWriter.1
            @Override // com.duowan.live.common.packer.walle.PayloadWriter.ApkSigningBlockHandler
