...
public class BorrowPools {
    ...
    public static class ObjectPool<T> implements IPool<T> {
        ...
        @Override // com.duowan.ark.util.pools.BorrowPools.IPool
        public T borrow() {
        ...
        public boolean revert(T t) {
            if (isInPool(t)) {
                KLog.error(BorrowPools.access$000(), "already in the pool");
    ...
    public static class SynchronizedObjectPool<T> extends ObjectPool<T> {
        ...
        @Override // com.duowan.ark.util.pools.BorrowPools.ObjectPool, com.duowan.ark.util.pools.BorrowPools.IPool
        public T borrow() {
            T t;
