...
public class ArkDialog extends DialogFragment implements IGetLayoutId, LifecycleOwner {
    private static final String BASE_CLASS_NAME = ArkDialog.class.getName();
