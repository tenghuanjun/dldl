...
public class SignV2Interceptor implements Interceptor {
    ...
    */
    public okhttp3.Response intercept(okhttp3.Interceptor.Chain r19) throws java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sq.tool.network.SignV2Interceptor.intercept(okhttp3.Interceptor$Chain):okhttp3.Response");
    }

    public static String sign(Map<String, String> map, SignExt signExt) {
        return sign(ConfigManager.getInstance(SQContextWrapper.getApplicationContext()).getAppKey(), map, signExt);
    }
