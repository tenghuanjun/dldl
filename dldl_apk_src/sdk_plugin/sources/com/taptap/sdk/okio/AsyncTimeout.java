...
public class AsyncTimeout extends Timeout {
    ...
    public final Sink sink(final Sink sink) {
        return new Sink() { // from class: com.taptap.sdk.okio.AsyncTimeout.1
    ...
    public final Source source(final Source source) {
        return new Source() { // from class: com.taptap.sdk.okio.AsyncTimeout.2
        ...
        */
        public void run() {
            /*
                r3 = this;
            L0:
                java.lang.Class<com.taptap.sdk.okio.AsyncTimeout> r0 = com.taptap.sdk.okio.AsyncTimeout.class
                monitor-enter(r0)     // Catch: java.lang.InterruptedException -> L0
                com.taptap.sdk.okio.AsyncTimeout r1 = com.taptap.sdk.okio.AsyncTimeout.awaitTimeout()     // Catch: java.lang.Throwable -> L19
                if (r1 != 0) goto Lb
                monitor-exit(r0)     // Catch: java.lang.Throwable -> L19
                goto L0
            Lb:
                com.taptap.sdk.okio.AsyncTimeout r2 = com.taptap.sdk.okio.AsyncTimeout.head     // Catch: java.lang.Throwable -> L19
                if (r1 != r2) goto L14
                r1 = 0
                com.taptap.sdk.okio.AsyncTimeout.head = r1     // Catch: java.lang.Throwable -> L19
                monitor-exit(r0)     // Catch: java.lang.Throwable -> L19
                return
            L14:
                monitor-exit(r0)     // Catch: java.lang.Throwable -> L19
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.taptap.sdk.okio.AsyncTimeout.Watchdog.run():void");
        }
    }
