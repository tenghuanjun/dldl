...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    @Override // com.taptap.sdk.okio.BufferedSource, com.taptap.sdk.okio.BufferedSink
    ...
    @Override // com.taptap.sdk.okio.BufferedSink
    ...
    @Override // com.taptap.sdk.okio.BufferedSink, com.taptap.sdk.okio.Sink, java.io.Flushable
    public void flush() {
    }
    ...
    public OutputStream outputStream() {
        return new OutputStream() { // from class: com.taptap.sdk.okio.Buffer.1
    ...
    @Override // com.taptap.sdk.okio.BufferedSource
    ...
    public InputStream inputStream() {
        return new InputStream() { // from class: com.taptap.sdk.okio.Buffer.2
    ...
    */
    public long readDecimalLong() {
        /*
            ...
            r9 = 0
        Lf:
            com.taptap.sdk.okio.Segment r10 = r0.head
            byte[] r11 = r10.data
            int r12 = r10.pos
            int r13 = r10.limit
        L17:
        ...
        L35:
            ...
            goto L73
        L3c:
            com.taptap.sdk.okio.Buffer r1 = new com.taptap.sdk.okio.Buffer
            r1.<init>()
            com.taptap.sdk.okio.Buffer r1 = r1.writeDecimalLong(r3)
            com.taptap.sdk.okio.Buffer r1 = r1.writeByte(r15)
            if (r8 != 0) goto L4e
            r1.readByte()
        L4e:
        ...
        L97:
            if (r12 != r13) goto La3
            com.taptap.sdk.okio.Segment r1 = r10.pop()
            r0.head = r1
            com.taptap.sdk.okio.SegmentPool.recycle(r10)
            goto La5
        La3:
            r10.pos = r12
        La5:
            if (r9 != 0) goto Lab
            com.taptap.sdk.okio.Segment r1 = r0.head
            if (r1 != 0) goto Lf
        Lab:
            long r1 = r0.size
            long r5 = (long) r7
        ...
        Lb6:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taptap.sdk.okio.Buffer.readDecimalLong():long");
    }
    ...
    */
    public long readHexadecimalUnsignedLong() {
        /*
            ...
            r1 = 0
        Lb:
            com.taptap.sdk.okio.Segment r6 = r15.head
            byte[] r7 = r6.data
            int r8 = r6.pos
            int r9 = r6.limit
        L13:
        ...
        L3a:
            ...
            goto L13
        L4a:
            com.taptap.sdk.okio.Buffer r0 = new com.taptap.sdk.okio.Buffer
            r0.<init>()
            com.taptap.sdk.okio.Buffer r0 = r0.writeHexadecimalUnsignedLong(r4)
            com.taptap.sdk.okio.Buffer r0 = r0.writeByte(r10)
            java.lang.NumberFormatException r1 = new java.lang.NumberFormatException
            java.lang.StringBuilder r2 = new java.lang.StringBuilder
            r2.<init>()
        ...
        L91:
            if (r8 != r9) goto L9d
            com.taptap.sdk.okio.Segment r7 = r6.pop()
            r15.head = r7
            com.taptap.sdk.okio.SegmentPool.recycle(r6)
            goto L9f
        L9d:
            r6.pos = r8
        L9f:
        ...
        Lac:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taptap.sdk.okio.Buffer.readHexadecimalUnsignedLong():long");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    int selectPrefix(com.taptap.sdk.okio.Options r18, boolean r19) {
        /*
            r17 = this;
            r0 = r18
            r1 = r17
            com.taptap.sdk.okio.Segment r2 = r1.head
            r3 = -2
            if (r2 != 0) goto L13
            if (r19 == 0) goto Lc
            return r3
        Lc:
            com.taptap.sdk.okio.ByteString r2 = com.taptap.sdk.okio.ByteString.EMPTY
        ...
        L47:
            if (r9 != r6) goto L62
            com.taptap.sdk.okio.Segment r4 = r10.next
            int r6 = r4.pos
            byte[] r9 = r4.data
            int r10 = r4.limit
            if (r4 != r2) goto L5c
        ...
        L80:
            ...
            r5 = r0[r13]
            if (r14 != r6) goto L95
            com.taptap.sdk.okio.Segment r10 = r10.next
            int r3 = r10.pos
            byte[] r4 = r10.data
            int r6 = r10.limit
            if (r10 != r2) goto L96
        ...
        L9d:
            ...
            goto L7d
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taptap.sdk.okio.Buffer.selectPrefix(com.taptap.sdk.okio.Options, boolean):int");
    }
    ...
    public Buffer writeUtf8(String str, int i, int i2) {
        ...
        while (i < i2) {
            ...
            if (cCharAt < 128) {
                ...
                if (cCharAt < 2048) {
                    writeByte((cCharAt >> 6) | Opcodes.CHECKCAST);
    ...
    public final ByteString hmacSha1(ByteString byteString) {
        return hmac(TapHttpUtil.HMAC_SHA1, byteString);
    }

    public final ByteString hmacSha256(ByteString byteString) {
        return hmac(TapHttpUtil.HMAC_SHA256, byteString);
    }
