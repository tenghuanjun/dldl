...
public final class Response<T> {
    ...
    private final com.taptap.sdk.okhttp3.Response rawResponse;
    ...
    public static <T> Response<T> success(@Nullable T t, com.taptap.sdk.okhttp3.Response response) {
    ...
    public static <T> Response<T> error(ResponseBody responseBody, com.taptap.sdk.okhttp3.Response response) {
        Objects.requireNonNull(responseBody, "body == null");
        Objects.requireNonNull(response, "rawResponse == null");
        if (response.isSuccessful()) {
    ...
    private Response(com.taptap.sdk.okhttp3.Response response, @Nullable T t, @Nullable ResponseBody responseBody) {
        this.rawResponse = response;
        this.body = t;
        this.errorBody = responseBody;
    }

    public com.taptap.sdk.okhttp3.Response raw() {
