package com.taptap.sdk.okhttp3.internal;
...
public final class Util {
    ...
    public static final Comparator<String> NATURAL_ORDER = new Comparator<String>() { // from class: com.taptap.sdk.okhttp3.internal.Util.1
    ...
    public static ThreadFactory threadFactory(final String str, final boolean z) {
        return new ThreadFactory() { // from class: com.taptap.sdk.okhttp3.internal.Util.2
    ...
    */
    private static java.net.InetAddress decodeIpv6(java.lang.String r11, int r12, int r13) {
        ...
        L90:
            ...
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taptap.sdk.okhttp3.internal.Util.decodeIpv6(java.lang.String, int, int):java.net.InetAddress");
    }
