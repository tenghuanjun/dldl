...
import com.taptap.sdk.okhttp3.WebSocketListener;
...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random, long j) {
        ...
        this.writerRunnable = new Runnable() { // from class: com.taptap.sdk.okhttp3.internal.ws.RealWebSocket.1
    ...
    public void connect(OkHttpClient okHttpClient) {
        ...
        final Request requestBuild = this.originalRequest.newBuilder().header("Upgrade", WebSocketCenter.KEY_WEBSOCKET).header("Connection", "Upgrade").header("Sec-WebSocket-Key", this.key).header("Sec-WebSocket-Version", FastLoginConstants.Code.FAILURE_VERIFY_FAIL).build();
        ...
        this.call.enqueue(new Callback() { // from class: com.taptap.sdk.okhttp3.internal.ws.RealWebSocket.2
    ...
    void checkResponse(Response response) throws ProtocolException {
        ...
        if (!WebSocketCenter.KEY_WEBSOCKET.equalsIgnoreCase(strHeader2)) {
