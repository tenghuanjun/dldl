...
import com.taptap.sdk.okhttp3.internal.connection.RouteSelector;
import com.taptap.sdk.okhttp3.internal.http.HttpCodec;
import com.taptap.sdk.okhttp3.internal.http2.ConnectionShutdownException;
import com.taptap.sdk.okhttp3.internal.http2.ErrorCode;
import com.taptap.sdk.okhttp3.internal.http2.StreamResetException;
    ...
    */
    private java.net.Socket deallocate(boolean r2, boolean r3, boolean r4) {
        ...
        L5:
            ...
            r1.released = r4
        La:
            com.taptap.sdk.okhttp3.internal.connection.RealConnection r3 = r1.connection
            if (r3 == 0) goto L4e
            if (r2 == 0) goto L12
            r3.noNewStreams = r4
        L12:
            com.taptap.sdk.okhttp3.internal.http.HttpCodec r2 = r1.codec
            if (r2 != 0) goto L4e
            boolean r2 = r1.released
            if (r2 != 0) goto L20
            com.taptap.sdk.okhttp3.internal.connection.RealConnection r2 = r1.connection
        ...
        L20:
            ...
            r1.release(r2)
            com.taptap.sdk.okhttp3.internal.connection.RealConnection r2 = r1.connection
            java.util.List<java.lang.ref.Reference<com.taptap.sdk.okhttp3.internal.connection.StreamAllocation>> r2 = r2.allocations
            boolean r2 = r2.isEmpty()
            if (r2 == 0) goto L4a
            com.taptap.sdk.okhttp3.internal.connection.RealConnection r2 = r1.connection
            long r3 = java.lang.System.nanoTime()
            r2.idleAtNanos = r3
            com.taptap.sdk.okhttp3.internal.Internal r2 = com.taptap.sdk.okhttp3.internal.Internal.instance
            com.taptap.sdk.okhttp3.ConnectionPool r3 = r1.connectionPool
            com.taptap.sdk.okhttp3.internal.connection.RealConnection r4 = r1.connection
        ...
        L4e:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taptap.sdk.okhttp3.internal.connection.StreamAllocation.deallocate(boolean, boolean, boolean):java.net.Socket");
    }
