...
import com.taptap.sdk.okhttp3.Address;
import com.taptap.sdk.okhttp3.Call;
import com.taptap.sdk.okhttp3.CertificatePinner;
import com.taptap.sdk.okhttp3.Connection;
import com.taptap.sdk.okhttp3.ConnectionPool;
import com.taptap.sdk.okhttp3.ConnectionSpec;
import com.taptap.sdk.okhttp3.EventListener;
import com.taptap.sdk.okhttp3.Handshake;
...
import com.taptap.sdk.okhttp3.internal.Internal;
import com.taptap.sdk.okhttp3.internal.Util;
import com.taptap.sdk.okhttp3.internal.Version;
import com.taptap.sdk.okhttp3.internal.http.HttpCodec;
import com.taptap.sdk.okhttp3.internal.http.HttpHeaders;
import com.taptap.sdk.okhttp3.internal.http1.Http1Codec;
import com.taptap.sdk.okhttp3.internal.http2.ErrorCode;
import com.taptap.sdk.okhttp3.internal.http2.Http2Codec;
import com.taptap.sdk.okhttp3.internal.http2.Http2Connection;
import com.taptap.sdk.okhttp3.internal.http2.Http2Stream;
import com.taptap.sdk.okhttp3.internal.platform.Platform;
import com.taptap.sdk.okhttp3.internal.tls.OkHostnameVerifier;
import com.taptap.sdk.okhttp3.internal.ws.RealWebSocket;
...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    */
    public void connect(int r17, int r18, int r19, int r20, boolean r21, com.taptap.sdk.okhttp3.Call r22, com.taptap.sdk.okhttp3.EventListener r23) throws java.lang.Throwable {
        /*
            Method dump skipped, instruction units count: 344
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taptap.sdk.okhttp3.internal.connection.RealConnection.connect(int, int, int, int, boolean, com.taptap.sdk.okhttp3.Call, com.taptap.sdk.okhttp3.EventListener):void");
    }
    ...
    public RealWebSocket.Streams newWebSocketStreams(final StreamAllocation streamAllocation) {
        return new RealWebSocket.Streams(true, this.source, this.sink) { // from class: com.taptap.sdk.okhttp3.internal.connection.RealConnection.1
    ...
    @Override // com.taptap.sdk.okhttp3.Connection
    public Route route() {
        return this.route;
    }
