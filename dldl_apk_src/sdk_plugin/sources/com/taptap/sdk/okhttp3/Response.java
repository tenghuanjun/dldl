...
public final class Response implements Closeable {
    ...
    public ResponseBody peekBody(long j) throws IOException {
        ...
        Buffer bufferM42clone = bufferedSourceSource.buffer().m42clone();
        if (bufferM42clone.size() > j) {
            Buffer buffer = new Buffer();
            buffer.write(bufferM42clone, j);
            bufferM42clone.clear();
            bufferM42clone = buffer;
        }
        return ResponseBody.create(this.body.contentType(), bufferM42clone.size(), bufferM42clone);
    }
