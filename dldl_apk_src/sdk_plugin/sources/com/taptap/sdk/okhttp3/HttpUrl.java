...
import com.taptap.sdk.okhttp3.internal.publicsuffix.PublicSuffixDatabase;
...
public final class HttpUrl {
    ...
    public boolean isHttps() {
        return this.scheme.equals(IDataSource.SCHEME_HTTPS_TAG);
    }
    ...
    public static int defaultPort(String str) {
        ...
        return str.equals(IDataSource.SCHEME_HTTPS_TAG) ? 443 : -1;
    }
    ...
    public static final class Builder {
        ...
        public Builder scheme(String str) {
            ...
            if (str.equalsIgnoreCase(IDataSource.SCHEME_HTTP_TAG)) {
                this.scheme = IDataSource.SCHEME_HTTP_TAG;
            } else if (str.equalsIgnoreCase(IDataSource.SCHEME_HTTPS_TAG)) {
                this.scheme = IDataSource.SCHEME_HTTPS_TAG;
            } else {
        ...
        private boolean isDot(String str) {
            return str.equals(FileUtil.FILE_EXTENSION_SEPARATOR) || str.equalsIgnoreCase("%2e");
        }
    ...
    */
    static void percentDecode(com.taptap.sdk.okio.Buffer r5, java.lang.String r6, int r7, int r8, boolean r9) {
        /*
        L0:
            if (r7 >= r8) goto L42
            ...
            int r2 = com.taptap.sdk.okhttp3.internal.Util.decodeHexDigit(r2)
            char r3 = r6.charAt(r1)
            int r3 = com.taptap.sdk.okhttp3.internal.Util.decodeHexDigit(r3)
            r4 = -1
            if (r2 == r4) goto L39
            if (r3 == r4) goto L39
            int r7 = r2 << 4
        ...
        L42:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taptap.sdk.okhttp3.HttpUrl.percentDecode(com.taptap.sdk.okio.Buffer, java.lang.String, int, int, boolean):void");
    }
