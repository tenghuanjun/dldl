...
import com.taptap.sdk.okhttp3.internal.cache.CacheStrategy;
import com.taptap.sdk.okhttp3.internal.cache.DiskLruCache;
import com.taptap.sdk.okhttp3.internal.cache.InternalCache;
import com.taptap.sdk.okhttp3.internal.http.HttpHeaders;
import com.taptap.sdk.okhttp3.internal.http.HttpMethod;
import com.taptap.sdk.okhttp3.internal.http.StatusLine;
...
import com.taptap.sdk.okio.ForwardingSink;
...
public final class Cache implements Closeable, Flushable {
    ...
    Cache(File file, long j, FileSystem fileSystem) {
        this.internalCache = new InternalCache() { // from class: com.taptap.sdk.okhttp3.Cache.1
    ...
    public Iterator<String> urls() throws IOException {
        return new Iterator<String>() { // from class: com.taptap.sdk.okhttp3.Cache.2
            boolean canRemove;
    ...
    private final class CacheRequestImpl implements CacheRequest {
        ...
        CacheRequestImpl(final DiskLruCache.Editor editor) {
            ...
            this.body = new ForwardingSink(sinkNewSink) { // from class: com.taptap.sdk.okhttp3.Cache.CacheRequestImpl.1
                @Override // com.taptap.sdk.okio.ForwardingSink, com.taptap.sdk.okio.Sink, java.io.Closeable, java.lang.AutoCloseable
                public void close() throws IOException {
    ...
    private static class CacheResponseBody extends ResponseBody {
        ...
        CacheResponseBody(final DiskLruCache.Snapshot snapshot, String str, String str2) {
            ...
            this.bodySource = Okio.buffer(new ForwardingSource(snapshot.getSource(1)) { // from class: com.taptap.sdk.okhttp3.Cache.CacheResponseBody.1
                @Override // com.taptap.sdk.okio.ForwardingSource, com.taptap.sdk.okio.Source, java.io.Closeable, java.lang.AutoCloseable
                public void close() throws IOException {
                    snapshot.close();
                    super.close();
                }
