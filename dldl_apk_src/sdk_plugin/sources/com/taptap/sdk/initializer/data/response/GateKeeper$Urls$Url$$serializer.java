...
public final class GateKeeper$Urls$Url$$serializer implements GeneratedSerializer<GateKeeper.Urls.Url> {
    ...
    static {
        GateKeeper$Urls$Url$$serializer gateKeeper$Urls$Url$$serializer = new GateKeeper$Urls$Url$$serializer();
        INSTANCE = gateKeeper$Urls$Url$$serializer;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.taptap.sdk.initializer.data.response.GateKeeper.Urls.Url", gateKeeper$Urls$Url$$serializer, 3);
    ...
    private GateKeeper$Urls$Url$$serializer() {
    }
    ...
    public GateKeeper.Urls.Url deserialize(Decoder decoder) {
        String str;
        ...
        return new GateKeeper.Urls.Url(i, str, str2, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public void serialize(Encoder encoder, GateKeeper.Urls.Url value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(descriptor2);
        GateKeeper.Urls.Url.write$Self(value, compositeEncoderBeginStructure, descriptor2);
