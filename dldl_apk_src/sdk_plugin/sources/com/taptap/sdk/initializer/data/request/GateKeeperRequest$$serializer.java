...
public final class GateKeeperRequest$$serializer implements GeneratedSerializer<GateKeeperRequest> {
    ...
    static {
        GateKeeperRequest$$serializer gateKeeperRequest$$serializer = new GateKeeperRequest$$serializer();
        INSTANCE = gateKeeperRequest$$serializer;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.taptap.sdk.initializer.data.request.GateKeeperRequest", gateKeeperRequest$$serializer, 3);
        pluginGeneratedSerialDescriptor.addElement("platform", false);
        pluginGeneratedSerialDescriptor.addElement("package_name", false);
        pluginGeneratedSerialDescriptor.addElement("package_sign", false);
        descriptor = pluginGeneratedSerialDescriptor;
    }

    private GateKeeperRequest$$serializer() {
    }
    ...
    public GateKeeperRequest deserialize(Decoder decoder) {
        String str;
        String str2;
        ...
        return new GateKeeperRequest(i, str2, str, (String) objDecodeNullableSerializableElement, null);
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public void serialize(Encoder encoder, GateKeeperRequest value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(descriptor2);
        GateKeeperRequest.write$Self(value, compositeEncoderBeginStructure, descriptor2);
