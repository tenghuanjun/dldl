...
final class DecodedBitStreamParser {
    ...
    private static int getPostCode2(byte[] bArr) {
        return getInt(bArr, new byte[]{33, 34, 35, 36, 25, 26, 27, 28, 29, 30, 19, 20, 21, 22, 23, 24, 13, 14, 15, 16, 17, 18, 7, 8, 9, 10, JceStruct.STRUCT_END, JceStruct.ZERO_TAG, 1, 2});
    }

    private static String getPostCode3(byte[] bArr) {
        return String.valueOf(new char[]{SETS[0].charAt(getInt(bArr, new byte[]{39, 40, 41, 42, 31, 32})), SETS[0].charAt(getInt(bArr, new byte[]{33, 34, 35, 36, 25, 26})), SETS[0].charAt(getInt(bArr, new byte[]{27, 28, 29, 30, 19, 20})), SETS[0].charAt(getInt(bArr, new byte[]{21, 22, 23, 24, 13, 14})), SETS[0].charAt(getInt(bArr, new byte[]{15, 16, 17, 18, 7, 8})), SETS[0].charAt(getInt(bArr, new byte[]{9, 10, JceStruct.STRUCT_END, JceStruct.ZERO_TAG, 1, 2}))});
    }
        ...
        while (i3 < i + i2) {
            ...
            switch (cCharAt) {
                ...
                case 65531:
                    ...
                    int i11 = i9 + 1;
                    int i12 = i10 + (bArr[i11] << JceStruct.ZERO_TAG);
                    int i13 = i11 + 1;
