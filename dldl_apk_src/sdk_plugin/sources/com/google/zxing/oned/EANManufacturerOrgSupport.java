...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{535}, "MT");
            add(new int[]{539}, "IE");
            add(new int[]{StencilManager.DRAW_AREA_WIDTH, 549}, "BE/LU");
            add(new int[]{560}, "PT");
            add(new int[]{569}, "IS");
            ...
            add(new int[]{893}, "VN");
            add(new int[]{896}, "PK");
            add(new int[]{899}, LoginTriggerTable.ID);
            add(new int[]{XXBarrageParser.SUPER_FAST_DURATION, ErrorCode._EC_HTTP}, "AT");
