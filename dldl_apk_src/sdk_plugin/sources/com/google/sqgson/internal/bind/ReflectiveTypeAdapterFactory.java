...
import com.google.sqgson.FieldNamingStrategy;
...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private BoundField createBoundField(final Gson gson, final Field field, String str, final TypeToken<?> typeToken, boolean z, boolean z2) {
        ...
        return new BoundField(str, z, z2) { // from class: com.google.sqgson.internal.bind.ReflectiveTypeAdapterFactory.1
            @Override // com.google.sqgson.internal.bind.ReflectiveTypeAdapterFactory.BoundField
