package com.sy37sdk.order.eventbus;
...
import com.sy37sdk.order.OrderModImpl;
...
public class EventBusIndex implements SubscriberInfoIndex {
    ...
    static {
        putIndex(new EventBeans(OrderModImpl.class, new SubscriberMethod[]{new SubscriberMethod(OrderModImpl.class, "onActivityResult", ThreadMode.POSTING, OnActivityResultEvent.class, false, 0), new SubscriberMethod(OrderModImpl.class, "onSActiveEvent", ThreadMode.POSTING, SActiveEvent.class, false, 0)}));
    }
