...
final class ApkUtil {
    ...
    public static Pair<ByteBuffer, Long> findApkSigningBlock(FileChannel fileChannel, long j) throws IOException {
        if (j < 32) {
    ...
    public static Map<Integer, ByteBuffer> findIdValues(ByteBuffer byteBuffer) throws IOException {
        ...
        while (byteBufferSliceFromTo.hasRemaining()) {
            ...
            if (i2 > byteBufferSliceFromTo.remaining()) {
                throw new IOException("APK Signing Block entry #" + i + " size out of range: " + i2 + ", available: " + byteBufferSliceFromTo.remaining());
            }
