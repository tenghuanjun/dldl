...
public interface m_a extends IInterface {
    ...
    public static abstract class AbstractBinderC0013m_a extends Binder implements m_a {
        ...
        public static class C0014m_a implements m_a {
            public IBinder m_a;

            public C0014m_a(IBinder iBinder) {
                this.m_a = iBinder;
            }
