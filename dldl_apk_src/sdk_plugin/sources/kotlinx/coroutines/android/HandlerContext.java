...
public final class HandlerContext extends HandlerDispatcher implements Delay {
    ...
    public DisposableHandle invokeOnTimeout(long timeMillis, final Runnable block, CoroutineContext context) {
        if (this.handler.postDelayed(block, RangesKt.coerceAtMost(timeMillis, DurationKt.MAX_MILLIS))) {
            return new DisposableHandle() { // from class: kotlinx.coroutines.android.-$$Lambda$HandlerContext$AYyJ57IpsQxcbmCNx8xF14_GmdI
    ...
    public static final void m1543invokeOnTimeout$lambda3(HandlerContext handlerContext, Runnable runnable) {
