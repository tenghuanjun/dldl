...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM52constructorimpl = Result.m52constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM52constructorimpl = Result.m52constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m58isFailureimpl(objM52constructorimpl) ? null : objM52constructorimpl);
    }
    ...
    public static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.-$$Lambda$HandlerDispatcherKt$NWrjUWFCewCsx_vZHJuqZRuFzKg
    ...
    public static final void m1544postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
