...
public final class StateFlowKt {
    ...
    public static final <T> T updateAndGet(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        ...
        T tInvoke;
        do {
            permissionVar = (Object) mutableStateFlow.getValue();
            tInvoke = function1.invoke(permissionVar);
        } while (!mutableStateFlow.compareAndSet(permissionVar, tInvoke));
        return tInvoke;
    }
    ...
    public static final <T> void update(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        ...
        do {
            permissionVar = (Object) mutableStateFlow.getValue();
        } while (!mutableStateFlow.compareAndSet(permissionVar, function1.invoke(permissionVar)));
    }
