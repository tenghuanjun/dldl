...
final /* synthetic */ class FlowKt__MigrationKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__MigrationKt$onErrorReturn$2", f = "Migration.kt", i = {}, l = {DouYinPayWay.ERROR_GO_PAY_PAGE}, m = "invokeSuspend", n = {}, s = {})
    ...
    static final class C02041<T> extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        final /* synthetic */ long $timeMillis;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02041(long j, Continuation<? super C02041> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02041(this.$timeMillis, continuation);
        }
    ...
    public static final <T> Flow<T> delayFlow(Flow<? extends T> flow, long j) {
        return FlowKt.onStart(flow, new C02041(j, null));
    }
