...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    */
    ...
    public final Object mo1548trySendJP2dKIU(E element) {
        ...
        if (objOfferInternal instanceof Closed) {
            return ChannelResult.INSTANCE.m1566closedJP2dKIU(helpCloseAndGetSendException((Closed) objOfferInternal));
        }
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 != null && (undeliveredElementExceptionCallUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            continuation.resumeWith(Result.m52constructorimpl(ResultKt.createFailure(undeliveredElementException)));
            return;
        }
        Result.Companion companion2 = Result.INSTANCE;
        continuation.resumeWith(Result.m52constructorimpl(ResultKt.createFailure(sendException)));
    }
    ...
    */
    ...
    private final void helpClose(Closed<?> closed) {
        ...
        while (true) {
            ...
            if (receive == null) {
                break;
            } else if (!receive.mo1593remove()) {
                receive.helpRemove();
            } else {
                objM1585constructorimpl$default = InlineList.m1590plusFjFbRPM(objM1585constructorimpl$default, receive);
            }
        }
        if (objM1585constructorimpl$default != null) {
            if (!(objM1585constructorimpl$default instanceof ArrayList)) {
                ((Receive) objM1585constructorimpl$default).resumeReceiveClosed(closed);
            } else if (objM1585constructorimpl$default != null) {
                ArrayList arrayList = (ArrayList) objM1585constructorimpl$default;
    ...
    */
    ...
    private static final class SendSelect<E, R> extends Send implements DisposableHandle {
        ...
        public String toString() {
            return "SendSelect@" + DebugStringsKt.getHexAddress(this) + '(' + getElement() + ")[" + this.channel + ", " + this.select + AbstractJsonLexerKt.END_LIST;
        }
    }
