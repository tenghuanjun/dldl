...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object objMo1548trySendJP2dKIU = sendChannel.mo1548trySendJP2dKIU(e);
            if (ChannelResult.m1563isSuccessimpl(objMo1548trySendJP2dKIU)) {
                return true;
            }
            Throwable thM1557exceptionOrNullimpl = ChannelResult.m1557exceptionOrNullimpl(objMo1548trySendJP2dKIU);
