        ...
        */
        public final boolean checkOffer() {
            ...
            L3:
                ...
                if (r3 == 0) goto L71
                java.lang.Object r3 = r10.peekUnderLock()     // Catch: java.lang.Throwable -> L6a
                kotlinx.coroutines.internal.Symbol r5 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch: java.lang.Throwable -> L6a
                if (r3 != r5) goto L20
            L1a:
                java.util.concurrent.locks.ReentrantLock r3 = r10.subLock
                r3.unlock()
                goto L3
            L20:
                boolean r5 = r3 instanceof kotlinx.coroutines.channels.Closed     // Catch: java.lang.Throwable -> L6a
                if (r5 == 0) goto L2d
                r4 = r3
                kotlinx.coroutines.channels.Closed r4 = (kotlinx.coroutines.channels.Closed) r4     // Catch: java.lang.Throwable -> L6a
            L27:
                java.util.concurrent.locks.ReentrantLock r0 = r10.subLock
                r0.unlock()
                goto L71
            L2d:
                kotlinx.coroutines.channels.ReceiveOrClosed r5 = r10.takeFirstReceiveOrPeekClosed()     // Catch: java.lang.Throwable -> L6a
                if (r5 != 0) goto L34
                goto L27
            L34:
                boolean r6 = r5 instanceof kotlinx.coroutines.channels.Closed     // Catch: java.lang.Throwable -> L6a
                if (r6 == 0) goto L39
                goto L27
            L39:
                kotlinx.coroutines.internal.Symbol r4 = r5.tryResumeReceive(r3, r4)     // Catch: java.lang.Throwable -> L6a
                if (r4 != 0) goto L40
                goto L1a
            L40:
                boolean r2 = kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED()     // Catch: java.lang.Throwable -> L6a
                if (r2 == 0) goto L56
                kotlinx.coroutines.internal.Symbol r2 = kotlinx.coroutines.CancellableContinuationImplKt.RESUME_TOKEN     // Catch: java.lang.Throwable -> L6a
                if (r4 != r2) goto L4c
                r2 = 1
                goto L4d
            L4c:
