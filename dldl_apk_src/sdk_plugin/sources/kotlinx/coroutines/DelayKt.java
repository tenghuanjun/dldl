...
public final class DelayKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.DelayKt", f = "Delay.kt", i = {}, l = {Opcodes.LCMP}, m = "awaitCancellation", n = {}, s = {})
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < LongCompanionObject.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1595scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1532delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1533toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1533toDelayMillisLRDsOJo(long j) {
        if (Duration.m1373compareToLRDsOJo(j, Duration.INSTANCE.m1476getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1392getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
