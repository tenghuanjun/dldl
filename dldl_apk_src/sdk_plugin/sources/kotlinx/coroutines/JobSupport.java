    ...
    */
    private final /* synthetic */ <T extends kotlinx.coroutines.JobNode> void notifyHandlers(kotlinx.coroutines.NodeList r8, java.lang.Throwable r9) throws java.lang.Throwable {
        ...
        L56:
            ...
            if (r1 == 0) goto L5f
            java.lang.Throwable r1 = (java.lang.Throwable) r1
            r7.handleOnCompletionException$kotlinx_coroutines_core(r1)
        L5f:
            return
        */
    ...
    private static final class Finishing implements Incomplete {
        ...
        public String toString() {
            return "Finishing[cancelling=" + isCancelling() + ", completing=" + isCompleting() + ", rootCause=" + getRootCause() + ", exceptions=" + get_exceptionsHolder() + ", list=" + getList() + AbstractJsonLexerKt.END_LIST;
        }
    }
