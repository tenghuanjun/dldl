...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM52constructorimpl = Result.m52constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM52constructorimpl = Result.m52constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m58isFailureimpl(objM52constructorimpl) ? null : objM52constructorimpl);
    ...
    private final void installSignalHandler() {
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.-$$Lambda$AgentPremain$6vy0kBIPkuO0a1izx5ONKfM-3Ss
                public final void handle(Signal signal) {
                    AgentPremain.m1570installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1570installSignalHandler$lambda1(Signal signal) {
