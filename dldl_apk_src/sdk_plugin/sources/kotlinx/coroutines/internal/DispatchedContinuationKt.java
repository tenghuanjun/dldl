...
public final class DispatchedContinuationKt {
    ...
    public static final <T> void resumeCancellableWith(Continuation<? super T> continuation, Object obj, Function1<? super Throwable, Unit> function1) {
        ...
        if (dispatchedContinuation.dispatcher.isDispatchNeeded(dispatchedContinuation.get$context())) {
            ...
            dispatchedContinuation.dispatcher.mo1594dispatch(dispatchedContinuation.get$context(), dispatchedContinuation);
            return;
        }
        ...
        try {
            ...
            if (job == null || job.isActive()) {
                ...
                dispatchedContinuation.resumeWith(Result.m52constructorimpl(ResultKt.createFailure(cancellationException)));
                z = true;
            }
            if (!z) {
