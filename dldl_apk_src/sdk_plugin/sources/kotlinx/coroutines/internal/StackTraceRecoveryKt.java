...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM52constructorimpl = Result.m52constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        if (Result.m55exceptionOrNullimpl(objM52constructorimpl) == null) {
            obj2 = objM52constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM52constructorimpl2 = Result.m52constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
