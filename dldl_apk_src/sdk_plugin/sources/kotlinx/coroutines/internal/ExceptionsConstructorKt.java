...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM52constructorimpl = Result.m52constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
            ...
            return (E) objM52constructorimpl;
        }
            ...
            return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$4
                ...
                public final Throwable invoke(Throwable th) {
                    ...
                    if (objNewInstance != null) {
                        ...
                        th3.initCause(th);
                        objM52constructorimpl = Result.m52constructorimpl(th3);
                        if (Result.m58isFailureimpl(objM52constructorimpl)) {
                            objM52constructorimpl = null;
                        }
                        return (Throwable) objM52constructorimpl;
                    }
            ...
            if (length == 2 && Intrinsics.areEqual(parameterTypes[0], String.class) && Intrinsics.areEqual(parameterTypes[1], Throwable.class)) {
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$1
                    ...
                    public final Throwable invoke(Throwable th) {
                        ...
                        if (objNewInstance != null) {
                            objM52constructorimpl = Result.m52constructorimpl((Throwable) objNewInstance);
                            if (Result.m58isFailureimpl(objM52constructorimpl)) {
                                objM52constructorimpl = null;
                            }
                            return (Throwable) objM52constructorimpl;
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    Result.Companion companion = Result.INSTANCE;
                    objM52constructorimpl = Result.m52constructorimpl(function12.invoke(th));
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM52constructorimpl = Result.m52constructorimpl(ResultKt.createFailure(th2));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM52constructorimpl = Result.m52constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM52constructorimpl = Result.m52constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m58isFailureimpl(objM52constructorimpl)) {
            objM52constructorimpl = numValueOf;
        }
        return ((Number) objM52constructorimpl).intValue();
    }
