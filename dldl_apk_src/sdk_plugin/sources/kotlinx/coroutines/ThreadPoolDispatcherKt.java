...
public final class ThreadPoolDispatcherKt {
    ...
    public static final ExecutorCoroutineDispatcher newFixedThreadPoolContext(final int i, final String str) {
        ...
        return ExecutorsKt.from((ExecutorService) Executors.newScheduledThreadPool(i, new ThreadFactory() { // from class: kotlinx.coroutines.-$$Lambda$ThreadPoolDispatcherKt$75qNBDtr7Q5r4C6Qw0YyznZk3QY
            @Override // java.util.concurrent.ThreadFactory
            public final Thread newThread(Runnable runnable) {
                return ThreadPoolDispatcherKt.m1540newFixedThreadPoolContext$lambda1(i, str, atomicInteger, runnable);
            }
        }));
    }
    ...
    public static final Thread m1540newFixedThreadPoolContext$lambda1(int i, String str, AtomicInteger atomicInteger, Runnable runnable) {
        if (i != 1) {
