    ...
    public Encoder encodeTaggedInline(final String tag, SerialDescriptor inlineDescriptor) {
        ...
        return StreamingJsonEncoderKt.isUnsignedNumber(inlineDescriptor) ? new AbstractEncoder() { // from class: kotlinx.serialization.json.internal.AbstractJsonTreeEncoder.encodeTaggedInline.1
            ...
            public void encodeInt(int value) {
                putUnquotedString(Long.toString(((long) UInt.m146constructorimpl(value)) & 4294967295L, 10));
            }

            @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
            public void encodeLong(long value) {
                putUnquotedString(C$r8$backportedMethods$utility$Long$2$toUnsignedStringWithRadix.toUnsignedString(ULong.m224constructorimpl(value), 10));
            }

            @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
            public void encodeByte(byte value) {
                putUnquotedString(UByte.m113toStringimpl(UByte.m70constructorimpl(value)));
            }

            @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
            public void encodeShort(short value) {
                putUnquotedString(UShort.m373toStringimpl(UShort.m330constructorimpl(value)));
            }
