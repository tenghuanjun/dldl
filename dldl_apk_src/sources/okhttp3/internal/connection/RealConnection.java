...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    */
    ...
    private Request createTunnelRequest() throws IOException {
        ...
        Request requestAuthenticate = this.route.address().proxyAuthenticator().authenticate(this.route, new Response.Builder().request(requestBuild).protocol(Protocol.HTTP_1_1).code(TTAdConstant.DOWNLOAD_URL_CODE).message("Preemptive Authenticate").body(Util.EMPTY_RESPONSE).sentRequestAtMillis(-1L).receivedResponseAtMillis(-1L).header("Proxy-Authenticate", "OkHttp-Preemptive").build());
    ...
    public String toString() {
        ...
        sb.append(handshake != null ? handshake.cipherSuite() : a.i);
        sb.append(" protocol=");
