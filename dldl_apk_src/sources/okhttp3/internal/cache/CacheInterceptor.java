...
public final class CacheInterceptor implements Interceptor {
    ...
    static boolean isContentSpecificHeader(String str) {
        return "Content-Length".equalsIgnoreCase(str) || com.alibaba.sdk.android.oss.common.utils.HttpHeaders.CONTENT_ENCODING.equalsIgnoreCase(str) || "Content-Type".equalsIgnoreCase(str);
    }
}
