...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    private Request followUpRequest(Response response, Route route) throws IOException {
        ...
        if (!this.client.followRedirects() || (strHeader = response.header(com.alibaba.sdk.android.oss.common.utils.HttpHeaders.LOCATION)) == null || (httpUrlResolve = response.request().url().resolve(strHeader)) == null) {
            return null;
        }
