...
public final class HttpHeaders {
    ...
    public static Set<String> varyFields(Headers headers) {
        ...
        for (int i = 0; i < size; i++) {
            if ("Vary".equalsIgnoreCase(headers.name(i))) {
                ...
                for (String str : strValue.split(b.aj)) {
    ...
    */
    ...
    public static boolean hasBody(Response response) {
        ...
        return (((iCode >= 100 && iCode < 200) || iCode == 204 || iCode == 304) && contentLength(response) == -1 && !DownloadUtils.VALUE_CHUNKED.equalsIgnoreCase(response.header(DownloadUtils.TRANSFER_ENCODING))) ? false : true;
    }
