    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (requestBodyBody != null) {
            ...
            if (jContentLength != -1) {
                ...
                builderNewBuilder.header(DownloadUtils.TRANSFER_ENCODING, DownloadUtils.VALUE_CHUNKED);
        ...
        if (z && "gzip".equalsIgnoreCase(responseProceed.header(com.alibaba.sdk.android.oss.common.utils.HttpHeaders.CONTENT_ENCODING)) && HttpHeaders.hasBody(responseProceed)) {
            GzipSource gzipSource = new GzipSource(responseProceed.body().source());
            builderRequest.headers(responseProceed.headers().newBuilder().removeAll(com.alibaba.sdk.android.oss.common.utils.HttpHeaders.CONTENT_ENCODING).removeAll("Content-Length").build());
