...
public class SwitchCompat extends CompoundButton {
    ...
    private Layout makeLayout(CharSequence charSequence) {
        ...
        return new StaticLayout(transformation, this.mTextPaint, transformation != null ? (int) Math.ceil(Layout.getDesiredWidth(transformation, r2)) : 0, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, true);
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (drawable2 != null) {
            ...
            if (opticalBounds != null) {
                ...
                i2 = opticalBounds.bottom > rect.bottom ? i6 - (opticalBounds.bottom - rect.bottom) : i6;
            } else {
                i = i4;
                i2 = i6;
            }
