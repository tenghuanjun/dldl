...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    class DecelerateInterpolator extends MotionInterpolator {
        ...
        public float getInterpolation(float f) {
            ...
            return (f7 * f) + (((f8 * f) * f) / 2.0f) + this.currentP;
        }
    ...
    public void getViewVelocity(View view, float f, float f2, float[] fArr, int i) {
        ...
        if (this.mInterpolator != null) {
            ...
            f3 = (fSignum * ((interpolation - interpolation2) / EPSILON)) / this.mTransitionDuration;
            f4 = interpolation2;
        }
    ...
    class Model {
        ...
        public void measure(int i, int i2) {
            ...
            MotionLayout.this.resolveMeasuredDimension(i, i2, (MotionLayout.this.mWidthMeasureMode == Integer.MIN_VALUE || MotionLayout.this.mWidthMeasureMode == 0) ? (int) (MotionLayout.this.mStartWrapWidth + (MotionLayout.this.mPostInterpolationPosition * (MotionLayout.this.mEndWrapWidth - MotionLayout.this.mStartWrapWidth))) : MotionLayout.this.mStartWrapWidth, (MotionLayout.this.mHeightMeasureMode == Integer.MIN_VALUE || MotionLayout.this.mHeightMeasureMode == 0) ? (int) (MotionLayout.this.mStartWrapHeight + (MotionLayout.this.mPostInterpolationPosition * (MotionLayout.this.mEndWrapHeight - MotionLayout.this.mStartWrapHeight))) : MotionLayout.this.mStartWrapHeight, this.mLayoutStart.isWidthMeasuredTooSmall() || this.mLayoutEnd.isWidthMeasuredTooSmall(), this.mLayoutStart.isHeightMeasuredTooSmall() || this.mLayoutEnd.isHeightMeasuredTooSmall());
        }
    ...
    void evaluate(boolean z) {
        ...
        if (this.mKeepAnimating || (this.mInTransition && (z || this.mTransitionGoalPosition != this.mTransitionLastPosition))) {
            ...
            if (interpolator != null && !z2) {
                if (this.mTemporalInterpolator) {
                    ...
                    if (interpolator3 instanceof MotionInterpolator) {
                        ...
                        this.mLastVelocity = ((interpolator3.getInterpolation(f4 + f) - interpolation2) * fSignum) / f;
                    }
                    f4 = interpolation2;
                }
            }
            ...
            if (this.mKeepAnimating || this.mInTransition) {
                invalidate();
            } else if ((fSignum > 0.0f && f4 == f2) || (fSignum < 0.0f && f4 == 0.0f)) {
                setState(TransitionState.FINISHED);
            }
            if ((!this.mKeepAnimating && this.mInTransition && fSignum > 0.0f && f4 == f2) || (fSignum < 0.0f && f4 == 0.0f)) {
                onNewStateAttachHandlers();
            }
        }
