...
public class MotionController {
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (motionPathsArr[i5].attributes.containsKey(str8)) {
                    ...
                    iArr[i4] = iArr[i4] + motionPathsArr[i5].attributes.get(str8).noOfInterpValues();
                    break;
                }
                i5++;
            }
        ...
        double[][] dArr3 = (double[][]) Array.newInstance((Class<?>) double.class, motionPathsArr.length, this.mInterpolateVariables.length);
        double[] dArr4 = new double[motionPathsArr.length];
        for (int i11 = 0; i11 < motionPathsArr.length; i11++) {
            motionPathsArr[i11].fillStandard(dArr3[i11], this.mInterpolateVariables);
            dArr4[i11] = motionPathsArr[i11].time;
        }
        int i12 = 0;
        while (true) {
        ...
        while (true) {
            ...
            while (i15 < motionPathsArr.length) {
                ...
                if (motionPathsArr[i15].hasCustomData(str10)) {
                    if (dArr6 == null) {
                        double[] dArr7 = new double[motionPathsArr.length];
                        dArr6 = (double[][]) Array.newInstance((Class<?>) double.class, motionPathsArr.length, motionPathsArr[i15].getCustomDataCount(str10));
                        dArr5 = dArr7;
                    }
                    dArr = dArr4;
                    dArr5[i16] = motionPathsArr[i15].time;
                    motionPathsArr[i15].getCustomData(str10, dArr6[i16], 0);
                    i16++;
                } else {
                    dArr = dArr4;
                }
            ...
            i14++;
            this.mSpline[i14] = CurveFit.get(this.mCurveFitType, Arrays.copyOf(dArr5, i16), (double[][]) Arrays.copyOf(dArr6, i16));
            dArr4 = dArr4;
            dArr2 = null;
        }
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i17 = 0; i17 < length; i17++) {
                ...
                dArr8[i17] = motionPathsArr[i17].time;
                dArr9[i17][0] = motionPathsArr[i17].x;
                dArr9[i17][1] = motionPathsArr[i17].y;
            }
            this.mArcSpline = CurveFit.getArc(iArr4, dArr8, dArr9);
        }
