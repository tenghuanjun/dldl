    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (variable != null) {
                ...
                String str3 = str2 + "[p: ";
                String str4 = (this.previous[iIndexOf] != -1 ? str3 + this.mCache.mIndexedVariables[this.variables[this.previous[iIndexOf]]] : str3 + a.i) + ", n: ";
                str = (this.next[iIndexOf] != -1 ? str4 + this.mCache.mIndexedVariables[this.variables[this.next[iIndexOf]]] : str4 + a.i) + "]";
            }
        }
        return str + " }";
    }
