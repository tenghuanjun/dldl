...
public class ConstraintWidget {
    ...
    public void addToSolver(LinearSystem linearSystem) {
        ...
        if (constraintWidget2.horizontalRun.start.resolved && constraintWidget2.horizontalRun.end.resolved && constraintWidget2.verticalRun.start.resolved && constraintWidget2.verticalRun.end.resolved) {
            ...
            linearSystem.addEquality(solverVariableCreateObjectVariable, constraintWidget2.horizontalRun.start.value);
        ...
        if (constraintWidget5 != null) {
            z = constraintWidget5 != null && constraintWidget5.mListDimensionBehaviors[0] == DimensionBehaviour.WRAP_CONTENT;
            ConstraintWidget constraintWidget6 = constraintWidget2.mParent;
            boolean z13 = constraintWidget6 != null && constraintWidget6.mListDimensionBehaviors[1] == DimensionBehaviour.WRAP_CONTENT;
            ...
            if (constraintWidget2.isChainHead(i9)) {
                ((ConstraintWidgetContainer) constraintWidget2.mParent).addChain(constraintWidget2, i9);
                zIsInVerticalChain = true;
            } else {
                zIsInVerticalChain = isInVerticalChain();
            }
            if (!zIsInHorizontalChain && z && constraintWidget2.mVisibility != 8 && constraintWidget2.mLeft.mTarget == null && constraintWidget2.mRight.mTarget == null) {
            ...
            if (!zIsInVerticalChain && z13 && constraintWidget2.mVisibility != 8 && constraintWidget2.mTop.mTarget == null && constraintWidget2.mBottom.mTarget == null && constraintWidget2.mBaseline == null) {
        ...
        boolean z14 = constraintWidget2.mListDimensionBehaviors[0] != DimensionBehaviour.MATCH_CONSTRAINT;
        boolean z15 = constraintWidget2.mListDimensionBehaviors[1] != DimensionBehaviour.MATCH_CONSTRAINT;
        ...
        if (f <= 0.0f || constraintWidget2.mVisibility == 8) {
            ...
            if (constraintWidget2.mListDimensionBehaviors[0] == DimensionBehaviour.MATCH_CONSTRAINT && constraintWidget2.mListDimensionBehaviors[1] == DimensionBehaviour.MATCH_CONSTRAINT && i14 == 3 && i15 == 3) {
                constraintWidget2.setupDimensionRatio(z, z2, z14, z15);
                ...
                int i17 = (int) (constraintWidget2.mResolvedDimensionRatio * constraintWidget2.mHeight);
                ...
                int i18 = (int) (constraintWidget2.mResolvedDimensionRatio * constraintWidget2.mWidth);
        ...
        boolean z16 = z5 && ((i8 = constraintWidget2.mResolvedDimensionRatioSide) == 0 || i8 == -1);
        boolean z17 = constraintWidget2.mListDimensionBehaviors[0] == DimensionBehaviour.WRAP_CONTENT && (constraintWidget2 instanceof ConstraintWidgetContainer);
        if (z17) {
            i16 = 0;
        }
        ...
        if (constraintWidget2.mHorizontalResolution == 2) {
            ...
            solverVariable4 = solverVariableCreateObjectVariable2;
            solverVariable5 = solverVariableCreateObjectVariable;
            applyConstraints(linearSystem, true, z6, z8, constraintWidget2.isTerminalWidget[0], constraintWidget8 != null ? linearSystem.createObjectVariable(constraintWidget8.mLeft) : null, solverVariableCreateObjectVariable6, constraintWidget2.mListDimensionBehaviors[0], z17, constraintWidget2.mLeft, constraintWidget2.mRight, constraintWidget2.mX, i16, constraintWidget2.mMinWidth, constraintWidget2.mMaxDimension[0], constraintWidget2.mHorizontalBiasPercent, z16, z3, z4, z19, i3, i2, constraintWidget2.mMatchConstraintMinWidth, constraintWidget2.mMatchConstraintMaxWidth, constraintWidget2.mMatchConstraintPercentWidth, z18);
            constraintWidget2 = this;
        } else {
            linearSystem.addEquality(solverVariableCreateObjectVariable, constraintWidget2.horizontalRun.start.value);
            linearSystem.addEquality(solverVariableCreateObjectVariable2, constraintWidget2.horizontalRun.end.value);
            if (constraintWidget2.mParent == null || !z || !constraintWidget2.isTerminalWidget[0] || isInHorizontalChain()) {
                z6 = z;
                z7 = z5;
                solverVariable2 = solverVariableCreateObjectVariable4;
                solverVariable3 = solverVariableCreateObjectVariable3;
        ...
        if (z9) {
            boolean z21 = constraintWidget2.mListDimensionBehaviors[i6] == DimensionBehaviour.WRAP_CONTENT && (constraintWidget2 instanceof ConstraintWidgetContainer);
            if (z21) {
                i = 0;
            }
            boolean z22 = z7 && ((i7 = constraintWidget2.mResolvedDimensionRatioSide) == i6 || i7 == -1);
            ConstraintWidget constraintWidget10 = constraintWidget2.mParent;
            SolverVariable solverVariableCreateObjectVariable7 = constraintWidget10 != null ? linearSystem2.createObjectVariable(constraintWidget10.mBottom) : null;
            ConstraintWidget constraintWidget11 = constraintWidget2.mParent;
            SolverVariable solverVariableCreateObjectVariable8 = constraintWidget11 != null ? linearSystem2.createObjectVariable(constraintWidget11.mTop) : null;
            if (constraintWidget2.mBaselineDistance > 0 || constraintWidget2.mVisibility == i5) {
                ...
                if (constraintWidget2.mBaseline.mTarget != null) {
                    linearSystem2.addEquality(solverVariable7, linearSystem2.createObjectVariable(constraintWidget2.mBaseline.mTarget), i4, i5);
                    if (z8) {
                        linearSystem2.addGreaterThan(solverVariableCreateObjectVariable7, linearSystem2.createObjectVariable(constraintWidget2.mBottom), i4, 5);
                    }
                    z10 = false;
                    solverVariable10 = solverVariable8;
                    SolverVariable solverVariable12 = solverVariableCreateObjectVariable8;
                    solverVariable11 = solverVariable9;
                    applyConstraints(linearSystem, false, z8, z6, constraintWidget2.isTerminalWidget[i6], solverVariable12, solverVariableCreateObjectVariable7, constraintWidget2.mListDimensionBehaviors[i6], z21, constraintWidget2.mTop, constraintWidget2.mBottom, constraintWidget2.mY, i, constraintWidget2.mMinHeight, constraintWidget2.mMaxDimension[i6], constraintWidget2.mVerticalBiasPercent, z22, z4, z3, z20, i2, i3, constraintWidget2.mMatchConstraintMinHeight, constraintWidget2.mMatchConstraintMaxHeight, constraintWidget2.mMatchConstraintPercentHeight, z10);
                } else {
                    if (constraintWidget2.mVisibility == i5) {
                        linearSystem2.addEquality(solverVariable7, solverVariable9, i4, i5);
                    }
                    z10 = z18;
                    solverVariable10 = solverVariable8;
                    SolverVariable solverVariable122 = solverVariableCreateObjectVariable8;
                    solverVariable11 = solverVariable9;
                    applyConstraints(linearSystem, false, z8, z6, constraintWidget2.isTerminalWidget[i6], solverVariable122, solverVariableCreateObjectVariable7, constraintWidget2.mListDimensionBehaviors[i6], z21, constraintWidget2.mTop, constraintWidget2.mBottom, constraintWidget2.mY, i, constraintWidget2.mMinHeight, constraintWidget2.mMaxDimension[i6], constraintWidget2.mVerticalBiasPercent, z22, z4, z3, z20, i2, i3, constraintWidget2.mMatchConstraintMinHeight, constraintWidget2.mMatchConstraintMaxHeight, constraintWidget2.mMatchConstraintPercentHeight, z10);
                }
            } else {
                z10 = z18;
                solverVariable10 = solverVariable8;
                SolverVariable solverVariable1222 = solverVariableCreateObjectVariable8;
                solverVariable11 = solverVariable9;
                applyConstraints(linearSystem, false, z8, z6, constraintWidget2.isTerminalWidget[i6], solverVariable1222, solverVariableCreateObjectVariable7, constraintWidget2.mListDimensionBehaviors[i6], z21, constraintWidget2.mTop, constraintWidget2.mBottom, constraintWidget2.mY, i, constraintWidget2.mMinHeight, constraintWidget2.mMaxDimension[i6], constraintWidget2.mVerticalBiasPercent, z22, z4, z3, z20, i2, i3, constraintWidget2.mMatchConstraintMinHeight, constraintWidget2.mMatchConstraintMaxHeight, constraintWidget2.mMatchConstraintPercentHeight, z10);
            }
        } else {
            solverVariable10 = solverVariable8;
            solverVariable11 = solverVariable9;
