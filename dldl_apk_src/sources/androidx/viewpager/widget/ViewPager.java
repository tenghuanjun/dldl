        ...
        if (this.mDecorChildCount > 0) {
            ...
            for (int i3 = 0; i3 < childCount; i3++) {
                ...
                if (layoutParams.isDecor) {
                    ...
                    if (i4 == 1) {
                        width = iMax;
                        iMax = Math.max((width2 - childAt.getMeasuredWidth()) / 2, iMax);
                    } else if (i4 == 3) {
                        width = childAt.getWidth() + iMax;
                    } else if (i4 != 5) {
                        width = iMax;
                    } else {
                        int measuredWidth2 = (width2 - measuredWidth) - childAt.getMeasuredWidth();
