...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (state.isPreLayout() && (i3 = this.mPendingScrollPosition) != -1 && this.mPendingScrollPositionOffset != Integer.MIN_VALUE && (viewFindViewByPosition = findViewByPosition(i3)) != null) {
        ...
        if (this.mAnchorInfo.mLayoutFromEnd) {
            ...
            if (this.mLayoutState.mAvailable > 0) {
                ...
                layoutState4.mExtraFillSpace = i6;
            ...
            if (this.mLayoutState.mAvailable > 0) {
                ...
                layoutState7.mExtraFillSpace = i8;
        ...
        if (getChildCount() > 0) {
            if (this.mShouldReverseLayout ^ this.mStackFromEnd) {
                ...
                int i9 = i2 + iFixLayoutEndGap;
                int i10 = i + iFixLayoutEndGap;
                int iFixLayoutStartGap = fixLayoutStartGap(i9, recycler, state, false);
                i2 = i9 + iFixLayoutStartGap;
                i = i10 + iFixLayoutStartGap;
            } else {
                int iFixLayoutStartGap2 = fixLayoutStartGap(i2, recycler, state, true);
                int i11 = i2 + iFixLayoutStartGap2;
                int i12 = i + iFixLayoutStartGap2;
                int iFixLayoutEndGap2 = fixLayoutEndGap(i12, recycler, state, false);
                i2 = i11 + iFixLayoutEndGap2;
                i = i12 + iFixLayoutEndGap2;
            }
        }
