        ...
        switch (actionMasked) {
            ...
            case 2:
                ...
                if (this.mScrollState == 1) {
                    ...
                    iArr3[0] = 0;
                    iArr3[1] = 0;
                    if (dispatchNestedPreScroll(zCanScrollHorizontally ? i : 0, zCanScrollVertically ? i2 : 0, this.mReusableIntPair, this.mScrollOffset, 0)) {
                        int[] iArr4 = this.mReusableIntPair;
                        i -= iArr4[0];
                        int i5 = i2 - iArr4[1];
                    ...
                    if (scrollByInternal(zCanScrollHorizontally ? i : 0, zCanScrollVertically ? i3 : 0, motionEvent)) {
                        getParent().requestDisallowInterceptTouchEvent(true);
                    }
                    if (this.mGapWorker != null && (i != 0 || i3 != 0)) {
                        this.mGapWorker.postFromTraversal(this, i, i3);
                    }
                }
                break;
                break;
    ...
    */
    ...
    class ViewFlinger implements Runnable {
        ...
        public void smoothScrollBy(int i, int i2, int i3, @Nullable Interpolator interpolator) {
            int iComputeScrollDuration = i3 == Integer.MIN_VALUE ? computeScrollDuration(i, i2, 0, 0) : i3;
        ...
        */
        ...
        private int[] getChildRectangleOnScreenScrollAmount(View view, Rect rect) {
            ...
            if (getLayoutDirection() != 1) {
                iMax = iMin != 0 ? iMin : Math.min(i, iMax);
            } else if (iMax == 0) {
        ...
        public boolean performAccessibilityAction(@NonNull Recycler recycler, @NonNull State state, int i, @Nullable Bundle bundle) {
            ...
            this.mRecyclerView.smoothScrollBy(width, i2, null, Integer.MIN_VALUE, true);
            return true;
        }
