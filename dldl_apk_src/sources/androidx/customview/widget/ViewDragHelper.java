...
public class ViewDragHelper {
    ...
    */
    ...
    private void dragTo(int i, int i2, int i3, int i4) {
        ...
        int top = this.mCapturedView.getTop();
        if (i3 != 0) {
            int iClampViewPositionHorizontal = this.mCallback.clampViewPositionHorizontal(this.mCapturedView, i, i3);
            ViewCompat.offsetLeftAndRight(this.mCapturedView, iClampViewPositionHorizontal - left);
            i5 = iClampViewPositionHorizontal;
        } else {
            i5 = i;
        }
        if (i4 != 0) {
            int iClampViewPositionVertical = this.mCallback.clampViewPositionVertical(this.mCapturedView, i2, i4);
            ViewCompat.offsetTopAndBottom(this.mCapturedView, iClampViewPositionVertical - top);
            i6 = iClampViewPositionVertical;
        } else {
            i6 = i2;
        }
        if (i3 == 0 && i4 == 0) {
