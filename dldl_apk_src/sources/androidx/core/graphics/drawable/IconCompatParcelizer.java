...
public class IconCompatParcelizer {
    public static android.support.v4.graphics.drawable.IconCompat read(VersionedParcel versionedParcel) {
    ...
    public static void write(android.support.v4.graphics.drawable.IconCompat iconCompat, VersionedParcel versionedParcel) {
