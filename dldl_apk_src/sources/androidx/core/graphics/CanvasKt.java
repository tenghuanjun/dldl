...
public final class CanvasKt {
    ...
    public static final void withScale(@NotNull Canvas withScale, float f, float f2, float f3, float f4, @NotNull Function1<? super Canvas, Unit> block) {
        Intrinsics.checkParameterIsNotNull(withScale, "$this$withScale");
        Intrinsics.checkParameterIsNotNull(block, "block");
        int iSave = withScale.save();
        withScale.scale(f, f2, f3, f4);
    ...
    public static final void withSkew(@NotNull Canvas withSkew, float f, float f2, @NotNull Function1<? super Canvas, Unit> block) {
        Intrinsics.checkParameterIsNotNull(withSkew, "$this$withSkew");
        Intrinsics.checkParameterIsNotNull(block, "block");
        int iSave = withSkew.save();
        withSkew.skew(f, f2);
    ...
    public static final void withClip(@NotNull Canvas withClip, int i, int i2, int i3, int i4, @NotNull Function1<? super Canvas, Unit> block) {
        Intrinsics.checkParameterIsNotNull(withClip, "$this$withClip");
        Intrinsics.checkParameterIsNotNull(block, "block");
        int iSave = withClip.save();
    ...
    public static final void withClip(@NotNull Canvas withClip, float f, float f2, float f3, float f4, @NotNull Function1<? super Canvas, Unit> block) {
        Intrinsics.checkParameterIsNotNull(withClip, "$this$withClip");
        Intrinsics.checkParameterIsNotNull(block, "block");
        int iSave = withClip.save();
