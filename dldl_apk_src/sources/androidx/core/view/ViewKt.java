...
public final class ViewKt {
    ...
    @RequiresApi(17)
    public static final void updatePaddingRelative(@NotNull View updatePaddingRelative, @Px int i, @Px int i2, @Px int i3, @Px int i4) {
        Intrinsics.checkParameterIsNotNull(updatePaddingRelative, "$this$updatePaddingRelative");
        updatePaddingRelative.setPaddingRelative(i, i2, i3, i4);
    }
    ...
    @RequiresApi(16)
    @NotNull
    public static final Runnable postOnAnimationDelayed(@NotNull View postOnAnimationDelayed, long j, @NotNull final Function0<Unit> action) {
    ...
    public static final /* synthetic */ <T extends ViewGroup.LayoutParams> void updateLayoutParamsTyped(@NotNull View updateLayoutParams, @NotNull Function1<? super T, Unit> block) {
