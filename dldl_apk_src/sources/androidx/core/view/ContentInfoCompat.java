...
public final class ContentInfoCompat {
    ...
    ContentInfoCompat(Builder builder) {
        ...
        this.mSource = Preconditions.checkArgumentInRange(builder.mSource, 0, 3, SocialConstants.PARAM_SOURCE);
    ...
    public String toString() {
        return "ContentInfoCompat{clip=" + this.mClip + ", source=" + sourceToString(this.mSource) + ", flags=" + flagsToString(this.mFlags) + ", linkUri=" + this.mLinkUri + ", extras=" + this.mExtras + i.d;
    }
