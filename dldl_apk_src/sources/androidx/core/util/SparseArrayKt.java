...
public final class SparseArrayKt {
    ...
    public static final <T> T getOrElse(@NotNull SparseArray<T> getOrElse, int i, @NotNull Function0<? extends T> defaultValue) {
    ...
    public static final class C01251<T> implements Iterator<T>, KMappedMarker {
        ...
        C01251(SparseArray<T> sparseArray) {
    ...
    public static final <T> Iterator<T> valueIterator(@NotNull SparseArray<T> valueIterator) {
        ...
        return new C01251(valueIterator);
    }
