...
public class ContextCompat {
    ...
    private static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            SERVICES.put(ActivityManager.class, TTDownloadField.TT_ACTIVITY);
            ...
            SERVICES.put(NotificationManager.class, b.l);
            SERVICES.put(PowerManager.class, "power");
            SERVICES.put(SearchManager.class, BaseConstants.MARKET_URI_AUTHORITY_SEARCH);
            SERVICES.put(SensorManager.class, BlobManager.BLOB_ELEM_TYPE_SENSOR);
