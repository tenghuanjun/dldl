...
public final class TypedArrayKt {
    ...
    public static final boolean getBooleanOrThrow(@NotNull TypedArray getBooleanOrThrow, @StyleableRes int i) {
    ...
    @ColorInt
    public static final int getColorOrThrow(@NotNull TypedArray getColorOrThrow, @StyleableRes int i) {
    ...
    @NotNull
    public static final ColorStateList getColorStateListOrThrow(@NotNull TypedArray getColorStateListOrThrow, @StyleableRes int i) {
    ...
    public static final float getDimensionOrThrow(@NotNull TypedArray getDimensionOrThrow, @StyleableRes int i) {
    ...
    @Dimension
    public static final int getDimensionPixelOffsetOrThrow(@NotNull TypedArray getDimensionPixelOffsetOrThrow, @StyleableRes int i) {
    ...
    @Dimension
    public static final int getDimensionPixelSizeOrThrow(@NotNull TypedArray getDimensionPixelSizeOrThrow, @StyleableRes int i) {
    ...
    @NotNull
    public static final Drawable getDrawableOrThrow(@NotNull TypedArray getDrawableOrThrow, @StyleableRes int i) {
    ...
    public static final float getFloatOrThrow(@NotNull TypedArray getFloatOrThrow, @StyleableRes int i) {
    ...
    @RequiresApi(26)
    @NotNull
    public static final Typeface getFontOrThrow(@NotNull TypedArray getFontOrThrow, @StyleableRes int i) {
    ...
    public static final int getIntOrThrow(@NotNull TypedArray getIntOrThrow, @StyleableRes int i) {
    ...
    public static final int getIntegerOrThrow(@NotNull TypedArray getIntegerOrThrow, @StyleableRes int i) {
    ...
    @AnyRes
    public static final int getResourceIdOrThrow(@NotNull TypedArray getResourceIdOrThrow, @StyleableRes int i) {
    ...
    @NotNull
    public static final String getStringOrThrow(@NotNull TypedArray getStringOrThrow, @StyleableRes int i) {
    ...
    @NotNull
    public static final CharSequence getTextOrThrow(@NotNull TypedArray getTextOrThrow, @StyleableRes int i) {
    ...
    @NotNull
    public static final CharSequence[] getTextArrayOrThrow(@NotNull TypedArray getTextArrayOrThrow, @StyleableRes int i) {
