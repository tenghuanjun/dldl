...
public final class SpannableStringBuilderKt {
    ...
    @NotNull
    public static final SpannableStringBuilder color(@NotNull SpannableStringBuilder color, @ColorInt int i, @NotNull Function1<? super SpannableStringBuilder, Unit> builderAction) {
    ...
    @NotNull
    public static final SpannableStringBuilder backgroundColor(@NotNull SpannableStringBuilder backgroundColor, @ColorInt int i, @NotNull Function1<? super SpannableStringBuilder, Unit> builderAction) {
    ...
    @NotNull
    public static final SpannableStringBuilder scale(@NotNull SpannableStringBuilder scale, float f, @NotNull Function1<? super SpannableStringBuilder, Unit> builderAction) {
