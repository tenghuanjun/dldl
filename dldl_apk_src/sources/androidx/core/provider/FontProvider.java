...
class FontProvider {
    ...
    static FontsContractCompat.FontInfo[] query(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) {
        ...
        try {
            String[] strArr = {DBDefinition.ID, "file_id", "font_ttc_index", "font_variation_settings", "font_weight", "font_italic", "result_code"};
            ...
            if (cursorQuery != null && cursorQuery.getCount() > 0) {
                ...
                while (cursorQuery.moveToNext()) {
                    ...
                    arrayList2.add(FontsContractCompat.FontInfo.create(uriWithAppendedId, i4, columnIndex5 != -1 ? cursorQuery.getInt(columnIndex5) : 400, columnIndex6 != -1 && cursorQuery.getInt(columnIndex6) == 1, i2));
                }
