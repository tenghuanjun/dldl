...
final class MultiDexExtractor implements Closeable {
    ...
    private static boolean isModified(Context context, File archive, long currentCrc, String prefsKeyPrefix) {
        ...
        if (prefs.getLong(prefsKeyPrefix + "timestamp", -1L) == getTimeStamp(archive)) {
        ...
        try {
            ...
            while (dexFile != null) {
                ...
                while (numAttempts < 3 && !isExtractionSuccessful) {
                    ...
                    sb.append(isExtractionSuccessful ? "succeeded" : e.a);
                    sb.append(" '");
    ...
    private void clearDexDir() {
        File[] files = this.dexDir.listFiles(new FileFilter() { // from class: android.support.multidex.MultiDexExtractor.1
