    ...
    public int indexOf(Object element) {
        ...
        for (int i2 = 0; i2 < iPositiveMod; i2++) {
            if (Intrinsics.areEqual(element, this.elementData[i2])) {
                return (i2 + this.elementData.length) - this.head;
            }
        }
        return -1;
    }
