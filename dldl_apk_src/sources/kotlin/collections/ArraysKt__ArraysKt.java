        ...
        for (int i = 0; i < length; i++) {
            ...
            if (objArr != objArr2) {
                ...
                if ((objArr instanceof Object[]) && (objArr2 instanceof Object[])) {
                    ...
                    if (!kotlin.collections.unsigned.UArraysKt.m434contentEqualskdPth3s(((UByteArray) objArr).getStorage(), ((UByteArray) objArr2).getStorage())) {
                        return false;
                    }
                } else if ((objArr instanceof UShortArray) && (objArr2 instanceof UShortArray)) {
                    if (!kotlin.collections.unsigned.UArraysKt.m435contentEqualsmazbYpA(((UShortArray) objArr).getStorage(), ((UShortArray) objArr2).getStorage())) {
                        return false;
                    }
                } else if ((objArr instanceof UIntArray) && (objArr2 instanceof UIntArray)) {
                    if (!kotlin.collections.unsigned.UArraysKt.m433contentEqualsctEhBpI(((UIntArray) objArr).getStorage(), ((UIntArray) objArr2).getStorage())) {
                        return false;
                    }
                } else if ((objArr instanceof ULongArray) && (objArr2 instanceof ULongArray)) {
                    if (!kotlin.collections.unsigned.UArraysKt.m436contentEqualsus8wMrg(((ULongArray) objArr).getStorage(), ((ULongArray) objArr2).getStorage())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(@NotNull T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (objArr == 0) {
                ...
                sb.append(kotlin.collections.unsigned.UArraysKt.m442contentToStringGBYM_sE(((UByteArray) objArr).getStorage()));
            } else if (objArr instanceof UShortArray) {
                sb.append(kotlin.collections.unsigned.UArraysKt.m444contentToStringrL5Bavg(((UShortArray) objArr).getStorage()));
            } else if (objArr instanceof UIntArray) {
                sb.append(kotlin.collections.unsigned.UArraysKt.m441contentToStringajY9A(((UIntArray) objArr).getStorage()));
            } else if (objArr instanceof ULongArray) {
                sb.append(kotlin.collections.unsigned.UArraysKt.m443contentToStringQwZRm1k(((ULongArray) objArr).getStorage()));
            } else {
