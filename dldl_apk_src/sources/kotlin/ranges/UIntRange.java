...
public final class UIntRange extends UIntProgression implements ClosedRange<UInt> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m927containsWZ4Q5Ns(((UInt) comparable).getData());
    }

    @Override // kotlin.ranges.ClosedRange
    @NotNull
    public UInt getStart() {
        return UInt.m97boximpl(getFirst());
    }

    @Override // kotlin.ranges.ClosedRange
    @NotNull
    public UInt getEndInclusive() {
        return UInt.m97boximpl(getLast());
    }

    /* JADX INFO: renamed from: contains-WZ4Q5Ns, reason: not valid java name */
    public boolean m927containsWZ4Q5Ns(int value) {
    ...
    public String toString() {
        return UInt.m140toStringimpl(getFirst()) + ".." + UInt.m140toStringimpl(getLast());
    }
