...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m929containsVKZWuLQ(((ULong) comparable).getData());
    }

    @Override // kotlin.ranges.ClosedRange
    @NotNull
    public ULong getStart() {
        return ULong.m166boximpl(getFirst());
    }

    @Override // kotlin.ranges.ClosedRange
    @NotNull
    public ULong getEndInclusive() {
        return ULong.m166boximpl(getLast());
    }

    /* JADX INFO: renamed from: contains-VKZWuLQ, reason: not valid java name */
    public boolean m929containsVKZWuLQ(long value) {
    ...
    public int hashCode() {
        ...
        return (((int) ULong.m172constructorimpl(getFirst() ^ ULong.m172constructorimpl(getFirst() >>> 32))) * 31) + ((int) ULong.m172constructorimpl(getLast() ^ ULong.m172constructorimpl(getLast() >>> 32)));
    }

    @Override // kotlin.ranges.ULongProgression
    @NotNull
    public String toString() {
        return ULong.m209toStringimpl(getFirst()) + ".." + ULong.m209toStringimpl(getLast());
    }
