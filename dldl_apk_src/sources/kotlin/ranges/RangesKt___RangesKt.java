...
public class RangesKt___RangesKt extends RangesKt__RangesKt {
    ...
    public static final Byte toByteExactOrNull(long j) {
        long j2 = -128;
        long j3 = TTDownloadField.CALL_DOWNLOAD_MODEL_SET_EXTRA_VALUE;
        if (j2 <= j && j3 >= j) {
    ...
    public static final Byte toByteExactOrNull(short s) {
        short s2 = (short) (-128);
        short s3 = (short) TTDownloadField.CALL_DOWNLOAD_MODEL_SET_EXTRA_VALUE;
        if (s2 <= s && s3 >= s) {
    ...
    public static final Byte toByteExactOrNull(double d) {
        double d2 = -128;
        double d3 = TTDownloadField.CALL_DOWNLOAD_MODEL_SET_EXTRA_VALUE;
        if (d < d2 || d > d3) {
            return null;
        }
    ...
    public static final Byte toByteExactOrNull(float f) {
        float f2 = -128;
        float f3 = TTDownloadField.CALL_DOWNLOAD_MODEL_SET_EXTRA_VALUE;
        if (f < f2 || f > f3) {
            return null;
        }
