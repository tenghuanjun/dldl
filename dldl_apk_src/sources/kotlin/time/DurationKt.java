...
public final class DurationKt {
    ...
    private static final double m1016timesmvk6XK0(int i, double d) {
        return Duration.m998timesimpl(d, i);
    }
    ...
    private static final double m1015timeskIfJnKk(double d, double d2) {
        return Duration.m997timesimpl(d2, d);
    }
    ...
    public static final double toDuration(double d, @NotNull TimeUnit unit) {
        Intrinsics.checkParameterIsNotNull(unit, "unit");
        return Duration.m971constructorimpl(DurationUnitKt.convertDurationUnit(d, unit, TimeUnit.NANOSECONDS));
    }
}
