...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    @NotNull
    public static final File copyTo(@NotNull File copyTo, @NotNull File target, boolean z, int i) throws IOException {
    ...
    public static final boolean copyRecursively(@NotNull File copyRecursively, @NotNull File target, boolean z, @NotNull final Function2<? super File, ? super IOException, ? extends OnErrorAction> onError) {
        boolean z2;
        ...
        try {
            for (File file : FilesKt.walkTopDown(copyRecursively).onFail(new Function2<File, IOException, Unit>() { // from class: kotlin.io.FilesKt__UtilsKt.copyRecursively.2
                ...
                public final void invoke2(@NotNull File f, @NotNull IOException e) throws TerminateException {
