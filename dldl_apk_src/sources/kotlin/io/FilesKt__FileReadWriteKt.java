...
class FilesKt__FileReadWriteKt extends FilesKt__FilePathComponentsKt {
    ...
    @NotNull
    public static final byte[] readBytes(@NotNull File readBytes) throws IOException {
    ...
    public static final void writeBytes(@NotNull File writeBytes, @NotNull byte[] array) throws IOException {
    ...
    public static final void appendBytes(@NotNull File appendBytes, @NotNull byte[] array) throws IOException {
    ...
    @NotNull
    public static final String readText(@NotNull File readText, @NotNull Charset charset) throws IOException {
    ...
    public static final void forEachBlock(@NotNull File forEachBlock, int i, @NotNull Function2<? super byte[], ? super Integer, Unit> action) throws IOException {
        Intrinsics.checkParameterIsNotNull(forEachBlock, "$this$forEachBlock");
        Intrinsics.checkParameterIsNotNull(action, "action");
    ...
    public static final void forEachLine(@NotNull File forEachLine, @NotNull Charset charset, @NotNull Function1<? super String, Unit> action) throws IOException {
