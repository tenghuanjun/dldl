...
public final class d {
    ...
    */
    private static byte[] a(int r7, byte[] r8, byte[] r9) throws javax.crypto.NoSuchPaddingException, java.security.NoSuchAlgorithmException, java.security.InvalidKeyException {
        /*
            if (r8 == 0) goto L61
            int r0 = r8.length
            r1 = 24
