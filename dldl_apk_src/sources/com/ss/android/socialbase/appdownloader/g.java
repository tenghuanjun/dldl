...
public final class g {
    ...
    private static a a(PackageManager packageManager, PackageInfo packageInfo) {
        ...
        return new a(str, string, drawableLoadIcon, applicationInfo.sourceDir, packageInfo.versionName, packageInfo.versionCode, (applicationInfo.flags & 1) != 0);
    }
    ...
    public static class a {
        ...
        public String toString() {
            return "{\n  pkg name: " + c() + "\n  app icon: " + a() + "\n  app name: " + d() + "\n  app path: " + e() + "\n  app v name: " + g() + "\n  app v code: " + f() + "\n  is system: " + b() + com.alipay.sdk.util.i.d;
        }
    }
