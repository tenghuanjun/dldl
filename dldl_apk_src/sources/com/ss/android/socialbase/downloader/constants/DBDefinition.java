...
public interface DBDefinition {
    ...
    public static final String[] CHUNK_ALL_COLUMNS = {ID, CHUNK_INDEX, START_OFFSET, CUR_OFFSET, END_OFFSET, CHUNK_CONTENT_LEN, HOST_CHUNK_INDEX};
    public static final String[] CHUNK_PK_COLUMNS = {ID};
