...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    private String getTokenFromWX(Context context) {
        Cursor cursorQuery = context.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.comm.provider/genTokenForOpenSdk"), null, null, new String[]{this.appId, "621086720"}, null);
    ...
    private boolean sendOpenBusinessView(Context context, BaseReq baseReq) {
        ...
        Cursor cursorQuery = context.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.comm.provider/openBusinessView"), null, null, new String[]{this.appId, req.businessType, req.query, req.extInfo, req.transaction}, null);
        if (cursorQuery != null) {
            cursorQuery.close();
        }
        return true;
    ...
    public boolean registerApp(String str, long j) {
        ...
        c0112a.a = "com.tencent.mm";
        c0112a.action = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c0112a.content = "weixin://registerapp?appid=" + this.appId;
        c0112a.b = j;
        return a.a(this.context, c0112a);
    }
    ...
    */
    ...
    public void unregisterApp() {
        ...
        a.C0112a c0112a = new a.C0112a();
        c0112a.a = "com.tencent.mm";
        c0112a.action = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c0112a.content = "weixin://unregisterapp?appid=" + this.appId;
        a.a(this.context, c0112a);
    }
}
