...
public class c extends com.tencent.open.b implements a.InterfaceC0117a {
    ...
    public c(Context context, String str, String str2, IUiListener iUiListener, QQToken qQToken) {
        ...
        this.d = str2;
        this.f = new C0116c(context, str, str2, qQToken.getAppId(), iUiListener);
    ...
    private class d extends Handler {
        ...
        public d(C0116c c0116c, Looper looper) {
            super(looper);
            this.b = c0116c;
        }
    ...
    /* JADX INFO: compiled from: ProGuard */
    private static class C0116c extends DefaultUiListener {
        String a;
        String b;
        ...
        public C0116c(Context context, String str, String str2, String str3, IUiListener iUiListener) {
