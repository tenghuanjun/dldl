...
public class a {
    ...
    public static class C0113a {
        ...
        public C0113a(WebView webView, long j, String str) {
    ...
    public static class b {
        ...
        public void call(String str, List<String> list, C0113a c0113a) {
            Method method;
            Object objInvoke;
            ...
            try {
                ...
                if (!"void".equals(returnType.getName()) && returnType != Void.class) {
                    if (c0113a == null || !customCallback()) {
                        return;
                    }
                    c0113a.a(objInvoke != null ? objInvoke.toString() : null);
                    return;
                }
                if (c0113a != null) {
                    c0113a.a((Object) null);
                }
            } catch (Exception e) {
    ...
    public void a(String str, String str2, List<String> list, C0113a c0113a) {
    ...
    public boolean a(WebView webView, String str) {
        ...
        C0113a c0113a = new C0113a(webView, 4L, str);
        webView.getUrl();
        a(str2, str3, listSubList, c0113a);
        return true;
    }
}
