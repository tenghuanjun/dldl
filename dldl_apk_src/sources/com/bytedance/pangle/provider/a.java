...
public class a {
    ...
    private static Uri a(String str, Uri uri, String str2) {
        ...
        return Uri.parse("content://" + ContentProviderManager.getInstance().getSystemProviderInfoMap().get(pluginProcessNameByAuthority).b + File.separator + "proxy?provider_params=" + strEncodeToString);
    }
