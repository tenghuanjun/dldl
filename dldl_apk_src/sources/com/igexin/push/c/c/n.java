...
public class n extends c {
    ...
    private static final String j = "com.igexin.push.c.c.n";
    public int b;
    public int c;
    public long d;
    public String e;
    ...
    public final byte[] b() {
        ...
        try {
            ...
            if (length > 0) {
                iA2 += com.igexin.b.a.b.g.a(bytes3, 0, bArr, iA2, length);
            }
            ...
            com.igexin.b.a.b.g.a(bytes2, 0, bArr, iA3 + 1, bytes2.length);
        } catch (Exception unused) {
        }
        return bArr;
    }
