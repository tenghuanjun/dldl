...
public class WebViewToolBar extends LinearLayout {
    ...
    private void initView() {
        this.ivBackBar = (ImageView) this.rootView.findViewById(SqResUtils.getIdByName("iv_back_bar", "id", this.mContext));
        this.ivForwardBar = (ImageView) this.rootView.findViewById(SqResUtils.getIdByName("iv_forward_bar", "id", this.mContext));
        this.ivRefreshBar = (ImageView) this.rootView.findViewById(SqResUtils.getIdByName("iv_refresh_bar", "id", this.mContext));
        this.ivCloseBar = (ImageView) this.rootView.findViewById(SqResUtils.getIdByName("iv_close_bar", "id", this.mContext));
        this.backBar = this.rootView.findViewById(SqResUtils.getIdByName("web_back_bar", "id", this.mContext));
        this.forwardBar = this.rootView.findViewById(SqResUtils.getIdByName("web_forward_bar", "id", this.mContext));
        this.refreshBar = this.rootView.findViewById(SqResUtils.getIdByName("web_refresh_bar", "id", this.mContext));
        this.closeBar = this.rootView.findViewById(SqResUtils.getIdByName("web_close_bar", "id", this.mContext));
        this.backBar.setOnClickListener(new View.OnClickListener() { // from class: com.host.WebViewToolBar.1
        ...
        this.forwardBar.setOnClickListener(new View.OnClickListener() { // from class: com.host.WebViewToolBar.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (WebViewToolBar.this.mToolBarClickListener != null) {
        ...
        this.refreshBar.setOnClickListener(new View.OnClickListener() { // from class: com.host.WebViewToolBar.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (WebViewToolBar.this.mToolBarClickListener != null) {
        ...
        this.closeBar.setOnClickListener(new View.OnClickListener() { // from class: com.host.WebViewToolBar.4
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (WebViewToolBar.this.mToolBarClickListener != null) {
