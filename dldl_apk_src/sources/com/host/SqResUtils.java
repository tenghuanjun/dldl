...
public class SqResUtils {
    ...
    private static final String TAG = "SqResUtils";
    ...
    public static int getLayoutId(Context context, String str) {
        return getIdentifier(context, str, TYPE_LAYOUT, context.getPackageName());
    }
    ...
    public static int getColorId(Context context, String str) {
        return getIdentifier(context, str, TYPE_COLOR, context.getPackageName());
    }
    ...
    public static int getMenuId(Context context, String str) {
        return getIdentifier(context, str, TYPE_MENU, context.getPackageName());
    }
    ...
    public static int getIdByName(String str, String str2, Context context) {
        try {
            ...
            e.printStackTrace();
            Log.e(TAG, " TYPE:" + str2 + ",RES:" + str + " NOT FOUND!");
            return 0;
        }
    }
