...
public class PluginMultiSdkManager {
    ...
    public void initMultiSdk(Context context) throws Throwable {
        ...
        this.mSkin = properties.getProperty(PRO_KEY_SKIN);
        this.mConfig = properties.getProperty("config");
        ...
        this.mDefaultPlugin = properties.getProperty(PRO_KEY_PLUGIN);
        this.mDefaultPluginVersion = Integer.parseInt(properties.getProperty(PRO_KEY_PLUGIN_VERSION) == null ? "0" : properties.getProperty(PRO_KEY_PLUGIN_VERSION));
        PluginLog.i("multi_sdk config: skin:" + this.mSkin + ", config:" + this.mConfig + ", info:" + this.mInfo + ", host:" + this.mHost + ", tag:" + this.mTag + ", accountDir:" + this.mAccountDir + ", accountFile:" + this.mAccountFile + ", scut3:" + this.mScut3 + ", defaultPlugin: " + this.mDefaultPlugin + ", defaultPluginVersion: " + this.mDefaultPluginVersion);
    }
    ...
    */
    private java.util.Properties readProperties(android.content.Context r4) throws java.lang.Throwable {
        ...
        L46:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.plugin.core.PluginMultiSdkManager.readProperties(android.content.Context):java.util.Properties");
    }
