...
public class j extends g implements WebViewWindow.a, WebViewWindow.b, WebViewWindow.c {
    ...
    public boolean a(WebViewWindow webViewWindow, SslErrorHandler sslErrorHandler, SslError sslError) {
        com.alipay.sdk.app.statistic.a.a(com.alipay.sdk.app.statistic.c.a, com.alipay.sdk.app.statistic.c.r, "2-" + sslError);
        if (this.w) {
    ...
    private void b(String str) {
        ...
        if (str.startsWith(i)) {
            a(mapC.get("func"), mapC.get("cbId"), mapC.get(com.alipay.sdk.packet.e.k));
            return;
        }
        if (str.startsWith(c)) {
            e();
        ...
        if (str.startsWith(f) && mapC.containsKey("bshow")) {
            this.x.getBackButton().setVisibility(TextUtils.equals(ZIMFacade.ZIM_EXT_PARAMS_VAL_USE_VIDEO_TRUE, mapC.get("bshow")) ? 0 : 4);
        } else if (str.startsWith(g)) {
            com.alipay.sdk.app.j.a(mapC.get("result"));
            a(TextUtils.equals(ZIMFacade.ZIM_EXT_PARAMS_VAL_USE_VIDEO_TRUE, mapC.get("bsucc")));
    ...
    private void a(String str, String str2, String str3) {
        ...
        if (m.equals(str)) {
            this.x.getBackButton().setVisibility(jSONObjectD.optBoolean("show", true) ? 0 : 4);
            return;
        }
        if (n.equals(str)) {
            this.x.getRefreshButton().setVisibility(jSONObjectD.optBoolean("show", true) ? 0 : 4);
        } else {
