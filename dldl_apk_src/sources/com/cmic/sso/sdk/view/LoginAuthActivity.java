...
public class LoginAuthActivity extends Activity implements View.OnClickListener {
    ...
    private static class b extends n.a {
        ...
        protected void a() {
            ...
            loginAuthActivity.m.a(LayaConch5.MARKET_LOGINTYPE, 1);
            com.mobile.auth.n.h.a(true, false);
            loginAuthActivity.n.b(loginAuthActivity.m, new com.mobile.auth.g.d() { // from class: com.cmic.sso.sdk.view.LoginAuthActivity.b.1
    ...
    public void a(String str, String str2, com.cmic.sso.sdk.a aVar, JSONObject jSONObject) {
        ...
        try {
            ...
            if ("103000".equals(str)) {
                ...
                aVarA = com.mobile.auth.g.a.a(this);
            } else {
    ...
    private void d() {
        String str;
        com.cmic.sso.sdk.a aVarD = com.mobile.auth.n.e.d(getIntent().getStringExtra("traceId"));
        this.m = aVarD;
        if (aVarD == null) {
        ...
        com.mobile.auth.n.c.b(a, "mSecurityPhone value is " + this.o);
        String strB = this.m.b("operatortype", "");
        com.mobile.auth.n.c.b(a, "operator value is " + strB);
        if (this.A.ap() == 1) {
        ...
        if (strB.equals("1")) {
            ...
            this.y = this.l[1];
            str = com.mobile.auth.gatewayauth.Constant.CTCC_PROTOCOL_URL;
        } else {
            this.y = this.l[2];
    ...
    private void e() {
        ...
        if (this.A.p() > 0 || this.A.q() < 0) {
            ...
            if (this.A.p() <= 0 || (this.B - this.r.getMeasuredHeight()) - i.a(this.c, this.A.p()) <= 0) {
                ...
                com.mobile.auth.n.c.b(a, "numberField_top");
        ...
        if (this.A.ab() > 0 || this.A.ac() < 0) {
            if (this.A.ab() <= 0 || (this.B - this.q.getMeasuredHeight()) - i.a(this.c, this.A.ab()) <= 0) {
                com.mobile.auth.n.c.b(a, "privacy_bottom=" + iZ);
                layoutParams3.addRule(12, -1);
                layoutParams3.setMargins(i.a(this.c, (float) iZ), 0, i.a(this.c, (float) iMax3), 0);
            } else {
                com.mobile.auth.n.c.b(a, "privacy_top = " + this.q.getMeasuredHeight());
            ...
            com.mobile.auth.n.c.b(a, "privacy_bottom=" + this.q.getMeasuredHeight());
            layoutParams3.addRule(12, -1);
    ...
    private void f() {
        ...
        com.mobile.auth.n.c.b(a, "orientation = " + requestedOrientation + "--screenWidth = " + this.C + "--screenHeight = " + this.B);
        ...
        try {
            ...
            com.cmic.sso.sdk.d.c.b.add(e);
            e.printStackTrace();
            com.mobile.auth.n.c.a(a, e.toString());
    ...
    */
    private void g() {
        /*
            ...
            r1 = 15
            r0.setGravity(r1)
            com.cmic.sso.sdk.view.a r1 = r6.A
            int r1 = r1.o()
            r3 = 0
            if (r1 != 0) goto L36
            r1 = 13
        ...
        L36:
            ...
            float r1 = (float) r1
            int r5 = com.cmic.sso.sdk.view.i.a(r5, r1)
            int r4 = r4 - r5
            if (r4 <= 0) goto L53
            android.content.Context r4 = r6.c
            int r1 = com.cmic.sso.sdk.view.i.a(r4, r1)
            r2.setMargins(r1, r3, r3, r3)
            goto L5d
        L53:
            java.lang.String r1 = com.cmic.sso.sdk.view.LoginAuthActivity.a
            java.lang.String r4 = "RelativeLayout.ALIGN_PARENT_RIGHT"
            com.mobile.auth.n.c.b(r1, r4)
            r1 = 11
            goto L32
        L5d:
            r1 = 2
        ...
        L9a:
            ...
            android.widget.RelativeLayout r1 = r6.r
            r1.measure(r0, r0)
            java.lang.String r0 = com.cmic.sso.sdk.view.LoginAuthActivity.a
    ...
    private String j() {
        ...
        if (this.z.contains(AuthThemeConfig.PLACEHOLDER)) {
            this.z = this.z.replace(AuthThemeConfig.PLACEHOLDER, this.y);
        }
        return this.z;
    }
    ...
    private void m() {
        try {
            ...
            if (!TextUtils.isEmpty(strB) && com.mobile.auth.n.e.a(strB)) {
                String strC = q.c();
                this.m.a("traceId", strC);
                com.mobile.auth.n.e.a(strC, this.v);
            }
            b();
            l();
            c cVar = new c(this.m);
            this.b.postDelayed(cVar, com.mobile.auth.g.a.a(this).c());
            n.a(new b(this, cVar));
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    protected void onCreate(Bundle bundle) {
        try {
            ...
            this.c = this;
            com.cmic.sso.sdk.view.a aVarA = com.mobile.auth.g.a.a(this).a();
            this.A = aVarA;
            if (aVarA != null) {
                if (aVarA.ao() != -1) {
                    setTheme(this.A.ao());
