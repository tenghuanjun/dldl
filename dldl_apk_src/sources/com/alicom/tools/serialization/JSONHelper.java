    ...
    private static final class ParameterizedTypeImpl implements Serializable, ParameterizedType {
        ...
        public ParameterizedTypeImpl(Type type, Type type2, Type... typeArr) {
            ...
            for (int i = 0; i < length; i++) {
                JSONPreconditions.checkNotNull(this.typeArguments[i]);
                JSONHelper.checkNotPrimitive(this.typeArguments[i]);
        ...
        public String toString() {
            ...
            sb.append(JSONHelper.typeToString(this.rawType));
            sb.append("<");
            sb.append(JSONHelper.typeToString(this.typeArguments[0]));
            for (int i = 1; i < length; i++) {
                sb.append(", ");
                sb.append(JSONHelper.typeToString(this.typeArguments[i]));
            }
            sb.append(">");
            return sb.toString();
        }
