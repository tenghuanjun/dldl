...
public class OSSLogToFileUtils {
    ...
    private Uri queryLogUri() {
        ...
        Cursor cursorQuery = contentResolver.query(contentUri, new String[]{DBDefinition.ID}, "relative_path like ? AND _display_name=?", new String[]{"Documents/OSSLog%", "logs.csv"}, null);
