...
public class e {
    ...
    protected class a implements Runnable {
        ...
        public void run() {
            ...
            e.this.a(jSONObjectA.optString(Constant.KEY_RESULT_CODE, "200023"), jSONObjectA.optString("resultString", "登录超时"), this.b, jSONObjectA);
        }
    }
    ...
    e(Context context) {
        ...
        n.a(new n.a() { // from class: com.mobile.auth.g.e.1
            ...
            protected void a() {
                String strB = k.b("AID", "");
                com.mobile.auth.n.c.b("AuthnHelperCore", "aid = " + strB);
                if (TextUtils.isEmpty(strB)) {
                    e.this.a();
                }
                com.mobile.auth.n.c.b("AuthnHelperCore", com.mobile.auth.n.b.a(e.this.b, true) ? "生成androidkeystore成功" : "生成androidkeystore失败");
            }
        });
    }
    ...
    protected com.cmic.sso.sdk.a a(b bVar) {
        ...
        if (bVar != null) {
            com.mobile.auth.n.e.a(strC, bVar);
        }
        return aVar;
    }
    ...
    public void a(com.cmic.sso.sdk.a aVar) {
        ...
        this.a.a(aVar, new d() { // from class: com.mobile.auth.g.e.3
    ...
    public void a(String str, String str2, com.cmic.sso.sdk.a aVar, JSONObject jSONObject) {
        try {
            ...
            if (com.mobile.auth.n.e.a(strB)) {
                return;
            }
            synchronized (this) {
                final b bVarC = com.mobile.auth.n.e.c(strB);
                if (jSONObject == null || !jSONObject.optBoolean("keepListener", false)) {
                    com.mobile.auth.n.e.b(strB);
                }
                if (bVarC == null) {
                    return;
                }
                ...
                this.d.post(new Runnable() { // from class: com.mobile.auth.g.e.4
                    @Override // java.lang.Runnable
                    public void run() {
                        bVarC.a(iB, jSONObjectA);
                    }
                });
                com.mobile.auth.f.c.a(this.b).a(aVar);
    ...
    public void a(final String str, final String str2, final b bVar) {
        ...
        n.a(new n.a(this.b, aVarA) { // from class: com.mobile.auth.g.e.2
            @Override // com.mobile.auth.n.n.a
            protected void a() {
    ...
    */
    protected boolean a(com.cmic.sso.sdk.a r7, java.lang.String r8, java.lang.String r9, java.lang.String r10, int r11, com.mobile.auth.g.b r12) {
        /*
            Method dump skipped, instruction units count: 526
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mobile.auth.g.e.a(com.cmic.sso.sdk.a, java.lang.String, java.lang.String, java.lang.String, int, com.mobile.auth.g.b):boolean");
    }
    ...
    public JSONObject c(Context context) {
        ...
        try {
            try {
                ...
                com.mobile.auth.h.a.a().a(context, g.a(context, PermissionUtils.PERMISSION_READ_PHONE_STATE), zA);
                String strA = j.a().a((String) null);
                int iA = m.a(context, zA);
                jSONObject.put("operatortype", strA);
                jSONObject.put("networktype", iA + "");
                com.mobile.auth.n.c.b("AuthnHelperCore", "网络类型: " + iA);
                com.mobile.auth.n.c.b("AuthnHelperCore", "运营商类型: " + strA);
                return jSONObject;
