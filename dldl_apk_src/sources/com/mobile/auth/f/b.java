...
public class b {
    ...
    /* JADX INFO: renamed from: com.mobile.auth.f.b$b, reason: collision with other inner class name */
    class C0066b extends u.a {
        final /* synthetic */ Context a;
        final /* synthetic */ com.cmic.sso.sdk.a b;

        C0066b(Context context, com.cmic.sso.sdk.a aVar) {
            this.a = context;
            this.b = aVar;
        }
    ...
    private b(boolean z) {
        com.mobile.auth.f.a aVarA = new a.C0065a().a();
        this.b = aVarA;
        if (z) {
            this.a = aVarA;
        } else {
        ...
        try {
            ...
            if (jSONObject.has("Configlist")) {
                ...
                if (jSONObject2.has("LOGS_CONTROL")) {
                    String[] strArrSplit = jSONObject2.getString("LOGS_CONTROL").replace("h", "").split(com.alipay.sdk.sys.a.b);
    ...
    public com.mobile.auth.f.a d() {
        return new a.C0065a().a(d.b(this.b.a())).c(d.a(this.b.c())).b(d.b(this.b.b())).d(d.c(this.b.d())).d(d.a(this.b.h())).e(d.b(this.b.i())).a(d.e(this.b.e())).b(d.d(this.b.f())).c(d.c(this.b.g())).f(d.f(this.b.j())).a(d.a(this.b.k())).b(d.b(this.b.l())).a();
    }

    com.mobile.auth.f.a a() {
        return this.b;
    }
