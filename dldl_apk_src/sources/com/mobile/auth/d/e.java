...
public class e {
    ...
    private boolean b(Context context, String str) {
        ...
        try {
            ...
            boolean zBooleanValue = ((Boolean) cls.getMethod("requestRouteToHost", Integer.TYPE, Integer.TYPE).invoke(this.c, 5, Integer.valueOf(a(b(str))))).booleanValue();
            try {
            ...
            i.a().a(new Runnable() { // from class: com.mobile.auth.d.e.1
                ...
                public void run() {
                    try {
                        ...
                        try {
                            Thread.sleep(i <= 2500 ? i : i - com.igexin.push.b.b.b);
                        } catch (Throwable th2) {
    ...
    public void a(Context context, a aVar) {
        try {
            ...
            try {
                ...
                if (this.e != null) {
                    this.e.a(MobileNetRequestManager.CODE_SWITCH_EXCEPTION, MobileNetRequestManager.MSG_SWITCH_EXCEPTION, -1L);
                }
            }
        } catch (Throwable th2) {
            try {
