...
public class b {
    ...
    static /* synthetic */ com.mobile.auth.q.a b(b bVar) {
        try {
            return bVar.b;
        } catch (Throwable th) {
            try {
        ...
        try {
            ...
            RequestQueue.getInstance().pushRequest(new com.mobile.auth.v.a(new Callback<com.mobile.auth.w.c>(ThreadStrategy.THREAD, 2000L) { // from class: com.mobile.auth.gatewayauth.manager.b.1
                ...
                public /* synthetic */ void onResult(Response response) {
                    try {
                        a((com.mobile.auth.w.c) response);
                    } catch (Throwable th) {
                        try {
                            ExceptionProcessor.processException(th);
                        } catch (Throwable th2) {
            ...
            }, new com.mobile.auth.r.c(this.a, this.d, this.b), 5000L, com.mobile.auth.w.c.class));
        } catch (Throwable th) {
            try {
                ExceptionProcessor.processException(th);
            } catch (Throwable th2) {
