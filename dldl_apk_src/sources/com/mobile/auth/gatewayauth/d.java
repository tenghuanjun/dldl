...
public class d {
    ...
    private final com.mobile.auth.q.a o;
    ...
    public ResultCodeProcessor a() {
        try {
            if (this.u == null) {
                this.u = new com.mobile.auth.gatewayauth.manager.compat.b();
            }
            return this.u;
        } catch (Throwable th) {
            ExceptionProcessor.processException(th);
        ...
        try {
            ExecutorManager.getInstance().scheduleFuture(new Runnable() { // from class: com.mobile.auth.gatewayauth.d.8
                ...
                public void run() {
                    ...
                    String str2;
                    try {
                        com.mobile.auth.q.a aVarD = d.d(d.this);
    ...
    public void a(String str, String str2) {
        ...
        try {
            ...
            if (TextUtils.isEmpty(authUIConfigQ.getProtocolAction())) {
                ...
                intent.putExtra(Constant.PROTOCOL_WEB_VIEW_ORIENTATION, q().getScreenOrientation());
                intent.putExtra(Constant.LOGIN_ACTIVITY_UI_MANAGER_ID, this.n);
            } else {
                intent = new Intent();
    ...
    public void b(String str, String str2, String str3, boolean z) {
        try {
            ...
            if (z) {
                a(str, this.t.k(str), ResultCode.CODE_CLICK_AUTH_PRIVACY_WEBURL, str2, str3);
            }
        } catch (Throwable th) {
            ExceptionProcessor.processException(th);
        }
    ...
    public void v() {
        try {
            try {
                if (this.h != null) {
                    if (this.l != null) {
                        this.l.removeAll(this.h.values());
                    }
                    this.h.clear();
                    this.h = null;
                    return;
    ...
    public void w() {
        try {
            try {
                if (this.i != null) {
                    if (this.m != null) {
                        this.m.removeAll(this.i.values());
                    }
                    this.i.clear();
                    this.i = null;
                    return;
