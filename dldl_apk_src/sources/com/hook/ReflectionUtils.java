...
public class ReflectionUtils {
    ...
    public static void hookResources(Context context) {
        try {
            ...
            if (cls == null) {
                cls = Class.forName("com.gdwan.msdk.GDwanCore");
            }
            if (cls == null) {
                cls = Class.forName("com.jcwan.msdk.JCwanCore");
            }
            Method declaredMethod = cls.getDeclaredMethod("getInstance", null);
            Object objInvoke = declaredMethod.invoke(null, null);
            Method method = cls.getMethod("getResources", Resources.class);
            if (declaredMethod != null) {
                hookResources(context, (Resources) method.invoke(objInvoke, context.getResources()));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
