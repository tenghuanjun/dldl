...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
        ...
        return new Adapter(gson, mapKeyAndValueTypes[0], getKeyAdapter(gson, mapKeyAndValueTypes[0]), mapKeyAndValueTypes[1], gson.getAdapter(TypeToken.get(mapKeyAndValueTypes[1])), this.constructorConstructor.getConstructor(typeToken));
    }
        ...
        public void write(JsonWriter jsonWriter, Map<K, V> map) throws IOException {
            if (map != null) {
                ...
                for (Map.Entry<K, V> entry2 : map.entrySet()) {
                    JsonElement jsonTree = MapTypeAdapterFactory.toJsonTree(this.keyTypeAdapter, entry2.getKey());
    ...
    public static <T> JsonElement toJsonTree(TypeAdapter<T> typeAdapter, T t) {
        try {
