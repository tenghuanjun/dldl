            ...
            if (pair.first == null) {
                ...
                if (!skipMonth(item, item2, Long.valueOf(jLongValue), Long.valueOf(jLongValue2))) {
                    ...
                    while (itemId <= itemId2) {
                        ...
                        if (!zIsLayoutRtl) {
                            int i2 = numColumns > iDayToPosition ? 0 : iHorizontalMidPoint;
                            int width2 = iDayToPosition2 > numColumns2 ? getWidth() : iHorizontalMidPoint2;
                            i = i2;
                            width = width2;
                        } else {
                            i = iDayToPosition2 > numColumns2 ? 0 : iHorizontalMidPoint2;
