...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    private void drawText(@NonNull Canvas canvas, @NonNull Rect rect) {
        if (this.text != null) {
            ...
            CharSequence charSequenceEllipsize = (!z || this.truncateAt == null) ? charSequence : TextUtils.ellipsize(charSequence, this.textDrawableHelper.getTextPaint(), this.rectF.width(), this.truncateAt);
    ...
    private void drawDebug(@NonNull Canvas canvas, @NonNull Rect rect) {
        ...
        if (paint != null) {
            ...
            this.debugPaint.setColor(ColorUtils.setAlphaComponent(-65536, TTDownloadField.CALL_DOWNLOAD_MODEL_SET_EXTRA_VALUE));
            calculateChipTouchBounds(rect, this.rectF);
            canvas.drawRect(this.rectF, this.debugPaint);
            this.debugPaint.setColor(ColorUtils.setAlphaComponent(-16711936, TTDownloadField.CALL_DOWNLOAD_MODEL_SET_EXTRA_VALUE));
