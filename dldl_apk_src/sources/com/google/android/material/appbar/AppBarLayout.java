    ...
    int getDownNestedPreScrollRange() {
        ...
        for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
            ...
            if ((i3 & 5) != 5) {
                ...
                if ((i3 & 8) != 0) {
                    minimumHeight = i4 + ViewCompat.getMinimumHeight(childAt);
                } else {
                    minimumHeight = (i3 & 2) != 0 ? i4 + (measuredHeight - ViewCompat.getMinimumHeight(childAt)) : i4 + measuredHeight;
                }
        ...
        public boolean onLayoutChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull T t, int i) {
            ...
            if (i2 >= 0 && (pendingAction & 8) == 0) {
                ...
                if (this.offsetToChildIndexOnLayoutIsMinHeight) {
                    iRound = i3 + ViewCompat.getMinimumHeight(childAt) + t.getTopInset();
                } else {
                    iRound = i3 + Math.round(childAt.getHeight() * this.offsetToChildIndexOnLayoutPerc);
                }
