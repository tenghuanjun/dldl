...
public final class CollapsingTextHelper {
    ...
    @NonNull
    private final TextPaint textPaint = new TextPaint(TTDownloadField.CALL_DOWNLOAD_MODEL_SET_EXTRA);
    ...
    private void drawMultilineTransition(@NonNull Canvas canvas, float f, float f2) {
        ...
        String strSubstring = strTrim.endsWith(ELLIPSIS_NORMAL) ? strTrim.substring(0, strTrim.length() - 1) : strTrim;
        this.textPaint.setAlpha(alpha);
        canvas.drawText(strSubstring, 0, Math.min(this.textLayout.getLineEnd(0), strSubstring.length()), 0.0f, f4, (Paint) this.textPaint);
    }
