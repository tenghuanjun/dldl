...
public final class Detector {
    ...
    public DetectorResult detect() throws NotFoundException {
        ...
        if (i * 4 >= i2 * 7 || i2 * 4 >= i * 7) {
            ...
            bitMatrixSampleGrid = sampleGrid(this.image, resultPoint2, resultPoint12, resultPoint11, resultPointCorrectTopRightRectangular, (transitions3 & 1) == 1 ? transitions3 + 1 : transitions3, (transitions4 & 1) == 1 ? transitions4 + 1 : transitions4);
        } else {
            ...
            int i3 = (iMax & 1) == 1 ? iMax + 1 : iMax;
            bitMatrixSampleGrid = sampleGrid(this.image, resultPoint13, resultPoint12, resultPoint11, resultPointCorrectTopRightRectangular, i3, i3);
            resultPoint2 = resultPoint13;
        }
