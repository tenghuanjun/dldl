...
public final class Encoder {
    ...
    public static AztecCode encode(byte[] bArr, int i, int i2) {
        ...
        if (i2 != 0) {
            ...
            if (bitArrayStuffBits2.getSize() + size > i8) {
                throw new IllegalArgumentException("Data to large for user specified layer");
            }
            if (z && bitArrayStuffBits2.getSize() > (i3 << 6)) {
                throw new IllegalArgumentException("Data to large for user specified layer");
            }
        } else {
            ...
            while (i9 <= 32) {
                ...
                if (size2 <= i12) {
                    if (bitArray == null || i10 != WORD_SIZE[i11]) {
                        i3 = WORD_SIZE[i11];
                    ...
                    int i14 = i12 - (i12 % i3);
                    if ((!z2 || bitArrayStuffBits.getSize() <= (i3 << 6)) && bitArrayStuffBits.getSize() + size <= i14) {
        ...
        BitArray bitArrayGenerateCheckWords = generateCheckWords(bitArrayStuffBits2, i4, i3);
        int size3 = bitArrayStuffBits2.getSize() / i3;
