...
public final class RSSExpandedReader extends AbstractRSSReader {
    ...
    private static final int[][] WEIGHTS = {new int[]{1, 3, 9, 27, 81, 32, 96, 77}, new int[]{20, 60, Opcodes.GETFIELD, 118, TTDownloadField.CALL_DOWNLOAD_MODEL_SET_MIME_TYPE, 7, 21, 63}, new int[]{189, TTDownloadField.CALL_DOWNLOAD_MODEL_SET_IS_SHOW_NOTIFICATION, 13, 39, 117, TTDownloadField.CALL_DOWNLOAD_MODEL_SET_DOWNLOAD_URL, 209, 205}, new int[]{Opcodes.INSTANCEOF, 157, 49, 147, 19, 57, 171, 91}, new int[]{62, 186, TTDownloadField.CALL_DOWNLOAD_MODEL_SET_PACKAGE_NAME, 197, Opcodes.RET, 85, 44, TTDownloadField.CALL_DOWNLOAD_MODEL_SET_ID}, new int[]{Opcodes.INVOKEINTERFACE, TTDownloadField.CALL_DOWNLOAD_MODEL_SET_IS_AD, Opcodes.NEWARRAY, TTDownloadField.CALL_DOWNLOAD_MODEL_SET_NOTIFICATION_JUMP_URL, 4, 12, 36, 108}, new int[]{113, 128, 173, 97, 80, 29, 87, 50}, new int[]{150, 28, 84, 41, 123, Opcodes.IFLE, 52, 156}, new int[]{46, TTDownloadField.CALL_DOWNLOAD_MODEL_SET_DEEP_LINK, BuildConfig.VERSION_CODE, Opcodes.NEW, TTDownloadField.CALL_DOWNLOAD_MODEL_SET_CLICK_TRACK_URL, 206, 196, 166}, new int[]{76, 17, 51, 153, 37, 111, 122, 155}, new int[]{43, TTDownloadField.CALL_DOWNLOAD_MODEL_SET_EXTRA, Opcodes.ARETURN, 106, 107, 110, 119, TTDownloadField.CALL_DOWNLOAD_MODEL_SET_FILE_PATH}, new int[]{16, 48, TTDownloadField.CALL_DOWNLOAD_MODEL_SET_HEADERS, 10, 30, 90, 59, Opcodes.RETURN}, new int[]{109, 116, TTDownloadField.CALL_DOWNLOAD_MODEL_SET_APP_ICON, 200, Opcodes.GETSTATIC, 112, 125, 164}, new int[]{70, 210, 208, Code.AUTHORIZE_FAILURE_CODE, Opcodes.INVOKESTATIC, TTDownloadField.CALL_DOWNLOAD_MODEL_SET_START_TOAST, 179, 115}, new int[]{TTDownloadField.CALL_DOWNLOAD_MODEL_SET_MODEL_TYPE, 191, 151, 31, 93, 68, 204, 190}, new int[]{148, 22, 66, Opcodes.IFNULL, 172, 94, 71, 2}, new int[]{6, 18, 54, Opcodes.IF_ICMPGE, 64, 192, Opcodes.IFNE, 40}, new int[]{120, 149, 25, 75, 14, 42, 126, Opcodes.GOTO}, new int[]{79, 26, 78, 23, 69, 207, Opcodes.IFNONNULL, 175}, new int[]{103, 98, 83, 38, 114, 131, Opcodes.INVOKEVIRTUAL, 124}, new int[]{Opcodes.IF_ICMPLT, 61, Opcodes.INVOKESPECIAL, TTDownloadField.CALL_DOWNLOAD_MODEL_SET_EXTRA_VALUE, 170, 88, 53, Opcodes.IF_ICMPEQ}, new int[]{55, Opcodes.IF_ACMPEQ, 73, 8, 24, 72, 5, 15}, new int[]{45, TTDownloadField.CALL_DOWNLOAD_MODEL_SET_LOG_EXTRA, 194, 160, 58, 174, 100, 89}};
