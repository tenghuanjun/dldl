...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{TTAdConstant.SHOW_POLL_TIME_SPLASH_DEFAULT, 509}, "GB");
            add(new int[]{520}, "GR");
            ...
            add(new int[]{594}, "RO");
            add(new int[]{599}, "HU");
            add(new int[]{AdBaseConstants.DEFAULT_BROADCAST_CHECK_TIME, 601}, "ZA");
            add(new int[]{603}, "GH");
            add(new int[]{608}, "BH");
            add(new int[]{609}, "MU");
            add(new int[]{611}, "MA");
            ...
            add(new int[]{896}, "PK");
            add(new int[]{899}, "ID");
            add(new int[]{ToygerConst.TOYGER_UI_MSG_BASE, 919}, "AT");
