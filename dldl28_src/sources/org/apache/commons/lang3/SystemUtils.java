...
public class SystemUtils {
    ...
    static {
        ...
        IS_JAVA_1_9 = getJavaVersionMatches(Constants.VIA_SHARE_TYPE_MINI_PROGRAM);
        IS_JAVA_9 = getJavaVersionMatches(Constants.VIA_SHARE_TYPE_MINI_PROGRAM);
        IS_JAVA_10 = getJavaVersionMatches(Constants.VIA_REPORT_TYPE_SHARE_TO_QQ);
        IS_JAVA_11 = getJavaVersionMatches(Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE);
        IS_JAVA_12 = getJavaVersionMatches(Constants.VIA_REPORT_TYPE_SET_AVATAR);
        IS_JAVA_13 = getJavaVersionMatches(Constants.VIA_REPORT_TYPE_JOININ_GROUP);
        IS_JAVA_14 = getJavaVersionMatches(Constants.VIA_REPORT_TYPE_MAKE_FRIEND);
        IS_JAVA_15 = getJavaVersionMatches(Constants.VIA_REPORT_TYPE_WPA_STATE);
