...
public final class BehaviorProcessor<T> extends FlowableProcessor<T> {
    ...
    public void onError(Throwable t) {
        ...
        if (!ComplexDouble$$ExternalSyntheticBackport0.m(this.terminalEvent, null, t)) {
    ...
    public void onComplete() {
        if (ComplexDouble$$ExternalSyntheticBackport0.m(this.terminalEvent, null, ExceptionHelper.TERMINATED)) {
