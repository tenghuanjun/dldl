...
public abstract class Flowable<T> implements Publisher<T> {
    ...
    public final <U extends Collection<? super T>> Flowable<U> buffer(int count, int skip, Supplier<U> bufferSupplier) {
        ObjectHelper.verifyPositive(count, MetricsSQLiteCacheKt.METRICS_COUNT);
    ...
    public static <T> Flowable<T> fromOptional(Optional<T> optional) {
        ...
        return (Flowable) optional.map(new java.util.function.Function() { // from class: io.reactivex.rxjava3.core.Flowable$$ExternalSyntheticLambda7
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return Flowable.just(obj);
            }
        }).orElseGet(new java.util.function.Supplier() { // from class: io.reactivex.rxjava3.core.Flowable$$ExternalSyntheticLambda8
    ...
    public final CompletionStage<T> firstStage(T defaultItem) {
        return l$$ExternalSyntheticApiModelOutline0.m6719m((Object) subscribeWith(new FlowableFirstStageSubscriber(true, defaultItem)));
    }
    ...
    public final CompletionStage<T> singleStage(T defaultItem) {
        return l$$ExternalSyntheticApiModelOutline0.m6719m((Object) subscribeWith(new FlowableSingleStageSubscriber(true, defaultItem)));
    }
    ...
    public final CompletionStage<T> lastStage(T defaultItem) {
        return l$$ExternalSyntheticApiModelOutline0.m6719m((Object) subscribeWith(new FlowableLastStageSubscriber(true, defaultItem)));
    }
    ...
    public final CompletionStage<T> firstOrErrorStage() {
        return l$$ExternalSyntheticApiModelOutline0.m6719m((Object) subscribeWith(new FlowableFirstStageSubscriber(false, null)));
    }
    ...
    public final CompletionStage<T> singleOrErrorStage() {
        return l$$ExternalSyntheticApiModelOutline0.m6719m((Object) subscribeWith(new FlowableSingleStageSubscriber(false, null)));
    }
    ...
    public final CompletionStage<T> lastOrErrorStage() {
        return l$$ExternalSyntheticApiModelOutline0.m6719m((Object) subscribeWith(new FlowableLastStageSubscriber(false, null)));
    }
    ...
    public final Stream<T> blockingStream(int prefetch) {
        ...
        disposable.getClass();
        return l$$ExternalSyntheticApiModelOutline0.m6724m((Object) stream.onClose(new Flowable$$ExternalSyntheticLambda6(disposable)));
    }
