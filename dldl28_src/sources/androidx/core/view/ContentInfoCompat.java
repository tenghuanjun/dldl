...
public final class ContentInfoCompat {
    ...
    public ContentInfo toContentInfo() {
        return HalfKt$$ExternalSyntheticApiModelOutline0.m6235m(Objects.requireNonNull(this.mCompat.getWrapped()));
    }
    ...
    private static final class CompatImpl implements Compat {
        ...
        CompatImpl(BuilderCompatImpl builderCompatImpl) {
            ...
            this.mSource = Preconditions.checkArgumentInRange(builderCompatImpl.mSource, 0, 5, SocialConstants.PARAM_SOURCE);
    ...
    private static final class Compat31Impl implements Compat {
        ...
        Compat31Impl(ContentInfo contentInfo) {
            this.mWrapped = HalfKt$$ExternalSyntheticApiModelOutline0.m6235m(Preconditions.checkNotNull(contentInfo));
        }
    ...
    private static final class BuilderCompat31Impl implements BuilderCompat {
        ...
        BuilderCompat31Impl(ContentInfoCompat contentInfoCompat) {
            HalfKt$$ExternalSyntheticApiModelOutline0.m6246m();
            this.mPlatformBuilder = HalfKt$$ExternalSyntheticApiModelOutline0.m6234m(contentInfoCompat.toContentInfo());
        }
