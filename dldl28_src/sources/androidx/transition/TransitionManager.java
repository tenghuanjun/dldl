...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo6295clone = transition.mo6295clone();
        transitionMo6295clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo6295clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo6295clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo6295clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo6295clone = transition.mo6295clone();
        sceneChangeSetup(viewGroup, transitionMo6295clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo6295clone);
    }
