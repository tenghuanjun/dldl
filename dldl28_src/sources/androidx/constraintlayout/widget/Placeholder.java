...
public class Placeholder extends View {
    ...
    public void onDraw(Canvas canvas) {
        if (isInEditMode()) {
            ...
            paint.setARGB(255, KeyBoardKey.KeyboardKeyGamepadRightThumbStickButton, KeyBoardKey.KeyboardKeyGamepadRightThumbStickButton, KeyBoardKey.KeyboardKeyGamepadRightThumbStickButton);
