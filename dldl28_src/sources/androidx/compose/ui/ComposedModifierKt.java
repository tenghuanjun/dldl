    ...
    public static final Modifier materializeModifier(final Composer composer, Modifier modifier) {
        ...
        Modifier modifier2 = (Modifier) modifier.foldIn(Modifier.INSTANCE, new Function2<Modifier, Modifier.Element, Modifier>() { // from class: androidx.compose.ui.ComposedModifierKt$materialize$result$1
            ...
            public final Modifier invoke(Modifier modifier3, Modifier.Element element) {
                Modifier.Element elementMaterializeModifier;
                if (element instanceof ComposedModifier) {
                    ...
                    elementMaterializeModifier = ComposedModifierKt.materializeModifier(composer, (Modifier) ((Function3) TypeIntrinsics.beforeCheckcastToFunctionOfArity(factory, 3)).invoke(Modifier.INSTANCE, composer, 0));
                } else {
                    elementMaterializeModifier = element;
                }
                return modifier3.then(elementMaterializeModifier);
            }
        });
