...
public final class TextIndent {
    ...
    public static /* synthetic */ TextIndent m5786copyNB67dxo$default(TextIndent textIndent, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textIndent.m5787copyNB67dxo(j, j2);
    }

    /* JADX INFO: renamed from: copy-NB67dxo, reason: not valid java name */
    public final TextIndent m5787copyNB67dxo(long firstLine, long restLine) {
    ...
    public boolean equals(Object other) {
        ...
        return TextUnit.m6074equalsimpl0(this.firstLine, textIndent.firstLine) && TextUnit.m6074equalsimpl0(this.restLine, textIndent.restLine);
    }

    public int hashCode() {
        return (TextUnit.m6078hashCodeimpl(this.firstLine) * 31) + TextUnit.m6078hashCodeimpl(this.restLine);
    }

    public String toString() {
        return "TextIndent(firstLine=" + ((Object) TextUnit.m6084toStringimpl(this.firstLine)) + ", restLine=" + ((Object) TextUnit.m6084toStringimpl(this.restLine)) + ')';
    }
}
