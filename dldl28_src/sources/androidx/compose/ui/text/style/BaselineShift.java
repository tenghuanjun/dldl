...
public final class BaselineShift {
    ...
    private static final float Superscript = m5649constructorimpl(0.5f);
    private static final float Subscript = m5649constructorimpl(-0.5f);
    private static final float None = m5649constructorimpl(0.0f);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ BaselineShift m5648boximpl(float f) {
        return new BaselineShift(f);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static float m5649constructorimpl(float f) {
        return f;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m5650equalsimpl(float f, Object obj) {
        return (obj instanceof BaselineShift) && Float.compare(f, ((BaselineShift) obj).m5654unboximpl()) == 0;
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m5651equalsimpl0(float f, float f2) {
        return Float.compare(f, f2) == 0;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m5652hashCodeimpl(float f) {
        return Float.floatToIntBits(f);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m5653toStringimpl(float f) {
        return "BaselineShift(multiplier=" + f + ')';
    }

    public boolean equals(Object obj) {
        return m5650equalsimpl(this.multiplier, obj);
    }

    public int hashCode() {
        return m5652hashCodeimpl(this.multiplier);
    }

    public String toString() {
        return m5653toStringimpl(this.multiplier);
    }

    /* JADX INFO: renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ float m5654unboximpl() {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m5655getNoney9eOQZs$annotations() {
        }

        /* JADX INFO: renamed from: getSubscript-y9eOQZs$annotations, reason: not valid java name */
        public static /* synthetic */ void m5656getSubscripty9eOQZs$annotations() {
        }

        /* JADX INFO: renamed from: getSuperscript-y9eOQZs$annotations, reason: not valid java name */
        public static /* synthetic */ void m5657getSuperscripty9eOQZs$annotations() {
        }
