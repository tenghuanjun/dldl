...
final /* data */ class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m5663copy8_81llA$default(ColorStyle colorStyle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = colorStyle.value;
        }
        return colorStyle.m5665copy8_81llA(j);
    }
    ...
    public final ColorStyle m5665copy8_81llA(long value) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorStyle) && Color.m3495equalsimpl0(this.value, ((ColorStyle) other).value);
    }
    ...
    public int hashCode() {
        return Color.m3501hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return "ColorStyle(value=" + ((Object) Color.m3502toStringimpl(this.value)) + ')';
    }
    ...
    public final long m5666getValue0d7_KjU() {
        return this.value;
    }
    ...
    public float getAlpha() {
        return Color.m3496getAlphaimpl(mo5662getColor0d7_KjU());
    }
}
