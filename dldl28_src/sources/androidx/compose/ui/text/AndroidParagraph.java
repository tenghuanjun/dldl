...
public final class AndroidParagraph implements Paragraph {
    ...
    private AndroidParagraph(AndroidParagraphIntrinsics androidParagraphIntrinsics, int i, boolean z, long j) {
        ...
        this.ellipsis = z;
        this.constraints = j;
        if (Constraints.m5829getMinHeightimpl(j) != 0 || Constraints.m5830getMinWidthimpl(j) != 0) {
        ...
        int iM5226toLayoutAlignaXe7zB0 = AndroidParagraph_androidKt.m5226toLayoutAlignaXe7zB0(style.m5409getTextAligne0LSkKk());
        boolean zM5760equalsimpl0 = TextAlign.m5760equalsimpl0(style.m5409getTextAligne0LSkKk(), TextAlign.INSTANCE.m5766getJustifye0LSkKk());
        int iM5228toLayoutHyphenationFrequency3fSNIE = AndroidParagraph_androidKt.m5228toLayoutHyphenationFrequency3fSNIE(style.getParagraphStyle().getHyphens());
        int iM5227toLayoutBreakStrategyxImikfE = AndroidParagraph_androidKt.m5227toLayoutBreakStrategyxImikfE(LineBreak.m5684getStrategyfcGXIks(style.m5406getLineBreakrAG3T2k()));
        int iM5229toLayoutLineBreakStylehpcqdu8 = AndroidParagraph_androidKt.m5229toLayoutLineBreakStylehpcqdu8(LineBreak.m5685getStrictnessusljTpc(style.m5406getLineBreakrAG3T2k()));
        int iM5230toLayoutLineBreakWordStylewPN0Rpw = AndroidParagraph_androidKt.m5230toLayoutLineBreakWordStylewPN0Rpw(LineBreak.m5686getWordBreakjp8hJ3c(style.m5406getLineBreakrAG3T2k()));
        TextUtils.TruncateAt truncateAt = z ? TextUtils.TruncateAt.END : null;
        TextLayout textLayoutConstructTextLayout = constructTextLayout(iM5226toLayoutAlignaXe7zB0, zM5760equalsimpl0 ? 1 : 0, truncateAt, i, iM5228toLayoutHyphenationFrequency3fSNIE, iM5227toLayoutBreakStrategyxImikfE, iM5229toLayoutLineBreakStylehpcqdu8, iM5230toLayoutLineBreakWordStylewPN0Rpw);
        if (z && textLayoutConstructTextLayout.getHeight() > Constraints.m5827getMaxHeightimpl(j) && i > 1) {
            int iNumberOfLinesThatFitMaxHeight = AndroidParagraph_androidKt.numberOfLinesThatFitMaxHeight(textLayoutConstructTextLayout, Constraints.m5827getMaxHeightimpl(j));
            if (iNumberOfLinesThatFitMaxHeight >= 0 && iNumberOfLinesThatFitMaxHeight != i) {
                textLayoutConstructTextLayout = constructTextLayout(iM5226toLayoutAlignaXe7zB0, zM5760equalsimpl0 ? 1 : 0, truncateAt, RangesKt.coerceAtLeast(iNumberOfLinesThatFitMaxHeight, 1), iM5228toLayoutHyphenationFrequency3fSNIE, iM5227toLayoutBreakStrategyxImikfE, iM5229toLayoutLineBreakStylehpcqdu8, iM5230toLayoutLineBreakWordStylewPN0Rpw);
            }
            this.layout = textLayoutConstructTextLayout;
        } else {
            this.layout = textLayoutConstructTextLayout;
        }
        getTextPaint$ui_text_release().m5628setBrush12SF9DM(style.getBrush(), SizeKt.Size(getWidth(), getHeight()), style.getAlpha());
        for (ShaderBrushSpan shaderBrushSpan : getShaderBrushSpans(this.layout)) {
            shaderBrushSpan.m5647setSizeuvyYCjk(SizeKt.Size(getWidth(), getHeight()));
        }
    ...
    public float getWidth() {
        return Constraints.m5828getMaxWidthimpl(this.constraints);
    }
    ...
    public int mo5216getOffsetForPositionk4lQ0M(long position) {
        return this.layout.getOffsetForHorizontal(this.layout.getLineForVertical((int) Offset.m3220getYimpl(position)), Offset.m3219getXimpl(position));
    }
    ...
    public void mo5214fillBoundingBoxes8ffj60Q(long range, float[] array, int arrayStart) {
        this.layout.fillBoundingBoxes(TextRange.m5366getMinimpl(range), TextRange.m5365getMaximpl(range), array, arrayStart);
    }
    ...
    public long mo5217getWordBoundaryjx7JFs(int offset) {
    ...
    public void mo5219paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration) {
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m5629setColor8_81llA(color);
    ...
    public void mo5218paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        int iM5626getBlendMode0nO6VwU = getTextPaint$ui_text_release().m5626getBlendMode0nO6VwU();
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m5629setColor8_81llA(color);
        textPaint$ui_text_release.setShadow(shadow);
        textPaint$ui_text_release.setTextDecoration(textDecoration);
        textPaint$ui_text_release.setDrawStyle(drawStyle);
        textPaint$ui_text_release.m5627setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m5627setBlendModes9anfk8(iM5626getBlendMode0nO6VwU);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* JADX INFO: renamed from: paint-hn5TExg, reason: not valid java name */
    public void mo5220painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        int iM5626getBlendMode0nO6VwU = getTextPaint$ui_text_release().m5626getBlendMode0nO6VwU();
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m5628setBrush12SF9DM(brush, SizeKt.Size(getWidth(), getHeight()), alpha);
        textPaint$ui_text_release.setShadow(shadow);
        textPaint$ui_text_release.setTextDecoration(textDecoration);
        textPaint$ui_text_release.setDrawStyle(drawStyle);
        textPaint$ui_text_release.m5627setBlendModes9anfk8(blendMode);
