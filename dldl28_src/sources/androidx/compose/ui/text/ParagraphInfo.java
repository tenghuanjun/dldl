...
public final /* data */ class ParagraphInfo {
    ...
    public final long m5258toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m3219getXimpl(j), Offset.m3220getYimpl(j) - this.top);
    }

    public final Rect toGlobal(Rect rect) {
        return rect.m3256translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    public final Path toGlobal(Path path) {
        path.mo3356translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }

    /* JADX INFO: renamed from: toGlobal-GEjPoXI, reason: not valid java name */
    public final long m5257toGlobalGEjPoXI(long j) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m5368getStartimpl(j)), toGlobalIndex(TextRange.m5363getEndimpl(j)));
    }
}
