...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public void updateDrawState(TextPaint textPaint) {
        if (textPaint != null) {
            ...
            if (drawStyle instanceof Stroke) {
                ...
                textPaint.setStrokeJoin(m5645toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).getJoin()));
                textPaint.setStrokeCap(m5644toAndroidCapBeK7IIE(((Stroke) this.drawStyle).getCap()));
    ...
    private final Paint.Join m5645toAndroidJoinWw9F2mQ(int i) {
        return StrokeJoin.m3861equalsimpl0(i, StrokeJoin.INSTANCE.m3866getMiterLxFBmk8()) ? Paint.Join.MITER : StrokeJoin.m3861equalsimpl0(i, StrokeJoin.INSTANCE.m3867getRoundLxFBmk8()) ? Paint.Join.ROUND : StrokeJoin.m3861equalsimpl0(i, StrokeJoin.INSTANCE.m3865getBevelLxFBmk8()) ? Paint.Join.BEVEL : Paint.Join.MITER;
    }

    /* JADX INFO: renamed from: toAndroidCap-BeK7IIE, reason: not valid java name */
    private final Paint.Cap m5644toAndroidCapBeK7IIE(int i) {
        return StrokeCap.m3851equalsimpl0(i, StrokeCap.INSTANCE.m3855getButtKaPHkGw()) ? Paint.Cap.BUTT : StrokeCap.m3851equalsimpl0(i, StrokeCap.INSTANCE.m3856getRoundKaPHkGw()) ? Paint.Cap.ROUND : StrokeCap.m3851equalsimpl0(i, StrokeCap.INSTANCE.m3857getSquareKaPHkGw()) ? Paint.Cap.SQUARE : Paint.Cap.BUTT;
    }
}
