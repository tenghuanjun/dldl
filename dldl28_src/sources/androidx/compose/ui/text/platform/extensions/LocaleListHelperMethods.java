...
public final class LocaleListHelperMethods {
    ...
    public final Object localeSpan(LocaleList localeList) {
        ...
        return NotificationCompat$$ExternalSyntheticApiModelOutline0.m6148m(NotificationCompat$$ExternalSyntheticApiModelOutline0.m((java.util.Locale[]) Arrays.copyOf(localeArr, localeArr.length)));
    }
    ...
    public final void setTextLocales(AndroidTextPaint textPaint, LocaleList localeList) {
        ...
        java.util.Locale[] localeArr = (java.util.Locale[]) arrayList.toArray(new java.util.Locale[0]);
        textPaint.setTextLocales(NotificationCompat$$ExternalSyntheticApiModelOutline0.m((java.util.Locale[]) Arrays.copyOf(localeArr, localeArr.length)));
    }
}
