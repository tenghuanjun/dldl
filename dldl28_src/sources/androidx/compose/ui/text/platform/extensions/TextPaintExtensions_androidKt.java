...
public final class TextPaintExtensions_androidKt {
    ...
    public static final SpanStyle applySpanStyle(AndroidTextPaint androidTextPaint, SpanStyle spanStyle, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4, Density density, boolean z) {
        Locale current;
        long jM6076getTypeUIouoOA = TextUnit.m6076getTypeUIouoOA(spanStyle.getFontSize());
        if (TextUnitType.m6105equalsimpl0(jM6076getTypeUIouoOA, TextUnitType.INSTANCE.m6110getSpUIouoOA())) {
            androidTextPaint.setTextSize(density.mo344toPxR2X_6o(spanStyle.getFontSize()));
        } else if (TextUnitType.m6105equalsimpl0(jM6076getTypeUIouoOA, TextUnitType.INSTANCE.m6109getEmUIouoOA())) {
            androidTextPaint.setTextSize(androidTextPaint.getTextSize() * TextUnit.m6077getValueimpl(spanStyle.getFontSize()));
        }
        if (hasFontAttributes(spanStyle)) {
            ...
            androidTextPaint.setTypeface(function4.invoke(fontFamily, fontWeight, fontStyleM5477boximpl, FontSynthesis.m5488boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m5497getAllGVVA2EU())));
        }
        if (spanStyle.getLocaleList() != null && !Intrinsics.areEqual(spanStyle.getLocaleList(), LocaleList.INSTANCE.getCurrent())) {
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                androidTextPaint.setTextLocale(LocaleExtensions_androidKt.toJavaLocale(current));
            }
        }
        ...
        androidTextPaint.m5629setColor8_81llA(spanStyle.m5327getColor0d7_KjU());
        androidTextPaint.m5628setBrush12SF9DM(spanStyle.getBrush(), Size.INSTANCE.m3296getUnspecifiedNHjbRc(), spanStyle.getAlpha());
        androidTextPaint.setShadow(spanStyle.getShadow());
        androidTextPaint.setTextDecoration(spanStyle.getTextDecoration());
        androidTextPaint.setDrawStyle(spanStyle.getDrawStyle());
        if (TextUnitType.m6105equalsimpl0(TextUnit.m6076getTypeUIouoOA(spanStyle.getLetterSpacing()), TextUnitType.INSTANCE.m6110getSpUIouoOA()) && TextUnit.m6077getValueimpl(spanStyle.getLetterSpacing()) != 0.0f) {
            float textSize = androidTextPaint.getTextSize() * androidTextPaint.getTextScaleX();
            float fMo344toPxR2X_6o = density.mo344toPxR2X_6o(spanStyle.getLetterSpacing());
            if (textSize != 0.0f) {
                androidTextPaint.setLetterSpacing(fMo344toPxR2X_6o / textSize);
            }
        } else if (TextUnitType.m6105equalsimpl0(TextUnit.m6076getTypeUIouoOA(spanStyle.getLetterSpacing()), TextUnitType.INSTANCE.m6109getEmUIouoOA())) {
            androidTextPaint.setLetterSpacing(TextUnit.m6077getValueimpl(spanStyle.getLetterSpacing()));
        }
        return m5643generateFallbackSpanStyle62GTOB8(spanStyle.getLetterSpacing(), z, spanStyle.getBackground(), spanStyle.getBaselineShift());
    }
    ...
    */
    private static final androidx.compose.ui.text.SpanStyle m5643generateFallbackSpanStyle62GTOB8(long r31, boolean r33, long r34, androidx.compose.ui.text.style.BaselineShift r36) {
        /*
            r0 = r34
            r2 = 1
            r3 = 0
            if (r33 == 0) goto L22
            long r4 = androidx.compose.ui.unit.TextUnit.m6076getTypeUIouoOA(r31)
            androidx.compose.ui.unit.TextUnitType$Companion r6 = androidx.compose.ui.unit.TextUnitType.INSTANCE
            long r6 = r6.m6110getSpUIouoOA()
            boolean r4 = androidx.compose.ui.unit.TextUnitType.m6105equalsimpl0(r4, r6)
            if (r4 == 0) goto L22
            float r4 = androidx.compose.ui.unit.TextUnit.m6077getValueimpl(r31)
            r5 = 0
        ...
        L23:
            ...
            long r5 = r5.m3530getUnspecified0d7_KjU()
            boolean r5 = androidx.compose.ui.graphics.Color.m3495equalsimpl0(r0, r5)
            if (r5 != 0) goto L3d
            androidx.compose.ui.graphics.Color$Companion r5 = androidx.compose.ui.graphics.Color.INSTANCE
            long r5 = r5.m3529getTransparent0d7_KjU()
            boolean r5 = androidx.compose.ui.graphics.Color.m3495equalsimpl0(r0, r5)
            if (r5 != 0) goto L3d
            r5 = 1
            goto L3e
        ...
        L3e:
            ...
            float r6 = r6.m5658getNoney9eOQZs()
            float r7 = r36.m5654unboximpl()
            boolean r6 = androidx.compose.ui.text.style.BaselineShift.m5651equalsimpl0(r7, r6)
            if (r6 != 0) goto L51
            goto L52
        L51:
            r2 = 0
        ...
        L5f:
            ...
            long r6 = r4.m6088getUnspecifiedXSAIIZE()
            r18 = r6
        L67:
            if (r5 == 0) goto L6a
            goto L70
        L6a:
            ...
            long r0 = r0.m3530getUnspecified0d7_KjU()
        L70:
            r23 = r0
            if (r2 == 0) goto L77
            r20 = r36
        ...
        L9b:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.platform.extensions.TextPaintExtensions_androidKt.m5643generateFallbackSpanStyle62GTOB8(long, boolean, long, androidx.compose.ui.text.style.BaselineShift):androidx.compose.ui.text.SpanStyle");
    }
    ...
    public static final void setTextMotion(AndroidTextPaint androidTextPaint, TextMotion textMotion) {
        ...
        if (TextMotion.Linearity.m5796equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m5801getLinear4e0Vf04())) {
            androidTextPaint.setFlags(androidTextPaint.getFlags() | 64);
            androidTextPaint.setHinting(0);
        } else if (TextMotion.Linearity.m5796equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m5800getFontHinting4e0Vf04())) {
            androidTextPaint.getFlags();
            androidTextPaint.setHinting(1);
        } else if (TextMotion.Linearity.m5796equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m5802getNone4e0Vf04())) {
            androidTextPaint.getFlags();
            androidTextPaint.setHinting(0);
        } else {
            androidTextPaint.getFlags();
