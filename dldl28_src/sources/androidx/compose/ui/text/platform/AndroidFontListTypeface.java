...
public final class AndroidFontListTypeface implements AndroidTypeface {
    ...
    */
    ...
    public Typeface mo5614getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        Font font = (Font) CollectionsKt.firstOrNull((List) this.fontMatcher.m5476matchFontRetOiIg(new ArrayList(this.loadedTypefaces.keySet()), fontWeight, fontStyle));
        if (font == null) {
        ...
        Object objM5501synthesizeTypefaceFxwP2eA = FontSynthesis_androidKt.m5501synthesizeTypefaceFxwP2eA(synthesis, typeface, font, fontWeight, fontStyle);
        Intrinsics.checkNotNull(objM5501synthesizeTypefaceFxwP2eA, "null cannot be cast to non-null type android.graphics.Typeface");
        return (Typeface) objM5501synthesizeTypefaceFxwP2eA;
    }
}
