...
public final class AndroidGenericFontFamilyTypeface implements AndroidTypeface {
    ...
    public Typeface mo5614getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        return m5615buildStyledTypefaceFO1MlWM(fontWeight, fontStyle);
    }

    /* JADX INFO: renamed from: buildStyledTypeface-FO1MlWM, reason: not valid java name */
    private final Typeface m5615buildStyledTypefaceFO1MlWM(FontWeight fontWeight, int fontStyle) {
        if (Build.VERSION.SDK_INT < 28) {
            return Typeface.create(this.nativeTypeface, AndroidFontUtils_androidKt.m5433getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle));
        }
        return TypefaceHelperMethodsApi28.INSTANCE.create(this.nativeTypeface, fontWeight.getWeight(), FontStyle.m5480equalsimpl0(fontStyle, FontStyle.INSTANCE.m5486getItalic_LCdwA()));
    }
}
