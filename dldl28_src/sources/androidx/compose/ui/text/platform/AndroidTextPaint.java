...
public final class AndroidTextPaint extends TextPaint {
    ...
    public final void setShadow(Shadow shadow) {
        ...
        if (Intrinsics.areEqual(shadow, Shadow.INSTANCE.getNone())) {
            ...
            setShadowLayer(TextPaintExtensions_androidKt.correctBlurRadius(this.shadow.getBlurRadius()), Offset.m3219getXimpl(this.shadow.getOffset()), Offset.m3220getYimpl(this.shadow.getOffset()), ColorKt.m3548toArgb8_81llA(this.shadow.getColor()));
        }
    }

    /* JADX INFO: renamed from: setBrush-12SF9DM$default, reason: not valid java name */
    public static /* synthetic */ void m5625setBrush12SF9DM$default(AndroidTextPaint androidTextPaint, Brush brush, long j, float f, int i, Object obj) {
        if ((i & 4) != 0) {
            f = Float.NaN;
        }
        androidTextPaint.m5628setBrush12SF9DM(brush, j, f);
    }

    /* JADX INFO: renamed from: setBrush-12SF9DM, reason: not valid java name */
    public final void m5628setBrush12SF9DM(Brush brush, long size, float alpha) {
        if (((brush instanceof SolidColor) && ((SolidColor) brush).getValue() != Color.INSTANCE.m3530getUnspecified0d7_KjU()) || ((brush instanceof ShaderBrush) && size != Size.INSTANCE.m3296getUnspecifiedNHjbRc())) {
            brush.mo3441applyToPq9zytI(size, this.composePaint, Float.isNaN(alpha) ? this.composePaint.getAlpha() : RangesKt.coerceIn(alpha, 0.0f, 1.0f));
        } else if (brush == null) {
    ...
    public final void setDrawStyle(DrawStyle drawStyle) {
        ...
        if (Intrinsics.areEqual(drawStyle, Fill.INSTANCE)) {
            this.composePaint.mo3344setStylek9PVt8s(PaintingStyle.INSTANCE.m3769getFillTiuSbCo());
            return;
        }
        if (drawStyle instanceof Stroke) {
            this.composePaint.mo3344setStylek9PVt8s(PaintingStyle.INSTANCE.m3770getStrokeTiuSbCo());
            Stroke stroke = (Stroke) drawStyle;
            this.composePaint.setStrokeWidth(stroke.getWidth());
            this.composePaint.setStrokeMiterLimit(stroke.getMiter());
            this.composePaint.mo3343setStrokeJoinWw9F2mQ(stroke.getJoin());
            this.composePaint.mo3342setStrokeCapBeK7IIE(stroke.getCap());
    ...
    public final int m5626getBlendMode0nO6VwU() {
        return this.composePaint.get_blendMode();
    }

    /* JADX INFO: renamed from: setBlendMode-s9anfk8, reason: not valid java name */
    public final void m5627setBlendModes9anfk8(int i) {
        this.composePaint.mo3339setBlendModes9anfk8(i);
    }

    /* JADX INFO: renamed from: setColor-8_81llA, reason: not valid java name */
    public final void m5629setColor8_81llA(long color) {
        if (color != Color.INSTANCE.m3530getUnspecified0d7_KjU()) {
            this.composePaint.mo3340setColor8_81llA(color);
            this.composePaint.setShader(null);
        }
    }
}
