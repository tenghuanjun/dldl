...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m5433getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0, FontStyle.m5480equalsimpl0(i, FontStyle.INSTANCE.m5486getItalic_LCdwA()));
    }
}
