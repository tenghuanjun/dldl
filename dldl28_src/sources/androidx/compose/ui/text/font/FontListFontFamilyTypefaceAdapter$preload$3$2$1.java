...
final class FontListFontFamilyTypefaceAdapter$preload$3$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Object>, Object> {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function1<Continuation<? super Object>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                if (i == 0) {
                    ...
                    this.label = 1;
                    obj = TimeoutKt.withTimeout(15000L, new C01351(this.$resourceLoader, this.$font, null), this);
        ...
        static final class C01351 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Object>, Object> {
            final /* synthetic */ Font $font;
            final /* synthetic */ PlatformFontLoader $resourceLoader;
            int label;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C01351(PlatformFontLoader platformFontLoader, Font font, Continuation<? super C01351> continuation) {
                super(2, continuation);
                this.$resourceLoader = platformFontLoader;
                this.$font = font;
            }
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C01351(this.$resourceLoader, this.$font, continuation);
            }
