...
public final class AndroidFontLoader implements PlatformFontLoader {
    ...
    public android.graphics.Typeface loadBlocking(Font font) {
        ...
        } else if (FontLoadingStrategy.m5467equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m5473getOptionalLocalPKNRLFQ())) {
            try {
                Result.Companion companion = Result.INSTANCE;
                AndroidFontLoader androidFontLoader = this;
                objM6745constructorimpl = Result.m6745constructorimpl(AndroidFontLoader_androidKt.load((ResourceFont) font, this.context));
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM6745constructorimpl = Result.m6745constructorimpl(ResultKt.createFailure(th));
            }
            typefaceLoad = (android.graphics.Typeface) (Result.m6751isFailureimpl(objM6745constructorimpl) ? null : objM6745constructorimpl);
        } else {
            if (FontLoadingStrategy.m5467equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m5471getAsyncPKNRLFQ())) {
                throw new UnsupportedOperationException("Unsupported Async font load path");
            }
            throw new IllegalArgumentException("Unknown loading type " + ((Object) FontLoadingStrategy.m5469toStringimpl(font.getLoadingStrategy())));
        }
