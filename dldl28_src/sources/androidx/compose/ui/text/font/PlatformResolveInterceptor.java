...
public interface PlatformResolveInterceptor {
    ...
    public final /* synthetic */ class CC {
        ...
        public static int m5505$default$interceptFontStyleT2F_aPo(PlatformResolveInterceptor _this, int i) {
            return i;
        }

        /* JADX INFO: renamed from: $default$interceptFontSynthesis-Mscr08Y, reason: not valid java name */
        public static int m5506$default$interceptFontSynthesisMscr08Y(PlatformResolveInterceptor _this, int i) {
            return i;
        }
    ...
    int mo5431interceptFontStyleT2F_aPo(int fontStyle);

    /* JADX INFO: renamed from: interceptFontSynthesis-Mscr08Y */
    int mo5432interceptFontSynthesisMscr08Y(int fontSynthesis);
    ...
    public static final class Companion {
        ...
        private static final PlatformResolveInterceptor Default = new PlatformResolveInterceptor() { // from class: androidx.compose.ui.text.font.PlatformResolveInterceptor$Companion$Default$1
            ...
            @Override // androidx.compose.ui.text.font.PlatformResolveInterceptor
            /* JADX INFO: renamed from: interceptFontStyle-T2F_aPo */
            public /* synthetic */ int mo5431interceptFontStyleT2F_aPo(int i) {
                return PlatformResolveInterceptor.CC.m5505$default$interceptFontStyleT2F_aPo(this, i);
            }

            @Override // androidx.compose.ui.text.font.PlatformResolveInterceptor
            /* JADX INFO: renamed from: interceptFontSynthesis-Mscr08Y */
            public /* synthetic */ int mo5432interceptFontSynthesisMscr08Y(int i) {
                return PlatformResolveInterceptor.CC.m5506$default$interceptFontSynthesisMscr08Y(this, i);
            }
