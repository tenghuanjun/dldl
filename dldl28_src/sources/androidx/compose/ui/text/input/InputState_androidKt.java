...
public final class InputState_androidKt {
    public static final ExtractedText toExtractedText(TextFieldValue textFieldValue) {
        ...
        extractedText.selectionStart = TextRange.m5366getMinimpl(textFieldValue.getSelection());
        extractedText.selectionEnd = TextRange.m5365getMaximpl(textFieldValue.getSelection());
