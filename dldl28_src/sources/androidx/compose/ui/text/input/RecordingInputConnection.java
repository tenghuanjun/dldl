...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        if (this.isActive) {
            ...
            int iM5366getMinimpl = composition != null ? TextRange.m5366getMinimpl(composition.getPackedValue()) : -1;
            TextRange composition2 = state.getComposition();
            inputMethodManager.updateSelection(TextRange.m5366getMinimpl(state.getSelection()), TextRange.m5365getMaximpl(state.getSelection()), iM5366getMinimpl, composition2 != null ? TextRange.m5365getMaximpl(composition2.getPackedValue()) : -1);
        }
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m5362getCollapsedimpl(this.mTextFieldValue.getSelection())) {
            return null;
        }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m5366getMinimpl(this.mTextFieldValue.getSelection()), reqModes);
    }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        this.eventCallback.mo5563onImeActionKlQnJC8(iM5547getDefaulteUduSuo);
        return true;
    }
