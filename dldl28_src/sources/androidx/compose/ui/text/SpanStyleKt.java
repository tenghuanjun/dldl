...
public final class SpanStyleKt {
    ...
    public static final long m5333lerpTextUnitInheritableC3pnCVY(long j, long j2, float f) {
        if (TextUnitKt.m6095isUnspecifiedR2X_6o(j) || TextUnitKt.m6095isUnspecifiedR2X_6o(j2)) {
            return ((TextUnit) lerpDiscrete(TextUnit.m6067boximpl(j), TextUnit.m6067boximpl(j2), f)).getPackedValue();
        }
        return TextUnitKt.m6097lerpC3pnCVY(j, j2, f);
    }
    ...
    public static final SpanStyle lerp(SpanStyle spanStyle, SpanStyle spanStyle2, float f) {
        ...
        long jM5333lerpTextUnitInheritableC3pnCVY = m5333lerpTextUnitInheritableC3pnCVY(spanStyle.getFontSize(), spanStyle2.getFontSize(), f);
        ...
        long jM5333lerpTextUnitInheritableC3pnCVY2 = m5333lerpTextUnitInheritableC3pnCVY(spanStyle.getLetterSpacing(), spanStyle2.getLetterSpacing(), f);
        BaselineShift baselineShift = spanStyle.getBaselineShift();
        float fM5654unboximpl = baselineShift != null ? baselineShift.m5654unboximpl() : BaselineShift.m5649constructorimpl(0.0f);
        BaselineShift baselineShift2 = spanStyle2.getBaselineShift();
        float fM5661lerpjWV1Mfo = BaselineShiftKt.m5661lerpjWV1Mfo(fM5654unboximpl, baselineShift2 != null ? baselineShift2.m5654unboximpl() : BaselineShift.m5649constructorimpl(0.0f), f);
        ...
        long jM3545lerpjxsXWHM = ColorKt.m3545lerpjxsXWHM(spanStyle.getBackground(), spanStyle2.getBackground(), f);
        ...
        return new SpanStyle(textForegroundStyleLerp, jM5333lerpTextUnitInheritableC3pnCVY, fontWeightLerp, fontStyle, fontSynthesis, fontFamily, str, jM5333lerpTextUnitInheritableC3pnCVY2, BaselineShift.m5648boximpl(fM5661lerpjWV1Mfo), textGeometricTransformLerp, localeList, jM3545lerpjxsXWHM, textDecoration, ShadowKt.lerp(shadow, shadow2, f), lerpPlatformStyle(spanStyle.getPlatformStyle(), spanStyle2.getPlatformStyle(), f), (DrawStyle) lerpDiscrete(spanStyle.getDrawStyle(), spanStyle2.getDrawStyle(), f), (DefaultConstructorMarker) null);
    }
    ...
    public static final SpanStyle resolveSpanStyleDefaults(SpanStyle spanStyle) {
        ...
        TextForegroundStyle textForegroundStyleTakeOrElse = spanStyle.getTextForegroundStyle().takeOrElse(new Function0<TextForegroundStyle>() { // from class: androidx.compose.ui.text.SpanStyleKt.resolveSpanStyleDefaults.1
            ...
            public final TextForegroundStyle invoke() {
                return TextForegroundStyle.INSTANCE.m5785from8_81llA(SpanStyleKt.DefaultColor);
            }
        });
        long fontSize = TextUnitKt.m6095isUnspecifiedR2X_6o(spanStyle.getFontSize()) ? DefaultFontSize : spanStyle.getFontSize();
        FontWeight fontWeight = spanStyle.getFontWeight();
        if (fontWeight == null) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        ...
        FontSynthesis fontSynthesisM5488boximpl = FontSynthesis.m5488boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m5497getAllGVVA2EU());
        ...
        if (TextUnitKt.m6095isUnspecifiedR2X_6o(spanStyle.getLetterSpacing())) {
        ...
        BaselineShift baselineShift = spanStyle.getBaselineShift();
        BaselineShift baselineShiftM5648boximpl = BaselineShift.m5648boximpl(baselineShift != null ? baselineShift.m5654unboximpl() : BaselineShift.INSTANCE.m5658getNoney9eOQZs());
        TextGeometricTransform textGeometricTransform = spanStyle.getTextGeometricTransform();
        if (textGeometricTransform == null) {
            textGeometricTransform = TextGeometricTransform.INSTANCE.getNone$ui_text_release();
        }
        ...
        if (background == Color.INSTANCE.m3530getUnspecified0d7_KjU()) {
        ...
        return new SpanStyle(textForegroundStyleTakeOrElse, fontSize, fontWeight2, fontStyleM5477boximpl, fontSynthesisM5488boximpl, fontFamily2, str, j, baselineShiftM5648boximpl, textGeometricTransform2, localeList2, j2, textDecoration2, shadow2, platformStyle, drawStyle, (DefaultConstructorMarker) null);
    }
