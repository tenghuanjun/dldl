...
public final class FocusTransactionsKt {
    ...
    public static final boolean requestFocus(FocusTargetNode focusTargetNode) {
        ...
        try {
            ...
            int i = WhenMappings.$EnumSwitchMapping$0[m3170performCustomRequestFocusMxy_nc0(focusTargetNode, FocusDirection.INSTANCE.m3146getEnterdhqQ8s()).ordinal()];
    ...
    */
                        ...
                        while (parent2 != null) {
                            if ((parent2.getKindSet() & iM4993constructorimpl2) != 0) {
                                ...
                                while (nodePop2 != null) {
                                    ...
                                    if ((nodePop2.getKindSet() & iM4993constructorimpl2) != 0 && (nodePop2 instanceof DelegatingNode)) {
                                        int i3 = 0;
                                        for (Modifier.Node delegate$ui_release2 = ((DelegatingNode) nodePop2).getDelegate(); delegate$ui_release2 != null; delegate$ui_release2 = delegate$ui_release2.getChild()) {
                                            if ((delegate$ui_release2.getKindSet() & iM4993constructorimpl2) != 0) {
                                                i3++;
                                                if (i3 == 1) {
    ...
    public static final CustomDestinationResult m3170performCustomRequestFocusMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        Modifier.Node nodePop;
        NodeChain nodes;
        int i2 = WhenMappings.$EnumSwitchMapping$1[focusTargetNode.getFocusState().ordinal()];
        if (i2 == 1 || i2 == 2) {
        ...
        if (i2 == 3) {
            return m3167performCustomClearFocusMxy_nc0(requireActiveChild(focusTargetNode), i);
        }
        if (i2 == 4) {
            ...
            if (i4 == 1) {
                return m3168performCustomEnterMxy_nc0(focusTargetNode3, i);
            }
            if (i4 == 2) {
                return CustomDestinationResult.Cancelled;
            }
            if (i4 == 3) {
                return m3170performCustomRequestFocusMxy_nc0(focusTargetNode3, i);
            }
            if (i4 != 4) {
                throw new NoWhenBranchMatchedException();
            }
            CustomDestinationResult customDestinationResultM3170performCustomRequestFocusMxy_nc0 = m3170performCustomRequestFocusMxy_nc0(focusTargetNode3, i);
            CustomDestinationResult customDestinationResult = customDestinationResultM3170performCustomRequestFocusMxy_nc0 != CustomDestinationResult.None ? customDestinationResultM3170performCustomRequestFocusMxy_nc0 : null;
            return customDestinationResult == null ? m3168performCustomEnterMxy_nc0(focusTargetNode3, i) : customDestinationResult;
        }
        throw new NoWhenBranchMatchedException();
    }

    /* JADX INFO: renamed from: performCustomClearFocus-Mxy_nc0, reason: not valid java name */
    public static final CustomDestinationResult m3167performCustomClearFocusMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        int i2 = WhenMappings.$EnumSwitchMapping$1[focusTargetNode.getFocusState().ordinal()];
        if (i2 != 1) {
            if (i2 == 2) {
                return CustomDestinationResult.Cancelled;
            ...
            if (i2 == 3) {
                CustomDestinationResult customDestinationResultM3167performCustomClearFocusMxy_nc0 = m3167performCustomClearFocusMxy_nc0(requireActiveChild(focusTargetNode), i);
                if (customDestinationResultM3167performCustomClearFocusMxy_nc0 == CustomDestinationResult.None) {
                    customDestinationResultM3167performCustomClearFocusMxy_nc0 = null;
                }
                return customDestinationResultM3167performCustomClearFocusMxy_nc0 == null ? m3169performCustomExitMxy_nc0(focusTargetNode, i) : customDestinationResultM3167performCustomClearFocusMxy_nc0;
            }
            if (i2 != 4) {
                throw new NoWhenBranchMatchedException();
            }
    ...
    private static final CustomDestinationResult m3168performCustomEnterMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        if (!focusTargetNode.isProcessingCustomEnter) {
            focusTargetNode.isProcessingCustomEnter = true;
            try {
                FocusRequester focusRequesterInvoke = focusTargetNode.fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m3136boximpl(i));
    ...
    private static final CustomDestinationResult m3169performCustomExitMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        if (!focusTargetNode.isProcessingCustomExit) {
            focusTargetNode.isProcessingCustomExit = true;
            try {
                FocusRequester focusRequesterInvoke = focusTargetNode.fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m3136boximpl(i));
                if (focusRequesterInvoke != FocusRequester.INSTANCE.getDefault()) {
                    if (focusRequesterInvoke == FocusRequester.INSTANCE.getCancel()) {
                        return CustomDestinationResult.Cancelled;
                    }
