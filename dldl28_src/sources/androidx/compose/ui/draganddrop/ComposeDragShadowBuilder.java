...
public final class ComposeDragShadowBuilder extends View.DragShadowBuilder {
    ...
    public void onProvideShadowMetrics(Point outShadowSize, Point outShadowTouchPoint) {
        ...
        outShadowSize.set(density.mo339roundToPx0680j_4(density.mo341toDpu2uoSUM(Size.m3288getWidthimpl(this.decorationSize))), density.mo339roundToPx0680j_4(density.mo341toDpu2uoSUM(Size.m3285getHeightimpl(this.decorationSize))));
    ...
    public void onDrawShadow(Canvas canvas) {
        ...
        drawParams2.m3978setSizeuvyYCjk(j);
        Canvas.save();
        ...
        drawParams3.m3978setSizeuvyYCjk(size);
    }
}
