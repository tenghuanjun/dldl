...
public final class ContentScaleKt {
    ...
    public static final float m4780computeFillMaxDimensioniLBOSCw(long j, long j2) {
        return Math.max(m4782computeFillWidthiLBOSCw(j, j2), m4779computeFillHeightiLBOSCw(j, j2));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: computeFillMinDimension-iLBOSCw, reason: not valid java name */
    public static final float m4781computeFillMinDimensioniLBOSCw(long j, long j2) {
        return Math.min(m4782computeFillWidthiLBOSCw(j, j2), m4779computeFillHeightiLBOSCw(j, j2));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: computeFillWidth-iLBOSCw, reason: not valid java name */
    public static final float m4782computeFillWidthiLBOSCw(long j, long j2) {
        return Size.m3288getWidthimpl(j2) / Size.m3288getWidthimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: computeFillHeight-iLBOSCw, reason: not valid java name */
    public static final float m4779computeFillHeightiLBOSCw(long j, long j2) {
        return Size.m3285getHeightimpl(j2) / Size.m3285getHeightimpl(j);
    }
}
