...
public interface MeasurePolicy {
    ...
    MeasureResult mo69measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j);
    ...
    public final /* synthetic */ class CC {
        public static int $default$minIntrinsicWidth(MeasurePolicy _this, IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            ...
            return _this.mo69measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), arrayList, jConstraints$default).get$w();
        }
        ...
        public static int $default$minIntrinsicHeight(MeasurePolicy _this, IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            ...
            return _this.mo69measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), arrayList, jConstraints$default).get$h();
        }
