...
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public Placeable mo4783measureBRTryo0(long constraints) {
        ...
        if (intrinsicWidthHeight == intrinsicWidthHeight2) {
            ...
            return new FixedSizeIntrinsicsPlaceable(iMinIntrinsicWidth, iM5828getMaxWidthimpl);
        }
        if (this.minMax == IntrinsicMinMax.Max) {
        ...
        return new FixedSizeIntrinsicsPlaceable(iM5828getMaxWidthimpl, iMinIntrinsicHeight);
    }
