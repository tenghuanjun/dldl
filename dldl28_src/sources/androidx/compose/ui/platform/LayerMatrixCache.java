...
public final class LayerMatrixCache<T> {
    ...
    public final float[] m5120calculateMatrixGrdbGEg(T target) {
        float[] fArrM3733constructorimpl$default = this.matrixCache;
        if (fArrM3733constructorimpl$default == null) {
            fArrM3733constructorimpl$default = androidx.compose.ui.graphics.Matrix.m3733constructorimpl$default(null, 1, null);
            this.matrixCache = fArrM3733constructorimpl$default;
        }
        if (!this.isDirty) {
            return fArrM3733constructorimpl$default;
        }
        ...
        if (matrix2 == null || !Intrinsics.areEqual(matrix, matrix2)) {
            AndroidMatrixConversions_androidKt.m3332setFromtUYjHk(fArrM3733constructorimpl$default, matrix);
    ...
    public final float[] m5119calculateInverseMatrixbWbORWo(T target) {
        float[] fArrM3733constructorimpl$default = this.inverseMatrixCache;
        if (fArrM3733constructorimpl$default == null) {
            fArrM3733constructorimpl$default = androidx.compose.ui.graphics.Matrix.m3733constructorimpl$default(null, 1, null);
            this.inverseMatrixCache = fArrM3733constructorimpl$default;
        }
        if (this.isInverseDirty) {
            this.isInverseValid = InvertMatrixKt.m5117invertToJiSxe2E(m5120calculateMatrixGrdbGEg(target), fArrM3733constructorimpl$default);
