...
public class ContentCaptureSessionCompat {
    ...
    public AutofillId newAutofillId(long j) {
        if (Build.VERSION.SDK_INT >= 29) {
            return Api29Impl.newAutofillId(RenderNodeApi29$$ExternalSyntheticApiModelOutline0.m5149m(this.mWrappedObj), ((AutofillIdCompat) Objects.requireNonNull(ViewCompatShims.getAutofillId(this.mView))).toAutofillId(), j);
        }
        return null;
    }
    ...
    public void notifyViewsDisappeared(long[] jArr) {
        if (Build.VERSION.SDK_INT >= 34) {
            Api29Impl.notifyViewsDisappeared(RenderNodeApi29$$ExternalSyntheticApiModelOutline0.m5149m(this.mWrappedObj), ((AutofillIdCompat) Objects.requireNonNull(ViewCompatShims.getAutofillId(this.mView))).toAutofillId(), jArr);
            return;
        }
        if (Build.VERSION.SDK_INT >= 29) {
            ViewStructure viewStructureNewViewStructure = Api29Impl.newViewStructure(RenderNodeApi29$$ExternalSyntheticApiModelOutline0.m5149m(this.mWrappedObj), this.mView);
