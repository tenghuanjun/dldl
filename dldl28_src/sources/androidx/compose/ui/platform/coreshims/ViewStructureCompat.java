...
public class ViewStructureCompat {
    ...
    public ViewStructure toViewStructure() {
        return NotificationCompat$$ExternalSyntheticApiModelOutline0.m6149m(this.mWrappedObj);
    }
    ...
    public void setText(CharSequence charSequence) {
        if (Build.VERSION.SDK_INT >= 23) {
            Api23Impl.setText(NotificationCompat$$ExternalSyntheticApiModelOutline0.m6149m(this.mWrappedObj), charSequence);
        }
    }

    public void setClassName(String str) {
        if (Build.VERSION.SDK_INT >= 23) {
            Api23Impl.setClassName(NotificationCompat$$ExternalSyntheticApiModelOutline0.m6149m(this.mWrappedObj), str);
        }
    }

    public void setTextStyle(float f, int i, int i2, int i3) {
        if (Build.VERSION.SDK_INT >= 23) {
            Api23Impl.setTextStyle(NotificationCompat$$ExternalSyntheticApiModelOutline0.m6149m(this.mWrappedObj), f, i, i2, i3);
        }
    }

    public void setContentDescription(CharSequence charSequence) {
        if (Build.VERSION.SDK_INT >= 23) {
            Api23Impl.setContentDescription(NotificationCompat$$ExternalSyntheticApiModelOutline0.m6149m(this.mWrappedObj), charSequence);
        }
    }

    public void setDimens(int i, int i2, int i3, int i4, int i5, int i6) {
        if (Build.VERSION.SDK_INT >= 23) {
            Api23Impl.setDimens(NotificationCompat$$ExternalSyntheticApiModelOutline0.m6149m(this.mWrappedObj), i, i2, i3, i4, i5, i6);
        }
    }
