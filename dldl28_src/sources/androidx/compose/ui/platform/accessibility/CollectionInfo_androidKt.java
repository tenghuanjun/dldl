    ...
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (arrayListEmptyList.size() == 1) {
            ...
            if (1 <= lastIndex2) {
                int i2 = 1;
                while (true) {
                    objFirst = Offset.m3208boximpl(Offset.m3224plusMKHz9U(((Offset) objFirst).getPackedValue(), ((Offset) arrayListEmptyList.get(i2)).getPackedValue()));
                    if (i2 == lastIndex2) {
                        break;
                    }
                    i2++;
        ...
        return Offset.m3210component2impl(packedValue) < Offset.m3209component1impl(packedValue);
    }
