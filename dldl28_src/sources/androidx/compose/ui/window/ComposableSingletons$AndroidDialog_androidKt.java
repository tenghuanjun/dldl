...
public final class ComposableSingletons$AndroidDialog_androidKt {
    ...
    public static Function2<Composer, Integer, Unit> f54lambda1 = ComposableLambdaKt.composableLambdaInstance(210148896, false, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.window.ComposableSingletons$AndroidDialog_androidKt$lambda-1$1
    ...
    public final Function2<Composer, Integer, Unit> m6137getLambda1$ui_release() {
        return f54lambda1;
    }
}
