...
public final /* data */ class DpRect {
    ...
    public static /* synthetic */ DpRect m5954copya9UjIt4$default(DpRect dpRect, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = dpRect.left;
        }
        if ((i & 2) != 0) {
    ...
    public final DpRect m5963copya9UjIt4(float left, float top, float right, float bottom) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5887equalsimpl0(this.left, dpRect.left) && Dp.m5887equalsimpl0(this.top, dpRect.top) && Dp.m5887equalsimpl0(this.right, dpRect.right) && Dp.m5887equalsimpl0(this.bottom, dpRect.bottom);
    }
    ...
    public String toString() {
        return "DpRect(left=" + ((Object) Dp.m5893toStringimpl(this.left)) + ", top=" + ((Object) Dp.m5893toStringimpl(this.top)) + ", right=" + ((Object) Dp.m5893toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m5893toStringimpl(this.bottom)) + ')';
    }
    ...
    public final float m5965getLeftD9Ej5fM() {
        return this.left;
    }

    /* JADX INFO: renamed from: getTop-D9Ej5fM, reason: not valid java name */
    public final float m5967getTopD9Ej5fM() {
        return this.top;
    }

    /* JADX INFO: renamed from: getRight-D9Ej5fM, reason: not valid java name */
    public final float m5966getRightD9Ej5fM() {
        return this.right;
    }

    /* JADX INFO: renamed from: getBottom-D9Ej5fM, reason: not valid java name */
    public final float m5964getBottomD9Ej5fM() {
        return this.bottom;
    }

    private DpRect(long j, long j2) {
        this(DpOffset.m5943getXD9Ej5fM(j), DpOffset.m5945getYD9Ej5fM(j), Dp.m5882constructorimpl(DpOffset.m5943getXD9Ej5fM(j) + DpSize.m5980getWidthD9Ej5fM(j2)), Dp.m5882constructorimpl(DpOffset.m5945getYD9Ej5fM(j) + DpSize.m5978getHeightD9Ej5fM(j2)), null);
    }
}
