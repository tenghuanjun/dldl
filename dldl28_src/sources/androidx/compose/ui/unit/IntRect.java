...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m6032getSizeYbymL2g$annotations() {
    }
    ...
    public final long m6040getSizeYbymL2g() {
    ...
    public final IntRect m6044translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m6014getXimpl(offset), this.top + IntOffset.m6015getYimpl(offset), this.right + IntOffset.m6014getXimpl(offset), this.bottom + IntOffset.m6015getYimpl(offset));
    }
    ...
    public final long m6037getCenternOccac() {
    ...
    public final long m6039getCenterRightnOccac() {
    ...
    public final long m6035getBottomLeftnOccac() {
    ...
    public final long m6034getBottomCenternOccac() {
    ...
    public final long m6036getBottomRightnOccac() {
        return IntOffsetKt.IntOffset(this.right, this.bottom);
    }

    /* JADX INFO: renamed from: contains--gyyYBs, reason: not valid java name */
    public final boolean m6033containsgyyYBs(long offset) {
        return IntOffset.m6014getXimpl(offset) >= this.left && IntOffset.m6014getXimpl(offset) < this.right && IntOffset.m6015getYimpl(offset) >= this.top && IntOffset.m6015getYimpl(offset) < this.bottom;
    }
