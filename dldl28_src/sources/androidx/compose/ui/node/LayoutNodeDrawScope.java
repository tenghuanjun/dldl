...
public final class LayoutNodeDrawScope implements DrawScope, ContentDrawScope {
    ...
    public void mo3953drawArcillE91I(Brush brush, float startAngle, float sweepAngle, boolean useCenter, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo3953drawArcillE91I(brush, startAngle, sweepAngle, useCenter, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo3954drawArcyD3GUKo(long color, float startAngle, float sweepAngle, boolean useCenter, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo3954drawArcyD3GUKo(color, startAngle, sweepAngle, useCenter, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo3955drawCircleV9BoPsw(Brush brush, float radius, long center, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo3955drawCircleV9BoPsw(brush, radius, center, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo3956drawCircleVaOC9Bg(long color, float radius, long center, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo3956drawCircleVaOC9Bg(color, radius, center, alpha, style, colorFilter, blendMode);
    }
    ...
    public /* synthetic */ void mo3957drawImage9jGpkUE(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo3957drawImage9jGpkUE(image, srcOffset, srcSize, dstOffset, dstSize, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo3958drawImageAZ2fEMs(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode, int filterQuality) {
        this.canvasDrawScope.mo3958drawImageAZ2fEMs(image, srcOffset, srcSize, dstOffset, dstSize, alpha, style, colorFilter, blendMode, filterQuality);
    }
    ...
    public void mo3959drawImagegbVJVH8(ImageBitmap image, long topLeft, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo3959drawImagegbVJVH8(image, topLeft, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo3960drawLine1RTmtNc(Brush brush, long start, long end, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo3960drawLine1RTmtNc(brush, start, end, strokeWidth, cap, pathEffect, alpha, colorFilter, blendMode);
    }
    ...
    public void mo3961drawLineNGM6Ib0(long color, long start, long end, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo3961drawLineNGM6Ib0(color, start, end, strokeWidth, cap, pathEffect, alpha, colorFilter, blendMode);
    }
    ...
    public void mo3962drawOvalAsUm42w(Brush brush, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo3962drawOvalAsUm42w(brush, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo3963drawOvalnJ9OG0(long color, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo3963drawOvalnJ9OG0(color, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo3964drawPathGBMwjPU(Path path, Brush brush, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo3964drawPathGBMwjPU(path, brush, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo3965drawPathLG529CI(Path path, long color, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo3965drawPathLG529CI(path, color, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo3966drawPointsF8ZwMP8(List<Offset> points, int pointMode, long color, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo3966drawPointsF8ZwMP8(points, pointMode, color, strokeWidth, cap, pathEffect, alpha, colorFilter, blendMode);
    }
    ...
    public void mo3967drawPointsGsft0Ws(List<Offset> points, int pointMode, Brush brush, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo3967drawPointsGsft0Ws(points, pointMode, brush, strokeWidth, cap, pathEffect, alpha, colorFilter, blendMode);
    }
    ...
    public void mo3968drawRectAsUm42w(Brush brush, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo3968drawRectAsUm42w(brush, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo3969drawRectnJ9OG0(long color, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo3969drawRectnJ9OG0(color, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo3970drawRoundRectZuiqVtQ(Brush brush, long topLeft, long size, long cornerRadius, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo3970drawRoundRectZuiqVtQ(brush, topLeft, size, cornerRadius, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo3971drawRoundRectuAw5IA(long color, long topLeft, long size, long cornerRadius, DrawStyle style, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo3971drawRoundRectuAw5IA(color, topLeft, size, cornerRadius, style, alpha, colorFilter, blendMode);
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* JADX INFO: renamed from: getCenter-F1C5BW0 */
    public long mo3972getCenterF1C5BW0() {
        return this.canvasDrawScope.mo3972getCenterF1C5BW0();
    }
    ...
    public long mo3973getSizeNHjbRc() {
        return this.canvasDrawScope.mo3973getSizeNHjbRc();
    }

    @Override // androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: roundToPx--R2X_6o */
    public int mo338roundToPxR2X_6o(long j) {
        return this.canvasDrawScope.mo338roundToPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: roundToPx-0680j_4 */
    public int mo339roundToPx0680j_4(float f) {
        return this.canvasDrawScope.mo339roundToPx0680j_4(f);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* JADX INFO: renamed from: toDp-GaN1DYA */
    public float mo340toDpGaN1DYA(long j) {
        return this.canvasDrawScope.mo340toDpGaN1DYA(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: toDp-u2uoSUM */
    public float mo341toDpu2uoSUM(float f) {
        return this.canvasDrawScope.mo341toDpu2uoSUM(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: toDp-u2uoSUM */
    public float mo342toDpu2uoSUM(int i) {
        return this.canvasDrawScope.mo342toDpu2uoSUM(i);
    }

    @Override // androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: toDpSize-k-rfVVM */
    public long mo343toDpSizekrfVVM(long j) {
        return this.canvasDrawScope.mo343toDpSizekrfVVM(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: toPx--R2X_6o */
    public float mo344toPxR2X_6o(long j) {
        return this.canvasDrawScope.mo344toPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: toPx-0680j_4 */
    public float mo345toPx0680j_4(float f) {
        return this.canvasDrawScope.mo345toPx0680j_4(f);
    }
    ...
    public long mo346toSizeXkaWNTQ(long j) {
        return this.canvasDrawScope.mo346toSizeXkaWNTQ(j);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* JADX INFO: renamed from: toSp-0xMU5do */
    public long mo347toSp0xMU5do(float f) {
        return this.canvasDrawScope.mo347toSp0xMU5do(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: toSp-kPz2Gy4 */
    public long mo348toSpkPz2Gy4(float f) {
        return this.canvasDrawScope.mo348toSpkPz2Gy4(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: toSp-kPz2Gy4 */
    public long mo349toSpkPz2Gy4(int i) {
        return this.canvasDrawScope.mo349toSpkPz2Gy4(i);
    }
    ...
    public void drawContent() {
        ...
        if (nodeNextDrawNode == 0) {
            NodeCoordinator nodeCoordinatorM4889requireCoordinator64DMado = DelegatableNodeKt.m4889requireCoordinator64DMado(drawModifierNode2, NodeKind.m4993constructorimpl(4));
            if (nodeCoordinatorM4889requireCoordinator64DMado.getTail() == drawModifierNode.getNode()) {
                nodeCoordinatorM4889requireCoordinator64DMado = nodeCoordinatorM4889requireCoordinator64DMado.getWrapped();
                Intrinsics.checkNotNull(nodeCoordinatorM4889requireCoordinator64DMado);
            }
            nodeCoordinatorM4889requireCoordinator64DMado.performDraw(canvas);
            return;
        }
        ...
        while (nodeNextDrawNode != 0) {
            ...
            } else if ((nodeNextDrawNode.getKindSet() & iM4993constructorimpl) != 0 && (nodeNextDrawNode instanceof DelegatingNode)) {
    ...
    public final void performDraw(DrawModifierNode drawModifierNode, Canvas canvas) {
        NodeCoordinator nodeCoordinatorM4889requireCoordinator64DMado = DelegatableNodeKt.m4889requireCoordinator64DMado(drawModifierNode, NodeKind.m4993constructorimpl(4));
        nodeCoordinatorM4889requireCoordinator64DMado.getLayoutNode().getMDrawScope$ui_release().m4927drawDirectx_KDEd0$ui_release(canvas, IntSizeKt.m6066toSizeozmzZPI(nodeCoordinatorM4889requireCoordinator64DMado.mo4790getSizeYbymL2g()), nodeCoordinatorM4889requireCoordinator64DMado, drawModifierNode);
    }

    /* JADX INFO: renamed from: drawDirect-x_KDEd0$ui_release, reason: not valid java name */
    public final void m4927drawDirectx_KDEd0$ui_release(Canvas canvas, long size, NodeCoordinator coordinator, DrawModifierNode drawNode) {
        DrawModifierNode drawModifierNode = this.drawNode;
    ...
    public final void m4926drawx_KDEd0$ui_release(Canvas canvas, long size, NodeCoordinator coordinator, Modifier.Node drawNode) {
        int iM4993constructorimpl = NodeKind.m4993constructorimpl(4);
        MutableVector mutableVector = null;
        while (drawNode != null) {
            if (drawNode instanceof DrawModifierNode) {
                m4927drawDirectx_KDEd0$ui_release(canvas, size, coordinator, (DrawModifierNode) drawNode);
            } else if ((drawNode.getKindSet() & iM4993constructorimpl) != 0 && (drawNode instanceof DelegatingNode)) {
                int i = 0;
