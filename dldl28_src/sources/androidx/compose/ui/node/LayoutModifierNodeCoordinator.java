...
public final class LayoutModifierNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateForLayoutModifierNode extends LookaheadDelegate {
        ...
        public Placeable mo4783measureBRTryo0(long constraints) {
            ...
            lookaheadDelegateForLayoutModifierNode.m4835setMeasurementConstraintsBRTryo0(constraints);
            layoutModifierNodeCoordinator.lookaheadConstraints = Constraints.m5816boximpl(constraints);
            LookaheadDelegate lookaheadDelegate = layoutModifierNodeCoordinator.getWrappedNonNull().getLookaheadDelegate();
            Intrinsics.checkNotNull(lookaheadDelegate);
            lookaheadDelegateForLayoutModifierNode.set_measureResult(layoutModifierNodeCoordinator.getLayoutModifierNode().mo121measure3p2s80s(this, lookaheadDelegate, constraints));
    ...
    /* JADX INFO: renamed from: measure-BRTryo0 */
    public Placeable mo4783measureBRTryo0(long constraints) {
        MeasureResult measureResultMo121measure3p2s80s;
        ...
        if (layoutModifierNode instanceof IntermediateLayoutModifierNode) {
            ...
            measureResultMo121measure3p2s80s = ((IntermediateLayoutModifierNode) layoutModifierNode).m4785intermediateMeasureTeuZzU(this, wrappedNonNull, constraints, jIntSize, constraints2.getValue());
        } else {
            measureResultMo121measure3p2s80s = layoutModifierNode.mo121measure3p2s80s(this, getWrappedNonNull(), constraints);
        }
        setMeasureResult$ui_release(measureResultMo121measure3p2s80s);
    ...
    static {
        ...
        Paint.mo3340setColor8_81llA(Color.INSTANCE.m3521getBlue0d7_KjU());
