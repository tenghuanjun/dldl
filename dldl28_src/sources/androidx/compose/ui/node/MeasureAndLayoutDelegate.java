...
public final class MeasureAndLayoutDelegate {
    ...
    public final void m4950updateRootConstraintsBRTryo0(long constraints) {
        ...
        this.rootConstraints = Constraints.m5816boximpl(constraints);
    ...
    private final boolean m4947doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean zM4914lookaheadRemeasure_Sx5XlM$ui_release$default;
        if (layoutNode.getLookaheadRoot() == null) {
            return false;
        }
        if (constraints != null) {
            zM4914lookaheadRemeasure_Sx5XlM$ui_release$default = layoutNode.m4918lookaheadRemeasure_Sx5XlM$ui_release(constraints);
        } else {
            zM4914lookaheadRemeasure_Sx5XlM$ui_release$default = LayoutNode.m4914lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (zM4914lookaheadRemeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return zM4914lookaheadRemeasure_Sx5XlM$ui_release$default;
    }

    /* JADX INFO: renamed from: doRemeasure-sdFAvZA, reason: not valid java name */
    private final boolean m4948doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean zM4915remeasure_Sx5XlM$ui_release$default;
        if (constraints != null) {
            zM4915remeasure_Sx5XlM$ui_release$default = layoutNode.m4919remeasure_Sx5XlM$ui_release(constraints);
        } else {
            zM4915remeasure_Sx5XlM$ui_release$default = LayoutNode.m4915remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (zM4915remeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return zM4915remeasure_Sx5XlM$ui_release$default;
    }
    ...
    public final void m4949measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        if (layoutNode.getIsDeactivated()) {
            return;
        }
        ...
        if (this.rootConstraints != null) {
            ...
            try {
                ...
                boolean zM4947doLookaheadRemeasuresdFAvZA = m4947doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m5816boximpl(constraints));
                m4948doRemeasuresdFAvZA(layoutNode, Constraints.m5816boximpl(constraints));
                if ((zM4947doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true)) {
    ...
    private final boolean remeasureAndRelayoutIfNeeded(LayoutNode layoutNode, boolean affectsLookahead, boolean relayoutNeeded) {
        ...
        boolean zM4947doLookaheadRemeasuresdFAvZA;
        boolean zM4948doRemeasuresdFAvZA;
        LayoutNode parent$ui_release;
        int i = 0;
        if (layoutNode.getIsDeactivated()) {
            return false;
        ...
        if (layoutNode.getLookaheadMeasurePending$ui_release() || layoutNode.getMeasurePending$ui_release()) {
            ...
            zM4947doLookaheadRemeasuresdFAvZA = (layoutNode.getLookaheadMeasurePending$ui_release() && affectsLookahead) ? m4947doLookaheadRemeasuresdFAvZA(layoutNode, constraints) : false;
            zM4948doRemeasuresdFAvZA = m4948doRemeasuresdFAvZA(layoutNode, constraints);
        } else {
            zM4948doRemeasuresdFAvZA = false;
            zM4947doLookaheadRemeasuresdFAvZA = false;
        }
        if (relayoutNeeded) {
            if ((zM4947doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true) && affectsLookahead) {
                layoutNode.lookaheadReplace$ui_release();
            }
        ...
        return zM4948doRemeasuresdFAvZA;
    }
    ...
    private final void remeasureOnly(LayoutNode layoutNode, boolean affectsLookahead) {
        ...
        if (affectsLookahead) {
            m4947doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
        } else {
            m4948doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
