...
public final class NodeKindKt {
    ...
    public static final boolean m5001contains64DMado(int i, int i2) {
        return (i & i2) != 0;
    }
    ...
    public static final int m5003or64DMado(int i, int i2) {
        return i | i2;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Node node) {
        ...
        int iM4993constructorimpl = NodeKind.m4993constructorimpl(1);
        if (node instanceof LayoutModifierNode) {
            iM4993constructorimpl |= NodeKind.m4993constructorimpl(2);
        }
        if (node instanceof DrawModifierNode) {
            iM4993constructorimpl |= NodeKind.m4993constructorimpl(4);
        }
        if (node instanceof SemanticsModifierNode) {
            iM4993constructorimpl |= NodeKind.m4993constructorimpl(8);
        }
        if (node instanceof PointerInputModifierNode) {
            iM4993constructorimpl |= NodeKind.m4993constructorimpl(16);
        }
        if (node instanceof ModifierLocalModifierNode) {
            iM4993constructorimpl |= NodeKind.m4993constructorimpl(32);
        }
        if (node instanceof ParentDataModifierNode) {
            iM4993constructorimpl |= NodeKind.m4993constructorimpl(64);
        }
        if (node instanceof LayoutAwareModifierNode) {
            iM4993constructorimpl |= NodeKind.m4993constructorimpl(128);
        }
        if (node instanceof GlobalPositionAwareModifierNode) {
            iM4993constructorimpl |= NodeKind.m4993constructorimpl(256);
        }
        if (node instanceof IntermediateLayoutModifierNode) {
            iM4993constructorimpl |= NodeKind.m4993constructorimpl(512);
        }
        if (node instanceof FocusTargetNode) {
            iM4993constructorimpl |= NodeKind.m4993constructorimpl(1024);
        }
        if (node instanceof FocusPropertiesModifierNode) {
            iM4993constructorimpl |= NodeKind.m4993constructorimpl(2048);
        }
        if (node instanceof FocusEventModifierNode) {
            iM4993constructorimpl |= NodeKind.m4993constructorimpl(4096);
        }
        if (node instanceof KeyInputModifierNode) {
            iM4993constructorimpl |= NodeKind.m4993constructorimpl(8192);
        }
        if (node instanceof RotaryInputModifierNode) {
            iM4993constructorimpl |= NodeKind.m4993constructorimpl(16384);
        }
        if (node instanceof CompositionLocalConsumerModifierNode) {
            iM4993constructorimpl |= NodeKind.m4993constructorimpl(32768);
        }
        if (node instanceof SoftKeyboardInterceptionModifierNode) {
            iM4993constructorimpl |= NodeKind.m4993constructorimpl(131072);
        }
        return node instanceof TraversableNode ? iM4993constructorimpl | NodeKind.m4993constructorimpl(262144) : iM4993constructorimpl;
    }
    ...
    private static final void autoInvalidateNodeSelf(Modifier.Node node, int i, int i2) {
        if (i2 != 0 || node.getShouldAutoInvalidate()) {
            if ((NodeKind.m4993constructorimpl(2) & i) != 0 && (node instanceof LayoutModifierNode)) {
                LayoutModifierNodeKt.invalidateMeasurement((LayoutModifierNode) node);
                if (i2 == 2) {
                    DelegatableNodeKt.m4889requireCoordinator64DMado(node, NodeKind.m4993constructorimpl(2)).onRelease();
                }
            }
            if ((NodeKind.m4993constructorimpl(256) & i) != 0 && (node instanceof GlobalPositionAwareModifierNode)) {
                DelegatableNodeKt.requireLayoutNode(node).invalidateMeasurements$ui_release();
            }
            if ((NodeKind.m4993constructorimpl(4) & i) != 0 && (node instanceof DrawModifierNode)) {
                DrawModifierNodeKt.invalidateDraw((DrawModifierNode) node);
            }
            if ((NodeKind.m4993constructorimpl(8) & i) != 0 && (node instanceof SemanticsModifierNode)) {
                SemanticsModifierNodeKt.invalidateSemantics((SemanticsModifierNode) node);
            }
            if ((NodeKind.m4993constructorimpl(64) & i) != 0 && (node instanceof ParentDataModifierNode)) {
                ParentDataModifierNodeKt.invalidateParentData((ParentDataModifierNode) node);
            }
            if ((NodeKind.m4993constructorimpl(1024) & i) != 0 && (node instanceof FocusTargetNode)) {
                if (i2 == 2) {
                    node.onReset();
                } else {
            ...
            if ((NodeKind.m4993constructorimpl(2048) & i) != 0 && (node instanceof FocusPropertiesModifierNode)) {
            ...
            if ((i & NodeKind.m4993constructorimpl(4096)) == 0 || !(node instanceof FocusEventModifierNode)) {
                return;
            }
    ...
    public static final boolean m5002getIncludeSelfInTraversalH91voCI(int i) {
        return (i & NodeKind.m4993constructorimpl(128)) != 0;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Element element) {
        ...
        return ((element instanceof OnPlacedModifier) || (element instanceof OnRemeasuredModifier)) ? iM4993constructorimpl | NodeKind.m4993constructorimpl(128) : iM4993constructorimpl;
    }
}
