...
public final class BlendModeColorFilter extends ColorFilter {
    ...
    private BlendModeColorFilter(long j, int i) {
        this(j, i, AndroidColorFilter_androidKt.m3327actualTintColorFilterxETnrds(j, i), null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3495equalsimpl0(this.color, blendModeColorFilter.color) && BlendMode.m3405equalsimpl0(this.blendMode, blendModeColorFilter.blendMode);
    }

    public int hashCode() {
        return (Color.m3501hashCodeimpl(this.color) * 31) + BlendMode.m3406hashCodeimpl(this.blendMode);
    }

    public String toString() {
        return "BlendModeColorFilter(color=" + ((Object) Color.m3502toStringimpl(this.color)) + ", blendMode=" + ((Object) BlendMode.m3407toStringimpl(this.blendMode)) + ')';
    }
}
