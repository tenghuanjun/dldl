...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint paint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m3436getSrcOver0nO6VwU();
    }
    ...
    public long mo3334getColor0d7_KjU() {
    ...
    public void mo3340setColor8_81llA(long j) {
        AndroidPaint_androidKt.m3346setNativeColor4WTKRHQ(this.internalPaint, j);
    }
    ...
    public void mo3339setBlendModes9anfk8(int i) {
        if (BlendMode.m3405equalsimpl0(this._blendMode, i)) {
            return;
        }
        this._blendMode = i;
        AndroidPaint_androidKt.m3345setNativeBlendModeGB0RdKg(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* JADX INFO: renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo3338getStyleTiuSbCo() {
    ...
    public void mo3344setStylek9PVt8s(int i) {
        AndroidPaint_androidKt.m3350setNativeStyle5YerkU(this.internalPaint, i);
    }
    ...
    public int mo3336getStrokeCapKaPHkGw() {
    ...
    public void mo3342setStrokeCapBeK7IIE(int i) {
        AndroidPaint_androidKt.m3348setNativeStrokeCapCSYIeUk(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* JADX INFO: renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo3337getStrokeJoinLxFBmk8() {
    ...
    public void mo3343setStrokeJoinWw9F2mQ(int i) {
        AndroidPaint_androidKt.m3349setNativeStrokeJoinkLtJ_vA(this.internalPaint, i);
    }
    ...
    public int mo3335getFilterQualityfv9h1I() {
    ...
    public void mo3341setFilterQualityvDHp3xo(int i) {
        AndroidPaint_androidKt.m3347setNativeFilterQuality50PEsBU(this.internalPaint, i);
    }
