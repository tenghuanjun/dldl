...
public final class PathComponent extends VNode {
    ...
    public final void m4147setPathFillTypeoQ8Xj4U(int i) {
        this.pathFillType = i;
        this.renderPath.mo3354setFillTypeoQ8Xj4U(i);
        invalidate();
    }
    ...
    public final void m4148setStrokeLineCapBeK7IIE(int i) {
    ...
    public final void m4149setStrokeLineJoinWw9F2mQ(int i) {
    ...
    private final void updateRenderPath() {
        ...
        if (Intrinsics.areEqual(this.renderPath, this.path)) {
            ...
            int iMo3352getFillTypeRgk1Os = this.renderPath.mo3352getFillTypeRgk1Os();
            this.renderPath.rewind();
            this.renderPath.mo3354setFillTypeoQ8Xj4U(iMo3352getFillTypeRgk1Os);
        }
    ...
    public void draw(DrawScope drawScope) {
        ...
        if (brush != null) {
            DrawScope.CC.m4048drawPathGBMwjPU$default(drawScope, this.renderPath, brush, this.fillAlpha, null, null, 0, 56, null);
        }
        ...
        if (brush2 != null) {
            ...
            DrawScope.CC.m4048drawPathGBMwjPU$default(drawScope, this.renderPath, brush2, this.strokeAlpha, stroke, null, 0, 48, null);
        }
    }
