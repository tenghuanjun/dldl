...
public final class GroupComponent extends VNode {
    ...
    public GroupComponent() {
        ...
        this.tintColor = Color.INSTANCE.m3530getUnspecified0d7_KjU();
    ...
    private final void markTintForBrush(Brush brush) {
        if (this.isTintable && brush != null) {
            if (brush instanceof SolidColor) {
                m4134markTintForColor8_81llA(((SolidColor) brush).getValue());
            } else {
                markNotTintable();
            }
        }
    ...
    private final void m4134markTintForColor8_81llA(long color) {
        if (this.isTintable && color != Color.INSTANCE.m3530getUnspecified0d7_KjU()) {
            if (this.tintColor == Color.INSTANCE.m3530getUnspecified0d7_KjU()) {
                this.tintColor = color;
            } else {
                if (VectorKt.m4157rgbEqualOWjLjI(this.tintColor, color)) {
                    return;
                }
                markNotTintable();
            }
    ...
    public final void markTintForVNode(VNode node) {
        if (node instanceof PathComponent) {
            ...
            if (groupComponent.isTintable && this.isTintable) {
                m4134markTintForColor8_81llA(groupComponent.tintColor);
            } else {
                markNotTintable();
            }
        }
    ...
    private final void updateMatrix() {
        float[] fArrM3733constructorimpl$default = this.groupMatrix;
        if (fArrM3733constructorimpl$default == null) {
            fArrM3733constructorimpl$default = Matrix.m3733constructorimpl$default(null, 1, null);
            this.groupMatrix = fArrM3733constructorimpl$default;
        } else {
            Matrix.m3742resetimpl(fArrM3733constructorimpl$default);
        }
        Matrix.m3753translateimpl$default(fArrM3733constructorimpl$default, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m3745rotateZimpl(fArrM3733constructorimpl$default, this.rotation);
        Matrix.m3746scaleimpl(fArrM3733constructorimpl$default, this.scaleX, this.scaleY, 1.0f);
        Matrix.m3753translateimpl$default(fArrM3733constructorimpl$default, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void draw(DrawScope drawScope) {
        ...
        if (fArr != null) {
            transform.mo3987transform58bKbWc((fArr != null ? Matrix.m3731boximpl(fArr) : null).m3754unboximpl());
        }
        Path path = this.clipPath;
        if (getWillClipPath() && path != null) {
            DrawTransform.CC.m4107clipPathmtrdDE$default(transform, path, 0, 2, null);
        }
