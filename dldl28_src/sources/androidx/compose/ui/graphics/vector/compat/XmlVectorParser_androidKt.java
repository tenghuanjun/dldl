...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m4175getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.INSTANCE.m3855getButtKaPHkGw();
        }
        return m4174getStrokeLineCapCSYIeUk(i, i2);
    }

    /* JADX INFO: renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m4174getStrokeLineCapCSYIeUk(int i, int i2) {
        if (i == 0) {
            return StrokeCap.INSTANCE.m3855getButtKaPHkGw();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeCap.INSTANCE.m3857getSquareKaPHkGw();
        }
        return StrokeCap.INSTANCE.m3856getRoundKaPHkGw();
    }

    /* JADX INFO: renamed from: getStrokeLineJoin-kLtJ_vA$default, reason: not valid java name */
    static /* synthetic */ int m4177getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.INSTANCE.m3866getMiterLxFBmk8();
        }
        return m4176getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* JADX INFO: renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m4176getStrokeLineJoinkLtJ_vA(int i, int i2) {
        if (i == 0) {
            return StrokeJoin.INSTANCE.m3866getMiterLxFBmk8();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeJoin.INSTANCE.m3865getBevelLxFBmk8();
        }
        return StrokeJoin.INSTANCE.m3867getRoundLxFBmk8();
    }
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet) throws XmlPullParserException {
        long jM3530getUnspecified0d7_KjU;
        int iM3434getSrcIn0nO6VwU;
        ...
        if (typedArrayObtainAttributes.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            if (typedValue.type != 2 && (namedColorStateList = androidVectorParser.getNamedColorStateList(typedArrayObtainAttributes, theme, "tint", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) != null) {
                jM3530getUnspecified0d7_KjU = ColorKt.Color(namedColorStateList.getDefaultColor());
            } else {
                jM3530getUnspecified0d7_KjU = Color.INSTANCE.m3530getUnspecified0d7_KjU();
            }
        } else {
            jM3530getUnspecified0d7_KjU = Color.INSTANCE.m3530getUnspecified0d7_KjU();
        }
        long j = jM3530getUnspecified0d7_KjU;
        ...
        if (i == -1) {
            iM3434getSrcIn0nO6VwU = BlendMode.INSTANCE.m3434getSrcIn0nO6VwU();
        } else if (i == 3) {
            iM3434getSrcIn0nO6VwU = BlendMode.INSTANCE.m3436getSrcOver0nO6VwU();
        } else if (i == 5) {
            iM3434getSrcIn0nO6VwU = BlendMode.INSTANCE.m3434getSrcIn0nO6VwU();
        } else if (i == 9) {
            iM3434getSrcIn0nO6VwU = BlendMode.INSTANCE.m3433getSrcAtop0nO6VwU();
        } else {
            switch (i) {
                case 14:
                    iM3434getSrcIn0nO6VwU = BlendMode.INSTANCE.m3425getModulate0nO6VwU();
                    break;
                case 15:
                    iM3434getSrcIn0nO6VwU = BlendMode.INSTANCE.m3430getScreen0nO6VwU();
                    break;
                case 16:
                    iM3434getSrcIn0nO6VwU = BlendMode.INSTANCE.m3428getPlus0nO6VwU();
                    break;
                default:
                    iM3434getSrcIn0nO6VwU = BlendMode.INSTANCE.m3434getSrcIn0nO6VwU();
                    break;
        ...
        int i2 = iM3434getSrcIn0nO6VwU;
        float fM5882constructorimpl = Dp.m5882constructorimpl(dimension / resources.getDisplayMetrics().density);
        float fM5882constructorimpl2 = Dp.m5882constructorimpl(dimension2 / resources.getDisplayMetrics().density);
        typedArrayObtainAttributes.recycle();
        return new ImageVector.Builder(null, fM5882constructorimpl, fM5882constructorimpl2, namedFloat, namedFloat2, j, i2, namedBoolean, 1, null);
    }
    ...
    public static final void parsePath(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int iM4174getStrokeLineCapCSYIeUk = m4174getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(typedArrayObtainAttributes, "strokeLineCap", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.INSTANCE.m3855getButtKaPHkGw());
        int iM4176getStrokeLineJoinkLtJ_vA = m4176getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(typedArrayObtainAttributes, "strokeLineJoin", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.INSTANCE.m3865getBevelLxFBmk8());
        ...
        builder.m4141addPathoIyEayM(listAddPathNodes, namedInt == 0 ? companion.m3786getNonZeroRgk1Os() : companion.m3785getEvenOddRgk1Os(), str, brushObtainBrushFromComplexColor, namedFloat, brushObtainBrushFromComplexColor2, namedFloat3, namedFloat4, iM4174getStrokeLineCapCSYIeUk, iM4176getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
    ...
    public static final void parseClipPath(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ImageVector.Builder builder) {
        ...
        typedArrayObtainAttributes.recycle();
        builder.addGroup((KeyBoardKey.KeyboardKeyOemClear & 1) != 0 ? "" : string, (KeyBoardKey.KeyboardKeyOemClear & 2) != 0 ? 0.0f : 0.0f, (KeyBoardKey.KeyboardKeyOemClear & 4) != 0 ? 0.0f : 0.0f, (KeyBoardKey.KeyboardKeyOemClear & 8) != 0 ? 0.0f : 0.0f, (KeyBoardKey.KeyboardKeyOemClear & 16) != 0 ? 1.0f : 0.0f, (KeyBoardKey.KeyboardKeyOemClear & 32) == 0 ? 0.0f : 1.0f, (KeyBoardKey.KeyboardKeyOemClear & 64) != 0 ? 0.0f : 0.0f, (KeyBoardKey.KeyboardKeyOemClear & 128) == 0 ? 0.0f : 0.0f, (KeyBoardKey.KeyboardKeyOemClear & 256) != 0 ? VectorKt.getEmptyPath() : listAddPathNodes);
    }
