...
public abstract class Painter {
    ...
    public abstract long mo4126getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m4131drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter, int i, Object obj) {
        if (obj != null) {
        ...
        painter.m4132drawx_KDEd0(drawScope, j, f2, colorFilter);
    }

    /* JADX INFO: renamed from: draw-x_KDEd0, reason: not valid java name */
    public final void m4132drawx_KDEd0(DrawScope drawScope, long j, float f, ColorFilter colorFilter) {
        configureAlpha(f);
        configureColorFilter(colorFilter);
        configureLayoutDirection(drawScope.getLayoutDirection());
        float fM3288getWidthimpl = Size.m3288getWidthimpl(drawScope.mo3973getSizeNHjbRc()) - Size.m3288getWidthimpl(j);
        float fM3285getHeightimpl = Size.m3285getHeightimpl(drawScope.mo3973getSizeNHjbRc()) - Size.m3285getHeightimpl(j);
        drawScope.getDrawContext().getTransform().inset(0.0f, 0.0f, fM3288getWidthimpl, fM3285getHeightimpl);
        if (f > 0.0f && Size.m3288getWidthimpl(j) > 0.0f && Size.m3285getHeightimpl(j) > 0.0f) {
            if (this.useLayer) {
                Rect rectM3259Recttz77jQw = RectKt.m3259Recttz77jQw(Offset.INSTANCE.m3235getZeroF1C5BW0(), SizeKt.Size(Size.m3288getWidthimpl(j), Size.m3285getHeightimpl(j)));
                Canvas canvas = drawScope.getDrawContext().getCanvas();
                try {
                    canvas.saveLayer(rectM3259Recttz77jQw, obtainPaint());
                    onDraw(drawScope);
                } finally {
                    canvas.restore();
                }
