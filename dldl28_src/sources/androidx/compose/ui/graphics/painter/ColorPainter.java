...
public final class ColorPainter extends Painter {
    ...
    protected void onDraw(DrawScope drawScope) {
        DrawScope.CC.m4053drawRectnJ9OG0$default(drawScope, this.color, 0L, 0L, this.alpha, null, this.colorFilter, 0, 86, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorPainter) && Color.m3495equalsimpl0(this.color, ((ColorPainter) other).color);
    }

    public int hashCode() {
        return Color.m3501hashCodeimpl(this.color);
    }

    public String toString() {
        return "ColorPainter(color=" + ((Object) Color.m3502toStringimpl(this.color)) + ')';
    }
