...
public final class BitmapPainter extends Painter {
    ...
    public /* synthetic */ BitmapPainter(ImageBitmap imageBitmap, long j, long j2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(imageBitmap, (i & 2) != 0 ? IntOffset.INSTANCE.m6024getZeronOccac() : j, (i & 4) != 0 ? IntSizeKt.IntSize(imageBitmap.getWidth(), imageBitmap.getHeight()) : j2, null);
    }
    ...
    private BitmapPainter(ImageBitmap imageBitmap, long j, long j2) {
        ...
        this.srcOffset = j;
        this.srcSize = j2;
        this.filterQuality = FilterQuality.INSTANCE.m3595getLowfv9h1I();
        this.size = m4124validateSizeN5eqBDc(j, j2);
        this.alpha = 1.0f;
    }
    ...
    public final void m4127setFilterQualityvDHp3xo$ui_graphics_release(int i) {
        this.filterQuality = i;
    }

    @Override // androidx.compose.ui.graphics.painter.Painter
    protected void onDraw(DrawScope drawScope) {
        DrawScope.CC.m4042drawImageAZ2fEMs$default(drawScope, this.image, this.srcOffset, this.srcSize, 0L, IntSizeKt.IntSize(MathKt.roundToInt(Size.m3288getWidthimpl(drawScope.mo3973getSizeNHjbRc())), MathKt.roundToInt(Size.m3285getHeightimpl(drawScope.mo3973getSizeNHjbRc()))), this.alpha, null, this.colorFilter, 0, this.filterQuality, 328, null);
    }

    @Override // androidx.compose.ui.graphics.painter.Painter
    /* JADX INFO: renamed from: getIntrinsicSize-NH-jbRc, reason: not valid java name */
    public long mo4126getIntrinsicSizeNHjbRc() {
        return IntSizeKt.m6066toSizeozmzZPI(this.size);
    }
    ...
    private final long m4124validateSizeN5eqBDc(long srcOffset, long srcSize) {
        if (IntOffset.m6014getXimpl(srcOffset) < 0 || IntOffset.m6015getYimpl(srcOffset) < 0 || IntSize.m6056getWidthimpl(srcSize) < 0 || IntSize.m6055getHeightimpl(srcSize) < 0 || IntSize.m6056getWidthimpl(srcSize) > this.image.getWidth() || IntSize.m6055getHeightimpl(srcSize) > this.image.getHeight()) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.image, bitmapPainter.image) && IntOffset.m6013equalsimpl0(this.srcOffset, bitmapPainter.srcOffset) && IntSize.m6054equalsimpl0(this.srcSize, bitmapPainter.srcSize) && FilterQuality.m3590equalsimpl0(this.filterQuality, bitmapPainter.filterQuality);
    }

    public int hashCode() {
        return (((((this.image.hashCode() * 31) + IntOffset.m6016hashCodeimpl(this.srcOffset)) * 31) + IntSize.m6057hashCodeimpl(this.srcSize)) * 31) + FilterQuality.m3591hashCodeimpl(this.filterQuality);
    }

    public String toString() {
        return "BitmapPainter(image=" + this.image + ", srcOffset=" + ((Object) IntOffset.m6021toStringimpl(this.srcOffset)) + ", srcSize=" + ((Object) IntSize.m6059toStringimpl(this.srcSize)) + ", filterQuality=" + ((Object) FilterQuality.m3592toStringimpl(this.filterQuality)) + ')';
    }
}
