...
public interface PositionCalculator {
    ...
    void mo4738localToScreen58bKbWc(float[] localTransform);

    /* JADX INFO: renamed from: localToScreen-MK-Hz9U, reason: not valid java name */
    long mo4739localToScreenMKHz9U(long localPosition);

    /* JADX INFO: renamed from: screenToLocal-MK-Hz9U, reason: not valid java name */
    long mo4740screenToLocalMKHz9U(long positionOnScreen);
}
