...
final class PointerInputChangeEventProducer {
    ...
    public final InternalPointerEvent produce(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator) {
        long uptime;
        boolean down;
        long jMo4740screenToLocalMKHz9U;
        ...
        for (int i = 0; i < size; i++) {
            ...
            PointerInputData pointerInputData = this.previousPointerInputData.get(pointerInputEventData.m4671getIdJ3iCeTQ());
            if (pointerInputData == null) {
                uptime = pointerInputEventData.getUptime();
                jMo4740screenToLocalMKHz9U = pointerInputEventData.m4673getPositionF1C5BW0();
                down = false;
            } else {
                long uptime2 = pointerInputData.getUptime();
                uptime = uptime2;
                down = pointerInputData.getDown();
                jMo4740screenToLocalMKHz9U = positionCalculator.mo4740screenToLocalMKHz9U(pointerInputData.getPositionOnScreen());
            }
            longSparseArray.put(pointerInputEventData.m4671getIdJ3iCeTQ(), new PointerInputChange(pointerInputEventData.m4671getIdJ3iCeTQ(), pointerInputEventData.getUptime(), pointerInputEventData.m4673getPositionF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.getPressure(), uptime, jMo4740screenToLocalMKHz9U, down, false, pointerInputEventData.m4676getTypeT8wyACA(), pointerInputEventData.getHistorical(), pointerInputEventData.m4675getScrollDeltaF1C5BW0(), pointerInputEventData.m4672getOriginalEventPositionF1C5BW0(), null));
            if (pointerInputEventData.getDown()) {
                this.previousPointerInputData.put(pointerInputEventData.m4671getIdJ3iCeTQ(), new PointerInputData(pointerInputEventData.getUptime(), pointerInputEventData.m4674getPositionOnScreenF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.m4676getTypeT8wyACA(), null));
            } else {
                this.previousPointerInputData.remove(pointerInputEventData.m4671getIdJ3iCeTQ());
            }
        }
