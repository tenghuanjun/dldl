...
public final class ProcessResult {
    ...
    public static final boolean m4744equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: getAnyMovementConsumed-impl, reason: not valid java name */
    public static final boolean m4745getAnyMovementConsumedimpl(int i) {
        return (i & 2) != 0;
    }

    /* JADX INFO: renamed from: getDispatchedToAPointerInputModifier-impl, reason: not valid java name */
    public static final boolean m4746getDispatchedToAPointerInputModifierimpl(int i) {
        return (i & 1) != 0;
    }
    ...
    public static String m4748toStringimpl(int i) {
