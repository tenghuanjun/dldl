...
public final class PersistentCompositionLocalHashMap extends PersistentHashMap<CompositionLocal<Object>, State<? extends Object>> implements PersistentCompositionLocalMap {
    ...
    public PersistentCompositionLocalMap putValue(CompositionLocal<Object> key, State<? extends Object> value) {
        TrieNode.ModificationResult<CompositionLocal<Object>, State<? extends Object>> modificationResultPut = getNode$runtime_release().put(key.hashCode(), key, value, 0);
