    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        while (true) {
            ...
            if (childData != null && childData.isTarget()) {
                placeableArr[i] = measurable.mo4783measureBRTryo0(j);
            }
            i++;
        }
        int size3 = list.size();
        for (int i2 = 0; i2 < size3; i2++) {
            ...
            if (placeableArr[i2] == null) {
                placeableArr[i2] = measurable2.mo4783measureBRTryo0(j);
            }
        }
        if (size == 0) {
            placeable2 = null;
        ...
        this.rootScope.m94setMeasuredSizeozmzZPI$animation_release(IntSizeKt.IntSize(width3, height3));
        return MeasureScope.CC.layout$default(measureScope, width3, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentMeasurePolicy$measure$3
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                for (Placeable placeable5 : placeableArr2) {
                    if (placeable5 != null) {
                        long jMo3096alignKFBX0sM = animatedContentMeasurePolicy.getRootScope().getContentAlignment().mo3096alignKFBX0sM(IntSizeKt.IntSize(placeable5.getWidth(), placeable5.getHeight()), IntSizeKt.IntSize(i3, i4), LayoutDirection.Ltr);
                        Placeable.PlacementScope.place$default(placementScope, placeable5, IntOffset.m6014getXimpl(jMo3096alignKFBX0sM), IntOffset.m6015getYimpl(jMo3096alignKFBX0sM), 0.0f, 4, null);
                    }
                }
            }
        }, 4, null);
