...
public final class TargetBasedAnimation<T, V extends AnimationVector> implements Animation<T, V> {
    ...
    public TargetBasedAnimation(VectorizedAnimationSpec<V> vectorizedAnimationSpec, TwoWayConverter<T, V> twoWayConverter, T t, T t2, V v) {
        ...
        this.durationNanos = vectorizedAnimationSpec.getDurationNanos(vInvoke, vInvoke2, v2);
        this.endVelocity = (V) vectorizedAnimationSpec.getEndVelocity(vInvoke, vInvoke2, v2);
    }
