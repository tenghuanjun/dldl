...
public final class Animatable<T, V extends AnimationVector> {
    ...
    static final class C04802 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        final /* synthetic */ T $targetValue;
        int label;
        final /* synthetic */ Animatable<T, V> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04802(Animatable<T, V> animatable, T t, Continuation<? super C04802> continuation) {
            super(1, continuation);
            this.this$0 = animatable;
            this.$targetValue = t;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C04802(this.this$0, this.$targetValue, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Unit> continuation) {
            return ((C04802) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object snapTo(T t, Continuation<? super Unit> continuation) {
        Object objMutate$default = MutatorMutex.mutate$default(this.mutatorMutex, null, new C04802(this, t, null), continuation, 1, null);
    ...
    static final class C04812 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        int label;
        final /* synthetic */ Animatable<T, V> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04812(Animatable<T, V> animatable, Continuation<? super C04812> continuation) {
            super(1, continuation);
            this.this$0 = animatable;
        }
        ...
        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Unit> continuation) {
            return ((C04812) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object stop(Continuation<? super Unit> continuation) {
        Object objMutate$default = MutatorMutex.mutate$default(this.mutatorMutex, null, new C04812(this, null), continuation, 1, null);
        return objMutate$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objMutate$default : Unit.INSTANCE;
    }
