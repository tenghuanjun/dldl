...
public interface FloatAnimationSpec extends AnimationSpec<Float> {
    ...
    public final /* synthetic */ class CC {
        ...
        public static VectorizedFloatAnimationSpec m162$default$vectorize(FloatAnimationSpec _this, TwoWayConverter twoWayConverter) {
    ...
    public static final class DefaultImpls {
        ...
        public static <V extends AnimationVector> VectorizedFloatAnimationSpec<V> vectorize(FloatAnimationSpec floatAnimationSpec, TwoWayConverter<Float, V> twoWayConverter) {
            return CC.m162$default$vectorize(floatAnimationSpec, (TwoWayConverter) twoWayConverter);
        }
    }
}
