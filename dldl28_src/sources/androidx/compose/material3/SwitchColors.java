...
public final class SwitchColors {
    ...
    public final long m2050thumbColorWaAFU9c$material3_release(boolean enabled, boolean checked) {
    ...
    public final long m2051trackColorWaAFU9c$material3_release(boolean enabled, boolean checked) {
    ...
    public final long m2031borderColorWaAFU9c$material3_release(boolean enabled, boolean checked) {
    ...
    public final long m2049iconColorWaAFU9c$material3_release(boolean enabled, boolean checked) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3495equalsimpl0(this.checkedThumbColor, switchColors.checkedThumbColor) && Color.m3495equalsimpl0(this.checkedTrackColor, switchColors.checkedTrackColor) && Color.m3495equalsimpl0(this.checkedBorderColor, switchColors.checkedBorderColor) && Color.m3495equalsimpl0(this.checkedIconColor, switchColors.checkedIconColor) && Color.m3495equalsimpl0(this.uncheckedThumbColor, switchColors.uncheckedThumbColor) && Color.m3495equalsimpl0(this.uncheckedTrackColor, switchColors.uncheckedTrackColor) && Color.m3495equalsimpl0(this.uncheckedBorderColor, switchColors.uncheckedBorderColor) && Color.m3495equalsimpl0(this.uncheckedIconColor, switchColors.uncheckedIconColor) && Color.m3495equalsimpl0(this.disabledCheckedThumbColor, switchColors.disabledCheckedThumbColor) && Color.m3495equalsimpl0(this.disabledCheckedTrackColor, switchColors.disabledCheckedTrackColor) && Color.m3495equalsimpl0(this.disabledCheckedBorderColor, switchColors.disabledCheckedBorderColor) && Color.m3495equalsimpl0(this.disabledCheckedIconColor, switchColors.disabledCheckedIconColor) && Color.m3495equalsimpl0(this.disabledUncheckedThumbColor, switchColors.disabledUncheckedThumbColor) && Color.m3495equalsimpl0(this.disabledUncheckedTrackColor, switchColors.disabledUncheckedTrackColor) && Color.m3495equalsimpl0(this.disabledUncheckedBorderColor, switchColors.disabledUncheckedBorderColor) && Color.m3495equalsimpl0(this.disabledUncheckedIconColor, switchColors.disabledUncheckedIconColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((Color.m3501hashCodeimpl(this.checkedThumbColor) * 31) + Color.m3501hashCodeimpl(this.checkedTrackColor)) * 31) + Color.m3501hashCodeimpl(this.checkedBorderColor)) * 31) + Color.m3501hashCodeimpl(this.checkedIconColor)) * 31) + Color.m3501hashCodeimpl(this.uncheckedThumbColor)) * 31) + Color.m3501hashCodeimpl(this.uncheckedTrackColor)) * 31) + Color.m3501hashCodeimpl(this.uncheckedBorderColor)) * 31) + Color.m3501hashCodeimpl(this.uncheckedIconColor)) * 31) + Color.m3501hashCodeimpl(this.disabledCheckedThumbColor)) * 31) + Color.m3501hashCodeimpl(this.disabledCheckedTrackColor)) * 31) + Color.m3501hashCodeimpl(this.disabledCheckedBorderColor)) * 31) + Color.m3501hashCodeimpl(this.disabledCheckedIconColor)) * 31) + Color.m3501hashCodeimpl(this.disabledUncheckedThumbColor)) * 31) + Color.m3501hashCodeimpl(this.disabledUncheckedTrackColor)) * 31) + Color.m3501hashCodeimpl(this.disabledUncheckedBorderColor)) * 31) + Color.m3501hashCodeimpl(this.disabledUncheckedIconColor);
    }

    /* JADX INFO: renamed from: copy-Q_H9qLU, reason: not valid java name */
    public final SwitchColors m2032copyQ_H9qLU(long checkedThumbColor, long checkedTrackColor, long checkedBorderColor, long checkedIconColor, long uncheckedThumbColor, long uncheckedTrackColor, long uncheckedBorderColor, long uncheckedIconColor, long disabledCheckedThumbColor, long disabledCheckedTrackColor, long disabledCheckedBorderColor, long disabledCheckedIconColor, long disabledUncheckedThumbColor, long disabledUncheckedTrackColor, long disabledUncheckedBorderColor, long disabledUncheckedIconColor) {
        return new SwitchColors(checkedThumbColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? checkedThumbColor : this.checkedThumbColor, checkedTrackColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? checkedTrackColor : this.checkedTrackColor, checkedBorderColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? checkedBorderColor : this.checkedBorderColor, checkedIconColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? checkedIconColor : this.checkedIconColor, uncheckedThumbColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? uncheckedThumbColor : this.uncheckedThumbColor, uncheckedTrackColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? uncheckedTrackColor : this.uncheckedTrackColor, uncheckedBorderColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? uncheckedBorderColor : this.uncheckedBorderColor, uncheckedIconColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? uncheckedIconColor : this.uncheckedIconColor, disabledCheckedThumbColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? disabledCheckedThumbColor : this.disabledCheckedThumbColor, disabledCheckedTrackColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? disabledCheckedTrackColor : this.disabledCheckedTrackColor, disabledCheckedBorderColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? disabledCheckedBorderColor : this.disabledCheckedBorderColor, disabledCheckedIconColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? disabledCheckedIconColor : this.disabledCheckedIconColor, disabledUncheckedThumbColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? disabledUncheckedThumbColor : this.disabledUncheckedThumbColor, disabledUncheckedTrackColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? disabledUncheckedTrackColor : this.disabledUncheckedTrackColor, disabledUncheckedBorderColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? disabledUncheckedBorderColor : this.disabledUncheckedBorderColor, disabledUncheckedIconColor != Color.INSTANCE.m3530getUnspecified0d7_KjU() ? disabledUncheckedIconColor : this.disabledUncheckedIconColor, null);
    }
}
