...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m5882constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m5882constructorimpl((float) 24.0d);
    ...
    public final float m2703getContainerSizeD9Ej5fM() {
    ...
    public final float m2704getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m2705getUnselectedOutlineWidthD9Ej5fM() {
