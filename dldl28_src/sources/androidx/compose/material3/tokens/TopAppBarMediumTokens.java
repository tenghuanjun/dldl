...
public final class TopAppBarMediumTokens {
    ...
    private static final float ContainerHeight = Dp.m5882constructorimpl((float) 112.0d);
    ...
    public final float m2895getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2896getContainerHeightD9Ej5fM() {
    ...
    public final float m2897getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m2898getTrailingIconSizeD9Ej5fM() {
