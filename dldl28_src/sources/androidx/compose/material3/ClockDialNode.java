...
public final class ClockDialNode extends DelegatingNode implements PointerInputModifierNode, CompositionLocalConsumerModifierNode, LayoutAwareModifierNode {
    ...
    public final float getMaxDist() {
        return DelegatableNodeKt.requireDensity(this).mo345toPx0680j_4(TimePickerKt.MaxDistance);
    }

    @Override // androidx.compose.ui.node.LayoutAwareModifierNode
    /* JADX INFO: renamed from: onRemeasured-ozmzZPI */
    public void mo298onRemeasuredozmzZPI(long size) {
        this.state.m2219setCentergyyYBs$material3_release(IntSizeKt.m6062getCenterozmzZPI(size));
    }

    @Override // androidx.compose.ui.node.PointerInputModifierNode
    /* JADX INFO: renamed from: onPointerEvent-H0pRuoY */
    public void mo211onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        this.pointerInputTapNode.mo211onPointerEventH0pRuoY(pointerEvent, pass, bounds);
        this.pointerInputDragNode.mo211onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
