...
final class DateRangePickerStateImpl extends BaseDatePickerStateImpl implements DateRangePickerState {
    ...
    private DateRangePickerStateImpl(Long l, Long l2, Long l3, IntRange intRange, int i, SelectableDates selectableDates, Locale locale) {
        ...
        setSelection(l, l2);
        this._displayMode = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(DisplayMode.m1558boximpl(i), null, 2, null);
    }
    ...
    public void mo1549setDisplayModevCnGnXg(int i) {
        ...
        this._displayMode.setValue(DisplayMode.m1558boximpl(i));
    }
    ...
    public void setSelection(Long startDateMillis, Long endDateMillis) {
        ...
        if (canonicalDate != null && !getYearRange().contains(canonicalDate.getYear())) {
            throw new IllegalArgumentException(("The provided start date year (" + canonicalDate.getYear() + ") is out of the years range of " + getYearRange() + ClassUtils.PACKAGE_SEPARATOR_CHAR).toString());
        }
        if (canonicalDate2 != null && !getYearRange().contains(canonicalDate2.getYear())) {
            throw new IllegalArgumentException(("The provided end date year (" + canonicalDate2.getYear() + ") is out of the years range of " + getYearRange() + ClassUtils.PACKAGE_SEPARATOR_CHAR).toString());
        }
        ...
        public final Saver<DateRangePickerStateImpl, Object> Saver(final SelectableDates selectableDates, final Locale locale) {
            return ListSaverKt.listSaver(new Function2<SaverScope, DateRangePickerStateImpl, List<? extends Object>>() { // from class: androidx.compose.material3.DateRangePickerStateImpl$Companion$Saver$1
                ...
                public final List<Object> invoke(SaverScope saverScope, DateRangePickerStateImpl dateRangePickerStateImpl) {
                    return CollectionsKt.listOf(dateRangePickerStateImpl.getSelectedStartDateMillis(), dateRangePickerStateImpl.getSelectedEndDateMillis(), Long.valueOf(dateRangePickerStateImpl.getDisplayedMonthMillis()), Integer.valueOf(dateRangePickerStateImpl.getYearRange().getFirst()), Integer.valueOf(dateRangePickerStateImpl.getYearRange().getLast()), Integer.valueOf(dateRangePickerStateImpl.mo1548getDisplayModejFl4v0()));
                }
                ...
                public final DateRangePickerStateImpl invoke2(List<? extends Object> list) {
                    ...
                    return new DateRangePickerStateImpl(l, l2, l3, intRange, DisplayMode.m1559constructorimpl(((Integer) obj3).intValue()), selectableDates, locale, null);
                }
            });
        }
    }
