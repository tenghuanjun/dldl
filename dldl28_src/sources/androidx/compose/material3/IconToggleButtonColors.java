...
public final class IconToggleButtonColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3495equalsimpl0(this.containerColor, iconToggleButtonColors.containerColor) && Color.m3495equalsimpl0(this.contentColor, iconToggleButtonColors.contentColor) && Color.m3495equalsimpl0(this.disabledContainerColor, iconToggleButtonColors.disabledContainerColor) && Color.m3495equalsimpl0(this.disabledContentColor, iconToggleButtonColors.disabledContentColor) && Color.m3495equalsimpl0(this.checkedContainerColor, iconToggleButtonColors.checkedContainerColor) && Color.m3495equalsimpl0(this.checkedContentColor, iconToggleButtonColors.checkedContentColor);
    }

    public int hashCode() {
        return (((((((((Color.m3501hashCodeimpl(this.containerColor) * 31) + Color.m3501hashCodeimpl(this.contentColor)) * 31) + Color.m3501hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m3501hashCodeimpl(this.disabledContentColor)) * 31) + Color.m3501hashCodeimpl(this.checkedContainerColor)) * 31) + Color.m3501hashCodeimpl(this.checkedContentColor);
    }
}
