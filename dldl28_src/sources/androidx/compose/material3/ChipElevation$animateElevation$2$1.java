        ...
        if (i == 0) {
            ...
            if (!Dp.m5887equalsimpl0(this.$animatable.getTargetValue().m5896unboximpl(), this.$target)) {
                if (this.$enabled) {
                    ...
                    this.label = 2;
                    if (ElevationKt.m1584animateElevationrAjV9yQ(this.$animatable, this.$target, interactionAnimateElevation$lambda$2, this.$interaction, this) == coroutine_suspended) {
