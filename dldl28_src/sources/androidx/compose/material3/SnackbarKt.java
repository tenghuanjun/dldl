...
public final class SnackbarKt {
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m1938SnackbarsDKtq54(final androidx.compose.material3.SnackbarData r38, androidx.compose.ui.Modifier r39, boolean r40, androidx.compose.ui.graphics.Shape r41, long r42, long r44, long r46, long r48, long r50, androidx.compose.runtime.Composer r52, final int r53, final int r54) {
        /*
            Method dump skipped, instruction units count: 699
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.SnackbarKt.m1938SnackbarsDKtq54(androidx.compose.material3.SnackbarData, androidx.compose.ui.Modifier, boolean, androidx.compose.ui.graphics.Shape, long, long, long, long, long, androidx.compose.runtime.Composer, int, int):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: NewLineButtonSnackbar-kKq0p4A, reason: not valid java name */
    public static final void m1935NewLineButtonSnackbarkKq0p4A(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final TextStyle textStyle, final long j, final long j2, Composer composer, final int i) {
        int i2;
        ...
        if ((74899 & i2) != 74898 || !composerStartRestartGroup.getSkipping()) {
            ...
            Modifier modifierM602paddingqDBjuR0$default = PaddingKt.m602paddingqDBjuR0$default(SizeKt.fillMaxWidth$default(SizeKt.m654widthInVpY3zN4$default(Modifier.INSTANCE, 0.0f, ContainerMaxWidth, 1, null), 0.0f, 1, null), HorizontalSpacing, 0.0f, 0.0f, SeparateButtonExtraY, 6, null);
            ...
            Modifier modifierM478paddingFromBaselineVpY3zN4 = AlignmentLineKt.m478paddingFromBaselineVpY3zN4(Modifier.INSTANCE, HeightToFirstLine, LongButtonVerticalOffset);
            float f = HorizontalSpacingButtonSide;
            Modifier modifierM602paddingqDBjuR0$default2 = PaddingKt.m602paddingqDBjuR0$default(modifierM478paddingFromBaselineVpY3zN4, 0.0f, 0.0f, f, 0.0f, 11, null);
            ...
            composerStartRestartGroup.endReplaceableGroup();
            composerStartRestartGroup.endReplaceableGroup();
            Modifier modifierM602paddingqDBjuR0$default3 = PaddingKt.m602paddingqDBjuR0$default(columnScopeInstance.align(Modifier.INSTANCE, Alignment.INSTANCE.getEnd()), 0.0f, 0.0f, function23 == null ? f : Dp.m5882constructorimpl(0), 0.0f, 11, null);
            composerStartRestartGroup.startReplaceableGroup(733328855);
            ComposerKt.sourceInformation(composerStartRestartGroup, "CC(Box)P(2,1,3)71@3309L67,72@3381L130:Box.kt#2w3rfo");
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3ModifierMaterializerOf3 = LayoutKt.modifierMaterializerOf(modifierM602paddingqDBjuR0$default3);
            if (!(composerStartRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            composerStartRestartGroup.startReusableNode();
            ...
            Updater.m2996setimpl(composerM2989constructorimpl4, measurePolicyRowMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m3484boximpl(j)), TextKt.getLocalTextStyle().provides(textStyle)}, function22, composerStartRestartGroup, i2 & 112);
            ...
            if (function23 != null) {
                CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m3484boximpl(j2)), function23, composerStartRestartGroup, ((i2 >> 3) & 112) | ProvidedValue.$stable);
            }
            composerStartRestartGroup.endReplaceableGroup();
            ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SnackbarKt$NewLineButtonSnackbar$2
                ...
                public final void invoke(Composer composer2, int i3) {
                    SnackbarKt.m1935NewLineButtonSnackbarkKq0p4A(function2, function22, function23, textStyle, j, j2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
    ...
    public static final void m1936OneRowSnackbarkKq0p4A(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final TextStyle textStyle, final long j, final long j2, Composer composer, final int i) {
        int i2;
        ...
        if ((74899 & i2) != 74898 || !composerStartRestartGroup.getSkipping()) {
            ...
            if (function23 == null) {
                fM5882constructorimpl = HorizontalSpacingButtonSide;
            } else {
                fM5882constructorimpl = Dp.m5882constructorimpl(0);
            }
            Modifier modifierM602paddingqDBjuR0$default = PaddingKt.m602paddingqDBjuR0$default(companion, f, 0.0f, fM5882constructorimpl, 0.0f, 10, null);
            ...
            if (measurePolicyRememberedValue == Composer.INSTANCE.getEmpty()) {
                measurePolicyRememberedValue = new MeasurePolicy() { // from class: androidx.compose.material3.SnackbarKt$OneRowSnackbar$2$1
                    ...
                    public final MeasureResult mo69measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j3) {
                        ...
                        final int height;
                        int iMax;
                        int iMin = Math.min(Constraints.m5828getMaxWidthimpl(j3), measureScope.mo339roundToPx0680j_4(SnackbarKt.ContainerMaxWidth));
                        String str4 = str2;
                        int size = list.size();
                        int i4 = 0;
                        while (true) {
                        ...
                        Placeable placeableMo4783measureBRTryo0 = measurable3 != null ? measurable3.mo4783measureBRTryo0(j3) : null;
                        String str5 = str3;
                        int size2 = list.size();
                        int i5 = 0;
                        while (true) {
                        ...
                        final Placeable placeableMo4783measureBRTryo02 = measurable4 != null ? measurable4.mo4783measureBRTryo0(j3) : null;
                        int width = placeableMo4783measureBRTryo0 != null ? placeableMo4783measureBRTryo0.getWidth() : 0;
                        int height2 = placeableMo4783measureBRTryo0 != null ? placeableMo4783measureBRTryo0.getHeight() : 0;
                        int width2 = placeableMo4783measureBRTryo02 != null ? placeableMo4783measureBRTryo02.getWidth() : 0;
                        int height3 = placeableMo4783measureBRTryo02 != null ? placeableMo4783measureBRTryo02.getHeight() : 0;
                        int iCoerceAtLeast = RangesKt.coerceAtLeast(((iMin - width) - width2) - (width2 == 0 ? measureScope.mo339roundToPx0680j_4(SnackbarKt.TextEndExtraSpacing) : 0), Constraints.m5830getMinWidthimpl(j3));
                        String str6 = str;
                        int size3 = list.size();
                        int i6 = 0;
                        while (i6 < size3) {
                            ...
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable5), str6)) {
                                Placeable placeable2 = placeableMo4783measureBRTryo0;
                                int i7 = height3;
                                final Placeable placeableMo4783measureBRTryo03 = measurable5.mo4783measureBRTryo0(Constraints.m5819copyZbe2FdA$default(j3, 0, iCoerceAtLeast, 0, 0, 9, null));
                                int i8 = placeableMo4783measureBRTryo03.get(androidx.compose.ui.layout.AlignmentLineKt.getFirstBaseline());
                                if (i8 == Integer.MIN_VALUE) {
                                    throw new IllegalArgumentException("No baselines for text".toString());
                                }
                                int i9 = placeableMo4783measureBRTryo03.get(androidx.compose.ui.layout.AlignmentLineKt.getLastBaseline());
                                ...
                                if (!z) {
                                    ...
                                    int i12 = measureScope.mo339roundToPx0680j_4(SnackbarKt.HeightToFirstLine) - i8;
                                    int iMax2 = Math.max(measureScope.mo339roundToPx0680j_4(SnackbarTokens.INSTANCE.m2844getTwoLinesContainerHeightD9Ej5fM()), placeableMo4783measureBRTryo03.getHeight() + i12);
                                    i3 = i12;
                                    height = placeable != null ? (iMax2 - placeable.getHeight()) / 2 : 0;
                                    iMax = iMax2;
                                } else {
                                    iMax = Math.max(measureScope.mo339roundToPx0680j_4(SnackbarTokens.INSTANCE.m2843getSingleLineContainerHeightD9Ej5fM()), Math.max(height2, i7));
                                    int height4 = (iMax - placeableMo4783measureBRTryo03.getHeight()) / 2;
                                    if (placeable2 != null) {
                                        placeable = placeable2;
                                ...
                                final int height5 = placeableMo4783measureBRTryo02 != null ? (iMax - placeableMo4783measureBRTryo02.getHeight()) / 2 : 0;
                                final Placeable placeable3 = placeable;
                                return MeasureScope.CC.layout$default(measureScope, iMin, iMax, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.SnackbarKt$OneRowSnackbar$2$1.4
                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                    {
                                        super(1);
                                    }
                                    ...
                                    public final void invoke2(Placeable.PlacementScope placementScope) {
                                        Placeable.PlacementScope.placeRelative$default(placementScope, placeableMo4783measureBRTryo03, 0, i3, 0.0f, 4, null);
                            ...
                            i6++;
                            placeableMo4783measureBRTryo0 = placeableMo4783measureBRTryo0;
                        }
            ...
            Modifier modifierM600paddingVpY3zN4$default = PaddingKt.m600paddingVpY3zN4$default(LayoutIdKt.layoutId(Modifier.INSTANCE, "text"), 0.0f, SnackbarVerticalPadding, 1, null);
            composerStartRestartGroup.startReplaceableGroup(733328855);
            ComposerKt.sourceInformation(composerStartRestartGroup, "CC(Box)P(2,1,3)71@3309L67,72@3381L130:Box.kt#2w3rfo");
            MeasurePolicy measurePolicyRememberBoxMeasurePolicy = BoxKt.rememberBoxMeasurePolicy(Alignment.INSTANCE.getTopStart(), false, composerStartRestartGroup, 0);
            composerStartRestartGroup.startReplaceableGroup(-1323940314);
            ...
            CompositionLocalMap currentCompositionLocalMap2 = composerStartRestartGroup.getCurrentCompositionLocalMap();
            Function0<ComposeUiNode> constructor2 = ComposeUiNode.INSTANCE.getConstructor();
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3ModifierMaterializerOf2 = LayoutKt.modifierMaterializerOf(modifierM600paddingVpY3zN4$default);
            if (!(composerStartRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            composerStartRestartGroup.startReusableNode();
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SnackbarKt$OneRowSnackbar$3
                ...
                public final void invoke(Composer composer2, int i3) {
                    SnackbarKt.m1936OneRowSnackbarkKq0p4A(function2, function22, function23, textStyle, j, j2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
    ...
    static {
        float f = 8;
        HorizontalSpacingButtonSide = Dp.m5882constructorimpl(f);
        TextEndExtraSpacing = Dp.m5882constructorimpl(f);
    }
}
