...
public final class SearchBarColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3495equalsimpl0(this.containerColor, searchBarColors.containerColor) && Color.m3495equalsimpl0(this.dividerColor, searchBarColors.dividerColor) && Intrinsics.areEqual(this.inputFieldColors, searchBarColors.inputFieldColors);
    }

    public int hashCode() {
        return (((Color.m3501hashCodeimpl(this.containerColor) * 31) + Color.m3501hashCodeimpl(this.dividerColor)) * 31) + this.inputFieldColors.hashCode();
    }
}
