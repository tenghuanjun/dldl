...
public final class Clickable_androidKt {
    ...
    public static final boolean m291isPressZmokQxo(KeyEvent keyEvent) {
        return KeyEventType.m4508equalsimpl0(KeyEvent_androidKt.m4516getTypeZmokQxo(keyEvent), KeyEventType.INSTANCE.m4512getKeyDownCS__XNY()) && m290isEnterZmokQxo(keyEvent);
    }

    /* JADX INFO: renamed from: isClick-ZmokQxo, reason: not valid java name */
    public static final boolean m289isClickZmokQxo(KeyEvent keyEvent) {
        return KeyEventType.m4508equalsimpl0(KeyEvent_androidKt.m4516getTypeZmokQxo(keyEvent), KeyEventType.INSTANCE.m4513getKeyUpCS__XNY()) && m290isEnterZmokQxo(keyEvent);
    }

    /* JADX INFO: renamed from: isEnter-ZmokQxo, reason: not valid java name */
    private static final boolean m290isEnterZmokQxo(KeyEvent keyEvent) {
        int iM4522getNativeKeyCodeYVgTNJs = Key_androidKt.m4522getNativeKeyCodeYVgTNJs(KeyEvent_androidKt.m4515getKeyZmokQxo(keyEvent));
        return iM4522getNativeKeyCodeYVgTNJs == 23 || iM4522getNativeKeyCodeYVgTNJs == 66 || iM4522getNativeKeyCodeYVgTNJs == 160;
    }
}
