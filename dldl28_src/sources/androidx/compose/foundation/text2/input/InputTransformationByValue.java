...
final /* data */ class InputTransformationByValue implements InputTransformation {
    ...
    public void transformInput(TextFieldCharSequence originalValue, TextFieldBuffer valueWithChanges) {
        TextFieldCharSequence textFieldCharSequenceM1123toTextFieldCharSequenceOEnZFl4$foundation_release$default = TextFieldBuffer.m1123toTextFieldCharSequenceOEnZFl4$foundation_release$default(valueWithChanges, null, 1, null);
        CharSequence charSequenceInvoke = this.transformation.invoke(originalValue, textFieldCharSequenceM1123toTextFieldCharSequenceOEnZFl4$foundation_release$default);
        if (charSequenceInvoke == textFieldCharSequenceM1123toTextFieldCharSequenceOEnZFl4$foundation_release$default) {
            return;
        }
