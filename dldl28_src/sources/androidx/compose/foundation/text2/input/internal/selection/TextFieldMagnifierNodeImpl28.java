...
public final class TextFieldMagnifierNodeImpl28 extends TextFieldMagnifierNode implements CompositionLocalConsumerModifierNode {
    ...
    private final MutableState magnifierSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m6048boximpl(IntSize.INSTANCE.m6061getZeroYbymL2g()), null, 2, null);
    private final MagnifierNode magnifierNode = (MagnifierNode) delegate(new MagnifierNode(new Function1<Density, Offset>() { // from class: androidx.compose.foundation.text2.input.internal.selection.TextFieldMagnifierNodeImpl28$magnifierNode$1
        ...
        public /* bridge */ /* synthetic */ Offset invoke(Density density) {
            return Offset.m3208boximpl(m1217invoketuRUvjQ(density));
        }

        /* JADX INFO: renamed from: invoke-tuRUvjQ, reason: not valid java name */
        public final long m1217invoketuRUvjQ(Density density) {
        ...
        public /* bridge */ /* synthetic */ Unit invoke(DpSize dpSize) {
            m1218invokeEaSLcWc(dpSize.getPackedValue());
            return Unit.INSTANCE;
        }

        /* JADX INFO: renamed from: invoke-EaSLcWc, reason: not valid java name */
        public final void m1218invokeEaSLcWc(long j) {
            ...
            textFieldMagnifierNodeImpl28.m1216setMagnifierSizeozmzZPI(IntSizeKt.IntSize(density.mo339roundToPx0680j_4(DpSize.m5980getWidthD9Ej5fM(j)), density.mo339roundToPx0680j_4(DpSize.m5978getHeightD9Ej5fM(j))));
        }
    ...
    public TextFieldMagnifierNodeImpl28(TransformedTextFieldState transformedTextFieldState, TextFieldSelectionState textFieldSelectionState, TextLayoutState textLayoutState, boolean z) {
        ...
        this.isFocused = z;
        this.animatable = new Animatable<>(Offset.m3208boximpl(TextFieldMagnifierKt.m1212calculateSelectionMagnifierCenterAndroidhUlJWOE(this.textFieldState, this.textFieldSelectionState, this.textLayoutState, m1215getMagnifierSizeYbymL2g())), SelectionMagnifierKt.getUnspecifiedSafeOffsetVectorConverter(), Offset.m3208boximpl(SelectionMagnifierKt.getOffsetDisplacementThreshold()), null, 8, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getMagnifierSize-YbymL2g, reason: not valid java name */
    public final long m1215getMagnifierSizeYbymL2g() {
    ...
    public final void m1216setMagnifierSizeozmzZPI(long j) {
        this.magnifierSize.setValue(IntSize.m6048boximpl(j));
    }
            ...
            if (i == 0) {
                ...
                Flow flowSnapshotFlow = SnapshotStateKt.snapshotFlow(new Function0<Offset>() { // from class: androidx.compose.foundation.text2.input.internal.selection.TextFieldMagnifierNodeImpl28.restartAnimationJob.1.1
                    ...
                    public /* bridge */ /* synthetic */ Offset invoke() {
                        return Offset.m3208boximpl(m1219invokeF1C5BW0());
                    }

                    /* JADX INFO: renamed from: invoke-F1C5BW0, reason: not valid java name */
                    public final long m1219invokeF1C5BW0() {
                        return TextFieldMagnifierKt.m1212calculateSelectionMagnifierCenterAndroidhUlJWOE(textFieldMagnifierNodeImpl28.textFieldState, textFieldMagnifierNodeImpl28.textFieldSelectionState, textFieldMagnifierNodeImpl28.textLayoutState, textFieldMagnifierNodeImpl28.m1215getMagnifierSizeYbymL2g());
                    }
                });
                ...
                if (flowSnapshotFlow.collect(new FlowCollector() { // from class: androidx.compose.foundation.text2.input.internal.selection.TextFieldMagnifierNodeImpl28.restartAnimationJob.1.2
                    ...
                    public /* bridge */ /* synthetic */ Object emit(Object obj2, Continuation continuation) {
                        return m1220emit3MmeM6k(((Offset) obj2).getPackedValue(), continuation);
                    }

                    /* JADX INFO: renamed from: emit-3MmeM6k, reason: not valid java name */
                    public final Object m1220emit3MmeM6k(long j, Continuation<? super Unit> continuation) {
                        if (OffsetKt.m3238isSpecifiedk4lQ0M(((Offset) textFieldMagnifierNodeImpl282.animatable.getValue()).getPackedValue()) && OffsetKt.m3238isSpecifiedk4lQ0M(j) && Offset.m3220getYimpl(((Offset) textFieldMagnifierNodeImpl282.animatable.getValue()).getPackedValue()) != Offset.m3220getYimpl(j)) {
                            BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new C00841(textFieldMagnifierNodeImpl282, j, null), 3, null);
                            return Unit.INSTANCE;
                        }
                        Object objSnapTo = textFieldMagnifierNodeImpl282.animatable.snapTo(Offset.m3208boximpl(j), continuation);
                    ...
                    /* JADX INFO: compiled from: AndroidTextFieldMagnifier.android.kt */
                    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 8, 0}, xi = 48)
                    @DebugMetadata(c = "androidx.compose.foundation.text2.input.internal.selection.TextFieldMagnifierNodeImpl28$restartAnimationJob$1$2$1", f = "AndroidTextFieldMagnifier.android.kt", i = {}, l = {KeyBoardKey.KeyboardKeyNavigationLeft}, m = "invokeSuspend", n = {}, s = {})
                    static final class C00841 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                        ...
                        C00841(TextFieldMagnifierNodeImpl28 textFieldMagnifierNodeImpl28, long j, Continuation<? super C00841> continuation) {
                            super(2, continuation);
                        ...
                        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                            return new C00841(this.this$0, this.$targetValue, continuation);
                        }
                        ...
                        public final Object invokeSuspend(Object obj) {
                            ...
                            if (i == 0) {
                                ResultKt.throwOnFailure(obj);
                                this.label = 1;
                                if (Animatable.animateTo$default(this.this$0.animatable, Offset.m3208boximpl(this.$targetValue), SelectionMagnifierKt.getMagnifierSpringSpec(), null, null, this, 12, null) == coroutine_suspended) {
