...
public final class TextUndoOperation {
    ...
    private static final Saver<TextUndoOperation, Object> Saver = new Saver<TextUndoOperation, Object>() { // from class: androidx.compose.foundation.text2.input.internal.undo.TextUndoOperation$Companion$Saver$1
        ...
        public Object save(SaverScope saverScope, TextUndoOperation textUndoOperation) {
            return CollectionsKt.listOf(Integer.valueOf(textUndoOperation.getIndex()), textUndoOperation.getPreText(), textUndoOperation.getPostText(), Integer.valueOf(TextRange.m5368getStartimpl(textUndoOperation.getPreSelection())), Integer.valueOf(TextRange.m5363getEndimpl(textUndoOperation.getPreSelection())), Integer.valueOf(TextRange.m5368getStartimpl(textUndoOperation.getPostSelection())), Integer.valueOf(TextRange.m5363getEndimpl(textUndoOperation.getPostSelection())), Long.valueOf(textUndoOperation.getTimeInMillis()));
        }
    ...
    public final TextDeleteType getDeletionType() {
        if (this.textEditType == TextEditType.Delete && TextRange.m5362getCollapsedimpl(this.postSelection)) {
            if (TextRange.m5362getCollapsedimpl(this.preSelection)) {
                if (TextRange.m5368getStartimpl(this.preSelection) > TextRange.m5368getStartimpl(this.postSelection)) {
                    return TextDeleteType.Start;
                }
                return TextDeleteType.End;
            }
            if (TextRange.m5368getStartimpl(this.preSelection) == TextRange.m5368getStartimpl(this.postSelection) && TextRange.m5368getStartimpl(this.preSelection) == this.index) {
