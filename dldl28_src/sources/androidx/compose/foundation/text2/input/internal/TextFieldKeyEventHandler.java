...
public abstract class TextFieldKeyEventHandler {
    ...
    public boolean mo1146onPreKeyEventMyFupTE(KeyEvent event, TransformedTextFieldState textFieldState, TextFieldSelectionState textFieldSelectionState, FocusManager focusManager, SoftwareKeyboardController keyboardController) {
        if (TextRange.m5362getCollapsedimpl(textFieldState.getText().getSelectionInChars()) || !KeyEventHelpers_androidKt.m903cancelsTextSelectionZmokQxo(event)) {
            return false;
        }
    ...
    public boolean m1175onKeyEvent6ptp14s(KeyEvent event, TransformedTextFieldState textFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, boolean editable, boolean singleLine, Function0<Unit> onSubmit) {
        Float visibleTextLayoutHeight;
        TextRange textRangeM5356boximpl;
        Integer numM902consumeZmokQxo;
        boolean z = false;
        if (!KeyEventType.m4508equalsimpl0(KeyEvent_androidKt.m4516getTypeZmokQxo(event), KeyEventType.INSTANCE.m4512getKeyDownCS__XNY())) {
            return false;
        }
        if (TextFieldKeyInput_androidKt.m966isTypedEventZmokQxo(event) && (numM902consumeZmokQxo = this.deadKeyCombiner.m902consumeZmokQxo(event)) != null) {
            String string = StringHelpers_jvmKt.appendCodePointX(new StringBuilder(2), numM902consumeZmokQxo.intValue()).toString();
            if (!editable) {
                return false;
            }
            ...
            if (textFieldState2.getMainBuffer().getChangeTracker().getChangeCount() != 0 || !TextRange.m5361equalsimpl0(text.getSelectionInChars(), textFieldState2.getMainBuffer().m1150getSelectiond9O1mEE()) || !Intrinsics.areEqual(text.getCompositionInChars(), textFieldState2.getMainBuffer().m1149getCompositionMzsxiRA())) {
                textFieldState2.commitEditAsUser(text, inputTransformation, true, textFieldEditUndoBehavior);
            }
            this.preparedSelectionState.resetCachedX();
            return true;
        }
        KeyCommand keyCommandMo904mapZmokQxo = this.keyMapping.mo904mapZmokQxo(event);
        if (keyCommandMo904mapZmokQxo == null || (keyCommandMo904mapZmokQxo.getEditsText() && !editable)) {
            return false;
        }
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[keyCommandMo904mapZmokQxo.ordinal()]) {
            case 1:
            ...
            case 19:
                ...
                break;
            case 20:
                if (!TextRange.m5362getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                    TransformedTextFieldState.m1196replaceTextSbBc2M$default(textFieldPreparedSelection.state, "", textFieldPreparedSelection.getSelection(), null, 4, null);
                } else {
                    Integer numValueOf = Integer.valueOf(textFieldPreparedSelection.getPrecedingCharacterIndex());
                    if (numValueOf.intValue() == -1) {
                        numValueOf = null;
                    }
                    textRangeM5356boximpl = numValueOf != null ? TextRange.m5356boximpl(TextRangeKt.TextRange(numValueOf.intValue(), TextRange.m5363getEndimpl(textFieldPreparedSelection.getSelection()))) : null;
                    if (textRangeM5356boximpl != null) {
                        TransformedTextFieldState.m1196replaceTextSbBc2M$default(textFieldPreparedSelection.state, "", textRangeM5356boximpl.getPackedValue(), null, 4, null);
                    }
                }
                z = true;
                break;
            case 21:
                if (!TextRange.m5362getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                    ...
                    textRangeM5356boximpl = numValueOf2 != null ? TextRange.m5356boximpl(TextRangeKt.TextRange(TextRange.m5368getStartimpl(textFieldPreparedSelection.getSelection()), numValueOf2.intValue())) : null;
                    if (textRangeM5356boximpl != null) {
                        TransformedTextFieldState.m1196replaceTextSbBc2M$default(textFieldPreparedSelection.state, "", textRangeM5356boximpl.getPackedValue(), null, 4, null);
                    }
                }
            ...
            case 22:
                if (!TextRange.m5362getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                    ...
                    TransformedTextFieldState.m1196replaceTextSbBc2M$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(textFieldPreparedSelection.getPreviousWordOffset(), TextRange.m5363getEndimpl(textFieldPreparedSelection.getSelection())), null, 4, null);
                }
                z = true;
                break;
            case 23:
                if (!TextRange.m5362getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                    ...
                    TransformedTextFieldState.m1196replaceTextSbBc2M$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(TextRange.m5368getStartimpl(textFieldPreparedSelection.getSelection()), textFieldPreparedSelection.getNextWordOffset()), null, 4, null);
                }
                z = true;
                break;
            case 24:
                if (!TextRange.m5362getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                    ...
                    TransformedTextFieldState.m1196replaceTextSbBc2M$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(textFieldPreparedSelection.getLineStartByOffset(), TextRange.m5363getEndimpl(textFieldPreparedSelection.getSelection())), null, 4, null);
                }
                z = true;
                break;
            case 25:
                if (!TextRange.m5362getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                    ...
                    TransformedTextFieldState.m1196replaceTextSbBc2M$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(TextRange.m5368getStartimpl(textFieldPreparedSelection.getSelection()), textFieldPreparedSelection.getLineEndByOffset()), null, 4, null);
                }
                z = true;
                break;
            case 26:
                if (!singleLine) {
                    ...
                    EditCommandKt.commitText(mainBuffer2, StringUtils.LF, 1);
                    if (textFieldState3.getMainBuffer().getChangeTracker().getChangeCount() != 0 || !TextRange.m5361equalsimpl0(text2.getSelectionInChars(), textFieldState3.getMainBuffer().m1150getSelectiond9O1mEE()) || !Intrinsics.areEqual(text2.getCompositionInChars(), textFieldState3.getMainBuffer().m1149getCompositionMzsxiRA())) {
            ...
            case 27:
                if (!singleLine) {
                    ...
                    if (textFieldState4.getMainBuffer().getChangeTracker().getChangeCount() != 0 || !TextRange.m5361equalsimpl0(text3.getSelectionInChars(), textFieldState4.getMainBuffer().m1150getSelectiond9O1mEE()) || !Intrinsics.areEqual(text3.getCompositionInChars(), textFieldState4.getMainBuffer().m1149getCompositionMzsxiRA())) {
        ...
        if (!TextRange.m5361equalsimpl0(textFieldPreparedSelection.getSelection(), textFieldPreparedSelection.getInitialValue().getSelectionInChars())) {
            textFieldState.m1201selectCharsIn5zctL8(textFieldPreparedSelection.getSelection());
        }
        return z;
    }
    ...
    private final void preparedSelectionContext(TransformedTextFieldState state, TextLayoutState textLayoutState, Function1<? super TextFieldPreparedSelection, Unit> block) {
        ...
        state.m1201selectCharsIn5zctL8(textFieldPreparedSelection.getSelection());
    }
    ...
    */
    private final java.lang.Float getVisibleTextLayoutHeight(androidx.compose.foundation.text2.input.internal.TextLayoutState r5) {
        ...
        L29:
            if (r5 == 0) goto L37
            long r0 = r5.m3252getSizeNHjbRc()
            float r5 = androidx.compose.ui.geometry.Size.m3285getHeightimpl(r0)
