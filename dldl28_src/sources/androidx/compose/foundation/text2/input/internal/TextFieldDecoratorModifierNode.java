...
public final class TextFieldDecoratorModifierNode extends DelegatingNode implements PlatformTextInputModifierNode, SemanticsModifierNode, FocusRequesterModifierNode, FocusEventModifierNode, GlobalPositionAwareModifierNode, PointerInputModifierNode, KeyInputModifierNode, CompositionLocalConsumerModifierNode, ObserverModifierNode {
    ...
    public TextFieldDecoratorModifierNode(TransformedTextFieldState transformedTextFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, InputTransformation inputTransformation, boolean z, boolean z2, KeyboardOptions keyboardOptions, KeyboardActions keyboardActions, boolean z3) {
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.foundation.text2.input.internal.TextFieldDecoratorModifierNode$onImeActionPerformed$1
            ...
            public final void m1174invokeKlQnJC8(int i) {
                ...
                Unit unit = null;
                if (ImeAction.m5535equalsimpl0(i, ImeAction.INSTANCE.m5548getDoneeUduSuo())) {
                    onSend = this.this$0.getKeyboardActions().getOnDone();
                } else if (ImeAction.m5535equalsimpl0(i, ImeAction.INSTANCE.m5549getGoeUduSuo())) {
                    onSend = this.this$0.getKeyboardActions().getOnGo();
                } else if (ImeAction.m5535equalsimpl0(i, ImeAction.INSTANCE.m5550getNexteUduSuo())) {
                    onSend = this.this$0.getKeyboardActions().getOnNext();
                } else if (ImeAction.m5535equalsimpl0(i, ImeAction.INSTANCE.m5552getPreviouseUduSuo())) {
                    onSend = this.this$0.getKeyboardActions().getOnPrevious();
                } else if (ImeAction.m5535equalsimpl0(i, ImeAction.INSTANCE.m5553getSearcheUduSuo())) {
                    onSend = this.this$0.getKeyboardActions().getOnSearch();
                } else if (ImeAction.m5535equalsimpl0(i, ImeAction.INSTANCE.m5554getSendeUduSuo())) {
                    onSend = this.this$0.getKeyboardActions().getOnSend();
                } else {
                    if (!(ImeAction.m5535equalsimpl0(i, ImeAction.INSTANCE.m5547getDefaulteUduSuo()) ? true : ImeAction.m5535equalsimpl0(i, ImeAction.INSTANCE.m5551getNoneeUduSuo()))) {
                ...
                if (unit == null) {
                    this.this$0.keyboardActionScope.mo905defaultKeyboardActionKlQnJC8(i);
                }
            }
        };
    }
    ...
    public void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        SemanticsPropertiesKt.m5213setTextSelectionRangeFDrldGo(semanticsPropertyReceiver, selectionInChars);
        ...
        SemanticsPropertiesKt.setSelection$default(semanticsPropertyReceiver, null, new Function3<Integer, Integer, Boolean, Boolean>() { // from class: androidx.compose.foundation.text2.input.internal.TextFieldDecoratorModifierNode.applySemantics.3
            ...
            public final Boolean invoke(int i, int i2, boolean z) {
                ...
                if (i == TextRange.m5368getStartimpl(selectionInChars2) && i2 == TextRange.m5363getEndimpl(selectionInChars2)) {
                    return true;
                }
                ...
                if (z) {
                    TextFieldDecoratorModifierNode.this.getTextFieldState().m1202selectUntransformedCharsIn5zctL8(jTextRange);
                } else {
                    TextFieldDecoratorModifierNode.this.getTextFieldState().m1201selectCharsIn5zctL8(jTextRange);
                }
                return true;
            }
        }, 1, null);
        ...
        SemanticsPropertiesKt.m5209onImeAction9UiTYpY$default(semanticsPropertyReceiver, this.keyboardOptions.getImeAction(), null, new Function0<Boolean>() { // from class: androidx.compose.foundation.text2.input.internal.TextFieldDecoratorModifierNode.applySemantics.5
            {
                super(0);
            }
            ...
            public final Boolean invoke() {
                TextFieldDecoratorModifierNode.this.onImeActionPerformed.invoke(ImeAction.m5532boximpl(TextFieldDecoratorModifierNode.this.getKeyboardOptions().getImeAction()));
                return true;
            }
        }, 2, null);
    ...
    public boolean mo210onKeyEventZmokQxo(KeyEvent event) {
        return this.textFieldKeyEventHandler.m1175onKeyEvent6ptp14s(event, this.textFieldState, this.textLayoutState, this.textFieldSelectionState, this.enabled && !this.readOnly, this.singleLine, new Function0<Unit>() { // from class: androidx.compose.foundation.text2.input.internal.TextFieldDecoratorModifierNode$onKeyEvent$1
            ...
            public final void invoke2() {
                this.this$0.onImeActionPerformed.invoke(ImeAction.m5532boximpl(this.this$0.getKeyboardOptions().getImeAction()));
            }
        });
    }
    ...
    static final class C06331 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return TextFieldDecoratorModifierNode.this.new C06331(continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (PlatformTextInputModifierNodeKt.establishTextInputSession(TextFieldDecoratorModifierNode.this, new C00791(TextFieldDecoratorModifierNode.this, null), this) == coroutine_suspended) {
        ...
        static final class C00791 extends SuspendLambda implements Function2<PlatformTextInputSessionScope, Continuation<?>, Object> {
            private /* synthetic */ Object L$0;
            int label;
            final /* synthetic */ TextFieldDecoratorModifierNode this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00791(TextFieldDecoratorModifierNode textFieldDecoratorModifierNode, Continuation<? super C00791> continuation) {
                super(2, continuation);
            ...
            public final Object invoke(PlatformTextInputSessionScope platformTextInputSessionScope, Continuation<?> continuation) {
                return ((C00791) create(platformTextInputSessionScope, continuation)).invokeSuspend(Unit.INSTANCE);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    BuildersKt__Builders_commonKt.launch$default(platformTextInputSessionScope, null, CoroutineStart.UNDISPATCHED, new C00801(this.this$0, null), 1, null);
                    this.label = 1;
            ...
            static final class C00801 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C00801(TextFieldDecoratorModifierNode textFieldDecoratorModifierNode, Continuation<? super C00801> continuation) {
                    super(2, continuation);
                    this.this$0 = textFieldDecoratorModifierNode;
                }
    ...
    private final void startInputSession() {
        this.inputSessionJob = BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C06331(null), 3, null);
    }
