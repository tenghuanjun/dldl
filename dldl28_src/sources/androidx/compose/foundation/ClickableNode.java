...
final class ClickableNode extends AbstractClickableNode {
    ...
    public final void m285updateXHw0xAI(MutableInteractionSource interactionSource, boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick) {
        m213updateCommonXHw0xAI(interactionSource, enabled, onClickLabel, role, onClick);
        getClickableSemanticsNode().m288updateUMe6uN4(enabled, onClickLabel, role, onClick, null, null);
