...
public interface PageSize {
    ...
    public static final class Fixed implements PageSize {
        ...
        @Override // androidx.compose.foundation.pager.PageSize
        public int calculateMainAxisPageSize(Density density, int i, int i2) {
            return density.mo339roundToPx0680j_4(this.pageSize);
        }
        ...
        public boolean equals(Object other) {
            ...
            if (other instanceof Fixed) {
                return Dp.m5887equalsimpl0(this.pageSize, ((Fixed) other).pageSize);
            }
            return false;
        }

        public int hashCode() {
            return Dp.m5888hashCodeimpl(this.pageSize);
        }
    }
}
