...
public final class AndroidExternalSurfaceZOrder {
    ...
    private static final int Behind = m228constructorimpl(0);
    private static final int MediaOverlay = m228constructorimpl(1);
    private static final int OnTop = m228constructorimpl(2);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ AndroidExternalSurfaceZOrder m227boximpl(int i) {
        return new AndroidExternalSurfaceZOrder(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m228constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m229equalsimpl(int i, Object obj) {
        return (obj instanceof AndroidExternalSurfaceZOrder) && i == ((AndroidExternalSurfaceZOrder) obj).m233unboximpl();
    }
    ...
    public static String m232toStringimpl(int i) {
        return "AndroidExternalSurfaceZOrder(zOrder=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m229equalsimpl(this.zOrder, obj);
    }

    public int hashCode() {
        return m231hashCodeimpl(this.zOrder);
    }

    public String toString() {
        return m232toStringimpl(this.zOrder);
    }

    /* JADX INFO: renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ int m233unboximpl() {
        return this.zOrder;
    }
