...
public final class TextDelegate {
    ...
    public /* synthetic */ TextDelegate(AnnotatedString annotatedString, TextStyle textStyle, int i, int i2, boolean z, int i3, Density density, FontFamily.Resolver resolver, List list, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, (i4 & 4) != 0 ? Integer.MAX_VALUE : i, (i4 & 8) != 0 ? 1 : i2, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? TextOverflow.INSTANCE.m5813getClipgIe3tQ8() : i3, density, resolver, (i4 & 256) != 0 ? CollectionsKt.emptyList() : list, null);
    }
    ...
    private final MultiParagraph m943layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        int iM5830getMinWidthimpl = Constraints.m5830getMinWidthimpl(constraints);
        int iM5828getMaxWidthimpl = ((this.softWrap || TextOverflow.m5806equalsimpl0(this.overflow, TextOverflow.INSTANCE.m5814getEllipsisgIe3tQ8())) && Constraints.m5824getHasBoundedWidthimpl(constraints)) ? Constraints.m5828getMaxWidthimpl(constraints) : Integer.MAX_VALUE;
        int i = (this.softWrap || !TextOverflow.m5806equalsimpl0(this.overflow, TextOverflow.INSTANCE.m5814getEllipsisgIe3tQ8())) ? this.maxLines : 1;
        if (iM5830getMinWidthimpl != iM5828getMaxWidthimpl) {
            iM5828getMaxWidthimpl = RangesKt.coerceIn(getMaxIntrinsicWidth(), iM5830getMinWidthimpl, iM5828getMaxWidthimpl);
        }
        return new MultiParagraph(getNonNullIntrinsics(), ConstraintsKt.Constraints$default(0, iM5828getMaxWidthimpl, 0, Constraints.m5827getMaxHeightimpl(constraints), 5, null), i, TextOverflow.m5806equalsimpl0(this.overflow, TextOverflow.INSTANCE.m5814getEllipsisgIe3tQ8()), null);
    }
    ...
    public final TextLayoutResult m945layoutNN6EwU(long constraints, LayoutDirection layoutDirection, TextLayoutResult prevResult) {
        if (prevResult != null && TextLayoutHelperKt.m979canReuse7_7YC6M(prevResult, this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints)) {
            return prevResult.m5339copyO0kMr_c(new TextLayoutInput(prevResult.getLayoutInput().getText(), this.style, prevResult.getLayoutInput().getPlaceholders(), prevResult.getLayoutInput().getMaxLines(), prevResult.getLayoutInput().getSoftWrap(), prevResult.getLayoutInput().getOverflow(), prevResult.getLayoutInput().getDensity(), prevResult.getLayoutInput().getLayoutDirection(), prevResult.getLayoutInput().getFontFamilyResolver(), constraints, (DefaultConstructorMarker) null), ConstraintsKt.m5839constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(prevResult.getMultiParagraph().getWidth()), TextDelegateKt.ceilToIntPx(prevResult.getMultiParagraph().getHeight()))));
        }
        MultiParagraph multiParagraphM943layoutTextK40F9xA = m943layoutTextK40F9xA(constraints, layoutDirection);
        return new TextLayoutResult(new TextLayoutInput(this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints, (DefaultConstructorMarker) null), multiParagraphM943layoutTextK40F9xA, ConstraintsKt.m5839constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(multiParagraphM943layoutTextK40F9xA.getWidth()), TextDelegateKt.ceilToIntPx(multiParagraphM943layoutTextK40F9xA.getHeight()))), null);
    }
