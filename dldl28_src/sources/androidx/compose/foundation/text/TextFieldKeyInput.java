...
public final class TextFieldKeyInput {
    ...
    private final CommitTextCommand m961typedCommandZmokQxo(KeyEvent event) {
        Integer numM902consumeZmokQxo;
        if (TextFieldKeyInput_androidKt.m966isTypedEventZmokQxo(event) && (numM902consumeZmokQxo = this.keyCombiner.m902consumeZmokQxo(event)) != null) {
            return new CommitTextCommand(StringHelpers_jvmKt.appendCodePointX(new StringBuilder(), numM902consumeZmokQxo.intValue()).toString(), 1);
        }
        return null;
    }

    /* JADX INFO: renamed from: process-ZmokQxo, reason: not valid java name */
    public final boolean m962processZmokQxo(KeyEvent event) {
        final KeyCommand keyCommandMo904mapZmokQxo;
        CommitTextCommand commitTextCommandM961typedCommandZmokQxo = m961typedCommandZmokQxo(event);
        if (commitTextCommandM961typedCommandZmokQxo != null) {
            if (!this.editable) {
                return false;
            }
            apply(commitTextCommandM961typedCommandZmokQxo);
            this.preparedSelectionState.resetCachedX();
            return true;
        }
        if (!KeyEventType.m4508equalsimpl0(KeyEvent_androidKt.m4516getTypeZmokQxo(event), KeyEventType.INSTANCE.m4512getKeyDownCS__XNY()) || (keyCommandMo904mapZmokQxo = this.keyMapping.mo904mapZmokQxo(event)) == null || (keyCommandMo904mapZmokQxo.getEditsText() && !this.editable)) {
            return false;
        }
                ...
                switch (WhenMappings.$EnumSwitchMapping$0[keyCommandMo904mapZmokQxo.ordinal()]) {
                    ...
                    case 20:
                        List<EditCommand> listDeleteIfSelectedOr = textFieldPreparedSelection.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.3
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection textFieldPreparedSelection2) {
                                return new DeleteSurroundingTextCommand(TextRange.m5363getEndimpl(textFieldPreparedSelection2.getSelection()) - textFieldPreparedSelection2.getPrecedingCharacterIndex(), 0);
                            }
                        });
                        ...
                        List<EditCommand> listDeleteIfSelectedOr2 = textFieldPreparedSelection.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.4
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection textFieldPreparedSelection2) {
                                ...
                                if (nextCharacterIndex != -1) {
                                    return new DeleteSurroundingTextCommand(0, nextCharacterIndex - TextRange.m5363getEndimpl(textFieldPreparedSelection2.getSelection()));
                                }
                                return null;
                            }
                        });
                        ...
                        List<EditCommand> listDeleteIfSelectedOr3 = textFieldPreparedSelection.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.5
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection textFieldPreparedSelection2) {
                                ...
                                if (previousWordOffset != null) {
                                    deleteSurroundingTextCommand = new DeleteSurroundingTextCommand(TextRange.m5363getEndimpl(textFieldPreparedSelection2.getSelection()) - previousWordOffset.intValue(), 0);
                                } else {
                    ...
                    case 23:
                        List<EditCommand> listDeleteIfSelectedOr4 = textFieldPreparedSelection.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.6
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection textFieldPreparedSelection2) {
                                ...
                                return nextWordOffset != null ? new DeleteSurroundingTextCommand(0, nextWordOffset.intValue() - TextRange.m5363getEndimpl(textFieldPreparedSelection2.getSelection())) : null;
                            }
                        });
                        ...
                        List<EditCommand> listDeleteIfSelectedOr5 = textFieldPreparedSelection.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.7
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection textFieldPreparedSelection2) {
                                ...
                                if (lineStartByOffset != null) {
                                    deleteSurroundingTextCommand = new DeleteSurroundingTextCommand(TextRange.m5363getEndimpl(textFieldPreparedSelection2.getSelection()) - lineStartByOffset.intValue(), 0);
                                } else {
                                    deleteSurroundingTextCommand = null;
                                }
                                return deleteSurroundingTextCommand;
                    ...
                    case 25:
                        List<EditCommand> listDeleteIfSelectedOr6 = textFieldPreparedSelection.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.8
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection textFieldPreparedSelection2) {
                                ...
                                return lineEndByOffset != null ? new DeleteSurroundingTextCommand(0, lineEndByOffset.intValue() - TextRange.m5363getEndimpl(textFieldPreparedSelection2.getSelection())) : null;
                            }
                        });
                    ...
                    case 26:
                        if (!this.getSingleLine()) {
                            ...
                            this.getState().getOnImeActionPerformed().invoke(ImeAction.m5532boximpl(this.imeAction));
                        }
                        break;
                    case 27:
                        if (!this.getSingleLine()) {
    ...
    private final void commandExecutionContext(Function1<? super TextFieldPreparedSelection, Unit> block) {
        ...
        if (TextRange.m5361equalsimpl0(textFieldPreparedSelection.getSelection(), this.value.getSelection()) && Intrinsics.areEqual(textFieldPreparedSelection.getAnnotatedString(), this.value.getAnnotatedString())) {
            return;
        }
