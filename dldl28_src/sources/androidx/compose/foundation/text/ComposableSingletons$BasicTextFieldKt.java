...
public final class ComposableSingletons$BasicTextFieldKt {
    ...
    public final Function3<Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> m895getLambda2$foundation_release() {
        return f1lambda2;
    }

    /* JADX INFO: renamed from: getLambda-3$foundation_release, reason: not valid java name */
    public final Function3<Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> m896getLambda3$foundation_release() {
        return f2lambda3;
    }

    /* JADX INFO: renamed from: getLambda-4$foundation_release, reason: not valid java name */
    public final Function3<Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> m897getLambda4$foundation_release() {
        return f3lambda4;
    }
}
