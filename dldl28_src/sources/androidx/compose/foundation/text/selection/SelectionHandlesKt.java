...
public final class SelectionHandlesKt {
    ...
    public static final long m1048getAdjustedCoordinatesk4lQ0M(long j) {
        return OffsetKt.Offset(Offset.m3219getXimpl(j), Offset.m3220getYimpl(j) - 1.0f);
    }

    static {
        float f = 25;
        HandleWidth = Dp.m5882constructorimpl(f);
        HandleHeight = Dp.m5882constructorimpl(f);
    }
}
