...
public interface MouseSelectionObserver {
    ...
    boolean mo1021onDrag3MmeM6k(long dragPosition, SelectionAdjustment adjustment);

    void onDragDone();

    /* JADX INFO: renamed from: onExtend-k-4lQ0M */
    boolean mo1022onExtendk4lQ0M(long downPosition);

    /* JADX INFO: renamed from: onExtendDrag-k-4lQ0M */
    boolean mo1023onExtendDragk4lQ0M(long dragPosition);

    /* JADX INFO: renamed from: onStart-3MmeM6k */
    boolean mo1024onStart3MmeM6k(long downPosition, SelectionAdjustment adjustment);
}
