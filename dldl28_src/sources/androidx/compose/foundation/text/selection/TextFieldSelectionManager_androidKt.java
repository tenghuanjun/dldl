        ...
        public final Modifier invoke(Modifier modifier, Composer composer, int i) {
            ...
            Function0<Offset> function0 = new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt.textFieldMagnifier.1.1
                ...
                public /* bridge */ /* synthetic */ Offset invoke() {
                    return Offset.m3208boximpl(m1109invokeF1C5BW0());
                }

                /* JADX INFO: renamed from: invoke-F1C5BW0, reason: not valid java name */
                public final long m1109invokeF1C5BW0() {
                    return TextFieldSelectionManagerKt.m1108calculateSelectionMagnifierCenterAndroidO0kMr_c(textFieldSelectionManager, AnonymousClass1.invoke$lambda$1(mutableState));
                }
            };
                    ...
                    public final Modifier invoke2(final Function0<Offset> function02) {
                        ...
                        Function1<Density, Offset> function1 = new Function1<Density, Offset>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$2$1.1
                            ...
                            public /* bridge */ /* synthetic */ Offset invoke(Density density2) {
                                return Offset.m3208boximpl(m1110invoketuRUvjQ(density2));
                            }

                            /* JADX INFO: renamed from: invoke-tuRUvjQ, reason: not valid java name */
                            public final long m1110invoketuRUvjQ(Density density2) {
                                return function02.invoke().getPackedValue();
                            }
                        };
                        final Density density2 = density;
                        final MutableState<IntSize> mutableState2 = mutableState;
                        return Magnifier_androidKt.m313magnifierjPUL71Q$default(companion, function1, null, new Function1<DpSize, Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$2$1.2
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            }
                            ...
                            public /* bridge */ /* synthetic */ Unit invoke(DpSize dpSize) {
                                m1111invokeEaSLcWc(dpSize.getPackedValue());
                                return Unit.INSTANCE;
                            }

                            /* JADX INFO: renamed from: invoke-EaSLcWc, reason: not valid java name */
                            public final void m1111invokeEaSLcWc(long j) {
                                MutableState<IntSize> mutableState3 = mutableState2;
                                Density density3 = density2;
                                TextFieldSelectionManager_androidKt.AnonymousClass1.invoke$lambda$2(mutableState3, IntSizeKt.IntSize(density3.mo339roundToPx0680j_4(DpSize.m5980getWidthD9Ej5fM(j)), density3.mo339roundToPx0680j_4(DpSize.m5978getHeightD9Ej5fM(j))));
                            }
