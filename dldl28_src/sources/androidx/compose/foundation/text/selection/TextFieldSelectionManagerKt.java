...
public final class TextFieldSelectionManagerKt {
    ...
    public static final void TextFieldSelectionHandle(final boolean z, final ResolvedTextDirection resolvedTextDirection, final TextFieldSelectionManager textFieldSelectionManager, Composer composer, final int i) {
        ...
        AndroidSelectionHandles_androidKt.SelectionHandle(new OffsetProvider() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManagerKt.TextFieldSelectionHandle.1
            ...
            public final long mo880provideF1C5BW0() {
                return textFieldSelectionManager.m1107getHandlePositiontuRUvjQ$foundation_release(z);
            }
        }, z, resolvedTextDirection, TextRange.m5367getReversedimpl(textFieldSelectionManager.getValue$foundation_release().getSelection()), SuspendingPointerInputFilterKt.pointerInput(Modifier.INSTANCE, textDragObserver, new AnonymousClass2(textDragObserver, null)), composerStartRestartGroup, (i << 3) & PointerIconCompat.TYPE_TEXT);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final boolean isSelectionHandleInVisibleBound(TextFieldSelectionManager textFieldSelectionManager, boolean z) {
        ...
        return SelectionManagerKt.m1085containsInclusiveUv8p0NA(rectVisibleBounds, textFieldSelectionManager.m1107getHandlePositiontuRUvjQ$foundation_release(z));
    }

    /* JADX INFO: renamed from: calculateSelectionMagnifierCenterAndroid-O0kMr_c, reason: not valid java name */
    public static final long m1108calculateSelectionMagnifierCenterAndroidO0kMr_c(TextFieldSelectionManager textFieldSelectionManager, long j) {
        int iM5368getStartimpl;
        TextLayoutResultProxy layoutResult;
        TextDelegate textDelegate;
        AnnotatedString text;
        Offset offsetM1105getCurrentDragPosition_m7T9E = textFieldSelectionManager.m1105getCurrentDragPosition_m7T9E();
        if (offsetM1105getCurrentDragPosition_m7T9E == null) {
            return Offset.INSTANCE.m3234getUnspecifiedF1C5BW0();
        }
        long packedValue = offsetM1105getCurrentDragPosition_m7T9E.getPackedValue();
        ...
        if (i == 1 || i == 2) {
            iM5368getStartimpl = TextRange.m5368getStartimpl(textFieldSelectionManager.getValue$foundation_release().getSelection());
        } else {
            if (i != 3) {
                throw new NoWhenBranchMatchedException();
            }
            iM5368getStartimpl = TextRange.m5363getEndimpl(textFieldSelectionManager.getValue$foundation_release().getSelection());
        }
        TextFieldState state$foundation_release = textFieldSelectionManager.getState();
        ...
        int iCoerceIn = RangesKt.coerceIn(textFieldSelectionManager.getOffsetMapping().originalToTransformed(iM5368getStartimpl), 0, text.length());
        float fM3219getXimpl = Offset.m3219getXimpl(layoutResult.m984translateDecorationToInnerCoordinatesMKHz9U$foundation_release(packedValue));
