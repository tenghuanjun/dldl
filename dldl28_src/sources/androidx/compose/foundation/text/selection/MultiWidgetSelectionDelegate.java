...
public final class MultiWidgetSelectionDelegate implements Selectable {
    ...
    private final synchronized int getLastVisibleOffset(TextLayoutResult textLayoutResult) {
        ...
        if (this._previousTextLayoutResult != textLayoutResult) {
            if (!textLayoutResult.getDidOverflowHeight() || textLayoutResult.getMultiParagraph().getDidExceedMaxLines()) {
                ...
                int iCoerceAtMost = RangesKt.coerceAtMost(textLayoutResult.getLineForVerticalPosition(IntSize.m6055getHeightimpl(textLayoutResult.getSize())), textLayoutResult.getLineCount() - 1);
                while (iCoerceAtMost >= 0 && textLayoutResult.getLineTop(iCoerceAtMost) >= IntSize.m6055getHeightimpl(textLayoutResult.getSize())) {
                    iCoerceAtMost--;
                }
    ...
    public void appendSelectableInfoToBuilder(SelectionLayoutBuilder builder) {
        ...
        long jM3223minusMKHz9U;
        LayoutCoordinates layoutCoordinates = getLayoutCoordinates();
        if (layoutCoordinates == null || (textLayoutResultInvoke = this.layoutResultCallback.invoke()) == null) {
            return;
        }
        long jMo4791localPositionOfR5De75A = builder.getContainerCoordinates().mo4791localPositionOfR5De75A(layoutCoordinates, Offset.INSTANCE.m3235getZeroF1C5BW0());
        long jM3223minusMKHz9U2 = Offset.m3223minusMKHz9U(builder.getCurrentPosition(), jMo4791localPositionOfR5De75A);
        if (OffsetKt.m3240isUnspecifiedk4lQ0M(builder.getPreviousHandlePosition())) {
            jM3223minusMKHz9U = Offset.INSTANCE.m3234getUnspecifiedF1C5BW0();
        } else {
            jM3223minusMKHz9U = Offset.m3223minusMKHz9U(builder.getPreviousHandlePosition(), jMo4791localPositionOfR5De75A);
        }
        MultiWidgetSelectionDelegateKt.m1035appendSelectableInfoParwq6A(builder, textLayoutResultInvoke, jM3223minusMKHz9U2, jM3223minusMKHz9U, getSelectableId());
    }
    ...
    public long mo1033getHandlePositiondBAh8RU(Selection selection, boolean isStartHandle) {
        TextLayoutResult textLayoutResultInvoke;
    ...
    public long mo1034getRangeOfLineContainingjx7JFs(int offset) {
        TextLayoutResult textLayoutResultInvoke = this.layoutResultCallback.invoke();
        if (textLayoutResultInvoke == null) {
