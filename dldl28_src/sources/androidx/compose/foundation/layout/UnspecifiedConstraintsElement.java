...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("minWidth", Dp.m5880boximpl(this.minWidth));
        inspectorInfo.getProperties().set("minHeight", Dp.m5880boximpl(this.minHeight));
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5887equalsimpl0(this.minWidth, unspecifiedConstraintsElement.minWidth) && Dp.m5887equalsimpl0(this.minHeight, unspecifiedConstraintsElement.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (Dp.m5888hashCodeimpl(this.minWidth) * 31) + Dp.m5888hashCodeimpl(this.minHeight);
    }
}
