...
final class PaddingNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m609setStart0680j_4(float f) {
        this.start = f;
    }
    ...
    public final void m610setTop0680j_4(float f) {
        this.top = f;
    }
    ...
    public final void m608setEnd0680j_4(float f) {
        this.end = f;
    }
    ...
    public final void m607setBottom0680j_4(float f) {
        this.bottom = f;
    }
    ...
    public MeasureResult mo121measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        int i = measureScope.mo339roundToPx0680j_4(this.start) + measureScope.mo339roundToPx0680j_4(this.end);
        int i2 = measureScope.mo339roundToPx0680j_4(this.top) + measureScope.mo339roundToPx0680j_4(this.bottom);
        ...
        return MeasureScope.CC.layout$default(measureScope, ConstraintsKt.m5842constrainWidthK40F9xA(j, placeableMo4783measureBRTryo0.getWidth() + i), ConstraintsKt.m5841constrainHeightK40F9xA(j, placeableMo4783measureBRTryo0.getHeight() + i2), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.PaddingNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                if (this.this$0.getRtlAware()) {
                    Placeable.PlacementScope.placeRelative$default(placementScope, placeableMo4783measureBRTryo0, measureScope.mo339roundToPx0680j_4(this.this$0.getStart()), measureScope.mo339roundToPx0680j_4(this.this$0.getTop()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default(placementScope, placeableMo4783measureBRTryo0, measureScope.mo339roundToPx0680j_4(this.this$0.getStart()), measureScope.mo339roundToPx0680j_4(this.this$0.getTop()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }
    ...
    public /* synthetic */ PaddingNode(float f, float f2, float f3, float f4, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m5882constructorimpl(0) : f, (i & 2) != 0 ? Dp.m5882constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m5882constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m5882constructorimpl(0) : f4, z, null);
    }
}
