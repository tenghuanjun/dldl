...
interface SideCalculator {
    ...
    long mo628consumedOffsetsMKHz9U(long available);

    /* JADX INFO: renamed from: consumedVelocity-QWom1Mo, reason: not valid java name */
    long mo629consumedVelocityQWom1Mo(long available, float remaining);
    ...
    /* JADX INFO: renamed from: androidx.compose.foundation.layout.SideCalculator$-CC, reason: invalid class name */
    /* JADX INFO: compiled from: WindowInsetsConnection.android.kt */
    ...
    public static final class Companion {
        ...
        private static final SideCalculator$Companion$LeftSideCalculator$1 LeftSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$LeftSideCalculator$1
            ...
            public long mo628consumedOffsetsMKHz9U(long available) {
                return androidx.compose.ui.geometry.OffsetKt.Offset(Offset.m3219getXimpl(available), 0.0f);
            }

            @Override // androidx.compose.foundation.layout.SideCalculator
            /* JADX INFO: renamed from: consumedVelocity-QWom1Mo */
            public long mo629consumedVelocityQWom1Mo(long available, float remaining) {
                return VelocityKt.Velocity(Velocity.m6121getXimpl(available) - remaining, 0.0f);
            }
        };
        private static final SideCalculator$Companion$TopSideCalculator$1 TopSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$TopSideCalculator$1
            ...
            /* JADX INFO: renamed from: consumedOffsets-MK-Hz9U */
            public long mo628consumedOffsetsMKHz9U(long available) {
                return androidx.compose.ui.geometry.OffsetKt.Offset(0.0f, Offset.m3220getYimpl(available));
            }

            @Override // androidx.compose.foundation.layout.SideCalculator
            /* JADX INFO: renamed from: consumedVelocity-QWom1Mo */
            public long mo629consumedVelocityQWom1Mo(long available, float remaining) {
                return VelocityKt.Velocity(0.0f, Velocity.m6122getYimpl(available) - remaining);
            }
        };
        ...
        public final SideCalculator m630chooseCalculatorni1skBw(int side, LayoutDirection layoutDirection) {
            if (WindowInsetsSides.m680equalsimpl0(side, WindowInsetsSides.INSTANCE.m694getLeftJoeWqyM())) {
                return LeftSideCalculator;
            }
            if (WindowInsetsSides.m680equalsimpl0(side, WindowInsetsSides.INSTANCE.m697getTopJoeWqyM())) {
                return TopSideCalculator;
            }
            if (WindowInsetsSides.m680equalsimpl0(side, WindowInsetsSides.INSTANCE.m695getRightJoeWqyM())) {
                return RightSideCalculator;
            }
            if (WindowInsetsSides.m680equalsimpl0(side, WindowInsetsSides.INSTANCE.m691getBottomJoeWqyM())) {
                return BottomSideCalculator;
            }
            if (WindowInsetsSides.m680equalsimpl0(side, WindowInsetsSides.INSTANCE.m696getStartJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return LeftSideCalculator;
                }
                return RightSideCalculator;
            }
            if (!WindowInsetsSides.m680equalsimpl0(side, WindowInsetsSides.INSTANCE.m692getEndJoeWqyM())) {
