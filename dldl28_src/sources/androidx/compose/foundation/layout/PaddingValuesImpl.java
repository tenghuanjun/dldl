...
public final class PaddingValuesImpl implements PaddingValues {
    ...
    public static /* synthetic */ void m615getBottomD9Ej5fM$annotations() {
    }

    /* JADX INFO: renamed from: getEnd-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m616getEndD9Ej5fM$annotations() {
    }

    /* JADX INFO: renamed from: getStart-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m617getStartD9Ej5fM$annotations() {
    }

    /* JADX INFO: renamed from: getTop-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m618getTopD9Ej5fM$annotations() {
    }
    ...
    public final float m622getTopD9Ej5fM() {
        return this.top;
    }
    ...
    public final float m619getBottomD9Ej5fM() {
        return this.bottom;
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5887equalsimpl0(this.start, paddingValuesImpl.start) && Dp.m5887equalsimpl0(this.top, paddingValuesImpl.top) && Dp.m5887equalsimpl0(this.end, paddingValuesImpl.end) && Dp.m5887equalsimpl0(this.bottom, paddingValuesImpl.bottom);
    }

    public int hashCode() {
        return (((((Dp.m5888hashCodeimpl(this.start) * 31) + Dp.m5888hashCodeimpl(this.top)) * 31) + Dp.m5888hashCodeimpl(this.end)) * 31) + Dp.m5888hashCodeimpl(this.bottom);
    }

    public String toString() {
        return "PaddingValues(start=" + ((Object) Dp.m5893toStringimpl(this.start)) + ", top=" + ((Object) Dp.m5893toStringimpl(this.top)) + ", end=" + ((Object) Dp.m5893toStringimpl(this.end)) + ", bottom=" + ((Object) Dp.m5893toStringimpl(this.bottom)) + ')';
    }
