...
final class AlignmentLineOffsetTextUnitNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m493setBeforeR2X_6o(long j) {
        this.before = j;
    }
    ...
    public final void m492setAfterR2X_6o(long j) {
        this.after = j;
    }
    ...
    public MeasureResult mo121measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        return AlignmentLineKt.m473alignmentLineOffsetMeasuretjqqzMA(measureScope, this.alignmentLine, !TextUnitKt.m6095isUnspecifiedR2X_6o(this.before) ? measureScope.mo340toDpGaN1DYA(this.before) : Dp.INSTANCE.m5902getUnspecifiedD9Ej5fM(), !TextUnitKt.m6095isUnspecifiedR2X_6o(this.after) ? measureScope.mo340toDpGaN1DYA(this.after) : Dp.INSTANCE.m5902getUnspecifiedD9Ej5fM(), measurable, j);
    }
}
