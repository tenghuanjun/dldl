...
final class WindowInsetsNestedScrollConnection implements NestedScrollConnection, WindowInsetsAnimationControlListener {
    ...
    public long mo434onPreScrollOzD1aCk(long available, int source) {
        return m676scroll8S9VItk(available, this.sideCalculator.hideMotion(Offset.m3219getXimpl(available), Offset.m3220getYimpl(available)));
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* JADX INFO: renamed from: onPostScroll-DzOQY0M */
    public long mo432onPostScrollDzOQY0M(long consumed, long available, int source) {
        return m676scroll8S9VItk(available, this.sideCalculator.showMotion(Offset.m3219getXimpl(available), Offset.m3220getYimpl(available)));
    }

    /* JADX INFO: renamed from: scroll-8S9VItk, reason: not valid java name */
    private final long m676scroll8S9VItk(long available, float scrollAmount) {
        ...
        if (scrollAmount != 0.0f) {
            if (this.windowInsets.isVisible() != (scrollAmount > 0.0f) || windowInsetsAnimationController != null) {
                if (windowInsetsAnimationController == null) {
                    ...
                    requestAnimationController();
                    return this.sideCalculator.mo628consumedOffsetsMKHz9U(available);
                }
    ...
    public Object mo433onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        return m675flinghuYlsQE(j, this.sideCalculator.hideMotion(Velocity.m6121getXimpl(j), Velocity.m6122getYimpl(j)), false, continuation);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* JADX INFO: renamed from: onPostFling-RZ2iAVY */
    public Object mo431onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        return m675flinghuYlsQE(j2, this.sideCalculator.showMotion(Velocity.m6121getXimpl(j2), Velocity.m6122getYimpl(j2)), true, continuation);
    }
    ...
    */
    public final java.lang.Object m675flinghuYlsQE(long r26, float r28, boolean r29, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r30) {
        /*
            Method dump skipped, instruction units count: 409
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.layout.WindowInsetsNestedScrollConnection.m675flinghuYlsQE(long, float, boolean, kotlin.coroutines.Continuation):java.lang.Object");
    }
