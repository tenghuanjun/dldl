...
final /* data */ class BoxWithConstraintsScopeImpl implements BoxWithConstraintsScope, BoxScope {
    ...
    public static /* synthetic */ BoxWithConstraintsScopeImpl m539copy0kLqBqw$default(BoxWithConstraintsScopeImpl boxWithConstraintsScopeImpl, Density density, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return boxWithConstraintsScopeImpl.m541copy0kLqBqw(density, j);
    }
    ...
    public final BoxWithConstraintsScopeImpl m541copy0kLqBqw(Density density, long constraints) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.density, boxWithConstraintsScopeImpl.density) && Constraints.m5821equalsimpl0(this.constraints, boxWithConstraintsScopeImpl.constraints);
    }

    public int hashCode() {
        return (this.density.hashCode() * 31) + Constraints.m5831hashCodeimpl(this.constraints);
    }
    ...
    public String toString() {
        return "BoxWithConstraintsScopeImpl(density=" + this.density + ", constraints=" + ((Object) Constraints.m5833toStringimpl(this.constraints)) + ')';
    }
    ...
    public long mo534getConstraintsmsEJaDk() {
        return this.constraints;
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMinWidth-D9Ej5fM */
    public float mo538getMinWidthD9Ej5fM() {
        return this.density.mo342toDpu2uoSUM(Constraints.m5830getMinWidthimpl(mo534getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMaxWidth-D9Ej5fM */
    public float mo536getMaxWidthD9Ej5fM() {
        return Constraints.m5824getHasBoundedWidthimpl(mo534getConstraintsmsEJaDk()) ? this.density.mo342toDpu2uoSUM(Constraints.m5828getMaxWidthimpl(mo534getConstraintsmsEJaDk())) : Dp.INSTANCE.m5901getInfinityD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMinHeight-D9Ej5fM */
    public float mo537getMinHeightD9Ej5fM() {
        return this.density.mo342toDpu2uoSUM(Constraints.m5829getMinHeightimpl(mo534getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMaxHeight-D9Ej5fM */
    public float mo535getMaxHeightD9Ej5fM() {
        return Constraints.m5823getHasBoundedHeightimpl(mo534getConstraintsmsEJaDk()) ? this.density.mo342toDpu2uoSUM(Constraints.m5827getMaxHeightimpl(mo534getConstraintsmsEJaDk())) : Dp.INSTANCE.m5901getInfinityD9Ej5fM();
    }
}
