...
final class OffsetElement extends ModifierNodeElement<OffsetNode> {
    ...
    public void update(OffsetNode node) {
        node.m562setX0680j_4(this.x);
        node.m563setY0680j_4(this.y);
    ...
    public boolean equals(Object other) {
        ...
        return offsetElement != null && Dp.m5887equalsimpl0(this.x, offsetElement.x) && Dp.m5887equalsimpl0(this.y, offsetElement.y) && this.rtlAware == offsetElement.rtlAware;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((Dp.m5888hashCodeimpl(this.x) * 31) + Dp.m5888hashCodeimpl(this.y)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifierElement(x=" + ((Object) Dp.m5893toStringimpl(this.x)) + ", y=" + ((Object) Dp.m5893toStringimpl(this.y)) + ", rtlAware=" + this.rtlAware + ')';
    }
