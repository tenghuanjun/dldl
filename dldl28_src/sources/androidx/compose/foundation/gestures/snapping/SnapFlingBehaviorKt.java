...
public final class SnapFlingBehaviorKt {
    ...
    private static final float MinFlingVelocityDp = Dp.m5882constructorimpl(400);
    ...
    public static final SnapFlingBehavior rememberSnapFlingBehavior(SnapLayoutInfoProvider snapLayoutInfoProvider, Composer composer, int i) {
        ...
        boolean zChanged = composer.changed((Density) objConsume) | composer.changed(snapLayoutInfoProvider) | composer.changed(decayAnimationSpecRememberSplineBasedDecay);
    ...
    */
    public static final java.lang.Object animateWithTarget(final androidx.compose.foundation.gestures.ScrollScope r12, float r13, final float r14, androidx.compose.animation.core.AnimationState<java.lang.Float, androidx.compose.animation.core.AnimationVector1D> r15, androidx.compose.animation.core.AnimationSpec<java.lang.Float> r16, final kotlin.jvm.functions.Function1<? super java.lang.Float, kotlin.Unit> r17, kotlin.coroutines.Continuation<? super androidx.compose.foundation.gestures.snapping.AnimationResult<java.lang.Float, androidx.compose.animation.core.AnimationVector1D>> r18) {
        /*
            r0 = r18
            boolean r1 = r0 instanceof androidx.compose.foundation.gestures.snapping.SnapFlingBehaviorKt.C05461
            if (r1 == 0) goto L16
            r1 = r0
            androidx.compose.foundation.gestures.snapping.SnapFlingBehaviorKt$animateWithTarget$1 r1 = (androidx.compose.foundation.gestures.snapping.SnapFlingBehaviorKt.C05461) r1
            int r2 = r1.label
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final float m470calculateFinalOffsetFhqu1e0(int r2, float r3, float r4) {
        /*
            ...
            int r0 = r0.m467getClosestItembbeMdSM()
            boolean r0 = androidx.compose.foundation.gestures.snapping.FinalSnappingItem.m463equalsimpl0(r2, r0)
            r1 = 0
            if (r0 == 0) goto L1a
        ...
        L1a:
            androidx.compose.foundation.gestures.snapping.FinalSnappingItem$Companion r0 = androidx.compose.foundation.gestures.snapping.FinalSnappingItem.INSTANCE
            int r0 = r0.m468getNextItembbeMdSM()
            boolean r0 = androidx.compose.foundation.gestures.snapping.FinalSnappingItem.m463equalsimpl0(r2, r0)
            if (r0 == 0) goto L28
        L26:
            r3 = r4
        ...
        L28:
            ...
            int r4 = r4.m469getPreviousItembbeMdSM()
            boolean r2 = androidx.compose.foundation.gestures.snapping.FinalSnappingItem.m463equalsimpl0(r2, r4)
            if (r2 == 0) goto L35
            goto L36
        L35:
            r3 = 0
        ...
        L3d:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.snapping.SnapFlingBehaviorKt.m470calculateFinalOffsetFhqu1e0(int, float, float):float");
    }
}
