...
@DebugMetadata(c = "androidx.compose.foundation.gestures.snapping.SnapFlingBehavior$fling$result$1", f = "SnapFlingBehavior.kt", i = {0}, l = {KeyBoardKey.KeyboardKeyVolumeDown, KeyBoardKey.KeyboardKeyOemPlus}, m = "invokeSuspend", n = {"remainingScrollOffset"}, s = {"L$0"})
