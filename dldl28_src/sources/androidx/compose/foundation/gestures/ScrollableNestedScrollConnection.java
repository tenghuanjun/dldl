...
final class ScrollableNestedScrollConnection implements NestedScrollConnection {
    ...
    public long mo434onPreScrollOzD1aCk(long available, int source) {
        if (NestedScrollSource.m4544equalsimpl0(source, NestedScrollSource.INSTANCE.m4550getFlingWNlRxjI())) {
    ...
    public long mo432onPostScrollDzOQY0M(long consumed, long available, int source) {
        if (this.enabled) {
            return this.scrollingLogic.m438performRawScrollMKHz9U(available);
        }
        return Offset.INSTANCE.m3235getZeroF1C5BW0();
    }
    ...
    */
    public java.lang.Object mo431onPostFlingRZ2iAVY(long r3, long r5, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r7) {
        /*
            r2 = this;
        ...
        L38:
            ...
            r3.J$0 = r5
            r3.label = r1
            java.lang.Object r4 = r4.m436doFlingAnimationQWom1Mo(r5, r3)
            if (r4 != r7) goto L4e
            return r7
        L4e:
            r3 = r2
        L4f:
            ...
            long r4 = androidx.compose.ui.unit.Velocity.m6124minusAH228Gc(r5, r0)
            goto L61
        L5a:
            androidx.compose.ui.unit.Velocity$Companion r3 = androidx.compose.ui.unit.Velocity.INSTANCE
            long r4 = r3.m6132getZero9UxMQ8M()
            r3 = r2
        L61:
            androidx.compose.ui.unit.Velocity r4 = androidx.compose.ui.unit.Velocity.m6112boximpl(r4)
            r4.getPackedValue()
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.ScrollableNestedScrollConnection.mo431onPostFlingRZ2iAVY(long, long, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
