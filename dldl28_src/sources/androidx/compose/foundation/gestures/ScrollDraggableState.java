...
final class ScrollDraggableState implements DraggableState, DragScope {
    ...
    public void dragBy(float pixels) {
        ...
        scrollingLogic.m435dispatchScroll3eAAhYA(this.latestScrollScope, scrollingLogic.m444toOffsettuRUvjQ(pixels), NestedScrollSource.INSTANCE.m4549getDragWNlRxjI());
    }
    ...
    public Object drag(MutatePriority mutatePriority, Function2<? super DragScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        Object objScroll = this.scrollLogic.getScrollableState().scroll(mutatePriority, new AnonymousClass2(function2, null), continuation);
    ...
    public void dispatchRawDelta(float delta) {
        ScrollingLogic scrollingLogic = this.scrollLogic;
        scrollingLogic.m438performRawScrollMKHz9U(scrollingLogic.m444toOffsettuRUvjQ(delta));
    }
}
