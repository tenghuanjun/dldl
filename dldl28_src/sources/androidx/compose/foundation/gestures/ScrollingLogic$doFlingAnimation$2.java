...
final class ScrollingLogic$doFlingAnimation$2 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final Function1<Offset, Offset> function1 = new Function1<Offset, Offset>() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$outerScopeScroll$1
                ...
                public /* bridge */ /* synthetic */ Offset invoke(Offset offset) {
                    return Offset.m3208boximpl(m447invokeMKHz9U(offset.getPackedValue()));
                }

                /* JADX INFO: renamed from: invoke-MK-Hz9U, reason: not valid java name */
                public final long m447invokeMKHz9U(long j2) {
                    ScrollingLogic scrollingLogic4 = scrollingLogic3;
                    return scrollingLogic4.m439reverseIfNeededMKHz9U(scrollingLogic4.m435dispatchScroll3eAAhYA(scrollScope, scrollingLogic4.m439reverseIfNeededMKHz9U(j2), NestedScrollSource.INSTANCE.m4550getFlingWNlRxjI()));
                }
            };
            ...
            ScrollScope scrollScope2 = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$scope$1
                ...
                public float scrollBy(float pixels) {
                    ...
                    return scrollingLogic5.m443toFloatk4lQ0M(function1.invoke(Offset.m3208boximpl(scrollingLogic5.m444toOffsettuRUvjQ(pixels))).getPackedValue());
                }
            };
            ...
            float fReverseIfNeeded = scrollingLogic.reverseIfNeeded(scrollingLogic.m442toFloatTH1AsA0(j2));
        ...
        longRef.element = scrollingLogic.m445updateQWom1Mo(j, scrollingLogic2.reverseIfNeeded(((Number) obj).floatValue()));
