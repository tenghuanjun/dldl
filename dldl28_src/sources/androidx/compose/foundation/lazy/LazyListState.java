...
public final class LazyListState implements ScrollableState {
    ...
    public final void m714setPremeasureConstraintsBRTryo0$foundation_release(long j) {
    ...
    */
    ...
    public final MutableState<Unit> m712getPlacementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    private final void updateScrollDeltaForPostLookahead(float delta) {
        if (delta <= this.density.mo345toPx0680j_4(LazyListStateKt.DeltaThresholdForScrollAnimation)) {
            return;
        }
