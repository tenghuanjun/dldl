...
public final class LazyStaggeredGridItemPlacementAnimator {
    ...
    private final void initializeAnimation(LazyStaggeredGridMeasuredItem item, int mainAxisOffset, ItemInfo itemInfo) {
        ...
        long jMo796getOffsetnOccac = item.getOffset();
        if (item.getIsVertical()) {
            jM6010copyiSbpLlY$default = IntOffset.m6010copyiSbpLlY$default(jMo796getOffsetnOccac, 0, mainAxisOffset, 1, null);
        } else {
            jM6010copyiSbpLlY$default = IntOffset.m6010copyiSbpLlY$default(jMo796getOffsetnOccac, mainAxisOffset, 0, 2, null);
        }
        for (LazyLayoutAnimation lazyLayoutAnimation : itemInfo.getAnimations()) {
            if (lazyLayoutAnimation != null) {
                long jMo796getOffsetnOccac2 = item.getOffset();
                long jIntOffset = IntOffsetKt.IntOffset(IntOffset.m6014getXimpl(jMo796getOffsetnOccac2) - IntOffset.m6014getXimpl(jMo796getOffsetnOccac), IntOffset.m6015getYimpl(jMo796getOffsetnOccac2) - IntOffset.m6015getYimpl(jMo796getOffsetnOccac));
    ...
    private final void startAnimationsIfNeeded(LazyStaggeredGridMeasuredItem item) {
        ...
        for (LazyLayoutAnimation lazyLayoutAnimation : itemInfo.getAnimations()) {
            if (lazyLayoutAnimation != null) {
                ...
                if (!IntOffset.m6013equalsimpl0(rawOffset, LazyLayoutAnimation.INSTANCE.m752getNotInitializednOccac()) && !IntOffset.m6013equalsimpl0(rawOffset, jMo796getOffsetnOccac)) {
                    lazyLayoutAnimation.m746animatePlacementDeltagyyYBs(IntOffsetKt.IntOffset(IntOffset.m6014getXimpl(jMo796getOffsetnOccac) - IntOffset.m6014getXimpl(rawOffset), IntOffset.m6015getYimpl(jMo796getOffsetnOccac) - IntOffset.m6015getYimpl(rawOffset)));
                }
                lazyLayoutAnimation.m751setRawOffsetgyyYBs(jMo796getOffsetnOccac);
            }
        }
    }
