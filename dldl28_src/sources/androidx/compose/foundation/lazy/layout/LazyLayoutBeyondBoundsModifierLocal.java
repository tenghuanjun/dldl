...
public final class LazyLayoutBeyondBoundsModifierLocal implements ModifierLocalProvider<BeyondBoundsLayout>, BeyondBoundsLayout {
    ...
    public <T> T mo758layouto7g1Pn8(final int direction, Function1<? super BeyondBoundsLayout.BeyondBoundsScope, ? extends T> block) {
        int firstPlacedIndex;
        if (this.state.getItemCount() <= 0 || !this.state.getHasVisibleItems()) {
            return block.invoke(emptyBeyondBoundsScope);
        }
        if (m756isForward4vf7U8o(direction)) {
        ...
        T tInvoke = null;
        while (tInvoke == null && m755hasMoreContentFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction)) {
            T t = (T) m754addNextIntervalFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction);
            ...
            tInvoke = block.invoke(new BeyondBoundsLayout.BeyondBoundsScope() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutBeyondBoundsModifierLocal$layout$2
                @Override // androidx.compose.ui.layout.BeyondBoundsLayout.BeyondBoundsScope
                public boolean getHasMoreContent() {
                    return this.this$0.m755hasMoreContentFR3nfPY(objectRef.element, direction);
                }
            });
        }
        this.beyondBoundsInfo.removeInterval((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element);
    ...
    private final boolean m756isForward4vf7U8o(int i) {
        if (BeyondBoundsLayout.LayoutDirection.m4763equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m4769getBeforehoxUOeE())) {
            return false;
        }
        if (!BeyondBoundsLayout.LayoutDirection.m4763equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m4768getAfterhoxUOeE())) {
            if (BeyondBoundsLayout.LayoutDirection.m4763equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m4767getAbovehoxUOeE())) {
                return this.reverseLayout;
            }
            if (BeyondBoundsLayout.LayoutDirection.m4763equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m4770getBelowhoxUOeE())) {
                if (this.reverseLayout) {
                    return false;
                }
            } else if (BeyondBoundsLayout.LayoutDirection.m4763equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m4771getLefthoxUOeE())) {
                ...
                if (!BeyondBoundsLayout.LayoutDirection.m4763equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m4772getRighthoxUOeE())) {
    ...
    private final LazyLayoutBeyondBoundsInfo.Interval m754addNextIntervalFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval currentInterval, int direction) {
    ...
    public final boolean m755hasMoreContentFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval interval, int i) {
        if (m757isOppositeToOrientation4vf7U8o(i)) {
            return false;
        }
        if (m756isForward4vf7U8o(i)) {
    ...
    private final boolean m757isOppositeToOrientation4vf7U8o(int i) {
        if (!(BeyondBoundsLayout.LayoutDirection.m4763equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m4767getAbovehoxUOeE()) ? true : BeyondBoundsLayout.LayoutDirection.m4763equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m4770getBelowhoxUOeE()))) {
            if (!(BeyondBoundsLayout.LayoutDirection.m4763equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m4771getLefthoxUOeE()) ? true : BeyondBoundsLayout.LayoutDirection.m4763equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m4772getRighthoxUOeE()))) {
                if (!(BeyondBoundsLayout.LayoutDirection.m4763equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m4769getBeforehoxUOeE()) ? true : BeyondBoundsLayout.LayoutDirection.m4763equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m4768getAfterhoxUOeE()))) {
                    LazyLayoutBeyondBoundsModifierLocalKt.unsupportedDirection();
                    throw new KotlinNothingValueException();
                }
