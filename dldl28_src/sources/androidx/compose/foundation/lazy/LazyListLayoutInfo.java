...
public interface LazyListLayoutInfo {
    ...
    long mo703getViewportSizeYbymL2g();

    int getViewportStartOffset();

    List<LazyListItemInfo> getVisibleItemsInfo();

    /* JADX INFO: renamed from: androidx.compose.foundation.lazy.LazyListLayoutInfo$-CC, reason: invalid class name */
    /* JADX INFO: compiled from: LazyListLayoutInfo.kt */
    public final /* synthetic */ class CC {
        ...
        /* JADX INFO: renamed from: $default$getViewportSize-YbymL2g, reason: not valid java name */
        public static long m704$default$getViewportSizeYbymL2g(LazyListLayoutInfo _this) {
    ...
    public static final class DefaultImpls {
        @Deprecated
        /* JADX INFO: renamed from: getViewportSize-YbymL2g, reason: not valid java name */
        public static long m706getViewportSizeYbymL2g(LazyListLayoutInfo lazyListLayoutInfo) {
            return CC.m704$default$getViewportSizeYbymL2g(lazyListLayoutInfo);
        }
