...
public abstract class LazyGridMeasuredItemProvider {
    ...
    /* JADX INFO: renamed from: getAndMeasure-3p2s80s$default, reason: not valid java name */
    public static /* synthetic */ LazyGridMeasuredItem m739getAndMeasure3p2s80s$default(LazyGridMeasuredItemProvider lazyGridMeasuredItemProvider, int i, int i2, long j, int i3, Object obj) {
        if (obj != null) {
        ...
        return lazyGridMeasuredItemProvider.m740getAndMeasure3p2s80s(i, i2, j);
    }

    /* JADX INFO: renamed from: getAndMeasure-3p2s80s, reason: not valid java name */
    public final LazyGridMeasuredItem m740getAndMeasure3p2s80s(int index, int mainAxisSpacing, long constraints) {
        ...
        List<Placeable> listMo762measure0kLqBqw = this.measureScope.mo762measure0kLqBqw(index, constraints);
        if (Constraints.m5826getHasFixedWidthimpl(constraints)) {
            iM5829getMinHeightimpl = Constraints.m5830getMinWidthimpl(constraints);
        } else {
            if (!Constraints.m5825getHasFixedHeightimpl(constraints)) {
                throw new IllegalArgumentException("does not have fixed height".toString());
            }
            iM5829getMinHeightimpl = Constraints.m5829getMinHeightimpl(constraints);
        }
        return createItem(index, key, contentType, iM5829getMinHeightimpl, mainAxisSpacing, listMo762measure0kLqBqw);
    }
