...
public final class ExitToAppKt {
    ...
    public static final ImageVector getExitToApp(Icons.AutoMirrored.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Outlined.ExitToApp", Dp.m5882constructorimpl(24.0f), Dp.m5882constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
