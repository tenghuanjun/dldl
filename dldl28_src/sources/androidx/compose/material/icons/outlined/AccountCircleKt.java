...
public final class AccountCircleKt {
    ...
    public static final ImageVector getAccountCircle(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.AccountCircle", Dp.m5882constructorimpl(24.0f), Dp.m5882constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilder.close();
        ImageVector.Builder.m4140addPathoIyEayM$default(builder, pathBuilder.getNodes(), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3855getButtKaPHkGw, iM3865getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
