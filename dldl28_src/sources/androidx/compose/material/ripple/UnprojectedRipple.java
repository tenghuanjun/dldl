...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m1263setColorDxMtmZc(long color, float alpha) {
        long jM1262calculateRippleColor5vOe2sY = m1262calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (color2 == null ? false : Color.m3495equalsimpl0(color2.m3504unboximpl(), jM1262calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m3484boximpl(jM1262calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m3548toArgb8_81llA(jM1262calculateRippleColor5vOe2sY)));
    }
    ...
    private final long m1262calculateRippleColor5vOe2sY(long color, float alpha) {
        if (Build.VERSION.SDK_INT < 28) {
            alpha *= 2;
        }
        return Color.m3493copywmQWz5c$default(color, RangesKt.coerceAtMost(alpha, 1.0f), 0.0f, 0.0f, 0.0f, 14, null);
    }
