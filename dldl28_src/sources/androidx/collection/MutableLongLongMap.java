    ...
    private final void resizeStorage(int newCapacity) {
        ...
        while (i2 < i) {
            if (((jArr3[i2 >> 3] >> ((i2 & 7) << 3)) & 255) < 128) {
                ...
                jArr7[iFindFirstAvailableSlot] = jArr5[i2];
            } else {
                jArr = jArr3;
                jArr2 = jArr4;
            }
