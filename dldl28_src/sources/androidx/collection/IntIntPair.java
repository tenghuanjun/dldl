...
public final class IntIntPair {
    ...
    public static final /* synthetic */ IntIntPair m52boximpl(long j) {
        return new IntIntPair(j);
    }

    /* JADX INFO: renamed from: component1-impl, reason: not valid java name */
    public static final int m53component1impl(long j) {
        return (int) (j >> 32);
    }

    /* JADX INFO: renamed from: component2-impl, reason: not valid java name */
    public static final int m54component2impl(long j) {
    ...
    public static boolean m57equalsimpl(long j, Object obj) {
        return (obj instanceof IntIntPair) && j == ((IntIntPair) obj).getPackedValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m58equalsimpl0(long j, long j2) {
        return j == j2;
    }

    /* JADX INFO: renamed from: getFirst-impl, reason: not valid java name */
    public static final int m59getFirstimpl(long j) {
        return (int) (j >> 32);
    }
    ...
    public static final int m60getSecondimpl(long j) {
        return (int) (j & 4294967295L);
    }
    ...
    public boolean equals(Object obj) {
        return m57equalsimpl(this.packedValue, obj);
    }
    ...
    public static long m55constructorimpl(int i, int i2) {
        return m56constructorimpl((((long) i2) & 4294967295L) | (((long) i) << 32));
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m62toStringimpl(long j) {
        return "(" + m59getFirstimpl(j) + ", " + m60getSecondimpl(j) + ')';
    }
