...
public interface ReceiveChannel<E> {
    ...
    Object mo8252receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo8253tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo8253tryReceivePtdJZtk = receiveChannel.mo8253tryReceivePtdJZtk();
            if (ChannelResult.m8268isSuccessimpl(objMo8253tryReceivePtdJZtk)) {
                return (E) ChannelResult.m8264getOrThrowimpl(objMo8253tryReceivePtdJZtk);
            }
            Throwable thM8262exceptionOrNullimpl = ChannelResult.m8262exceptionOrNullimpl(objMo8253tryReceivePtdJZtk);
            if (thM8262exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM8262exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) {
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo8252receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m8263getOrNullimpl(r4)
                return r4
            */
