...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.channels.BroadcastChannelImpl", f = "BroadcastChannel.kt", i = {0, 0}, l = {KeyBoardKey.KeyboardKeyIcoClear}, m = "send", n = {"this", "element"}, s = {"L$0", "L$1"})
        ...
        try {
            ...
            if (!isClosedForSend() || this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                if (this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                    subscriberConflated.mo8248trySendJP2dKIU(getValue());
                }
    ...
    */
    ...
    public Object mo8248trySendJP2dKIU(E element) {
        ...
        try {
            if (isClosedForSend()) {
                return super.mo8248trySendJP2dKIU(element);
            }
            List<? extends BufferedChannel<E>> list = this.subscribers;
            ...
            while (it2.hasNext()) {
                ((BufferedChannel) it2.next()).mo8248trySendJP2dKIU(element);
            }
