...
public interface SendChannel<E> {
    ...
    Object mo8248trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m8268isSuccessimpl(objMo8248trySendJP2dKIU)) {
                return true;
            }
            Throwable thM8262exceptionOrNullimpl = ChannelResult.m8262exceptionOrNullimpl(objMo8248trySendJP2dKIU);
