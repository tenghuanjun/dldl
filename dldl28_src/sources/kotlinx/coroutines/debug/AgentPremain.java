...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM6745constructorimpl = Result.m6745constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM6745constructorimpl = Result.m6745constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m6751isFailureimpl(objM6745constructorimpl) ? null : objM6745constructorimpl);
