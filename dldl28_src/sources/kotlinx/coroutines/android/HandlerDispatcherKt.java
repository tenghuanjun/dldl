...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM6745constructorimpl = Result.m6745constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM6745constructorimpl = Result.m6745constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m6751isFailureimpl(objM6745constructorimpl) ? null : objM6745constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo8304dispatch(cancellableContinuationImpl2.get$context(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
