...
public interface Delay {
    ...
    void mo8305scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation);
    ...
    public static final class DefaultImpls {
        ...
        public static Object delay(Delay delay, long j, Continuation<? super Unit> continuation) {
            ...
            delay.mo8305scheduleResumeAfterDelay(j, cancellableContinuationImpl);
