...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final byte m8483deprecated_getByte(long index) {
    ...
    */
        ...
        while (beginIndex < endIndex) {
            ...
            if (cCharAt2 < 128) {
                ...
                if (cCharAt2 < 2048) {
                    ...
                    segmentWritableSegment$okio2.data[segmentWritableSegment$okio2.limit] = (byte) ((cCharAt2 >> 6) | KeyBoardKey.KeyboardKeyOem3);
                    ...
                    if (cCharAt2 > 56319 || 56320 > cCharAt3 || cCharAt3 >= 57344) {
                        ...
                        segmentWritableSegment$okio4.data[segmentWritableSegment$okio4.limit] = (byte) ((i5 >> 18) | KeyBoardKey.KeyboardKeyOemAttn);
    ...
    public Buffer writeUtf8CodePoint(int codePoint) {
        if (codePoint < 128) {
            ...
            segmentWritableSegment$okio.data[segmentWritableSegment$okio.limit] = (byte) ((codePoint >> 6) | KeyBoardKey.KeyboardKeyOem3);
            ...
            segmentWritableSegment$okio3.data[segmentWritableSegment$okio3.limit] = (byte) ((codePoint >> 18) | KeyBoardKey.KeyboardKeyOemAttn);
    ...
    public long writeAll(Source source) throws IOException {
        ...
        long j = 0;
        while (true) {
            long j2 = source.read(this, IjkMediaMeta.AV_CH_TOP_FRONT_CENTER);
            if (j2 == -1) {
                return j;
            }
            j += j2;
        ...
        while (byteCount > 0) {
            ...
            if (byteCount < i - r1.pos) {
                ...
                if (segment != null && segment.owner) {
                    if ((((long) segment.limit) + byteCount) - ((long) (segment.shared ? 0 : segment.pos)) <= IjkMediaMeta.AV_CH_TOP_FRONT_CENTER) {
            ...
            if (size() - j < j) {
                ...
                if (segment != null) {
                    ...
                    while (size < size3) {
                        ...
                        while (i < iMin) {
                            if (bArr[i] == b && _BufferKt.rangeEquals(segment, i + 1, bArrInternalArray$okio, 1, size2)) {
                                return ((long) (i - segment.pos)) + size;
                            }
                            i++;
                        }
                ...
                if (segment != null) {
                    ...
                    while (size < size5) {
                        ...
                        i = (int) ((((long) segment.pos) + j) - size);
                        while (i < iMin2) {
                            if (bArr2[i] == b2 && _BufferKt.rangeEquals(segment, i + 1, bArrInternalArray$okio2, 1, size4)) {
                                return ((long) (i - segment.pos)) + size;
                            }
                            i++;
                        }
