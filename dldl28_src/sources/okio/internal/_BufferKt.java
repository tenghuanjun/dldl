    ...
    */
            ...
            if (cCharAt2 < 128) {
                ...
                if (cCharAt2 < 2048) {
                    ...
                    if (cCharAt2 > 56319 || 56320 > cCharAt3 || cCharAt3 >= 57344) {
                        ...
                        segmentWritableSegment$okio4.data[segmentWritableSegment$okio4.limit] = (byte) ((i7 >> 18) | KeyBoardKey.KeyboardKeyOemAttn);
    ...
    public static final Buffer commonWriteUtf8CodePoint(Buffer buffer, int i) {
        ...
        if (i < 128) {
            ...
            segmentWritableSegment$okio.data[segmentWritableSegment$okio.limit] = (byte) ((i >> 6) | KeyBoardKey.KeyboardKeyOem3);
            ...
            segmentWritableSegment$okio3.data[segmentWritableSegment$okio3.limit] = (byte) ((i >> 18) | KeyBoardKey.KeyboardKeyOemAttn);
    ...
    public static final long commonWriteAll(Buffer buffer, Source source) throws IOException {
        ...
        long j = 0;
        while (true) {
            long j2 = source.read(buffer, IjkMediaMeta.AV_CH_TOP_FRONT_CENTER);
            if (j2 == -1) {
                return j;
            }
            j += j2;
        ...
        while (j > 0) {
            ...
            if (j < i - r1.pos) {
                ...
                if (segment != null && segment.owner) {
                    if ((((long) segment.limit) + j) - ((long) (segment.shared ? 0 : segment.pos)) <= IjkMediaMeta.AV_CH_TOP_FRONT_CENTER) {
    ...
    public static final long commonIndexOf(Buffer buffer, ByteString bytes, long j) {
        ...
        if (buffer.size() - j3 < j3) {
            ...
            while (size < size3) {
                ...
                for (int i = (int) ((((long) segment.pos) + j3) - size); i < iMin; i++) {
        ...
        while (size < size5) {
            ...
            for (int i2 = (int) ((((long) segment.pos) + j5) - size); i2 < iMin2; i2++) {
