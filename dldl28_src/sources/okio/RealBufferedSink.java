...
public final class RealBufferedSink implements BufferedSink {
    ...
    public long writeAll(Source source) throws IOException {
        ...
        long j = 0;
        while (true) {
            long j2 = source.read(this.bufferField, IjkMediaMeta.AV_CH_TOP_FRONT_CENTER);
            if (j2 == -1) {
                return j;
            }
            j += j2;
