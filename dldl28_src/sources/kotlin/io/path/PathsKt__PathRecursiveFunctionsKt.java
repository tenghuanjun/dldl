...
class PathsKt__PathRecursiveFunctionsKt extends PathsKt__PathReadWriteKt {
        ...
        if ((i & 2) != 0) {
            function3 = new Function3() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.1
                ...
                public /* bridge */ /* synthetic */ Object invoke(Object obj2, Object obj3, Object obj4) {
                    return invoke(l$$ExternalSyntheticApiModelOutline0.m6710m(obj2), l$$ExternalSyntheticApiModelOutline0.m6710m(obj3), (Exception) obj4);
                }
        ...
        if (z2) {
            return PathsKt.copyToRecursively(path, target, onError, z, new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.2
                ...
                public /* bridge */ /* synthetic */ CopyActionResult invoke(CopyActionContext copyActionContext, Path path2, Path path3) {
                    return invoke2(copyActionContext, l$$ExternalSyntheticApiModelOutline0.m6710m((Object) path2), l$$ExternalSyntheticApiModelOutline0.m6710m((Object) path3));
                }
        ...
        if ((i & 8) != 0) {
            function32 = new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.4
                ...
                public /* bridge */ /* synthetic */ CopyActionResult invoke(CopyActionContext copyActionContext, Path path3, Path path4) {
                    return invoke2(copyActionContext, l$$ExternalSyntheticApiModelOutline0.m6710m((Object) path3), l$$ExternalSyntheticApiModelOutline0.m6710m((Object) path4));
                }
    ...
    public static final Path copyToRecursively(final Path path, final Path target, final Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> onError, boolean z, final Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult> copyAction) throws FileSystemException {
        ...
        if (!Files.exists(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))) {
            l$$ExternalSyntheticApiModelOutline0.m6740m$2();
            throw l$$ExternalSyntheticApiModelOutline0.m6709m(path.toString(), target.toString(), "The source file doesn't exist.");
        }
        ...
        if (Files.exists(path, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) && (z || !Files.isSymbolicLink(path))) {
            ...
            if (!z2 || !Files.isSameFile(path, target)) {
                ...
                if (zStartsWith) {
                    l$$ExternalSyntheticApiModelOutline0.m6725m();
                    throw l$$ExternalSyntheticApiModelOutline0.m(path.toString(), target.toString(), "Recursively copying a directory into its subdirectory is prohibited.");
                }
            }
        }
        PathsKt.visitFileTree$default(path, 0, z, new Function1<FileVisitorBuilder, Unit>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.5
            ...
            /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function2<Path, BasicFileAttributes, FileVisitResult> {
                ...
                public /* bridge */ /* synthetic */ FileVisitResult invoke(Path path, BasicFileAttributes basicFileAttributes) {
                    return invoke2(l$$ExternalSyntheticApiModelOutline0.m6710m((Object) path), l$$ExternalSyntheticApiModelOutline0.m6716m((Object) basicFileAttributes));
                }
            ...
            public final void invoke2(FileVisitorBuilder visitFileTree) {
                ...
                visitFileTree.onPostVisitDirectory(new Function2<Path, IOException, FileVisitResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.5.4
                    ...
                    public /* bridge */ /* synthetic */ FileVisitResult invoke(Path path4, IOException iOException) {
                        return invoke2(l$$ExternalSyntheticApiModelOutline0.m6710m((Object) path4), iOException);
                    }
            ...
            /* synthetic */ class AnonymousClass3 extends FunctionReferenceImpl implements Function2<Path, Exception, FileVisitResult> {
                ...
                public /* bridge */ /* synthetic */ FileVisitResult invoke(Path path, Exception exc) {
                    return invoke2(l$$ExternalSyntheticApiModelOutline0.m6710m((Object) path), exc);
                }
    ...
    public static final void deleteRecursively(Path path) throws FileSystemException {
        ...
        FileSystemException fileSystemExceptionM = l$$ExternalSyntheticApiModelOutline0.m("Failed to delete one or more files. See suppressed exceptions for details.");
    ...
    private static final List<Exception> deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt(Path path) {
        ...
        if (parent != null) {
            ...
            if (directoryStreamNewDirectoryStream != null) {
                ...
                try {
                    DirectoryStream directoryStreamM = l$$ExternalSyntheticApiModelOutline0.m((Object) directoryStream);
                    if (l$$ExternalSyntheticApiModelOutline0.m6728m((Object) directoryStreamM)) {
                        exceptionsCollector.setPath(parent);
                        SecureDirectoryStream secureDirectoryStreamM6712m = l$$ExternalSyntheticApiModelOutline0.m6712m((Object) directoryStreamM);
                        Path fileName = path.getFileName();
                        Intrinsics.checkNotNullExpressionValue(fileName, "getFileName(...)");
                        handleEntry$PathsKt__PathRecursiveFunctionsKt(secureDirectoryStreamM6712m, fileName, exceptionsCollector);
                    } else {
                        z = true;
                    }
    ...
    private static final void enterDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, ExceptionsCollector exceptionsCollector) {
        ...
        try {
            SecureDirectoryStream secureDirectoryStreamM6712m = l$$ExternalSyntheticApiModelOutline0.m6712m((Object) secureDirectoryStream2);
            Iterator it = secureDirectoryStreamM6712m.iterator();
            while (it.hasNext()) {
                Path fileName = l$$ExternalSyntheticApiModelOutline0.m6710m(it.next()).getFileName();
                Intrinsics.checkNotNullExpressionValue(fileName, "getFileName(...)");
                handleEntry$PathsKt__PathRecursiveFunctionsKt(secureDirectoryStreamM6712m, fileName, exceptionsCollector);
            }
            Unit unit = Unit.INSTANCE;
    ...
    private static final boolean isDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, LinkOption... linkOptionArr) {
        Boolean boolValueOf;
        try {
            boolValueOf = Boolean.valueOf(l$$ExternalSyntheticApiModelOutline0.m6715m((Object) secureDirectoryStream.getFileAttributeView(path, l$$ExternalSyntheticApiModelOutline0.m$1(), (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))).readAttributes().isDirectory());
        } catch (NoSuchFileException unused) {
            boolValueOf = null;
        }
        if (boolValueOf != null) {
    ...
    private static final void insecureEnterDirectory$PathsKt__PathRecursiveFunctionsKt(Path path, ExceptionsCollector exceptionsCollector) {
        ...
        DirectoryStream directoryStream = directoryStreamNewDirectoryStream;
        try {
            Iterator it = l$$ExternalSyntheticApiModelOutline0.m((Object) directoryStream).iterator();
            while (it.hasNext()) {
                Path pathM6710m = l$$ExternalSyntheticApiModelOutline0.m6710m(it.next());
                Intrinsics.checkNotNull(pathM6710m);
                insecureHandleEntry$PathsKt__PathRecursiveFunctionsKt(pathM6710m, exceptionsCollector);
            }
            Unit unit = Unit.INSTANCE;
            CloseableKt.closeFinally(directoryStream, null);
        } finally {
