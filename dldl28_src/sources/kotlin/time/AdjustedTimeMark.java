...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo8063minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m8209minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: elapsedNow-UwyO8pc */
    public long mo8062elapsedNowUwyO8pc() {
        return Duration.m8107minusLRDsOJo(this.mark.mo8062elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo8065plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m8108plusLRDsOJo(this.adjustment, duration), null);
    }
}
