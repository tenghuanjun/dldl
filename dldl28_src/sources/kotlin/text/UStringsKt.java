...
public final class UStringsKt {
    ...
    public static final String m8059toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m8061toStringolVBNx4(short s, int i) {
    ...
    public static final String m8060toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m8058toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m6841constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m6757boximpl(UByte.m6763constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m6841constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m7021boximpl(UShort.m7027constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM6841constructorimpl = UInt.m6841constructorimpl(i);
        int iM = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                if (iM == 119304647) {
                    iM = UByte$$ExternalSyntheticBackport0.m(-1, iM6841constructorimpl);
                    if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM6841constructorimpl2 = UInt.m6841constructorimpl(i3 * iM6841constructorimpl);
            int iM6841constructorimpl3 = UInt.m6841constructorimpl(UInt.m6841constructorimpl(iDigitOf) + iM6841constructorimpl2);
            if (Integer.compare(iM6841constructorimpl3 ^ Integer.MIN_VALUE, iM6841constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM6841constructorimpl3;
        }
        return UInt.m6835boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM6920constructorimpl = ULong.m6920constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                if (jM$1 == 512409557603043100L) {
                    jM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1L, jM6920constructorimpl);
                    if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM6920constructorimpl2 = ULong.m6920constructorimpl(j * jM6920constructorimpl);
            long jM6920constructorimpl3 = ULong.m6920constructorimpl(ULong.m6920constructorimpl(((long) UInt.m6841constructorimpl(iDigitOf)) & 4294967295L) + jM6920constructorimpl2);
            if (Long.compare(jM6920constructorimpl3 ^ Long.MIN_VALUE, jM6920constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            j = jM6920constructorimpl3;
        }
