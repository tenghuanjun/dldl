...
public class ItemWelfareTaskBindingImpl extends ItemWelfareTaskBinding {
    ...
    public ItemWelfareTaskBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private ItemWelfareTaskBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.cy.yyjia.zhe28.databinding.ItemWelfareTaskBinding
    ...
    protected void executeBindings() {
        ...
        if (j2 != 0) {
            TextViewBindingAdapter.setText(this.btn, welfare);
