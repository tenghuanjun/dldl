...
public class ItemBbsMessageOfficialBindingImpl extends ItemBbsMessageOfficialBinding {
    ...
    public ItemBbsMessageOfficialBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private ItemBbsMessageOfficialBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.cy.yyjia.zhe28.databinding.ItemBbsMessageOfficialBinding
    ...
    protected void executeBindings() {
        ...
        if (j2 != 0) {
            ...
            TextViewBindingAdapter.setText(this.mboundView2, message);
            TextViewBindingAdapter.setText(this.mboundView3, createTime);
        }
    }
}
