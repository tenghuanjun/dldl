...
@DebugMetadata(c = "com.cy.yyjia.zhe28.util.Repository$fastLogin$$inlined$post$1", f = "Repository.kt", i = {}, l = {431}, m = "invokeSuspend", n = {}, s = {})
public final class Repository$fastLogin$$inlined$post$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public Repository$fastLogin$$inlined$post$1(Function1 function1, Function1 function12, String str, Map map, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new Repository$fastLogin$$inlined$post$1(this.$success, this.$fail, this.$url, this.$param, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((Repository$fastLogin$$inlined$post$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.cy.yyjia.zhe28.util.Repository$fastLogin$$inlined$post$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: NetUtil.kt */
            ...
            try {
                ...
                if (strString != null) {
                    if (responseExecute.isSuccessful()) {
                        ...
                        if (i == 200) {
                            Object objFromJson = new Gson().fromJson(strString, new TypeToken<BaseResult<LoginResult>>() { // from class: com.cy.yyjia.zhe28.util.Repository$fastLogin$.inlined.post.1.1.1
                            }.getType());
