...
@DebugMetadata(c = "com.cy.yyjia.zhe28.ui.fragment.BbsIndexFragment$onResume$$inlined$get$1", f = "BbsIndexFragment.kt", i = {}, l = {382}, m = "invokeSuspend", n = {}, s = {})
public final class BbsIndexFragment$onResume$$inlined$get$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ Map $param;
    final /* synthetic */ String $url;
    int label;
    final /* synthetic */ BbsIndexFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BbsIndexFragment$onResume$$inlined$get$1(String str, Map map, Continuation continuation, BbsIndexFragment bbsIndexFragment, BbsIndexFragment bbsIndexFragment2) {
        super(2, continuation);
        this.$url = str;
        this.$param = map;
        this.this$0 = bbsIndexFragment;
    }
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        String str = this.$url;
        Map map = this.$param;
        BbsIndexFragment bbsIndexFragment = this.this$0;
        return new BbsIndexFragment$onResume$$inlined$get$1(str, map, continuation, bbsIndexFragment, bbsIndexFragment);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((BbsIndexFragment$onResume$$inlined$get$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (!(requestResult instanceof NetUtil.RequestResult.Success)) {
            ...
            Iterator it = ((List) ((NetUtil.RequestResult.Success) requestResult).getData()).iterator();
            boolean z = false;
            while (it.hasNext()) {
                z = ((GameToolBean) it.next()).isDot() == 1;
                if (z) {
                    break;
                }
            }
            BbsIndexFragment.access$getMBinding(this.this$0).point.setVisibility(z ? 0 : 8);
        }
        return Unit.INSTANCE;
    }

    /* JADX INFO: renamed from: com.cy.yyjia.zhe28.ui.fragment.BbsIndexFragment$onResume$$inlined$get$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: NetUtil.kt */
            ...
            try {
                ...
                if (strString != null) {
                    if (responseExecute.isSuccessful()) {
                        ...
                        if (i == 200) {
                            Object objFromJson = new Gson().fromJson(strString, new TypeToken<BaseResult<List<GameToolBean>>>() { // from class: com.cy.yyjia.zhe28.ui.fragment.BbsIndexFragment$onResume$.inlined.get.1.1.1
                            }.getType());
