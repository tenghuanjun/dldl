...
@DebugMetadata(c = "com.cy.yyjia.zhe28.ui.fragment.BbsFragment$getBlockDetail$$inlined$get$1", f = "BbsFragment.kt", i = {}, l = {382}, m = "invokeSuspend", n = {}, s = {})
public final class BbsFragment$getBlockDetail$$inlined$get$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public BbsFragment$getBlockDetail$$inlined$get$1(String str, Map map, Continuation continuation, BbsFragment bbsFragment, BbsFragment bbsFragment2) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        return new BbsFragment$getBlockDetail$$inlined$get$1(str, map, continuation, bbsFragment, bbsFragment);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((BbsFragment$getBlockDetail$$inlined$get$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.cy.yyjia.zhe28.ui.fragment.BbsFragment$getBlockDetail$$inlined$get$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: NetUtil.kt */
            ...
            try {
                ...
                if (strString != null) {
                    if (responseExecute.isSuccessful()) {
                        ...
                        if (i == 200) {
                            Object objFromJson = new Gson().fromJson(strString, new TypeToken<BaseResult<BbsDetailBean>>() { // from class: com.cy.yyjia.zhe28.ui.fragment.BbsFragment$getBlockDetail$.inlined.get.1.1.1
                            }.getType());
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (requestResult instanceof NetUtil.RequestResult.Success) {
            ...
            BbsFragment.access$getMBinding(this.this$0).setData(bbsDetailBean);
            BbsFragment.access$getMBinding(this.this$0).tab.removeAllTabs();
            for (BbsDetailBean.Cate cate : bbsDetailBean.getInfo().getCates()) {
                TabLayout.Tab tabNewTab = BbsFragment.access$getMBinding(this.this$0).tab.newTab();
                ...
                BbsFragment.access$getMBinding(this.this$0).tab.addTab(tabNewTab);
            }
