...
@DebugMetadata(c = "com.cy.yyjia.zhe28.ui.activity.ItemSellActivity$getServer$$inlined$get$1", f = "ItemSellActivity.kt", i = {}, l = {382}, m = "invokeSuspend", n = {}, s = {})
public final class ItemSellActivity$getServer$$inlined$get$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ Map $param;
    final /* synthetic */ String $url;
    int label;
    final /* synthetic */ ItemSellActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ItemSellActivity$getServer$$inlined$get$1(String str, Map map, Continuation continuation, ItemSellActivity itemSellActivity, ItemSellActivity itemSellActivity2) {
        super(2, continuation);
        this.$url = str;
        this.$param = map;
        this.this$0 = itemSellActivity;
    }
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        String str = this.$url;
        Map map = this.$param;
        ItemSellActivity itemSellActivity = this.this$0;
        return new ItemSellActivity$getServer$$inlined$get$1(str, map, continuation, itemSellActivity, itemSellActivity);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ItemSellActivity$getServer$$inlined$get$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.cy.yyjia.zhe28.ui.activity.ItemSellActivity$getServer$$inlined$get$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: NetUtil.kt */
            ...
            try {
                ...
                if (strString != null) {
                    if (responseExecute.isSuccessful()) {
                        ...
                        if (i == 200) {
                            Object objFromJson = new Gson().fromJson(strString, new TypeToken<BaseResult<List<String>>>() { // from class: com.cy.yyjia.zhe28.ui.activity.ItemSellActivity$getServer$.inlined.get.1.1.1
                            }.getType());
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (requestResult instanceof NetUtil.RequestResult.Success) {
            ...
            while (it.hasNext()) {
                arrayList.add(new GMRoleBean("", "", "", (String) it.next(), "", ""));
            }
            final BaseAdapter baseAdapter = new BaseAdapter(R.layout.item_deal_role, arrayList);
            final BaseDialog baseDialogShow = new QuickDialog(this.this$0, R.layout.dialog_gm_roles).setAdapter(R.id.rv, baseAdapter).setText(R.id.tv_title, "选择区服").setOnClickListener(R.id.iv_close, new BaseDialog.OnClickListener() { // from class: com.cy.yyjia.zhe28.ui.activity.ItemSellActivity$getServer$1$dialog$1
                @Override // com.cy.yyjia.zhe28.base.BaseDialog.OnClickListener
                public final void onClick(BaseDialog baseDialog, View view) {
                    baseDialog.dismiss();
                }
            }).show();
            final ItemSellActivity itemSellActivity = this.this$0;
            baseAdapter.setOnItemClickListener(new OnItemClickListener() { // from class: com.cy.yyjia.zhe28.ui.activity.ItemSellActivity$getServer$1$1
                @Override // com.chad.library.adapter.base.listener.OnItemClickListener
                public final void onItemClick(BaseQuickAdapter<?, ?> baseQuickAdapter, View view, int i2) {
                    Intrinsics.checkNotNullParameter(baseQuickAdapter, "<anonymous parameter 0>");
                    Intrinsics.checkNotNullParameter(view, "<anonymous parameter 1>");
                    ItemTradeBean data = itemSellActivity.getMBinding().getData();
                    Intrinsics.checkNotNull(data);
                    data.setServiceCode(baseAdapter.getItem(i2).getServiceCode());
                    itemSellActivity.getMBinding().setData(itemSellActivity.getMBinding().getData());
