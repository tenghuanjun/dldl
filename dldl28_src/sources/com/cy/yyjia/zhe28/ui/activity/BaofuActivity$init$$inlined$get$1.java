...
@DebugMetadata(c = "com.cy.yyjia.zhe28.ui.activity.BaofuActivity$init$$inlined$get$1", f = "BaofuActivity.kt", i = {}, l = {382}, m = "invokeSuspend", n = {}, s = {})
public final class BaofuActivity$init$$inlined$get$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ Map $param;
    final /* synthetic */ String $url;
    int label;
    final /* synthetic */ BaofuActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BaofuActivity$init$$inlined$get$1(String str, Map map, Continuation continuation, BaofuActivity baofuActivity, BaofuActivity baofuActivity2) {
        super(2, continuation);
        this.$url = str;
        this.$param = map;
        this.this$0 = baofuActivity;
    }
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        String str = this.$url;
        Map map = this.$param;
        BaofuActivity baofuActivity = this.this$0;
        return new BaofuActivity$init$$inlined$get$1(str, map, continuation, baofuActivity, baofuActivity);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((BaofuActivity$init$$inlined$get$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (requestResult instanceof NetUtil.RequestResult.Success) {
            BaofuActivity.DataBean dataBean = (BaofuActivity.DataBean) ((NetUtil.RequestResult.Success) requestResult).getData();
            this.this$0.getMBinding().tvService.setText(dataBean.getMore());
            for (GameBean gameBean : dataBean.getGameList()) {
                this.this$0.getMBinding().f439tv.append(gameBean.getName() + StringUtils.LF);
            }
    ...
    /* JADX INFO: renamed from: com.cy.yyjia.zhe28.ui.activity.BaofuActivity$init$$inlined$get$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: NetUtil.kt */
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super NetUtil.RequestResult<? extends BaofuActivity.DataBean>>, Object> {
        final /* synthetic */ Map $param;
        final /* synthetic */ String $url;
        int label;
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super NetUtil.RequestResult<? extends BaofuActivity.DataBean>> continuation) {
            ...
            try {
                ...
                if (strString != null) {
                    if (responseExecute.isSuccessful()) {
                        ...
                        if (i == 200) {
                            Object objFromJson = new Gson().fromJson(strString, new TypeToken<BaseResult<BaofuActivity.DataBean>>() { // from class: com.cy.yyjia.zhe28.ui.activity.BaofuActivity$init$.inlined.get.1.1.1
                            }.getType());
