...
import com.cy.yyjia.zhe28.ui.dialog.InviteGameDialog;
...
@DebugMetadata(c = "com.cy.yyjia.zhe28.ui.activity.InviteActivity$onClick$$inlined$get$1", f = "InviteActivity.kt", i = {}, l = {382}, m = "invokeSuspend", n = {}, s = {})
public final class InviteActivity$onClick$$inlined$get$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public InviteActivity$onClick$$inlined$get$1(String str, Map map, Continuation continuation, InviteActivity inviteActivity, InviteActivity inviteActivity2) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        return new InviteActivity$onClick$$inlined$get$1(str, map, continuation, inviteActivity, inviteActivity);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((InviteActivity$onClick$$inlined$get$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.cy.yyjia.zhe28.ui.activity.InviteActivity$onClick$$inlined$get$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: NetUtil.kt */
            ...
            try {
                ...
                if (strString != null) {
                    if (responseExecute.isSuccessful()) {
                        ...
                        if (i == 200) {
                            Object objFromJson = new Gson().fromJson(strString, new TypeToken<BaseResult<List<GameBean>>>() { // from class: com.cy.yyjia.zhe28.ui.activity.InviteActivity$onClick$.inlined.get.1.1.1
                            }.getType());
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (requestResult instanceof NetUtil.RequestResult.Success) {
            new InviteGameDialog(this.this$0).setData((List) ((NetUtil.RequestResult.Success) requestResult).getData()).show();
