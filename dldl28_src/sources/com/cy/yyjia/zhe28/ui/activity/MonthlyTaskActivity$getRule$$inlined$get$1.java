...
@DebugMetadata(c = "com.cy.yyjia.zhe28.ui.activity.MonthlyTaskActivity$getRule$$inlined$get$1", f = "MonthlyTaskActivity.kt", i = {}, l = {382}, m = "invokeSuspend", n = {}, s = {})
public final class MonthlyTaskActivity$getRule$$inlined$get$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public MonthlyTaskActivity$getRule$$inlined$get$1(String str, Map map, Continuation continuation, MonthlyTaskActivity monthlyTaskActivity, MonthlyTaskActivity monthlyTaskActivity2) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        return new MonthlyTaskActivity$getRule$$inlined$get$1(str, map, continuation, monthlyTaskActivity, monthlyTaskActivity);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((MonthlyTaskActivity$getRule$$inlined$get$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (!(requestResult instanceof NetUtil.RequestResult.Success)) {
            ...
            new RuleDialog(this.this$0).setTextStr((String) ((NetUtil.RequestResult.Success) requestResult).getData()).show();
        }
        return Unit.INSTANCE;
    }

    /* JADX INFO: renamed from: com.cy.yyjia.zhe28.ui.activity.MonthlyTaskActivity$getRule$$inlined$get$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: NetUtil.kt */
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super NetUtil.RequestResult<? extends String>>, Object> {
        final /* synthetic */ Map $param;
        final /* synthetic */ String $url;
        int label;
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super NetUtil.RequestResult<? extends String>> continuation) {
            ...
            try {
                ...
                if (strString != null) {
                    if (responseExecute.isSuccessful()) {
                        ...
                        if (i == 200) {
                            Object objFromJson = new Gson().fromJson(strString, new TypeToken<BaseResult<String>>() { // from class: com.cy.yyjia.zhe28.ui.activity.MonthlyTaskActivity$getRule$.inlined.get.1.1.1
                            }.getType());
