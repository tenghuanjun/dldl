...
@DebugMetadata(c = "com.cy.yyjia.zhe28.ui.activity.VipCouponActivity$getData$$inlined$get$1", f = "VipCouponActivity.kt", i = {}, l = {382}, m = "invokeSuspend", n = {}, s = {})
public final class VipCouponActivity$getData$$inlined$get$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ Map $param;
    final /* synthetic */ String $url;
    int label;
    final /* synthetic */ VipCouponActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public VipCouponActivity$getData$$inlined$get$1(String str, Map map, Continuation continuation, VipCouponActivity vipCouponActivity, VipCouponActivity vipCouponActivity2) {
        super(2, continuation);
        this.$url = str;
        this.$param = map;
        this.this$0 = vipCouponActivity;
    }
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        String str = this.$url;
        Map map = this.$param;
        VipCouponActivity vipCouponActivity = this.this$0;
        return new VipCouponActivity$getData$$inlined$get$1(str, map, continuation, vipCouponActivity, vipCouponActivity);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((VipCouponActivity$getData$$inlined$get$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (!(requestResult instanceof NetUtil.RequestResult.Success)) {
            ...
            VipCouponIndexBean vipCouponIndexBean = (VipCouponIndexBean) ((NetUtil.RequestResult.Success) requestResult).getData();
            for (VipCouponIndexBean.Vip vip : vipCouponIndexBean.getVipList()) {
                vip.setSelected(Intrinsics.areEqual(vip.getId(), vipCouponIndexBean.getUser().getVieLevel()));
                if (vip.getSelected()) {
                    vip.setMy(true);
                    this.this$0.setMax(vip.getNum());
                }
            }
            this.this$0.getMBinding().setData(vipCouponIndexBean);
        }
        return Unit.INSTANCE;
    }

    /* JADX INFO: renamed from: com.cy.yyjia.zhe28.ui.activity.VipCouponActivity$getData$$inlined$get$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: NetUtil.kt */
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super NetUtil.RequestResult<? extends VipCouponIndexBean>>, Object> {
        final /* synthetic */ Map $param;
        final /* synthetic */ String $url;
        int label;
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super NetUtil.RequestResult<? extends VipCouponIndexBean>> continuation) {
            ...
            try {
                ...
                if (strString != null) {
                    if (responseExecute.isSuccessful()) {
                        ...
                        if (i == 200) {
                            Object objFromJson = new Gson().fromJson(strString, new TypeToken<BaseResult<VipCouponIndexBean>>() { // from class: com.cy.yyjia.zhe28.ui.activity.VipCouponActivity$getData$.inlined.get.1.1.1
                            }.getType());
