...
public class WebViewJsUtil {
    ...
    public static class a implements ValueCallback<String> {
        ...
        public final /* synthetic */ Handler f201a;
    ...
    public static class d implements com.tencent.smtt.sdk.ValueCallback<String> {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final /* synthetic */ g f202a;
    ...
    public static class e implements ValueCallback<String> {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final /* synthetic */ g f203a;
    ...
    public static class f implements b.e {
        ...
        public j3 a() {
            return WebViewJsUtil.create(this.f204a, this.b, this.c, this.d);
        }
    }
    ...
    public static q3 create(String str, String str2, boolean z, JSONObject jSONObject) {
    ...
    public static void injectCollectJs(View view, String str) {
        ...
        String str2 = !com.bytedance.bdtracker.b.a(new b()) ? JS_CODE_MARQUEE : JS_CODE_COLLECT;
        ...
        try {
            ...
            for (int i = 0; i < jSONArray.length(); i++) {
                ...
                if (!TextUtils.isEmpty(strOptString)) {
                    com.bytedance.bdtracker.b.a(new f(strOptString, strOptString2, z, jSONObjectOptJSONObject), com.bytedance.bdtracker.b.f216a);
                }
            }
        } catch (Throwable th) {
