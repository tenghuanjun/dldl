...
public class a implements ConfigService, b.a {
    ...
    private final Map<String, List<ConfigService.ConfigObserver>> f1117a;
    ...
    public void dispatchConfig(String str, String str2) {
        ...
        List<ConfigService.ConfigObserver> list = this.f1117a.get(str);
    ...
    public void register(String str, ConfigService.ConfigObserver configObserver) {
        List<ConfigService.ConfigObserver> arrayList = this.f1117a.get(str);
        if (arrayList == null) {
            arrayList = new ArrayList<>();
            this.f1117a.put(str, arrayList);
        }
