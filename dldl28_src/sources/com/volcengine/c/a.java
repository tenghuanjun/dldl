...
public class a implements IDownloadCallback, com.volcengine.a.a, ConfigService.ConfigObserver {
    ...
    private final com.volcengine.a.b f1110a = new com.volcengine.a.b(SDKContext.getContext(), SDKContext.getExecutorsService().getIOExecutor(), this);
    ...
    class C0443a extends TimerTask {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ DownloadRequest f1111a;

        C0443a(DownloadRequest downloadRequest) {
            this.f1111a = downloadRequest;
        }
    ...
    private void b(DownloadResponse downloadResponse, int i2, String str) {
        ...
        try {
            ...
            try {
                ...
                Map<String, String> mapC = this.f1110a.c();
    ...
    private void e(DownloadResponse downloadResponse) {
        ...
        this.f1110a.d(downloadResponse.getExtras());
    }
