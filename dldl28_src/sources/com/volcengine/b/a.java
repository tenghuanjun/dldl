...
public abstract class a {
    ...
    class C0442a extends TimerTask {
        ...
        public void run() {
            a.this.e = true;
            this.f1107a.put("diagnosis_interrupt", Constant.API_PARAMS_KEY_TIMEOUT);
            this.f1107a.put("diagnosis_time", Long.toString(System.currentTimeMillis() - a.this.c));
            a aVar = a.this;
            b bVar = aVar.i;
            if (bVar != null) {
                bVar.a(aVar, this.f1107a);
            }
            a.this.d = false;
        }
    }
    ...
    private void b(Map<String, String> map) {
        ...
        this.b = timer;
        timer.schedule(new C0442a(map), ((long) this.f1106a) * 1000);
    }
