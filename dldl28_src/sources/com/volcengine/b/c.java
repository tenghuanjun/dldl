...
public class c extends com.volcengine.b.a {
    ...
    private static class a implements Runnable {
        ...
        public void run() throws Throwable {
            this.c.put(this.f1108a, c.b(this.b) ? "0" : "1");
            this.d.countDown();
        }
    }
    ...
    */
    ...
    public static boolean b(String str) throws Throwable {
        ...
        return (lowerCase.contains(Constant.API_PARAMS_KEY_TIMEOUT) || lowerCase.contains("timed out") || lowerCase.contains("unknown")) ? false : true;
    }
