...
public class QQAvatar extends BaseApi {
    ...
    public void setAvatarByQQ(Activity activity, Uri uri, IUiListener iUiListener) {
        ...
        IUiListener iUiListener2 = this.f994a;
        if (iUiListener2 != null) {
            iUiListener2.onCancel();
        }
        this.f994a = iUiListener;
        if (!k.b(activity)) {
    ...
    public void setAvatar(Activity activity, Uri uri, IUiListener iUiListener, int i) {
        ...
        Bundle bundleA = m.a(this.c.getOpenId(), Constants.VIA_SET_AVATAR, Constants.VIA_REPORT_TYPE_SET_AVATAR, "18", this.c.getAppId());
    ...
    private void a(Activity activity, Bundle bundle, Intent intent) {
        ...
        UIListenerManager.getInstance().setListenerWithRequestcode(Constants.REQUEST_AVATER, this.f994a);
