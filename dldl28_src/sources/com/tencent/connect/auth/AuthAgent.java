...
public class AuthAgent extends BaseApi {
    ...
    private int a(boolean z, IUiListener iUiListener, boolean z2, Map<String, Object> map) {
        ...
        if (isOEM) {
            bundleA.putString(Constants.PARAM_PLATFORM_ID, "desktop_m_qq-" + installChannel + "-android-" + registerChannel + "-" + businessId);
        } else {
    ...
    private boolean a(Activity activity, Fragment fragment, Map<String, Object> map, boolean z, Object[] objArr) {
        ...
        if (intentC != null) {
            ...
            try {
                this.f960a = new b(this.f960a);
                UIListenerManager.getInstance().setListenerWithRequestcode(Constants.REQUEST_LOGIN, this.f960a);
                if (fragment != null) {
    ...
    private class a extends DefaultUiListener {
        ...
        public void onComplete(Object obj) {
            ...
            try {
                ...
                IUiListener iUiListener = this.f963a;
                if (iUiListener != null) {
    ...
    private class b extends DefaultUiListener {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        WeakReference<IUiListener> f964a;
        ...
        public b(IUiListener iUiListener) {
            this.f964a = new WeakReference<>(iUiListener);
        }
        ...
        public void onComplete(Object obj) {
            ...
            if (z && !TextUtils.isEmpty(strDecode)) {
                a(strDecode, this.f964a.get(), obj);
                SLog.i("openSDK_LOG.AuthAgent", " WORDING is not empty and return");
                return;
            }
            IUiListener iUiListener = this.f964a.get();
            if (iUiListener != null) {
        ...
        private View a(Context context, Drawable drawable, String str, View.OnClickListener onClickListener, View.OnClickListener onClickListener2) {
            ...
            view.setBackgroundColor(Color.rgb(KeyBoardKey.KeyboardKeyGamepadLeftThumbStickLeft, KeyBoardKey.KeyboardKeyGamepadLeftThumbStickLeft, KeyBoardKey.KeyboardKeyGamepadLeftThumbStickLeft));
            view.setId(3);
            ...
            button.setTextColor(Color.rgb(36, 97, KeyBoardKey.KeyboardKeyF20));
            ...
            relativeLayout.setBackgroundColor(Color.rgb(KeyBoardKey.KeyboardKeyCrSel, KeyBoardKey.KeyboardKeyZoom, KeyBoardKey.KeyboardKeyCrSel));
            PaintDrawable paintDrawable = new PaintDrawable(Color.rgb(KeyBoardKey.KeyboardKeyCrSel, KeyBoardKey.KeyboardKeyZoom, KeyBoardKey.KeyboardKeyCrSel));
        ...
        protected void a() {
            ...
            HttpUtils.requestAsync(AuthAgent.this.c, activity, "https://appsupport.qq.com/cgi-bin/qzapps/mapp_addapp.cgi", bundleB, Constants.HTTP_POST, null);
        }

        @Override // com.tencent.tauth.DefaultUiListener, com.tencent.tauth.IUiListener
        public void onError(UiError uiError) {
            if (this.f964a.get() != null) {
                this.f964a.get().onError(uiError);
            }
        }
