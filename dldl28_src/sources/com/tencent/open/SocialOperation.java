...
public class SocialOperation extends BaseApi {
    ...
    public void unBindGroup(Context context, String str, final IUiListener iUiListener) {
        ...
        if (TextUtils.isEmpty(appId)) {
            ...
            if (iUiListener != null) {
                iUiListener.onError(new UiError(PointerIconCompat.TYPE_HELP, "param appId is null", "appid is null please login."));
                return;
            }
            return;
        }
        ...
        HttpUtils.requestAsync(this.c, context, "https://openmobile.qq.com/cgi-bin/qunopensdk/unbind", bundleA, Constants.HTTP_GET, new BaseApi.TempRequestListener(defaultUiListener));
    ...
    public void joinGroup(final Activity activity, String str, final IUiListener iUiListener) {
        ...
        if (TextUtils.isEmpty(appId)) {
            ...
            if (iUiListener != null) {
                iUiListener.onError(new UiError(PointerIconCompat.TYPE_HELP, "appid is null", "appid is null, please login."));
                return;
            }
            return;
        }
        ...
        bundleA.putString("appid", appId);
        bundleA.putString("orgid", str);
        HttpUtils.requestAsync(this.c, activity, "https://openmobile.qq.com/cgi-bin/qunopensdk/check_group", bundleA, Constants.HTTP_GET, new BaseApi.TempRequestListener(defaultUiListener));
    ...
    public void bindQQGroup(final Activity activity, String str, String str2, final IUiListener iUiListener) {
        ...
        if (TextUtils.isEmpty(appId)) {
            ...
            if (iUiListener != null) {
                iUiListener.onError(new UiError(PointerIconCompat.TYPE_HELP, "appid is null", "please login."));
                return;
            }
            return;
        }
        ...
        if (TextUtils.isEmpty(strA)) {
            ...
            if (iUiListener != null) {
                iUiListener.onError(new UiError(WebSocketProtocol.CLOSE_NO_STATUS_CODE, "appName params is null", ""));
                return;
            }
            return;
        }
