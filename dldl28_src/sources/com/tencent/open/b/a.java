...
public class a {
    ...
    protected static final Uri f1048a = Uri.parse("content://telephony/carriers/preferapn");
    ...
    public static String c(Context context) {
        try {
            Cursor cursorQuery = context.getContentResolver().query(f1048a, null, null, null, null);
            if (cursorQuery == null) {
                return null;
            }
