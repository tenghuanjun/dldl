...
public class NativeCrashHandler implements q {
    ...
    private synchronized void a(boolean z) {
        ...
        if (this.j) {
            try {
                String strRegist = regist(f864a, z, c);
                if (strRegist != null) {
            ...
            try {
                ...
                String str = (String) ap.a("com.tencent.feedback.eup.jni.NativeExceptionUpload", "registNativeExceptionHandler2", new Class[]{String.class, String.class, cls, cls}, new Object[]{f864a, ab.d(), Integer.valueOf(z ? 1 : 5), 1});
                if (str == null) {
                    Class[] clsArr = {String.class, String.class, Integer.TYPE};
                    String strD = ab.d();
                    aa.b();
                    str = (String) ap.a("com.tencent.feedback.eup.jni.NativeExceptionUpload", "registNativeExceptionHandler", clsArr, new Object[]{f864a, strD, Integer.valueOf(aa.B())});
                }
                if (str != null) {
                    this.k = true;
                    this.e.u = str;
    ...
    public synchronized void startNativeMonitor() {
        if (!this.j && !this.i) {
            ...
            if (this.j || this.i) {
                ...
                setNativeLaunchTime(this.e.f867a);
                return;
            }
            return;
        }
            ...
            public final void run() {
                ...
                if (ap.a(NativeCrashHandler.this.d, "native_record_lock")) {
                    if (!NativeCrashHandler.n) {
                        NativeCrashHandler.a(NativeCrashHandler.this, BooleanUtils.FALSE);
                    }
                    CrashDetailBean crashDetailBeanA = be.a(NativeCrashHandler.this.d, NativeCrashHandler.f864a, NativeCrashHandler.this.g);
