...
public class H5JavaScriptInterface {
    ...
    private static HashSet<Integer> f863a = new HashSet<>();
    ...
    public static H5JavaScriptInterface getInstance(CrashReport.a aVar) {
        String string = null;
        if (aVar == null || f863a.contains(Integer.valueOf(aVar.hashCode()))) {
            return null;
        }
        H5JavaScriptInterface h5JavaScriptInterface = new H5JavaScriptInterface();
        f863a.add(Integer.valueOf(aVar.hashCode()));
    ...
    private static bb a(String str) {
        ...
        if (str != null && str.length() > 0) {
            try {
                ...
                bb bbVar = new bb();
                bbVar.f914a = jSONObject.getString("projectRoot");
                if (bbVar.f914a == null) {
                    return null;
                }
                ...
                int iIndexOf = string.indexOf(StringUtils.LF);
                if (iIndexOf < 0) {
                ...
                al.a("[projectRoot]: " + bbVar.f914a, new Object[0]);
    ...
    public void reportJSException(String str) {
        ...
        if (bbVarA.f914a != null) {
            linkedHashMap2.put("[JS] projectRoot", bbVarA.f914a);
        }
        if (bbVarA.b != null) {
