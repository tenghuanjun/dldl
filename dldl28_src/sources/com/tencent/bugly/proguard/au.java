    ...
    static /* synthetic */ void a(au auVar, Thread thread, int i, String str, String str2, String str3, Map map) {
        ...
        try {
            ...
            if (!strategyBeanC.f && auVar.b.b()) {
                ...
                as.a(str4, ap.a(), auVar.c.d, threadCurrentThread.getName(), str + StringUtils.LF + str2 + StringUtils.LF + str3, null);
            ...
            str5 = "";
            if (str3 != null) {
                String[] strArrSplit = str3.split(StringUtils.LF);
            ...
            crashDetailBean.Q = auVar.c.f867a;
            ...
            as.a(str4, ap.a(), auVar.c.d, threadCurrentThread.getName(), str + StringUtils.LF + str2 + StringUtils.LF + str3, crashDetailBean);
    ...
    public static void a(final Thread thread, final int i, final String str, final String str2, final String str3, final Map<String, String> map) {
        ak.a().a(new Runnable() { // from class: com.tencent.bugly.proguard.au.2
            ...
            public final void run() {
                try {
                    if (au.f902a != null) {
                        au.a(au.f902a, thread, i, str, str2, str3, map);
                    } else {
