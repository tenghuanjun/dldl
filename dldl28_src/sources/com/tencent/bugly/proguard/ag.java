...
public final class ag {
    ...
    private final SimpleDateFormat f872a;
    private final ad b;
    ...
    private ag() {
        this.f872a = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss:SSS", Locale.US);
        this.b = new ad();
    }
    ...
    private static void e(List<b> list) {
        for (b bVar : list) {
            al.c("sla save id:%s time:%s msg:%s", bVar.f875a, Long.valueOf(bVar.b), bVar.c);
            try {
                ContentValues contentValues = new ContentValues();
                contentValues.put(DBHelper.COL_ID, bVar.f875a);
    ...
    public static List<b> a() {
        Cursor cursorA = w.a().a("t_sla", new String[]{DBHelper.COL_ID, "_tm", "_dt"}, (String) null, "_tm", "30");
        if (cursorA == null) {
            return null;
        }
        ...
        while (cursorA.moveToNext()) {
            try {
                b bVar = new b();
                bVar.f875a = cursorA.getString(cursorA.getColumnIndex(DBHelper.COL_ID));
    ...
    public static class b {
        ...
        public final String toString() {
            return "SLAData{uuid='" + this.f875a + "', time=" + this.b + ", data='" + this.c + "'}";
        }
    }
    ...
    public static class a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private static final ag f874a = new ag(0);
    }
    ...
    private b b(c cVar) {
        ...
        sb.append(this.f872a.format(new Date(cVar.c)));
        ...
        al.c("sla convert eventId:%s eventType:%s, eventTime:%s success:%s cost:%s from:%s uploadMsg:", cVar.f876a, cVar.b, Long.valueOf(cVar.c), Boolean.valueOf(cVar.d), Long.valueOf(cVar.e), cVar.f, cVar.g);
        String str = cVar.f876a + "-" + cVar.b;
        b bVar = new b();
        bVar.f875a = str;
        bVar.b = cVar.c;
        bVar.c = string;
