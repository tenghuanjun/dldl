...
public final class ap {
    ...
    private static Map<String, String> f890a;
    ...
    public static String a(String str) {
        ...
        try {
            ...
            if (f890a.containsKey(str)) {
                return f890a.get(str);
            }
    ...
    public static void a(Parcel parcel, Map<String, PlugInBean> map) {
        ...
        for (int i2 = 0; i2 < arrayList.size(); i2++) {
            bundle.putString("pluginVal" + i2 + "plugInId", ((PlugInBean) arrayList2.get(i2)).f857a);
