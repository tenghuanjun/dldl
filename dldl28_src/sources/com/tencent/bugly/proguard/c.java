...
class c {
    ...
    protected HashMap<String, HashMap<String, byte[]>> f932a = new HashMap<>();
    ...
    public void a(byte[] bArr) {
        ...
        map2.put("", new byte[0]);
        map.put("", map2);
        this.f932a = this.d.a((Map) map, 0, false);
    }
}
