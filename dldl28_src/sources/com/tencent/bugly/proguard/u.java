...
public final class u {
    ...
    public static final long f950a = System.currentTimeMillis();
    private static u b;
    private Context c;
    ...
    public final void a(final int i) {
        ak.a().a(new Runnable() { // from class: com.tencent.bugly.proguard.u.1
            ...
            /* JADX INFO: renamed from: a, reason: collision with root package name */
            final /* synthetic */ int f951a = 1004;
            ...
            public final void run() {
                ...
                try {
                    ...
                    List<t> listD = u.this.d(this.f951a);
                    if (listD == null) {
                        listD = new ArrayList();
                    }
                    if (u.this.e.get(Integer.valueOf(this.f951a)) == null) {
                        u.this.e.put(Integer.valueOf(this.f951a), new HashMap());
                    }
                    if (((Map) u.this.e.get(Integer.valueOf(this.f951a))).get(u.this.d) != null) {
                        tVar = (t) ((Map) u.this.e.get(Integer.valueOf(this.f951a))).get(u.this.d);
                        tVar.d = i;
                    } else {
                        tVar = new t();
                        tVar.f949a = this.f951a;
                        tVar.g = u.f950a;
                        tVar.b = u.this.d;
                        tVar.f = aa.b().o;
                        tVar.e = aa.b().h;
                        ...
                        tVar.d = i;
                        ((Map) u.this.e.get(Integer.valueOf(this.f951a))).put(u.this.d, tVar);
                    }
                    ArrayList arrayList = new ArrayList();
                    boolean z = false;
                    for (t tVar2 : listD) {
