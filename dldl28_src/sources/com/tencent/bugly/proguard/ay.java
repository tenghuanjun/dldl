...
public final class ay {
    ...
    private CrashDetailBean a(ax axVar) {
        ...
        try {
            ...
            int iIndexOf = crashDetailBean.q != null ? crashDetailBean.q.indexOf(StringUtils.LF) : -1;
    ...
    public final boolean a(boolean z) {
        boolean zCompareAndSet = this.f907a.compareAndSet(!z, z);
    ...
    public final void a(long j, String str) {
        ...
        try {
            ...
            al.c("anr time:%d\ntrace file:%s\nproc:%s\nmain stack:%s\nshort msg:%s\nlong msg:%s\n threads:%d", Long.valueOf(axVar.c), axVar.d, axVar.f906a, axVar.g, axVar.f, axVar.e, Integer.valueOf(axVar.b == null ? 0 : axVar.b.size()));
            ...
            if (TextUtils.isEmpty(str) || !new File(str).exists()) {
                ...
                if (str.startsWith("/data/anr/")) {
                    al.a("backup trace isOK:%s", Boolean.valueOf(a(str, file.getAbsolutePath(), axVar.f906a)));
                } else {
                    al.a("trace file rename :%s", Boolean.valueOf(new File(str).renameTo(file)));
                }
                synchronized (this.j) {
                    bg bgVar = this.m;
                    listC = bgVar != null ? bgVar.f919a.c() : null;
                }
                if (listC != null) {
            ...
            if (crashDetailBeanA.f859a >= 0) {
                al.a("backup anr record success!", new Object[0]);
            } else {
                al.d("backup anr record fail!", new Object[0]);
            }
            as.a("ANR", ap.a(j), axVar.f906a, "main", axVar.g, crashDetailBeanA);
