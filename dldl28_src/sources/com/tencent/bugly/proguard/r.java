...
public final class r {
    ...
    private static int a(List<UserInfoBean> list) {
        ...
        for (UserInfoBean userInfoBean : list) {
            if (userInfoBean.e > jCurrentTimeMillis - MonitorCommonConstants.STOP_MORE_CHANNEL_INTERVAL && (userInfoBean.b == 1 || userInfoBean.b == 4 || userInfoBean.b == 3)) {
                i++;
            }
        }
        return i;
    ...
    private void a(final List<UserInfoBean> list, boolean z) {
        ...
        bq bqVarA = ae.a(this.f941a, 840, bArrA);
        if (bqVarA == null) {
            al.d("[UserInfo] Request package is null.", new Object[0]);
            return;
        }
        ai.a().a(1001, bqVarA, ac.a().c().q, StrategyBean.f858a, new ah() { // from class: com.tencent.bugly.proguard.r.1
    ...
    public void a(UserInfoBean userInfoBean, boolean z) {
        ...
        if (!z && userInfoBean.b != 1 && (listA = a(aa.a(this.f941a).d)) != null && listA.size() >= 20) {
            ...
            try {
                ...
                while (cursorA.moveToNext()) {
                    ...
                    if (userInfoBeanA != null) {
                        ...
                        try {
                            long j = cursorA.getLong(cursorA.getColumnIndex(DBHelper.COL_ID));
                            sb.append(" or _id = ");
                            sb.append(j);
    ...
    private static ContentValues b(UserInfoBean userInfoBean) {
        ...
        try {
            ...
            if (userInfoBean.f856a > 0) {
                contentValues.put(DBHelper.COL_ID, Long.valueOf(userInfoBean.f856a));
            }
    ...
    private static UserInfoBean a(Cursor cursor) {
        ...
        try {
            ...
            long j = cursor.getLong(cursor.getColumnIndex(DBHelper.COL_ID));
            UserInfoBean userInfoBean = (UserInfoBean) ap.a(blob, UserInfoBean.CREATOR);
            if (userInfoBean != null) {
                userInfoBean.f856a = j;
            }
            return userInfoBean;
        } catch (Throwable th) {
            if (!al.a(th)) {
    ...
    */
    public synchronized void a(boolean r8) {
        ...
        L22:
            ...
            return
        L24:
            android.content.Context r0 = r7.f941a     // Catch: java.lang.Throwable -> L8d
    ...
    */
    private boolean b(boolean r15) {
        ...
        L6:
            ...
            android.content.Context r2 = r14.f941a
