                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (configRule2 != null && configRule2.getSls() != null) {
                            ACMLimitConfig aCMLimitConfigBuild = ACMLimitConfig.newACMLimitConfig().isLimited(BooleanUtils.TRUE.equals(configRule.getSls().getIs_limited())).limitCount(configRule.getSls().getLimit_count()).limitHours(configRule.getSls().getLimit_time_hour()).build();
                            ...
                            if (a.b(a.this) != null) {
                                if (BooleanUtils.TRUE.equals(configRule.getIs_sls_demoted()) || BooleanUtils.TRUE.equals(configRule.getIs_demoted())) {
                                    a.b(a.this, true);
                                } else {
                                    a.b(a.this, false);
                                }
            ...
            this.g.post(new Runnable() { // from class: com.mobile.auth.p.a.2
                ...
                public void run() {
                    try {
                        ...
                        a.b(a.this).setLimitConfig(ACMLimitConfig.newACMLimitConfig().isLimited(BooleanUtils.TRUE.equals(limited_info.getIs_limited())).limitCount(limited_info.getLimit_count()).limitHours(limited_info.getLimit_time_hour()).build());
                    } catch (Throwable th) {
                        try {
                            ExceptionProcessor.processException(th);
                        } catch (Throwable th2) {
