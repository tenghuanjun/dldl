    ...
    public com.mobile.auth.v.c b() throws Exception {
        try {
            ...
            try {
                ...
                String sDKConfigByPop = RequestUtil.getSDKConfigByPop(RequestState.getInstance().getKeyRespone().getSk(), EncryptUtils.noEncryptTinfo(this.f775a, this.c.c(), com.mobile.auth.gatewayauth.utils.c.b(this.f775a)));
                    ...
                    if (configRBFromJson.getResponse() == null || configRBFromJson.getResponse().getResult() == null) {
                        if (configRBFromJson.getErrorResponse() != null) {
                            if (configRBFromJson.getErrorResponse().getCode() == 22) {
                                UTSharedPreferencesHelper.saveSDKConfigCloseFlag(this.f775a, true);
                            } else if (configRBFromJson.getErrorResponse().getCode() == 7) {
                                UTSharedPreferencesHelper.saveSDKConfigLimitFlag(this.f775a, com.mobile.auth.gatewayauth.utils.a.a());
                            }
                        }
