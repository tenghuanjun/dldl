...
public class TokenMaskManager {
    ...
    class AnonymousClass10 implements RequestCallback<com.mobile.auth.v.d, com.mobile.auth.gatewayauth.manager.base.b> {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ CacheKey f638a;
        ...
        public void a(com.mobile.auth.v.d dVar) {
            try {
                ...
                TokenMaskManager.a(TokenMaskManager.this, this.f638a, loginPhoneInfoBuild, this.b);
    ...
    class AnonymousClass11 extends Callback<com.mobile.auth.v.d> {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ RequestCallback f639a;
        ...
        AnonymousClass11(ThreadStrategy threadStrategy, long j, RequestCallback requestCallback) {
            ...
            this.f639a = requestCallback;
        }

        public void a(com.mobile.auth.v.d dVar) {
            try {
                if (dVar.a()) {
                    this.f639a.onSuccess(dVar);
                    return;
                }
    ...
    class AnonymousClass12 extends com.mobile.auth.q.d {
        ...
        public void a(RequestCallback requestCallback, a aVar) {
            try {
                aVar.a((RequestCallback<a.C0424a, com.mobile.auth.gatewayauth.manager.base.b>) requestCallback, a.b.a().a(this.f640a).b(this.b).a());
            } catch (Throwable th) {
                try {
                    ExceptionProcessor.processException(th);
                } catch (Throwable th2) {
    ...
    class AnonymousClass13 extends Callback<com.mobile.auth.v.d> {
        ...
        public void a(com.mobile.auth.v.d dVar) {
            try {
                ...
                if (dVar.a()) {
                    dVar.b().a(Math.min(System.currentTimeMillis() + 86400000, dVar.b().f()));
                    TokenMaskManager.a(TokenMaskManager.this, this.f641a, this.b, this.c, dVar.b().d(), dVar.b().f());
                    this.d.onSuccess(BooleanUtils.FALSE);
                } else {
                    com.mobile.auth.gatewayauth.manager.base.b bVarB = dVar.b();
                    if (bVarB == null) {
                        bVarB = com.mobile.auth.gatewayauth.manager.base.b.a(ResultCode.CODE_ERROR_UNKNOWN_FAIL, "未知异常");
    ...
    class AnonymousClass14 extends com.mobile.auth.q.d {
        ...
        public void a(RequestCallback requestCallback, a aVar) {
            try {
                aVar.b((RequestCallback<a.C0424a, com.mobile.auth.gatewayauth.manager.base.b>) requestCallback, a.b.a().a(this.f642a).b(this.b).a());
            } catch (Throwable th) {
                try {
                    ExceptionProcessor.processException(th);
                } catch (Throwable th2) {
    ...
    class AnonymousClass15 extends Callback<com.mobile.auth.v.d> {
        ...
        public void a(com.mobile.auth.v.d dVar) {
            try {
                TokenMaskManager.d(TokenMaskManager.this).a("Update LoginToken from network!");
                if (dVar.a()) {
                    dVar.b().a(TokenMaskManager.a(TokenMaskManager.this, dVar.b().d(), this.f643a, true));
    ...
    class AnonymousClass16 extends com.mobile.auth.q.d {
        ...
        public void a(RequestCallback requestCallback, a aVar) {
            try {
                aVar.b((RequestCallback<a.C0424a, com.mobile.auth.gatewayauth.manager.base.b>) requestCallback, a.b.a().a(this.f644a).b(this.b).a());
            } catch (Throwable th) {
                try {
                    ExceptionProcessor.processException(th);
                } catch (Throwable th2) {
    ...
    class AnonymousClass2 extends Callback<com.mobile.auth.v.e> {
        ...
        public void a(com.mobile.auth.v.e eVar) {
            try {
                ...
                if (eVar.a()) {
                    eVar.b().a(TokenMaskManager.a(TokenMaskManager.this, eVar.b().d(), this.f645a, false));
        ...
        public void a(com.mobile.auth.v.e eVar) {
            try {
                ...
                if (eVar.a()) {
                    ...
                    TokenMaskManager.b(TokenMaskManager.this, this.f646a, this.b, this.c, eVar.b().d(), eVar.b().f());
                    this.d.onSuccess(BooleanUtils.FALSE);
                } else {
                    com.mobile.auth.gatewayauth.manager.base.b bVarB = eVar.b();
                    if (bVarB == null) {
    ...
    class AnonymousClass8 implements Runnable {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ JSONObject f651a;

        AnonymousClass8(JSONObject jSONObject) {
            this.f651a = jSONObject;
        }

        @Override // java.lang.Runnable
        public void run() {
            try {
                TokenMaskManager.h(TokenMaskManager.this).save(TokenMaskManager.f(TokenMaskManager.this).encryptContent(this.f651a.toString()));
            } catch (Throwable th) {
                try {
                    ExceptionProcessor.processException(th);
                } catch (Throwable th2) {
