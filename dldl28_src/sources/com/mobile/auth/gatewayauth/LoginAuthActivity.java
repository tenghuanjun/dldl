...
public class LoginAuthActivity extends Activity {
    ...
    class AnonymousClass3 extends ClickableSpan {
        ...
        public void onClick(View view) {
            try {
                LoginAuthActivity.access$100(LoginAuthActivity.this).a(LoginAuthActivity.access$200(LoginAuthActivity.this), this.f549a, this.b, false);
                LoginAuthActivity.access$100(LoginAuthActivity.this).a(this.f549a, this.b);
            } catch (Throwable th) {
                ExceptionProcessor.processException(th);
            }
        }
    ...
    class AnonymousClass5 implements View.OnClickListener {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ LinkedHashMap f551a;
        final /* synthetic */ String b;
        ...
        public void onClick(View view) {
            ...
            try {
                AuthRegisterViewConfig authRegisterViewConfig = (AuthRegisterViewConfig) this.f551a.get(this.b);
    ...
    class AnonymousClass6 implements View.OnClickListener {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ LinkedHashMap f552a;
        final /* synthetic */ String b;

        AnonymousClass6(LinkedHashMap linkedHashMap, String str) {
            this.f552a = linkedHashMap;
            this.b = str;
        }
        ...
        public void onClick(View view) {
            CustomInterface customInterface;
            try {
                AuthRegisterViewConfig authRegisterViewConfig = (AuthRegisterViewConfig) this.f552a.get(this.b);
                if (authRegisterViewConfig == null || (customInterface = authRegisterViewConfig.getCustomInterface()) == null) {
                    return;
                }
                customInterface.onClick(LoginAuthActivity.this);
