...
public class a {
    ...
    private void a(Context context, boolean z) {
        ...
        if (subscriptionManagerFrom != null) {
            try {
                if (this.c.f543a == -1 && Build.VERSION.SDK_INT >= 24) {
    ...
    */
    private void b(android.content.Context r11) {
        ...
        L29:
            ...
            int r5 = com.mobile.auth.g.a.C0422a.b(r5)     // Catch: java.lang.Exception -> L82 java.lang.Throwable -> L92
            r6 = -1
            if (r5 != r6) goto L71
            com.mobile.auth.g.a$a r5 = r10.c     // Catch: java.lang.Exception -> L82 java.lang.Throwable -> L92
            int r5 = com.mobile.auth.g.a.C0422a.a(r5)     // Catch: java.lang.Exception -> L82 java.lang.Throwable -> L92
            if (r5 == r6) goto L71
            com.mobile.auth.g.a$a r5 = r10.c     // Catch: java.lang.Exception -> L82 java.lang.Throwable -> L92
            int r5 = com.mobile.auth.g.a.C0422a.a(r5)     // Catch: java.lang.Exception -> L82 java.lang.Throwable -> L92
            if (r5 != r4) goto L71
            com.mobile.auth.g.a$a r5 = r10.c     // Catch: java.lang.Exception -> L82 java.lang.Throwable -> L92
            com.mobile.auth.g.a.C0422a.a(r5, r2)     // Catch: java.lang.Exception -> L82 java.lang.Throwable -> L92
        ...
        L71:
            ...
            com.mobile.auth.g.a.C0422a.b(r2, r4)     // Catch: java.lang.Exception -> L82 java.lang.Throwable -> L92
            goto L29
        L7f:
            if (r11 == 0) goto L8c
            goto L89
    ...
    private int c(Context context) {
        ...
        if (!g.a(context, Permission.READ_PHONE_STATE) || (telephonyManager = (TelephonyManager) context.getApplicationContext().getSystemService(HintConstants.AUTOFILL_HINT_PHONE)) == null) {
            return -1;
        }
        if (!m.d()) {
            ...
            if (z2) {
                ...
                if (m.e() && m.d()) {
                    ...
                    if (this.c.b == 0 || this.c.b == 1) {
                        if (this.c.f543a == -1) {
                            C0422a c0422a = this.c;
                            c0422a.f543a = c0422a.b;
                        }
                        this.c.b = -1;
                    }
                    if (this.c.f543a != -1 || this.c.b != -1) {
                        b(context);
                    }
                }
    ...
    public C0422a b() {
        C0422a c0422a = this.c;
        return c0422a == null ? new C0422a() : c0422a;
    }
}
