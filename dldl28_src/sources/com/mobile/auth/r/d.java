...
public class d extends com.mobile.auth.gatewayauth.manager.a {
    ...
    static /* synthetic */ void a(d dVar, RequestCallback requestCallback, String str, String str2, String str3, String str4, MonitorStruct monitorStruct, String str5) {
        try {
            dVar.a((RequestCallback<a.C0424a, com.mobile.auth.gatewayauth.manager.base.b>) requestCallback, str, str2, str3, str4, monitorStruct, str5);
        } catch (Throwable th) {
            try {
                ExceptionProcessor.processException(th);
            } catch (Throwable th2) {
    ...
    */
    ...
    @Override // com.mobile.auth.gatewayauth.manager.a
    public synchronized void d(final RequestCallback<a.C0424a, com.mobile.auth.gatewayauth.manager.base.b> requestCallback, a.b bVar) {
            ...
            this.i.a(new com.mobile.auth.f.b() { // from class: com.mobile.auth.r.d.1
                ...
                public void a(int i, JSONObject jSONObject) {
                    try {
                        ...
                        requestCallback.onSuccess(a.C0424a.a().a(strOptString4).c(Constant.CMCC_PROTOCOL).d(Constant.CMCC_PROTOCOL_URL).a());
    ...
    @Override // com.mobile.auth.gatewayauth.manager.a
    public synchronized void e(final RequestCallback<a.C0424a, com.mobile.auth.gatewayauth.manager.base.b> requestCallback, a.b bVar) {
        try {
            ...
            this.i.c(new com.mobile.auth.f.b() { // from class: com.mobile.auth.r.d.2
                ...
                public void a(int i, JSONObject jSONObject) {
                    try {
                        ...
                        requestCallback.onSuccess(a.C0424a.a().b(jSONObject.optString("token")).a(System.currentTimeMillis() + 120000).a());
                    } catch (Throwable th) {
                        try {
                            ExceptionProcessor.processException(th);
                        } catch (Throwable th2) {
    ...
    @Override // com.mobile.auth.gatewayauth.manager.a
    public synchronized void f(final RequestCallback<a.C0424a, com.mobile.auth.gatewayauth.manager.base.b> requestCallback, a.b bVar) {
        final MonitorStruct monitorStruct;
        try {
            monitorStruct = new MonitorStruct();
            monitorStruct.putApiParam(Constant.API_PARAMS_KEY_TIMEOUT, String.valueOf(this.c));
                ...
                */
                public void a(int r12, org.json.JSONObject r13) {
                    ...
                    L41:
                        ...
                        com.mobile.auth.gatewayauth.manager.a$a$a r13 = com.mobile.auth.gatewayauth.manager.a.C0424a.a()     // Catch: java.lang.Throwable -> Lb2
