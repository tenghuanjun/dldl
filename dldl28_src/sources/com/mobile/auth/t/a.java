...
public class a extends com.mobile.auth.gatewayauth.manager.a {
                    ...
                    try {
                        try {
                            ...
                            if (jSONObjectOptJSONObject != null) {
                                ...
                                requestCallback.onSuccess(a.C0424a.a().a(strOptString2).c(Constant.CUCC_WOPROTOCOL).d(Constant.CUCC_WOPROTOCOL_URL).b(strOptString3).a(jOptLong).a());
    ...
    */
    ...
    @Override // com.mobile.auth.gatewayauth.manager.a
    public synchronized void e(final RequestCallback<a.C0424a, b> requestCallback, a.b bVar) {
        try {
            MonitorStruct monitorStruct = new MonitorStruct();
            monitorStruct.putApiParam(Constant.API_PARAMS_KEY_TIMEOUT, String.valueOf(this.c));
            monitorStruct.setSessionId(bVar.c());
            ...
            monitorStruct.setNetworkType(c.a(this.d, true));
            a(new RequestCallback<a.C0424a, b>() { // from class: com.mobile.auth.t.a.2
    ...
    public synchronized void f(final RequestCallback<a.C0424a, b> requestCallback, a.b bVar) {
        try {
            ...
            monitorStruct.setNetworkType(c.a(this.d, true));
            a(new RequestCallback<a.C0424a, b>() { // from class: com.mobile.auth.t.a.3
                public void a(a.C0424a c0424a) {
                    try {
                        requestCallback.onSuccess(c0424a);
                    } catch (Throwable th) {
