...
public class e {
    ...
    private static final String f518a = "e";
    private a e;
    ...
    public static int a(String str) {
        try {
            ...
            com.mobile.auth.a.a.a(f518a, "When InetAddress.getByName(),throws exception", th3);
            return -1;
        }
    }
    ...
    private void b() {
        ...
        try {
            ...
            try {
                ...
                com.mobile.auth.a.a.a(f518a, "unregisterNetworkCallback", th);
            }
            this.c = null;
        } catch (Throwable th2) {
            try {
    ...
    private boolean b(Context context, String str) {
            ...
            if (connectivityManager.getNetworkInfo(5).getState().compareTo(NetworkInfo.State.CONNECTED) != 0) {
                ...
                for (int i = 0; i < 5; i++) {
                    try {
                        ...
                        com.mobile.auth.a.a.a(f518a, "switchToMobileForUnderL", th);
                    }
                }
            }
            int iA = a(b(str));
        ...
        try {
            ...
            com.mobile.auth.a.a.a(f518a, "Switch network result ： " + zBooleanValue + " (4.x) , expendTime ：" + this.f);
            return zBooleanValue;
        } catch (Throwable th3) {
            z = zBooleanValue;
            th = th3;
            try {
                com.mobile.auth.a.a.a(f518a, "4.x网络切换异常", th);
                return z;
            } catch (Throwable th4) {
                try {
    ...
    public void a(Context context, a aVar) {
        try {
            ...
            try {
                ...
                com.mobile.auth.a.a.a(f518a, "switchToMobileForAboveL", th);
                if (this.e != null) {
