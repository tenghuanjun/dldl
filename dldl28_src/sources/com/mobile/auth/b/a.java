...
public class a {
    ...
    private static final String f500a = "a";
    ...
    public static String a(String str, String str2) {
        try {
            ...
            try {
                com.mobile.auth.a.a.a(f500a, "encryptAesNew error", th);
                return null;
            } catch (Throwable th2) {
                try {
    ...
    public static byte[] b(String str, String str2) {
        try {
            ...
            try {
                com.mobile.auth.a.a.a(f500a, "encrypt4Ux error", th);
                return null;
            } catch (Throwable th2) {
                try {
                    ExceptionProcessor.processException(th2);
    ...
    public static String c(String str, String str2) {
        try {
            ...
            com.mobile.auth.a.a.a(f500a, "Aes decrypt result is empty");
            return "";
        } catch (Throwable th) {
            try {
                com.mobile.auth.a.a.a(f500a, "decryptAesNew error", th);
                return "";
            } catch (Throwable th2) {
                try {
                    ExceptionProcessor.processException(th2);
