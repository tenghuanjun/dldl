...
public class ImageUtil {
    ...
    public static boolean isNeedSavePicture(Context context, long j) {
        Cursor cursorQuery = context.getContentResolver().query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI.buildUpon().appendQueryParameter("limit", "1").build(), new String[]{"date_added", DBHelper.COL_ID, "_size"}, "_size>0", null, "_id DESC");
        ...
        cursorQuery.getInt(cursorQuery.getColumnIndex(DBHelper.COL_ID));
