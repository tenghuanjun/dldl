...
public final class Response implements Closeable {
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = CommonConstants.KEY_MESSAGE, imports = {}))
    ...
    public final CacheControl m8465deprecated_cacheControl() {
        return cacheControl();
    }
