    ...
    public static final class Pin {
        ...
        public final boolean matchesHostname(String hostname) {
            ...
            if (StringsKt.startsWith$default(this.pattern, "**.", false, 2, (Object) null)) {
                ...
                if (!StringsKt.regionMatches(hostname, hostname.length() - length3, this.pattern, 1, length3, (16 & 16) != 0 ? false : false) || StringsKt.lastIndexOf$default((CharSequence) hostname, ClassUtils.PACKAGE_SEPARATOR_CHAR, length4 - 1, false, 4, (Object) null) != -1) {
                    return false;
                }
            } else {
