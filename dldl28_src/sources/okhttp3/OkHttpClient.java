...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public final List<Interceptor> m8445deprecated_interceptors() {
        return this.interceptors;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "networkInterceptors", imports = {}))
    /* JADX INFO: renamed from: -deprecated_networkInterceptors, reason: not valid java name */
    public final List<Interceptor> m8446deprecated_networkInterceptors() {
        return this.networkInterceptors;
    }
    ...
    public static final class Builder {
        ...
        public final Builder m8457addInterceptor(final Function1<? super Interceptor.Chain, Response> block) {
        ...
        public final Builder m8458addNetworkInterceptor(final Function1<? super Interceptor.Chain, Response> block) {
            Intrinsics.checkNotNullParameter(block, "block");
        ...
        public final Builder callTimeout(long timeout, TimeUnit unit) {
            ...
            setCallTimeout$okhttp(Util.checkDuration(Constant.API_PARAMS_KEY_TIMEOUT, timeout, unit));
            return this;
        }
        ...
        public final Builder connectTimeout(long timeout, TimeUnit unit) {
            Intrinsics.checkNotNullParameter(unit, "unit");
            setConnectTimeout$okhttp(Util.checkDuration(Constant.API_PARAMS_KEY_TIMEOUT, timeout, unit));
            return this;
        }
        ...
        public final Builder readTimeout(long timeout, TimeUnit unit) {
            Intrinsics.checkNotNullParameter(unit, "unit");
            setReadTimeout$okhttp(Util.checkDuration(Constant.API_PARAMS_KEY_TIMEOUT, timeout, unit));
            return this;
        }
        ...
        public final Builder writeTimeout(long timeout, TimeUnit unit) {
            Intrinsics.checkNotNullParameter(unit, "unit");
            setWriteTimeout$okhttp(Util.checkDuration(Constant.API_PARAMS_KEY_TIMEOUT, timeout, unit));
            return this;
        }
        ...
        public final Builder pingInterval(long interval, TimeUnit unit) {
            Intrinsics.checkNotNullParameter(unit, "unit");
            setPingInterval$okhttp(Util.checkDuration(MetricsSQLiteCacheKt.METRICS_INTERVAL, interval, unit));
            return this;
        }
