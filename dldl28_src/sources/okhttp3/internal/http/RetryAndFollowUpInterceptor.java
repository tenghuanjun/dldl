...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    private final Request buildRedirectRequest(Response userResponse, String method) {
        ...
        if (!this.client.followRedirects() || (strHeader$default = Response.header$default(userResponse, com.lzy.okgo.model.HttpHeaders.HEAD_KEY_LOCATION, null, 2, null)) == null || (httpUrlResolve = userResponse.request().url().resolve(strHeader$default)) == null) {
            return null;
        }
        ...
        if (HttpMethod.permitsRequestBody(method)) {
            ...
            if (HttpMethod.INSTANCE.redirectsToGet(method) && iCode != 308 && iCode != 307) {
                builderNewBuilder.method(Constants.HTTP_GET, null);
            } else {
            ...
            if (!z) {
                ...
                builderNewBuilder.removeHeader(com.lzy.okgo.model.HttpHeaders.HEAD_KEY_CONTENT_TYPE);
            }
        }
